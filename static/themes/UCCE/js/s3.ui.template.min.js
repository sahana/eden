...
C+G+'<div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><h2 class="left">Answer</h2></div></div><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><label>Choices</label><select id="scale-'+b+'"><option value="">Please choose scale</option>'+g+'</select></div></div><div class="row"><div class="columns medium-1"></div><div class="columns medium-11">'+v+"</div></div></div>";v='<div class="media content" id="translation-'+c+'"><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><h2 class="left">Likert-scale</h2></div></div><div class="row"><div class="columns medium-1"><label id="qlabel-l10n-'+
b+'" class="fright">Q'+k+'</label></div><div class="columns medium-11"><div class="translate-from"></div></div></div><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><input id="name-l10n-'+b+'" type="text" size=100 placeholder="type translated question" value="'+n+'"></div></div></div>';H="#question-"+b+" input, #question-"+b+" select";n="#question-"+b+" .ucce-delete";break;case "heatmap":n=r="",d&&(r=u.name,h&&(n=u.name_l10n||"")),r='<div class="media content active" id="edit-'+
c+'"><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><h2 class="left">Heatmap</h2></div></div><div class="row"><div class="columns medium-1"><label id="qlabel-'+b+'" class="fright">Q'+k+'</label></div><div class="columns medium-11"><input id="name-'+b+'"type="text" size=100 placeholder="type question" value="'+r+'"></div></div>'+C+'<div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><h2 class="fleft">Image</h2></div></div><div class="row"><div class="columns medium-1"></div><div class="columns medium-6"><label for="image-'+
...
v='<div class="media content" id="translation-'+c+'"><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><h2 class="left">Heatmap</h2></div></div><div class="row"><div class="columns medium-1"><label id="qlabel-l10n-'+b+'" class="fright">Q'+k+'</label></div><div class="columns medium-11"><div class="translate-from"></div></div></div><div class="row"><div class="columns medium-1"></div><div class="columns medium-11"><input id="name-l10n-'+b+'" type="text" size=100 placeholder="type translated question" value="'+
n+'"></div></div></div>',H="#question-"+b+" input",n="#question-"+b+" .ucce-delete"}m=m+r+p+v;m+="</div></div>";a("#survey-droppable-"+c).before(m);k=c+1;a("#survey-droppable-"+c).attr("id","survey-droppable-"+k);B[e]++;a("#section-break-"+A[e]+" > span").html("PAGE "+e+" ("+B[e]+" ELEMENTS)");var y=this.eventNamespace,x=this,O=function(){a(H).off("change"+y).on("change"+y,function(){if("instructions"==f){var d=this.id.split("-");d=parseInt(d[d.length-1]);var c=x.data.layout[d];c.do.text=a("#do-"+
d).val();c.say.text=a("#say-"+d).val();h&&(c.do.hasOwnProperty("10n")||(c.do.l10n={}),c.do.l10n[h]=a("#do-l10n-"+d).val(),c.say.hasOwnProperty("10n")||(c.say.l10n={}),c.say.l10n[h]=a("#say-l10n-"+d).val());x.saveLayout()}else x.saveQuestion(f,b)});if("instructions"!=f&&"heatmap"!=f)a("#pipe-"+b).on("change"+y,function(){var d=a(this).val();if(d){for(var c,e=0,g=q.length;e<g;e++)if(c=q[e],c.label==d){u.settings.pipeImage={id:c.id,region:c.region};break}x.deleteImage(b)}else delete u.settings.pipeImage;
x.saveQuestion(f,b)})};O();"instructions"!=f&&(d&&(e=u.file)&&t(S3.Ap.concat("/default/download/"+e),function(d){var c=t.scale(d,{canvas:!0,maxHeight:80,maxWidth:80});a("#preview-"+b).removeClass("preview-empty").empty().append(c);return d},{}),a("#image-delete-"+b).on("click"+y,function(){x.deleteImage(b)}),a("#image-"+b).fileupload({dataType:"json",dropZone:a("#preview-"+b+", #image-"+b),maxNumberOfFiles:1,url:S3.Ap.concat("/dc/question/")+b+"/image_upload.json",add:function(d,c){if(d.isDefaultPrevented())return!1;
(c.autoUpload||!1!==c.autoUpload&&a(this).fileupload("option","autoUpload"))&&c.process().done(function(){c.submit();t(c.files[0],function(d){var c=t.scale(d,{canvas:!0,maxHeight:80,maxWidth:80});a("#preview-"+b).removeClass("preview-empty").empty().append(c);c=u.type;if(13!=c){u.settings.hasOwnProperty("pipeImage")&&a("#pipe-"+b).val("").trigger("change");var e=!1;for(d in q)d.id==b&&(e=!0);e||(c="Q"+a("#question-"+b).data("number")+" "+J[c],q.push({label:c,id:b}));c=x.data.questions;e=x.data.layout;
for(var f=1;f<=Object.keys(e).length;f++){var g=e[f];if("question"==g.type){g=g.id;var h=c[g];13!=h.type&&a("#pipe-"+g).empty().append(x.pipeOptionsHtml(g))}}}return d},{})})}}));a(n).on("click"+y,function(){x.deleteQuestion(f,b,this)});switch(f){case "number":a("#answer-"+b).validate({rules:{min:{required:!1,digits:!0,lessThanMax:!0},max:{required:!1,digits:!0,greaterThanMin:!0}},messages:{min:{digits:"Only integers allowed"},max:{digits:"Only integers allowed"}},errorClass:"req",focusCleanup:!0});
break;case "multichoice":var F=a("#multiple-"+b),z=a("#multiple-count-"+b),P=function(){a(".choice-"+b).next().off("click"+y).on("click"+y,function(){if(1<a(".choice-"+b).length){a(this).parent().remove();var d=parseInt(z.html()),c=a(".choice-"+b).length;a("#other-"+b).prop("checked")&&c++;d>c&&(z.html(c),1==c&&F.prop("checked",!1));x.saveQuestion(f,b)}else a(this).prev().val("")});a(".choice-"+b).next().next().off("click"+y).on("click"+y,function(){a(this).parent().after(L);O();P()});a("#other-"+
b).on("change"+y,function(){if(a(this).prop("checked"))a("#other-label-"+b).prop("disabled",!1);else{a("#other-label-"+b).prop("disabled",!0);var d=parseInt(z.html()),c=a(".choice-"+b).length;d>c&&(z.html(c),1==c&&F.prop("checked",!1))}});F.on("change"+y,function(){if(F.prop("checked")){parseInt(z.html());var d=a(".choice-"+b).length;a("#other-"+b).prop("checked")&&d++;1<d?z.html(2):F.prop("checked",!1)}else z.html(1);x.saveQuestion(f,b)});z.prev().on("click"+y,function(){if(F.prop("checked")){var a=
parseInt(z.html());2<a?(z.html(a-1),x.saveQuestion(f,b)):2==a&&(z.html(1),F.prop("checked",!1),x.saveQuestion(f,b))}});z.next().on("click"+y,function(){if(F.prop("checked")){var d=parseInt(z.html()),c=a(".choice-"+b).length;a("#other-"+b).prop("checked")&&c++;d<c&&(z.html(d+1),x.saveQuestion(f,b))}})};P();break;case "likert":a("#scale-"+b).on("change"+y,function(){var b=a(this),d=b.val();if(d){d=w[d];for(var c="",e=0,f=d.length;e<f;e++)c+="<li>"+d[e]+"</li>";d="<ul>"+c+"</ul>";b.parent().next().empty().append(d)}else b.parent().next().empty()})}"instructions"==
f?a("#instruction-"+c).foundation("tab","reflow"):a("#question-"+b).foundation("tab","reflow")},deleteQuestion:function(c,e,f){if("instructions"==c){f=parseInt(a(f).closest(".dl-item").attr("id").split("-")[1]);var b=a("#instruction-"+f).data("page")}else f=a("#question-"+e).data("number"),f=D[f],b=a("#question-"+e).data("page");B[b]--;a("#section-break-"+A[b]+" > span").html("PAGE "+b+" ("+B[b]+" ELEMENTS)");var d=b+1;for(b=Object.keys(A).length;d<=b;d++)A[d]--;var h,g,l=this.data.layout,k=Object.keys(l).length;
for(d=f;d<k;d++){b=d+1;var m=l[b];l[d]=m;if("break"==m.type)a("#section-break-"+b).attr("id","section-break-"+d);else{if("question"==m.type){var n=m.id;m=a("#question-"+n);var p=m.data("number");if("instructions"==c)D[p]=d;else{var q=p-1;m.data("number",q);a("#qlabel-"+n).html("Q"+q);a("#qlabel-l10n-"+n).html("Q"+q);D[q]=d}}else a("#instruction-"+b).attr("id","instruction-"+d),m=a("#instruction-"+d),a("#do-"+b).attr("id","do-"+d),a("#say-"+b).attr("id","say-"+d),a("#do-l10n-"+b).attr("id","do-l10n-"+
d),a("#say-l10n-"+b).attr("id","say-l10n-"+d);a("#edit-"+b).attr("id","edit-"+d);a("#logic-"+b).attr("id","logic-"+d);a("#translation-"+b).attr("id","translation-"+d);m.find("li.tab-title > a").each(function(){var b=a(this);h=b.attr("href");g=h.split("-")[0];g=g.substring(1,g.length);b.attr("href","#"+g+"-"+d)})}}delete l[k];"instructions"!=c&&delete D[p];this.saveLayout();"instructions"==c?a("#instruction-"+f).remove():a("#question-"+e).remove();a("#survey-droppable-"+(k+1)).attr("id","survey-droppable-"+
k);"instructions"!=c&&(c=S3.Ap.concat("/dc/question/")+e+"/delete.json",this.ajaxMethod({url:c,type:"POST",dataType:"json",success:function(){},error:function(a,b,d){console.log("UNAUTHORIZED"==d?i18n.gis_requires_login:a.responseText)}}))},pipeOptionsHtml:function(a,e){var c=this.data.questions[a];e='<option value="">select question</option>';if(c&&c.settings&&c.settings.pipeImage)var b=c.settings.pipeImage;for(var d=0,h=q.length;d<h;d++)c=q[d],c.id!=a&&(e=b&&b.id==c.id&&b.region==c.region?e+("<option selected>"+
c.label+"</option>"):e+("<option>"+c.label+"</option>"));return e},logicOptionsHtml:function(a,e){return'<option value="">select question</option>'},deleteImage:function(c){var e=this,f=a("#preview-"+c);if(!f.hasClass("preview-empty")){var b=S3.Ap.concat("/dc/question/")+c+"/image_delete.json";this.ajaxMethod({url:b,type:"POST",dataType:"json",success:function(){f.empty().addClass("preview-empty");var b=q;q=[];for(var h=0,g=b.length;h<g;h++){var l=b[h];l.id!=c&&q.push(l)}l=e.data.questions;b=e.data.layout;
for(h=1;h<=Object.keys(b).length;h++)if(g=b[h],"question"==g.type){g=g.id;var k=l[g];13!=k.type&&a("#pipe-"+g).empty().append(e.pipeOptionsHtml(g))}},error:function(a,b,c){console.log("UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText)}})}},addSectionBreak:function(c,e,f){e++;A[e]=c;B[e]=0;var b='<div class="row"><div class="section-break medium-11 columns" id="section-break-'+c+'" data-page="'+e+'"><span>PAGE '+e+' (0 ELEMENTS)</span></div><div class="medium-1 columns">'+(c?'<i class="ucce ucce-delete-page"> </i>':
"")+'<i class="ucce ucce-down-alt"> </i></div></div>';if(c){a("#survey-droppable-"+c).before(b);b=c+1;a("#survey-droppable-"+c).data("page",e).attr("id","survey-droppable-"+b);f||(this.data.layout[c]={type:"break"},this.saveLayout());var d=this;e=this.eventNamespace;a("#section-break-"+c).next().children(".ucce-delete-page").on("click"+e,function(){var b=parseInt(a(this).parent().prev().attr("id").split("-")[2]);d.deleteSectionBreak(b)})}else a(this.element).parent().append(b)},deleteSectionBreak:function(c){var e=
a("#section-break-"+c).data("page"),f=B[e];if(f){var b=e-1;B[b]+=f;a("#section-break-"+A[b]+" > span").html("PAGE "+b+" ("+B[b]+" ELEMENTS)")}f=Object.keys(A).length;for(var d=e;d<f;d++)A[d]=A[d+1]-1,B[d]=B[d+1];delete A[f];delete B[f];e=this.data.layout;b=Object.keys(e).length;if(c!=b){var h,g;for(d=c;d<b;d++){var l=d+1;var k=e[l];e[d]=k;if("break"==k.type)k=a("#section-break-"+l).data("page")-1,a("#section-break-"+l).data("page",k),a("#section-break-"+l+" > span").html("PAGE "+k+" ("+B[k]+" ELEMENTS)"),
a("#section-break-"+l).attr("id","section-break-"+d);else{if("question"==k.type){var m=a("#question-"+k.id);k=m.data("number");D[k]=d}else a("#instruction-"+l).attr("id","instruction-"+d),m=a("#instruction-"+d),a("#do-"+l).attr("id","do-"+d),a("#say-"+l).attr("id","say-"+d),a("#do-l10n-"+l).attr("id","do-"+d),a("#say-l10n-"+l).attr("id","say-"+d);a("#edit-"+l).attr("id","edit-"+d);a("#logic-"+l).attr("id","logic-"+d);a("#translation-"+l).attr("id","translation-"+d);m.find("li.tab-title > a").each(function(){var b=
