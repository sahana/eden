...
$(document).ready(function(){$("#buttons").find(".button").off("click.ucce").on("click.ucce",function(c){var b=$(this);if(b.hasClass("secondary"))window.parent.S3.popup_remove();else if(b.hasClass("disabled"))return c.preventDefault(),!1;return!0});var a=$("#checkbox1, #checkbox2");a.off(".ucce").on("change.ucce",function(){0==a.not(":checked").length&&$(".button.disabled").removeClass("disabled")})});
