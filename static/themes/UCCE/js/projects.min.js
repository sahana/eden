...
$jscomp.global.Symbol(d):$jscomp.POLYFILL_PREFIX+b+"$"+d),$jscomp.defineProperty(e,$jscomp.propertyToPolyfillSymbol[d],{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(c,b){return $jscomp.findInternal(this,c,b).v}},"es6","es3");
$(document).ready(function(){var a=$.ajaxS3;void 0!==$.searchS3&&(a=$.searchS3);var c=$("#datalist");(function(){c.find(".switch input").off("change.ucce").on("change.ucce",function(){var b=$(this),e=b.attr("id").split("-").pop();b=b.prop("checked")?"activate":"deactivate";a({url:S3.Ap.concat("/dc/target/")+e+"/"+b+".json",type:"POST",dataType:"json",success:function(){},error:function(d,f,g){console.log("UNAUTHORIZED"==g?i18n.gis_requires_login:d.responseText)}})})})()});
