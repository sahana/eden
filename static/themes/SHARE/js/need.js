(function() {
    ...
    $.filterOptionsS3({
      'trigger': {'alias': 'line', 'name': 'item_category_id'},
      'target': {'alias': 'line', 'name': 'item_id'},
      'scope': 'row',
      'lookupPrefix': 'supply',
      'lookupResource': 'item',
    ...
    $.filterOptionsS3({
      'trigger': {'alias':'line','name':'item_id'},
      'target': {'alias':'line','name':'item_pack_id'},
      'scope': 'row',
      'lookupPrefix': 'supply',
    ...
    $.filterOptionsS3({
      'trigger': {'alias': 'line', 'name': 'coarse_location_id'},
      'target': {'alias': 'line', 'name': 'location_id'},
      'scope': 'row',
      'lookupPrefix': 'gis',
      'lookupResource': 'location',
      // Level hardcoded for SHARE/LK
