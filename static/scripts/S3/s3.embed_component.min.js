...
$("#select_from_registry").removeClass("hide");$("#clear_form_link").removeClass("hide");$("#edit_selected_link").removeClass("hide")});$("#component_autocomplete_row").addClass("hide");$("#select_from_registry_row").removeClass("hide")};"None"!=d&&($(c).val(d),select_component(d));$("form").submit(function(){S3ClearNavigateAwayConfirm();b();return!0})});
