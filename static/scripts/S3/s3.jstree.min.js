...
*/
(function(){if(!jQuery||!jQuery.jstree){var n=!1,t=!1,s=!1;(function(b){b.vakata={};b.vakata.css={get_css:function(a,b,c){a=a.toLowerCase();var e=c.cssRules||c.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==a)return!0===b?(c.removeRule&&c.removeRule(d),c.deleteRule&&c.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,c){if(b.jstree.css.get_css(a,!1,c))return!1;c.insertRule?c.insertRule(a+" { }",0):c.addRule(a,null,0);return b.vakata.css.get_css(a)},
...
refresh:function(){this._unbindEvents();var b=this.options;if(this.tree.find("li").length){this.noopts.hide();this.button.show();var a=[],c=b.selected;if(c){for(var d=this.treeID,e=0,f=c.length;e<f;e++)a.push(d+"-"+c[e]);this._updateButtonText(a)}n.jstree._themes=S3.Ap.concat("/",b.themesFolder,"/");"ltr"==n("body").css("direction")?(c=!1,d=b.theme):(c=!0,d=b.theme+"-rtl");var e=b.multiple,g=b.leafonly,f=this.tree,l=[],h=f.find("> ul > li");1==h.length&&l.push(h.attr("id"));f.jstree({core:{animation:100,
check_callback:!0,html_titles:b.htmlTitles,initially_open:l,rtl:c},themes:{icons:!1,theme:d},ui:{initially_select:a,select_limit:e?-1:1,select_multiple_modifier:"on"},checkbox:{override_ui:!0,two_state:!g},plugins:["themes","html_data","ui","sort","checkbox"]});if(!e){var f=this.tree,m=jQuery.jstree._reference(f);f.bind("check_node.jstree",function(a,b){var c=b.rslt.obj.attr("id");m.get_checked(null,!0).each(function(){c!=this.id&&(g&&!m.is_leaf("#"+this.id)||m.uncheck_node("#"+this.id))})})}this._bindEvents()}else this.button.hide(),
