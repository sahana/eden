...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(d,q,z){d instanceof String&&(d=String(d));for(var f=d.length,l=0;l<f;l++){var n=d[l];if(q.call(z,n,l,d))return{i:l,v:n}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,q,z){d!=Array.prototype&&d!=Object.prototype&&(d[q]=z.value)};$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(d,q,z,f){if(q){z=$jscomp.global;d=d.split(".");for(f=0;f<d.length-1;f++){var l=d[f];l in z||(z[l]={});z=z[l]}d=d[d.length-1];f=z[d];q=q(f);q!=f&&null!=q&&$jscomp.defineProperty(z,d,{configurable:!0,writable:!0,value:q})}};$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(d,z){return $jscomp.findInternal(this,d,z).v}},"es6","es3");
(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):"undefined"!==typeof module&&module.exports?module.exports=d(require("jquery")):d(jQuery)})(function(d,q){if(!d.jstree){var z=0,f=!1,l=!1,n=!1,v=[],x=d("script:last").attr("src"),t=window.document;d.jstree={version:"3.3.8",defaults:{plugins:[]},plugins:{},path:x&&-1!==x.indexOf("/")?x.replace(/\/[^\/]+$/,""):"",idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g,root:"#"};d.jstree.create=function(a,b){var c=new d.jstree.core(++z),
...
a=this._data.core.selected.length;var p,w;b.each(d.proxy(function(a,c){if(p=this._parse_model_from_html(d(c),e,m.parents.concat()))h.push(p),k.push(p),g[p].children_d.length&&(k=k.concat(g[p].children_d))},this));m.children=h;m.children_d=k;b=0;for(w=m.parents.length;b<w;b++)g[m.parents[b]].children_d=g[m.parents[b]].children_d.concat(k);this.trigger("model",{nodes:k,parent:e});e!==d.jstree.root?(this._node_changed(e),this.redraw()):(this.get_container_ul().children(".jstree-initial-node").remove(),
...
b.id,e);var B=r[g];b.children.push(g);B.children_d.length&&(b.children_d=b.children_d.concat(B.children_d))}b.children_d=b.children_d.concat(b.children)}a&&a.children&&!0===a.children&&(b.state.loaded=!1,b.children=[],b.children_d=[]);delete a.data;delete a.children;b.original=a;r[b.id]=b;b.state.selected&&k.push(b.id);return b.id};if(b.length&&b[0].id!==c&&b[0].parent!==c){var q=0;for(l=b.length;q<l;q++)b[q].children||(b[q].children=[]),b[q].state||(b[q].state={}),r[b[q].id.toString()]=b[q];q=0;
for(l=b.length;q<l;q++)r[b[q].parent.toString()]?(r[b[q].parent.toString()].children.push(b[q].id.toString()),f.children_d.push(b[q].id.toString())):"undefined"!==typeof g&&(g._data.core.last_error={error:"parse",plugin:"core",id:"core_07",reason:"Node with invalid parent",data:JSON.stringify({id:b[q].id.toString(),parent:b[q].parent.toString()})},g.settings.core.error.call(g,g._data.core.last_error));q=0;for(l=f.children.length;q<l;q++){var v=n(r[f.children[q]],e,f.parents.concat());h.push(v);r[v].children_d.length&&
(h=h.concat(r[v].children_d))}}else{q=0;for(l=b.length;q<l;q++)if(v=t(b[q],e,f.parents.concat()))d.push(v),h.push(v),r[v].children_d.length&&(h=h.concat(r[v].children_d));f.children=d;f.children_d=h}q=0;for(l=f.parents.length;q<l;q++)r[f.parents[q]].children_d=r[f.parents[q]].children_d.concat(h);b={cnt:w,mod:r,sel:a,par:e,dpc:h,add:k};if("undefined"===typeof window||"undefined"===typeof window.document)postMessage(b);else return b},p=function(a,b){if(null!==this.element){this._cnt=a.cnt;var e=this._model.data;
...
this.get_node(a),k=!1,g=!1,m=!1,p=!1,w=!1,r=!1,f="";r=this._model.data;var u=!1,l=null;f=w=0;var q=!1,B=!1;if(!h)return!1;if(h.id===d.jstree.root)return this.redraw(!0);b=b||0===h.children.length;if(a=t.querySelector?this.element[0].querySelector("#"+(-1!=="0123456789".indexOf(h.id[0])?"\\3"+h.id[0]+" "+h.id.substr(1).replace(d.jstree.idregex,"\\$&"):h.id.replace(d.jstree.idregex,"\\$&"))):t.getElementById(h.id))a=d(a),c||(k=a.parent().parent()[0],k===this.element[0]&&(k=null),g=a.index()),b||!h.children.length||
...
("class"!==p?a.setAttribute(p,h.li_attr[p]):f+=h.li_attr[p]);h.a_attr.id||(h.a_attr.id=h.id+"_anchor");a.setAttribute("aria-selected",!!h.state.selected);a.setAttribute("aria-level",h.parents.length);a.setAttribute("aria-labelledby",h.a_attr.id);h.state.disabled&&a.setAttribute("aria-disabled",!0);p=0;for(w=h.children.length;p<w;p++)if(!r[h.children[p]].state.hidden){q=!0;break}if(null!==h.parent&&r[h.parent]&&!h.state.hidden&&(p=d.inArray(h.id,r[h.parent].children),B=h.id,-1!==p))for(p++,w=r[h.parent].children.length;p<
w&&(r[r[h.parent].children[p]].state.hidden||(B=r[h.parent].children[p]),B===h.id);p++);h.state.hidden&&(f+=" jstree-hidden");h.state.loading&&(f+=" jstree-loading");h.state.loaded&&!q?f+=" jstree-leaf":(f+=h.state.opened&&h.state.loaded?" jstree-open":" jstree-closed",a.setAttribute("aria-expanded",h.state.opened&&h.state.loaded));B===h.id&&(f+=" jstree-last");a.id=h.id;a.className=f;f=(h.state.selected?" jstree-clicked":"")+(h.state.disabled?" jstree-disabled":"");for(w in h.a_attr)!h.a_attr.hasOwnProperty(w)||
"href"===w&&"#"===h.a_attr[w]||("class"!==w?a.childNodes[1].setAttribute(w,h.a_attr[w]):f+=" "+h.a_attr[w]);f.length&&(a.childNodes[1].className="jstree-anchor "+f);if(h.icon&&!0!==h.icon||!1===h.icon)!1===h.icon?a.childNodes[1].childNodes[0].className+=" jstree-themeicon-hidden":-1===h.icon.indexOf("/")&&-1===h.icon.indexOf(".")?a.childNodes[1].childNodes[0].className+=" "+h.icon+" jstree-themeicon-custom":(a.childNodes[1].childNodes[0].style.backgroundImage='url("'+h.icon+'")',a.childNodes[1].childNodes[0].style.backgroundPosition=
"center center",a.childNodes[1].childNodes[0].style.backgroundSize="auto",a.childNodes[1].childNodes[0].className+=" jstree-themeicon-custom");this.settings.core.force_text?a.childNodes[1].appendChild(t.createTextNode(h.text)):a.childNodes[1].innerHTML+=h.text;if(b&&h.children.length&&(h.state.opened||e)&&h.state.loaded){r=t.createElement("UL");r.setAttribute("role","group");r.className="jstree-children";p=0;for(w=h.children.length;p<w;p++)r.appendChild(this.redraw_node(h.children[p],b,!0));a.appendChild(r)}m&&
a.appendChild(m);if(!c){k||(k=this.element[0]);p=0;for(w=k.childNodes.length;p<w;p++)if(k.childNodes[p]&&k.childNodes[p].className&&-1!==k.childNodes[p].className.indexOf("jstree-children")){l=k.childNodes[p];break}l||(l=t.createElement("UL"),l.setAttribute("role","group"),l.className="jstree-children",k.appendChild(l));k=l;g<k.childNodes.length?k.insertBefore(a,k.childNodes[g]):k.appendChild(a);u&&(w=this.element[0].scrollTop,f=this.element[0].scrollLeft,a.childNodes[1].focus(),this.element[0].scrollTop=
w,this.element[0].scrollLeft=f)}h.state.opened&&!h.state.loaded&&(h.state.opened=!1,setTimeout(d.proxy(function(){this.open_node(h.id,!1,0)},this),0));return a},open_node:function(a,b,c){var e;if(d.isArray(a)){a=a.slice();var h=0;for(e=a.length;h<e;h++)this.open_node(a[h],b,c);return!0}a=this.get_node(a);if(!a||a.id===d.jstree.root)return!1;c=c===q?this.settings.core.animation:c;if(!this.is_closed(a))return b&&b.call(this,a,!1),!1;if(this.is_loaded(a)){h=this.get_node(a,!0);var k=this;h.length&&(c&&
...
d.inArray(b.id,f.children)+1;break;case "inside":case "first":c=0;break;case "last":c=f.children.length;break;default:c||(c=0)}c>f.children.length&&(c=f.children.length);if(!this.check("move_node",a,f,c,{core:!0,origin:g,is_multi:u&&u._id&&u._id!==this._id,is_foreign:!u||!u._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;if(a.parent===f.id){h=f.children.concat();p=d.inArray(a.id,h);-1!==p&&(h=d.vakata.array_remove(h,p),c>p&&c--);p=[];var n=0;for(w=h.length;n<w;n++)p[n>=
c?n+1:n]=h[n];p[c]=a.id;f.children=p;this._node_changed(f.id);this.redraw(f.id===d.jstree.root)}else{p=a.children_d.concat();p.push(a.id);n=0;for(w=a.parents.length;n<w;n++){h=[];var B=u._model.data[a.parents[n]].children_d;var t=0;for(r=B.length;t<r;t++)-1===d.inArray(B[t],p)&&h.push(B[t]);u._model.data[a.parents[n]].children_d=h}u._model.data[m].children=d.vakata.array_remove_item(u._model.data[m].children,a.id);n=0;for(w=f.parents.length;n<w;n++)this._model.data[f.parents[n]].children_d=this._model.data[f.parents[n]].children_d.concat(p);
h=[];n=0;for(w=f.children.length;n<w;n++)h[n>=c?n+1:n]=f.children[n];h[c]=a.id;f.children=h;f.children_d.push(a.id);f.children_d=f.children_d.concat(a.children_d);a.parent=f.id;p=f.parents.concat();p.unshift(f.id);B=a.parents.length;a.parents=p;p=p.concat();n=0;for(w=a.children_d.length;n<w;n++)this._model.data[a.children_d[n]].parents=this._model.data[a.children_d[n]].parents.slice(0,-1*B),Array.prototype.push.apply(this._model.data[a.children_d[n]].parents,p);if(m===d.jstree.root||f.id===d.jstree.root)this._model.force_full_redraw=
...
a;if(!u)return!1;!0===u.id&&delete u.id;u=this._parse_model_from_json(u,f.id,f.parents.concat());if(!u)return!1;p=this.get_node(u);a&&a.state&&!1===a.state.loaded&&(p.state.loaded=!1);h=[];h.push(u);h=h.concat(p.children_d);this.trigger("model",{nodes:h,parent:f.id});u=0;for(w=f.parents.length;u<w;u++)this._model.data[f.parents[u]].children_d=this._model.data[f.parents[u]].children_d.concat(h);h=[];u=0;for(w=f.children.length;u<w;u++)h[u>=c?u+1:u]=f.children[u];h[c]=p.id;f.children=h;f.children_d.push(p.id);
...
c.id),(e=this.get_node(c,!0))&&e.length&&e.attr("aria-selected",!1).children(".jstree-anchor").removeClass(m?"jstree-clicked":"jstree-checked");else break;c=this.get_node(c.parent)}},this))};this.get_undetermined=function(a){if(-1===this.settings.checkbox.cascade.indexOf("undetermined"))return[];var c,b,k={},g=this._model.data,m=this.settings.checkbox.tie_selection,f=this._data[m?"core":"checkbox"].selected,w=[],r=this,l=[];var u=0;for(c=f.length;u<c;u++)if(g[f[u]]&&g[f[u]].parents){var n=0;for(b=
g[f[u]].parents.length;n<b&&k[g[f[u]].parents[n]]===q;n++)g[f[u]].parents[n]!==d.jstree.root&&(k[g[f[u]].parents[n]]=!0,w.push(g[f[u]].parents[n]))}this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function(){var a=r.get_node(this);if(a)if(a.state.loaded)for(u=0,c=a.children_d.length;u<c;u++){var e=g[a.children_d[u]];if(!e.state.loaded&&e.original&&e.original.state&&e.original.state.undetermined&&!0===e.original.state.undetermined)for(k[e.id]===q&&e.id!==d.jstree.root&&(k[e.id]=
!0,w.push(e.id)),n=0,b=e.parents.length;n<b;n++)k[e.parents[n]]===q&&e.parents[n]!==d.jstree.root&&(k[e.parents[n]]=!0,w.push(e.parents[n]))}else if(a.original&&a.original.state&&a.original.state.undetermined&&!0===a.original.state.undetermined)for(k[a.id]===q&&a.id!==d.jstree.root&&(k[a.id]=!0,w.push(a.id)),n=0,b=a.parents.length;n<b;n++)k[a.parents[n]]===q&&a.parents[n]!==d.jstree.root&&(k[a.parents[n]]=!0,w.push(a.parents[n]))});u=0;for(c=w.length;u<c;u++)g[w[u]].state[m?"selected":"checked"]||
l.push(a?g[w[u]]:w[u]);return l};this._undetermined=function(){if(null!==this.element){var a=this.get_undetermined(!1),b,d;this.element.find(".jstree-undetermined").removeClass("jstree-undetermined");var k=0;for(b=a.length;k<b;k++)(d=this.get_node(a[k],!0))&&d.length&&d.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined")}};this.redraw_node=function(a,e,h,k){if(a=b.redraw_node.apply(this,arguments)){var c,m=null;var f=0;for(c=a.childNodes.length;f<c;f++)if(a.childNodes[f]&&
a.childNodes[f].className&&-1!==a.childNodes[f].className.indexOf("jstree-anchor")){m=a.childNodes[f];break}m&&(!this.settings.checkbox.tie_selection&&this._model.data[a.id].state.checked&&(m.className+=" jstree-checked"),f=y.cloneNode(!1),this._model.data[a.id].state.checkbox_disabled&&(f.className+=" jstree-checkbox-disabled"),m.insertBefore(f,m.childNodes[0]))}h||-1===this.settings.checkbox.cascade.indexOf("undetermined")||(this._data.checkbox.uto&&clearTimeout(this._data.checkbox.uto),this._data.checkbox.uto=
...
!this.settings.checkbox.cascade_to_hidden&&d.state.hidden){var w=this.get_checked_descendants(a);d.state[c?"selected":"checked"]&&w.push(d.id);e=e.concat(w)}else{if(d.children)for(a=0,f=d.children.length;a<f;a++){var r=d.children[a];w=this._cascade_new_checked_state(r,b);e=e.concat(w);-1<w.indexOf(r)&&m.push(r)}a=this.get_node(d,!0);f=0<m.length&&m.length<d.children.length;d.original&&d.original.state&&d.original.state.undetermined&&(d.original.state.undetermined=f);f?(d.state[c?"selected":"checked"]=
...
c.length&&c.width("");switch(!0){case !m&&!e:return!1;case !!m&&!!e:d=e;h=m.x;k=m.y;break;case !m&&!!e:d=e;m=e.offset();h=m.left+e.outerHeight();k=m.top;break;case !!m&&!e:h=m.x,k=m.y}e&&!l&&a(e).data("vakata_contextmenu")&&(l=a(e).data("vakata_contextmenu"));a.vakata.context._parse(l)&&c.html(f);if(g.length){c.appendTo(t.body);l=c;m=h;var r=k;var n=l.width();var w=l.height();var B=a(window).width()+a(window).scrollLeft();var q=a(window).height()+a(window).scrollTop();b&&(m-=l.outerWidth()-a(e).outerWidth(),
m<a(window).scrollLeft()+20&&(m=a(window).scrollLeft()+20));m+n+20>B&&(m=B-(n+20));r+w+20>q&&(r=q-(w+20));c.css({left:m,top:r}).show().find("a").first().focus().parent().addClass("vakata-context-hover");p=!0;a.vakata.context._trigger("show")}},hide:function(){p&&(c.hide().find("ul").hide().end().find(":focus").blur().end().detach(),p=!1,a.vakata.context._trigger("hide"))}};a(function(){b="rtl"===a(t.body).css("direction");var d=!1;c=a("<ul class='vakata-context'></ul>");c.on("mouseenter","li",function(b){b.stopImmediatePropagation();
...
l.length&&l.parent().is(".jstree-closed, .jstree-open, .jstree-leaf")){r=l.offset();k=(g.event.pageY!==q?g.event.pageY:g.event.originalEvent.pageY)-r.top;var H=l.outerHeight();var D=k<H/3?["b","i","a"]:k>H-H/3?["a","i","b"]:k>H/2?["i","a","b"]:["i","b","a"];d.each(D,function(c,k){switch(k){case "b":n=r.left-6;u=r.top;t=p.get_parent(l);v=l.parent().index();break;case "i":A=p.settings.dnd.inside_pos;z=p.get_node(l.parent());n=r.left-2;u=r.top+H/2+1;t=z.id;v="first"===A?0:"last"===A?z.children.length:
Math.min(A,z.children.length);break;case "a":n=r.left-6,u=r.top+H,t=p.get_parent(l),v=l.parent().index()+1}F=!0;E=0;for(B=g.data.nodes.length;E<B;E++)if(x=g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey))?"copy_node":"move_node",C=v,"move_node"===x&&"a"===k&&g.data.origin&&g.data.origin===p&&t===p.get_parent(g.data.nodes[E])&&(y=p.get_node(t),C>d.inArray(g.data.nodes[E],y.children)&&--C),F=F&&(p&&p.settings&&p.settings.dnd&&
!1===p.settings.dnd.check_while_dragging||p.check(x,g.data.origin&&g.data.origin!==p?g.data.origin.get_node(g.data.nodes[E]):g.data.nodes[E],t,C,{dnd:!0,ref:p.get_node(l.parent()),pos:k,origin:g.data.origin,is_multi:g.data.origin&&g.data.origin!==p,is_foreign:!g.data.origin})),!F){p&&p.last_error&&(b=p.last_error());break}"i"===k&&l.parent().is(".jstree-closed")&&p.settings.dnd.open_timeout&&(!g.event||"dragover"!==g.event.type||f)&&(e&&clearTimeout(e),e=setTimeout(function(a,c){return function(){a.open_node(c)}}(p,
l),p.settings.dnd.open_timeout));if(F)return G=p.get_node(t,!0),G.hasClass(".jstree-dnd-parent")||(d(".jstree-dnd-parent").removeClass("jstree-dnd-parent"),G.addClass("jstree-dnd-parent")),a={ins:p,par:t,pos:"i"!==k||"last"!==A||0!==v||p.is_loaded(z)?v:"last"},h.css({left:n+"px",top:u+"px"}).show(),g.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"),g.event.originalEvent&&g.event.originalEvent.dataTransfer&&(g.event.originalEvent.dataTransfer.dropEffect=I?"copy":"move"),
b={},D=!0,!1});if(!0===D)return}}else{var F=!0;var E=0;for(B=g.data.nodes.length;E<B&&(F=F&&p.check(g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey))?"copy_node":"move_node",g.data.origin&&g.data.origin!==p?g.data.origin.get_node(g.data.nodes[E]):g.data.nodes[E],d.jstree.root,"last",{dnd:!0,ref:p.get_node(d.jstree.root),pos:"i",origin:g.data.origin,is_multi:g.data.origin&&g.data.origin!==p,is_foreign:!g.data.origin}),F);E++);
...
g.data.origin.settings.dnd.copy&&(k.metaKey||k.ctrlKey))?"show":"hide"](),c&&(c.metaKey=k.metaKey,c.ctrlKey=k.ctrlKey,d.vakata.dnd._trigger("move",c))))})});(function(a){a.vakata.html={div:a("<div />"),escape:function(c){return a.vakata.html.div.text(c).html()},strip:function(c){return a.vakata.html.div.empty().append(a.parseHTML(c)).text()}};var b=!1,c=!1,d=!1,h=!1,k=!1,g=0,f=!1,p=0,l=0,r=0,n=0,u=!1,v=!1,x=!1;a.vakata.dnd={settings:{scroll_speed:10,scroll_proximity:20,helper_left:5,helper_top:10,
threshold:5,threshold_touch:10},_trigger:function(c,b,d){d===q&&(d=a.vakata.dnd._get());d.event=b;a(t).triggerHandler("dnd_"+c+".vakata",d)},_get:function(){return{data:f,element:b,helper:k}},_clean:function(){k&&k.remove();v&&(clearInterval(v),v=!1);k=h=d=c=b=!1;g=0;f=!1;n=r=l=p=0;x=v=u=!1;a(t).off("mousemove.vakata.jstree touchmove.vakata.jstree",a.vakata.dnd.drag);a(t).off("mouseup.vakata.jstree touchend.vakata.jstree",a.vakata.dnd.stop)},_scroll:function(c){if(!u||!r&&!n)return v&&(clearInterval(v),
...
b.originalEvent.changedTouches[0].pageY,b.target=t.elementFromPoint(b.originalEvent.changedTouches[0].pageX-window.pageXOffset,b.originalEvent.changedTouches[0].pageY-window.pageYOffset));if(d){if(!h)if(Math.abs(b.pageX-p)>(x?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold)||Math.abs(b.pageY-l)>(x?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold))k&&(k.appendTo(t.body),g=k.outerWidth()),h=!0,a(c).one("click.vakata",!1),a.vakata.dnd._trigger("start",b);else return;
var e=!1,f=!1,m=!1,w=!1,q=!1,B=f=!1,v=!1;w=e=!1;r=n=0;u=!1;a(a(b.target).parentsUntil("body").addBack().get().reverse()).filter(function(){return/^auto|scroll$/.test(a(this).css("overflow"))&&(this.scrollHeight>this.offsetHeight||this.scrollWidth>this.offsetWidth)}).each(function(){var c=a(this),d=c.offset();this.scrollHeight>this.offsetHeight&&(d.top+c.height()-b.pageY<a.vakata.dnd.settings.scroll_proximity&&(n=1),b.pageY-d.top<a.vakata.dnd.settings.scroll_proximity&&(n=-1));this.scrollWidth>this.offsetWidth&&
(d.left+c.width()-b.pageX<a.vakata.dnd.settings.scroll_proximity&&(r=1),b.pageX-d.left<a.vakata.dnd.settings.scroll_proximity&&(r=-1));if(n||r)return u=a(this),!1});!u&&(e=a(t),f=a(window),m=e.height(),w=f.height(),q=e.width(),f=f.width(),B=e.scrollTop(),v=e.scrollLeft(),m>w&&b.pageY-B<a.vakata.dnd.settings.scroll_proximity&&(n=-1),m>w&&w-(b.pageY-B)<a.vakata.dnd.settings.scroll_proximity&&(n=1),q>f&&b.pageX-v<a.vakata.dnd.settings.scroll_proximity&&(r=-1),q>f&&f-(b.pageX-v)<a.vakata.dnd.settings.scroll_proximity&&
(r=1),n||r)&&(u=e);u&&a.vakata.dnd._scroll(!0);k&&(e=parseInt(b.pageY+a.vakata.dnd.settings.helper_top,10),w=parseInt(b.pageX+a.vakata.dnd.settings.helper_left,10),m&&e+25>m&&(e=m-50),q&&w+g>q&&(w=q-(g+2)),k.css({left:w+"px",top:e+"px"}));a.vakata.dnd._trigger("move",b);return!1}},stop:function(b){"touchend"===b.type&&b.originalEvent&&b.originalEvent.changedTouches&&b.originalEvent.changedTouches[0]&&(b.pageX=b.originalEvent.changedTouches[0].pageX,b.pageY=b.originalEvent.changedTouches[0].pageY,
...
!1);if(d.fuzzy){var p=1<<m-1;var l=function(){var a={},c;for(c=0;c<m;c++)a[b.charAt(c)]=0;for(c=0;c<m;c++)a[b.charAt(c)]|=1<<m-c-1;return a}();var n=function(a,b){a/=m;b=Math.abs(e-b);return f?a+b/f:b?1:a}}var t=function(a){a=d.caseSensitive?a:a.toLowerCase();if(b===a||-1!==a.indexOf(b))return{isMatch:!0,score:0};if(!d.fuzzy)return{isMatch:!1,score:1};var c,h=a.length,f=g,k=a.indexOf(b,e),r,w=m+h,t=1,q=[];-1!==k&&(f=Math.min(n(0,k),f),k=a.lastIndexOf(b,e+m),-1!==k&&(f=Math.min(n(0,k),f)));k=-1;for(c=
0;c<m;c++){var v=0;for(r=w;v<r;)n(c,e+r)<=f?v=r:w=r,r=Math.floor((w-v)/2+v);w=r;v=Math.max(1,e-r+1);var u=Math.min(e+r,h)+m;r=Array(u+2);for(r[u+1]=(1<<c)-1;u>=v;u--){var x=l[a.charAt(u-1)];r[u]=0===c?(r[u+1]<<1|1)&x:(r[u+1]<<1|1)&x|(C[u+1]|C[u])<<1|1|C[u+1];if(r[u]&p&&(t=n(c,u-1),t<=f))if(f=t,k=u-1,q.push(k),k>e)v=Math.max(1,2*e-k);else break}if(n(c+1,e)>f)break;var C=r}return{isMatch:0<=k,score:t}};return!0===c?{search:t}:t(c)};a.vakata.search.defaults={location:0,distance:100,threshold:.6,fuzzy:!1,
...
function(a,b){this.check=function(a,e,f,k,g){if(!1===b.check.call(this,a,e,f,k,g))return!1;e=e&&e.id?e:this.get_node(e);f=f&&f.id?f:this.get_node(f);if(!f||!f.children)return!0;var c="rename_node"===a?k:e.text,h=[],l=this.settings.unique.case_sensitive,n=this.settings.unique.trim_whitespace,t=this._model.data,q;var v=0;for(q=f.children.length;v<q;v++){var x=t[f.children[v]].text;l||(x=x.toLowerCase());n&&(x=x.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));h.push(x)}l||(c=c.toLowerCase());n&&(c=
c.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));switch(a){case "rename_node":return x=e.text||"",l||(x=x.toLowerCase()),n&&(x=x.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")),v=-1===d.inArray(c,h)||e.text&&x===c,v||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_01",reason:"Child with name "+c+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:k,obj:e&&e.id?e.id:!1,par:f&&f.id?f.id:!1})}),v;case "create_node":return v=-1===d.inArray(c,h),v||(this._data.core.last_error=
{error:"check",plugin:"unique",id:"unique_04",reason:"Child with name "+c+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:k,obj:e&&e.id?e.id:!1,par:f&&f.id?f.id:!1})}),v;case "copy_node":return v=-1===d.inArray(c,h),v||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_02",reason:"Child with name "+c+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:k,obj:e&&e.id?e.id:!1,par:f&&f.id?f.id:!1})}),v;case "move_node":return v=e.parent===f.id&&(!g||!g.is_multi)||
-1===d.inArray(c,h),v||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_03",reason:"Child with name "+c+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:k,obj:e&&e.id?e.id:!1,par:f&&f.id?f.id:!1})}),v}return!0};this.create_node=function(a,e,f,k,g){if(!e||e.text===q){null===a&&(a=d.jstree.root);a=this.get_node(a);if(!a)return b.create_node.call(this,a,e,f,k,g);f=f===q?"last":f;if(!f.toString().match(/^(before|after)$/)&&!g&&!this.is_loaded(a))return b.create_node.call(this,
a,e,f,k,g);e||(e={});var c,h,l=this._model.data,n=this.settings.unique.case_sensitive,t=this.settings.unique.trim_whitespace,v=this.settings.unique.duplicate;var x=c=this.get_string("New node");var C=[];var A=0;for(h=a.children.length;A<h;A++){var y=l[a.children[A]].text;n||(y=y.toLowerCase());t&&(y=y.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));C.push(y)}A=1;y=x;n||(y=y.toLowerCase());for(t&&(y=y.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));-1!==d.inArray(y,C);)y=x=v.call(this,c,++A).toString(),
n||(y=y.toLowerCase()),t&&(y=y.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));e.text=x}return b.create_node.call(this,a,e,f,k,g)}};var D=t.createElement("DIV");D.setAttribute("unselectable","on");D.setAttribute("role","presentation");D.className="jstree-wholerow";D.innerHTML="&#160;";d.jstree.plugins.wholerow=function(a,b){this.bind=function(){b.bind.call(this);this.element.on("ready.jstree set_state.jstree",d.proxy(function(){this.hide_dots()},this)).on("init.jstree loading.jstree ready.jstree",
...
var v=this.input.val();if(v){v=this._parseSelection(v);var q=this.treeID;d.each(v,function(){d("#"+q+"-"+this).data("jstree",{selected:!0})})}v=l.find("> ul > li");if(1==v.length){v=v.first();var t=v.data("jstree");v.data("jstree",d.extend({},t,{opened:!0}))}v=f.multiple;t=f.leafonly;var y=f.cascade,A=!1,C=null,z=["sort","checkbox"];this.input.data("multiple",v);(y||t)&&v?A=!0:v&&(f.cascadeOptionInTree?this.manualCascadeOption=!0:(C=function(a){return l.jstree("is_parent",a)?(d.vakata.context.settings.icons=
!1,{select_all:{label:n.options.selectAllText,icon:!1,action:function(b){n._selectBranch(a)}},deselect_all:{label:n.options.deselectAllText,icon:!1,action:function(b){n._deselectBranch(a)}}}):null},z.push("contextmenu")));l.jstree({core:{themes:{name:"s3",icons:f.icons,stripes:f.stripes},animation:100,multiple:v,check_callback:!0},checkbox:{three_state:A},sort:function(a,b){var c=this.get_text(a)>this.get_text(b)?1:-1;try{var d=this.get_node(a).li_attr.rel}catch(k){d=null}try{var f=this.get_node(b).li_attr.rel}catch(k){f=
null}return"bulk"==d?-1:"bulk"==f?1:"none"==d?-1:"none"==f?1:c},contextmenu:{items:C,select_node:!1,icons:!1},plugins:z});var D=jQuery.jstree.reference(l);v&&((f.bulkSelect||this.manualCascadeOption)&&f.cascadeOptionInTree?(this.wrapper.find(".s3-hierarchy-header").hide(),D.create_node("#",{id:this.treeID+"-select-all",text:f.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first")):this.wrapper.find(".s3-hierarchy-header").removeClass("hide").show());l.on("ready.jstree",function(){var a=
D.get_checked();n._updateButtonText(a)});this._bindEvents()}else this.button.hide(),this.noopts.show()},_setOption:function(f,l){if("selected"===f){var n=jQuery.jstree.reference(d(this.tree));if(n&&(n.uncheck_all(),l)){this.input.val(this._stringifySelection(l));var v=this.treeID;d.each(l,function(){n.check_node("#"+v+"-"+this)});this._updateButtonText(l)}}this._super(f,l)},_updateSelectedNodes:function(){var f=jQuery.jstree.reference(d(this.tree)),l=this._parseSelection(this.input.val()),n=[],v=
[],q=this.options.leafonly,t=f.get_checked(!0);d(t).each(function(){var l=d(this).attr("id");if("bulk"!=d(this).attr("rel")&&l&&(!q||f.is_leaf(this))){var t=l.split("-").pop();"None"!=t&&(t=parseInt(t));t&&(n.push(t),v.push(l))}});t=!1;var y=d(n).not(l).get();y.length?t=!0:(y=d(l).not(n).get(),y.length&&(t=!0));l=this.input.val(this._stringifySelection(n));this._updateButtonText(v);t&&(l.change(),d(this.element).trigger("select.s3hierarchy"));return!0},_updateButtonText:function(f){var l=this.options,
n=0;f&&(n=f.length);if(n)if(1<n)f=l.selectedText.replace("#",n);else{for(var v=[],q=0;q<n;q++)v.push(d("#"+f[q]+" > a").text().replace(/^\s+|\s+$/g,""));f=v.length?v.join(" "):l.noneSelectedText}else f=l.noneSelectedText;this.buttonText.text(f)},_updateAndClose:function(){if(!this._isBulk){this._updateSelectedNodes();var d=this.wrapper,l=this;if(l.options.multiple)d.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",function(){window.setTimeout(function(){l.closeMenu()},100)});
else window.setTimeout(function(){l.closeMenu()},100)}},_selectNode:function(f){var l=this.options,n=jQuery.jstree.reference(d(this.tree)),q=l.multiple,x=l.leafonly;if(q)this._isBulk||"bulk"!=f.li_attr.rel||((l=n.get_parent(f))&&"#"!=l?(l=n.get_node(l),this._selectBranch(l,!0)):n.select_all());else{var t=f.id;d(n.get_checked(!0)).each(function(){t==this.id||x&&!n.is_leaf(this)||n.uncheck_node(this)})}if(x&&!q&&!n.is_leaf(f))return n.deselect_node(f),!1;this._updateAndClose()},_deselectNode:function(f){var l=
...
!1,!0);if(this.manualCascadeOption){var q=f.id;n=l.get_node(q+"-select-all");n||(f=l.create_node(f,{id:q+"-select-all",text:this.options.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first"),n=l.get_node(f));(f=l.get_node(this.treeID+"-select-all"))&&l.is_checked(f)&&(this._isBulk=!0,l.check_node(n),this._isBulk=!1)}},_selectBranch:function(f,l){var n=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;n.open_node(f,function(){var v=n.get_children_dom(f);d(v).each(function(){q._selectBranch(this)});
l||n.check_node(f)});this._isBulk=!1;this._updateAndClose()},_deselectBranch:function(f,l){var n=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;n.open_node(f,function(){var v=n.get_children_dom(f);d(v).each(function(){q._deselectBranch(this)});l||n.uncheck_node(f)});this._isBulk=!1;this._updateSelectedNodes()},set:function(f){var l=jQuery.jstree.reference(d(this.tree)),n=this.treeID;this._isBulk=!0;l.uncheck_all();l.close_all();if(f){var q=function(d,f){if(d=l.get_parent(d))"#"!=d?(q(d),
...
d(this.wrapper).fadeOut(50);this._isOpen=!1;d(this.button).removeClass("ui-state-active");d(this).trigger("close")},addNode:function(f,l,n,q){var v=this.tree,t=this.treeID,y="#";f&&(y=d("#"+t+"-"+f),y.length||(y="#"));l=t+"-"+l;v.jstree("create_node",y,{id:l,text:n,li_attr:{rel:"leaf"}},"last");f&&(y.attr({rel:"parent"}),v.jstree("open_node",y));q&&v.jstree("check_node",d("#"+l))},_parseSelection:function(d){if(d)d=JSON.parse(d);else return[];d?d.constructor!==Array&&(d=[d]):d=[];return d},_stringifySelection:function(d){if(!this.options.multiple)if(d.length)d=
d[0];else return"";return JSON.stringify(d)},_bindEvents:function(){var f=this,l=d(this.wrapper),n=d(this.tree),q=d(this.button),x=this._namespace,t=this.options,y=jQuery.jstree.reference(n),A=d.vakata.context.settings.icons;d(document).bind("context_show.vakata",function(){l.unbind("mouseleave.hierarchicalopts");d.vakata.context.settings.icons=A});n.bind("select_node.jstree",function(d,l){f._selectNode(l.node)}).bind("deselect_node.jstree",function(d,l){f._deselectNode(l.node)}).bind("open_node.jstree",
function(d,l){f._openNode(l.node)});q.bind("click"+x,function(){f._isOpen?f.closeMenu():f.openMenu()}).bind("keyup"+x,function(d){d.preventDefault();switch(d.keyCode){case 27:case 38:case 37:f.closeMenu();break;case 39:case 40:f.openMenu()}}).bind("mouseenter"+x,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-hover")}).bind("mouseleave"+x,function(){d(this).removeClass("ui-state-hover")}).bind("focus"+x,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-focus")}).bind("blur"+
x,function(){d(this).removeClass("ui-state-focus")});t.multiple&&t.bulkSelect&&!t.cascadeOptionInTree&&(l.find(".s3-hierarchy-select-all").bind("click"+x,function(d){d.preventDefault();y.select_all();f._updateSelectedNodes()}),l.find(".s3-hierarchy-deselect-all").bind("click"+x,function(d){d.preventDefault();y.deselect_all();f._updateSelectedNodes()}),l.find(".s3-hierarchy-header").bind("click"+x,function(d){d.preventDefault();d.stopPropagation()}).bind("mousedown"+x,function(d){d.preventDefault();
d.stopPropagation()}));d(document).bind("mousedown"+x,function(t){var v=t.target;if(d(".jstree-contextmenu").has(v).length||3==t.which)return l.unbind("mouseleave.hierarchicalopts"),!0;n.is(v)||q.is(v)||0!==n.has(v).length||0!==q.has(v).length||f.closeMenu()});return!0},_unbindEvents:function(){var f=d(this.tree);d(this.button);var l=this._namespace;f.unbind("select_node.jstree").unbind("deselect_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");d(this.button).unbind(l);d(document).unbind(l);
return!0}})})(jQuery);
(function(d,q){var z=0;d.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,deleteRoot:!0,addTitle:"Add Record",addLabel:"Add",addURL:null,icons:!1,stripes:!0,htmlTitles:!0},_create:function(){this.treeID=d(this.element).attr("id")+"-tree";this.id=z;z+=1},_init:function(){this.tree=d(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){d.Widget.prototype.destroy.call(this)},refresh:function(){var f=
this.tree,l=this.options;this._unbindEvents();var n=f.find("> ul > li");if(1==n.length){n=n.first();var q=n.data("jstree");n.data("jstree",d.extend({},q,{opened:!0}))}var x=this;f.jstree({core:{themes:{name:"s3",icons:l.icons,stripes:l.stripes},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(d){var n=!0;"#"==f.jstree(!0).get_parent(d)&&(n=l.deleteRoot);var q={open:{label:x.options.openLabel,action:function(f){x._openNode(d)},separator_after:!0}};l.editURL&&(q.edit={label:x.options.editLabel,
action:function(f){x._editNode(d)}});n&&l.deleteURL&&(q.delete={label:x.options.deleteLabel,separator_after:!0,action:function(f){x._deleteNode(d)}});l.addURL&&(q.add={label:x.options.addLabel,action:function(f){x._addNode(d)}});return q},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},_openNode:function(d){var f=this.options.openURL;d=d.id;f&&d&&(d=parseInt(d.split("-").pop()))&&(f=f.replace("[id]",d).replace("%5Bid%5D",d),window.location.href=f)},refreshNode:function(f){var l=
this.options.ajaxURL,n=f.attr("id");if(l&&n&&(n=parseInt(n.split("-").pop()))){var q=this.tree,x=this.treeID;d.getJSONS3(l+"?node="+n,function(d){d.label&&q.jstree("rename_node",f,d.label);if(d=d.children){q.jstree("open_node",f,!1,!1);for(var l,n,t,v=0,z=0,a=d.length;z<a;z++)l=d[z],n=x+"-"+l.node,(t=q.jstree("get_node","#"+n,!0))?q.jstree("rename_node",t,l.label):(q.jstree("create_node",f,{id:n,text:l.label,li_attr:{rel:"leaf"}}),v++);v&&(q.jstree("open_node",f),f.attr({rel:"parent"}))}})}},_editNode:function(f){var l=
...
n).split("?")[0],d.ajaxS3({type:"POST",url:l+"?recursive=1",data:{},dataType:"JSON",success:function(d){q.jstree("delete_node",f)},error:function(d,f,l){f=d.responseText;if("{"==f[0])try{f=JSON.parse(d.responseText),S3.showAlert(f.message,"error")}catch(A){}}}))},_openPopup:function(f,l){f.dialog({close:function(d,l){if(self.parent){var n=self.parent.$("iframe.ui-dialog-content"),q=n.width();n.width(0);window.setTimeout(function(){n.width(q)},300)}f.remove()},minHeight:480,modal:!0,open:function(l,
