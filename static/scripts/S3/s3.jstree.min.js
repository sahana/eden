...
*/
(function(){if(!jQuery||!jQuery.jstree){var m=!1,t=!1,s=!1;(function(b){b.vakata={};b.vakata.css={get_css:function(a,b,c){a=a.toLowerCase();var e=c.cssRules||c.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==a)return!0===b?(c.removeRule&&c.removeRule(d),c.deleteRule&&c.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,c){if(b.jstree.css.get_css(a,!1,c))return!1;c.insertRule?c.insertRule(a+" { }",0):c.addRule(a,null,0);return b.vakata.css.get_css(a)},
...
b.call(),!1;var e=c||m?0:this._get_settings().core.animation,d=this;this._is_loaded(a)?(this._get_settings().core.open_parents&&a.parentsUntil(".jstree",".jstree-closed").each(function(){d.open_node(this,!1,!0)}),e&&a.children("ul").css("display","none"),a.removeClass("jstree-closed").addClass("jstree-open").children("a").removeClass("jstree-loading"),e?a.children("ul").stop(!0,!0).slideDown(e,function(){this.style.display="";d.after_open(a)}):d.after_open(a),this.__callback({obj:a}),b&&b.call()):
(a.children("a").addClass("jstree-loading"),this.load_node(a,function(){d.open_node(a,b,c)},b))},after_open:function(a){this.__callback({obj:a})},close_node:function(a,b){a=this._get_node(a);var c=b||m?0:this._get_settings().core.animation,e=this;if(!a.length||!a.hasClass("jstree-open"))return!1;c&&a.children("ul").attr("style","display:block !important");a.removeClass("jstree-open").addClass("jstree-closed");c?a.children("ul").stop(!0,!0).slideUp(c,function(){this.style.display="";e.after_close(a)}):
...
p.length?p.before(k):a.children("ul").append(k),p=a}if(-1===p||p.get(0)===this.get_container().get(0))p=-1;this.clean_node(p);this.__callback({obj:k,parent:p});d&&d.call(this,k);return k},get_text:function(a){a=this._get_node(a);if(!a.length)return!1;var c=this._get_settings().core.html_titles;a=a.children("a:eq(0)");return c?(a=a.clone(),a.children("INS").remove(),a.html()):(a=a.contents().filter(function(){return 3==this.nodeType}))?a[0].nodeValue:""},set_text:function(a,c){a=this._get_node(a);
...
h=l&&l.length?l.children("ul").find("a.jstree-clicked"):b(),n=this;!1!==d.selected_parent_close&&h.length&&h.each(function(){n.deselect_node(this);"select_parent"===d.selected_parent_close&&n.select_node(l)})},this)).bind("delete_node.jstree",b.proxy(function(a,c){var b=this._get_settings().ui.select_prev_on_delete,d=this._get_node(c.rslt.obj),d=d&&d.length?d.find("a.jstree-clicked"):[],h=this;d.each(function(){h.deselect_node(this)});b&&d.length&&c.rslt.prev.each(function(){if(this.parentNode)return h.select_node(this),
...
b(function(){b.vakata.css.add_sheet({str:".jstree .jstree-real-checkbox { display:none; } ",title:"jstree"})})})(jQuery);(function(b){b.vakata.xslt=function(a,c,f){var g=!1,l,h,n;if(!1===g&&window.ActiveXObject)try{g=new ActiveXObject("Msxml2.XSLTemplate"),h=new ActiveXObject("Msxml2.DOMDocument"),h.loadXML(a),n=new ActiveXObject("Msxml2.FreeThreadedDOMDocument"),n.loadXML(c),g.stylesheet=n,l=g.createProcessor(),l.input=h,l.transform(),g=l.output}catch(k){}a=b.parseXML(a);c=b.parseXML(c);!1===g&&
...
h&&h.call(this,b,c,e);-1!==a&&a.length?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),"success"===c&&g.correct_state&&this.correct_state(a)):"success"===c&&g.correct_state&&this.get_container().children("ul").empty();f&&f.call(this)},h=function(f,h,m){f=m.responseText;var p=this.get_settings().xml_data.ajax.success;p&&(f=p.call(this,f,h,m)||f);if(""===f||f&&f.toString&&""===f.toString().replace(/^[\s\n]+$/,""))return l.call(this,m,h,"");this.parse_xml(f,
b.proxy(function(f){f&&(f=f.replace(/ ?xmlns="[^"]*"/ig,""),10<f.length?(f=b(f),-1!==a&&a?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.append(f),a.removeData("jstree_is_loading")):this.get_container().children("ul").empty().append(f.children()),g.clean_node&&this.clean_node(a),c&&c.call(this)):a&&-1!==a?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),g.correct_state&&(this.correct_state(a),c&&c.call(this))):g.correct_state&&(this.get_container().children("ul").empty(),
c&&c.call(this)))},this))},g.ajax.context=this,g.ajax.error=l,g.ajax.success=h,g.ajax.dataType||(g.ajax.dataType="xml"),b.isFunction(g.ajax.url)&&(g.ajax.url=g.ajax.url.call(this,a)),b.isFunction(g.ajax.data)&&(g.ajax.data=g.ajax.data.call(this,a)),b.ajax(g.ajax)}},parse_xml:function(c,e){var f=this._get_settings().xml_data;b.vakata.xslt(c,a[f.xsl],e)},get_xml:function(a,e,f,g,l){var h="",n=this._get_settings(),k=this,m,p,q,s,t;a||(a="flat");l||(l=0);(e=this._get_node(e))&&-1!==e||(e=this.get_container().find("> ul > li"));
f=b.isArray(f)?f:["id","class"];!l&&this.data.types&&-1===b.inArray(n.types.type_attr,f)&&f.push(n.types.type_attr);g=b.isArray(g)?g:[];l||(n.xml_data.get_include_preamble&&(h+='<?xml version="1.0" encoding="UTF-8"?>'),h+="<root>");e.each(function(){h+="<item";q=b(this);b.each(f,function(a,b){var d=q.attr(b);n.xml_data.get_skip_empty&&"undefined"===typeof d||(h+=" "+b+'="'+c((" "+(d||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))+'"')});q.hasClass("jstree-open")&&
(h+=' state="open"');q.hasClass("jstree-closed")&&(h+=' state="closed"');"flat"===a&&(h+=' parent_id="'+c(l)+'"');h+=">";h+="<content>";s=q.children("a");s.each(function(){m=b(this);t=!1;h+="<name";-1!==b.inArray("languages",n.plugins)&&b.each(n.languages,function(a,b){if(m.hasClass(b))return h+=' lang="'+c(b)+'"',t=b,!1});g.length&&b.each(g,function(a,b){var d=m.attr(b);n.xml_data.get_skip_empty&&"undefined"===typeof d||(h+=" "+b+'="'+c((" "+d||"").replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))+'"')});m.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(h+=' icon="'+c(m.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))+'"');m.children("ins").get(0).style.backgroundImage.length&&(h+=' icon="'+c(m.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","").replace(/'/ig,"").replace(/"/ig,""))+'"');h+=">";h+="<![CDATA["+k.get_text(m,t)+"]]\x3e";
h+="</name>"});h+="</content>";p=q[0].id||!0;q=q.find("> ul > li");p=q.length?k.get_xml(a,q,f,g,p):"";"nest"==a&&(h+=p);h+="</item>";"flat"==a&&(h+=p)});l||(h+="</root>");return h}}})})(jQuery);(function(b){8<=b().jquery.split(".")[1]?(b.expr[":"].jstree_contains=b.expr.createPseudo(function(a){return function(b){return 0<=(b.textContent||b.innerText||"").toLowerCase().indexOf(a.toLowerCase())}}),b.expr[":"].jstree_title_contains=b.expr.createPseudo(function(a){return function(b){return 0<=(b.getAttribute("title")||
...
g+a.o.length>d))return!1;if(-2!==c.max_depth&&-1!==e){l=0;if(0===e)return!1;if("undefined"===typeof a.o.d){for(c=a.o;0<c.length;)c=c.find("> ul > li"),l++;a.o.d=l}if(0>e-a.o.d)return!1}return!0},create_node:function(a,c,d,e,f,g){if(!g&&(f||this._is_loaded(a))){var l="string"==typeof c&&c.match(/^before|after$/i)&&-1!==a?this._get_parent(a):this._get_node(a),h=this._get_settings().types,n=this._check("max_children",l),k=this._check("max_depth",l),m=this._check("valid_children",l);"string"===typeof d&&
(d={data:d});d||(d={});if("none"===m)return!1;if(b.isArray(m))if(!d.attr||!d.attr[h.type_attr])d.attr||(d.attr={}),d.attr[h.type_attr]=m[0];else if(-1===b.inArray(d.attr[h.type_attr],m))return!1;if(-2!==h.max_children&&-1!==n&&(l=-1===l?this.get_container().find("> ul > li").length:l.find("> ul > li").length,l+1>n)||-2!==h.max_depth&&-1!==k&&0>k-1)return!1}return this.__call_old(!0,a,c,d,e,f,g)}}})})(jQuery);(function(b){b.jstree.plugin("html_data",{__init:function(){this.data.html_data.original_container_html=
...
s&&(a+=".jstree .jstree-wholerow a { display:block; height:18px; margin:0; padding:0; border:0; } .jstree .jstree-wholerow-real a { border-color:transparent !important; } ");if(t||m)a+=".jstree .jstree-wholerow, .jstree .jstree-wholerow li, .jstree .jstree-wholerow ul, .jstree .jstree-wholerow a { margin:0; padding:0; line-height:18px; } .jstree .jstree-wholerow a { display:block; height:18px; line-height:18px; overflow:hidden; } ";b.vakata.css.add_sheet({str:a,title:"jstree"})})})(jQuery);(function(b){var a=
...
(function(m,t){var s=0;m.widget("s3.hierarchicalopts",{options:{selected:null,noneSelectedText:"Select",selectedText:"selected",noOptionsText:"No options available",multiple:!0,leafonly:!0,themesFolder:"static/styles/jstree",theme:"default",htmlTitles:!0},_create:function(){var b=m(this.element),a=this.options;this.id=s;s+=1;this._namespace=".hierarchicalopts"+s;this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.button=m('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></button>');
this.buttonText=m("<span>"+a.noneSelectedText+"</span>").appendTo(this.button);this.noopts=m('<span class="no-options-available">'+a.noOptionsText+"</span>").hide();this.tree=b.find(".s3-hierarchy-tree").first().hide().before(this.noopts).before(this.button).detach().appendTo("body");this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){m.Widget.prototype.destroy.call(this);this._unbindEvents();m(this.button).remove();m(this.noopts).remove();m(this.tree).detach().appendTo(this.element).show()},
refresh:function(){this._unbindEvents();var b=this.options;if(this.tree.find("li").length){this.noopts.hide();this.button.show();var a=[],c=b.selected;if(c){for(var d=this.treeID,e=0,f=c.length;e<f;e++)a.push(d+"-"+c[e]);this._updateButtonText(a)}m.jstree._themes=S3.Ap.concat("/",b.themesFolder,"/");"ltr"==m("body").css("direction")?(c=!1,d=b.theme):(c=!0,d=b.theme+"-rtl");var e=b.multiple,g=b.leafonly;this.tree.jstree({core:{check_callback:!0,animation:100,rtl:c,html_titles:b.htmlTitles},themes:{theme:d,
icons:!1},ui:{select_limit:e?-1:1,select_multiple_modifier:"on",initially_select:a},checkbox:{override_ui:!0,two_state:!g},plugins:["themes","html_data","ui","sort","checkbox"]});if(!e){var b=this.tree,l=jQuery.jstree._reference(b);b.bind("check_node.jstree",function(a,b){var c=b.rslt.obj.attr("id");l.get_checked(null,!0).each(function(){c!=this.id&&(g&&!l.is_leaf("#"+this.id)||l.uncheck_node("#"+this.id))})})}this._bindEvents()}else this.button.hide(),this.noopts.show()},_updateSelectedNodes:function(){var b=
this.input.val(),b=b?JSON.parse(b):[],a=this.tree,c=[],d=[],e=this.options.leafonly,f=a.jstree("get_checked",null,!0);m(f).each(function(){var b=m(this).attr("id");if(b&&(!e||a.jstree("is_leaf",this))){var f=parseInt(b.split("-").pop());f&&(c.push(f),d.push(b))}});var f=!1,g=m(c).not(b).get();g.length?f=!0:(g=m(b).not(c).get(),g.length&&(f=!0));this.input.val(JSON.stringify(c));this._updateButtonText(d);f&&m(this.element).trigger("select.s3hierarchy");return!0},_updateButtonText:function(b){var a=
null,a=this.options;if(numSelected=b?b.length:0)if(1<numSelected)a=a.selectedText.replace("#",numSelected);else{for(var c=[],d=0;d<numSelected;d++)c.push(m("#"+b[d]+" > a").text().replace(/^\s+|\s+$/g,""));a=c.length?c.join(" "):a.noneSelectedText}else a=a.noneSelectedText;this.buttonText.text(a)},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=m("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?JSON.parse(b):
[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},openMenu:function(){this._isOpen&&this.closeMenu();var b=m(this.tree),a=m(this.button),c=a.offset();b.css({position:"absolute",top:c.top+a.outerHeight(),left:c.left,minWidth:a.outerWidth()-8,"z-index":999999}).show().jstree("set_focus");this._isOpen=!0;a.addClass("ui-state-active");var d=this;b.one("click.hierarchicalopts",function(){m(this).one("mouseleave.hierarchicalopts",function(){d.closeMenu()})});m(this).trigger("open")},
closeMenu:function(){m(this.tree).hide().jstree("unset_focus").unbind("click.hierarchicalopts").unbind("mouseleave.hierarchicalopts");this._isOpen=!1;m(this.button).removeClass("ui-state-active");m(this).trigger("close")},addNode:function(b,a,c,d){var e=this.tree,f=this.treeID,g=b?"#"+f+"-"+b:-1;a=f+"-"+a;e.jstree("create_node",g,"last",{data:c,attr:{id:a,rel:"leaf"}},!1,!1);b&&(m(g).attr({rel:"parent"}),e.jstree("open_node",g));d&&e.jstree("check_node","#"+a)},_bindEvents:function(){var b=this,a=
m(this.tree),c=m(this.button),d=this._namespace;a.bind("check_node.jstree",function(a,c){b._updateSelectedNodes();b.options.multiple||b.closeMenu()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("open_node.jstree",function(a,b){b.inst._get_parent(b.rslt.obj).length&&b.inst.open_node(b.inst._get_parent(b.rslt.obj),!1,!0)});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();
break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||m(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){m(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||m(this).addClass("ui-state-focus")}).bind("blur"+d,function(){m(this).removeClass("ui-state-focus")});m(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length||
b.closeMenu()});return!0},_unbindEvents:function(){var b=m(this.tree);m(this.button);var a=this._namespace;b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");m(this.button).unbind(a);m(document).unbind(a);return!0}})})(jQuery);
