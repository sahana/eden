...
this.id&&(g&&!l.is_leaf("#"+this.id)||l.uncheck_node("#"+this.id))})})}this._bindEvents()},_updateSelectedNodes:function(b){b=this.input.val();var a=[],c;b=b?JSON.parse(b):[];var d=this.tree,e=this.options,f=d.jstree("get_checked",null,!0);n(f).each(function(){var b=n(this).attr("id"),f=e.leafonly;b&&(!f||d.jstree("is_leaf",this))&&(f=parseInt(b.split("-").pop()))&&(a.push(f),c=b)});var f=!1,g=n(a).not(b).get();g.length?f=!0:(g=n(b).not(a).get(),g.length&&(f=!0));this.input.val(JSON.stringify(a));
this._updateButtonText(a,c);f&&n(this.element).trigger("select.s3hierarchy");return!0},_updateButtonText:function(b,a){var c=null,d=this.options;!d.multiple&&a&&(c=n("#"+a).text().replace(/^\s+|\s+$/g,""));c||(c=(c=b?b.length:0)?d.selectedText.replace("#",c):d.noneSelectedText);this.buttonText.text(c)},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=n("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?
JSON.parse(b):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},open:function(){this._isOpen&&this._close();var b=n(this.button),a=b.position();n(this.tree).css({position:"absolute",top:a.top+b.outerHeight()+3,left:a.left,minWidth:b.outerWidth(),"z-index":999999}).show();this._isOpen=!0;b.addClass("ui-state-active");n(this).trigger("open")},close:function(){n(this.tree).hide();this._isOpen=!1;n(this.button).removeClass("ui-state-active");n(this).trigger("close")},_bindEvents:function(){var b=
this,a=n(this.tree),c=n(this.button),d=this._namespace;a.bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()});b.options.leafonly&&!b.options.multiple&&a.bind("loaded.jstree",function(b,c){a.find(' li[rel="parent"] > a > ins.jstree-checkbox').css({display:"none"})});c.bind("click"+d,function(){b._isOpen?b.close():b.open()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.close();
break;case 39:case 40:b.open()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){n(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-focus")}).bind("blur"+d,function(){n(this).removeClass("ui-state-focus")});n(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||(c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length)||
b.close()});return!0},_unbindEvents:function(){var b=n(this.tree);n(this.button);var a=this._namespace;b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree");n(this.button).unbind(a);n(document).unbind(a);return!0}})})(jQuery);
