...
(function(n,t){var s=0;n.widget("s3.hierarchicalopts",{options:{selected:null,hint:"Select"},_create:function(){var b=n(this.element),a=this.options.hint;this.id=s;s+=1;this._namespace=".hierarchicalopts"+s;this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.button=n('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span><span>'+a+"</span></button>");this.tree=b.find(".s3-hierarchy-tree").first().hide().before(this.button);
this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){n.Widget.prototype.destroy.call(this);this._unbindEvents();n(this.button).remove();n(this.tree).show()},refresh:function(){this._unbindEvents();var b=[],a=this.options.selected;if(a)for(var c=this.treeID,d=0,e=a.length;d<e;d++)b.push(c+"-"+a[d]);n.jstree._themes=S3.Ap.concat("/static/styles/jstree/");theme=(rtl="ltr"==n("body").css("direction")?!1:!0)?"default-rtl":"default";this.tree.jstree({core:{animation:100,rtl:rtl},themes:{theme:theme,
icons:!1},ui:{initially_select:b},checkbox:{override_ui:!0},plugins:["themes","html_data","ui","checkbox","sort"]});this._bindEvents()},_updateSelectedNodes:function(b){b=this.input.val();var a=[];b=b?JSON.parse(b):[];var c=this.tree.jstree("get_checked",null,!0);n(c).each(function(){var b=n(this).attr("id");b&&(b=parseInt(b.split("-").pop()))&&a.push(b)});var c=!1,d=n(a).not(b).get();d.length?c=!0:(d=n(b).not(a).get(),d.length&&(c=!0));this.input.val(JSON.stringify(a));c&&n(this.element).trigger("select.s3hierarchy");
return!0},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=n("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?JSON.parse(b):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},open:function(){this._isOpen&&this._close();var b=n(this.button),a=b.position();n(this.tree).css({position:"absolute",top:a.top+b.outerHeight()+3,left:a.left,minWidth:b.outerWidth(),"z-index":999999}).show();
this._isOpen=!0;b.addClass("ui-state-active");n(this).trigger("open")},close:function(){n(this.tree).hide();this._isOpen=!1;n(this.button).removeClass("ui-state-active");n(this).trigger("close")},_bindEvents:function(){var b=this,a=n(this.tree),c=n(this.button),d=this._namespace;a.bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()});c.bind("click"+d,function(){b._isOpen?b.close():b.open()}).bind("keyup"+d,function(a){a.preventDefault();
switch(a.keyCode){case 27:case 38:case 37:b.close();break;case 39:case 40:b.open()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){n(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-focus")}).bind("blur"+d,function(){n(this).removeClass("ui-state-focus")});n(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||(c.is(f)||0!==a.has(d.target).length||
0!==c.has(d.target).length)||b.close()});return!0},_unbindEvents:function(){var b=n(this.tree);n(this.button);var a=this._namespace;b.unbind("check_node.jstree").unbind("uncheck_node.jstree");n(this.button).unbind(a);n(document).unbind(a);return!0}})})(jQuery);
