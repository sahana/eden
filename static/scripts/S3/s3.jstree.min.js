...
*/
var $jscomp={scope:{},findInternal:function(d,t,w){d instanceof String&&(d=String(d));for(var g=d.length,l=0;l<g;l++){var p=d[l];if(t.call(w,p,l,d))return{i:l,v:p}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(d,t,w){if(w.get||w.set)throw new TypeError("ES3 does not support getters and setters.");d!=Array.prototype&&d!=Object.prototype&&(d[t]=w.value)};
$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(d,t,w,g){if(t){w=$jscomp.global;d=d.split(".");for(g=0;g<d.length-1;g++){var l=d[g];l in w||(w[l]={});w=w[l]}d=d[d.length-1];g=w[d];t=t(g);t!=g&&null!=t&&$jscomp.defineProperty(w,d,{configurable:!0,writable:!0,value:t})}};
$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(d,w){return $jscomp.findInternal(this,d,w).v}},"es6-impl","es3");
(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):"object"===typeof exports?d(require("jquery")):d(jQuery)})(function(d,t){if(!d.jstree){var w=0,g=!1,l=!1,p=!1,q=[],u=d("script:last").attr("src"),x=document,y=x.createElement("LI"),B;y.setAttribute("role","treeitem");B=x.createElement("I");B.className="jstree-icon jstree-ocl";B.setAttribute("role","presentation");y.appendChild(B);B=x.createElement("A");B.className="jstree-anchor";B.setAttribute("href","#");B.setAttribute("tabindex",
"-1");x=x.createElement("I");x.className="jstree-icon jstree-themeicon";x.setAttribute("role","presentation");B.appendChild(x);y.appendChild(B);B=x=null;d.jstree={version:"3.0.9",defaults:{plugins:[]},plugins:{},path:u&&-1!==u.indexOf("/")?u.replace(/\/[^\/]+$/,""):"",idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g};d.jstree.create=function(a,c){var b=new d.jstree.core(++w),f=c;c=d.extend(!0,{},d.jstree.defaults,c);f&&f.plugins&&(c.plugins=f.plugins);d.each(c.plugins,function(a,f){"core"!==a&&
...
this.is_parent(a)&&!a.state.opened},is_leaf:function(a){return!this.is_parent(a)},load_node:function(a,c){var b,f,e,k,h;if(d.isArray(a))return this._load_nodes(a.slice(),c),!0;a=this.get_node(a);if(!a)return c&&c.call(this,a,!1),!1;if(a.state.loaded){a.state.loaded=!1;b=0;for(f=a.children_d.length;b<f;b++){e=0;for(k=a.parents.length;e<k;e++)this._model.data[a.parents[e]].children_d=d.vakata.array_remove_item(this._model.data[a.parents[e]].children_d,a.children_d[b]);this._model.data[a.children_d[b]].state.selected&&
(h=!0,this._data.core.selected=d.vakata.array_remove_item(this._data.core.selected,a.children_d[b]));delete this._model.data[a.children_d[b]]}a.children=[];a.children_d=[];h&&this.trigger("changed",{action:"load_node",node:a,selected:this._data.core.selected})}a.state.loading=!0;this.get_node(a,!0).addClass("jstree-loading").attr("aria-busy",!0);this._load_node(a,d.proxy(function(b){a=this._model.data[a.id];a.state.loading=!1;a.state.loaded=b;var e=this.get_node(a,!0);a.state.loaded&&!a.children.length&&
e&&e.length&&!e.hasClass("jstree-leaf")&&e.removeClass("jstree-closed jstree-open").addClass("jstree-leaf");e.removeClass("jstree-loading").attr("aria-busy",!1);this.trigger("load_node",{node:a,status:b});c&&c.call(this,a,b)},this));return!0},_load_nodes:function(a,c,b){var f=!0,e=function(){this._load_nodes(a,c,!0)},d=this._model.data,h,v;h=0;for(v=a.length;h<v;h++)!d[a[h]]||d[a[h]].state.loaded&&b||(this.is_loading(a[h])||this.load_node(a[h],e),f=!1);f&&c&&!c.done&&(c.call(this,a),c.done=!0)},load_all:function(a,
c){a||(a="#");a=this.get_node(a);if(!a)return!1;var b=[],f=this._model.data,e=f[a.id].children_d,d,h;a.state&&!a.state.loaded&&b.push(a.id);d=0;for(h=e.length;d<h;d++)f[e[d]]&&f[e[d]].state&&!f[e[d]].state.loaded&&b.push(e[d]);b.length?this._load_nodes(b,function(){this.load_all(a,c)}):(c&&c.call(this,a),this.trigger("load_all",{node:a}))},_load_node:function(a,c){var b=this.settings.core.data;if(!b)return"#"===a.id?this._append_html_data(a,this._data.core.original_container_html.clone(!0),function(a){c.call(this,
...
x(r[e.children[d]],e.id,c),n=r[m],e.children_d.push(m),n.children_d.length&&(e.children_d=e.children_d.concat(n.children_d));delete a.data;delete a.children;r[e.id].original=a;e.state.selected&&h.push(e.id);return e.id},t=function(a,e,c){c=c?c.concat():[];e&&c.unshift(e);var f,d,n,g;do f="j"+m+"_"+ ++v;while(r[f]);e={id:!1,text:"string"===typeof a?a:"",icon:"object"===typeof a&&a.icon!==b?a.icon:!0,parent:e,parents:c,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};
...
a.li_attr[d]);e.li_attr.id&&!e.id&&(e.id=e.li_attr.id.toString());e.id||(e.id=f);e.li_attr.id||(e.li_attr.id=e.id);if(a&&"object"===typeof a.a_attr)for(d in a.a_attr)a.a_attr.hasOwnProperty(d)&&(e.a_attr[d]=a.a_attr[d]);if(a&&a.children&&a.children.length){d=0;for(f=a.children.length;d<f;d++)n=t(a.children[d],e.id,c),g=r[n],e.children.push(n),g.children_d.length&&(e.children_d=e.children_d.concat(g.children_d));e.children_d=e.children_d.concat(e.children)}a&&a.children&&!0===a.children&&(e.state.loaded=
!1,e.children=[],e.children_d=[]);delete a.data;delete a.children;e.original=a;r[e.id]=e;e.state.selected&&h.push(e.id);return e.id};if(e.length&&e[0].id!==b&&e[0].parent!==b){q=0;for(u=e.length;q<u;q++)e[q].children||(e[q].children=[]),r[e[q].id.toString()]=e[q];q=0;for(u=e.length;q<u;q++)r[e[q].parent.toString()].children.push(e[q].id.toString()),g.children_d.push(e[q].id.toString());q=0;for(u=g.children.length;q<u;q++)p=x(r[g.children[q]],c,g.parents.concat()),d.push(p),r[p].children_d.length&&
(d=d.concat(r[p].children_d))}else{q=0;for(u=e.length;q<u;q++)if(p=t(e[q],c,g.parents.concat()))f.push(p),d.push(p),r[p].children_d.length&&(d=d.concat(r[p].children_d));g.children=f;g.children_d=d}q=0;for(u=g.parents.length;q<u;q++)r[g.parents[q]].children_d=r[g.parents[q]].children_d.concat(d);e={cnt:v,mod:r,sel:l,par:c,dpc:d,add:h};if("undefined"===typeof window||"undefined"===typeof window.document)postMessage(e);else return e},v=function(a,e){this._cnt=a.cnt;this._model.data=a.mod;if(e){var c,
f,h=a.add,k=a.sel,m=this._data.core.selected.slice(),v=this._model.data;if(k.length!==m.length||d.vakata.array_unique(k.concat(m)).length!==k.length){c=0;for(f=k.length;c<f;c++)-1===d.inArray(k[c],h)&&-1===d.inArray(k[c],m)&&(v[k[c]].state.selected=!1);c=0;for(f=m.length;c<f;c++)-1===d.inArray(m[c],k)&&(v[m[c]].state.selected=!0)}}a.add.length&&(this._data.core.selected=this._data.core.selected.concat(a.add));this.trigger("model",{nodes:a.dpc,parent:a.par});"#"!==a.par?(this._node_changed(a.par),
this.redraw()):this.redraw(!0);a.add.length&&this.trigger("changed",{action:"model",selected:this._data.core.selected});b.call(this,!0)};if(this.settings.core.worker&&window.Blob&&window.URL&&window.Worker)try{null===this._wrk&&(this._wrk=window.URL.createObjectURL(new window.Blob(["self.onmessage = "+h.toString()],{type:"text/javascript"}))),!this._data.core.working||f?(this._data.core.working=!0,e=new window.Worker(this._wrk),e.onmessage=d.proxy(function(a){v.call(this,a.data,!0);try{e.terminate(),
e=null}catch(r){}this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):this._data.core.working=!1},this),k.par?e.postMessage(k):this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):this._data.core.working=!1):this._data.core.worker_queue.push([a,c,b,!0])}catch(m){v.call(this,h(k),!1),this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):
this._data.core.working=!1}else v.call(this,h(k),!1)},_parse_model_from_html:function(a,c,b){b=b?[].concat(b):[];c&&b.unshift(c);var f,e,k=this._model.data,h={id:!1,text:!1,icon:!0,parent:c,parents:b,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1},v;for(v in this._model.default_state)this._model.default_state.hasOwnProperty(v)&&(h.state[v]=this._model.default_state[v]);c=d.vakata.attributes(a,!0);d.each(c,function(a,b){b=d.trim(b);if(!b.length)return!0;
h.li_attr[a]=b;"id"===a&&(h.id=b.toString())});c=a.children("a").first();c.length&&(c=d.vakata.attributes(c,!0),d.each(c,function(a,b){b=d.trim(b);b.length&&(h.a_attr[a]=b)}));c=a.children("a").first().length?a.children("a").first().clone():a.clone();c.children("ins, i, ul").remove();c=c.html();c=d("<div />").html(c);h.text=this.settings.core.force_text?c.text():c.html();c=a.data();h.data=c?d.extend(!0,{},c):null;h.state.opened=a.hasClass("jstree-open");h.state.selected=a.children("a").hasClass("jstree-clicked");
h.state.disabled=a.children("a").hasClass("jstree-disabled");if(h.data&&h.data.jstree)for(v in h.data.jstree)h.data.jstree.hasOwnProperty(v)&&(h.state[v]=h.data.jstree[v]);c=a.children("a").children(".jstree-themeicon");c.length&&(h.icon=c.hasClass("jstree-themeicon-hidden")?!1:c.attr("rel"));h.state.icon&&(h.icon=h.state.icon);c=a.children("ul").children("li");do v="j"+this._id+"_"+ ++this._cnt;while(k[v]);h.id=h.li_attr.id?h.li_attr.id.toString():v;c.length?(c.each(d.proxy(function(a,c){f=this._parse_model_from_html(d(c),
h.id,b);e=this._model.data[f];h.children.push(f);e.children_d.length&&(h.children_d=h.children_d.concat(e.children_d))},this)),h.children_d=h.children_d.concat(h.children)):a.hasClass("jstree-closed")&&(h.state.loaded=!1);h.li_attr["class"]&&(h.li_attr["class"]=h.li_attr["class"].replace("jstree-closed","").replace("jstree-open",""));h.a_attr["class"]&&(h.a_attr["class"]=h.a_attr["class"].replace("jstree-clicked","").replace("jstree-disabled",""));k[h.id]=h;h.state.selected&&this._data.core.selected.push(h.id);
return h.id},_parse_model_from_flat_json:function(a,c,b){b=b?b.concat():[];c&&b.unshift(c);var f=a.id.toString(),e=this._model.data,d=this._model.default_state,h,v;c={id:f,text:a.text||"",icon:a.icon!==t?a.icon:!0,parent:c,parents:b,children:a.children||[],children_d:a.children_d||[],data:a.data,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(h in d)d.hasOwnProperty(h)&&(c.state[h]=d[h]);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(c.icon=a.data.jstree.icon);if(a&&a.data&&(c.data=a.data,
a.data.jstree))for(h in a.data.jstree)a.data.jstree.hasOwnProperty(h)&&(c.state[h]=a.data.jstree[h]);if(a&&"object"===typeof a.state)for(h in a.state)a.state.hasOwnProperty(h)&&(c.state[h]=a.state[h]);if(a&&"object"===typeof a.li_attr)for(h in a.li_attr)a.li_attr.hasOwnProperty(h)&&(c.li_attr[h]=a.li_attr[h]);c.li_attr.id||(c.li_attr.id=f);if(a&&"object"===typeof a.a_attr)for(h in a.a_attr)a.a_attr.hasOwnProperty(h)&&(c.a_attr[h]=a.a_attr[h]);a&&a.children&&!0===a.children&&(c.state.loaded=!1,c.children=
[],c.children_d=[]);e[c.id]=c;h=0;for(f=c.children.length;h<f;h++)d=this._parse_model_from_flat_json(e[c.children[h]],c.id,b),v=e[d],c.children_d.push(d),v.children_d.length&&(c.children_d=c.children_d.concat(v.children_d));delete a.data;delete a.children;e[c.id].original=a;c.state.selected&&this._data.core.selected.push(c.id);return c.id},_parse_model_from_json:function(a,c,b){b=b?b.concat():[];c&&b.unshift(c);var f,e,d,h,v=this._model.data;d=this._model.default_state;do f="j"+this._id+"_"+ ++this._cnt;
while(v[f]);c={id:!1,text:"string"===typeof a?a:"",icon:"object"===typeof a&&a.icon!==t?a.icon:!0,parent:c,parents:b,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(e in d)d.hasOwnProperty(e)&&(c.state[e]=d[e]);a&&a.id&&(c.id=a.id.toString());a&&a.text&&(c.text=a.text);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(c.icon=a.data.jstree.icon);if(a&&a.data&&(c.data=a.data,a.data.jstree))for(e in a.data.jstree)a.data.jstree.hasOwnProperty(e)&&(c.state[e]=
...
f;e++)d=this._parse_model_from_json(a.children[e],c.id,b),h=v[d],c.children.push(d),h.children_d.length&&(c.children_d=c.children_d.concat(h.children_d));c.children_d=c.children_d.concat(c.children)}a&&a.children&&!0===a.children&&(c.state.loaded=!1,c.children=[],c.children_d=[]);delete a.data;delete a.children;c.original=a;v[c.id]=c;c.state.selected&&this._data.core.selected.push(c.id);return c.id},_redraw:function(){var a=this._model.force_full_redraw?this._model.data["#"].children.concat([]):this._model.changed.concat([]),
...
b=0;for(d=c.children.length;b<d;b++)e.appendChild(this.redraw_node(c.children[b],!0,!0));a.appendChild(e)}},redraw_node:function(a,c,b,f){var e=this.get_node(a),k=!1,h=!1,v=!1,m=!1,r=!1,n=!1,g="",l=document,n=this._model.data,p=!1,q=null,C=g=0;if(!e)return!1;if("#"===e.id)return this.redraw(!0);c=c||0===e.children.length;if(a=document.querySelector?this.element[0].querySelector("#"+(-1!=="0123456789".indexOf(e.id[0])?"\\3"+e.id[0]+" "+e.id.substr(1).replace(d.jstree.idregex,"\\$&"):e.id.replace(d.jstree.idregex,
"\\$&"))):document.getElementById(e.id))a=d(a),b||(k=a.parent().parent()[0],k===this.element[0]&&(k=null),h=a.index()),c||!e.children.length||a.children(".jstree-children").length||(c=!0),c||(v=a.children(".jstree-children")[0]),p=a.children(".jstree-anchor")[0]===document.activeElement,a.remove();else if(c=!0,!b){k="#"!==e.parent?d("#"+e.parent.replace(d.jstree.idregex,"\\$&"),this.element)[0]:null;if(!(null===k||k&&n[e.parent].state.opened))return!1;h=d.inArray(e.id,null===k?n["#"].children:n[e.parent].children)}a=
y.cloneNode(!0);g="jstree-node ";for(m in e.li_attr)e.li_attr.hasOwnProperty(m)&&"id"!==m&&("class"!==m?a.setAttribute(m,e.li_attr[m]):g+=e.li_attr[m]);e.a_attr.id||(e.a_attr.id=e.id+"_anchor");a.setAttribute("aria-selected",!!e.state.selected);a.setAttribute("aria-level",e.parents.length);a.setAttribute("aria-labelledby",e.a_attr.id);e.state.disabled&&a.setAttribute("aria-disabled",!0);e.state.loaded&&!e.children.length?g+=" jstree-leaf":(g+=e.state.opened&&e.state.loaded?" jstree-open":" jstree-closed",
a.setAttribute("aria-expanded",e.state.opened&&e.state.loaded));null!==e.parent&&n[e.parent].children[n[e.parent].children.length-1]===e.id&&(g+=" jstree-last");a.id=e.id;a.className=g;g=(e.state.selected?" jstree-clicked":"")+(e.state.disabled?" jstree-disabled":"");for(r in e.a_attr)!e.a_attr.hasOwnProperty(r)||"href"===r&&"#"===e.a_attr[r]||("class"!==r?a.childNodes[1].setAttribute(r,e.a_attr[r]):g+=" "+e.a_attr[r]);g.length&&(a.childNodes[1].className="jstree-anchor "+g);if(e.icon&&!0!==e.icon||
...
a.childNodes[1].appendChild(l.createTextNode(e.text)):a.childNodes[1].innerHTML+=e.text;if(c&&e.children.length&&(e.state.opened||f)&&e.state.loaded){n=l.createElement("UL");n.setAttribute("role","group");n.className="jstree-children";m=0;for(r=e.children.length;m<r;m++)n.appendChild(this.redraw_node(e.children[m],c,!0));a.appendChild(n)}v&&a.appendChild(v);if(!b){k||(k=this.element[0]);m=0;for(r=k.childNodes.length;m<r;m++)if(k.childNodes[m]&&k.childNodes[m].className&&-1!==k.childNodes[m].className.indexOf("jstree-children")){q=
k.childNodes[m];break}q||(q=l.createElement("UL"),q.setAttribute("role","group"),q.className="jstree-children",k.appendChild(q));k=q;h<k.childNodes.length?k.insertBefore(a,k.childNodes[h]):k.appendChild(a);p&&(g=this.element[0].scrollTop,C=this.element[0].scrollLeft,a.childNodes[1].focus(),this.element[0].scrollTop=g,this.element[0].scrollLeft=C)}e.state.opened&&!e.state.loaded&&(e.state.opened=!1,setTimeout(d.proxy(function(){this.open_node(e.id,!1,0)},this),0));return a},open_node:function(a,c,
b){var f,e,k;if(d.isArray(a)){a=a.slice();f=0;for(e=a.length;f<e;f++)this.open_node(a[f],c,b);return!0}a=this.get_node(a);if(!a||"#"===a.id)return!1;b=b===t?this.settings.core.animation:b;if(!this.is_closed(a))return c&&c.call(this,a,!1),!1;if(this.is_loaded(a))f=this.get_node(a,!0),k=this,f.length&&(b&&f.children(".jstree-children").length&&f.children(".jstree-children").stop(!0,!0),a.children.length&&!this._firstChild(f.children(".jstree-children")[0])&&this.draw_children(a),b?(this.trigger("before_open",
...
e=this.get_node(this._data.core.last_clicked.parent).children,k=!1,h,v;h=0;for(v=e.length;h<v;h+=1)e[h]===b&&(k=!k),e[h]===d&&(k=!k),k||e[h]===b||e[h]===d?this.select_node(e[h],!0,!1,c):this.deselect_node(e[h],!0,c);this.trigger("changed",{action:"select_node",node:this.get_node(a),selected:this._data.core.selected,event:c})}else this.is_selected(a)?this.deselect_node(a,!1,c):this.select_node(a,!1,!1,c);else!this.settings.core.multiple&&(c.metaKey||c.ctrlKey||c.shiftKey)&&this.is_selected(a)?this.deselect_node(a,
...
d.proxy(function(a){return this.get_node(a)},this)):this._data.core.selected.slice()},get_top_selected:function(a){var c=this.get_selected(!0),b={},f,e,k,h;f=0;for(e=c.length;f<e;f++)b[c[f].id]=c[f];f=0;for(e=c.length;f<e;f++)for(k=0,h=c[f].children_d.length;k<h;k++)b[c[f].children_d[k]]&&delete b[c[f].children_d[k]];c=[];for(f in b)b.hasOwnProperty(f)&&c.push(f);return a?d.map(c,d.proxy(function(a){return this.get_node(a)},this)):c},get_bottom_selected:function(a){var c=this.get_selected(!0),b=[],
...
f,e,k;if(a.core.open){if(!d.isArray(a.core.open))return delete a.core.open,this.set_state(a,c),!1;b=!0;f=!1;e=this;d.each(a.core.open.concat([]),function(h,k){if(f=e.get_node(k))e.is_loaded(k)?(e.is_closed(k)&&e.open_node(k,!1,0),a&&a.core&&a.core.open&&d.vakata.array_remove_item(a.core.open,k)):(e.is_loading(k)||e.open_node(k,d.proxy(function(b,e){!e&&a&&a.core&&a.core.open&&d.vakata.array_remove_item(a.core.open,b.id);this.set_state(a,c)},e),0),b=!1)});b&&(delete a.core.open,this.set_state(a,c));
return!1}if(a.core.scroll)return a.core.scroll&&a.core.scroll.left!==t&&this.element.scrollLeft(a.core.scroll.left),a.core.scroll&&a.core.scroll.top!==t&&this.element.scrollTop(a.core.scroll.top),delete a.core.scroll,this.set_state(a,c),!1;if(a.core.selected)return k=this,this.deselect_all(),d.each(a.core.selected,function(a,b){k.select_node(b)}),delete a.core.selected,this.set_state(a,c),!1;if(d.isEmptyObject(a.core))return delete a.core,this.set_state(a,c),!1}return d.isEmptyObject(a)?(a=null,c&&
...
k;e++)c&&c.flat?this.get_json(a.children[e],c,b):f.children.push(this.get_json(a.children[e],c));return c&&c.flat?b:"#"===a.id?f.children:f},create_node:function(a,c,b,f,e){null===a&&(a="#");a=this.get_node(a);if(!a)return!1;b=b===t?"last":b;if(!b.toString().match(/^(before|after)$/)&&!e&&!this.is_loaded(a))return this.load_node(a,function(){this.create_node(a,c,b,f,!0)});c||(c={text:this.get_string("New node")});"string"===typeof c&&(c={text:c});c.text===t&&(c.text=this.get_string("New node"));var k,
h,v;"#"===a.id&&("before"===b&&(b="first"),"after"===b&&(b="last"));switch(b){case "before":e=this.get_node(a.parent);b=d.inArray(a.id,e.children);a=e;break;case "after":e=this.get_node(a.parent);b=d.inArray(a.id,e.children)+1;a=e;break;case "inside":case "first":b=0;break;case "last":b=a.children.length;break;default:b||(b=0)}b>a.children.length&&(b=a.children.length);c.id||(c.id=!0);if(!this.check("create_node",c,a,b))return this.settings.core.error.call(this,this._data.core.last_error),!1;!0===
c.id&&delete c.id;c=this._parse_model_from_json(c,a.id,a.parents.concat());if(!c)return!1;e=this.get_node(c);k=[];k.push(c);k=k.concat(e.children_d);this.trigger("model",{nodes:k,parent:a.id});a.children_d=a.children_d.concat(k);h=0;for(v=a.parents.length;h<v;h++)this._model.data[a.parents[h]].children_d=this._model.data[a.parents[h]].children_d.concat(k);c=e;e=[];h=0;for(v=a.children.length;h<v;h++)e[h>=b?h+1:h]=a.children[h];e[b]=c.id;a.children=e;this.redraw_node(a,!0);f&&f.call(this,this.get_node(c));
...
b,f,e,k,h,v,m;if(d.isArray(a)){a=a.slice();c=0;for(b=a.length;c<b;c++)this.delete_node(a[c]);return!0}a=this.get_node(a);if(!a||"#"===a.id)return!1;c=this.get_node(a.parent);b=d.inArray(a.id,c.children);m=!1;if(!this.check("delete_node",a,c,b))return this.settings.core.error.call(this,this._data.core.last_error),!1;-1!==b&&(c.children=d.vakata.array_remove(c.children,b));f=a.children_d.concat([]);f.push(a.id);h=0;for(v=f.length;h<v;h++){e=0;for(k=a.parents.length;e<k;e++)b=d.inArray(f[h],this._model.data[a.parents[e]].children_d),
-1!==b&&(this._model.data[a.parents[e]].children_d=d.vakata.array_remove(this._model.data[a.parents[e]].children_d,b));this._model.data[f[h]].state.selected&&(m=!0,b=d.inArray(f[h],this._data.core.selected),-1!==b&&(this._data.core.selected=d.vakata.array_remove(this._data.core.selected,b)))}this.trigger("delete_node",{node:a,parent:c.id});m&&this.trigger("changed",{action:"delete_node",node:a,selected:this._data.core.selected,parent:c.id});h=0;for(v=f.length;h<v;h++)delete this._model.data[f[h]];
...
!1,par:b&&b.id?b.id:!1})},!1;k&&k.data&&(k=k.data);return k&&k.functions&&(!1===k.functions[a]||!0===k.functions[a])?(!1===k.functions[a]&&(this._data.core.last_error={error:"check",plugin:"core",id:"core_02",reason:"Node data prevents function: "+a,data:JSON.stringify({chk:a,pos:f,obj:c&&c.id?c.id:!1,par:b&&b.id?b.id:!1})}),k.functions[a]):!1===h||d.isFunction(h)&&!1===h.call(this,a,c,b,f,e)||h&&!1===h[a]?(this._data.core.last_error={error:"check",plugin:"core",id:"core_03",reason:"User config for core.check_callback prevents function: "+
a,data:JSON.stringify({chk:a,pos:f,obj:c&&c.id?c.id:!1,par:b&&b.id?b.id:!1})},!1):!0},last_error:function(){return this._data.core.last_error},move_node:function(a,c,b,f,e,k){var h,v,m,r,n,g,l,p,q,C;c=this.get_node(c);b=b===t?0:b;if(!c)return!1;if(!b.toString().match(/^(before|after)$/)&&!e&&!this.is_loaded(c))return this.load_node(c,function(){this.move_node(a,c,b,f,!0)});if(d.isArray(a)){a=a.slice();k=0;for(h=a.length;k<h;k++)this.move_node(a[k],c,b,f,e,!0)&&(c=a[k],b="after");this.redraw();return!0}a=
a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;h=(a.parent||"#").toString();m=b.toString().match(/^(before|after)$/)&&"#"!==c.id?this.get_node(c.parent):c;r=a.instance?a.instance:this._model.data[a.id]?this:d.jstree.reference(a.id);n=!r||!r._id||this._id!==r._id;v=r&&r._id&&h&&r._model.data[h]&&r._model.data[h].children?d.inArray(a.id,r._model.data[h].children):-1;if(n)return this.copy_node(a,c,b,f,e)?(r&&r.delete_node(a),!0):!1;"#"===c.id&&("before"===b&&(b="first"),"after"===b&&(b="last"));
...
n),b>n&&b--);n=[];g=0;for(l=e.length;g<l;g++)n[g>=b?g+1:g]=e[g];n[b]=a.id;m.children=n;this._node_changed(m.id);this.redraw("#"===m.id)}else{n=a.children_d.concat();n.push(a.id);g=0;for(l=a.parents.length;g<l;g++){e=[];C=r._model.data[a.parents[g]].children_d;p=0;for(q=C.length;p<q;p++)-1===d.inArray(C[p],n)&&e.push(C[p]);r._model.data[a.parents[g]].children_d=e}r._model.data[h].children=d.vakata.array_remove_item(r._model.data[h].children,a.id);g=0;for(l=m.parents.length;g<l;g++)this._model.data[m.parents[g]].children_d=
this._model.data[m.parents[g]].children_d.concat(n);e=[];g=0;for(l=m.children.length;g<l;g++)e[g>=b?g+1:g]=m.children[g];e[b]=a.id;m.children=e;m.children_d.push(a.id);m.children_d=m.children_d.concat(a.children_d);a.parent=m.id;n=m.parents.concat();n.unshift(m.id);C=a.parents.length;a.parents=n;n=n.concat();g=0;for(l=a.children_d.length;g<l;g++)this._model.data[a.children_d[g]].parents=this._model.data[a.children_d[g]].parents.slice(0,-1*C),Array.prototype.push.apply(this._model.data[a.children_d[g]].parents,
n);if("#"===h||"#"===m.id)this._model.force_full_redraw=!0;this._model.force_full_redraw||(this._node_changed(h),this._node_changed(m.id));k||this.redraw()}f&&f.call(this,a,m,b);this.trigger("move_node",{node:a,parent:m.id,position:b,old_parent:h,old_position:v,is_multi:r&&r._id&&r._id!==this._id,is_foreign:!r||!r._id,old_instance:r,new_instance:this});return!0},copy_node:function(a,c,b,f,e,k){var h,g,m,r,n,l;c=this.get_node(c);b=b===t?0:b;if(!c)return!1;if(!b.toString().match(/^(before|after)$/)&&
!e&&!this.is_loaded(c))return this.load_node(c,function(){this.copy_node(a,c,b,f,!0)});if(d.isArray(a)){a=a.slice();k=0;for(h=a.length;k<h;k++)if(g=this.copy_node(a[k],c,b,f,e,!0))c=g,b="after";this.redraw();return!0}a=a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;h=(a.parent||"#").toString();n=b.toString().match(/^(before|after)$/)&&"#"!==c.id?this.get_node(c.parent):c;l=a.instance?a.instance:this._model.data[a.id]?this:d.jstree.reference(a.id);"#"===c.id&&("before"===b&&(b="first"),"after"===
...
!0===m.id&&delete m.id;m=this._parse_model_from_json(m,n.id,n.parents.concat());if(!m)return!1;g=this.get_node(m);a&&a.state&&!1===a.state.loaded&&(g.state.loaded=!1);e=[];e.push(m);e=e.concat(g.children_d);this.trigger("model",{nodes:e,parent:n.id});m=0;for(r=n.parents.length;m<r;m++)this._model.data[n.parents[m]].children_d=this._model.data[n.parents[m]].children_d.concat(e);e=[];m=0;for(r=n.children.length;m<r;m++)e[m>=b?m+1:m]=n.children[m];e[b]=g.id;n.children=e;n.children_d.push(g.id);n.children_d=
n.children_d.concat(g.children_d);"#"===n.id&&(this._model.force_full_redraw=!0);this._model.force_full_redraw||this._node_changed(n.id);k||this.redraw("#"===n.id);f&&f.call(this,g,n,b);this.trigger("copy_node",{node:g,original:a,parent:n.id,position:b,old_parent:h,old_position:l&&l._id&&h&&l._model.data[h]&&l._model.data[h].children?d.inArray(a.id,l._model.data[h].children):-1,is_multi:l&&l._id&&l._id!==this._id,is_foreign:!l||!l._id,old_instance:l,new_instance:this});return g.id},cut:function(a){a||
(a=this._data.core.selected.concat());d.isArray(a)||(a=[a]);if(!a.length)return!1;var c=[],b,f,e;f=0;for(e=a.length;f<e;f++)(b=this.get_node(a[f]))&&b.id&&"#"!==b.id&&c.push(b);if(!c.length)return!1;g=c;p=this;l="move_node";this.trigger("cut",{node:a})},copy:function(a){a||(a=this._data.core.selected.concat());d.isArray(a)||(a=[a]);if(!a.length)return!1;var c=[],b,f,e;f=0;for(e=a.length;f<e;f++)(b=this.get_node(a[f]))&&b.id&&"#"!==b.id&&c.push(b);if(!c.length)return!1;g=c;p=this;l="copy_node";this.trigger("copy",
{node:a})},get_buffer:function(){return{mode:l,node:g,inst:p}},can_paste:function(){return!1!==l&&!1!==g},paste:function(a,c){a=this.get_node(a);if(!(a&&l&&l.match(/^(copy_node|move_node)$/)&&g))return!1;this[l](g,a,c)&&this.trigger("paste",{parent:a.id,node:g,mode:l});p=l=g=!1},clear_buffer:function(){p=l=g=!1;this.trigger("clear_buffer")},edit:function(a,c){a=this.get_node(a);if(!a)return!1;if(!1===this.settings.core.check_callback)return this._data.core.last_error={error:"check",plugin:"core",
id:"core_07",reason:"Could not edit node because of check_callback"},this.settings.core.error.call(this,this._data.core.last_error),!1;c="string"===typeof c?c:a.text;this.set_text(a,"");a=this._open_to(a);var b=this._data.core.rtl,f=this.element.width(),e=a.children(".jstree-anchor"),k=d("<span>"),h=c,g=d("<div />",{css:{position:"absolute",top:"-200px",left:b?"0px":"-1000px",visibility:"hidden"}}).appendTo("body"),m=d("<input />",{value:h,"class":"jstree-rename-input",css:{padding:"0",border:"1px solid silver",
"box-sizing":"border-box",display:"inline-block",height:this._data.core.li_height+"px",lineHeight:this._data.core.li_height+"px",width:"150px"},blur:d.proxy(function(){var b=k.children(".jstree-rename-input").val();""===b&&(b=h);g.remove();k.replaceWith(e);k.remove();this.set_text(a,h);!1===this.rename_node(a,d("<div></div>").text(b)[this.settings.core.force_text?"text":"html"]())&&this.set_text(a,h)},this),keydown:function(a){var b=a.which;27===b&&(this.value=h);27!==b&&13!==b&&37!==b&&38!==b&&39!==
b&&40!==b&&32!==b||a.stopImmediatePropagation();if(27===b||13===b)a.preventDefault(),this.blur()},click:function(a){a.stopImmediatePropagation()},mousedown:function(a){a.stopImmediatePropagation()},keyup:function(a){m.width(Math.min(g.text("pW"+this.value).width(),f))},keypress:function(a){if(13===a.which)return!1}}),b={fontFamily:e.css("fontFamily")||"",fontSize:e.css("fontSize")||"",fontWeight:e.css("fontWeight")||"",fontStyle:e.css("fontStyle")||"",fontStretch:e.css("fontStretch")||"",fontVariant:e.css("fontVariant")||
"",letterSpacing:e.css("letterSpacing")||"",wordSpacing:e.css("wordSpacing")||""};k.attr("class",e.attr("class")).append(e.contents().clone()).append(m);e.replaceWith(k);g.css(b);m.css(b).width(Math.min(g.text("pW"+m[0].value).width(),f))[0].select()},set_theme:function(a,c){if(!a)return!1;if(!0===c){var b=this.settings.core.themes.dir;b||(b=d.jstree.path+"/themes");c=b+"/"+a+"/style.css"}c&&-1===d.inArray(c,q)&&(d("head").append('<link rel="stylesheet" href="'+c+'" type="text/css" />'),q.push(c));
...
a.length);a.length=0>c?a.length+c:c;a.push.apply(a,b);return a};d.vakata.array_remove_item=function(a,c){var b=d.inArray(c,a);return-1!==b?d.vakata.array_remove(a,b):a};var z=document.createElement("I");z.className="jstree-icon jstree-checkbox";z.setAttribute("role","presentation");d.jstree.defaults.checkbox={visible:!0,three_state:!0,whole_node:!0,keep_selected_style:!0,cascade:"",tie_selection:!0};d.jstree.plugins.checkbox=function(a,c){this.bind=function(){c.bind.call(this);this._data.checkbox.uto=
...
c){var b=this._model.data,d=c.nodes,f,g;f=0;for(g=d.length;f<g;f++)b[d[f]].state.checked=b[d[f]].original&&b[d[f]].original.state&&b[d[f]].original.state.checked,b[d[f]].state.checked&&this._data.checkbox.selected.push(d[f])},this));if(-1!==this.settings.checkbox.cascade.indexOf("up")||-1!==this.settings.checkbox.cascade.indexOf("down"))this.element.on("model.jstree",d.proxy(function(a,c){var b=this._model.data,f=b[c.parent],h=c.nodes,g=[],m,r,n,l,p=this.settings.checkbox.cascade,q=this.settings.checkbox.tie_selection;
if(-1!==p.indexOf("down"))if(f.state[q?"selected":"checked"]){m=0;for(r=h.length;m<r;m++)b[h[m]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(h)}else for(m=0,r=h.length;m<r;m++)if(b[h[m]].state[q?"selected":"checked"]){n=0;for(l=b[h[m]].children_d.length;n<l;n++)b[b[h[m]].children_d[n]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(b[h[m]].children_d)}if(-1!==
p.indexOf("up")){m=0;for(r=f.children_d.length;m<r;m++)b[f.children_d[m]].children.length||g.push(b[f.children_d[m]].parent);g=d.vakata.array_unique(g);n=0;for(l=g.length;n<l;n++)for(f=b[g[n]];f&&"#"!==f.id;){m=h=0;for(r=f.children.length;m<r;m++)h+=b[f.children[m]].state[q?"selected":"checked"];if(h===r)f.state[q?"selected":"checked"]=!0,this._data[q?"core":"checkbox"].selected.push(f.id),(m=this.get_node(f,!0))&&m.length&&m.attr("aria-selected",!0).children(".jstree-anchor").addClass(q?"jstree-clicked":
"jstree-checked");else break;f=this.get_node(f.parent)}}this._data[q?"core":"checkbox"].selected=d.vakata.array_unique(this._data[q?"core":"checkbox"].selected)},this)).on(this.settings.checkbox.tie_selection?"select_node.jstree":"check_node.jstree",d.proxy(function(a,c){var b=c.node,f=this._model.data,h=this.get_node(b.parent),g=this.get_node(b,!0),m,r,n,l=this.settings.checkbox.cascade,p=this.settings.checkbox.tie_selection;if(-1!==l.indexOf("down"))for(this._data[p?"core":"checkbox"].selected=
d.vakata.array_unique(this._data[p?"core":"checkbox"].selected.concat(b.children_d)),m=0,r=b.children_d.length;m<r;m++)n=f[b.children_d[m]],n.state[p?"selected":"checked"]=!0,n&&n.original&&n.original.state&&n.original.state.undetermined&&(n.original.state.undetermined=!1);if(-1!==l.indexOf("up"))for(;h&&"#"!==h.id;){m=b=0;for(r=h.children.length;m<r;m++)b+=f[h.children[m]].state[p?"selected":"checked"];if(b===r)h.state[p?"selected":"checked"]=!0,this._data[p?"core":"checkbox"].selected.push(h.id),
(n=this.get_node(h,!0))&&n.length&&n.attr("aria-selected",!0).children(".jstree-anchor").addClass(p?"jstree-clicked":"jstree-checked");else break;h=this.get_node(h.parent)}-1!==l.indexOf("down")&&g.length&&g.find(".jstree-anchor").addClass(p?"jstree-clicked":"jstree-checked").parent().attr("aria-selected",!0)},this)).on(this.settings.checkbox.tie_selection?"deselect_all.jstree":"uncheck_all.jstree",d.proxy(function(a,d){var b=this.get_node("#"),c=this._model.data,f,g,m;f=0;for(g=b.children_d.length;f<
g;f++)(m=c[b.children_d[f]])&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1)},this)).on(this.settings.checkbox.tie_selection?"deselect_node.jstree":"uncheck_node.jstree",d.proxy(function(a,c){var b=c.node,f=this.get_node(b,!0),h,g,m,r=this.settings.checkbox.cascade,n=this.settings.checkbox.tie_selection;b&&b.original&&b.original.state&&b.original.state.undetermined&&(b.original.state.undetermined=!1);if(-1!==r.indexOf("down"))for(h=0,g=b.children_d.length;h<
g;h++)m=this._model.data[b.children_d[h]],m.state[n?"selected":"checked"]=!1,m&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1);if(-1!==r.indexOf("up"))for(h=0,g=b.parents.length;h<g;h++)m=this._model.data[b.parents[h]],m.state[n?"selected":"checked"]=!1,m&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1),(m=this.get_node(b.parents[h],!0))&&m.length&&m.attr("aria-selected",!1).children(".jstree-anchor").removeClass(n?
"jstree-clicked":"jstree-checked");m=[];h=0;for(g=this._data[n?"core":"checkbox"].selected.length;h<g;h++)-1!==r.indexOf("down")&&-1!==d.inArray(this._data[n?"core":"checkbox"].selected[h],b.children_d)||-1!==r.indexOf("up")&&-1!==d.inArray(this._data[n?"core":"checkbox"].selected[h],b.parents)||m.push(this._data[n?"core":"checkbox"].selected[h]);this._data[n?"core":"checkbox"].selected=d.vakata.array_unique(m);-1!==r.indexOf("down")&&f.length&&f.find(".jstree-anchor").removeClass(n?"jstree-clicked":
"jstree-checked").parent().attr("aria-selected",!1)},this));if(-1!==this.settings.checkbox.cascade.indexOf("up"))this.element.on("delete_node.jstree",d.proxy(function(a,c){for(var b=this.get_node(c.parent),d=this._model.data,f,g,m,r=this.settings.checkbox.tie_selection;b&&"#"!==b.id;){f=m=0;for(g=b.children.length;f<g;f++)m+=d[b.children[f]].state[r?"selected":"checked"];if(m===g)b.state[r?"selected":"checked"]=!0,this._data[r?"core":"checkbox"].selected.push(b.id),(f=this.get_node(b,!0))&&f.length&&
f.attr("aria-selected",!0).children(".jstree-anchor").addClass(r?"jstree-clicked":"jstree-checked");else break;b=this.get_node(b.parent)}},this)).on("move_node.jstree",d.proxy(function(a,c){var b=c.is_multi,f=c.old_parent,h=this.get_node(c.parent),g=this._model.data,m,r,n=this.settings.checkbox.tie_selection;if(!b)for(b=this.get_node(f);b&&"#"!==b.id;){m=f=0;for(r=b.children.length;m<r;m++)f+=g[b.children[m]].state[n?"selected":"checked"];if(f===r)b.state[n?"selected":"checked"]=!0,this._data[n?"core":
"checkbox"].selected.push(b.id),(f=this.get_node(b,!0))&&f.length&&f.attr("aria-selected",!0).children(".jstree-anchor").addClass(n?"jstree-clicked":"jstree-checked");else break;b=this.get_node(b.parent)}for(b=h;b&&"#"!==b.id;){m=f=0;for(r=b.children.length;m<r;m++)f+=g[b.children[m]].state[n?"selected":"checked"];if(f===r)b.state[n?"selected":"checked"]||(b.state[n?"selected":"checked"]=!0,this._data[n?"core":"checkbox"].selected.push(b.id),(f=this.get_node(b,!0))&&f.length&&f.attr("aria-selected",
...
k=this.settings.checkbox.tie_selection,h=this._data[k?"core":"checkbox"].selected,g=[],m=this;a=0;for(c=h.length;a<c;a++)e[h[a]]&&e[h[a]].parents&&(g=g.concat(e[h[a]].parents));this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function(){var b=m.get_node(this),d;if(b.state.loaded)for(a=0,c=b.children_d.length;a<c;a++)d=e[b.children_d[a]],!d.state.loaded&&d.original&&d.original.state&&d.original.state.undetermined&&!0===d.original.state.undetermined&&(g.push(d.id),g=g.concat(d.parents));
else b.original&&b.original.state&&b.original.state.undetermined&&!0===b.original.state.undetermined&&(g.push(b.id),g=g.concat(b.parents))});g=d.vakata.array_unique(g);g=d.vakata.array_remove_item(g,"#");this.element.find(".jstree-undetermined").removeClass("jstree-undetermined");a=0;for(c=g.length;a<c;a++)e[g[a]].state[k?"selected":"checked"]||(h=this.get_node(g[a],!0))&&h.length&&h.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined")};this.redraw_node=function(a,
f,e,k){if(a=c.redraw_node.apply(this,arguments)){var b,g,m=null;b=0;for(g=a.childNodes.length;b<g;b++)if(a.childNodes[b]&&a.childNodes[b].className&&-1!==a.childNodes[b].className.indexOf("jstree-anchor")){m=a.childNodes[b];break}m&&(!this.settings.checkbox.tie_selection&&this._model.data[a.id].state.checked&&(m.className+=" jstree-checked"),m.insertBefore(z.cloneNode(!1),m.childNodes[0]))}e||-1===this.settings.checkbox.cascade.indexOf("undetermined")||(this._data.checkbox.uto&&clearTimeout(this._data.checkbox.uto),
...
var b=this.settings.checkbox.cascade,c;c=this.settings.checkbox.tie_selection;var k=this._data[c?"core":"checkbox"].selected,h=this._model.data;if(!a||!0===a.state[c?"selected":"checked"]||-1===b.indexOf("undetermined")||-1===b.indexOf("down")&&-1===b.indexOf("up"))return!1;if(!a.state.loaded&&!0===a.original.state.undetermined)return!0;b=0;for(c=a.children_d.length;b<c;b++)if(-1!==d.inArray(a.children_d[b],k)||!h[a.children_d[b]].state.loaded&&h[a.children_d[b]].original.state.undetermined)return!0;
...
f.length?f:!1},_show_submenu:function(b){b=a(b);if(b.length&&b.children("ul").length){var d=b.children("ul"),e=b.offset().left+b.outerWidth(),f=b.offset().top,h=d.width(),k=d.height(),g=a(window).width()+a(window).scrollLeft(),m=a(window).height()+a(window).scrollTop();if(c)b[0>e-(h+10+b.outerWidth())?"addClass":"removeClass"]("vakata-context-left");else b[e+h+10>g?"addClass":"removeClass"]("vakata-context-right");f+k+10>m&&d.css("bottom","-1px");d.show()}},show:function(f,n,l){var r,v,p,q,u;b&&b.length&&
b.width("");switch(!0){case !n&&!f:return!1;case !!n&&!!f:d=f;e=n.x;k=n.y;break;case !n&&!!f:d=f;n=f.offset();e=n.left+f.outerHeight();k=n.top;break;case !!n&&!f:e=n.x,k=n.y}f&&!l&&a(f).data("vakata_contextmenu")&&(l=a(f).data("vakata_contextmenu"));a.vakata.context._parse(l)&&b.html(g);h.length&&(b.appendTo("body"),l=b,n=e,r=k,v=l.width(),p=l.height(),q=a(window).width()+a(window).scrollLeft(),u=a(window).height()+a(window).scrollTop(),c&&(n-=l.outerWidth()-a(f).outerWidth(),n<a(window).scrollLeft()+
20&&(n=a(window).scrollLeft()+20)),n+v+20>q&&(n=q-(v+20)),r+p+20>u&&(r=u-(p+20)),b.css({left:n,top:r}).show().find("a").first().focus().parent().addClass("vakata-context-hover"),m=!0,a.vakata.context._trigger("show"))},hide:function(){m&&(b.hide().find("ul").hide().end().find(":focus").blur().end().detach(),m=!1,a.vakata.context._trigger("hide"))}};a(function(){c="rtl"===a("body").css("direction");var d=!1;b=a("<ul class='vakata-context'></ul>");b.on("mouseenter","li",function(c){c.stopImmediatePropagation();
...
this))}};d(function(){var a=!1,c=!1,b=!1,f=d('<div id="jstree-marker">&#160;</div>').hide();d(document).on("dnd_start.vakata.jstree",function(b,c){a=!1;c&&c.data&&c.data.jstree&&f.appendTo("body")}).on("dnd_move.vakata.jstree",function(e,k){b&&clearTimeout(b);if(k&&k.data&&k.data.jstree&&(!k.event.target.id||"jstree-marker"!==k.event.target.id)){var h=d.jstree.reference(k.event.target),g=!1,m=!1,l=!1,n,p,q,u,x,C,t,D,z,y,A,B,w,E;if(h&&h._data&&h._data.dnd)if(f.attr("class","jstree-"+h.get_theme()+
(h.settings.core.themes.responsive?" jstree-dnd-responsive":"")),k.helper.children().attr("class","jstree-"+h.get_theme()+" jstree-"+h.get_theme()+"-"+h.get_theme_variant()+" "+(h.settings.core.themes.responsive?" jstree-dnd-responsive":"")).find(".jstree-copy").first()[k.data.origin&&(k.data.origin.settings.dnd.always_copy||k.data.origin.settings.dnd.copy&&(k.event.metaKey||k.event.ctrlKey))?"show":"hide"](),k.event.target!==h.element[0]&&k.event.target!==h.get_container_ul()[0]||0!==h.get_container_ul().children().length){if((g=
d(k.event.target).closest(".jstree-anchor"))&&g.length&&g.parent().is(".jstree-closed, .jstree-open, .jstree-leaf")&&(m=g.offset(),l=k.event.pageY-m.top,q=g.height(),C=l<q/3?["b","i","a"]:l>q-q/3?["a","i","b"]:l>q/2?["i","a","b"]:["i","b","a"],d.each(C,function(e,l){switch(l){case "b":n=m.left-6;p=m.top;u=h.get_parent(g);x=g.parent().index();break;case "i":w=h.settings.dnd.inside_pos;E=h.get_node(g.parent());n=m.left-2;p=m.top+q/2+1;u=E.id;x="first"===w?0:"last"===w?E.children.length:Math.min(w,E.children.length);
break;case "a":n=m.left-6,p=m.top+q,u=h.get_parent(g),x=g.parent().index()+1}t=!0;D=0;for(z=k.data.nodes.length;D<z;D++)if(y=k.data.origin&&(k.data.origin.settings.dnd.always_copy||k.data.origin.settings.dnd.copy&&(k.event.metaKey||k.event.ctrlKey))?"copy_node":"move_node",A=x,"move_node"===y&&"a"===l&&k.data.origin&&k.data.origin===h&&u===h.get_parent(k.data.nodes[D])&&(B=h.get_node(u),A>d.inArray(k.data.nodes[D],B.children)&&--A),t=t&&(h&&h.settings&&h.settings.dnd&&!1===h.settings.dnd.check_while_dragging||
h.check(y,k.data.origin&&k.data.origin!==h?k.data.origin.get_node(k.data.nodes[D]):k.data.nodes[D],u,A,{dnd:!0,ref:h.get_node(g.parent()),pos:l,is_multi:k.data.origin&&k.data.origin!==h,is_foreign:!k.data.origin})),!t){h&&h.last_error&&(c=h.last_error());break}"i"===l&&g.parent().is(".jstree-closed")&&h.settings.dnd.open_timeout&&(b=setTimeout(function(a,b){return function(){a.open_node(b)}}(h,g),h.settings.dnd.open_timeout));if(t)return a={ins:h,par:u,pos:"i"!==l||"last"!==w||0!==x||h.is_loaded(E)?
x:"last"},f.css({left:n+"px",top:p+"px"}).show(),k.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"),c={},C=!0,!1}),!0===C))return}else{t=!0;D=0;for(z=k.data.nodes.length;D<z&&(t=t&&h.check(k.data.origin&&(k.data.origin.settings.dnd.always_copy||k.data.origin.settings.dnd.copy&&(k.event.metaKey||k.event.ctrlKey))?"copy_node":"move_node",k.data.origin&&k.data.origin!==h?k.data.origin.get_node(k.data.nodes[D]):k.data.nodes[D],"#","last",{dnd:!0,ref:h.get_node("#"),pos:"i",
is_multi:k.data.origin&&k.data.origin!==h,is_foreign:!k.data.origin}),t);D++);if(t){a={ins:h,par:"#",pos:"last"};f.hide();k.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok");return}}a=!1;k.helper.find(".jstree-icon").removeClass("jstree-ok").addClass("jstree-er");f.hide()}}).on("dnd_scroll.vakata.jstree",function(b,c){c&&c.data&&c.data.jstree&&(f.hide(),a=!1,c.helper.find(".jstree-icon").first().removeClass("jstree-ok").addClass("jstree-er"))}).on("dnd_stop.vakata.jstree",
function(e,k){b&&clearTimeout(b);if(k&&k.data&&k.data.jstree){f.hide().detach();var h,g,m=[];if(a){h=0;for(g=k.data.nodes.length;h<g;h++)m[h]=k.data.origin?k.data.origin.get_node(k.data.nodes[h]):k.data.nodes[h],k.data.origin&&(m[h].instance=k.data.origin);a.ins[k.data.origin&&(k.data.origin.settings.dnd.always_copy||k.data.origin.settings.dnd.copy&&(k.event.metaKey||k.event.ctrlKey))?"copy_node":"move_node"](m,a.par,a.pos);h=0;for(g=m.length;h<g;h++)m[h].instance&&(m[h].instance=null)}else h=d(k.event.target).closest(".jstree"),
h.length&&c&&c.error&&"check"===c.error&&(h=h.jstree(!0))&&h.settings.core.error.call(this,c)}}).on("keyup.jstree keydown.jstree",function(a,b){if((b=d.vakata.dnd._get())&&b.data&&b.data.jstree)b.helper.find(".jstree-copy").first()[b.data.origin&&(b.data.origin.settings.dnd.always_copy||b.data.origin.settings.dnd.copy&&(a.metaKey||a.ctrlKey))?"show":"hide"]()})});(function(a){var c=!1,b=!1,d=!1,e=!1,k=!1,h=0,g=!1,m=0,l=0,n=0,p=0,q=!1,u=!1,t=!1;a.vakata.dnd={settings:{scroll_speed:10,scroll_proximity:20,
helper_left:5,helper_top:10,threshold:5,threshold_touch:50},_trigger:function(b,c){var d=a.vakata.dnd._get();d.event=c;a(document).triggerHandler("dnd_"+b+".vakata",d)},_get:function(){return{data:g,element:c,helper:k}},_clean:function(){k&&k.remove();u&&(clearInterval(u),u=!1);k=e=d=b=c=!1;h=0;g=!1;p=n=l=m=0;t=u=q=!1;a(document).off("mousemove.vakata.jstree touchmove.vakata.jstree",a.vakata.dnd.drag);a(document).off("mouseup.vakata.jstree touchend.vakata.jstree",a.vakata.dnd.stop)},_scroll:function(b){if(!q||
!n&&!p)return u&&(clearInterval(u),u=!1),!1;if(!u)return u=setInterval(a.vakata.dnd._scroll,100),!1;if(!0===b)return!1;b=q.scrollTop();var c=q.scrollLeft();q.scrollTop(b+p*a.vakata.dnd.settings.scroll_speed);q.scrollLeft(c+n*a.vakata.dnd.settings.scroll_speed);b===q.scrollTop()&&c===q.scrollLeft()||a.vakata.dnd._trigger("scroll",q)},start:function(f,h,n){"touchstart"===f.type&&f.originalEvent&&f.originalEvent.changedTouches&&f.originalEvent.changedTouches[0]&&(f.pageX=f.originalEvent.changedTouches[0].pageX,
f.pageY=f.originalEvent.changedTouches[0].pageY,f.target=document.elementFromPoint(f.originalEvent.changedTouches[0].pageX-window.pageXOffset,f.originalEvent.changedTouches[0].pageY-window.pageYOffset));e&&a.vakata.dnd.stop({});try{f.currentTarget.unselectable="on",f.currentTarget.onselectstart=function(){return!1},f.currentTarget.style&&(f.currentTarget.style.MozUserSelect="none")}catch(J){}m=f.pageX;l=f.pageY;g=h;d=!0;c=f.currentTarget;b=f.target;t="touchstart"===f.type;!1!==n&&(k=a("<div id='vakata-dnd'></div>").html(n).css({display:"block",
...
window.pageXOffset,b.originalEvent.changedTouches[0].pageY-window.pageYOffset));if(d){if(!e)if(Math.abs(b.pageX-m)>(t?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold)||Math.abs(b.pageY-l)>(t?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold))k&&(k.appendTo("body"),h=k.outerWidth()),e=!0,a.vakata.dnd._trigger("start",b);else return;var c=!1,f=!1,g=!1,r=!1,v=!1,u=f=!1,x=!1,r=c=!1;n=p=0;q=!1;a(a(b.target).parentsUntil("body").addBack().get().reverse()).filter(function(){return/^auto|scroll$/.test(a(this).css("overflow"))&&
...
f=a(window),g=c.height(),r=f.height(),v=c.width(),f=f.width(),u=c.scrollTop(),x=c.scrollLeft(),g>r&&b.pageY-u<a.vakata.dnd.settings.scroll_proximity&&(p=-1),g>r&&r-(b.pageY-u)<a.vakata.dnd.settings.scroll_proximity&&(p=1),v>f&&b.pageX-x<a.vakata.dnd.settings.scroll_proximity&&(n=-1),v>f&&f-(b.pageX-x)<a.vakata.dnd.settings.scroll_proximity&&(n=1),p||n)&&(q=c);q&&a.vakata.dnd._scroll(!0);k&&(c=parseInt(b.pageY+a.vakata.dnd.settings.helper_top,10),r=parseInt(b.pageX+a.vakata.dnd.settings.helper_left,
10),g&&c+25>g&&(c=g-50),v&&r+h>v&&(r=v-(h+2)),k.css({left:r+"px",top:c+"px"}));a.vakata.dnd._trigger("move",b);return!1}},stop:function(c){"touchend"===c.type&&c.originalEvent&&c.originalEvent.changedTouches&&c.originalEvent.changedTouches[0]&&(c.pageX=c.originalEvent.changedTouches[0].pageX,c.pageY=c.originalEvent.changedTouches[0].pageY,c.target=document.elementFromPoint(c.originalEvent.changedTouches[0].pageX-window.pageXOffset,c.originalEvent.changedTouches[0].pageY-window.pageYOffset));if(e)a.vakata.dnd._trigger("stop",
...
[];this._data.search.som=!1;this.element.on("before_open.jstree",d.proxy(function(a,c){var b,f,h=this._data.search.res,g=[];b=d();if(h&&h.length&&(this._data.search.dom=d(this.element[0].querySelectorAll("#"+d.map(h,function(a){return-1!=="0123456789".indexOf(a[0])?"\\3"+a[0]+" "+a.substr(1).replace(d.jstree.idregex,"\\$&"):a.replace(d.jstree.idregex,"\\$&")}).join(", #"))),this._data.search.dom.children(".jstree-anchor").addClass("jstree-search"),this._data.search.som&&this._data.search.res.length)){b=
0;for(f=h.length;b<f;b++)g=g.concat(this.get_node(h[b]).parents);g=d.vakata.array_remove_item(d.vakata.array_unique(g),"#");b=g.length?d(this.element[0].querySelectorAll("#"+d.map(g,function(a){return-1!=="0123456789".indexOf(a[0])?"\\3"+a[0]+" "+a.substr(1).replace(d.jstree.idregex,"\\$&"):a.replace(d.jstree.idregex,"\\$&")}).join(", #"))):d();this.element.find(".jstree-node").hide().filter(".jstree-last").filter(function(){return this.nextSibling}).removeClass("jstree-last");b=b.add(this._data.search.dom);
...
b.d&&(b=b.d);this._load_nodes(d.isArray(b)?d.vakata.array_unique(b):[],function(){this.search(a,!0,e)},!0)},this))}this._data.search.str=a;this._data.search.dom=d();this._data.search.res=[];this._data.search.opn=[];this._data.search.som=e;g=new d.vakata.search(a,!0,{caseSensitive:b.case_sensitive,fuzzy:b.fuzzy});d.each(this._model.data,function(c,d){d.text&&(b.search_callback&&b.search_callback.call(this,a,d)||!b.search_callback&&g.search(d.text).isMatch)&&(!b.search_leaves_only||d.state.loaded&&
...
function(c,f){if("#"===f)return!0;try{f=d("#"+f.replace(d.jstree.idregex,"\\$&"),b.element)}catch(h){}f&&f.length&&b.is_closed(f)&&(b._data.search.opn.push(f[0].id),b.open_node(f,function(){b._search_open(a)},0))})}};(function(a){a.vakata.search=function(a,b,d){d=d||{};!1!==d.fuzzy&&(d.fuzzy=!0);a=d.caseSensitive?a:a.toLowerCase();var c=d.location||0,f=d.distance||100,h=d.threshold||.6,g=a.length,m,l,n,p;32<g&&(d.fuzzy=!1);d.fuzzy&&(m=1<<g-1,l=function(){var b={},c;for(c=0;c<g;c++)b[a.charAt(c)]=
0;for(c=0;c<g;c++)b[a.charAt(c)]|=1<<g-c-1;return b}(),n=function(a,b){var d=a/g,e=Math.abs(c-b);return f?d+e/f:e?1:d});p=function(b){b=d.caseSensitive?b:b.toLowerCase();if(a===b||-1!==b.indexOf(a))return{isMatch:!0,score:0};if(!d.fuzzy)return{isMatch:!1,score:1};var e,f,k=b.length,p=h,q=b.indexOf(a,c),r,v,u=g+k,t,x,z=1,y=[];-1!==q&&(p=Math.min(n(0,q),p),q=b.lastIndexOf(a,c+g),-1!==q&&(p=Math.min(n(0,q),p)));q=-1;for(e=0;e<g;e++){r=0;for(v=u;r<v;)n(e,c+v)<=p?r=v:u=v,v=Math.floor((u-r)/2+r);u=v;r=
Math.max(1,c-v+1);f=Math.min(c+v,k)+g;v=Array(f+2);for(v[f+1]=(1<<e)-1;f>=r;f--)if(x=l[b.charAt(f-1)],v[f]=0===e?(v[f+1]<<1|1)&x:(v[f+1]<<1|1)&x|(t[f+1]|t[f])<<1|1|t[f+1],v[f]&m&&(z=n(e,f-1),z<=p))if(p=z,q=f-1,y.push(q),q>c)r=Math.max(1,2*c-q);else break;if(n(e+1,c)>p)break;t=v}return{isMatch:0<=q,score:z}};return!0===b?{search:p}:p(b)}})(d);d.jstree.defaults.sort=function(a,c){return this.get_text(a)>this.get_text(c)?1:-1};d.jstree.plugins.sort=function(a,c){this.bind=function(){c.bind.call(this);
...
d.jstree.defaults.types={"#":{},"default":{}};d.jstree.plugins.types=function(a,c){this.init=function(a,d){var b,f;if(d&&d.types&&d.types["default"])for(b in d.types)if("default"!==b&&"#"!==b&&d.types.hasOwnProperty(b))for(f in d.types["default"])d.types["default"].hasOwnProperty(f)&&d.types[b][f]===t&&(d.types[b][f]=d.types["default"][f]);c.init.call(this,a,d);this._model.data["#"].type="#"};this.refresh=function(a,d){c.refresh.call(this,a,d);this._model.data["#"].type="#"};this.bind=function(){this.element.on("model.jstree",
d.proxy(function(a,c){var b=this._model.data,d=c.nodes,f=this.settings.types,g,m,l;g=0;for(m=d.length;g<m;g++)l="default",b[d[g]].original&&b[d[g]].original.type&&f[b[d[g]].original.type]&&(l=b[d[g]].original.type),b[d[g]].data&&b[d[g]].data.jstree&&b[d[g]].data.jstree.type&&f[b[d[g]].data.jstree.type]&&(l=b[d[g]].data.jstree.type),b[d[g]].type=l,!0===b[d[g]].icon&&f[l].icon!==t&&(b[d[g]].icon=f[l].icon);b["#"].type="#"},this));c.bind.call(this)};this.get_json=function(a,f,e){var b=this._model.data,
...
c=a.length;b<c;b++)a[b]=this._delete_ids(a[b]);return a}delete a.id;a.li_attr&&a.li_attr.id&&delete a.li_attr.id;a.a_attr&&a.a_attr.id&&delete a.a_attr.id;a.children&&d.isArray(a.children)&&(a.children=this._delete_ids(a.children));return a};this.check=function(a,f,e,g,h){if(!1===c.check.call(this,a,f,e,g,h))return!1;f=f&&f.id?f:this.get_node(f);e=e&&e.id?e:this.get_node(e);h=f&&f.id?d.jstree.reference(f.id):null;var b,k,l,n;h=h&&h._model&&h._model.data?h._model.data:null;switch(a){case "create_node":case "move_node":case "copy_node":if("move_node"!==
a||-1===d.inArray(f.id,e.children)){b=this.get_rules(e);if(b.max_children!==t&&-1!==b.max_children&&b.max_children===e.children.length)return this._data.core.last_error={error:"check",plugin:"types",id:"types_01",reason:"max_children prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})},!1;if(b.valid_children!==t&&-1!==b.valid_children&&-1===d.inArray(f.type||"default",b.valid_children))return this._data.core.last_error={error:"check",plugin:"types",id:"types_02",
reason:"valid_children prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})},!1;if(h&&f.children_d&&f.parents){l=k=0;for(n=f.children_d.length;l<n;l++)k=Math.max(k,h[f.children_d[l]].parents.length);k=k-f.parents.length+1}if(0>=k||k===t)k=1;do{if(b.max_depth!==t&&-1!==b.max_depth&&b.max_depth<k)return this._data.core.last_error={error:"check",plugin:"types",id:"types_03",reason:"max_depth prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?
f.id:!1,par:e&&e.id?e.id:!1})},!1;e=this.get_node(e.parent);b=this.get_rules(e);k++}while(e)}}return!0};this.get_rules=function(a){a=this.get_node(a);if(!a)return!1;a=this.get_type(a,!0);a.max_depth===t&&(a.max_depth=-1);a.max_children===t&&(a.max_children=-1);a.valid_children===t&&(a.valid_children=-1);return a};this.get_type=function(a,c){return(a=this.get_node(a))?c?d.extend({type:a.type},this.settings.types[a.type]):a.type:!1};this.set_type=function(a,c){var b,f,h;if(d.isArray(a)){a=a.slice();
b=0;for(f=a.length;b<f;b++)this.set_type(a[b],c);return!0}b=this.settings.types;a=this.get_node(a);if(!b[c]||!a)return!1;f=a.type;h=this.get_icon(a);a.type=c;(!0===h||b[f]&&b[f].icon!==t&&h===b[f].icon)&&this.set_icon(a,b[c].icon!==t?b[c].icon:!0);return!0}};d.jstree.defaults.unique={case_sensitive:!1,duplicate:function(a,c){return a+" ("+c+")"}};d.jstree.plugins.unique=function(a,c){this.check=function(a,f,e,g,h){if(!1===c.check.call(this,a,f,e,g,h))return!1;f=f&&f.id?f:this.get_node(f);e=e&&e.id?
e:this.get_node(e);if(!e||!e.children)return!0;h="rename_node"===a?g:f.text;var b=[],k=this.settings.unique.case_sensitive,l=this._model.data,n,p;n=0;for(p=e.children.length;n<p;n++)b.push(k?l[e.children[n]].text:l[e.children[n]].text.toLowerCase());k||(h=h.toLowerCase());switch(a){case "rename_node":return n=-1===d.inArray(h,b)||f.text&&f.text[k?"toString":"toLowerCase"]()===h,n||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_01",reason:"Child with name "+h+" already exists. Preventing: "+
a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})}),n;case "create_node":return n=-1===d.inArray(h,b),n||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_04",reason:"Child with name "+h+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})}),n;case "copy_node":return n=-1===d.inArray(h,b),n||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_02",reason:"Child with name "+h+" already exists. Preventing: "+
a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})}),n;case "move_node":return n=f.parent===e.id||-1===d.inArray(h,b),n||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_03",reason:"Child with name "+h+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:g,obj:f&&f.id?f.id:!1,par:e&&e.id?e.id:!1})}),n}return!0};this.create_node=function(a,f,e,g,h){if(!f||f.text===t){null===a&&(a="#");a=this.get_node(a);if(!a)return c.create_node.call(this,
a,f,e,g,h);e=e===t?"last":e;if(!e.toString().match(/^(before|after)$/)&&!h&&!this.is_loaded(a))return c.create_node.call(this,a,f,e,g,h);f||(f={});var b,k,l,n,p,q=this._model.data,u=this.settings.unique.case_sensitive,x=this.settings.unique.duplicate;k=b=this.get_string("New node");l=[];n=0;for(p=a.children.length;n<p;n++)l.push(u?q[a.children[n]].text:q[a.children[n]].text.toLowerCase());for(n=1;-1!==d.inArray(u?k:k.toLowerCase(),l);)k=x.call(this,b,++n).toString();f.text=k}return c.create_node.call(this,
a,f,e,g,h)}};var G=document.createElement("DIV");G.setAttribute("unselectable","on");G.setAttribute("role","presentation");G.className="jstree-wholerow";G.innerHTML="&#160;";d.jstree.plugins.wholerow=function(a,c){this.bind=function(){c.bind.call(this);this.element.on("ready.jstree set_state.jstree",d.proxy(function(){this.hide_dots()},this)).on("init.jstree loading.jstree ready.jstree",d.proxy(function(){this.get_container_ul().addClass("jstree-wholerow-ul")},this)).on("deselect_all.jstree",d.proxy(function(a,
...
(function(d,t){var w=0;d.widget("s3.hierarchicalopts",{options:{selected:null,multiple:!0,leafonly:!0,cascade:!1,bulkSelect:!1,cascadeOptionInTree:!0,noneSelectedText:"Select",selectedText:"selected",noOptionsText:"No options available",selectAllText:"Select All",deselectAllText:"Deselect All",icons:!1,stripes:!0,htmlTitles:!0},_create:function(){var g=d(this.element),l=this.options;this.id=w;w+=1;this._namespace=".hierarchicalopts"+w;this.treeID=g.attr("id")+"-tree";this.input=g.find(".s3-hierarchy-input").first();
this.input.data("input",!0);var p=l.selected;p&&this.input.val(this._stringifySelection(p));this.button=d('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></button>');this.buttonText=d("<span>"+l.noneSelectedText+"</span>").appendTo(this.button);this.noopts=d('<span class="no-options-available">'+l.noOptionsText+"</span>").hide();this.tree=g.find(".s3-hierarchy-tree").first();this.wrapper=this.tree.closest(".s3-hierarchy-wrapper").hide().before(this.noopts).before(this.button).detach().appendTo("body");
this.manualCascadeOption=this._isBulk=this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){d.Widget.prototype.destroy.call(this);this._unbindEvents();d(this.button).remove();d(this.noopts).remove();d(this.tree).detach().appendTo(this.element).show()},refresh:function(){this._unbindEvents();var g=this.options,l=this.tree,p=this;if(l.find("li").length){this.noopts.hide();this.button.show();this.input.next(".error_wrapper").insertAfter(this.button).one("click",function(){d(this).fadeOut()});
var q=this.input.val();if(q){var q=this._parseSelection(q),u=this.treeID;d.each(q,function(){d("#"+u+"-"+this).data("jstree",{selected:!0})})}q=l.find("> ul > li");if(1==q.length){var q=q.first(),t=q.data("jstree");q.data("jstree",d.extend({},t,{opened:!0}))}var q=g.multiple,t=g.leafonly,y=g.cascade,w=!1,z=null,A=["sort","checkbox"];this.input.data("multiple",q);(y||t)&&q?w=!0:q&&(g.cascadeOptionInTree?this.manualCascadeOption=!0:(z=function(g){return l.jstree("is_parent",g)?(d.vakata.context.settings.icons=
!1,{select_all:{label:p.options.selectAllText,icon:!1,action:function(d){p._selectBranch(g)}},deselect_all:{label:p.options.deselectAllText,icon:!1,action:function(d){p._deselectBranch(g)}}}):null},A.push("contextmenu")));l.jstree({core:{themes:{name:"s3",icons:g.icons,stripes:g.stripes},animation:100,multiple:q,check_callback:!0},checkbox:{three_state:w},sort:function(d,g){var l=this.get_text(d)>this.get_text(g)?1:-1,a,c;try{a=this.get_node(d).li_attr.rel}catch(b){a=null}try{c=this.get_node(g).li_attr.rel}catch(b){c=
null}return"bulk"==a?-1:"bulk"==c?1:"none"==a?-1:"none"==c?1:l},contextmenu:{items:z,select_node:!1,icons:!1},plugins:A});var F=jQuery.jstree.reference(l);q&&((g.bulkSelect||this.manualCascadeOption)&&g.cascadeOptionInTree?(this.wrapper.find(".s3-hierarchy-header").hide(),F.create_node("#",{id:this.treeID+"-select-all",text:g.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first")):this.wrapper.find(".s3-hierarchy-header").removeClass("hide").show());l.on("ready.jstree",function(){var d=
F.get_checked();p._updateButtonText(d)});this._bindEvents()}else this.button.hide(),this.noopts.show()},_setOption:function(g,l){if("selected"===g){var p=jQuery.jstree.reference(d(this.tree));if(p!==t&&(p.uncheck_all(),l)){this.input.val(this._stringifySelection(l));var q=this.treeID;d.each(l,function(){p.check_node("#"+q+"-"+this)});this._updateButtonText(l)}}this._super(g,l)},_updateSelectedNodes:function(){var g=jQuery.jstree.reference(d(this.tree)),l=this._parseSelection(this.input.val()),p=[],
q=[],u=this.options.leafonly,t=g.get_checked(!0);d(t).each(function(){var l=d(this).attr("id");if("bulk"!=d(this).attr("rel")&&l&&(!u||g.is_leaf(this))){var t=l.split("-").pop();"None"!=t&&(t=parseInt(t));t&&(p.push(t),q.push(l))}});var t=!1,y=d(p).not(l).get();y.length?t=!0:(y=d(l).not(p).get(),y.length&&(t=!0));l=this.input.val(this._stringifySelection(p));this._updateButtonText(q);t&&(l.change(),d(this.element).trigger("select.s3hierarchy"));return!0},_updateButtonText:function(g){var l=this.options,
p=0;g&&(p=g.length);if(p)if(1<p)g=l.selectedText.replace("#",p);else{for(var q=[],u=0;u<p;u++)q.push(d("#"+g[u]+" > a").text().replace(/^\s+|\s+$/g,""));g=q.length?q.join(" "):l.noneSelectedText}else g=l.noneSelectedText;this.buttonText.text(g)},_updateAndClose:function(){if(!this._isBulk){this._updateSelectedNodes();var d=this.wrapper,l=this;if(l.options.multiple)d.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",function(){window.setTimeout(function(){l.closeMenu()},100)});
else window.setTimeout(function(){l.closeMenu()},100)}},_selectNode:function(g){var l=this.options,p=jQuery.jstree.reference(d(this.tree)),q=l.multiple,u=l.leafonly;if(q)this._isBulk||"bulk"!=g.li_attr.rel||((l=p.get_parent(g))&&"#"!=l?(l=p.get_node(l),this._selectBranch(l,!0)):p.select_all());else{var t=g.id;d(p.get_checked(!0)).each(function(){t!=this.id&&(u&&!p.is_leaf(this)||p.uncheck_node(this))})}if(u&&!q&&!p.is_leaf(g))return p.deselect_node(g),!1;this._updateAndClose()},_deselectNode:function(g){var l=
jQuery.jstree.reference(d(this.tree));if(!this._isBulk){if("bulk"==g.li_attr.rel)(g=l.get_parent(g))&&"#"!=g?(g=l.get_node(g),this._deselectBranch(g,!0)):l.deselect_all();else if(g=l.get_parent(g))if(g=l.get_node(g+"-select-all"))this._isBulk=!0,l.uncheck_node(g),this._isBulk=!1;if(g=l.get_node(this.treeID+"-select-all"))this._isBulk=!0,l.uncheck_node(g),this._isBulk=!1}this._updateSelectedNodes()},_openNode:function(g){var l=jQuery.jstree.reference(d(this.tree)),p=l.get_parent(g);p.length&&l.open_node(p,
!1,!0);if(this.manualCascadeOption){var q=g.id,p=l.get_node(q+"-select-all");p||(g=l.create_node(g,{id:q+"-select-all",text:this.options.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first"),p=l.get_node(g));(g=l.get_node(this.treeID+"-select-all"))&&l.is_checked(g)&&(this._isBulk=!0,l.check_node(p),this._isBulk=!1)}},_selectBranch:function(g,l){var p=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;p.open_node(g,function(){var u=p.get_children_dom(g);d(u).each(function(){q._selectBranch(this)});
l||p.check_node(g)});this._isBulk=!1;this._updateAndClose()},_deselectBranch:function(g,l){var p=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;p.open_node(g,function(){var u=p.get_children_dom(g);d(u).each(function(){q._deselectBranch(this)});l||p.uncheck_node(g)});this._isBulk=!1;this._updateSelectedNodes()},set:function(g){var l=jQuery.jstree.reference(d(this.tree));l.uncheck_all();if(g)for(var p=0,q=g.length,u;p<q;p++)u=d("#"+this.treeID+"-"+g[p]),l.check_node(u)},get:function(){return this._parseSelection(this.input.val())},
reset:function(){this._isBulk=!0;this.tree.jstree("uncheck_all");this._isBulk=!1;this._updateSelectedNodes();return!0},openMenu:function(){this._isOpen&&this.closeMenu();var g=d(this.button),l=g.offset();d(this.wrapper).css({position:"absolute",top:l.top+g.outerHeight(),left:l.left,minWidth:g.outerWidth()-8}).show();d(this.tree).jstree("set_focus");this._isOpen=!0;g.addClass("ui-state-active");d(this).trigger("open")},closeMenu:function(){d(this.tree).jstree("unset_focus").unbind("click.hierarchicalopts").unbind("mouseleave.hierarchicalopts");
d(this.wrapper).fadeOut(50);this._isOpen=!1;d(this.button).removeClass("ui-state-active");d(this).trigger("close")},addNode:function(g,l,p,q){var u=this.tree,t=this.treeID,y="#";g&&(y=d("#"+t+"-"+g),y.length||(y="#"));l=t+"-"+l;u.jstree("create_node",y,{id:l,text:p,li_attr:{rel:"leaf"}},"last");g&&(y.attr({rel:"parent"}),u.jstree("open_node",y));q&&u.jstree("check_node",d("#"+l))},_parseSelection:function(d){if(d)d=JSON.parse(d);else return[];d?d.constructor!==Array&&(d=[d]):d=[];return d},_stringifySelection:function(d){if(!this.options.multiple)if(d.length)d=
d[0];else return"";return JSON.stringify(d)},_bindEvents:function(){var g=this,l=d(this.wrapper),p=d(this.tree),q=d(this.button),u=this._namespace,t=this.options,y=jQuery.jstree.reference(p),w=d.vakata.context.settings.icons;d(document).bind("context_show.vakata",function(){l.unbind("mouseleave.hierarchicalopts");d.vakata.context.settings.icons=w});p.bind("select_node.jstree",function(d,l){g._selectNode(l.node)}).bind("deselect_node.jstree",function(d,l){g._deselectNode(l.node)}).bind("open_node.jstree",
function(d,l){g._openNode(l.node)});q.bind("click"+u,function(){g._isOpen?g.closeMenu():g.openMenu()}).bind("keyup"+u,function(d){d.preventDefault();switch(d.keyCode){case 27:case 38:case 37:g.closeMenu();break;case 39:case 40:g.openMenu()}}).bind("mouseenter"+u,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-hover")}).bind("mouseleave"+u,function(){d(this).removeClass("ui-state-hover")}).bind("focus"+u,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-focus")}).bind("blur"+
u,function(){d(this).removeClass("ui-state-focus")});t.multiple&&t.bulkSelect&&!t.cascadeOptionInTree&&(l.find(".s3-hierarchy-select-all").bind("click"+u,function(d){d.preventDefault();y.select_all();g._updateSelectedNodes()}),l.find(".s3-hierarchy-deselect-all").bind("click"+u,function(d){d.preventDefault();y.deselect_all();g._updateSelectedNodes()}),l.find(".s3-hierarchy-header").bind("click"+u,function(d){d.preventDefault();d.stopPropagation()}).bind("mousedown"+u,function(d){d.preventDefault();
d.stopPropagation()}));d(document).bind("mousedown"+u,function(u){var t=u.target;if(d(".jstree-contextmenu").has(t).length||3==u.which)return l.unbind("mouseleave.hierarchicalopts"),!0;p.is(t)||q.is(t)||0!==p.has(t).length||0!==q.has(t).length||g.closeMenu()});return!0},_unbindEvents:function(){var g=d(this.tree);d(this.button);var l=this._namespace;g.unbind("select_node.jstree").unbind("deselect_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");d(this.button).unbind(l);d(document).unbind(l);
return!0}})})(jQuery);
(function(d,t){var w=0;d.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,addTitle:"Add Record",addLabel:"Add",addURL:null,icons:!1,stripes:!0,htmlTitles:!0},_create:function(){this.treeID=d(this.element).attr("id")+"-tree";this.id=w;w+=1},_init:function(){this.tree=d(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){d.Widget.prototype.destroy.call(this)},refresh:function(){var g=
this.tree,l=this.options;this._unbindEvents();var p=g.find("> ul > li");if(1==p.length){var p=p.first(),q=p.data("jstree");p.data("jstree",d.extend({},q,{opened:!0}))}var u=this;g.jstree({core:{themes:{name:"s3",icons:l.icons,stripes:l.stripes},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(d){return{open:{label:u.options.openLabel,action:function(g){u._openNode(d)},separator_after:!0},edit:{label:u.options.editLabel,action:function(g){u._editNode(d)}},"delete":{label:u.options.deleteLabel,
separator_after:!0,action:function(g){u._deleteNode(d)}},add:{label:u.options.addLabel,action:function(g){u._addNode(d)}}}},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},_openNode:function(d){var g=this.options.openURL;d=d.id;g&&d&&(d=parseInt(d.split("-").pop()))&&(g=g.replace("[id]",d).replace("%5Bid%5D",d),window.location.href=g)},refreshNode:function(g){var l=this.options.ajaxURL,p=g.attr("id");if(l&&p&&(p=parseInt(p.split("-").pop()))){var q=this.tree,u=this.treeID;d.getJSONS3(l+
"?node="+p,function(d){d.label&&q.jstree("rename_node",g,d.label);if(d=d.children){q.jstree("open_node",g,!1,!1);for(var l,p,t,x=0,w=0,H=d.length;w<H;w++)l=d[w],p=u+"-"+l.node,(t=q.jstree("get_node","#"+p,!0))?q.jstree("rename_node",t,l.label):(q.jstree("create_node",g,{id:p,text:l.label,li_attr:{rel:"leaf"}}),x++);x&&(q.jstree("open_node",g),g.attr({rel:"parent"}))}})}},_editNode:function(g){var l=this.options.editURL;g=g.id;if(l&&g){var p=parseInt(g.split("-").pop());p&&(l=l.replace("[id]",p).replace("%5Bid%5D",
p).split("?")[0],l+="?node="+g+"&hierarchy="+this.options.widgetID,g=S3.uid(),l=d('<iframe id="'+g+'" src='+l+" onload=\"S3.popup_loaded('"+g+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(l,this.options.editTitle))}},_addNode:function(g){var l=this.options.addURL;g=g.id;if(l&&g){var p=parseInt(g.split("-").pop());p&&(l=l.split("?")[0],l+="?node="+g+"&link_to_parent="+p+"&hierarchy="+this.options.widgetID,g=S3.uid(),l=d('<iframe id="'+
g+'" src='+l+" onload=\"S3.popup_loaded('"+g+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(l,this.options.addTitle))}},_deleteNode:function(g){if(!confirm(i18n.delete_confirmation))return!1;var l=this.options.deleteURL,p=g.id,q=this.tree;l&&p&&(p=parseInt(p.split("-").pop()))&&(l=l.replace("[id]",p).replace("%5Bid%5D",p).split("?")[0],d.ajaxS3({type:"POST",url:l+"?recursive=1",data:{},dataType:"JSON",success:function(d){q.jstree("delete_node",
g)},error:function(d,g,l){g=d.responseText;if("{"==g[0])try{g=JSON.parse(d.responseText),S3.showAlert(g.message,"error")}catch(B){}}}))},_openPopup:function(g,l){g.dialog({close:function(d,l){if(self.parent){var p=self.parent.$("iframe.ui-dialog-content"),q=p.width();p.width(0);window.setTimeout(function(){p.width(q)},300)}g.remove()},minHeight:480,modal:!0,open:function(l,q){d(".ui-widget-overlay").bind("click",function(){g.dialog("close")})},title:l,minWidth:320,closeText:""})},_bindEvents:function(){return!0},
