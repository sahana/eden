/*
 ...
 requires jQuery jstree 3.0.3
*/
(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):"object"===typeof exports?d(require("jquery")):d(jQuery)})(function(d,r){if(!d.jstree){var F=0,h=!1,l=!1,n=!1,v=[],u=d("script:last").attr("src"),q=document,z=q.createElement("LI"),A;z.setAttribute("role","treeitem");A=q.createElement("I");A.className="jstree-icon jstree-ocl";A.setAttribute("role","presentation");z.appendChild(A);A=q.createElement("A");A.className="jstree-anchor";A.setAttribute("href","#");A.setAttribute("tabindex",
"-1");q=q.createElement("I");q.className="jstree-icon jstree-themeicon";q.setAttribute("role","presentation");A.appendChild(q);z.appendChild(A);A=q=null;d.jstree={version:"3.0.9",defaults:{plugins:[]},plugins:{},path:u&&-1!==u.indexOf("/")?u.replace(/\/[^\/]+$/,""):"",idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g};d.jstree.create=function(a,b){var e=new d.jstree.core(++F),k=b;b=d.extend(!0,{},d.jstree.defaults,b);k&&k.plugins&&(b.plugins=k.plugins);d.each(b.plugins,function(a,k){"core"!==a&&
(e=e.plugin(k,b[k]))});e.init(a,b);return e};d.jstree.destroy=function(){d(".jstree:jstree").jstree("destroy");d(document).off(".jstree")};d.jstree.core=function(a){this._id=a;this._cnt=0;this._wrk=null;this._data={core:{themes:{name:!1,dots:!1,icons:!1},selected:[],last_error:{},working:!1,worker_queue:[],focused:null}}};d.jstree.reference=function(a){var b=null,e=null;a&&a.id&&(a=a.id);if(!e||!e.length)try{e=d(a)}catch(k){}if(!e||!e.length)try{e=d("#"+a.replace(d.jstree.idregex,"\\$&"))}catch(k){}e&&
e.length&&(e=e.closest(".jstree")).length&&(e=e.data("jstree"))?b=e:d(".jstree").each(function(){var e=d(this).data("jstree");if(e&&e._model.data[a])return b=e,!1});return b};d.fn.jstree=function(a){var b="string"===typeof a,e=Array.prototype.slice.call(arguments,1),k=null;if(!0===a&&!this.length)return!1;this.each(function(){var c=d.jstree.reference(this),g=b&&c?c[a]:null;k=b&&g?g.apply(c,e):null;c||b||a!==r&&!d.isPlainObject(a)||d(this).data("jstree",new d.jstree.create(this,a));if(c&&!b||!0===
a)k=c||!1;if(null!==k&&k!==r)return!1});return null!==k&&k!==r?k:this};d.expr[":"].jstree=d.expr.createPseudo(function(a){return function(a){return d(a).hasClass("jstree")&&d(a).data("jstree")!==r}});d.jstree.defaults.core={data:!1,strings:!1,check_callback:!1,error:d.noop,animation:200,multiple:!0,themes:{name:!1,url:!1,dir:!1,dots:!0,icons:!0,stripes:!1,variant:!1,responsive:!1},expand_selected_onload:!0,worker:!0,force_text:!1,dblclick_toggle:!0};d.jstree.core.prototype={plugin:function(a,b){var e=
...
b.children():b;var k=a.id,c=[],g=[],f=this._model.data,t=f[k];a=this._data.core.selected.length;var m,w;b.each(d.proxy(function(a,e){if(m=this._parse_model_from_html(d(e),k,t.parents.concat()))c.push(m),g.push(m),f[m].children_d.length&&(g=g.concat(f[m].children_d))},this));t.children=c;t.children_d=g;b=0;for(w=t.parents.length;b<w;b++)f[t.parents[b]].children_d=f[t.parents[b]].children_d.concat(g);this.trigger("model",{nodes:g,parent:k});"#"!==k?(this._node_changed(k),this.redraw()):(this.get_container_ul().children(".jstree-initial-node").remove(),
...
d=[],f=[],g=a.df,t=a.t_id,h=a.t_cnt,l=a.m,n=l[b],u=a.sel,v,q,r,x=function(a,c,b){b=b?b.concat():[];c&&b.unshift(c);var k=a.id.toString(),d,m,p;c={id:k,text:a.text||"",icon:a.icon!==e?a.icon:!0,parent:c,parents:b,children:a.children||[],children_d:a.children_d||[],data:a.data,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(d in g)g.hasOwnProperty(d)&&(c.state[d]=g[d]);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(c.icon=a.data.jstree.icon);if(a&&a.data&&(c.data=a.data,a.data.jstree))for(d in a.data.jstree)a.data.jstree.hasOwnProperty(d)&&
(c.state[d]=a.data.jstree[d]);if(a&&"object"===typeof a.state)for(d in a.state)a.state.hasOwnProperty(d)&&(c.state[d]=a.state[d]);if(a&&"object"===typeof a.li_attr)for(d in a.li_attr)a.li_attr.hasOwnProperty(d)&&(c.li_attr[d]=a.li_attr[d]);c.li_attr.id||(c.li_attr.id=k);if(a&&"object"===typeof a.a_attr)for(d in a.a_attr)a.a_attr.hasOwnProperty(d)&&(c.a_attr[d]=a.a_attr[d]);a&&a.children&&!0===a.children&&(c.state.loaded=!1,c.children=[],c.children_d=[]);l[c.id]=c;d=0;for(k=c.children.length;d<k;d++)m=
x(l[c.children[d]],c.id,b),p=l[m],c.children_d.push(m),p.children_d.length&&(c.children_d=c.children_d.concat(p.children_d));delete a.data;delete a.children;l[c.id].original=a;c.state.selected&&f.push(c.id);return c.id},z=function(a,c,b){b=b?b.concat():[];c&&b.unshift(c);var k,d,m,p;do k="j"+t+"_"+ ++h;while(l[k]);c={id:!1,text:"string"===typeof a?a:"",icon:"object"===typeof a&&a.icon!==e?a.icon:!0,parent:c,parents:b,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};
for(d in g)g.hasOwnProperty(d)&&(c.state[d]=g[d]);a&&a.id&&(c.id=a.id.toString());a&&a.text&&(c.text=a.text);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(c.icon=a.data.jstree.icon);if(a&&a.data&&(c.data=a.data,a.data.jstree))for(d in a.data.jstree)a.data.jstree.hasOwnProperty(d)&&(c.state[d]=a.data.jstree[d]);if(a&&"object"===typeof a.state)for(d in a.state)a.state.hasOwnProperty(d)&&(c.state[d]=a.state[d]);if(a&&"object"===typeof a.li_attr)for(d in a.li_attr)a.li_attr.hasOwnProperty(d)&&(c.li_attr[d]=
a.li_attr[d]);c.li_attr.id&&!c.id&&(c.id=c.li_attr.id.toString());c.id||(c.id=k);c.li_attr.id||(c.li_attr.id=c.id);if(a&&"object"===typeof a.a_attr)for(d in a.a_attr)a.a_attr.hasOwnProperty(d)&&(c.a_attr[d]=a.a_attr[d]);if(a&&a.children&&a.children.length){d=0;for(k=a.children.length;d<k;d++)m=z(a.children[d],c.id,b),p=l[m],c.children.push(m),p.children_d.length&&(c.children_d=c.children_d.concat(p.children_d));c.children_d=c.children_d.concat(c.children)}a&&a.children&&!0===a.children&&(c.state.loaded=
!1,c.children=[],c.children_d=[]);delete a.data;delete a.children;c.original=a;l[c.id]=c;c.state.selected&&f.push(c.id);return c.id};if(c.length&&c[0].id!==e&&c[0].parent!==e){q=0;for(r=c.length;q<r;q++)c[q].children||(c[q].children=[]),l[c[q].id.toString()]=c[q];q=0;for(r=c.length;q<r;q++)l[c[q].parent.toString()].children.push(c[q].id.toString()),n.children_d.push(c[q].id.toString());q=0;for(r=n.children.length;q<r;q++)v=x(l[n.children[q]],b,n.parents.concat()),d.push(v),l[v].children_d.length&&
(d=d.concat(l[v].children_d))}else{q=0;for(r=c.length;q<r;q++)if(v=z(c[q],b,n.parents.concat()))k.push(v),d.push(v),l[v].children_d.length&&(d=d.concat(l[v].children_d));n.children=k;n.children_d=d}q=0;for(r=n.parents.length;q<r;q++)l[n.parents[q]].children_d=l[n.parents[q]].children_d.concat(d);c={cnt:h,mod:l,sel:u,par:b,dpc:d,add:f};if("undefined"===typeof window||"undefined"===typeof window.document)postMessage(c);else return c},t=function(a,c){this._cnt=a.cnt;this._model.data=a.mod;if(c){var b,
k,f=a.add,g=a.sel,t=this._data.core.selected.slice(),h=this._model.data;if(g.length!==t.length||d.vakata.array_unique(g.concat(t)).length!==g.length){b=0;for(k=g.length;b<k;b++)-1===d.inArray(g[b],f)&&-1===d.inArray(g[b],t)&&(h[g[b]].state.selected=!1);b=0;for(k=t.length;b<k;b++)-1===d.inArray(t[b],g)&&(h[t[b]].state.selected=!0)}}a.add.length&&(this._data.core.selected=this._data.core.selected.concat(a.add));this.trigger("model",{nodes:a.dpc,parent:a.par});"#"!==a.par?(this._node_changed(a.par),
this.redraw()):this.redraw(!0);a.add.length&&this.trigger("changed",{action:"model",selected:this._data.core.selected});e.call(this,!0)};if(this.settings.core.worker&&window.Blob&&window.URL&&window.Worker)try{null===this._wrk&&(this._wrk=window.URL.createObjectURL(new window.Blob(["self.onmessage = "+f.toString()],{type:"text/javascript"}))),!this._data.core.working||k?(this._data.core.working=!0,c=new window.Worker(this._wrk),c.onmessage=d.proxy(function(a){t.call(this,a.data,!0);try{c.terminate(),
c=null}catch(e){}this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):this._data.core.working=!1},this),g.par?c.postMessage(g):this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):this._data.core.working=!1):this._data.core.worker_queue.push([a,b,e,!0])}catch(m){t.call(this,f(g),!1),this._data.core.worker_queue.length?this._append_json_data.apply(this,this._data.core.worker_queue.shift()):
this._data.core.working=!1}else t.call(this,f(g),!1)},_parse_model_from_html:function(a,b,e){e=e?[].concat(e):[];b&&e.unshift(b);var k,c,g=this._model.data,f={id:!1,text:!1,icon:!0,parent:b,parents:e,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1},t;for(t in this._model.default_state)this._model.default_state.hasOwnProperty(t)&&(f.state[t]=this._model.default_state[t]);b=d.vakata.attributes(a,!0);d.each(b,function(a,e){e=d.trim(e);if(!e.length)return!0;
...
f.state.disabled=a.children("a").hasClass("jstree-disabled");if(f.data&&f.data.jstree)for(t in f.data.jstree)f.data.jstree.hasOwnProperty(t)&&(f.state[t]=f.data.jstree[t]);b=a.children("a").children(".jstree-themeicon");b.length&&(f.icon=b.hasClass("jstree-themeicon-hidden")?!1:b.attr("rel"));f.state.icon&&(f.icon=f.state.icon);b=a.children("ul").children("li");do t="j"+this._id+"_"+ ++this._cnt;while(g[t]);f.id=f.li_attr.id?f.li_attr.id.toString():t;b.length?(b.each(d.proxy(function(a,b){k=this._parse_model_from_html(d(b),
...
k;c++)d=this._parse_model_from_json(a.children[c],b.id,e),f=t[d],b.children.push(d),f.children_d.length&&(b.children_d=b.children_d.concat(f.children_d));b.children_d=b.children_d.concat(b.children)}a&&a.children&&!0===a.children&&(b.state.loaded=!1,b.children=[],b.children_d=[]);delete a.data;delete a.children;b.original=a;t[b.id]=b;b.state.selected&&this._data.core.selected.push(b.id);return b.id},_redraw:function(){var a=this._model.force_full_redraw?this._model.data["#"].children.concat([]):this._model.changed.concat([]),
...
null);this._model.force_full_redraw=!1;this._model.changed=[];this.trigger("redraw",{nodes:a})},redraw:function(a){a&&(this._model.force_full_redraw=!0);this._redraw()},draw_children:function(a){var b=this.get_node(a),e,k,c;e=document;if(!b)return!1;if("#"===b.id)return this.redraw(!0);a=this.get_node(a,!0);if(!a||!a.length)return!1;a.children(".jstree-children").remove();a=a[0];if(b.children.length&&b.state.loaded){c=e.createElement("UL");c.setAttribute("role","group");c.className="jstree-children";
e=0;for(k=b.children.length;e<k;e++)c.appendChild(this.redraw_node(b.children[e],!0,!0));a.appendChild(c)}},redraw_node:function(a,b,e,k){var c=this.get_node(a),g=!1,f=!1,t=!1,m=!1,w=!1,p=!1,h="",l=document,p=this._model.data,n=!1,q=null,B=h=0;if(!c)return!1;if("#"===c.id)return this.redraw(!0);b=b||0===c.children.length;if(a=document.querySelector?this.element[0].querySelector("#"+(-1!=="0123456789".indexOf(c.id[0])?"\\3"+c.id[0]+" "+c.id.substr(1).replace(d.jstree.idregex,"\\$&"):c.id.replace(d.jstree.idregex,
"\\$&"))):document.getElementById(c.id))a=d(a),e||(g=a.parent().parent()[0],g===this.element[0]&&(g=null),f=a.index()),b||!c.children.length||a.children(".jstree-children").length||(b=!0),b||(t=a.children(".jstree-children")[0]),n=a.children(".jstree-anchor")[0]===document.activeElement,a.remove();else if(b=!0,!e){g="#"!==c.parent?d("#"+c.parent.replace(d.jstree.idregex,"\\$&"),this.element)[0]:null;if(!(null===g||g&&p[c.parent].state.opened))return!1;f=d.inArray(c.id,null===g?p["#"].children:p[c.parent].children)}a=
z.cloneNode(!0);h="jstree-node ";for(m in c.li_attr)c.li_attr.hasOwnProperty(m)&&"id"!==m&&("class"!==m?a.setAttribute(m,c.li_attr[m]):h+=c.li_attr[m]);c.a_attr.id||(c.a_attr.id=c.id+"_anchor");a.setAttribute("aria-selected",!!c.state.selected);a.setAttribute("aria-level",c.parents.length);a.setAttribute("aria-labelledby",c.a_attr.id);c.state.disabled&&a.setAttribute("aria-disabled",!0);c.state.loaded&&!c.children.length?h+=" jstree-leaf":(h+=c.state.opened&&c.state.loaded?" jstree-open":" jstree-closed",
a.setAttribute("aria-expanded",c.state.opened&&c.state.loaded));null!==c.parent&&p[c.parent].children[p[c.parent].children.length-1]===c.id&&(h+=" jstree-last");a.id=c.id;a.className=h;h=(c.state.selected?" jstree-clicked":"")+(c.state.disabled?" jstree-disabled":"");for(w in c.a_attr)!c.a_attr.hasOwnProperty(w)||"href"===w&&"#"===c.a_attr[w]||("class"!==w?a.childNodes[1].setAttribute(w,c.a_attr[w]):h+=" "+c.a_attr[w]);h.length&&(a.childNodes[1].className="jstree-anchor "+h);if(c.icon&&!0!==c.icon||
...
a.childNodes[1].appendChild(l.createTextNode(c.text)):a.childNodes[1].innerHTML+=c.text;if(b&&c.children.length&&(c.state.opened||k)&&c.state.loaded){p=l.createElement("UL");p.setAttribute("role","group");p.className="jstree-children";m=0;for(w=c.children.length;m<w;m++)p.appendChild(this.redraw_node(c.children[m],b,!0));a.appendChild(p)}t&&a.appendChild(t);if(!e){g||(g=this.element[0]);m=0;for(w=g.childNodes.length;m<w;m++)if(g.childNodes[m]&&g.childNodes[m].className&&-1!==g.childNodes[m].className.indexOf("jstree-children")){q=
g.childNodes[m];break}q||(q=l.createElement("UL"),q.setAttribute("role","group"),q.className="jstree-children",g.appendChild(q));g=q;f<g.childNodes.length?g.insertBefore(a,g.childNodes[f]):g.appendChild(a);n&&(h=this.element[0].scrollTop,B=this.element[0].scrollLeft,a.childNodes[1].focus(),this.element[0].scrollTop=h,this.element[0].scrollLeft=B)}c.state.opened&&!c.state.loaded&&(c.state.opened=!1,setTimeout(d.proxy(function(){this.open_node(c.id,!1,0)},this),0));return a},open_node:function(a,b,
e){var k,c,g;if(d.isArray(a)){a=a.slice();k=0;for(c=a.length;k<c;k++)this.open_node(a[k],b,e);return!0}a=this.get_node(a);if(!a||"#"===a.id)return!1;e=e===r?this.settings.core.animation:e;if(!this.is_closed(a))return b&&b.call(this,a,!1),!1;if(this.is_loaded(a))k=this.get_node(a,!0),g=this,k.length&&(e&&k.children(".jstree-children").length&&k.children(".jstree-children").stop(!0,!0),a.children.length&&!this._firstChild(k.children(".jstree-children")[0])&&this.draw_children(a),e?(this.trigger("before_open",
...
return!1}if(a.core.scroll)return a.core.scroll&&a.core.scroll.left!==r&&this.element.scrollLeft(a.core.scroll.left),a.core.scroll&&a.core.scroll.top!==r&&this.element.scrollTop(a.core.scroll.top),delete a.core.scroll,this.set_state(a,b),!1;if(a.core.selected)return g=this,this.deselect_all(),d.each(a.core.selected,function(a,e){g.select_node(e)}),delete a.core.selected,this.set_state(a,b),!1;if(d.isEmptyObject(a.core))return delete a.core,this.set_state(a,b),!1}return d.isEmptyObject(a)?(a=null,b&&
...
g;c++)b&&b.flat?this.get_json(a.children[c],b,e):k.children.push(this.get_json(a.children[c],b));return b&&b.flat?e:"#"===a.id?k.children:k},create_node:function(a,b,e,k,c){null===a&&(a="#");a=this.get_node(a);if(!a)return!1;e=e===r?"last":e;if(!e.toString().match(/^(before|after)$/)&&!c&&!this.is_loaded(a))return this.load_node(a,function(){this.create_node(a,b,e,k,!0)});b||(b={text:this.get_string("New node")});"string"===typeof b&&(b={text:b});b.text===r&&(b.text=this.get_string("New node"));var g,
f,t;"#"===a.id&&("before"===e&&(e="first"),"after"===e&&(e="last"));switch(e){case "before":c=this.get_node(a.parent);e=d.inArray(a.id,c.children);a=c;break;case "after":c=this.get_node(a.parent);e=d.inArray(a.id,c.children)+1;a=c;break;case "inside":case "first":e=0;break;case "last":e=a.children.length;break;default:e||(e=0)}e>a.children.length&&(e=a.children.length);b.id||(b.id=!0);if(!this.check("create_node",b,a,e))return this.settings.core.error.call(this,this._data.core.last_error),!1;!0===
b.id&&delete b.id;b=this._parse_model_from_json(b,a.id,a.parents.concat());if(!b)return!1;c=this.get_node(b);g=[];g.push(b);g=g.concat(c.children_d);this.trigger("model",{nodes:g,parent:a.id});a.children_d=a.children_d.concat(g);f=0;for(t=a.parents.length;f<t;f++)this._model.data[a.parents[f]].children_d=this._model.data[a.parents[f]].children_d.concat(g);b=c;c=[];f=0;for(t=a.children.length;f<t;f++)c[f>=e?f+1:f]=a.children[f];c[e]=b.id;a.children=c;this.redraw_node(a,!0);k&&k.call(this,this.get_node(b));
...
e,k,c,g,f,t,m;if(d.isArray(a)){a=a.slice();b=0;for(e=a.length;b<e;b++)this.delete_node(a[b]);return!0}a=this.get_node(a);if(!a||"#"===a.id)return!1;b=this.get_node(a.parent);e=d.inArray(a.id,b.children);m=!1;if(!this.check("delete_node",a,b,e))return this.settings.core.error.call(this,this._data.core.last_error),!1;-1!==e&&(b.children=d.vakata.array_remove(b.children,e));k=a.children_d.concat([]);k.push(a.id);f=0;for(t=k.length;f<t;f++){c=0;for(g=a.parents.length;c<g;c++)e=d.inArray(k[f],this._model.data[a.parents[c]].children_d),
-1!==e&&(this._model.data[a.parents[c]].children_d=d.vakata.array_remove(this._model.data[a.parents[c]].children_d,e));this._model.data[k[f]].state.selected&&(m=!0,e=d.inArray(k[f],this._data.core.selected),-1!==e&&(this._data.core.selected=d.vakata.array_remove(this._data.core.selected,e)))}this.trigger("delete_node",{node:a,parent:b.id});m&&this.trigger("changed",{action:"delete_node",node:a,selected:this._data.core.selected,parent:b.id});f=0;for(t=k.length;f<t;f++)delete this._model.data[k[f]];
...
a,data:JSON.stringify({chk:a,pos:k,obj:b&&b.id?b.id:!1,par:e&&e.id?e.id:!1})},!1):!0},last_error:function(){return this._data.core.last_error},move_node:function(a,b,e,k,c,g){var f,t,m,w,p,h,l,n,q,B;b=this.get_node(b);e=e===r?0:e;if(!b)return!1;if(!e.toString().match(/^(before|after)$/)&&!c&&!this.is_loaded(b))return this.load_node(b,function(){this.move_node(a,b,e,k,!0)});if(d.isArray(a)){a=a.slice();g=0;for(f=a.length;g<f;g++)this.move_node(a[g],b,e,k,c,!0)&&(b=a[g],e="after");this.redraw();return!0}a=
a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;f=(a.parent||"#").toString();m=e.toString().match(/^(before|after)$/)&&"#"!==b.id?this.get_node(b.parent):b;w=a.instance?a.instance:this._model.data[a.id]?this:d.jstree.reference(a.id);p=!w||!w._id||this._id!==w._id;t=w&&w._id&&f&&w._model.data[f]&&w._model.data[f].children?d.inArray(a.id,w._model.data[f].children):-1;if(p)return this.copy_node(a,b,e,k,c)?(w&&w.delete_node(a),!0):!1;"#"===b.id&&("before"===e&&(e="first"),"after"===e&&(e="last"));
switch(e){case "before":e=d.inArray(b.id,m.children);break;case "after":e=d.inArray(b.id,m.children)+1;break;case "inside":case "first":e=0;break;case "last":e=m.children.length;break;default:e||(e=0)}e>m.children.length&&(e=m.children.length);if(!this.check("move_node",a,m,e,{core:!0,is_multi:w&&w._id&&w._id!==this._id,is_foreign:!w||!w._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;if(a.parent===m.id){c=m.children.concat();p=d.inArray(a.id,c);-1!==p&&(c=d.vakata.array_remove(c,
p),e>p&&e--);p=[];h=0;for(l=c.length;h<l;h++)p[h>=e?h+1:h]=c[h];p[e]=a.id;m.children=p;this._node_changed(m.id);this.redraw("#"===m.id)}else{p=a.children_d.concat();p.push(a.id);h=0;for(l=a.parents.length;h<l;h++){c=[];B=w._model.data[a.parents[h]].children_d;n=0;for(q=B.length;n<q;n++)-1===d.inArray(B[n],p)&&c.push(B[n]);w._model.data[a.parents[h]].children_d=c}w._model.data[f].children=d.vakata.array_remove_item(w._model.data[f].children,a.id);h=0;for(l=m.parents.length;h<l;h++)this._model.data[m.parents[h]].children_d=
this._model.data[m.parents[h]].children_d.concat(p);c=[];h=0;for(l=m.children.length;h<l;h++)c[h>=e?h+1:h]=m.children[h];c[e]=a.id;m.children=c;m.children_d.push(a.id);m.children_d=m.children_d.concat(a.children_d);a.parent=m.id;p=m.parents.concat();p.unshift(m.id);B=a.parents.length;a.parents=p;p=p.concat();h=0;for(l=a.children_d.length;h<l;h++)this._model.data[a.children_d[h]].parents=this._model.data[a.children_d[h]].parents.slice(0,-1*B),Array.prototype.push.apply(this._model.data[a.children_d[h]].parents,
p);if("#"===f||"#"===m.id)this._model.force_full_redraw=!0;this._model.force_full_redraw||(this._node_changed(f),this._node_changed(m.id));g||this.redraw()}k&&k.call(this,a,m,e);this.trigger("move_node",{node:a,parent:m.id,position:e,old_parent:f,old_position:t,is_multi:w&&w._id&&w._id!==this._id,is_foreign:!w||!w._id,old_instance:w,new_instance:this});return!0},copy_node:function(a,b,e,k,c,g){var f,t,m,h,p,l;b=this.get_node(b);e=e===r?0:e;if(!b)return!1;if(!e.toString().match(/^(before|after)$/)&&
!c&&!this.is_loaded(b))return this.load_node(b,function(){this.copy_node(a,b,e,k,!0)});if(d.isArray(a)){a=a.slice();g=0;for(f=a.length;g<f;g++)if(t=this.copy_node(a[g],b,e,k,c,!0))b=t,e="after";this.redraw();return!0}a=a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;f=(a.parent||"#").toString();p=e.toString().match(/^(before|after)$/)&&"#"!==b.id?this.get_node(b.parent):b;l=a.instance?a.instance:this._model.data[a.id]?this:d.jstree.reference(a.id);"#"===b.id&&("before"===e&&(e="first"),"after"===
e&&(e="last"));switch(e){case "before":e=d.inArray(b.id,p.children);break;case "after":e=d.inArray(b.id,p.children)+1;break;case "inside":case "first":e=0;break;case "last":e=p.children.length;break;default:e||(e=0)}e>p.children.length&&(e=p.children.length);if(!this.check("copy_node",a,p,e,{core:!0,is_multi:l&&l._id&&l._id!==this._id,is_foreign:!l||!l._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;m=l?l.get_json(a,{no_id:!0,no_data:!0,no_state:!0}):a;if(!m)return!1;
!0===m.id&&delete m.id;m=this._parse_model_from_json(m,p.id,p.parents.concat());if(!m)return!1;t=this.get_node(m);a&&a.state&&!1===a.state.loaded&&(t.state.loaded=!1);c=[];c.push(m);c=c.concat(t.children_d);this.trigger("model",{nodes:c,parent:p.id});m=0;for(h=p.parents.length;m<h;m++)this._model.data[p.parents[m]].children_d=this._model.data[p.parents[m]].children_d.concat(c);c=[];m=0;for(h=p.children.length;m<h;m++)c[m>=e?m+1:m]=p.children[m];c[e]=t.id;p.children=c;p.children_d.push(t.id);p.children_d=
p.children_d.concat(t.children_d);"#"===p.id&&(this._model.force_full_redraw=!0);this._model.force_full_redraw||this._node_changed(p.id);g||this.redraw("#"===p.id);k&&k.call(this,t,p,e);this.trigger("copy_node",{node:t,original:a,parent:p.id,position:e,old_parent:f,old_position:l&&l._id&&f&&l._model.data[f]&&l._model.data[f].children?d.inArray(a.id,l._model.data[f].children):-1,is_multi:l&&l._id&&l._id!==this._id,is_foreign:!l||!l._id,old_instance:l,new_instance:this});return t.id},cut:function(a){a||
(a=this._data.core.selected.concat());d.isArray(a)||(a=[a]);if(!a.length)return!1;var b=[],e,k,c;k=0;for(c=a.length;k<c;k++)(e=this.get_node(a[k]))&&e.id&&"#"!==e.id&&b.push(e);if(!b.length)return!1;h=b;n=this;l="move_node";this.trigger("cut",{node:a})},copy:function(a){a||(a=this._data.core.selected.concat());d.isArray(a)||(a=[a]);if(!a.length)return!1;var b=[],e,k,c;k=0;for(c=a.length;k<c;k++)(e=this.get_node(a[k]))&&e.id&&"#"!==e.id&&b.push(e);if(!b.length)return!1;h=b;n=this;l="copy_node";this.trigger("copy",
{node:a})},get_buffer:function(){return{mode:l,node:h,inst:n}},can_paste:function(){return!1!==l&&!1!==h},paste:function(a,b){a=this.get_node(a);if(!(a&&l&&l.match(/^(copy_node|move_node)$/)&&h))return!1;this[l](h,a,b)&&this.trigger("paste",{parent:a.id,node:h,mode:l});n=l=h=!1},clear_buffer:function(){n=l=h=!1;this.trigger("clear_buffer")},edit:function(a,b){a=this.get_node(a);if(!a)return!1;if(!1===this.settings.core.check_callback)return this._data.core.last_error={error:"check",plugin:"core",
id:"core_07",reason:"Could not edit node because of check_callback"},this.settings.core.error.call(this,this._data.core.last_error),!1;b="string"===typeof b?b:a.text;this.set_text(a,"");a=this._open_to(a);var e=this._data.core.rtl,k=this.element.width(),c=a.children(".jstree-anchor"),g=d("<span>"),f=b,t=d("<div />",{css:{position:"absolute",top:"-200px",left:e?"0px":"-1000px",visibility:"hidden"}}).appendTo("body"),m=d("<input />",{value:f,"class":"jstree-rename-input",css:{padding:"0",border:"1px solid silver",
"box-sizing":"border-box",display:"inline-block",height:this._data.core.li_height+"px",lineHeight:this._data.core.li_height+"px",width:"150px"},blur:d.proxy(function(){var e=g.children(".jstree-rename-input").val();""===e&&(e=f);t.remove();g.replaceWith(c);g.remove();this.set_text(a,f);!1===this.rename_node(a,d("<div></div>").text(e)[this.settings.core.force_text?"text":"html"]())&&this.set_text(a,f)},this),keydown:function(a){var e=a.which;27===e&&(this.value=f);27!==e&&13!==e&&37!==e&&38!==e&&39!==
e&&40!==e&&32!==e||a.stopImmediatePropagation();if(27===e||13===e)a.preventDefault(),this.blur()},click:function(a){a.stopImmediatePropagation()},mousedown:function(a){a.stopImmediatePropagation()},keyup:function(a){m.width(Math.min(t.text("pW"+this.value).width(),k))},keypress:function(a){if(13===a.which)return!1}}),e={fontFamily:c.css("fontFamily")||"",fontSize:c.css("fontSize")||"",fontWeight:c.css("fontWeight")||"",fontStyle:c.css("fontStyle")||"",fontStretch:c.css("fontStretch")||"",fontVariant:c.css("fontVariant")||
"",letterSpacing:c.css("letterSpacing")||"",wordSpacing:c.css("wordSpacing")||""};g.attr("class",c.attr("class")).append(c.contents().clone()).append(m);c.replaceWith(g);t.css(e);m.css(e).width(Math.min(t.text("pW"+m[0].value).width(),k))[0].select()},set_theme:function(a,b){if(!a)return!1;if(!0===b){var e=this.settings.core.themes.dir;e||(e=d.jstree.path+"/themes");b=e+"/"+a+"/style.css"}b&&-1===d.inArray(b,v)&&(d("head").append('<link rel="stylesheet" href="'+b+'" type="text/css" />'),v.push(b));
...
return!0}};d.vakata={};d.vakata.attributes=function(a,b){a=d(a)[0];var e=b?{}:[];a&&a.attributes&&d.each(a.attributes,function(a,c){-1===d.inArray(c.name.toLowerCase(),["style","contenteditable","hasfocus","tabindex"])&&null!==c.value&&""!==d.trim(c.value)&&(b?e[c.name]=c.value:e.push(c.name))});return e};d.vakata.array_unique=function(a){var b=[],e,k,c;e=0;for(c=a.length;e<c;e++){for(k=0;k<=e&&a[e]!==a[k];k++);k===e&&b.push(a[e])}return b};d.vakata.array_remove=function(a,b,e){e=a.slice((e||b)+1||
a.length);a.length=0>b?a.length+b:b;a.push.apply(a,e);return a};d.vakata.array_remove_item=function(a,b){var e=d.inArray(b,a);return-1!==e?d.vakata.array_remove(a,e):a};var x=document.createElement("I");x.className="jstree-icon jstree-checkbox";x.setAttribute("role","presentation");d.jstree.defaults.checkbox={visible:!0,three_state:!0,whole_node:!0,keep_selected_style:!0,cascade:"",tie_selection:!0};d.jstree.plugins.checkbox=function(a,b){this.bind=function(){b.bind.call(this);this._data.checkbox.uto=
...
b){var c=this._model.data,d=b.nodes,f,t;f=0;for(t=d.length;f<t;f++)c[d[f]].state.checked=c[d[f]].original&&c[d[f]].original.state&&c[d[f]].original.state.checked,c[d[f]].state.checked&&this._data.checkbox.selected.push(d[f])},this));if(-1!==this.settings.checkbox.cascade.indexOf("up")||-1!==this.settings.checkbox.cascade.indexOf("down"))this.element.on("model.jstree",d.proxy(function(a,b){var c=this._model.data,g=c[b.parent],f=b.nodes,t=[],m,h,p,l,n=this.settings.checkbox.cascade,q=this.settings.checkbox.tie_selection;
if(-1!==n.indexOf("down"))if(g.state[q?"selected":"checked"]){m=0;for(h=f.length;m<h;m++)c[f[m]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(f)}else for(m=0,h=f.length;m<h;m++)if(c[f[m]].state[q?"selected":"checked"]){p=0;for(l=c[f[m]].children_d.length;p<l;p++)c[c[f[m]].children_d[p]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(c[f[m]].children_d)}if(-1!==
n.indexOf("up")){m=0;for(h=g.children_d.length;m<h;m++)c[g.children_d[m]].children.length||t.push(c[g.children_d[m]].parent);t=d.vakata.array_unique(t);p=0;for(l=t.length;p<l;p++)for(g=c[t[p]];g&&"#"!==g.id;){m=f=0;for(h=g.children.length;m<h;m++)f+=c[g.children[m]].state[q?"selected":"checked"];if(f===h)g.state[q?"selected":"checked"]=!0,this._data[q?"core":"checkbox"].selected.push(g.id),(m=this.get_node(g,!0))&&m.length&&m.attr("aria-selected",!0).children(".jstree-anchor").addClass(q?"jstree-clicked":
"jstree-checked");else break;g=this.get_node(g.parent)}}this._data[q?"core":"checkbox"].selected=d.vakata.array_unique(this._data[q?"core":"checkbox"].selected)},this)).on(this.settings.checkbox.tie_selection?"select_node.jstree":"check_node.jstree",d.proxy(function(a,b){var c=b.node,g=this._model.data,f=this.get_node(c.parent),t=this.get_node(c,!0),m,h,p,l=this.settings.checkbox.cascade,n=this.settings.checkbox.tie_selection;if(-1!==l.indexOf("down"))for(this._data[n?"core":"checkbox"].selected=
d.vakata.array_unique(this._data[n?"core":"checkbox"].selected.concat(c.children_d)),m=0,h=c.children_d.length;m<h;m++)p=g[c.children_d[m]],p.state[n?"selected":"checked"]=!0,p&&p.original&&p.original.state&&p.original.state.undetermined&&(p.original.state.undetermined=!1);if(-1!==l.indexOf("up"))for(;f&&"#"!==f.id;){m=c=0;for(h=f.children.length;m<h;m++)c+=g[f.children[m]].state[n?"selected":"checked"];if(c===h)f.state[n?"selected":"checked"]=!0,this._data[n?"core":"checkbox"].selected.push(f.id),
(p=this.get_node(f,!0))&&p.length&&p.attr("aria-selected",!0).children(".jstree-anchor").addClass(n?"jstree-clicked":"jstree-checked");else break;f=this.get_node(f.parent)}-1!==l.indexOf("down")&&t.length&&t.find(".jstree-anchor").addClass(n?"jstree-clicked":"jstree-checked").parent().attr("aria-selected",!0)},this)).on(this.settings.checkbox.tie_selection?"deselect_all.jstree":"uncheck_all.jstree",d.proxy(function(a,b){var c=this.get_node("#"),d=this._model.data,f,t,m;f=0;for(t=c.children_d.length;f<
t;f++)(m=d[c.children_d[f]])&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1)},this)).on(this.settings.checkbox.tie_selection?"deselect_node.jstree":"uncheck_node.jstree",d.proxy(function(a,b){var c=b.node,g=this.get_node(c,!0),f,t,m,h=this.settings.checkbox.cascade,p=this.settings.checkbox.tie_selection;c&&c.original&&c.original.state&&c.original.state.undetermined&&(c.original.state.undetermined=!1);if(-1!==h.indexOf("down"))for(f=0,t=c.children_d.length;f<
t;f++)m=this._model.data[c.children_d[f]],m.state[p?"selected":"checked"]=!1,m&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1);if(-1!==h.indexOf("up"))for(f=0,t=c.parents.length;f<t;f++)m=this._model.data[c.parents[f]],m.state[p?"selected":"checked"]=!1,m&&m.original&&m.original.state&&m.original.state.undetermined&&(m.original.state.undetermined=!1),(m=this.get_node(c.parents[f],!0))&&m.length&&m.attr("aria-selected",!1).children(".jstree-anchor").removeClass(p?
"jstree-clicked":"jstree-checked");m=[];f=0;for(t=this._data[p?"core":"checkbox"].selected.length;f<t;f++)-1!==h.indexOf("down")&&-1!==d.inArray(this._data[p?"core":"checkbox"].selected[f],c.children_d)||-1!==h.indexOf("up")&&-1!==d.inArray(this._data[p?"core":"checkbox"].selected[f],c.parents)||m.push(this._data[p?"core":"checkbox"].selected[f]);this._data[p?"core":"checkbox"].selected=d.vakata.array_unique(m);-1!==h.indexOf("down")&&g.length&&g.find(".jstree-anchor").removeClass(p?"jstree-clicked":
"jstree-checked").parent().attr("aria-selected",!1)},this));if(-1!==this.settings.checkbox.cascade.indexOf("up"))this.element.on("delete_node.jstree",d.proxy(function(a,b){for(var c=this.get_node(b.parent),d=this._model.data,f,h,m,l=this.settings.checkbox.tie_selection;c&&"#"!==c.id;){f=m=0;for(h=c.children.length;f<h;f++)m+=d[c.children[f]].state[l?"selected":"checked"];if(m===h)c.state[l?"selected":"checked"]=!0,this._data[l?"core":"checkbox"].selected.push(c.id),(f=this.get_node(c,!0))&&f.length&&
f.attr("aria-selected",!0).children(".jstree-anchor").addClass(l?"jstree-clicked":"jstree-checked");else break;c=this.get_node(c.parent)}},this)).on("move_node.jstree",d.proxy(function(a,b){var c=b.is_multi,g=b.old_parent,f=this.get_node(b.parent),h=this._model.data,m,l,p=this.settings.checkbox.tie_selection;if(!c)for(c=this.get_node(g);c&&"#"!==c.id;){m=g=0;for(l=c.children.length;m<l;m++)g+=h[c.children[m]].state[p?"selected":"checked"];if(g===l)c.state[p?"selected":"checked"]=!0,this._data[p?"core":
"checkbox"].selected.push(c.id),(g=this.get_node(c,!0))&&g.length&&g.attr("aria-selected",!0).children(".jstree-anchor").addClass(p?"jstree-clicked":"jstree-checked");else break;c=this.get_node(c.parent)}for(c=f;c&&"#"!==c.id;){m=g=0;for(l=c.children.length;m<l;m++)g+=h[c.children[m]].state[p?"selected":"checked"];if(g===l)c.state[p?"selected":"checked"]||(c.state[p?"selected":"checked"]=!0,this._data[p?"core":"checkbox"].selected.push(c.id),(g=this.get_node(c,!0))&&g.length&&g.attr("aria-selected",
...
g=this.settings.checkbox.tie_selection,f=this._data[g?"core":"checkbox"].selected,h=[],m=this;a=0;for(b=f.length;a<b;a++)c[f[a]]&&c[f[a]].parents&&(h=h.concat(c[f[a]].parents));this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function(){var d=m.get_node(this),f;if(d.state.loaded)for(a=0,b=d.children_d.length;a<b;a++)f=c[d.children_d[a]],!f.state.loaded&&f.original&&f.original.state&&f.original.state.undetermined&&!0===f.original.state.undetermined&&(h.push(f.id),h=h.concat(f.parents));
...
k,c,g){if(a=b.redraw_node.apply(this,arguments)){var f,h,m=null;f=0;for(h=a.childNodes.length;f<h;f++)if(a.childNodes[f]&&a.childNodes[f].className&&-1!==a.childNodes[f].className.indexOf("jstree-anchor")){m=a.childNodes[f];break}m&&(!this.settings.checkbox.tie_selection&&this._model.data[a.id].state.checked&&(m.className+=" jstree-checked"),m.insertBefore(x.cloneNode(!1),m.childNodes[0]))}c||-1===this.settings.checkbox.cascade.indexOf("undetermined")||(this._data.checkbox.uto&&clearTimeout(this._data.checkbox.uto),
...
arguments);if(c&&a.checkbox){if(!this.settings.checkbox.tie_selection){this.uncheck_all();var g=this;d.each(a.checkbox,function(a,e){g.check_node(e)})}delete a.checkbox;return!1}return c}};var y=null,E,C;d.jstree.defaults.contextmenu={select_node:!0,show_at_node:!0,items:function(a,b){return{create:{separator_before:!1,separator_after:!0,_disabled:!1,label:"Create",action:function(a){var b=d.jstree.reference(a.reference);a=b.get_node(a.reference);b.create_node(a,{},"last",function(a){setTimeout(function(){b.edit(a)},
...
action:function(a){var b=d.jstree.reference(a.reference);a=b.get_node(a.reference);b.paste(a)}}}}}}};d.jstree.plugins.contextmenu=function(a,b){this.bind=function(){b.bind.call(this);var a=0;this.element.on("contextmenu.jstree",".jstree-anchor",d.proxy(function(b,c){b.preventDefault();a=b.ctrlKey?+new Date:0;if(c||y)a=+new Date+1E4;y&&clearTimeout(y);this.is_loading(b.currentTarget)||this.show_contextmenu(b.currentTarget,b.pageX,b.pageY,b)},this)).on("click.jstree",".jstree-anchor",d.proxy(function(b){this._data.contextmenu.visible&&
(!a||250<+new Date-a)&&d.vakata.context.hide();a=0},this)).on("touchstart.jstree",".jstree-anchor",function(a){a.originalEvent&&a.originalEvent.changedTouches&&a.originalEvent.changedTouches[0]&&(E=a.pageX,C=a.pageY,y=setTimeout(function(){d(a.currentTarget).trigger("contextmenu",!0)},750))});d(document).on("context_hide.vakata.jstree",d.proxy(function(){this._data.contextmenu.visible=!1},this))};this.teardown=function(){this._data.contextmenu.visible&&d.vakata.context.hide();b.teardown.call(this)};
this.show_contextmenu=function(a,b,c,g){a=this.get_node(a);if(!a||"#"===a.id)return!1;var f=this.settings.contextmenu,h=this.get_node(a,!0).children(".jstree-anchor"),m=!1,m=!1;if(f.show_at_node||b===r||c===r)m=h.offset(),b=m.left,c=m.top+this._data.core.li_height;this.settings.contextmenu.select_node&&!this.is_selected(a)&&this.activate_node(a,g);m=f.items;d.isFunction(m)&&(m=m.call(this,a,d.proxy(function(d){this._show_contextmenu(a,b,c,d)},this)));d.isPlainObject(m)&&this._show_contextmenu(a,b,
c,m)};this._show_contextmenu=function(a,b,c,g){var f=this.get_node(a,!0).children(".jstree-anchor");d(document).one("context_show.vakata.jstree",d.proxy(function(a,e){var b="jstree-contextmenu jstree-"+this.get_theme()+"-contextmenu";d(e.element).addClass(b)},this));this._data.contextmenu.visible=!0;d.vakata.context.show(f,{x:b,y:c},g);this.trigger("show_contextmenu",{node:a,x:b,y:c})}};d(function(){d(document).on("touchmove.vakata.jstree",function(a){y&&a.originalEvent&&a.originalEvent.changedTouches&&
a.originalEvent.changedTouches[0]&&(50<Math.abs(E-a.pageX)||50<Math.abs(C-a.pageY))&&clearTimeout(y)}).on("touchend.vakata.jstree",function(a){y&&clearTimeout(y)})});(function(a){var b=!1,e=!1,d=!1,c=0,g=0,f=[],h="",m=!1;a.vakata.context={settings:{hide_onmouseleave:0,icons:!0},_trigger:function(b){a(document).triggerHandler("context_"+b+".vakata",{reference:d,element:e,position:{x:c,y:g}})},_execute:function(b){return(b=f[b])&&(!b._disabled||a.isFunction(b._disabled)&&!b._disabled({item:b,reference:d,
element:e}))&&b.action?b.action.call(null,{item:b,reference:d,element:e,position:{x:c,y:g}}):!1},_parse:function(b,c){if(!b)return!1;c||(h="",f=[]);var g="",m=!1,l;c&&(g+="<ul>");a.each(b,function(b,c){if(!c)return!0;f.push(c);!m&&c.separator_before&&(g+="<li class='vakata-context-separator'><a href='#' "+(a.vakata.context.settings.icons?"":'style="margin-left:0px;"')+">&#160;</a></li>");m=!1;g+="<li class='"+(c._class||"")+(!0===c._disabled||a.isFunction(c._disabled)&&c._disabled({item:c,reference:d,
...
' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-'+c.shortcut+'">'+(c.shortcut_label||"")+"</span>":"")+"</a>";c.submenu&&(l=a.vakata.context._parse(c.submenu,!0))&&(g+=l);g+="</li>";c.separator_after&&(g+="<li class='vakata-context-separator'><a href='#' "+(a.vakata.context.settings.icons?"":'style="margin-left:0px;"')+">&#160;</a></li>",m=!0)});g=g.replace(/<li class\='vakata-context-separator'\><\/li\>$/,"");c&&(g+="</ul>");c||(h=g,a.vakata.context._trigger("parse"));return 10<
g.length?g:!1},_show_submenu:function(e){e=a(e);if(e.length&&e.children("ul").length){var c=e.children("ul"),d=e.offset().left+e.outerWidth(),f=e.offset().top,k=c.width(),g=c.height(),h=a(window).width()+a(window).scrollLeft(),m=a(window).height()+a(window).scrollTop();if(b)e[0>d-(k+10+e.outerWidth())?"addClass":"removeClass"]("vakata-context-left");else e[d+k+10>h?"addClass":"removeClass"]("vakata-context-right");f+g+10>m&&c.css("bottom","-1px");c.show()}},show:function(l,p,n){var q,u,v,B,r;e&&e.length&&
e.width("");switch(!0){case !p&&!l:return!1;case !!p&&!!l:d=l;c=p.x;g=p.y;break;case !p&&!!l:d=l;p=l.offset();c=p.left+l.outerHeight();g=p.top;break;case !!p&&!l:c=p.x,g=p.y}l&&!n&&a(l).data("vakata_contextmenu")&&(n=a(l).data("vakata_contextmenu"));a.vakata.context._parse(n)&&e.html(h);f.length&&(e.appendTo("body"),n=e,p=c,q=g,u=n.width(),v=n.height(),B=a(window).width()+a(window).scrollLeft(),r=a(window).height()+a(window).scrollTop(),b&&(p-=n.outerWidth()-a(l).outerWidth(),p<a(window).scrollLeft()+
20&&(p=a(window).scrollLeft()+20)),p+u+20>B&&(p=B-(u+20)),q+v+20>r&&(q=r-(v+20)),e.css({left:p,top:q}).show().find("a").first().focus().parent().addClass("vakata-context-hover"),m=!0,a.vakata.context._trigger("show"))},hide:function(){m&&(e.hide().find("ul").hide().end().find(":focus").blur().end().detach(),m=!1,a.vakata.context._trigger("hide"))}};a(function(){b="rtl"===a("body").css("direction");var c=!1;e=a("<ul class='vakata-context'></ul>");e.on("mouseenter","li",function(b){b.stopImmediatePropagation();
...
a.vakata.context.settings.hide_onmouseleave&&(c=setTimeout(function(e){return function(){a.vakata.context.hide()}}(this),a.vakata.context.settings.hide_onmouseleave))}).on("click","a",function(e){e.preventDefault();a(this).blur().parent().hasClass("vakata-context-disabled")||!1===a.vakata.context._execute(a(this).attr("rel"))||a.vakata.context.hide()}).on("keydown","a",function(b){var c;switch(b.which){case 13:case 32:b.type="mouseup";b.preventDefault();a(b.currentTarget).trigger(b);break;case 37:m&&
(e.find(".vakata-context-hover").last().closest("li").first().find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").focus(),b.stopImmediatePropagation(),b.preventDefault());break;case 38:m&&(c=e.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").prevAll("li:not(.vakata-context-separator)").first(),c.length||(c=e.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last()),
c.addClass("vakata-context-hover").children("a").focus(),b.stopImmediatePropagation(),b.preventDefault());break;case 39:m&&(e.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").focus(),b.stopImmediatePropagation(),b.preventDefault());break;case 40:m&&(c=e.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").nextAll("li:not(.vakata-context-separator)").first(),
c.length||(c=e.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").first()),c.addClass("vakata-context-hover").children("a").focus(),b.stopImmediatePropagation(),b.preventDefault());break;case 27:a.vakata.context.hide(),b.preventDefault()}}).on("keydown",function(a){a.preventDefault();a=e.find(".vakata-contextmenu-shortcut-"+a.which).parent();a.parent().not(".vakata-context-disabled")&&a.click()});a(document).on("mousedown.vakata.jstree",function(b){m&&!a.contains(e[0],
b.target)&&a.vakata.context.hide()}).on("context_show.vakata.jstree",function(a,c){e.find("li:has(ul)").children("a").addClass("vakata-context-parent");b&&e.addClass("vakata-context-rtl").css("direction","rtl");e.find("ul").hide().end()})})})(d);d.jstree.defaults.dnd={copy:!0,open_timeout:500,is_draggable:!0,check_while_dragging:!0,always_copy:!1,inside_pos:0,drag_selection:!0,touch:!0};d.jstree.plugins.dnd=function(a,b){this.bind=function(){b.bind.call(this);this.element.on("mousedown.jstree touchstart.jstree",
...
d(g.event.target).closest(".jstree-anchor"))&&h.length&&h.parent().is(".jstree-closed, .jstree-open, .jstree-leaf")&&(m=h.offset(),l=g.event.pageY-m.top,q=h.height(),B=l<q/3?["b","i","a"]:l>q-q/3?["a","i","b"]:l>q/2?["i","a","b"]:["i","b","a"],d.each(B,function(c,l){switch(l){case "b":p=m.left-6;n=m.top;u=f.get_parent(h);v=h.parent().index();break;case "i":C=f.settings.dnd.inside_pos;G=f.get_node(h.parent());p=m.left-2;n=m.top+q/2+1;u=G.id;v="first"===C?0:"last"===C?G.children.length:Math.min(C,G.children.length);
break;case "a":p=m.left-6,n=m.top+q,u=f.get_parent(h),v=h.parent().index()+1}r=!0;D=0;for(x=g.data.nodes.length;D<x;D++)if(z=g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey))?"copy_node":"move_node",y=v,"move_node"===z&&"a"===l&&g.data.origin&&g.data.origin===f&&u===f.get_parent(g.data.nodes[D])&&(A=f.get_node(u),y>d.inArray(g.data.nodes[D],A.children)&&--y),r=r&&(f&&f.settings&&f.settings.dnd&&!1===f.settings.dnd.check_while_dragging||
f.check(z,g.data.origin&&g.data.origin!==f?g.data.origin.get_node(g.data.nodes[D]):g.data.nodes[D],u,y,{dnd:!0,ref:f.get_node(h.parent()),pos:l,is_multi:g.data.origin&&g.data.origin!==f,is_foreign:!g.data.origin})),!r){f&&f.last_error&&(b=f.last_error());break}"i"===l&&h.parent().is(".jstree-closed")&&f.settings.dnd.open_timeout&&(e=setTimeout(function(a,e){return function(){a.open_node(e)}}(f,h),f.settings.dnd.open_timeout));if(r)return a={ins:f,par:u,pos:"i"!==l||"last"!==C||0!==v||f.is_loaded(G)?
v:"last"},k.css({left:p+"px",top:n+"px"}).show(),g.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"),b={},B=!0,!1}),!0===B))return}else{r=!0;D=0;for(x=g.data.nodes.length;D<x&&(r=r&&f.check(g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey))?"copy_node":"move_node",g.data.origin&&g.data.origin!==f?g.data.origin.get_node(g.data.nodes[D]):g.data.nodes[D],"#","last",{dnd:!0,ref:f.get_node("#"),pos:"i",
is_multi:g.data.origin&&g.data.origin!==f,is_foreign:!g.data.origin}),r);D++);if(r){a={ins:f,par:"#",pos:"last"};k.hide();g.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok");return}}a=!1;g.helper.find(".jstree-icon").removeClass("jstree-ok").addClass("jstree-er");k.hide()}}).on("dnd_scroll.vakata.jstree",function(e,b){b&&b.data&&b.data.jstree&&(k.hide(),a=!1,b.helper.find(".jstree-icon").first().removeClass("jstree-ok").addClass("jstree-er"))}).on("dnd_stop.vakata.jstree",
function(c,g){e&&clearTimeout(e);if(g&&g.data&&g.data.jstree){k.hide().detach();var f,h,m=[];if(a){f=0;for(h=g.data.nodes.length;f<h;f++)m[f]=g.data.origin?g.data.origin.get_node(g.data.nodes[f]):g.data.nodes[f],g.data.origin&&(m[f].instance=g.data.origin);a.ins[g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey))?"copy_node":"move_node"](m,a.par,a.pos);f=0;for(h=m.length;f<h;f++)m[f].instance&&(m[f].instance=null)}else f=d(g.event.target).closest(".jstree"),
f.length&&b&&b.error&&"check"===b.error&&(f=f.jstree(!0))&&f.settings.core.error.call(this,b)}}).on("keyup.jstree keydown.jstree",function(a,e){if((e=d.vakata.dnd._get())&&e.data&&e.data.jstree)e.helper.find(".jstree-copy").first()[e.data.origin&&(e.data.origin.settings.dnd.always_copy||e.data.origin.settings.dnd.copy&&(a.metaKey||a.ctrlKey))?"show":"hide"]()})});(function(a){var b=!1,e=!1,d=!1,c=!1,g=!1,f=0,h=!1,m=0,l=0,p=0,n=0,q=!1,u=!1,v=!1;a.vakata.dnd={settings:{scroll_speed:10,scroll_proximity:20,
helper_left:5,helper_top:10,threshold:5,threshold_touch:50},_trigger:function(e,b){var c=a.vakata.dnd._get();c.event=b;a(document).triggerHandler("dnd_"+e+".vakata",c)},_get:function(){return{data:h,element:b,helper:g}},_clean:function(){g&&g.remove();u&&(clearInterval(u),u=!1);g=c=d=e=b=!1;f=0;h=!1;n=p=l=m=0;v=u=q=!1;a(document).off("mousemove.vakata.jstree touchmove.vakata.jstree",a.vakata.dnd.drag);a(document).off("mouseup.vakata.jstree touchend.vakata.jstree",a.vakata.dnd.stop)},_scroll:function(e){if(!q||
!p&&!n)return u&&(clearInterval(u),u=!1),!1;if(!u)return u=setInterval(a.vakata.dnd._scroll,100),!1;if(!0===e)return!1;e=q.scrollTop();var b=q.scrollLeft();q.scrollTop(e+n*a.vakata.dnd.settings.scroll_speed);q.scrollLeft(b+p*a.vakata.dnd.settings.scroll_speed);e===q.scrollTop()&&b===q.scrollLeft()||a.vakata.dnd._trigger("scroll",q)},start:function(f,p,n){"touchstart"===f.type&&f.originalEvent&&f.originalEvent.changedTouches&&f.originalEvent.changedTouches[0]&&(f.pageX=f.originalEvent.changedTouches[0].pageX,
f.pageY=f.originalEvent.changedTouches[0].pageY,f.target=document.elementFromPoint(f.originalEvent.changedTouches[0].pageX-window.pageXOffset,f.originalEvent.changedTouches[0].pageY-window.pageYOffset));c&&a.vakata.dnd.stop({});try{f.currentTarget.unselectable="on",f.currentTarget.onselectstart=function(){return!1},f.currentTarget.style&&(f.currentTarget.style.MozUserSelect="none")}catch(q){}m=f.pageX;l=f.pageY;h=p;d=!0;b=f.currentTarget;e=f.target;v="touchstart"===f.type;!1!==n&&(g=a("<div id='vakata-dnd'></div>").html(n).css({display:"block",
...
window.pageXOffset,e.originalEvent.changedTouches[0].pageY-window.pageYOffset));if(d){if(!c)if(Math.abs(e.pageX-m)>(v?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold)||Math.abs(e.pageY-l)>(v?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold))g&&(g.appendTo("body"),f=g.outerWidth()),c=!0,a.vakata.dnd._trigger("start",e);else return;var b=!1,h=!1,t=!1,u=!1,r=!1,x=h=!1,z=!1,u=b=!1;p=n=0;q=!1;a(a(e.target).parentsUntil("body").addBack().get().reverse()).filter(function(){return/^auto|scroll$/.test(a(this).css("overflow"))&&
(this.scrollHeight>this.offsetHeight||this.scrollWidth>this.offsetWidth)}).each(function(){var b=a(this),c=b.offset();this.scrollHeight>this.offsetHeight&&(c.top+b.height()-e.pageY<a.vakata.dnd.settings.scroll_proximity&&(n=1),e.pageY-c.top<a.vakata.dnd.settings.scroll_proximity&&(n=-1));this.scrollWidth>this.offsetWidth&&(c.left+b.width()-e.pageX<a.vakata.dnd.settings.scroll_proximity&&(p=1),e.pageX-c.left<a.vakata.dnd.settings.scroll_proximity&&(p=-1));if(n||p)return q=a(this),!1});!q&&(b=a(document),
h=a(window),t=b.height(),u=h.height(),r=b.width(),h=h.width(),x=b.scrollTop(),z=b.scrollLeft(),t>u&&e.pageY-x<a.vakata.dnd.settings.scroll_proximity&&(n=-1),t>u&&u-(e.pageY-x)<a.vakata.dnd.settings.scroll_proximity&&(n=1),r>h&&e.pageX-z<a.vakata.dnd.settings.scroll_proximity&&(p=-1),r>h&&h-(e.pageX-z)<a.vakata.dnd.settings.scroll_proximity&&(p=1),n||p)&&(q=b);q&&a.vakata.dnd._scroll(!0);g&&(b=parseInt(e.pageY+a.vakata.dnd.settings.helper_top,10),u=parseInt(e.pageX+a.vakata.dnd.settings.helper_left,
10),t&&b+25>t&&(b=t-50),r&&u+f>r&&(u=r-(f+2)),g.css({left:u+"px",top:b+"px"}));a.vakata.dnd._trigger("move",e);return!1}},stop:function(b){"touchend"===b.type&&b.originalEvent&&b.originalEvent.changedTouches&&b.originalEvent.changedTouches[0]&&(b.pageX=b.originalEvent.changedTouches[0].pageX,b.pageY=b.originalEvent.changedTouches[0].pageY,b.target=document.elementFromPoint(b.originalEvent.changedTouches[0].pageX-window.pageXOffset,b.originalEvent.changedTouches[0].pageY-window.pageYOffset));if(c)a.vakata.dnd._trigger("stop",
...
this)).on("clear_search.jstree",d.proxy(function(a,b){this._data.search.som&&b.nodes.length&&this.element.find(".jstree-node").css("display","").filter(".jstree-last").filter(function(){return this.nextSibling}).removeClass("jstree-last")},this))};this.search=function(a,b,c){if(!1===a||""===d.trim(a.toString()))return this.clear_search();a=a.toString();var g=this.settings.search,f=g.ajax?g.ajax:!1,h=null,m=[],l=[];this._data.search.res.length&&this.clear_search();c===r&&(c=g.show_only_matches);if(!b&&
...
0===c.children.length)&&(m.push(b),l=l.concat(c.parents))});m.length&&(l=d.vakata.array_unique(l),this._search_open(l),this._data.search.dom=d(this.element[0].querySelectorAll("#"+d.map(m,function(a){return-1!=="0123456789".indexOf(a[0])?"\\3"+a[0]+" "+a.substr(1).replace(d.jstree.idregex,"\\$&"):a.replace(d.jstree.idregex,"\\$&")}).join(", #"))),this._data.search.res=m,this._data.search.dom.children(".jstree-anchor").addClass("jstree-search"));this.trigger("search",{nodes:this._data.search.dom,str:a,
...
function(c,g){if("#"===g)return!0;try{g=d("#"+g.replace(d.jstree.idregex,"\\$&"),b.element)}catch(f){}g&&g.length&&b.is_closed(g)&&(b._data.search.opn.push(g[0].id),b.open_node(g,function(){b._search_open(a)},0))})}};(function(a){a.vakata.search=function(a,e,d){d=d||{};!1!==d.fuzzy&&(d.fuzzy=!0);a=d.caseSensitive?a:a.toLowerCase();var c=d.location||0,g=d.distance||100,f=d.threshold||.6,h=a.length,m,l,p,n;32<h&&(d.fuzzy=!1);d.fuzzy&&(m=1<<h-1,l=function(){var e={},c;for(c=0;c<h;c++)e[a.charAt(c)]=
0;for(c=0;c<h;c++)e[a.charAt(c)]|=1<<h-c-1;return e}(),p=function(a,e){var b=a/h,d=Math.abs(c-e);return g?b+d/g:d?1:b});n=function(e){e=d.caseSensitive?e:e.toLowerCase();if(a===e||-1!==e.indexOf(a))return{isMatch:!0,score:0};if(!d.fuzzy)return{isMatch:!1,score:1};var g,n,q=e.length,u=f,v=e.indexOf(a,c),r,x,z=h+q,y,A,C=1,E=[];-1!==v&&(u=Math.min(p(0,v),u),v=e.lastIndexOf(a,c+h),-1!==v&&(u=Math.min(p(0,v),u)));v=-1;for(g=0;g<h;g++){r=0;for(x=z;r<x;)p(g,c+x)<=u?r=x:z=x,x=Math.floor((z-r)/2+r);z=x;r=
Math.max(1,c-x+1);n=Math.min(c+x,q)+h;x=Array(n+2);for(x[n+1]=(1<<g)-1;n>=r;n--)if(A=l[e.charAt(n-1)],x[n]=0===g?(x[n+1]<<1|1)&A:(x[n+1]<<1|1)&A|(y[n+1]|y[n])<<1|1|y[n+1],x[n]&m&&(C=p(g,n-1),C<=u))if(u=C,v=n-1,E.push(v),v>c)r=Math.max(1,2*c-v);else break;if(p(g+1,c)>u)break;y=x}return{isMatch:0<=v,score:C}};return!0===e?{search:n}:n(e)}})(d);d.jstree.defaults.sort=function(a,b){return this.get_text(a)>this.get_text(b)?1:-1};d.jstree.plugins.sort=function(a,b){this.bind=function(){b.bind.call(this);
...
d.jstree.defaults.types={"#":{},"default":{}};d.jstree.plugins.types=function(a,b){this.init=function(a,d){var c,g;if(d&&d.types&&d.types["default"])for(c in d.types)if("default"!==c&&"#"!==c&&d.types.hasOwnProperty(c))for(g in d.types["default"])d.types["default"].hasOwnProperty(g)&&d.types[c][g]===r&&(d.types[c][g]=d.types["default"][g]);b.init.call(this,a,d);this._model.data["#"].type="#"};this.refresh=function(a,d){b.refresh.call(this,a,d);this._model.data["#"].type="#"};this.bind=function(){this.element.on("model.jstree",
d.proxy(function(a,b){var c=this._model.data,d=b.nodes,f=this.settings.types,h,m,l;h=0;for(m=d.length;h<m;h++)l="default",c[d[h]].original&&c[d[h]].original.type&&f[c[d[h]].original.type]&&(l=c[d[h]].original.type),c[d[h]].data&&c[d[h]].data.jstree&&c[d[h]].data.jstree.type&&f[c[d[h]].data.jstree.type]&&(l=c[d[h]].data.jstree.type),c[d[h]].type=l,!0===c[d[h]].icon&&f[l].icon!==r&&(c[d[h]].icon=f[l].icon);c["#"].type="#"},this));b.bind.call(this)};this.get_json=function(a,k,c){var g=this._model.data,
...
c=a.length;b<c;b++)a[b]=this._delete_ids(a[b]);return a}delete a.id;a.li_attr&&a.li_attr.id&&delete a.li_attr.id;a.a_attr&&a.a_attr.id&&delete a.a_attr.id;a.children&&d.isArray(a.children)&&(a.children=this._delete_ids(a.children));return a};this.check=function(a,k,c,g,f){if(!1===b.check.call(this,a,k,c,g,f))return!1;k=k&&k.id?k:this.get_node(k);c=c&&c.id?c:this.get_node(c);f=k&&k.id?d.jstree.reference(k.id):null;var h,m,l,p;f=f&&f._model&&f._model.data?f._model.data:null;switch(a){case "create_node":case "move_node":case "copy_node":if("move_node"!==
a||-1===d.inArray(k.id,c.children)){h=this.get_rules(c);if(h.max_children!==r&&-1!==h.max_children&&h.max_children===c.children.length)return this._data.core.last_error={error:"check",plugin:"types",id:"types_01",reason:"max_children prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})},!1;if(h.valid_children!==r&&-1!==h.valid_children&&-1===d.inArray(k.type||"default",h.valid_children))return this._data.core.last_error={error:"check",plugin:"types",id:"types_02",
reason:"valid_children prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})},!1;if(f&&k.children_d&&k.parents){l=m=0;for(p=k.children_d.length;l<p;l++)m=Math.max(m,f[k.children_d[l]].parents.length);m=m-k.parents.length+1}if(0>=m||m===r)m=1;do{if(h.max_depth!==r&&-1!==h.max_depth&&h.max_depth<m)return this._data.core.last_error={error:"check",plugin:"types",id:"types_03",reason:"max_depth prevents function: "+a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?
k.id:!1,par:c&&c.id?c.id:!1})},!1;c=this.get_node(c.parent);h=this.get_rules(c);m++}while(c)}}return!0};this.get_rules=function(a){a=this.get_node(a);if(!a)return!1;a=this.get_type(a,!0);a.max_depth===r&&(a.max_depth=-1);a.max_children===r&&(a.max_children=-1);a.valid_children===r&&(a.valid_children=-1);return a};this.get_type=function(a,b){return(a=this.get_node(a))?b?d.extend({type:a.type},this.settings.types[a.type]):a.type:!1};this.set_type=function(a,b){var c,g,f;if(d.isArray(a)){a=a.slice();
c=0;for(g=a.length;c<g;c++)this.set_type(a[c],b);return!0}c=this.settings.types;a=this.get_node(a);if(!c[b]||!a)return!1;g=a.type;f=this.get_icon(a);a.type=b;(!0===f||c[g]&&c[g].icon!==r&&f===c[g].icon)&&this.set_icon(a,c[b].icon!==r?c[b].icon:!0);return!0}};d.jstree.defaults.unique={case_sensitive:!1,duplicate:function(a,b){return a+" ("+b+")"}};d.jstree.plugins.unique=function(a,b){this.check=function(a,k,c,g,f){if(!1===b.check.call(this,a,k,c,g,f))return!1;k=k&&k.id?k:this.get_node(k);c=c&&c.id?
c:this.get_node(c);if(!c||!c.children)return!0;f="rename_node"===a?g:k.text;var h=[],m=this.settings.unique.case_sensitive,l=this._model.data,p,n;p=0;for(n=c.children.length;p<n;p++)h.push(m?l[c.children[p]].text:l[c.children[p]].text.toLowerCase());m||(f=f.toLowerCase());switch(a){case "rename_node":return p=-1===d.inArray(f,h)||k.text&&k.text[m?"toString":"toLowerCase"]()===f,p||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_01",reason:"Child with name "+f+" already exists. Preventing: "+
a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})}),p;case "create_node":return p=-1===d.inArray(f,h),p||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_04",reason:"Child with name "+f+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})}),p;case "copy_node":return p=-1===d.inArray(f,h),p||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_02",reason:"Child with name "+f+" already exists. Preventing: "+
a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})}),p;case "move_node":return p=k.parent===c.id||-1===d.inArray(f,h),p||(this._data.core.last_error={error:"check",plugin:"unique",id:"unique_03",reason:"Child with name "+f+" already exists. Preventing: "+a,data:JSON.stringify({chk:a,pos:g,obj:k&&k.id?k.id:!1,par:c&&c.id?c.id:!1})}),p}return!0};this.create_node=function(a,k,c,g,f){if(!k||k.text===r){null===a&&(a="#");a=this.get_node(a);if(!a)return b.create_node.call(this,
a,k,c,g,f);c=c===r?"last":c;if(!c.toString().match(/^(before|after)$/)&&!f&&!this.is_loaded(a))return b.create_node.call(this,a,k,c,g,f);k||(k={});var h,m,l,n,q,u=this._model.data,v=this.settings.unique.case_sensitive,x=this.settings.unique.duplicate;m=h=this.get_string("New node");l=[];n=0;for(q=a.children.length;n<q;n++)l.push(v?u[a.children[n]].text:u[a.children[n]].text.toLowerCase());for(n=1;-1!==d.inArray(v?m:m.toLowerCase(),l);)m=x.call(this,h,++n).toString();k.text=m}return b.create_node.call(this,
a,k,c,g,f)}};var H=document.createElement("DIV");H.setAttribute("unselectable","on");H.setAttribute("role","presentation");H.className="jstree-wholerow";H.innerHTML="&#160;";d.jstree.plugins.wholerow=function(a,b){this.bind=function(){b.bind.call(this);this.element.on("ready.jstree set_state.jstree",d.proxy(function(){this.hide_dots()},this)).on("init.jstree loading.jstree ready.jstree",d.proxy(function(){this.get_container_ul().addClass("jstree-wholerow-ul")},this)).on("deselect_all.jstree",d.proxy(function(a,
b){this.element.find(".jstree-wholerow-clicked").removeClass("jstree-wholerow-clicked")},this)).on("changed.jstree",d.proxy(function(a,b){this.element.find(".jstree-wholerow-clicked").removeClass("jstree-wholerow-clicked");var c,d,f;d=0;for(f=b.selected.length;d<f;d++)(c=this.get_node(b.selected[d],!0))&&c.length&&c.children(".jstree-wholerow").addClass("jstree-wholerow-clicked")},this)).on("open_node.jstree",d.proxy(function(a,b){this.get_node(b.node,!0).find(".jstree-clicked").parent().children(".jstree-wholerow").addClass("jstree-wholerow-clicked")},
...
var n=this.input.val();if(n){var n=JSON.parse(n),v=this.treeID;d.each(n,function(){d("#"+v+"-"+this).data("jstree",{selected:!0})})}n=l.find("> ul > li");if(1==n.length){var n=n.first(),u=n.data("jstree");n.data("jstree",d.extend({},u,{opened:!0}))}var n=h.multiple,u=h.leafonly,q=h.cascade,r=!1,A=null,x=["sort","checkbox"];this.input.data("multiple",n);if((q||u)&&n)r=!0;else if(n)if(h.cascadeOptionInTree)this.manualCascadeOption=!0;else{var y=this,A=function(h){return l.jstree("is_parent",h)?(d.vakata.context.settings.icons=
!1,{select_all:{label:y.options.selectAllText,icon:!1,action:function(d){y._selectBranch(h)}},deselect_all:{label:y.options.deselectAllText,icon:!1,action:function(d){y._deselectBranch(h)}}}):null};x.push("contextmenu")}l.jstree({core:{themes:{name:"s3",icons:h.icons,stripes:h.stripes},animation:100,multiple:n,check_callback:!0},checkbox:{three_state:r},sort:function(d,h){var l=this.get_text(d)>this.get_text(h)?1:-1,a,b;try{a=this.get_node(d).li_attr.rel}catch(e){a=null}try{b=this.get_node(h).li_attr.rel}catch(e){b=
null}return"bulk"==a?-1:"bulk"==b?1:"none"==a?-1:"none"==b?1:l},contextmenu:{items:A,select_node:!1,icons:!1},plugins:x});var E=jQuery.jstree.reference(l);n&&((h.bulkSelect||this.manualCascadeOption)&&h.cascadeOptionInTree?(this.wrapper.find(".s3-hierarchy-header").hide(),E.create_node("#",{id:this.treeID+"-select-all",text:h.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first")):this.wrapper.find(".s3-hierarchy-header").removeClass("hide").show());y=this;l.on("ready.jstree",
function(){var d=E.get_checked();y._updateButtonText(d)});this._bindEvents()}else this.button.hide(),this.noopts.show()},_setOption:function(h,l){if("selected"===h){var n=jQuery.jstree.reference(d(this.tree));if(n!==r&&(n.uncheck_all(),l)){this.input.val(JSON.stringify(l));var v=this.treeID;d.each(l,function(){n.check_node("#"+v+"-"+this)});this._updateButtonText(l)}}this._super(h,l)},_updateSelectedNodes:function(){var h=jQuery.jstree.reference(d(this.tree)),l=this.input.val(),l=l?JSON.parse(l):
[],n=[],v=[],u=this.options.leafonly,q=h.get_checked(!0);d(q).each(function(){var l=d(this).attr("id");if("bulk"!=d(this).attr("rel")&&l&&(!u||h.is_leaf(this))){var q=l.split("-").pop();"None"!=q&&(q=parseInt(q));q&&(n.push(q),v.push(l))}});var q=!1,r=d(n).not(l).get();r.length?q=!0:(r=d(l).not(n).get(),r.length&&(q=!0));this.input.val(JSON.stringify(n));this._updateButtonText(v);q&&(this.input.change(),d(this.element).trigger("select.s3hierarchy"));return!0},_updateButtonText:function(h){var l=this.options,
n=0;h&&(n=h.length);if(n)if(1<n)h=l.selectedText.replace("#",n);else{for(var v=[],u=0;u<n;u++)v.push(d("#"+h[u]+" > a").text().replace(/^\s+|\s+$/g,""));h=v.length?v.join(" "):l.noneSelectedText}else h=l.noneSelectedText;this.buttonText.text(h)},_updateAndClose:function(){if(!this._isBulk){this._updateSelectedNodes();var d=this.wrapper,l=this;if(l.options.multiple)d.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",function(){window.setTimeout(function(){l.closeMenu()},100)});
else window.setTimeout(function(){l.closeMenu()},100)}},_selectNode:function(h){var l=this.options,n=jQuery.jstree.reference(d(this.tree)),v=l.multiple,u=l.leafonly;if(v)this._isBulk||"bulk"!=h.li_attr.rel||((l=n.get_parent(h))&&"#"!=l?(l=n.get_node(l),this._selectBranch(l,!0)):n.select_all());else{var q=h.id;d(n.get_checked(!0)).each(function(){q!=this.id&&(u&&!n.is_leaf(this)||n.uncheck_node(this))})}if(u&&!v&&!n.is_leaf(h))return n.deselect_node(h),!1;this._updateAndClose()},_deselectNode:function(h){var l=
jQuery.jstree.reference(d(this.tree));if(!this._isBulk){if("bulk"==h.li_attr.rel)(h=l.get_parent(h))&&"#"!=h?(h=l.get_node(h),this._deselectBranch(h,!0)):l.deselect_all();else if(h=l.get_parent(h))if(h=l.get_node(h+"-select-all"))this._isBulk=!0,l.uncheck_node(h),this._isBulk=!1;if(h=l.get_node(this.treeID+"-select-all"))this._isBulk=!0,l.uncheck_node(h),this._isBulk=!1}this._updateSelectedNodes()},_openNode:function(h){var l=jQuery.jstree.reference(d(this.tree)),n=l.get_parent(h);n.length&&l.open_node(n,
!1,!0);if(this.manualCascadeOption){var v=h.id,n=l.get_node(v+"-select-all");n||(h=l.create_node(h,{id:v+"-select-all",text:this.options.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first"),n=l.get_node(h));(h=l.get_node(this.treeID+"-select-all"))&&l.is_checked(h)&&(this._isBulk=!0,l.check_node(n),this._isBulk=!1)}},_selectBranch:function(h,l){var n=jQuery.jstree.reference(d(this.tree)),v=this;this._isBulk=!0;n.open_node(h,function(){var u=n.get_children_dom(h);d(u).each(function(){v._selectBranch(this)});
l||n.check_node(h)});this._isBulk=!1;this._updateAndClose()},_deselectBranch:function(h,l){var n=jQuery.jstree.reference(d(this.tree)),v=this;this._isBulk=!0;n.open_node(h,function(){var u=n.get_children_dom(h);d(u).each(function(){v._deselectBranch(this)});l||n.uncheck_node(h)});this._isBulk=!1;this._updateSelectedNodes()},set:function(h){var l=jQuery.jstree.reference(d(this.tree));l.uncheck_all();if(h)for(var n=0,v=h.length,u;n<v;n++)u=d("#"+this.treeID+"-"+h[n]),l.check_node(u)},get:function(){var d=
...
d(this.wrapper).fadeOut(50);this._isOpen=!1;d(this.button).removeClass("ui-state-active");d(this).trigger("close")},addNode:function(h,l,n,v){var u=this.tree,q=this.treeID,r="#";h&&(r=d("#"+q+"-"+h),r.length||(r="#"));l=q+"-"+l;u.jstree("create_node",r,{id:l,text:n,li_attr:{rel:"leaf"}},"last");h&&(r.attr({rel:"parent"}),u.jstree("open_node",r));v&&u.jstree("check_node",d("#"+l))},_bindEvents:function(){var h=this,l=d(this.wrapper),n=d(this.tree),r=d(this.button),u=this._namespace,q=this.options,
z=jQuery.jstree.reference(n),A=d.vakata.context.settings.icons;d(document).bind("context_show.vakata",function(){l.unbind("mouseleave.hierarchicalopts");d.vakata.context.settings.icons=A});n.bind("select_node.jstree",function(d,l){h._selectNode(l.node)}).bind("deselect_node.jstree",function(d,l){h._deselectNode(l.node)}).bind("open_node.jstree",function(d,l){h._openNode(l.node)});r.bind("click"+u,function(){h._isOpen?h.closeMenu():h.openMenu()}).bind("keyup"+u,function(d){d.preventDefault();switch(d.keyCode){case 27:case 38:case 37:h.closeMenu();
break;case 39:case 40:h.openMenu()}}).bind("mouseenter"+u,function(){r.hasClass("ui-state-disabled")||d(this).addClass("ui-state-hover")}).bind("mouseleave"+u,function(){d(this).removeClass("ui-state-hover")}).bind("focus"+u,function(){r.hasClass("ui-state-disabled")||d(this).addClass("ui-state-focus")}).bind("blur"+u,function(){d(this).removeClass("ui-state-focus")});q.multiple&&q.bulkSelect&&!q.cascadeOptionInTree&&(l.find(".s3-hierarchy-select-all").bind("click"+u,function(d){d.preventDefault();
z.select_all();h._updateSelectedNodes()}),l.find(".s3-hierarchy-deselect-all").bind("click"+u,function(d){d.preventDefault();z.deselect_all();h._updateSelectedNodes()}),l.find(".s3-hierarchy-header").bind("click"+u,function(d){d.preventDefault();d.stopPropagation()}).bind("mousedown"+u,function(d){d.preventDefault();d.stopPropagation()}));d(document).bind("mousedown"+u,function(q){var u=q.target;if(d(".jstree-contextmenu").has(u).length||3==q.which)return l.unbind("mouseleave.hierarchicalopts"),!0;
n.is(u)||r.is(u)||0!==n.has(u).length||0!==r.has(u).length||h.closeMenu()});return!0},_unbindEvents:function(){var h=d(this.tree);d(this.button);var l=this._namespace;h.unbind("select_node.jstree").unbind("deselect_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");d(this.button).unbind(l);d(document).unbind(l);return!0}})})(jQuery);
(function(d,r){var F=0;d.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,addTitle:"Add Record",addLabel:"Add",addURL:null,icons:!1,stripes:!0,htmlTitles:!0},_create:function(){this.treeID=d(this.element).attr("id")+"-tree";this.id=F;F+=1},_init:function(){this.tree=d(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){d.Widget.prototype.destroy.call(this)},
refresh:function(){var h=this.tree,l=this.options;this._unbindEvents();var n=h.find("> ul > li");if(1==n.length){var n=n.first(),r=n.data("jstree");n.data("jstree",d.extend({},r,{opened:!0}))}var u=this;h.jstree({core:{themes:{name:"s3",icons:l.icons,stripes:l.stripes},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(d){return{open:{label:u.options.openLabel,action:function(h){u._openNode(d)},separator_after:!0},edit:{label:u.options.editLabel,action:function(h){u._editNode(d)}},
"delete":{label:u.options.deleteLabel,separator_after:!0,action:function(h){u._deleteNode(d)}},add:{label:u.options.addLabel,action:function(h){u._addNode(d)}}}},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},_openNode:function(d){var l=this.options.openURL;d=d.id;l&&d&&(d=parseInt(d.split("-").pop()))&&(l=l.replace("[id]",d).replace("%5Bid%5D",d),window.location.href=l)},refreshNode:function(h){var l=this.options.ajaxURL,n=h.attr("id");if(l&&n&&(n=parseInt(n.split("-").pop()))){var r=
this.tree,u=this.treeID;d.getJSONS3(l+"?node="+n,function(d){d.label&&r.jstree("rename_node",h,d.label);if(d=d.children){r.jstree("open_node",h,!1,!1);for(var l,n,x,y=0,E=0,C=d.length;E<C;E++)l=d[E],n=u+"-"+l.node,(x=r.jstree("get_node","#"+n,!0))?r.jstree("rename_node",x,l.label):(r.jstree("create_node",h,{id:n,text:l.label,li_attr:{rel:"leaf"}}),y++);y&&(r.jstree("open_node",h),h.attr({rel:"parent"}))}})}},_editNode:function(h){var l=this.options.editURL;h=h.id;if(l&&h){var n=parseInt(h.split("-").pop());
n&&(l=l.replace("[id]",n).replace("%5Bid%5D",n).split("?")[0],l+="?node="+h+"&hierarchy="+this.options.widgetID,h=S3.uid(),l=d('<iframe id="'+h+'" src='+l+" onload=\"S3.popup_loaded('"+h+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(l,this.options.editTitle))}},_addNode:function(h){var l=this.options.addURL;h=h.id;if(l&&h){var n=parseInt(h.split("-").pop());n&&(l=l.split("?")[0],l+="?node="+h+"&link_to_parent="+n+"&hierarchy="+
this.options.widgetID,h=S3.uid(),l=d('<iframe id="'+h+'" src='+l+" onload=\"S3.popup_loaded('"+h+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(l,this.options.addTitle))}},_deleteNode:function(h){if(!confirm(i18n.delete_confirmation))return!1;var l=this.options.deleteURL,n=h.id,r=this.tree;l&&n&&(n=parseInt(n.split("-").pop()))&&(l=l.replace("[id]",n).replace("%5Bid%5D",n).split("?")[0],d.ajaxS3({type:"POST",url:l+"?recursive=1",
data:{},dataType:"JSON",success:function(d){r.jstree("delete_node",h)},error:function(d,h,l){h=d.responseText;if("{"==h[0])try{h=JSON.parse(d.responseText),S3.showAlert(h.message,"error")}catch(n){}}}))},_openPopup:function(h,l){h.dialog({close:function(d,l){if(self.parent){var r=self.parent.$("iframe.ui-dialog-content"),q=r.width();r.width(0);window.setTimeout(function(){r.width(q)},300)}h.remove()},minHeight:480,modal:!0,open:function(l,r){d(".ui-widget-overlay").bind("click",function(){h.dialog("close")})},
