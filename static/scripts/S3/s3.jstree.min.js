...
closeMenu:function(){m(this.tree).hide().jstree("unset_focus");this._isOpen=!1;m(this.button).removeClass("ui-state-active");m(this).trigger("close")},addNode:function(b,a,c,d){var e=this.tree,f=this.treeID,g=b?"#"+f+"-"+b:-1;a=f+"-"+a;e.jstree("create_node",g,"last",{data:c,attr:{id:a,rel:"leaf"}},!1,!1);b&&(m(g).attr({rel:"parent"}),e.jstree("open_node",g));d&&e.jstree("check_node","#"+a)},_bindEvents:function(){var b=this,a=m(this.tree),c=m(this.button),d=this._namespace;a.bind("check_node.jstree",
function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("open_node.jstree",function(a,b){b.inst._get_parent(b.rslt.obj).length&&b.inst.open_node(b.inst._get_parent(b.rslt.obj),!1,!0)});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||
m(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){m(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||m(this).addClass("ui-state-focus")}).bind("blur"+d,function(){m(this).removeClass("ui-state-focus")});m(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length||b.closeMenu()});return!0},_unbindEvents:function(){var b=m(this.tree);m(this.button);var a=this._namespace;
b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");m(this.button).unbind(a);m(document).unbind(a);return!0}})})(jQuery);
