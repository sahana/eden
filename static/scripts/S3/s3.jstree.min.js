...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(d,u,w){d instanceof String&&(d=String(d));for(var g=d.length,k=0;k<g;k++){var m=d[k];if(u.call(w,m,k,d))return{i:k,v:m}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,u,w){d!=Array.prototype&&d!=Object.prototype&&(d[u]=w.value)};$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(d,u,w,g){if(u){w=$jscomp.global;d=d.split(".");for(g=0;g<d.length-1;g++){var k=d[g];k in w||(w[k]={});w=w[k]}d=d[d.length-1];g=w[d];u=u(g);u!=g&&null!=u&&$jscomp.defineProperty(w,d,{configurable:!0,writable:!0,value:u})}};$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(d,w){return $jscomp.findInternal(this,d,w).v}},"es6","es3");
