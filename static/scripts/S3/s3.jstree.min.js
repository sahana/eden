/*
 ...
 requires jQuery jstree 1.0
*/
(function(){if(!jQuery||!jQuery.jstree){var l=!1,s=!1,q=!1;(function(b){b.vakata={};b.vakata.css={get_css:function(b,a,c){b=b.toLowerCase();var e=c.cssRules||c.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==b)return!0===a?(c.removeRule&&c.removeRule(d),c.deleteRule&&c.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,c){if(b.jstree.css.get_css(a,!1,c))return!1;c.insertRule?c.insertRule(a+" { }",0):c.addRule(a,null,0);return b.vakata.css.get_css(a)},
...
c=c&&b.isFunction(c[f])?c[f].apply(c,e):c;if("undefined"!==typeof c&&(0===f.indexOf("is_")||!0!==c&&!1!==c))return h=c,!1})}else this.each(function(){var c=b.data(this,"jstree_instance_id"),g=[],h=f?b.extend({},!0,f):{},p=b(this),l=!1,u=[],g=g.concat(e);p.data("jstree")&&g.push(p.data("jstree"));h=g.length?b.extend.apply(null,[!0,h].concat(g)):h;"undefined"!==typeof c&&a[c]&&a[c].destroy();c=parseInt(a.push({}),10)-1;b.data(this,"jstree_instance_id",c);h.plugins=b.isArray(h.plugins)?h.plugins:b.jstree.defaults.plugins.slice();
h.plugins.unshift("core");h.plugins=h.plugins.sort().join(",,").replace(/(,|^)([^,]+)(,,\2)+(,|$)/g,"$1$2$4").replace(/,,+/g,",").replace(/,$/,"").split(",");l=b.extend(!0,{},b.jstree.defaults,h);l.plugins=h.plugins;b.each(d,function(a,f){-1===b.inArray(a,l.plugins)?(l[a]=null,delete l[a]):u.push(a)});l.plugins=u;a[c]=new b.jstree._instance(c,b(this).addClass("jstree jstree-"+c),l);b.each(a[c]._get_settings().plugins,function(b,f){a[c].data[f]={}});b.each(a[c]._get_settings().plugins,function(b,f){d[f]&&
...
b.proxy(function(a,c){var e=this._get_node(c.rslt.obj),d=this;-1===e&&(e=this.get_container_ul());e.length&&e.find("li.jstree-open:not(:has(ul))").each(function(){d.load_node(this,b.noop,b.noop)})},this));this.__callback();this.load_node(-1,function(){this.loaded();this.reload_nodes()})},destroy:function(){var f,e=this.get_index(),m=this._get_settings(),h=this;b.each(m.plugins,function(a,b){try{d[b].__destroy.apply(h)}catch(c){}});this.__callback();if(this.is_focused())for(f in a)if(a.hasOwnProperty(f)&&
...
"\\.").replace(/\:/g,"\\:"))});this.__callback(a.data.core.to_open)},save_loaded:function(){},reload_nodes:function(a){var c=this,e=!0,d=[],n=[];a||(this.data.core.reopen=!1,this.data.core.refreshing=!0,this.data.core.to_open=b.map(b.makeArray(this.data.core.to_open),function(a){return"#"+a.toString().replace(/^#/,"").replace(/\\\//g,"/").replace(/\//g,"\\/").replace(/\\\./g,".").replace(/\./g,"\\.").replace(/\:/g,"\\:")}),this.data.core.to_load=b.map(b.makeArray(this.data.core.to_load),function(a){return"#"+
a.toString().replace(/^#/,"").replace(/\\\//g,"/").replace(/\//g,"\\/").replace(/\\\./g,".").replace(/\./g,"\\.").replace(/\:/g,"\\:")}),this.data.core.to_open.length&&(this.data.core.to_load=this.data.core.to_load.concat(this.data.core.to_open)));this.data.core.to_load.length&&(b.each(this.data.core.to_load,function(a,c){if("#"==c)return!0;b(c).length?d.push(c):n.push(c)}),d.length&&(this.data.core.to_load=n,b.each(d,function(a,b){c._is_loaded(b)||(c.load_node(b,function(){c.reload_nodes(!0)},function(){c.reload_nodes(!0)}),
...
b.call(),!1;var e=c||l?0:this._get_settings().core.animation,d=this;this._is_loaded(a)?(this._get_settings().core.open_parents&&a.parentsUntil(".jstree",".jstree-closed").each(function(){d.open_node(this,!1,!0)}),e&&a.children("ul").css("display","none"),a.removeClass("jstree-closed").addClass("jstree-open").children("a").removeClass("jstree-loading"),e?a.children("ul").stop(!0,!0).slideDown(e,function(){this.style.display="";d.after_open(a)}):d.after_open(a),this.__callback({obj:a}),b&&b.call()):
(a.children("a").addClass("jstree-loading"),this.load_node(a,function(){d.open_node(a,b,c)},b))},after_open:function(a){this.__callback({obj:a})},close_node:function(a,b){a=this._get_node(a);var c=b||l?0:this._get_settings().core.animation,e=this;if(!a.length||!a.hasClass("jstree-open"))return!1;c&&a.children("ul").attr("style","display:block !important");a.removeClass("jstree-open").addClass("jstree-closed");c?a.children("ul").stop(!0,!0).slideUp(c,function(){this.style.display="";e.after_close(a)}):
...
a.not(".jstree-open, .jstree-closed").addClass("jstree-leaf").children("ul").remove();this.__callback({obj:a})},get_rollback:function(){this.__callback();return{i:this.get_index(),h:this.get_container().children("ul").clone(!0),d:this.data}},set_rollback:function(a,b){this.get_container().empty().append(a);this.data=b;this.__callback()},load_node:function(a,b,c){this.__callback({obj:a})},_is_loaded:function(a){return!0},create_node:function(a,c,e,d,n){a=this._get_node(a);c="undefined"===typeof c?
"last":c;var k=b("<li />"),r=this._get_settings().core,p;if(-1!==a&&!a.length)return!1;if(!n&&!this._is_loaded(a))return this.load_node(a,function(){this.create_node(a,c,e,d,!0)}),!1;this.__rollback();"string"===typeof e&&(e={data:e});e||(e={});e.attr&&k.attr(e.attr);e.metadata&&k.data(e.metadata);e.state&&k.addClass("jstree-"+e.state);e.data||(e.data=this._get_string("new_node"));b.isArray(e.data)||(p=e.data,e.data=[],e.data.push(p));b.each(e.data,function(a,c){p=b("<a />");b.isFunction(c)&&(c=c.call(this,
e));if("string"==typeof c)p.attr("href","#")[r.html_titles?"html":"text"](c);else c.attr||(c.attr={}),c.attr.href||(c.attr.href="#"),p.attr(c.attr)[r.html_titles?"html":"text"](c.title),c.language&&p.addClass(c.language);p.prepend("<ins class='jstree-icon'>&#160;</ins>");!c.icon&&e.icon&&(c.icon=e.icon);c.icon&&(-1===c.icon.indexOf("/")?p.children("ins").addClass(c.icon):p.children("ins").css("background","url('"+c.icon+"') center center no-repeat"));k.append(p)});k.prepend("<ins class='jstree-icon'>&#160;</ins>");
-1===a&&(a=this.get_container(),"before"===c&&(c="first"),"after"===c&&(c="last"));switch(c){case "before":a.before(k);p=this._get_parent(a);break;case "after":a.after(k);p=this._get_parent(a);break;case "inside":case "first":a.children("ul").length||a.append("<ul />");a.children("ul").prepend(k);p=a;break;case "last":a.children("ul").length||a.append("<ul />");a.children("ul").append(k);p=a;break;default:a.children("ul").length||a.append("<ul />"),c||(c=0),p=a.children("ul").children("li").eq(c),
p.length?p.before(k):a.children("ul").append(k),p=a}if(-1===p||p.get(0)===this.get_container().get(0))p=-1;this.clean_node(p);this.__callback({obj:k,parent:p});d&&d.call(this,k);return k},get_text:function(a){a=this._get_node(a);if(!a.length)return!1;var b=this._get_settings().core.html_titles;a=a.children("a:eq(0)");return b?(a=a.clone(),a.children("INS").remove(),a.html()):(a=a.contents().filter(function(){return 3==this.nodeType}))?a[0].nodeValue:""},set_text:function(a,b){a=this._get_node(a);
...
this.hover_node(a.target)},this)).delegate("a","mouseleave.jstree",b.proxy(function(a){b(a.currentTarget).hasClass("jstree-loading")||this.dehover_node(a.target)},this)).bind("reopen.jstree",b.proxy(function(){this.reselect()},this)).bind("get_rollback.jstree",b.proxy(function(){this.dehover_node();this.save_selected()},this)).bind("set_rollback.jstree",b.proxy(function(){this.reselect()},this)).bind("close_node.jstree",b.proxy(function(a,c){var d=this._get_settings().ui,m=this._get_node(c.rslt.obj),
h=m&&m.length?m.children("ul").find("a.jstree-clicked"):b(),n=this;!1!==d.selected_parent_close&&h.length&&h.each(function(){n.deselect_node(this);"select_parent"===d.selected_parent_close&&n.select_node(m)})},this)).bind("delete_node.jstree",b.proxy(function(a,b){var c=this._get_settings().ui.select_prev_on_delete,d=this._get_node(b.rslt.obj),d=d&&d.length?d.find("a.jstree-clicked"):[],h=this;d.each(function(){h.deselect_node(this)});c&&d.length&&b.rslt.prev.each(function(){if(this.parentNode)return h.select_node(this),
...
reselect:function(){var a=this,c=this.data.ui.to_select,c=b.map(b.makeArray(c),function(a){return"#"+a.toString().replace(/^#/,"").replace(/\\\//g,"/").replace(/\//g,"\\/").replace(/\\\./g,".").replace(/\./g,"\\.").replace(/\:/g,"\\:")});b.each(c,function(b,c){c&&"#"!==c&&a.select_node(c)});this.data.ui.selected=this.data.ui.selected.filter(function(){return this.parentNode});this.__callback()},refresh:function(a){this.save_selected();return this.__call_old()},hover_node:function(a){a=this._get_node(a);
...
h="on"==d.select_multiple_modifier||!1!==d.select_multiple_modifier&&b&&b[d.select_multiple_modifier+"Key"],n=!1!==d.select_range_modifier&&b&&b[d.select_range_modifier+"Key"]&&this.data.ui.last_selected&&this.data.ui.last_selected[0]!==a[0]&&this.data.ui.last_selected.parent()[0]===a.parent()[0],k=this.is_selected(a),r=!0,p=this;if(c){if(d.disable_selecting_children&&h&&(a.parentsUntil(".jstree","li").children("a.jstree-clicked").length||a.children("ul").find("a.jstree-clicked:eq(0)").length))return!1;
r=!1;switch(!0){case n:this.data.ui.last_selected.addClass("jstree-last-selected");a=a[a.index()<this.data.ui.last_selected.index()?"nextUntil":"prevUntil"](".jstree-last-selected").addBack();-1==d.select_limit||a.length<d.select_limit?(this.data.ui.last_selected.removeClass("jstree-last-selected"),this.data.ui.selected.each(function(){this!==p.data.ui.last_selected[0]&&p.deselect_node(this)}),k=!1,r=!0):r=!1;break;case k&&!h:this.deselect_all();k=!1;r=!0;break;case !k&&!h:if(-1==d.select_limit||
0<d.select_limit)this.deselect_all(),r=!0;break;case k&&h:this.deselect_node(a);break;case !k&&h:if(-1==d.select_limit||this.data.ui.selected.length+1<=d.select_limit)r=!0}}r&&!k&&(n||(this.data.ui.last_selected=a),a.children("a").addClass("jstree-clicked"),d.selected_parent_open&&a.parents(".jstree-closed").each(function(){p.open_node(this,!1,!0)}),this.data.ui.selected=this.data.ui.selected.add(a),this._fix_scroll(a.eq(0)),this.__callback({obj:a,e:b}))},_fix_scroll:function(c){var b=this.get_container()[0];
...
this.get_container().find("a.jstree-clicked").parent();a.children("a.jstree-clicked").removeClass("jstree-clicked");this.data.ui.selected=b([]);this.data.ui.last_selected=!1;this.__callback({obj:a})}}});b.jstree.defaults.plugins.push("ui")})(jQuery);(function(b){b.jstree.plugin("crrm",{__init:function(){this.get_container().bind("move_node.jstree",b.proxy(function(a,b){if(this._get_settings().crrm.move.open_onmove){var d=this;b.rslt.np.parentsUntil(".jstree").addBack().filter(".jstree-closed").each(function(){d.open_node(this,
!1,!0)})}},this))},defaults:{input_width_limit:200,move:{always_copy:!1,open_onmove:!0,default_position:"last",check_move:function(a){return!0}}},_fn:{_show_input:function(a,c){a=this._get_node(a);var d=this._get_settings().core.rtl,e=this._get_settings().crrm.input_width_limit,f=a.children("ins").width(),g=a.find("> a:visible > ins").width()*a.find("> a:visible > ins").length,m=this.get_text(a),h=b("<div />",{css:{position:"absolute",top:"-200px",left:d?"0px":"-1000px",visibility:"hidden"}}).appendTo("body"),
n=a.css("position","relative").append(b("<input />",{value:m,"class":"jstree-rename-input",css:{padding:"0",border:"1px solid silver",position:"absolute",left:d?"auto":f+g+4+"px",right:d?f+g+4+"px":"auto",top:"0px",height:this.data.core.li_height-2+"px",lineHeight:this.data.core.li_height-2+"px",width:"150px"},blur:b.proxy(function(){var b=a.children(".jstree-rename-input"),d=b.val();""===d&&(d=m);h.remove();b.remove();this.set_text(a,m);this.rename_node(a,d);c.call(this,a,d,m);a.css("position","")},
this),keyup:function(a){a=a.keyCode||a.which;27==a?(this.value=m,this.blur()):13==a?this.blur():n.width(Math.min(h.text("pW"+this.value).width(),e))},keypress:function(a){if(13==(a.keyCode||a.which))return!1}})).children(".jstree-rename-input");this.set_text(a,"");h.css({fontFamily:n.css("fontFamily")||"",fontSize:n.css("fontSize")||"",fontWeight:n.css("fontWeight")||"",fontStyle:n.css("fontStyle")||"",fontStretch:n.css("fontStretch")||"",fontVariant:n.css("fontVariant")||"",letterSpacing:n.css("letterSpacing")||
"",wordSpacing:n.css("wordSpacing")||""});n.width(Math.min(h.text("pW"+n[0].value).width(),e))[0].select()},rename:function(a){a=this._get_node(a);this.__rollback();var b=this.__callback;this._show_input(a,function(a,e,f){b.call(this,{obj:a,new_name:e,old_name:f})})},create:function(a,c,d,e,f){var g=this;(a=this._get_node(a))||(a=-1);this.__rollback();return this.create_node(a,c,d,function(a){var c=this._get_parent(a),d=b(a).index();e&&e.call(this,a);c.length&&c.hasClass("jstree-closed")&&this.open_node(c,
!1,!0);f?g.__callback({obj:a,name:this.get_text(a),parent:c,position:d}):this._show_input(a,function(a,b,e){g.__callback({obj:a,name:b,parent:c,position:d})})})},remove:function(a){a=this._get_node(a,!0);var b=this._get_parent(a),d=this._get_prev(a);this.__rollback();a=this.delete_node(a);!1!==a&&this.__callback({obj:a,prev:d,parent:b})},check_move:function(){return this.__call_old()&&this._get_settings().crrm.move.check_move.call(this,this._get_move())?!0:!1},move_node:function(a,b,d,e,f,g){var m=
this._get_settings().crrm.move;if(!f)return"undefined"===typeof d&&(d=m.default_position),"inside"!==d||m.default_position.match(/^(before|after)$/)||(d=m.default_position),this.__call_old(!0,a,b,d,e,!1,g);if(!0===m.always_copy||"multitree"===m.always_copy&&a.rt.get_index()!==a.ot.get_index())e=!0;this.__call_old(!0,a,b,d,e,!0,g)},cut:function(a){a=this._get_node(a,!0);if(!a||!a.length)return!1;this.data.crrm.cp_nodes=!1;this.data.crrm.ct_nodes=a;this.__callback({obj:a})},copy:function(a){a=this._get_node(a,
...
(e.progressive_render||e.progressive_unload)&&!a.is(".jstree-open, .jstree-leaf")&&0===a.children("ul").children("li").length&&a.data("jstree_children")){if(f=this._parse_json(a.data("jstree_children"),a))a.append(f),e.progressive_unload||a.removeData("jstree_children");this.clean_node(a);c&&c.call(this)}else{if(a&&-1!==a){if(a.data("jstree_is_loading"))return;a.data("jstree_is_loading",!0)}switch(!0){case !e.data&&!e.ajax:throw"Neither data nor ajax settings supplied.";case b.isFunction(e.data):e.data.call(this,
...
"success"===c&&e.correct_state&&this.correct_state(a)):"success"===c&&e.correct_state&&this.get_container().children("ul").empty();d&&d.call(this)},f=function(d,f,n){var k=this.get_settings().json_data.ajax.success;k&&(d=k.call(this,d,f,n)||d);if(""===d||d&&d.toString&&""===d.toString().replace(/^[\s\n]+$/,"")||!b.isArray(d)&&!b.isPlainObject(d))return g.call(this,n,f,"");(d=this._parse_json(d,a))?(-1!==a&&a?(a.append(d).children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading")):
...
b.isFunction(e.ajax.data)&&(e.ajax.data=e.ajax.data.call(this,a)),b.ajax(e.ajax)}}},_parse_json:function(a,c,d){var e=!1,f=this._get_settings(),g=f.json_data,m=f.core.html_titles,h;if(!a)return e;g.progressive_unload&&c&&-1!==c&&c.data("jstree_children",e);if(b.isArray(a)){e=b("<ul>");if(!a.length)return!1;f=0;for(g=a.length;f<g;f++)h=this._parse_json(a[f],c,!0),h.length&&(e=e.append(h));e=e.children()}else{"string"==typeof a&&(a={data:a});if(!a.data&&""!==a.data)return e;e=b("<li />");a.attr&&e.attr(a.attr);
a.metadata&&e.data(a.metadata);a.state&&e.addClass("jstree-"+a.state);b.isArray(a.data)||(h=a.data,a.data=[],a.data.push(h));b.each(a.data,function(c,d){h=b("<a />");b.isFunction(d)&&(d=d.call(this,a));if("string"==typeof d)h.attr("href","#")[m?"html":"text"](d);else d.attr||(d.attr={}),d.attr.href||(d.attr.href="#"),h.attr(d.attr)[m?"html":"text"](d.title),d.language&&h.addClass(d.language);h.prepend("<ins class='jstree-icon'>&#160;</ins>");!d.icon&&a.icon&&(d.icon=a.icon);d.icon&&(-1===d.icon.indexOf("/")?
h.children("ins").addClass(d.icon):h.children("ins").css("background","url('"+d.icon+"') center center no-repeat"));e.append(h)});e.prepend("<ins class='jstree-icon'>&#160;</ins>");a.children&&(g.progressive_render&&"open"!==a.state?e.addClass("jstree-closed").data("jstree_children",a.children):(g.progressive_unload&&e.data("jstree_children",a.children),b.isArray(a.children)&&a.children.length&&(h=this._parse_json(a.children,c,!0),h.length&&(c=b("<ul />"),c.append(h),e.append(c)))))}d||(d=b("<ul />"),
d.append(e),e=d);return e},get_json:function(a,c,d,e){var f=[],g=this._get_settings(),m=this,h,n,k,r,p,l;(a=this._get_node(a))&&-1!==a||(a=this.get_container().find("> ul > li"));c=b.isArray(c)?c:["id","class"];!e&&this.data.types&&c.push(g.types.type_attr);d=b.isArray(d)?d:[];a.each(function(){k=b(this);h={data:[]};c.length&&(h.attr={});b.each(c,function(a,b){(n=k.attr(b))&&n.length&&n.replace(/jstree[^ ]*/ig,"").length&&(h.attr[b]=(" "+n).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))});k.hasClass("jstree-open")&&(h.state="open");k.hasClass("jstree-closed")&&(h.state="closed");k.data()&&(h.metadata=k.data());r=k.children("a");r.each(function(){p=b(this);d.length||-1!==b.inArray("languages",g.plugins)||p.children("ins").get(0).style.backgroundImage.length||p.children("ins").get(0).className&&p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").length?(l=!1,-1!==b.inArray("languages",g.plugins)&&b.isArray(g.languages)&&g.languages.length&&b.each(g.languages,
function(a,b){if(p.hasClass(b))return l=b,!1}),n={attr:{},title:m.get_text(p,l)},b.each(d,function(a,b){n.attr[b]=(" "+(p.attr(b)||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")}),-1!==b.inArray("languages",g.plugins)&&b.isArray(g.languages)&&g.languages.length&&b.each(g.languages,function(a,b){if(p.hasClass(b))return n.language=b,!0}),p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(n.icon=p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,
"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")),p.children("ins").get(0).style.backgroundImage.length&&(n.icon=p.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")",""))):n=m.get_text(p);1<r.length?h.data.push(n):h.data=n});k=k.find("> ul > li");k.length&&(h.children=m.get_json(k,c,d,!0));f.push(h)});return f}}})})(jQuery);(function(b){var a=!1;b.jstree.plugin("languages",{__init:function(){this._load_css()},defaults:[],_fn:{set_lang:function(c){var d=this._get_settings().languages,
...
d){var e=this._get_settings().languages,f=this._get_settings().core.strings;b.isArray(e)&&e.length&&(d=d&&-1!=b.inArray(d,e)?d:this.data.languages.current_language);return f[d]&&f[d][a]?f[d][a]:f[a]?f[a]:a},get_text:function(a,d){a=this._get_node(a)||this.data.ui.last_selected;if(!a.size())return!1;var e=this._get_settings().languages,f=this._get_settings().core.html_titles;b.isArray(e)&&e.length?(d=d&&-1!=b.inArray(d,e)?d:this.data.languages.current_language,a=a.children("a."+d)):a=a.children("a:eq(0)");
if(f)return a=a.clone(),a.children("INS").remove(),a.html();a=a.contents().filter(function(){return 3==this.nodeType})[0];return a.nodeValue},set_text:function(a,d,e){a=this._get_node(a)||this.data.ui.last_selected;if(!a.size())return!1;var f=this._get_settings().languages,g=this._get_settings().core.html_titles;b.isArray(f)&&f.length?(e=e&&-1!=b.inArray(e,f)?e:this.data.languages.current_language,a=a.children("a."+e)):a=a.children("a:eq(0)");if(g)return f=a.children("INS").clone(),a.html(d).prepend(f),
this.__callback({obj:a,name:d,lang:e}),!0;a=a.contents().filter(function(){return 3==this.nodeType})[0];this.__callback({obj:a,name:d,lang:e});return a.nodeValue=d},_load_css:function(){var c=this._get_settings().languages,d="/* languages css */",e=".jstree-"+this.get_index()+" a",f;if(b.isArray(c)&&c.length){this.data.languages.current_language=c[0];for(f=0;f<c.length;f++)d+=e+"."+c[f]+" {",c[f]!=this.data.languages.current_language&&(d+=" display:none; "),d+=" } ";a=b.vakata.css.add_sheet({str:d,
...
d?(g&&"down"===m&&(clearInterval(g),g=!1),g||(m="up",g=setInterval(function(){b(document).scrollTop(b(document).scrollTop()-b.vakata.dnd.scroll_spd)},150))):g&&"up"===m&&(clearInterval(g),g=!1);20>b(window).height()-(a.pageY-d)?(g&&"up"===m&&(clearInterval(g),g=!1),g||(m="down",g=setInterval(function(){b(document).scrollTop(b(document).scrollTop()+b.vakata.dnd.scroll_spd)},150))):g&&"down"===m&&(clearInterval(g),g=!1);20>a.pageX-c?(f&&"right"===h&&(clearInterval(f),f=!1),f||(h="left",f=setInterval(function(){b(document).scrollLeft(b(document).scrollLeft()-
...
b(function(){b.vakata.css.add_sheet({str:".jstree .jstree-real-checkbox { display:none; } ",title:"jstree"})})})(jQuery);(function(b){b.vakata.xslt=function(a,c,f){var g=!1,m,h,n;if(!1===g&&window.ActiveXObject)try{g=new ActiveXObject("Msxml2.XSLTemplate"),h=new ActiveXObject("Msxml2.DOMDocument"),h.loadXML(a),n=new ActiveXObject("Msxml2.FreeThreadedDOMDocument"),n.loadXML(c),g.stylesheet=n,m=g.createProcessor(),m.input=h,m.transform(),g=m.output}catch(k){}a=b.parseXML(a);c=b.parseXML(c);!1===g&&
"undefined"!==typeof XSLTProcessor&&(m=new XSLTProcessor,m.importStylesheet(c),g=m.transformToFragment(a,document),g=b("<div />").append(g).html());!1===g&&"undefined"!==typeof a.transformNode&&(g=a.transformNode(c));f.call(null,g)};var a={nest:'<?xml version="1.0" encoding="utf-8" ?><xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" ><xsl:output method="html" encoding="utf-8" omit-xml-declaration="yes" standalone="no" indent="no" media-type="text/html" /><xsl:template match="/">\t<xsl:call-template name="nodes">\t\t<xsl:with-param name="node" select="/root" />\t</xsl:call-template></xsl:template><xsl:template name="nodes">\t<xsl:param name="node" />\t<ul>\t<xsl:for-each select="$node/item">\t\t<xsl:variable name="children" select="count(./item) &gt; 0" />\t\t<li>\t\t\t<xsl:attribute name="class">\t\t\t\t<xsl:if test="position() = last()">jstree-last </xsl:if>\t\t\t\t<xsl:choose>\t\t\t\t\t<xsl:when test="@state = \'open\'">jstree-open </xsl:when>\t\t\t\t\t<xsl:when test="$children or @hasChildren or @state = \'closed\'">jstree-closed </xsl:when>\t\t\t\t\t<xsl:otherwise>jstree-leaf </xsl:otherwise>\t\t\t\t</xsl:choose>\t\t\t\t<xsl:value-of select="@class" />\t\t\t</xsl:attribute>\t\t\t<xsl:for-each select="@*">\t\t\t\t<xsl:if test="name() != \'class\' and name() != \'state\' and name() != \'hasChildren\'">\t\t\t\t\t<xsl:attribute name="{name()}"><xsl:value-of select="." /></xsl:attribute>\t\t\t\t</xsl:if>\t\t\t</xsl:for-each>\t<ins class="jstree-icon"><xsl:text>&#xa0;</xsl:text></ins>\t\t\t<xsl:for-each select="content/name">\t\t\t\t<a>\t\t\t\t<xsl:attribute name="href">\t\t\t\t\t<xsl:choose>\t\t\t\t\t<xsl:when test="@href"><xsl:value-of select="@href" /></xsl:when>\t\t\t\t\t<xsl:otherwise>#</xsl:otherwise>\t\t\t\t\t</xsl:choose>\t\t\t\t</xsl:attribute>\t\t\t\t<xsl:attribute name="class"><xsl:value-of select="@lang" /> <xsl:value-of select="@class" /></xsl:attribute>\t\t\t\t<xsl:attribute name="style"><xsl:value-of select="@style" /></xsl:attribute>\t\t\t\t<xsl:for-each select="@*">\t\t\t\t\t<xsl:if test="name() != \'style\' and name() != \'class\' and name() != \'href\'">\t\t\t\t\t\t<xsl:attribute name="{name()}"><xsl:value-of select="." /></xsl:attribute>\t\t\t\t\t</xsl:if>\t\t\t\t</xsl:for-each>\t\t\t\t\t<ins>\t\t\t\t\t\t<xsl:attribute name="class">jstree-icon \t\t\t\t\t\t\t<xsl:if test="string-length(attribute::icon) > 0 and not(contains(@icon,\'/\'))"><xsl:value-of select="@icon" /></xsl:if>\t\t\t\t\t\t</xsl:attribute>\t\t\t\t\t\t<xsl:if test="string-length(attribute::icon) > 0 and contains(@icon,\'/\')"><xsl:attribute name="style">background:url(<xsl:value-of select="@icon" />) center center no-repeat;</xsl:attribute></xsl:if>\t\t\t\t\t\t<xsl:text>&#xa0;</xsl:text>\t\t\t\t\t</ins>\t\t\t\t\t<xsl:copy-of select="./child::node()" />\t\t\t\t</a>\t\t\t</xsl:for-each>\t\t\t<xsl:if test="$children or @hasChildren"><xsl:call-template name="nodes"><xsl:with-param name="node" select="current()" /></xsl:call-template></xsl:if>\t\t</li>\t</xsl:for-each>\t</ul></xsl:template></xsl:stylesheet>',
...
!a||!c.ajax&&!b.isFunction(c.data)||a.is(".jstree-open, .jstree-leaf")||0<a.children("ul").children("li").size()},load_node_xml:function(a,c,f){var g=this.get_settings().xml_data,m=function(){},h=function(){};if((a=this._get_node(a))&&-1!==a){if(a.data("jstree_is_loading"))return;a.data("jstree_is_loading",!0)}switch(!0){case !g.data&&!g.ajax:throw"Neither data nor ajax settings supplied.";case b.isFunction(g.data):g.data.call(this,a,b.proxy(function(f){this.parse_xml(f,b.proxy(function(f){f&&(f=
...
c&&c.call(this)))},this))},this));break;case !!g.data&&!g.ajax||!!g.data&&!!g.ajax&&(!a||-1===a):a&&-1!=a||this.parse_xml(g.data,b.proxy(function(f){f?(f=f.replace(/ ?xmlns="[^"]*"/ig,""),10<f.length&&(f=b(f),this.get_container().children("ul").empty().append(f.children()),g.clean_node&&this.clean_node(a),c&&c.call(this))):g.correct_state&&(this.get_container().children("ul").empty(),c&&c.call(this))},this));break;case !g.data&&!!g.ajax||!!g.data&&!!g.ajax&&a&&-1!==a:m=function(b,c,e){var h=this.get_settings().xml_data.ajax.error;
h&&h.call(this,b,c,e);-1!==a&&a.length?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),"success"===c&&g.correct_state&&this.correct_state(a)):"success"===c&&g.correct_state&&this.get_container().children("ul").empty();f&&f.call(this)},h=function(f,h,l){f=l.responseText;var p=this.get_settings().xml_data.ajax.success;p&&(f=p.call(this,f,h,l)||f);if(""===f||f&&f.toString&&""===f.toString().replace(/^[\s\n]+$/,""))return m.call(this,l,h,"");this.parse_xml(f,
b.proxy(function(f){f&&(f=f.replace(/ ?xmlns="[^"]*"/ig,""),10<f.length?(f=b(f),-1!==a&&a?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.append(f),a.removeData("jstree_is_loading")):this.get_container().children("ul").empty().append(f.children()),g.clean_node&&this.clean_node(a),c&&c.call(this)):a&&-1!==a?(a.children("a.jstree-loading").removeClass("jstree-loading"),a.removeData("jstree_is_loading"),g.correct_state&&(this.correct_state(a),c&&c.call(this))):g.correct_state&&(this.get_container().children("ul").empty(),
c&&c.call(this)))},this))},g.ajax.context=this,g.ajax.error=m,g.ajax.success=h,g.ajax.dataType||(g.ajax.dataType="xml"),b.isFunction(g.ajax.url)&&(g.ajax.url=g.ajax.url.call(this,a)),b.isFunction(g.ajax.data)&&(g.ajax.data=g.ajax.data.call(this,a)),b.ajax(g.ajax)}},parse_xml:function(c,e){var f=this._get_settings().xml_data;b.vakata.xslt(c,a[f.xsl],e)},get_xml:function(a,e,f,g,m){var h="",n=this._get_settings(),k=this,l,p,q,s,t;a||(a="flat");m||(m=0);(e=this._get_node(e))&&-1!==e||(e=this.get_container().find("> ul > li"));
f=b.isArray(f)?f:["id","class"];!m&&this.data.types&&-1===b.inArray(n.types.type_attr,f)&&f.push(n.types.type_attr);g=b.isArray(g)?g:[];m||(n.xml_data.get_include_preamble&&(h+='<?xml version="1.0" encoding="UTF-8"?>'),h+="<root>");e.each(function(){h+="<item";q=b(this);b.each(f,function(a,b){var d=q.attr(b);n.xml_data.get_skip_empty&&"undefined"===typeof d||(h+=" "+b+'="'+c((" "+(d||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))+'"')});q.hasClass("jstree-open")&&
(h+=' state="open"');q.hasClass("jstree-closed")&&(h+=' state="closed"');"flat"===a&&(h+=' parent_id="'+c(m)+'"');h+=">";h+="<content>";s=q.children("a");s.each(function(){l=b(this);t=!1;h+="<name";-1!==b.inArray("languages",n.plugins)&&b.each(n.languages,function(a,b){if(l.hasClass(b))return h+=' lang="'+c(b)+'"',t=b,!1});g.length&&b.each(g,function(a,b){var d=l.attr(b);n.xml_data.get_skip_empty&&"undefined"===typeof d||(h+=" "+b+'="'+c((" "+d||"").replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))+'"')});l.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(h+=' icon="'+c(l.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))+'"');l.children("ins").get(0).style.backgroundImage.length&&(h+=' icon="'+c(l.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","").replace(/'/ig,"").replace(/"/ig,""))+'"');h+=">";h+="<![CDATA["+k.get_text(l,t)+"]]\x3e";
h+="</name>"});h+="</content>";p=q[0].id||!0;q=q.find("> ul > li");p=q.length?k.get_xml(a,q,f,g,p):"";"nest"==a&&(h+=p);h+="</item>";"flat"==a&&(h+=p)});m||(h+="</root>");return h}}})})(jQuery);(function(b){8<=b().jquery.split(".")[1]?(b.expr[":"].jstree_contains=b.expr.createPseudo(function(a){return function(b){return 0<=(b.textContent||b.innerText||"").toLowerCase().indexOf(a.toLowerCase())}}),b.expr[":"].jstree_title_contains=b.expr.createPseudo(function(a){return function(b){return 0<=(b.getAttribute("title")||
...
this._get_node(a))&&a.length?a.attr(this._get_settings().types.type_attr)||"default":!1},set_type:function(a,b){b=this._get_node(b);var d=b.length&&a?b.attr(this._get_settings().types.type_attr,a):!1;d&&this.__callback({obj:b,type:a});return d},_check:function(a,c,d){c=this._get_node(c);var e=!1,f=this._get_type(c),g=0,m=this,h=this._get_settings().types,n=!1;if(-1===c)if(h[a])e=h[a];else return;else{if(!1===f)return;(n=h.use_data?c.data("jstree"):!1)&&n.types&&"undefined"!==typeof n.types[a]?e=n.types[a]:
h.types[f]&&"undefined"!==typeof h.types[f][a]?e=h.types[f][a]:h.types["default"]&&"undefined"!==typeof h.types["default"][a]&&(e=h.types["default"][a])}b.isFunction(e)&&(e=e.call(this,c));"max_depth"===a&&-1!==c&&!1!==d&&-2!==h.max_depth&&0!==e&&c.children("a:eq(0)").parentsUntil(".jstree","li").each(function(b){if(-1!==h.max_depth&&0>=h.max_depth-(b+1))return e=0,!1;g=0===b?e:m._check(a,this,!1);if(-1!==g&&0>=g-(b+1))return e=0,!1;0<=g&&(g-(b+1)<e||0>e)&&(e=g-(b+1));0<=h.max_depth&&(h.max_depth-
(b+1)<e||0>e)&&(e=h.max_depth-(b+1))});return e},check_move:function(){if(!this.__call_old())return!1;var a=this._get_move(),c=a.rt._get_settings().types,d=a.rt._check("max_children",a.cr),e=a.rt._check("max_depth",a.cr),f=a.rt._check("valid_children",a.cr),g=0,m=1;if("none"===f||b.isArray(f)&&a.ot&&a.ot._get_type&&(a.o.each(function(){if(-1===b.inArray(a.ot._get_type(this),f))return m=!1}),!1===m)||-2!==c.max_children&&-1!==d&&(g=-1===a.cr?this.get_container().find("> ul > li").not(a.o).length:a.cr.find("> ul > li").not(a.o).length,
g+a.o.length>d))return!1;if(-2!==c.max_depth&&-1!==e){m=0;if(0===e)return!1;if("undefined"===typeof a.o.d){for(c=a.o;0<c.length;)c=c.find("> ul > li"),m++;a.o.d=m}if(0>e-a.o.d)return!1}return!0},create_node:function(a,c,d,e,f,g){if(!g&&(f||this._is_loaded(a))){var m="string"==typeof c&&c.match(/^before|after$/i)&&-1!==a?this._get_parent(a):this._get_node(a),h=this._get_settings().types,n=this._check("max_children",m),k=this._check("max_depth",m),l=this._check("valid_children",m);"string"===typeof d&&
(d={data:d});d||(d={});if("none"===l)return!1;if(b.isArray(l))if(!d.attr||!d.attr[h.type_attr])d.attr||(d.attr={}),d.attr[h.type_attr]=l[0];else if(-1===b.inArray(d.attr[h.type_attr],l))return!1;if(-2!==h.max_children&&-1!==n&&(m=-1===m?this.get_container().find("> ul > li").length:m.find("> ul > li").length,m+1>n)||-2!==h.max_depth&&-1!==k&&0>k-1)return!1}return this.__call_old(!0,a,c,d,e,f,g)}}})})(jQuery);(function(b){b.jstree.plugin("html_data",{__init:function(){this.data.html_data.original_container_html=
...
e)},this)):this.model_done(f.getChildren(),e)}},defaults:{object:!1,id_prefix:!1,async:!1},_fn:{model_done:function(a,c){var f=[],g=this._get_settings(),m=this;b.isArray(a)||(a=[a]);b.each(a,function(a,c){var d=c.getProps()||{};d.attr=c.getAttr()||{};c.getChildrenCount()&&(d.state="closed");d.data=c.getName();b.isArray(d.data)||(d.data=[d.data]);m.data.types&&b.isFunction(c.getType)&&(d.attr[g.types.type_attr]=c.getType());d.attr.id&&g.model.id_prefix&&(d.attr.id=g.model.id_prefix+d.attr.id);d.metadata||
(d.metadata={});d.metadata.jstree_model=c;f.push(d)});c.call(null,f)}}})})(jQuery)}})();
(function(l,s){var q=0;l.widget("s3.hierarchicalopts",{options:{selected:null,noneSelectedText:"Select",selectedText:"selected",noOptionsText:"No options available",multiple:!0,leafonly:!0,themesFolder:"static/styles/jstree",theme:"default",htmlTitles:!0},_create:function(){var b=l(this.element),a=this.options;this.id=q;q+=1;this._namespace=".hierarchicalopts"+q;this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.button=l('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></button>');
this.buttonText=l("<span>"+a.noneSelectedText+"</span>").appendTo(this.button);this.noopts=l('<span class="no-options-available">'+a.noOptionsText+"</span>").hide();this.tree=b.find(".s3-hierarchy-tree").first().hide().before(this.noopts).before(this.button).detach().appendTo("body");this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){l.Widget.prototype.destroy.call(this);this._unbindEvents();l(this.button).remove();l(this.noopts).remove();l(this.tree).detach().appendTo(this.element).show()},
refresh:function(){this._unbindEvents();var b=this.options;if(this.tree.find("li").length){this.noopts.hide();this.button.show();var a=[],c=b.selected;if(c){for(var d=this.treeID,e=0,f=c.length;e<f;e++)a.push(d+"-"+c[e]);this._updateButtonText(a)}l.jstree._themes=S3.Ap.concat("/",b.themesFolder,"/");"ltr"==l("body").css("direction")?(c=!1,d=b.theme):(c=!0,d=b.theme+"-rtl");var e=b.multiple,g=b.leafonly,f=this.tree,m=[],h=f.find("> ul > li");1==h.length&&m.push(h.attr("id"));f.jstree({core:{animation:100,
check_callback:!0,html_titles:b.htmlTitles,initially_open:m,rtl:c},themes:{icons:!1,theme:d},ui:{initially_select:a,select_limit:e?-1:1,select_multiple_modifier:"on"},checkbox:{override_ui:!0,two_state:!g},plugins:["themes","html_data","ui","sort","checkbox"]});if(!e){var f=this.tree,n=jQuery.jstree._reference(f);f.bind("check_node.jstree",function(a,b){var c=b.rslt.obj.attr("id");n.get_checked(null,!0).each(function(){c!=this.id&&(g&&!n.is_leaf("#"+this.id)||n.uncheck_node("#"+this.id))})})}this._bindEvents()}else this.button.hide(),
this.noopts.show()},_updateSelectedNodes:function(){var b=this.input.val(),b=b?JSON.parse(b):[],a=this.tree,c=[],d=[],e=this.options.leafonly,f=a.jstree("get_checked",null,!0);l(f).each(function(){var b=l(this).attr("id");if(b&&(!e||a.jstree("is_leaf",this))){var f=parseInt(b.split("-").pop());f&&(c.push(f),d.push(b))}});var f=!1,g=l(c).not(b).get();g.length?f=!0:(g=l(b).not(c).get(),g.length&&(f=!0));this.input.val(JSON.stringify(c));this._updateButtonText(d);f&&l(this.element).trigger("select.s3hierarchy");
return!0},_updateButtonText:function(b){var a=null,a=this.options;if(numSelected=b?b.length:0)if(1<numSelected)a=a.selectedText.replace("#",numSelected);else{for(var c=[],d=0;d<numSelected;d++)c.push(l("#"+b[d]+" > a").text().replace(/^\s+|\s+$/g,""));a=c.length?c.join(" "):a.noneSelectedText}else a=a.noneSelectedText;this.buttonText.text(a)},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=l("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=
this.input.val();return b?JSON.parse(b):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},openMenu:function(){this._isOpen&&this.closeMenu();var b=l(this.button),a=b.offset();l(this.tree).css({position:"absolute",top:a.top+b.outerHeight(),left:a.left,minWidth:b.outerWidth()-8,"z-index":999999}).show().jstree("set_focus");this._isOpen=!0;b.addClass("ui-state-active");l(this).trigger("open")},closeMenu:function(){l(this.tree).fadeOut(50).jstree("unset_focus").unbind("click.hierarchicalopts").unbind("mouseleave.hierarchicalopts");
this._isOpen=!1;l(this.button).removeClass("ui-state-active");l(this).trigger("close")},addNode:function(b,a,c,d){var e=this.tree,f=this.treeID,g=b?"#"+f+"-"+b:-1;a=f+"-"+a;e.jstree("create_node",g,"last",{data:c,attr:{id:a,rel:"leaf"}},!1,!1);b&&(l(g).attr({rel:"parent"}),e.jstree("open_node",g));d&&e.jstree("check_node","#"+a)},_bindEvents:function(){var b=this,a=l(this.tree),c=l(this.button),d=this._namespace;a.bind("check_node.jstree",function(c,d){b._updateSelectedNodes();if(b.options.multiple)a.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",
function(){window.setTimeout(function(){b.closeMenu()},100)});else window.setTimeout(function(){b.closeMenu()},100)}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("open_node.jstree",function(a,b){b.inst._get_parent(b.rslt.obj).length&&b.inst.open_node(b.inst._get_parent(b.rslt.obj),!1,!0)});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+
d,function(){c.hasClass("ui-state-disabled")||l(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){l(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||l(this).addClass("ui-state-focus")}).bind("blur"+d,function(){l(this).removeClass("ui-state-focus")});l(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length||b.closeMenu()});return!0},_unbindEvents:function(){var b=
l(this.tree);l(this.button);var a=this._namespace;b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");l(this.button).unbind(a);l(document).unbind(a);return!0}})})(jQuery);
(function(l,s){var q=0;l.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,addLabel:"Add",addURL:null,themesFolder:"static/styles/jstree",theme:"default",htmlTitles:!0},_create:function(){this.id=q;q+=1},_init:function(){this.tree=l(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){l.Widget.prototype.destroy.call(this)},refresh:function(){var b=
this.tree,a=this.options;this._unbindEvents();var c,d;l.jstree._themes=S3.Ap.concat("/",a.themesFolder,"/");"ltr"==l("body").css("direction")?(c=!1,d=a.theme):(c=!0,d=a.theme+"-rtl");var e=[],f=b.find("> ul > li");1==f.length&&e.push(f.attr("id"));var g=this;b.jstree({core:{animation:100,check_callback:!0,html_titles:a.htmlTitles,initially_open:e,rtl:c},themes:{icons:!1,theme:d},ui:{select_limit:1},contextmenu:{items:{create:null,rename:null,remove:null,ccp:null,open:{label:g.options.openLabel,action:function(a){g._openNode(a)},
separator_after:!0},edit:{label:g.options.editLabel,action:function(a){g._editNode(a)}},"delete":{label:g.options.deleteLabel,separator_after:!0,_disabled:!0},add:{label:g.options.addLabel,_disabled:!0}},select_node:!0},plugins:["themes","html_data","ui","sort","contextmenu"]});this._bindEvents()},_openNode:function(b){var a=this.options.openURL;b=b.attr("id");a&&b&&(b=parseInt(b.split("-").pop()))&&(a=a.replace("[id]",b).replace("%5Bid%5D",b),window.location.href=a)},refreshNode:function(b){var a=
this.options.ajaxURL,c=b.attr("id");if(a&&c&&(c=parseInt(c.split("-").pop()))){var d=this.tree;l.getJSONS3(a+"?node="+c,function(a){a.label&&d.jstree("rename_node",b,a.label)})}},_editNode:function(b){var a=this.options.editURL;b=b.attr("id");if(a&&b){var c=parseInt(b.split("-").pop());if(c){a=a.replace("[id]",c).replace("%5Bid%5D",c).split("?")[0];a+="?node="+b+"&hierarchy="+this.options.widgetID;b=S3.uid();var d=l('<iframe id="'+b+'" src='+a+" onload=\"S3.popup_loaded('"+b+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body");
d.dialog({close:function(a,b){if(self.parent){var c=self.parent.$("iframe.ui-dialog-content"),l=c.width();c.width(0);window.setTimeout(function(){c.width(l)},300)}d.remove()},minHeight:480,modal:!0,open:function(a,b){l(".ui-widget-overlay").bind("click",function(){d.dialog("close")})},title:this.options.editTitle,minWidth:320,closeText:""})}}},_bindEvents:function(){return!0},_unbindEvents:function(){return!0}})})(jQuery);
