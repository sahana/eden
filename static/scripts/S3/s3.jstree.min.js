...
[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},openMenu:function(){this._isOpen&&this.closeMenu();var b=n(this.button),a=b.offset();n(this.tree).css({position:"absolute",top:a.top+b.outerHeight(),left:a.left,minWidth:b.outerWidth()-8,"z-index":999999}).show();this._isOpen=!0;b.addClass("ui-state-active");n(this).trigger("open")},closeMenu:function(){n(this.tree).hide();this._isOpen=!1;n(this.button).removeClass("ui-state-active");n(this).trigger("close")},_bindEvents:function(){var b=
this,a=n(this.tree),c=n(this.button),d=this._namespace;a.bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-hover")}).bind("mouseleave"+
