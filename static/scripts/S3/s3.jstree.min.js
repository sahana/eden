...
*/
(function(){if(!jQuery||!jQuery.jstree){var r=!1,t=!1,s=!1;(function(b){b.vakata={};b.vakata.css={get_css:function(a,b,c){a=a.toLowerCase();var e=c.cssRules||c.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==a)return!0===b?(c.removeRule&&c.removeRule(d),c.deleteRule&&c.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,c){if(b.jstree.css.get_css(a,!1,c))return!1;c.insertRule?c.insertRule(a+" { }",0):c.addRule(a,null,0);return b.vakata.css.get_css(a)},
...
(function(r,t){var s=0;r.widget("s3.hierarchicalopts",{options:{appname:"eden",selected:null},_create:function(){var b=r(this.element);this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.tree=b.find(".s3-hierarchy-tree").first();this.id=s;s+=1},_init:function(){this.refresh()},_destroy:function(){},refresh:function(){this._unbindEvents();var b=this.options,a=[],c=b.selected;if(c)for(var d=this.treeID,e=0,f=c.length;e<f;e++)a.push(d+"-"+c[e]);r.jstree._themes="/"+
b.appname+"/static/styles/jstree/";this.tree.jstree({core:{animation:100},themes:{icons:!1},ui:{initially_select:a},checkbox:{override_ui:!0},plugins:["themes","html_data","ui","checkbox","sort"]});this._bindEvents()},_updateSelectedNodes:function(b){b=this.input.val();var a=[];b=b?JSON.parse(b):[];var c=this.tree.jstree("get_checked",null,!0);r(c).each(function(){var b=r(this).attr("id");b&&(b=parseInt(b.split("-").pop()))&&a.push(b)});var c=!1,d=r(a).not(b).get();d.length?c=!0:(d=r(b).not(a).get(),
d.length&&(c=!0));this.input.val(JSON.stringify(a));c&&r(this.element).trigger("select.s3hierarchy");return!0},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=r("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?JSON.parse(b):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},_bindEvents:function(){var b=this;r(this.tree).bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",
function(a,c){b._updateSelectedNodes()});return!0},_unbindEvents:function(){r(this.tree).unbind("check_node.jstree").unbind("uncheck_node.jstree");return!0}})})(jQuery);
