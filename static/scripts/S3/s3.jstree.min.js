/*
 ...
 requires jQuery jstree 3.0.3
*/
(function(c){"function"===typeof define&&define.amd?define(["jquery"],c):"object"===typeof exports?c(require("jquery")):c(jQuery)})(function(c,v){if(!c.jstree){var A=0,m=!1,p=!1,q=!1,t=[],s=c("script:last").attr("src"),u=document,z=u.createElement("LI"),x;z.setAttribute("role","treeitem");x=u.createElement("I");x.className="jstree-icon jstree-ocl";z.appendChild(x);x=u.createElement("A");x.className="jstree-anchor";x.setAttribute("href","#");u=u.createElement("I");u.className="jstree-icon jstree-themeicon";
x.appendChild(u);z.appendChild(x);x=u=null;c.jstree={version:"3.0.3",defaults:{plugins:[]},plugins:{},path:s&&-1!==s.indexOf("/")?s.replace(/\/[^\/]+$/,""):"",idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%]/g};c.jstree.create=function(a,b){var e=new c.jstree.core(++A),d=b;b=c.extend(!0,{},c.jstree.defaults,b);d&&d.plugins&&(b.plugins=d.plugins);c.each(b.plugins,function(a,d){"core"!==a&&(e=e.plugin(d,b[d]))});e.init(a,b);return e};c.jstree.core=function(a){this._id=a;this._cnt=0;this._wrk=null;this._data=
...
e=Array.prototype.slice.call(arguments,1),d=null;this.each(function(){var g=c.jstree.reference(this),f=b&&g?g[a]:null;d=b&&f?f.apply(g,e):null;g||b||a!==v&&!c.isPlainObject(a)||c(this).data("jstree",new c.jstree.create(this,a));if(g&&!b||!0===a)d=g||!1;if(null!==d&&d!==v)return!1});return null!==d&&d!==v?d:this};c.expr[":"].jstree=c.expr.createPseudo(function(a){return function(a){return c(a).hasClass("jstree")&&c(a).data("jstree")!==v}});c.jstree.defaults.core={data:!1,strings:!1,check_callback:!1,
...
[];b=b.is("ul")?b.children():b;var d=a.id,g=[],f=[],h=this._model.data,k=h[d];a=this._data.core.selected.length;var l,r;b.each(c.proxy(function(a,e){if(l=this._parse_model_from_html(c(e),d,k.parents.concat()))g.push(l),f.push(l),h[l].children_d.length&&(f=f.concat(h[l].children_d))},this));k.children=g;k.children_d=f;b=0;for(r=k.parents.length;b<r;b++)h[k.parents[b]].children_d=h[k.parents[b]].children_d.concat(f);this.trigger("model",{nodes:f,parent:d});"#"!==d?(this._node_changed(d),this.redraw()):
...
(d.state.loaded=!1,d.children=[],d.children_d=[]);p[d.id]=d;f=0;for(g=d.children.length;f<g;f++)k=v(p[d.children[f]],d.id,b),n=p[k],d.children_d.push(k),n.children_d.length&&(d.children_d=d.children_d.concat(n.children_d));delete a.data;delete a.children;p[d.id].original=a;d.state.selected&&c.push(d.id);return d.id},z=function(a,d,b){b=b?b.concat():[];d&&b.unshift(d);var g=!1,f,n,l;do g="j"+k+"_"+ ++m;while(p[g]);d={id:!1,text:"string"===typeof a?a:"",icon:"object"===typeof a&&a.icon!==e?a.icon:!0,
...
a.state[f]);if(a&&"object"===typeof a.li_attr)for(f in a.li_attr)a.li_attr.hasOwnProperty(f)&&(d.li_attr[f]=a.li_attr[f]);d.li_attr.id&&!d.id&&(d.id=d.li_attr.id.toString());d.id||(d.id=g);d.li_attr.id||(d.li_attr.id=d.id);if(a&&"object"===typeof a.a_attr)for(f in a.a_attr)a.a_attr.hasOwnProperty(f)&&(d.a_attr[f]=a.a_attr[f]);if(a&&a.children&&a.children.length){f=0;for(g=a.children.length;f<g;f++)n=z(a.children[f],d.id,b),l=p[n],d.children.push(n),l.children_d.length&&(d.children_d=d.children_d.concat(l.children_d));
d.children_d=d.children_d.concat(d.children)}a&&a.children&&!0===a.children&&(d.state.loaded=!1,d.children=[],d.children_d=[]);delete a.data;delete a.children;d.original=a;p[d.id]=d;d.state.selected&&c.push(d.id);return d.id};if(d.length&&d[0].id!==e&&d[0].parent!==e){w=0;for(t=d.length;w<t;w++)d[w].children||(d[w].children=[]),p[d[w].id.toString()]=d[w];w=0;for(t=d.length;w<t;w++)p[d[w].parent.toString()].children.push(d[w].id.toString()),q.children_d.push(d[w].id.toString());w=0;for(t=q.children.length;w<
t;w++)s=v(p[q.children[w]],b,q.parents.concat()),f.push(s),p[s].children_d.length&&(f=f.concat(p[s].children_d))}else{w=0;for(t=d.length;w<t;w++)if(s=z(d[w],b,q.parents.concat()))g.push(s),f.push(s),p[s].children_d.length&&(f=f.concat(p[s].children_d));q.children=g;q.children_d=f}w=0;for(t=q.parents.length;w<t;w++)p[q.parents[w]].children_d=p[q.parents[w]].children_d.concat(f);return{cnt:m,mod:p,sel:u,par:b,dpc:f,add:c}},h=function(a,d){this._cnt=a.cnt;this._model.data=a.mod;if(d){var b,g,f=a.add,
...
[];this.trigger("redraw",{nodes:a})},redraw:function(a){a&&(this._model.force_full_redraw=!0);this._redraw()},redraw_node:function(a,b,e){var d=this.get_node(a),g=!1,f=!1,h=!1,k=!1,l=!1,r=!1,r="",n=document,y=this._model.data,m=!1,p=!1,q=null;if(!d)return!1;if("#"===d.id)return this.redraw(!0);b=b||0===d.children.length;if(a=document.querySelector?this.element[0].querySelector("#"+(-1!=="0123456789".indexOf(d.id[0])?"\\3"+d.id[0]+" "+d.id.substr(1).replace(c.jstree.idregex,"\\$&"):d.id.replace(c.jstree.idregex,
"\\$&"))):document.getElementById(d.id))a=c(a),e||(g=a.parent().parent()[0],g===this.element[0]&&(g=null),f=a.index()),b||!d.children.length||a.children(".jstree-children").length||(b=!0),b||(h=a.children(".jstree-children")[0]),p=a.attr("aria-selected"),m=a.children(".jstree-anchor")[0]===document.activeElement,a.remove();else if(b=!0,!e){g="#"!==d.parent?c("#"+d.parent.replace(c.jstree.idregex,"\\$&"),this.element)[0]:null;if(!(null===g||g&&y[d.parent].state.opened))return!1;f=c.inArray(d.id,null===
g?y["#"].children:y[d.parent].children)}a=z.cloneNode(!0);r="jstree-node ";for(k in d.li_attr)d.li_attr.hasOwnProperty(k)&&"id"!==k&&("class"!==k?a.setAttribute(k,d.li_attr[k]):r+=d.li_attr[k]);p&&"false"!==p&&a.setAttribute("aria-selected",!0);d.state.loaded&&!d.children.length?r+=" jstree-leaf":(r+=d.state.opened&&d.state.loaded?" jstree-open":" jstree-closed",a.setAttribute("aria-expanded",d.state.opened&&d.state.loaded));null!==d.parent&&y[d.parent].children[y[d.parent].children.length-1]===d.id&&
(r+=" jstree-last");a.id=d.id;a.className=r;r=(d.state.selected?" jstree-clicked":"")+(d.state.disabled?" jstree-disabled":"");for(l in d.a_attr)!d.a_attr.hasOwnProperty(l)||"href"===l&&"#"===d.a_attr[l]||("class"!==l?a.childNodes[1].setAttribute(l,d.a_attr[l]):r+=" "+d.a_attr[l]);r.length&&(a.childNodes[1].className="jstree-anchor "+r);if(d.icon&&!0!==d.icon||!1===d.icon)!1===d.icon?a.childNodes[1].childNodes[0].className+=" jstree-themeicon-hidden":-1===d.icon.indexOf("/")&&-1===d.icon.indexOf(".")?
...
d.state.loaded){r=n.createElement("UL");r.setAttribute("role","group");r.className="jstree-children";k=0;for(l=d.children.length;k<l;k++)r.appendChild(this.redraw_node(d.children[k],b,!0));a.appendChild(r)}h&&a.appendChild(h);if(!e){g||(g=this.element[0]);k=0;for(l=g.childNodes.length;k<l;k++)if(g.childNodes[k]&&g.childNodes[k].className&&-1!==g.childNodes[k].className.indexOf("jstree-children")){q=g.childNodes[k];break}q||(q=n.createElement("UL"),q.setAttribute("role","group"),q.className="jstree-children",
g.appendChild(q));g=q;f<g.childNodes.length?g.insertBefore(a,g.childNodes[f]):g.appendChild(a);m&&a.childNodes[1].focus()}d.state.opened&&!d.state.loaded&&(d.state.opened=!1,setTimeout(c.proxy(function(){this.open_node(d.id,!1,0)},this),0));return a},open_node:function(a,b,e){var d,g,f;if(c.isArray(a)){a=a.slice();d=0;for(g=a.length;d<g;d++)this.open_node(a[d],b,e);return!0}a=this.get_node(a);if(!a||"#"===a.id)return!1;e=e===v?this.settings.core.animation:e;if(!this.is_closed(a))return b&&b.call(this,
...
g),0),e=!1)});e&&(delete a.core.open,this.set_state(a,b));return!1}if(a.core.scroll)return a.core.scroll&&a.core.scroll.left!==v&&this.element.scrollLeft(a.core.scroll.left),a.core.scroll&&a.core.scroll.top!==v&&this.element.scrollTop(a.core.scroll.top),delete a.core.scroll,this.set_state(a,b),!1;if(a.core.selected)return f=this,this.deselect_all(),c.each(a.core.selected,function(a,e){f.select_node(e)}),delete a.core.selected,this.set_state(a,b),!1;if(c.isEmptyObject(a.core))return delete a.core,
...
"#"!==a.id&&e.push(d);if(!b||!b.no_children)for(g=0,f=a.children.length;g<f;g++)b&&b.flat?this.get_json(a.children[g],b,e):d.children.push(this.get_json(a.children[g],b));return b&&b.flat?e:"#"===a.id?d.children:d},create_node:function(a,b,e,d,g){null===a&&(a="#");a=this.get_node(a);if(!a)return!1;e=e===v?"last":e;if(!e.toString().match(/^(before|after)$/)&&!g&&!this.is_loaded(a))return this.load_node(a,function(){this.create_node(a,b,e,d,!0)});b||(b={text:this.get_string("New node")});b.text===v&&
...
plugin:"core",id:"core_03",reason:"User config for core.check_callback prevents function: "+a,data:JSON.stringify({chk:a,pos:d,obj:b&&b.id?b.id:!1,par:e&&e.id?e.id:!1})},!1):!0},last_error:function(){return this._data.core.last_error},move_node:function(a,b,e,d,g){var f,h,k,l,r,n,y,m,p,q;b=this.get_node(b);e=e===v?0:e;if(!b)return!1;if(!e.toString().match(/^(before|after)$/)&&!g&&!this.is_loaded(b))return this.load_node(b,function(){this.move_node(a,b,e,d,!0)});if(c.isArray(a)){a=a.reverse().slice();
f=0;for(h=a.length;f<h;f++)this.move_node(a[f],b,e,d,g);return!0}a=a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;f=(a.parent||"#").toString();k=e.toString().match(/^(before|after)$/)&&"#"!==b.id?this.get_node(b.parent):b;l=a.instance?a.instance:this._model.data[a.id]?this:c.jstree.reference(a.id);r=!l||!l._id||this._id!==l._id;h=l&&l._id&&f&&l._model.data[f]&&l._model.data[f].children?c.inArray(a.id,l._model.data[f].children):-1;if(r)return this.copy_node(a,b,e,d,g)?(l&&l.delete_node(a),!0):
...
k.children.concat();r=c.inArray(a.id,g);-1!==r&&(g=c.vakata.array_remove(g,r),e>r&&e--);r=[];n=0;for(y=g.length;n<y;n++)r[n>=e?n+1:n]=g[n];r[e]=a.id;k.children=r;this._node_changed(k.id);this.redraw("#"===k.id)}else{r=a.children_d.concat();r.push(a.id);n=0;for(y=a.parents.length;n<y;n++){g=[];q=l._model.data[a.parents[n]].children_d;m=0;for(p=q.length;m<p;m++)-1===c.inArray(q[m],r)&&g.push(q[m]);l._model.data[a.parents[n]].children_d=g}l._model.data[f].children=c.vakata.array_remove_item(l._model.data[f].children,
a.id);n=0;for(y=k.parents.length;n<y;n++)this._model.data[k.parents[n]].children_d=this._model.data[k.parents[n]].children_d.concat(r);g=[];n=0;for(y=k.children.length;n<y;n++)g[n>=e?n+1:n]=k.children[n];g[e]=a.id;k.children=g;k.children_d.push(a.id);k.children_d=k.children_d.concat(a.children_d);a.parent=k.id;r=k.parents.concat();r.unshift(k.id);q=a.parents.length;a.parents=r;r=r.concat();n=0;for(y=a.children_d.length;n<y;n++)this._model.data[a.children_d[n]].parents=this._model.data[a.children_d[n]].parents.slice(0,
-1*q),Array.prototype.push.apply(this._model.data[a.children_d[n]].parents,r);this._node_changed(f);this._node_changed(k.id);this.redraw("#"===f||"#"===k.id)}d&&d.call(this,a,k,e);this.trigger("move_node",{node:a,parent:k.id,position:e,old_parent:f,old_position:h,is_multi:l&&l._id&&l._id!==this._id,is_foreign:!l||!l._id,old_instance:l,new_instance:this});return!0},copy_node:function(a,b,e,d,g){var f,h,k,l,r,n;b=this.get_node(b);e=e===v?0:e;if(!b)return!1;if(!e.toString().match(/^(before|after)$/)&&
!g&&!this.is_loaded(b))return this.load_node(b,function(){this.copy_node(a,b,e,d,!0)});if(c.isArray(a)){a=a.reverse().slice();f=0;for(h=a.length;f<h;f++)this.copy_node(a[f],b,e,d,g);return!0}a=a&&a.id?a:this.get_node(a);if(!a||"#"===a.id)return!1;h=(a.parent||"#").toString();r=e.toString().match(/^(before|after)$/)&&"#"!==b.id?this.get_node(b.parent):b;n=a.instance?a.instance:this._model.data[a.id]?this:c.jstree.reference(a.id);"#"===r.id&&("before"===e&&(e="first"),"after"===e&&(e="last"));switch(e){case "before":e=
c.inArray(b.id,r.children);break;case "after":e=c.inArray(b.id,r.children)+1;break;case "inside":case "first":e=0;break;case "last":e=r.children.length;break;default:e||(e=0)}e>r.children.length&&(e=r.children.length);if(!this.check("copy_node",a,r,e,{core:!0,is_multi:n&&n._id&&n._id!==this._id,is_foreign:!n||!n._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;k=n?n.get_json(a,{no_id:!0,no_data:!0,no_state:!0}):a;if(!k)return!1;!0===k.id&&delete k.id;k=this._parse_model_from_json(k,
r.id,r.parents.concat());if(!k)return!1;f=this.get_node(k);a&&a.state&&!1===a.state.loaded&&(f.state.loaded=!1);g=[];g.push(k);g=g.concat(f.children_d);this.trigger("model",{nodes:g,parent:r.id});k=0;for(l=r.parents.length;k<l;k++)this._model.data[r.parents[k]].children_d=this._model.data[r.parents[k]].children_d.concat(g);g=[];k=0;for(l=r.children.length;k<l;k++)g[k>=e?k+1:k]=r.children[k];g[e]=f.id;r.children=g;r.children_d.push(f.id);r.children_d=r.children_d.concat(f.children_d);this._node_changed(r.id);
this.redraw("#"===r.id);d&&d.call(this,f,r,e);this.trigger("copy_node",{node:f,original:a,parent:r.id,position:e,old_parent:h,old_position:n&&n._id&&h&&n._model.data[h]&&n._model.data[h].children?c.inArray(a.id,n._model.data[h].children):-1,is_multi:n&&n._id&&n._id!==this._id,is_foreign:!n||!n._id,old_instance:n,new_instance:this});return f.id},cut:function(a){a||(a=this._data.core.selected.concat());c.isArray(a)||(a=[a]);if(!a.length)return!1;var b=[],e,d,g;d=0;for(g=a.length;d<g;d++)(e=this.get_node(a[d]))&&
e.id&&"#"!==e.id&&b.push(e);if(!b.length)return!1;m=b;q=this;p="move_node";this.trigger("cut",{node:a})},copy:function(a){a||(a=this._data.core.selected.concat());c.isArray(a)||(a=[a]);if(!a.length)return!1;var b=[],e,d,g;d=0;for(g=a.length;d<g;d++)(e=this.get_node(a[d]))&&e.id&&"#"!==e.id&&b.push(e);if(!b.length)return!1;m=b;q=this;p="copy_node";this.trigger("copy",{node:a})},get_buffer:function(){return{mode:p,node:m,inst:q}},can_paste:function(){return!1!==p&&!1!==m},paste:function(a,b){a=this.get_node(a);
if(!(a&&p&&p.match(/^(copy_node|move_node)$/)&&m))return!1;this[p](m,a,b)&&this.trigger("paste",{parent:a.id,node:m,mode:p});q=p=m=!1},edit:function(a,b){a=this.get_node(a);if(!a)return!1;if(!1===this.settings.core.check_callback)return this._data.core.last_error={error:"check",plugin:"core",id:"core_07",reason:"Could not edit node because of check_callback"},this.settings.core.error.call(this,this._data.core.last_error),!1;b="string"===typeof b?b:a.text;this.set_text(a,"");a=this._open_to(a);var e=
...
-1!==this.settings.checkbox.cascade.indexOf("down"))this.element.on("model.jstree",c.proxy(function(a,d){var b=this._model.data,f=b[d.parent],h=d.nodes,k=[],l,r,n,m,p=this.settings.checkbox.cascade,q=this.settings.checkbox.tie_selection;if(-1!==p.indexOf("down"))if(f.state[q?"selected":"checked"]){l=0;for(r=h.length;l<r;l++)b[h[l]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(h)}else for(l=0,r=h.length;l<r;l++)if(b[h[l]].state[q?
"selected":"checked"]){n=0;for(m=b[h[l]].children_d.length;n<m;n++)b[b[h[l]].children_d[n]].state[q?"selected":"checked"]=!0;this._data[q?"core":"checkbox"].selected=this._data[q?"core":"checkbox"].selected.concat(b[h[l]].children_d)}if(-1!==p.indexOf("up")){l=0;for(r=f.children_d.length;l<r;l++)b[f.children_d[l]].children.length||k.push(b[f.children_d[l]].parent);k=c.vakata.array_unique(k);n=0;for(m=k.length;n<m;n++)for(f=b[k[n]];f&&"#"!==f.id;){l=h=0;for(r=f.children.length;l<r;l++)h+=b[f.children[l]].state[q?
"selected":"checked"];if(h===r)f.state[q?"selected":"checked"]=!0,this._data[q?"core":"checkbox"].selected.push(f.id),(l=this.get_node(f,!0))&&l.length&&l.children(".jstree-anchor").addClass(q?"jstree-clicked":"jstree-checked");else break;f=this.get_node(f.parent)}}this._data[q?"core":"checkbox"].selected=c.vakata.array_unique(this._data[q?"core":"checkbox"].selected)},this)).on(this.settings.checkbox.tie_selection?"select_node.jstree":"check_node.jstree",c.proxy(function(a,d){var b=d.node,f=this._model.data,
h=this.get_node(b.parent),k=this.get_node(b,!0),l,r,n,m=this.settings.checkbox.cascade,p=this.settings.checkbox.tie_selection;if(-1!==m.indexOf("down"))for(this._data[p?"core":"checkbox"].selected=c.vakata.array_unique(this._data[p?"core":"checkbox"].selected.concat(b.children_d)),l=0,r=b.children_d.length;l<r;l++)n=f[b.children_d[l]],n.state[p?"selected":"checked"]=!0,n&&n.original&&n.original.state&&n.original.state.undetermined&&(n.original.state.undetermined=!1);if(-1!==m.indexOf("up"))for(;h&&
"#"!==h.id;){l=b=0;for(r=h.children.length;l<r;l++)b+=f[h.children[l]].state[p?"selected":"checked"];if(b===r)h.state[p?"selected":"checked"]=!0,this._data[p?"core":"checkbox"].selected.push(h.id),(n=this.get_node(h,!0))&&n.length&&n.children(".jstree-anchor").addClass(p?"jstree-clicked":"jstree-checked");else break;h=this.get_node(h.parent)}-1!==m.indexOf("down")&&k.length&&k.find(".jstree-anchor").addClass(p?"jstree-clicked":"jstree-checked")},this)).on(this.settings.checkbox.tie_selection?"deselect_all.jstree":
"uncheck_all.jstree",c.proxy(function(a,d){var b=this.get_node("#"),f=this._model.data,c,k,l;c=0;for(k=b.children_d.length;c<k;c++)(l=f[b.children_d[c]])&&l.original&&l.original.state&&l.original.state.undetermined&&(l.original.state.undetermined=!1)},this)).on(this.settings.checkbox.tie_selection?"deselect_node.jstree":"uncheck_node.jstree",c.proxy(function(a,d){var b=d.node,f=this.get_node(b,!0),h,k,l,r=this.settings.checkbox.cascade,n=this.settings.checkbox.tie_selection;b&&b.original&&b.original.state&&
b.original.state.undetermined&&(b.original.state.undetermined=!1);if(-1!==r.indexOf("down"))for(h=0,k=b.children_d.length;h<k;h++)l=this._model.data[b.children_d[h]],l.state[n?"selected":"checked"]=!1,l&&l.original&&l.original.state&&l.original.state.undetermined&&(l.original.state.undetermined=!1);if(-1!==r.indexOf("up"))for(h=0,k=b.parents.length;h<k;h++)l=this._model.data[b.parents[h]],l.state[n?"selected":"checked"]=!1,l&&l.original&&l.original.state&&l.original.state.undetermined&&(l.original.state.undetermined=
!1),(l=this.get_node(b.parents[h],!0))&&l.length&&l.children(".jstree-anchor").removeClass(n?"jstree-clicked":"jstree-checked");l=[];h=0;for(k=this._data[n?"core":"checkbox"].selected.length;h<k;h++)-1!==r.indexOf("down")&&-1!==c.inArray(this._data[n?"core":"checkbox"].selected[h],b.children_d)||-1!==r.indexOf("up")&&-1!==c.inArray(this._data[n?"core":"checkbox"].selected[h],b.parents)||l.push(this._data[n?"core":"checkbox"].selected[h]);this._data[n?"core":"checkbox"].selected=c.vakata.array_unique(l);
-1!==r.indexOf("down")&&f.length&&f.find(".jstree-anchor").removeClass(n?"jstree-clicked":"jstree-checked")},this));if(-1!==this.settings.checkbox.cascade.indexOf("up"))this.element.on("delete_node.jstree",c.proxy(function(a,d){for(var b=this.get_node(d.parent),f=this._model.data,c,k,l,r=this.settings.checkbox.tie_selection;b&&"#"!==b.id;){c=l=0;for(k=b.children.length;c<k;c++)l+=f[b.children[c]].state[r?"selected":"checked"];if(l===k)b.state[r?"selected":"checked"]=!0,this._data[r?"core":"checkbox"].selected.push(b.id),
(c=this.get_node(b,!0))&&c.length&&c.children(".jstree-anchor").addClass(r?"jstree-clicked":"jstree-checked");else break;b=this.get_node(b.parent)}},this)).on("move_node.jstree",c.proxy(function(a,d){var b=d.is_multi,f=d.old_parent,h=this.get_node(d.parent),k=this._model.data,l,r,n=this.settings.checkbox.tie_selection;if(!b)for(b=this.get_node(f);b&&"#"!==b.id;){l=f=0;for(r=b.children.length;l<r;l++)f+=k[b.children[l]].state[n?"selected":"checked"];if(f===r)b.state[n?"selected":"checked"]=!0,this._data[n?
"core":"checkbox"].selected.push(b.id),(f=this.get_node(b,!0))&&f.length&&f.children(".jstree-anchor").addClass(n?"jstree-clicked":"jstree-checked");else break;b=this.get_node(b.parent)}for(b=h;b&&"#"!==b.id;){l=f=0;for(r=b.children.length;l<r;l++)f+=k[b.children[l]].state[n?"selected":"checked"];if(f===r)b.state[n?"selected":"checked"]||(b.state[n?"selected":"checked"]=!0,this._data[n?"core":"checkbox"].selected.push(b.id),(f=this.get_node(b,!0))&&f.length&&f.children(".jstree-anchor").addClass(n?
...
if(!a||"#"===a.id)return!1;var h=this.settings.contextmenu,k=this.get_node(a,!0).children(".jstree-anchor"),l=!1,l=!1;if(h.show_at_node||b===v||g===v)l=k.offset(),b=l.left,g=l.top+this._data.core.li_height;this.settings.contextmenu.select_node&&!this.is_selected(a)&&this.activate_node(a,f);l=h.items;c.isFunction(l)&&(l=l.call(this,a,c.proxy(function(c){this._show_contextmenu(a,b,g,c)},this)));c.isPlainObject(l)&&this._show_contextmenu(a,b,g,l)};this._show_contextmenu=function(a,b,g,f){var h=this.get_node(a,
...
d.css("bottom","-1px");d.show()}},show:function(r,n,m){var p,q,s,B;e&&e.length&&e.width("");switch(!0){case !n&&!r:return!1;case !!n&&!!r:d=r;c=n.x;f=n.y;break;case !n&&!!r:d=r;n=r.offset();c=n.left+r.outerHeight();f=n.top;break;case !!n&&!r:c=n.x,f=n.y}r&&!m&&a(r).data("vakata_contextmenu")&&(m=a(r).data("vakata_contextmenu"));a.vakata.context._parse(m)&&e.html(k);h.length&&(r=e,m=c,n=f,p=r.width(),q=r.height(),s=a(window).width()+a(window).scrollLeft(),B=a(window).height()+a(window).scrollTop(),
b&&(m-=r.outerWidth(),m<a(window).scrollLeft()+20&&(m=a(window).scrollLeft()+20)),m+p+20>s&&(m=s-(p+20)),n+q+20>B&&(n=B-(q+20)),e.css({left:m,top:n}).show().find("a:eq(0)").focus().parent().addClass("vakata-context-hover"),l=!0,a.vakata.context._trigger("show"))},hide:function(){l&&(e.hide().find("ul").hide().end().find(":focus").blur(),l=!1,a.vakata.context._trigger("hide"))}};a(function(){b="rtl"===a("body").css("direction");var d=!1;e=a("<ul class='vakata-context'></ul>");e.on("mouseenter","li",
...
"jstree-marker"!==f.event.target.id)){var h=c.jstree.reference(f.event.target),k=!1,l=!1,r=!1,n,m,p,q,s,B,t,u,v,z,x,F,w,D;if(h&&h._data&&h._data.dnd)if(d.attr("class","jstree-"+h.get_theme()+(h.settings.core.themes.responsive?" jstree-dnd-responsive":"")),f.helper.children().attr("class","jstree-"+h.get_theme()+(h.settings.core.themes.responsive?" jstree-dnd-responsive":"")).find(".jstree-copy:eq(0)")[f.data.origin&&(f.data.origin.settings.dnd.always_copy||f.data.origin.settings.dnd.copy&&(f.event.metaKey||
f.event.ctrlKey))?"show":"hide"](),f.event.target!==h.element[0]&&f.event.target!==h.get_container_ul()[0]||0!==h.get_container_ul().children().length){if((k=c(f.event.target).closest(".jstree-anchor"))&&k.length&&k.parent().is(".jstree-closed, .jstree-open, .jstree-leaf")&&(l=k.offset(),r=f.event.pageY-l.top,p=k.height(),B=r<p/3?["b","i","a"]:r>p-p/3?["a","i","b"]:r>p/2?["i","a","b"]:["i","b","a"],c.each(B,function(g,r){switch(r){case "b":n=l.left-6;m=l.top;q=h.get_parent(k);s=k.parent().index();
break;case "i":w=h.settings.dnd.inside_pos;D=h.get_node(k.parent());n=l.left-2;m=l.top+p/2+1;q=D.id;s="first"===w?0:"last"===w?D.children.length:Math.min(w,D.children.length);break;case "a":n=l.left-6,m=l.top+p,q=h.get_parent(k),s=k.parent().index()+1}t=!0;u=0;for(v=f.data.nodes.length;u<v;u++)if(z=f.data.origin&&(f.data.origin.settings.dnd.always_copy||f.data.origin.settings.dnd.copy&&(f.event.metaKey||f.event.ctrlKey))?"copy_node":"move_node",x=s,"move_node"===z&&"a"===r&&f.data.origin&&f.data.origin===
h&&q===h.get_parent(f.data.nodes[u])&&(F=h.get_node(q),x>c.inArray(f.data.nodes[u],F.children)&&(x-=1)),t=t&&(h&&h.settings&&h.settings.dnd&&!1===h.settings.dnd.check_while_dragging||h.check(z,f.data.origin&&f.data.origin!==h?f.data.origin.get_node(f.data.nodes[u]):f.data.nodes[u],q,x,{dnd:!0,ref:h.get_node(k.parent()),pos:r,is_multi:f.data.origin&&f.data.origin!==h,is_foreign:!f.data.origin})),!t){h&&h.last_error&&(b=h.last_error());break}if(t)return"i"===r&&k.parent().is(".jstree-closed")&&h.settings.dnd.open_timeout&&
(e=setTimeout(function(a,b){return function(){a.open_node(b)}}(h,k),h.settings.dnd.open_timeout)),a={ins:h,par:q,pos:"i"!==r||"last"!==w||0!==s||h.is_loaded(D)?s:"last"},d.css({left:n+"px",top:m+"px"}).show(),f.helper.find(".jstree-icon:eq(0)").removeClass("jstree-er").addClass("jstree-ok"),b={},B=!0,!1}),!0===B))return}else{t=!0;u=0;for(v=f.data.nodes.length;u<v&&(t=t&&h.check(f.data.origin&&(f.data.origin.settings.dnd.always_copy||f.data.origin.settings.dnd.copy&&(f.event.metaKey||f.event.ctrlKey))?
"copy_node":"move_node",f.data.origin&&f.data.origin!==h?f.data.origin.get_node(f.data.nodes[u]):f.data.nodes[u],"#","last",{dnd:!0,ref:h.get_node("#"),pos:"i",is_multi:f.data.origin&&f.data.origin!==h,is_foreign:!f.data.origin}),t);u++);if(t){a={ins:h,par:"#",pos:"last"};d.hide();f.helper.find(".jstree-icon:eq(0)").removeClass("jstree-er").addClass("jstree-ok");return}}a=!1;f.helper.find(".jstree-icon").removeClass("jstree-ok").addClass("jstree-er");d.hide()}}).bind("dnd_scroll.vakata",function(b,
...
(n=1),b.pageX-d.left<a.vakata.dnd.settings.scroll_proximity&&(n=-1));if(m||n)return p=a(this),!1});!p&&(e=a(document),k=a(window),q=e.height(),u=k.height(),t=e.width(),k=k.width(),v=e.scrollTop(),w=e.scrollLeft(),q>u&&b.pageY-v<a.vakata.dnd.settings.scroll_proximity&&(m=-1),q>u&&u-(b.pageY-v)<a.vakata.dnd.settings.scroll_proximity&&(m=1),t>k&&b.pageX-w<a.vakata.dnd.settings.scroll_proximity&&(n=-1),t>k&&k-(b.pageX-w)<a.vakata.dnd.settings.scroll_proximity&&(n=1),m||n)&&(p=e);p&&a.vakata.dnd._scroll(!0);
f&&(e=parseInt(b.pageY+a.vakata.dnd.settings.helper_top,10),u=parseInt(b.pageX+a.vakata.dnd.settings.helper_left,10),q&&e+25>q&&(e=q-50),t&&u+h>t&&(u=t-(h+2)),f.css({left:u+"px",top:e+"px"}));a.vakata.dnd._trigger("move",b);return!1}},stop:function(b){"touchend"===b.type&&b.originalEvent&&b.originalEvent.changedTouches&&b.originalEvent.changedTouches[0]&&(b.pageX=b.originalEvent.changedTouches[0].pageX,b.pageY=b.originalEvent.changedTouches[0].pageY,b.target=document.elementFromPoint(b.originalEvent.changedTouches[0].pageX-
...
b.open_node(f,function(){b._search_open(a)},0))})}};(function(a){a.vakata.search=function(a,e,d){d=d||{};!1!==d.fuzzy&&(d.fuzzy=!0);a=d.caseSensitive?a:a.toLowerCase();var c=d.location||0,f=d.distance||100,h=d.threshold||.6,k=a.length,l,r,n,m;32<k&&(d.fuzzy=!1);d.fuzzy&&(l=1<<k-1,r=function(){for(var e={},d=0,d=0;d<k;d++)e[a.charAt(d)]=0;for(d=0;d<k;d++)e[a.charAt(d)]|=1<<k-d-1;return e}(),n=function(a,b){var e=a/k,d=Math.abs(c-b);return f?e+d/f:d?1:e});m=function(e){e=d.caseSensitive?e:e.toLowerCase();
if(a===e||-1!==e.indexOf(a))return{isMatch:!0,score:0};if(!d.fuzzy)return{isMatch:!1,score:1};var f,m,p=e.length,q=h,u=e.indexOf(a,c),t,s,v=k+p,z,w,x=1,y=[];-1!==u&&(q=Math.min(n(0,u),q),u=e.lastIndexOf(a,c+k),-1!==u&&(q=Math.min(n(0,u),q)));u=-1;for(f=0;f<k;f++){t=0;for(s=v;t<s;)n(f,c+s)<=q?t=s:v=s,s=Math.floor((v-t)/2+t);v=s;t=Math.max(1,c-s+1);m=Math.min(c+s,p)+k;s=Array(m+2);for(s[m+1]=(1<<f)-1;m>=t;m--)if(w=r[e.charAt(m-1)],s[m]=0===f?(s[m+1]<<1|1)&w:(s[m+1]<<1|1)&w|(z[m+1]|z[m])<<1|1|z[m+1],
s[m]&l&&(x=n(f,m-1),x<=q))if(q=x,u=m-1,y.push(u),u>c)t=Math.max(1,2*c-u);else break;if(n(f+1,c)>q)break;z=s}return{isMatch:0<=u,score:x}};return!0===e?{search:m}:m(e)}})(c);c.jstree.defaults.sort=function(a,b){return this.get_text(a)>this.get_text(b)?1:-1};c.jstree.plugins.sort=function(a,b){this.bind=function(){b.bind.call(this);this.element.on("model.jstree",c.proxy(function(a,b){this.sort(b.parent,!0)},this)).on("rename_node.jstree create_node.jstree",c.proxy(function(a,b){this.sort(b.parent||
b.node.parent,!1);this.redraw_node(b.parent||b.node.parent,!0)},this)).on("move_node.jstree copy_node.jstree",c.proxy(function(a,b){this.sort(b.parent,!1);this.redraw_node(b.parent,!0)},this))};this.sort=function(a,b){var g,f;if((a=this.get_node(a))&&a.children&&a.children.length&&(a.children.sort(c.proxy(this.settings.sort,this)),b))for(g=0,f=a.children_d.length;g<f;g++)this.sort(a.children_d[g],!1)}};var E=!1;c.jstree.defaults.state={key:"jstree",events:"changed.jstree open_node.jstree close_node.jstree",
...
g.id?g:this.get_node(g);h=d&&d.id?c.jstree.reference(d.id):null;var k,l,m,n;h=h&&h._model&&h._model.data?h._model.data:null;switch(a){case "create_node":case "move_node":case "copy_node":if("move_node"!==a||-1===c.inArray(d.id,g.children)){k=this.get_rules(g);if(k.max_children!==v&&-1!==k.max_children&&k.max_children===g.children.length)return this._data.core.last_error={error:"check",plugin:"types",id:"types_01",reason:"max_children prevents function: "+a,data:JSON.stringify({chk:a,pos:f,obj:d&&
d.id?d.id:!1,par:g&&g.id?g.id:!1})},!1;if(k.valid_children!==v&&-1!==k.valid_children&&-1===c.inArray(d.type,k.valid_children))return this._data.core.last_error={error:"check",plugin:"types",id:"types_02",reason:"valid_children prevents function: "+a,data:JSON.stringify({chk:a,pos:f,obj:d&&d.id?d.id:!1,par:g&&g.id?g.id:!1})},!1;if(h&&d.children_d&&d.parents){m=l=0;for(n=d.children_d.length;m<n;m++)l=Math.max(l,h[d.children_d[m]].parents.length);l=l-d.parents.length+1}if(0>=l||l===v)l=1;do{if(k.max_depth!==
v&&-1!==k.max_depth&&k.max_depth<l)return this._data.core.last_error={error:"check",plugin:"types",id:"types_03",reason:"max_depth prevents function: "+a,data:JSON.stringify({chk:a,pos:f,obj:d&&d.id?d.id:!1,par:g&&g.id?g.id:!1})},!1;g=this.get_node(g.parent);k=this.get_rules(g);l++}while(g)}}return!0};this.get_rules=function(a){a=this.get_node(a);if(!a)return!1;a=this.get_type(a,!0);a.max_depth===v&&(a.max_depth=-1);a.max_children===v&&(a.max_children=-1);a.valid_children===v&&(a.valid_children=-1);
...
pos:f,obj:d&&d.id?d.id:!1,par:g&&g.id?g.id:!1})}),n}return!0};this.create_node=function(a,d,g,f,h){if(!d||d.text===v){null===a&&(a="#");a=this.get_node(a);if(!a)return b.create_node.call(this,a,d,g,f,h);g=g===v?"last":g;if(!g.toString().match(/^(before|after)$/)&&!h&&!this.is_loaded(a))return b.create_node.call(this,a,d,g,f,h);d||(d={});var k,l,m,n,p,q=this._model.data,s=this.settings.unique.case_sensitive,u=this.settings.unique.duplicate;l=k=this.get_string("New node");m=[];n=0;for(p=a.children.length;n<
p;n++)m.push(s?q[a.children[n]].text:q[a.children[n]].text.toLowerCase());for(n=1;-1!==c.inArray(s?l:l.toLowerCase(),m);)l=u.call(this,k,++n).toString();d.text=l}return b.create_node.call(this,a,d,g,f,h)}};var C=document.createElement("DIV");C.setAttribute("unselectable","on");C.className="jstree-wholerow";C.innerHTML="&#160;";c.jstree.plugins.wholerow=function(a,b){this.bind=function(){b.bind.call(this);this.element.on("ready.jstree set_state.jstree",c.proxy(function(){this.hide_dots()},this)).on("init.jstree loading.jstree ready.jstree",
...
refresh:function(){this._unbindEvents();var m=this.options,p=this.tree;if(p.find("li").length){this.noopts.hide();this.button.show();var q=m.selected;if(q){var t=this.treeID;c.each(q,function(){c("#"+t+"-"+this).data("jstree",{selected:!0})})}q=p.find("> ul > li");if(1==q.length){var q=q.first(),s=q.data("jstree");q.data("jstree",c.extend({},s,{opened:!0}))}var q=m.multiple,u=m.leafonly;p.jstree({core:{themes:{url:!0,dir:S3.Ap.concat("/",m.themesFolder,"/"),name:m.theme,icons:!1,stripes:!0},animation:100,
multiple:q,check_callback:!0},checkbox:{three_state:u},plugins:["sort","checkbox"]});m=p.jstree("get_checked");this._updateButtonText(m);if(!q){var p=this.tree,v=jQuery.jstree.reference(p);p.bind("select_node.jstree",function(m,p){var q=c(p.node).attr("id");c(v.get_checked(!0)).each(function(){q!=this.id&&(u&&!v.is_leaf(this)||v.uncheck_node(this))})})}this._bindEvents()}else this.button.hide(),this.noopts.show()},_updateSelectedNodes:function(){var m=this.input.val(),m=m?JSON.parse(m):[],p=this.tree,
q=[],t=[],s=this.options.leafonly,u=p.jstree("get_checked",!0);c(u).each(function(){var m=c(this).attr("id");if(m&&(!s||p.jstree("is_leaf",this))){var u=parseInt(m.split("-").pop());u&&(q.push(u),t.push(m))}});var u=!1,v=c(q).not(m).get();v.length?u=!0:(v=c(m).not(q).get(),v.length&&(u=!0));this.input.val(JSON.stringify(q));this._updateButtonText(t);u&&c(this.element).trigger("select.s3hierarchy");return!0},_updateButtonText:function(m){var p=null,p=this.options;if(numSelected=m?m.length:0)if(1<numSelected)p=
p.selectedText.replace("#",numSelected);else{for(var q=[],t=0;t<numSelected;t++)q.push(c("#"+m[t]+" > a").text().replace(/^\s+|\s+$/g,""));p=q.length?q.join(" "):p.noneSelectedText}else p=p.noneSelectedText;this.buttonText.text(p)},set:function(m){this.tree.jstree("uncheck_all");if(m)for(var p=0,q=m.length;p<q;p++)node=c("#"+this.treeID+"-"+m[p]),this.tree.jstree("check_node",node)},get:function(){var c=this.input.val();return c?JSON.parse(c):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},
...
c(this).trigger("close")},addNode:function(m,p,q,t){var s=this.tree,u=this.treeID,v="#";m&&(v=c("#"+u+"-"+m),v.length||(v="#"));p=u+"-"+p;s.jstree("create_node",v,{id:p,text:q,li_attr:{rel:"leaf"}},"last");m&&(v.attr({rel:"parent"}),s.jstree("open_node",v));t&&s.jstree("check_node",c("#"+p))},_bindEvents:function(){var m=this,p=c(this.tree),q=c(this.button),t=this._namespace;p.bind("select_node.jstree",function(c,q){m._updateSelectedNodes();if(m.options.multiple)p.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",
function(){window.setTimeout(function(){m.closeMenu()},100)});else window.setTimeout(function(){m.closeMenu()},100)}).bind("deselect_node.jstree",function(c,p){m._updateSelectedNodes()}).bind("open_node.jstree",function(c,m){var p=m.instance,q=p.get_parent(m.node);q.length&&p.open_node(q,!1,!0)});q.bind("click"+t,function(){m._isOpen?m.closeMenu():m.openMenu()}).bind("keyup"+t,function(c){c.preventDefault();switch(c.keyCode){case 27:case 38:case 37:m.closeMenu();break;case 39:case 40:m.openMenu()}}).bind("mouseenter"+
t,function(){q.hasClass("ui-state-disabled")||c(this).addClass("ui-state-hover")}).bind("mouseleave"+t,function(){c(this).removeClass("ui-state-hover")}).bind("focus"+t,function(){q.hasClass("ui-state-disabled")||c(this).addClass("ui-state-focus")}).bind("blur"+t,function(){c(this).removeClass("ui-state-focus")});c(document).bind("mousedown"+t,function(c){var u=c.target;p.is(u)||q.is(u)||0!==p.has(c.target).length||0!==q.has(c.target).length||m.closeMenu()});return!0},_unbindEvents:function(){var m=
...
(function(c,v){var A=0;c.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,addTitle:"Add Record",addLabel:"Add",addURL:null,themesFolder:"static/styles/jstree",theme:"default",htmlTitles:!0},_create:function(){this.treeID=c(this.element).attr("id")+"-tree";this.id=A;A+=1},_init:function(){this.tree=c(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){c.Widget.prototype.destroy.call(this)},
refresh:function(){var m=this.tree,p=this.options;this._unbindEvents();var q=m.find("> ul > li");if(1==q.length){var q=q.first(),t=q.data("jstree");q.data("jstree",c.extend({},t,{opened:!0}))}var s=this;m.jstree({core:{themes:{url:!0,dir:S3.Ap.concat("/",p.themesFolder,"/"),name:p.theme,icons:!1,stripes:!0},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(c){return{open:{label:s.options.openLabel,action:function(m){s._openNode(c)},separator_after:!0},edit:{label:s.options.editLabel,
action:function(m){s._editNode(c)}},"delete":{label:s.options.deleteLabel,separator_after:!0,_disabled:!0},add:{label:s.options.addLabel,action:function(m){s._addNode(c)}}}},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},_openNode:function(c){var p=this.options.openURL;c=c.id;p&&c&&(c=parseInt(c.split("-").pop()))&&(p=p.replace("[id]",c).replace("%5Bid%5D",c),window.location.href=p)},refreshNode:function(m){var p=this.options.ajaxURL,q=m.attr("id");if(p&&q&&(q=parseInt(q.split("-").pop()))){var t=
this.tree,s=this.treeID;c.getJSONS3(p+"?node="+q,function(c){c.label&&t.jstree("rename_node",m,c.label);if(c=c.children){t.jstree("open_node",m,!1,!1);for(var p,q,v,A=0,C=0,a=c.length;C<a;C++)p=c[C],q=s+"-"+p.node,(v=t.jstree("get_node","#"+q,!0))?t.jstree("rename_node",v,p.label):(t.jstree("create_node",m,{id:q,text:p.label,li_attr:{rel:"leaf"}}),A++);A&&(t.jstree("open_node",m),m.attr({rel:"parent"}))}})}},_editNode:function(m){var p=this.options.editURL;m=m.id;if(p&&m){var q=parseInt(m.split("-").pop());
q&&(p=p.replace("[id]",q).replace("%5Bid%5D",q).split("?")[0],p+="?node="+m+"&hierarchy="+this.options.widgetID,m=S3.uid(),p=c('<iframe id="'+m+'" src='+p+" onload=\"S3.popup_loaded('"+m+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(p,this.options.editTitle))}},_addNode:function(m){var p=this.options.addURL;m=m.id;if(p&&m){var q=parseInt(m.split("-").pop());q&&(p=p.split("?")[0],p+="?node="+m+"&link_to_parent="+q+"&hierarchy="+
this.options.widgetID,m=S3.uid(),p=c('<iframe id="'+m+'" src='+p+" onload=\"S3.popup_loaded('"+m+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(p,this.options.addTitle))}},_openPopup:function(m,p){m.dialog({close:function(c,p){if(self.parent){var s=self.parent.$("iframe.ui-dialog-content"),u=s.width();s.width(0);window.setTimeout(function(){s.width(u)},300)}m.remove()},minHeight:480,modal:!0,open:function(p,t){c(".ui-widget-overlay").bind("click",
function(){m.dialog("close")})},title:p,minWidth:320,closeText:""})},_bindEvents:function(){return!0},_unbindEvents:function(){return!0}})})(jQuery);
