...
[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},openMenu:function(){this._isOpen&&this.closeMenu();var b=n(this.button),a=b.offset();n(this.tree).css({position:"absolute",top:a.top+b.outerHeight(),left:a.left,minWidth:b.outerWidth()-8,"z-index":999999}).show().jstree("set_focus");this._isOpen=!0;b.addClass("ui-state-active");n(this).trigger("open")},closeMenu:function(){n(this.tree).hide().jstree("unset_focus");this._isOpen=!1;n(this.button).removeClass("ui-state-active");
n(this).trigger("close")},addNode:function(b,a,c,d){var e=this.tree,f=this.treeID,g=b?"#"+f+"-"+b:-1;a=f+"-"+a;e.jstree("create_node",g,"last",{data:c,attr:{id:a,rel:"leaf"},state:"open"},!1,!1);b&&(n(g).attr({rel:"parent"}),e.jstree("open_node",g));d&&e.jstree("check_node","#"+a)},_bindEvents:function(){var b=this,a=n(this.tree),c=n(this.button),d=this._namespace;a.bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("open_node.jstree",
function(a,b){b.inst._get_parent(b.rslt.obj).length&&b.inst.open_node(b.inst._get_parent(b.rslt.obj),!1,!0)});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){n(this).removeClass("ui-state-hover")}).bind("focus"+
d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-focus")}).bind("blur"+d,function(){n(this).removeClass("ui-state-focus")});n(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length||b.closeMenu()});return!0},_unbindEvents:function(){var b=n(this.tree);n(this.button);var a=this._namespace;b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");n(this.button).unbind(a);
n(document).unbind(a);return!0}})})(jQuery);
