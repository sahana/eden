...
b.call(),!1;var e=c||n?0:this._get_settings().core.animation,d=this;this._is_loaded(a)?(this._get_settings().core.open_parents&&a.parentsUntil(".jstree",".jstree-closed").each(function(){d.open_node(this,!1,!0)}),e&&a.children("ul").css("display","none"),a.removeClass("jstree-closed").addClass("jstree-open").children("a").removeClass("jstree-loading"),e?a.children("ul").stop(!0,!0).slideDown(e,function(){this.style.display="";d.after_open(a)}):d.after_open(a),this.__callback({obj:a}),b&&b.call()):
(a.children("a").addClass("jstree-loading"),this.load_node(a,function(){d.open_node(a,b,c)},b))},after_open:function(a){this.__callback({obj:a})},close_node:function(a,b){a=this._get_node(a);var c=b||n?0:this._get_settings().core.animation,e=this;if(!a.length||!a.hasClass("jstree-open"))return!1;c&&a.children("ul").attr("style","display:block !important");a.removeClass("jstree-open").addClass("jstree-closed");c?a.children("ul").stop(!0,!0).slideUp(c,function(){this.style.display="";e.after_close(a)}):
...
h="on"==d.select_multiple_modifier||!1!==d.select_multiple_modifier&&b&&b[d.select_multiple_modifier+"Key"],m=!1!==d.select_range_modifier&&b&&b[d.select_range_modifier+"Key"]&&this.data.ui.last_selected&&this.data.ui.last_selected[0]!==a[0]&&this.data.ui.last_selected.parent()[0]===a.parent()[0],k=this.is_selected(a),r=!0,p=this;if(c){if(d.disable_selecting_children&&h&&(a.parentsUntil(".jstree","li").children("a.jstree-clicked").length||a.children("ul").find("a.jstree-clicked:eq(0)").length))return!1;
...
0<d.select_limit)this.deselect_all(),r=!0;break;case k&&h:this.deselect_node(a);break;case !k&&h:if(-1==d.select_limit||this.data.ui.selected.length+1<=d.select_limit)r=!0}}r&&!k&&(m||(this.data.ui.last_selected=a),a.children("a").addClass("jstree-clicked"),d.selected_parent_open&&a.parents(".jstree-closed").each(function(){p.open_node(this,!1,!0)}),this.data.ui.selected=this.data.ui.selected.add(a),this._fix_scroll(a.eq(0)),this.__callback({obj:a,e:b}))},_fix_scroll:function(c){var b=this.get_container()[0];
...
d.append(e),e=d);return e},get_json:function(a,c,d,e){var f=[],g=this._get_settings(),l=this,h,m,k,r,p,n;(a=this._get_node(a))&&-1!==a||(a=this.get_container().find("> ul > li"));c=b.isArray(c)?c:["id","class"];!e&&this.data.types&&c.push(g.types.type_attr);d=b.isArray(d)?d:[];a.each(function(){k=b(this);h={data:[]};c.length&&(h.attr={});b.each(c,function(a,b){(m=k.attr(b))&&m.length&&m.replace(/jstree[^ ]*/ig,"").length&&(h.attr[b]=(" "+m).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))});k.hasClass("jstree-open")&&(h.state="open");k.hasClass("jstree-closed")&&(h.state="closed");k.data()&&(h.metadata=k.data());r=k.children("a");r.each(function(){p=b(this);d.length||-1!==b.inArray("languages",g.plugins)||p.children("ins").get(0).style.backgroundImage.length||p.children("ins").get(0).className&&p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").length?(n=!1,-1!==b.inArray("languages",g.plugins)&&b.isArray(g.languages)&&g.languages.length&&b.each(g.languages,
function(a,b){if(p.hasClass(b))return n=b,!1}),m={attr:{},title:l.get_text(p,n)},b.each(d,function(a,b){m.attr[b]=(" "+(p.attr(b)||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")}),-1!==b.inArray("languages",g.plugins)&&b.isArray(g.languages)&&g.languages.length&&b.each(g.languages,function(a,b){if(p.hasClass(b))return m.language=b,!0}),p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(m.icon=p.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,
"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")),p.children("ins").get(0).style.backgroundImage.length&&(m.icon=p.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")",""))):m=l.get_text(p);1<r.length?h.data.push(m):h.data=m});k=k.find("> ul > li");k.length&&(h.children=l.get_json(k,c,d,!0));f.push(h)});return f}}})})(jQuery);(function(b){var a=!1;b.jstree.plugin("languages",{__init:function(){this._load_css()},defaults:[],_fn:{set_lang:function(c){var d=this._get_settings().languages,
...
(h+=' state="open"');q.hasClass("jstree-closed")&&(h+=' state="closed"');"flat"===a&&(h+=' parent_id="'+c(l)+'"');h+=">";h+="<content>";s=q.children("a");s.each(function(){n=b(this);t=!1;h+="<name";-1!==b.inArray("languages",m.plugins)&&b.each(m.languages,function(a,b){if(n.hasClass(b))return h+=' lang="'+c(b)+'"',t=b,!1});g.length&&b.each(g,function(a,b){var d=n.attr(b);m.xml_data.get_skip_empty&&"undefined"===typeof d||(h+=" "+b+'="'+c((" "+d||"").replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))+'"')});n.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(h+=' icon="'+c(n.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,""))+'"');n.children("ins").get(0).style.backgroundImage.length&&(h+=' icon="'+c(n.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","").replace(/'/ig,"").replace(/"/ig,""))+'"');h+=">";h+="<![CDATA["+k.get_text(n,t)+"]]\x3e";
...
g+a.o.length>d))return!1;if(-2!==c.max_depth&&-1!==e){l=0;if(0===e)return!1;if("undefined"===typeof a.o.d){for(c=a.o;0<c.length;)c=c.find("> ul > li"),l++;a.o.d=l}if(0>e-a.o.d)return!1}return!0},create_node:function(a,c,d,e,f,g){if(!g&&(f||this._is_loaded(a))){var l="string"==typeof c&&c.match(/^before|after$/i)&&-1!==a?this._get_parent(a):this._get_node(a),h=this._get_settings().types,m=this._check("max_children",l),k=this._check("max_depth",l),n=this._check("valid_children",l);"string"===typeof d&&
(d={data:d});d||(d={});if("none"===n)return!1;if(b.isArray(n))if(!d.attr||!d.attr[h.type_attr])d.attr||(d.attr={}),d.attr[h.type_attr]=n[0];else if(-1===b.inArray(d.attr[h.type_attr],n))return!1;if(-2!==h.max_children&&-1!==m&&(l=-1===l?this.get_container().find("> ul > li").length:l.find("> ul > li").length,l+1>m)||-2!==h.max_depth&&-1!==k&&0>k-1)return!1}return this.__call_old(!0,a,c,d,e,f,g)}}})})(jQuery);(function(b){b.jstree.plugin("html_data",{__init:function(){this.data.html_data.original_container_html=
...
(function(n,t){var s=0;n.widget("s3.hierarchicalopts",{options:{selected:null,noneSelectedText:"Select",selectedText:"selected",noOptionsText:"No options available",multiple:!0,leafonly:!0,themesFolder:"static/styles/jstree",theme:"default",htmlTitles:!0},_create:function(){var b=n(this.element),a=this.options;this.id=s;s+=1;this._namespace=".hierarchicalopts"+s;this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.button=n('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></button>');
this.buttonText=n("<span>"+a.noneSelectedText+"</span>").appendTo(this.button);this.noopts=n('<span class="no-options-available">'+a.noOptionsText+"</span>").hide();this.tree=b.find(".s3-hierarchy-tree").first().hide().before(this.noopts).before(this.button).detach().appendTo("body");this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){n.Widget.prototype.destroy.call(this);this._unbindEvents();n(this.button).remove();n(this.noopts).remove();n(this.tree).detach().appendTo(this.element).show()},
refresh:function(){this._unbindEvents();var b=this.options;if(this.tree.find("li").length){this.noopts.hide();this.button.show();var a=[],c=b.selected;if(c){for(var d=this.treeID,e=0,f=c.length;e<f;e++)a.push(d+"-"+c[e]);this._updateButtonText(a)}n.jstree._themes=S3.Ap.concat("/",b.themesFolder,"/");"ltr"==n("body").css("direction")?(c=!1,d=b.theme):(c=!0,d=b.theme+"-rtl");var e=b.multiple,g=b.leafonly;this.tree.jstree({core:{check_callback:!0,animation:100,rtl:c,html_titles:b.htmlTitles},themes:{theme:d,
...
this.input.val(),b=b?JSON.parse(b):[],a=this.tree,c=[],d=[],e=this.options.leafonly,f=a.jstree("get_checked",null,!0);n(f).each(function(){var b=n(this).attr("id");if(b&&(!e||a.jstree("is_leaf",this))){var f=parseInt(b.split("-").pop());f&&(c.push(f),d.push(b))}});var f=!1,g=n(c).not(b).get();g.length?f=!0:(g=n(b).not(c).get(),g.length&&(f=!0));this.input.val(JSON.stringify(c));this._updateButtonText(d);f&&n(this.element).trigger("select.s3hierarchy");return!0},_updateButtonText:function(b){var a=
null,a=this.options;if(numSelected=b?b.length:0)if(1<numSelected)a=a.selectedText.replace("#",numSelected);else{for(var c=[],d=0;d<numSelected;d++)c.push(n("#"+b[d]+" > a").text().replace(/^\s+|\s+$/g,""));a=c.length?c.join(" "):a.noneSelectedText}else a=a.noneSelectedText;this.buttonText.text(a)},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=n("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?JSON.parse(b):
[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},openMenu:function(){this._isOpen&&this.closeMenu();var b=n(this.button),a=b.offset();n(this.tree).css({position:"absolute",top:a.top+b.outerHeight(),left:a.left,minWidth:b.outerWidth()-8,"z-index":999999}).show().jstree("set_focus");this._isOpen=!0;b.addClass("ui-state-active");n(this).trigger("open")},closeMenu:function(){n(this.tree).hide().jstree("unset_focus").unbind("click.hierarchicalopts").unbind("mouseleave.hierarchicalopts");
this._isOpen=!1;n(this.button).removeClass("ui-state-active");n(this).trigger("close")},addNode:function(b,a,c,d){var e=this.tree,f=this.treeID,g=b?"#"+f+"-"+b:-1;a=f+"-"+a;e.jstree("create_node",g,"last",{data:c,attr:{id:a,rel:"leaf"}},!1,!1);b&&(n(g).attr({rel:"parent"}),e.jstree("open_node",g));d&&e.jstree("check_node","#"+a)},_bindEvents:function(){var b=this,a=n(this.tree),c=n(this.button),d=this._namespace;a.bind("check_node.jstree",function(c,d){b._updateSelectedNodes();if(b.options.multiple)a.one("mouseleave.hierarchicalopts",
function(){b.closeMenu()});else b.closeMenu()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("open_node.jstree",function(a,b){b.inst._get_parent(b.rslt.obj).length&&b.inst.open_node(b.inst._get_parent(b.rslt.obj),!1,!0)});c.bind("click"+d,function(){b._isOpen?b.closeMenu():b.openMenu()}).bind("keyup"+d,function(a){a.preventDefault();switch(a.keyCode){case 27:case 38:case 37:b.closeMenu();break;case 39:case 40:b.openMenu()}}).bind("mouseenter"+d,function(){c.hasClass("ui-state-disabled")||
n(this).addClass("ui-state-hover")}).bind("mouseleave"+d,function(){n(this).removeClass("ui-state-hover")}).bind("focus"+d,function(){c.hasClass("ui-state-disabled")||n(this).addClass("ui-state-focus")}).bind("blur"+d,function(){n(this).removeClass("ui-state-focus")});n(document).bind("mousedown"+d,function(d){var f=d.target;a.is(f)||c.is(f)||0!==a.has(d.target).length||0!==c.has(d.target).length||b.closeMenu()});return!0},_unbindEvents:function(){var b=n(this.tree);n(this.button);var a=this._namespace;
b.unbind("check_node.jstree").unbind("uncheck_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");n(this.button).unbind(a);n(document).unbind(a);return!0}})})(jQuery);
