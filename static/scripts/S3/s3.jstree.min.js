...
$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;$jscomp.getGlobal=function(f){f=["object"==typeof globalThis&&globalThis,f,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var B=0;B<f.length;++B){var I=f[B];if(I&&I.Math==Math)return I}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(f,B,I){if(f==Array.prototype||f==Object.prototype)return f;f[B]=I.value;return f};$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";
var $jscomp$lookupPolyfilledValue=function(f,B){var I=$jscomp.propertyToPolyfillSymbol[B];if(null==I)return f[B];I=f[I];return void 0!==I?I:f[B]};$jscomp.polyfill=function(f,B,I,t){B&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(f,B,I,t):$jscomp.polyfillUnisolated(f,B,I,t))};
$jscomp.polyfillUnisolated=function(f,B,I,t){I=$jscomp.global;f=f.split(".");for(t=0;t<f.length-1;t++){var q=f[t];if(!(q in I))return;I=I[q]}f=f[f.length-1];t=I[f];B=B(t);B!=t&&null!=B&&$jscomp.defineProperty(I,f,{configurable:!0,writable:!0,value:B})};
$jscomp.polyfillIsolated=function(f,B,I,t){var q=f.split(".");f=1===q.length;t=q[0];t=!f&&t in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var z=0;z<q.length-1;z++){var w=q[z];if(!(w in t))return;t=t[w]}q=q[q.length-1];I=$jscomp.IS_SYMBOL_NATIVE&&"es6"===I?t[q]:null;B=B(I);null!=B&&(f?$jscomp.defineProperty($jscomp.polyfills,q,{configurable:!0,writable:!0,value:B}):B!==I&&(void 0===$jscomp.propertyToPolyfillSymbol[q]&&(I=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[q]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(q):$jscomp.POLYFILL_PREFIX+I+"$"+q),$jscomp.defineProperty(t,$jscomp.propertyToPolyfillSymbol[q],{configurable:!0,writable:!0,value:B})))};
$jscomp.polyfill("Promise",function(f){function B(){this.batch_=null}function I(w){return w instanceof q?w:new q(function(A,x){A(w)})}if(f&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return f;B.prototype.asyncExecute=function(w){if(null==this.batch_){this.batch_=[];var A=this;this.asyncExecuteFunction(function(){A.executeBatch_()})}this.batch_.push(w)};
var t=$jscomp.global.setTimeout;B.prototype.asyncExecuteFunction=function(w){t(w,0)};B.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var w=this.batch_;this.batch_=[];for(var A=0;A<w.length;++A){var x=w[A];w[A]=null;try{x()}catch(F){this.asyncThrow_(F)}}}this.batch_=null};B.prototype.asyncThrow_=function(w){this.asyncExecuteFunction(function(){throw w;})};var q=function(w){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var A=this.createResolveAndReject_();
try{w(A.resolve,A.reject)}catch(x){A.reject(x)}};q.prototype.createResolveAndReject_=function(){function w(F){return function(M){x||(x=!0,F.call(A,M))}}var A=this,x=!1;return{resolve:w(this.resolveTo_),reject:w(this.reject_)}};q.prototype.resolveTo_=function(w){if(w===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(w instanceof q)this.settleSameAsPromise_(w);else{a:switch(typeof w){case "object":var A=null!=w;break a;case "function":A=!0;break a;default:A=!1}A?this.resolveToNonPromiseObj_(w):
this.fulfill_(w)}};q.prototype.resolveToNonPromiseObj_=function(w){var A=void 0;try{A=w.then}catch(x){this.reject_(x);return}"function"==typeof A?this.settleSameAsThenable_(A,w):this.fulfill_(w)};q.prototype.reject_=function(w){this.settle_(2,w)};q.prototype.fulfill_=function(w){this.settle_(1,w)};q.prototype.settle_=function(w,A){if(0!=this.state_)throw Error("Cannot settle("+w+", "+A+"): Promise already settled in state"+this.state_);this.state_=w;this.result_=A;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};q.prototype.scheduleUnhandledRejectionCheck_=function(){var w=this;t(function(){if(w.notifyUnhandledRejection_()){var A=$jscomp.global.console;"undefined"!==typeof A&&A.error(w.result_)}},1)};q.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var w=$jscomp.global.CustomEvent,A=$jscomp.global.Event,x=$jscomp.global.dispatchEvent;if("undefined"===typeof x)return!0;"function"===typeof w?w=new w("unhandledrejection",{cancelable:!0}):
"function"===typeof A?w=new A("unhandledrejection",{cancelable:!0}):(w=$jscomp.global.document.createEvent("CustomEvent"),w.initCustomEvent("unhandledrejection",!1,!0,w));w.promise=this;w.reason=this.result_;return x(w)};q.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var w=0;w<this.onSettledCallbacks_.length;++w)z.asyncExecute(this.onSettledCallbacks_[w]);this.onSettledCallbacks_=null}};var z=new B;q.prototype.settleSameAsPromise_=function(w){var A=this.createResolveAndReject_();
w.callWhenSettled_(A.resolve,A.reject)};q.prototype.settleSameAsThenable_=function(w,A){var x=this.createResolveAndReject_();try{w.call(A,x.resolve,x.reject)}catch(F){x.reject(F)}};q.prototype.then=function(w,A){function x(N,Q){return"function"==typeof N?function(S){try{F(N(S))}catch(V){M(V)}}:Q}var F,M,H=new q(function(N,Q){F=N;M=Q});this.callWhenSettled_(x(w,F),x(A,M));return H};q.prototype.catch=function(w){return this.then(void 0,w)};q.prototype.callWhenSettled_=function(w,A){function x(){switch(F.state_){case 1:w(F.result_);
break;case 2:A(F.result_);break;default:throw Error("Unexpected state: "+F.state_);}}var F=this;null==this.onSettledCallbacks_?z.asyncExecute(x):this.onSettledCallbacks_.push(x);this.isRejectionHandled_=!0};q.resolve=I;q.reject=function(w){return new q(function(A,x){x(w)})};q.race=function(w){return new q(function(A,x){for(var F=$jscomp.makeIterator(w),M=F.next();!M.done;M=F.next())I(M.value).callWhenSettled_(A,x)})};q.all=function(w){var A=$jscomp.makeIterator(w),x=A.next();return x.done?I([]):new q(function(F,
M){function H(S){return function(V){N[S]=V;Q--;0==Q&&F(N)}}var N=[],Q=0;do N.push(void 0),Q++,I(x.value).callWhenSettled_(H(N.length-1),M),x=A.next();while(!x.done)})};return q},"es6","es3");$jscomp.findInternal=function(f,B,I){f instanceof String&&(f=String(f));for(var t=f.length,q=0;q<t;q++){var z=f[q];if(B.call(I,z,q,f))return{i:q,v:z}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(f){return f?f:function(B,I){return $jscomp.findInternal(this,B,I).v}},"es6","es3");
(function(f){"function"===typeof define&&define.amd?define(["jquery"],f):"undefined"!==typeof module&&module.exports?module.exports=f(require("jquery")):f(jQuery)})(function(f,B){if(!f.jstree){var I=0,t=!1,q=!1,z=!1,w=[],A=f("script:last").attr("src"),x=window.document,F=window.setImmediate,M=window.Promise;!F&&M&&(F=function(a,d){M.resolve(d).then(a)});f.jstree={version:"3.3.12",defaults:{plugins:[]},plugins:{},path:A&&-1!==A.indexOf("/")?A.replace(/\/[^\/]+$/,""):"",idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g,
...
1),c=null;if(!0===a&&!this.length)return!1;this.each(function(){var e=f.jstree.reference(this),h=d&&e?e[a]:null;c=d&&h?h.apply(e,b):null;e||d||a!==B&&!f.isPlainObject(a)||f.jstree.create(this,a);if(e&&!d||!0===a)c=e||!1;if(null!==c&&c!==B)return!1});return null!==c&&c!==B?c:this};f.expr.pseudos.jstree=f.expr.createPseudo(function(a){return function(d){return f(d).hasClass("jstree")&&f(d).data("jstree")!==B}});f.jstree.defaults.core={data:!1,strings:!1,check_callback:!1,error:f.noop,animation:200,
...
a.children=[];a.children_d=[];d.d&&(d=d.d,"string"===typeof d&&(d=JSON.parse(d)));f.vakata.is_array(d)||(d=[d]);var e=null,h={df:this._model.default_state,dat:d,par:a.id,m:this._model.data,t_id:this._id,t_cnt:this._cnt,sel:this._data.core.selected},g=this,k=function(m,n){m.data&&(m=m.data);var r=m.dat,u=m.par,v=[],y=[],p=[],D=m.df,K=m.t_id,T=m.t_cnt,L=m.m,R=L[u];m=m.sel;var O,P=function(C,E,W){W=W?W.concat():[];E&&W.unshift(E);var U=C.id.toString();E={id:U,text:C.text||"",icon:C.icon!==n?C.icon:!0,
parent:E,parents:W,children:C.children||[],children_d:C.children_d||[],data:C.data,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(G in D)D.hasOwnProperty(G)&&(E.state[G]=D[G]);C&&C.data&&C.data.jstree&&C.data.jstree.icon&&(E.icon=C.data.jstree.icon);if(E.icon===n||null===E.icon||""===E.icon)E.icon=!0;if(C&&C.data&&(E.data=C.data,C.data.jstree))for(G in C.data.jstree)C.data.jstree.hasOwnProperty(G)&&(E.state[G]=C.data.jstree[G]);if(C&&"object"===typeof C.state)for(G in C.state)C.state.hasOwnProperty(G)&&
(E.state[G]=C.state[G]);if(C&&"object"===typeof C.li_attr)for(G in C.li_attr)C.li_attr.hasOwnProperty(G)&&(E.li_attr[G]=C.li_attr[G]);E.li_attr.id||(E.li_attr.id=U);if(C&&"object"===typeof C.a_attr)for(G in C.a_attr)C.a_attr.hasOwnProperty(G)&&(E.a_attr[G]=C.a_attr[G]);C&&C.children&&!0===C.children&&(E.state.loaded=!1,E.children=[],E.children_d=[]);L[E.id]=E;var G=0;for(U=E.children.length;G<U;G++){var Z=P(L[E.children[G]],E.id,W);var aa=L[Z];E.children_d.push(Z);aa.children_d.length&&(E.children_d=
E.children_d.concat(aa.children_d))}delete C.data;delete C.children;L[E.id].original=C;E.state.selected&&p.push(E.id);return E.id},X=function(C,E,W){W=W?W.concat():[];E&&W.unshift(E);do var U="j"+K+"_"+ ++T;while(L[U]);E={id:!1,text:"string"===typeof C?C:"",icon:"object"===typeof C&&C.icon!==n?C.icon:!0,parent:E,parents:W,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(G in D)D.hasOwnProperty(G)&&(E.state[G]=D[G]);C&&C.id&&(E.id=C.id.toString());C&&
C.text&&(E.text=C.text);C&&C.data&&C.data.jstree&&C.data.jstree.icon&&(E.icon=C.data.jstree.icon);if(E.icon===n||null===E.icon||""===E.icon)E.icon=!0;if(C&&C.data&&(E.data=C.data,C.data.jstree))for(G in C.data.jstree)C.data.jstree.hasOwnProperty(G)&&(E.state[G]=C.data.jstree[G]);if(C&&"object"===typeof C.state)for(G in C.state)C.state.hasOwnProperty(G)&&(E.state[G]=C.state[G]);if(C&&"object"===typeof C.li_attr)for(G in C.li_attr)C.li_attr.hasOwnProperty(G)&&(E.li_attr[G]=C.li_attr[G]);E.li_attr.id&&
!E.id&&(E.id=E.li_attr.id.toString());E.id||(E.id=U);E.li_attr.id||(E.li_attr.id=E.id);if(C&&"object"===typeof C.a_attr)for(G in C.a_attr)C.a_attr.hasOwnProperty(G)&&(E.a_attr[G]=C.a_attr[G]);if(C&&C.children&&C.children.length){var G=0;for(U=C.children.length;G<U;G++){var Z=X(C.children[G],E.id,W);var aa=L[Z];E.children.push(Z);aa.children_d.length&&(E.children_d=E.children_d.concat(aa.children_d))}E.children_d=E.children_d.concat(E.children)}C&&C.children&&!0===C.children&&(E.state.loaded=!1,E.children=
[],E.children_d=[]);delete C.data;delete C.children;E.original=C;L[E.id]=E;E.state.selected&&p.push(E.id);return E.id};if(r.length&&r[0].id!==n&&r[0].parent!==n){var J=0;for(O=r.length;J<O;J++)r[J].children||(r[J].children=[]),r[J].state||(r[J].state={}),L[r[J].id.toString()]=r[J];J=0;for(O=r.length;J<O;J++)L[r[J].parent.toString()]?(L[r[J].parent.toString()].children.push(r[J].id.toString()),R.children_d.push(r[J].id.toString())):"undefined"!==typeof g&&(g._data.core.last_error={error:"parse",plugin:"core",
id:"core_07",reason:"Node with invalid parent",data:JSON.stringify({id:r[J].id.toString(),parent:r[J].parent.toString()})},g.settings.core.error.call(g,g._data.core.last_error));J=0;for(O=R.children.length;J<O;J++){var Y=P(L[R.children[J]],u,R.parents.concat());y.push(Y);L[Y].children_d.length&&(y=y.concat(L[Y].children_d))}}else{J=0;for(O=r.length;J<O;J++)if(Y=X(r[J],u,R.parents.concat()))v.push(Y),y.push(Y),L[Y].children_d.length&&(y=y.concat(L[Y].children_d));R.children=v;R.children_d=y}J=0;for(O=
R.parents.length;J<O;J++)L[R.parents[J]].children_d=L[R.parents[J]].children_d.concat(y);r={cnt:T,mod:L,sel:m,par:u,dpc:y,add:p};if("undefined"===typeof window||"undefined"===typeof window.document)postMessage(r);else return r},l=function(m,n){if(null!==this.element){this._cnt=m.cnt;var r=this._model.data;for(D in r)r.hasOwnProperty(D)&&r[D].state&&r[D].state.loading&&m.mod[D]&&(m.mod[D].state.loading=!0);this._model.data=m.mod;if(n){var u,v=m.add,y=m.sel,p=this._data.core.selected.slice();r=this._model.data;
if(y.length!==p.length||f.vakata.array_unique(y.concat(p)).length!==y.length){var D=0;for(u=y.length;D<u;D++)-1===f.inArray(y[D],v)&&-1===f.inArray(y[D],p)&&(r[y[D]].state.selected=!1);D=0;for(u=p.length;D<u;D++)-1===f.inArray(p[D],y)&&(r[p[D]].state.selected=!0)}}m.add.length&&(this._data.core.selected=this._data.core.selected.concat(m.add));this.trigger("model",{nodes:m.dpc,parent:m.par});m.par!==f.jstree.root?(this._node_changed(m.par),this.redraw()):this.redraw(!0);m.add.length&&this.trigger("changed",
{action:"model",selected:this._data.core.selected});!n&&F?F(function(){b.call(g,!0)}):b.call(g,!0)}};if(this.settings.core.worker&&window.Blob&&window.URL&&window.Worker)try{null===this._wrk&&(this._wrk=window.URL.createObjectURL(new window.Blob(["self.onmessage = "+k.toString()],{type:"text/javascript"}))),!this._data.core.working||c?(this._data.core.working=!0,e=new window.Worker(this._wrk),e.onmessage=function(m){l.call(this,m.data,!0);try{e.terminate(),e=null}catch(n){}this._data.core.worker_queue.length?
...
return g.id},_parse_model_from_flat_json:function(a,d,b){b=b?b.concat():[];d&&b.unshift(d);var c=a.id.toString(),e=this._model.data,h=this._model.default_state;d={id:c,text:a.text||"",icon:a.icon!==B?a.icon:!0,parent:d,parents:b,children:a.children||[],children_d:a.children_d||[],data:a.data,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(g in h)h.hasOwnProperty(g)&&(d.state[g]=h[g]);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(d.icon=a.data.jstree.icon);if(d.icon===B||null===d.icon||
...
var e=this._model.default_state;do var h="j"+this._id+"_"+ ++this._cnt;while(c[h]);d={id:!1,text:"string"===typeof a?a:"",icon:"object"===typeof a&&a.icon!==B?a.icon:!0,parent:d,parents:b,children:[],children_d:[],data:null,state:{},li_attr:{id:!1},a_attr:{href:"#"},original:!1};for(g in e)e.hasOwnProperty(g)&&(d.state[g]=e[g]);a&&a.id&&(d.id=a.id.toString());a&&a.text&&(d.text=a.text);a&&a.data&&a.data.jstree&&a.data.jstree.icon&&(d.icon=a.data.jstree.icon);if(d.icon===B||null===d.icon||""===d.icon)d.icon=
...
p===e.id);l++);e.state.hidden&&(r+=" jstree-hidden");e.state.loading&&(r+=" jstree-loading");e.state.loaded&&!y?r+=" jstree-leaf":(r+=e.state.opened&&e.state.loaded?" jstree-open":" jstree-closed",a.childNodes[1].setAttribute("aria-expanded",e.state.opened&&e.state.loaded));p===e.id&&(r+=" jstree-last");a.id=e.id;a.className=r;r=(e.state.selected?" jstree-clicked":"")+(e.state.disabled?" jstree-disabled":"");for(m in e.a_attr)!e.a_attr.hasOwnProperty(m)||"href"===m&&"#"===e.a_attr[m]||("class"!==
m?a.childNodes[1].setAttribute(m,e.a_attr[m]):r+=" "+e.a_attr[m]);r.length&&(a.childNodes[1].className="jstree-anchor "+r);if(e.icon&&!0!==e.icon||!1===e.icon)!1===e.icon?a.childNodes[1].childNodes[0].className+=" jstree-themeicon-hidden":-1===e.icon.indexOf("/")&&-1===e.icon.indexOf(".")?a.childNodes[1].childNodes[0].className+=" "+e.icon+" jstree-themeicon-custom":(a.childNodes[1].childNodes[0].style.backgroundImage='url("'+e.icon+'")',a.childNodes[1].childNodes[0].style.backgroundPosition="center center",
...
d!==f.jstree.root&&(this._model.data[d].state.loaded&&this.settings.core.loaded_state&&a.core.loaded.push(d),this._model.data[d].state.opened&&a.core.open.push(d),this._model.data[d].state.selected&&a.core.selected.push(d));return a},set_state:function(a,d){if(a){a.core&&a.core.selected&&a.core.initial_selection===B&&(a.core.initial_selection=this._data.core.selected.concat([]).sort().join(","));if(a.core){var b;if(a.core.loaded)return this.settings.core.loaded_state&&f.vakata.is_array(a.core.loaded)&&
a.core.loaded.length?this._load_nodes(a.core.loaded,function(e){delete a.core.loaded;this.set_state(a,d)}):(delete a.core.loaded,this.set_state(a,d)),!1;if(a.core.open)return f.vakata.is_array(a.core.open)&&a.core.open.length?this._load_nodes(a.core.open,function(e){this.open_node(e,!1,0);delete a.core.open;this.set_state(a,d)}):(delete a.core.open,this.set_state(a,d)),!1;if(a.core.scroll)return a.core.scroll&&a.core.scroll.left!==B&&this.element.scrollLeft(a.core.scroll.left),a.core.scroll&&a.core.scroll.top!==
B&&this.element.scrollTop(a.core.scroll.top),delete a.core.scroll,this.set_state(a,d),!1;if(a.core.selected){var c=this;if(a.core.initial_selection===B||a.core.initial_selection===this._data.core.selected.concat([]).sort().join(","))this.deselect_all(),f.each(a.core.selected,function(e,h){c.select_node(h,!1,!0)});delete a.core.initial_selection;delete a.core.selected;this.set_state(a,d);return!1}for(b in a)a.hasOwnProperty(b)&&"core"!==b&&-1===f.inArray(b,this.settings.plugins)&&delete a[b];if(f.isEmptyObject(a.core))return delete a.core,
...
b=b===B?0:b;if(!d)return!1;if(!b.toString().match(/^(before|after)$/)&&!e&&!this.is_loaded(d))return this.load_node(d,function(){this.move_node(a,d,b,c,!0,!1,g)});if(f.vakata.is_array(a))if(1===a.length)a=a[0];else{h=0;for(k=a.length;h<k;h++)if(l=this.move_node(a[h],d,b,c,e,!1,g))d=l,b="after";this.redraw();return!0}a=a&&a.id?a:this.get_node(a);if(!a||a.id===f.jstree.root)return!1;k=(a.parent||f.jstree.root).toString();var r=b.toString().match(/^(before|after)$/)&&d.id!==f.jstree.root?this.get_node(d.parent):
d;var u=g?g:this._model.data[a.id]?this:f.jstree.reference(a.id);l=!u||!u._id||this._id!==u._id;var v=u&&u._id&&k&&u._model.data[k]&&u._model.data[k].children?f.inArray(a.id,u._model.data[k].children):-1;u&&u._id&&(a=u._model.data[a.id]);if(l)return(l=this.copy_node(a,d,b,c,e,!1,g))?(u&&u.delete_node(a),l):!1;d.id===f.jstree.root&&("before"===b&&(b="first"),"after"===b&&(b="last"));switch(b){case "before":b=f.inArray(d.id,r.children);break;case "after":b=f.inArray(d.id,r.children)+1;break;case "inside":case "first":b=
0;break;case "last":b=r.children.length;break;default:b||(b=0)}b>r.children.length&&(b=r.children.length);if(!this.check("move_node",a,r,b,{core:!0,origin:g,is_multi:u&&u._id&&u._id!==this._id,is_foreign:!u||!u._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;if(a.parent===r.id){e=r.children.concat();l=f.inArray(a.id,e);-1!==l&&(e=f.vakata.array_remove(e,l),b>l&&b--);l=[];var y=0;for(m=e.length;y<m;y++)l[y>=b?y+1:y]=e[y];l[b]=a.id;r.children=l;this._node_changed(r.id);
this.redraw(r.id===f.jstree.root)}else{l=a.children_d.concat();l.push(a.id);y=0;for(m=a.parents.length;y<m;y++){e=[];var p=u._model.data[a.parents[y]].children_d;var D=0;for(n=p.length;D<n;D++)-1===f.inArray(p[D],l)&&e.push(p[D]);u._model.data[a.parents[y]].children_d=e}u._model.data[k].children=f.vakata.array_remove_item(u._model.data[k].children,a.id);y=0;for(m=r.parents.length;y<m;y++)this._model.data[r.parents[y]].children_d=this._model.data[r.parents[y]].children_d.concat(l);e=[];y=0;for(m=r.children.length;y<
m;y++)e[y>=b?y+1:y]=r.children[y];e[b]=a.id;r.children=e;r.children_d.push(a.id);r.children_d=r.children_d.concat(a.children_d);a.parent=r.id;l=r.parents.concat();l.unshift(r.id);p=a.parents.length;a.parents=l;l=l.concat();y=0;for(m=a.children_d.length;y<m;y++)this._model.data[a.children_d[y]].parents=this._model.data[a.children_d[y]].parents.slice(0,-1*p),Array.prototype.push.apply(this._model.data[a.children_d[y]].parents,l);if(k===f.jstree.root||r.id===f.jstree.root)this._model.force_full_redraw=
!0;this._model.force_full_redraw||(this._node_changed(k),this._node_changed(r.id));h||this.redraw()}c&&c.call(this,a,r,b);this.trigger("move_node",{node:a,parent:r.id,position:b,old_parent:k,old_position:v,is_multi:u&&u._id&&u._id!==this._id,is_foreign:!u||!u._id,old_instance:u,new_instance:this});return a.id},copy_node:function(a,d,b,c,e,h,g){var k,l,m,n;d=this.get_node(d);b=b===B?0:b;if(!d)return!1;if(!b.toString().match(/^(before|after)$/)&&!e&&!this.is_loaded(d))return this.load_node(d,function(){this.copy_node(a,
...
"first"),"after"===b&&(b="last"));switch(b){case "before":b=f.inArray(d.id,r.children);break;case "after":b=f.inArray(d.id,r.children)+1;break;case "inside":case "first":b=0;break;case "last":b=r.children.length;break;default:b||(b=0)}b>r.children.length&&(b=r.children.length);if(!this.check("copy_node",a,r,b,{core:!0,origin:g,is_multi:n&&n._id&&n._id!==this._id,is_foreign:!n||!n._id}))return this.settings.core.error.call(this,this._data.core.last_error),!1;var u=n?n.get_json(a,{no_id:!0,no_data:!0,
no_state:!0}):a;if(!u)return!1;!0===u.id&&delete u.id;u=this._parse_model_from_json(u,r.id,r.parents.concat());if(!u)return!1;l=this.get_node(u);a&&a.state&&!1===a.state.loaded&&(l.state.loaded=!1);e=[];e.push(u);e=e.concat(l.children_d);this.trigger("model",{nodes:e,parent:r.id});u=0;for(m=r.parents.length;u<m;u++)this._model.data[r.parents[u]].children_d=this._model.data[r.parents[u]].children_d.concat(e);e=[];u=0;for(m=r.children.length;u<m;u++)e[u>=b?u+1:u]=r.children[u];e[b]=l.id;r.children=
e;r.children_d.push(l.id);r.children_d=r.children_d.concat(l.children_d);r.id===f.jstree.root&&(this._model.force_full_redraw=!0);this._model.force_full_redraw||this._node_changed(r.id);h||this.redraw(r.id===f.jstree.root);c&&c.call(this,l,r,b);this.trigger("copy_node",{node:l,original:a,parent:r.id,position:b,old_parent:k,old_position:n&&n._id&&k&&n._model.data[k]&&n._model.data[k].children?f.inArray(a.id,n._model.data[k].children):-1,is_multi:n&&n._id&&n._id!==this._id,is_foreign:!n||!n._id,old_instance:n,
new_instance:this});return l.id},cut:function(a){a||(a=this._data.core.selected.concat());f.vakata.is_array(a)||(a=[a]);if(!a.length)return!1;var d=[],b,c;var e=0;for(c=a.length;e<c;e++)(b=this.get_node(a[e]))&&b.id&&b.id!==f.jstree.root&&d.push(b);if(!d.length)return!1;t=d;z=this;q="move_node";this.trigger("cut",{node:a})},copy:function(a){a||(a=this._data.core.selected.concat());f.vakata.is_array(a)||(a=[a]);if(!a.length)return!1;var d=[],b,c;var e=0;for(c=a.length;e<c;e++)(b=this.get_node(a[e]))&&
b.id&&b.id!==f.jstree.root&&d.push(b);if(!d.length)return!1;t=d;z=this;q="copy_node";this.trigger("copy",{node:a})},get_buffer:function(){return{mode:q,node:t,inst:z}},can_paste:function(){return!1!==q&&!1!==t},paste:function(a,d){a=this.get_node(a);if(!(a&&q&&q.match(/^(copy_node|move_node)$/)&&t))return!1;this[q](t,a,d,!1,!1,!1,z)&&this.trigger("paste",{parent:a.id,node:t,mode:q});z=q=t=!1},clear_buffer:function(){z=q=t=!1;this.trigger("clear_buffer")},edit:function(a,d,b){var c=!1;a=this.get_node(a);
...
["style","contenteditable","hasfocus","tabindex"])&&null!==e.value&&""!==f.vakata.trim(e.value)&&(d?b[e.name]=e.value:b.push(e.name))});return b};f.vakata.array_unique=function(a){var d=[],b,c={};var e=0;for(b=a.length;e<b;e++)c[a[e]]===B&&(d.push(a[e]),c[a[e]]=!0);return d};f.vakata.array_remove=function(a,d){a.splice(d,1);return a};f.vakata.array_remove_item=function(a,d){d=f.inArray(d,a);return-1!==d?f.vakata.array_remove(a,d):a};f.vakata.array_filter=function(a,d,b,c,e){if(a.filter)return a.filter(d,
...
function(b,c){b=this._model.data;var e=b[c.parent],h=c.nodes;c=[];var g,k,l=this.settings.checkbox.cascade,m=this.settings.checkbox.tie_selection;if(-1!==l.indexOf("down"))if(e.state[m?"selected":"checked"]){var n=0;for(g=h.length;n<g;n++)b[h[n]].state[m?"selected":"checked"]=!0;this._data[m?"core":"checkbox"].selected=this._data[m?"core":"checkbox"].selected.concat(h)}else for(n=0,g=h.length;n<g;n++)if(b[h[n]].state[m?"selected":"checked"]){var r=0;for(k=b[h[n]].children_d.length;r<k;r++)b[b[h[n]].children_d[r]].state[m?
"selected":"checked"]=!0;this._data[m?"core":"checkbox"].selected=this._data[m?"core":"checkbox"].selected.concat(b[h[n]].children_d)}if(-1!==l.indexOf("up")){n=0;for(g=e.children_d.length;n<g;n++)b[e.children_d[n]].children.length||c.push(b[e.children_d[n]].parent);c=f.vakata.array_unique(c);r=0;for(k=c.length;r<k;r++)for(e=b[c[r]];e&&e.id!==f.jstree.root;){n=h=0;for(g=e.children.length;n<g;n++)h+=b[e.children[n]].state[m?"selected":"checked"];if(h===g)e.state[m?"selected":"checked"]=!0,this._data[m?
...
this.get_undetermined=function(b){if(-1===this.settings.checkbox.cascade.indexOf("undetermined"))return[];var c,e,h={},g=this._model.data,k=this.settings.checkbox.tie_selection,l=this._data[k?"core":"checkbox"].selected,m=[],n=this,r=[];var u=0;for(c=l.length;u<c;u++)if(g[l[u]]&&g[l[u]].parents){var v=0;for(e=g[l[u]].parents.length;v<e&&h[g[l[u]].parents[v]]===B;v++)g[l[u]].parents[v]!==f.jstree.root&&(h[g[l[u]].parents[v]]=!0,m.push(g[l[u]].parents[v]))}this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function(){var y=
n.get_node(this);if(y)if(y.state.loaded)for(u=0,c=y.children_d.length;u<c;u++){var p=g[y.children_d[u]];if(!p.state.loaded&&p.original&&p.original.state&&p.original.state.undetermined&&!0===p.original.state.undetermined)for(h[p.id]===B&&p.id!==f.jstree.root&&(h[p.id]=!0,m.push(p.id)),v=0,e=p.parents.length;v<e;v++)h[p.parents[v]]===B&&p.parents[v]!==f.jstree.root&&(h[p.parents[v]]=!0,m.push(p.parents[v]))}else if(y.original&&y.original.state&&y.original.state.undetermined&&!0===y.original.state.undetermined)for(h[y.id]===
B&&y.id!==f.jstree.root&&(h[y.id]=!0,m.push(y.id)),v=0,e=y.parents.length;v<e;v++)h[y.parents[v]]===B&&y.parents[v]!==f.jstree.root&&(h[y.parents[v]]=!0,m.push(y.parents[v]))});u=0;for(c=m.length;u<c;u++)g[m[u]].state[k?"selected":"checked"]||r.push(b?g[m[u]]:m[u]);return r};this._undetermined=function(){if(null!==this.element){var b=this.get_undetermined(!1),c,e;this.element.find(".jstree-undetermined").removeClass("jstree-undetermined");var h=0;for(c=b.length;h<c;h++)(e=this.get_node(b[h],!0))&&
e.length&&e.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined")}};this.redraw_node=function(b,c,e,h){if(b=d.redraw_node.apply(this,arguments)){var g,k=null;var l=0;for(g=b.childNodes.length;l<g;l++)if(b.childNodes[l]&&b.childNodes[l].className&&-1!==b.childNodes[l].className.indexOf("jstree-anchor")){k=b.childNodes[l];break}k&&(!this.settings.checkbox.tie_selection&&this._model.data[b.id].state.checked&&(k.className+=" jstree-checked"),l=H.cloneNode(!1),this._model.data[b.id].state.checkbox_disabled&&
...
!1,e=0,h=0,g=[],k="",l=!1;a.vakata.context={settings:{hide_onmouseleave:0,icons:!0},_trigger:function(m){a(x).triggerHandler("context_"+m+".vakata",{reference:c,element:b,position:{x:e,y:h}})},_execute:function(m){return(m=g[m])&&(!m._disabled||a.vakata.is_function(m._disabled)&&!m._disabled({item:m,reference:c,element:b}))&&m.action?m.action.call(null,{item:m,reference:c,element:b,position:{x:e,y:h}}):!1},_parse:function(m,n){if(!m)return!1;n||(k="",g=[]);var r="",u=!1,v;n&&(r+="<ul>");a.each(m,
function(y,p){if(!p)return!0;g.push(p);!u&&p.separator_before&&(r+="<li class='vakata-context-separator'><a href='#' "+(a.vakata.context.settings.icons?"":'class="vakata-context-no-icons"')+">&#160;</a></li>");u=!1;r+="<li class='"+(p._class||"")+(!0===p._disabled||a.vakata.is_function(p._disabled)&&p._disabled({item:p,reference:c,element:b})?" vakata-contextmenu-disabled ":"")+"' "+(p.shortcut?" data-shortcut='"+p.shortcut+"' ":"")+">";r+="<a href='#' rel='"+(g.length-1)+"' "+(p.title?"title='"+
p.title+"'":"")+">";a.vakata.context.settings.icons&&(r+="<i ",p.icon&&(r=-1!==p.icon.indexOf("/")||-1!==p.icon.indexOf(".")?r+(" style='background:url(\""+p.icon+"\") center center no-repeat' "):r+(" class='"+p.icon+"' ")),r+="></i><span class='vakata-contextmenu-sep'>&#160;</span>");r+=(a.vakata.is_function(p.label)?p.label({item:y,reference:c,element:b}):p.label)+(p.shortcut?' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-'+p.shortcut+'">'+(p.shortcut_label||"")+"</span>":
"")+"</a>";p.submenu&&(v=a.vakata.context._parse(p.submenu,!0))&&(r+=v);r+="</li>";p.separator_after&&(r+="<li class='vakata-context-separator'><a href='#' "+(a.vakata.context.settings.icons?"":'class="vakata-context-no-icons"')+">&#160;</a></li>",u=!0)});r=r.replace(/<li class='vakata-context-separator'><\/li>$/,"");n&&(r+="</ul>");n||(k=r,a.vakata.context._trigger("parse"));return 10<r.length?r:!1},_show_submenu:function(m){m=a(m);if(m.length&&m.children("ul").length){var n=m.children("ul"),r=m.offset().left,
u=r+m.outerWidth(),v=m.offset().top,y=n.width(),p=n.height(),D=a(window).width()+a(window).scrollLeft(),K=a(window).height()+a(window).scrollTop();if(d)m[0>u-(y+10+m.outerWidth())?"addClass":"removeClass"]("vakata-context-left");else m[u+y>D&&r>D-u?"addClass":"removeClass"]("vakata-context-right");v+p+10>K&&n.css("bottom","-1px");m.hasClass("vakata-context-right")?r<y&&n.css("margin-right",r-y):D-u<y&&n.css("margin-left",D-u-y);n.show()}},show:function(m,n,r){b&&b.length&&b.width("");switch(!0){case !n&&
!m:return!1;case !!n&&!!m:c=m;e=n.x;h=n.y;break;case !n&&!!m:c=m;n=m.offset();e=n.left+m.outerHeight();h=n.top;break;case !!n&&!m:e=n.x,h=n.y}m&&!r&&a(m).data("vakata_contextmenu")&&(r=a(m).data("vakata_contextmenu"));a.vakata.context._parse(r)&&b.html(k);if(g.length){b.appendTo(x.body);r=b;n=e;var u=h;var v=r.width();var y=r.height();var p=a(window).width()+a(window).scrollLeft();var D=a(window).height()+a(window).scrollTop();d&&(n-=r.outerWidth()-a(m).outerWidth(),n<a(window).scrollLeft()+20&&(n=
...
a.vakata.context.settings.hide_onmouseleave&&(m=setTimeout(function(r){return function(){a.vakata.context.hide()}}(this),a.vakata.context.settings.hide_onmouseleave))}).on("click","a",function(n){n.preventDefault();a(this).trigger("blur").parent().hasClass("vakata-context-disabled")||!1===a.vakata.context._execute(a(this).attr("rel"))||a.vakata.context.hide()}).on("keydown","a",function(n){switch(n.which){case 13:case 32:n.type="click";n.preventDefault();a(n.currentTarget).trigger(n);break;case 37:l&&
(b.find(".vakata-context-hover").last().closest("li").first().find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").trigger("focus"),n.stopImmediatePropagation(),n.preventDefault());break;case 38:if(l){var r=b.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").prevAll("li:not(.vakata-context-separator)").first();r.length||(r=b.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last());
r.addClass("vakata-context-hover").children("a").trigger("focus");n.stopImmediatePropagation();n.preventDefault()}break;case 39:l&&(b.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").trigger("focus"),n.stopImmediatePropagation(),n.preventDefault());break;case 40:l&&(r=b.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").nextAll("li:not(.vakata-context-separator)").first(),
r.length||(r=b.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").first()),r.addClass("vakata-context-hover").children("a").trigger("focus"),n.stopImmediatePropagation(),n.preventDefault());break;case 27:a.vakata.context.hide(),n.preventDefault()}}).on("keydown",function(n){n.preventDefault();n=b.find(".vakata-contextmenu-shortcut-"+n.which).parent();n.parent().not(".vakata-context-disabled")&&n.trigger("click")});a(x).on("mousedown.vakata.jstree",function(n){l&&b[0]!==
n.target&&!a.contains(b[0],n.target)&&a.vakata.context.hide()}).on("context_show.vakata.jstree",function(n,r){b.find("li:has(ul)").children("a").addClass("vakata-context-parent");d&&b.addClass("vakata-context-rtl").css("direction","rtl");b.find("ul").hide().end()})})})(f);f.jstree.defaults.dnd={copy:!0,open_timeout:500,is_draggable:!0,check_while_dragging:!0,always_copy:!1,inside_pos:0,drag_selection:!0,touch:!0,large_drop_target:!1,large_drag_target:!1,use_html5:!1};var N,Q;f.jstree.plugins.dnd=
...
g.event;var l=f.jstree.reference(g.event.target),m=!1,n=!1;h=!1;var r,u,v,y,p,D,K,T,L,R,O,P;if(l&&l._data&&l._data.dnd){e.attr("class","jstree-"+l.get_theme()+(l.settings.core.themes.responsive?" jstree-dnd-responsive":""));var X=g.data.origin&&(g.data.origin.settings.dnd.always_copy||g.data.origin.settings.dnd.copy&&(g.event.metaKey||g.event.ctrlKey));g.helper.children().attr("class","jstree-"+l.get_theme()+" jstree-"+l.get_theme()+"-"+l.get_theme_variant()+" "+(l.settings.core.themes.responsive?
" jstree-dnd-responsive":"")).find(".jstree-copy").first()[X?"show":"hide"]();if(g.event.target!==l.element[0]&&g.event.target!==l.get_container_ul()[0]||0!==l.get_container_ul().children().length){if((m=l.settings.dnd.large_drop_target?f(g.event.target).closest(".jstree-node").children(".jstree-anchor"):f(g.event.target).closest(".jstree-anchor"))&&m.length&&m.parent().is(".jstree-closed, .jstree-open, .jstree-leaf")){n=m.offset();h=(g.event.pageY!==B?g.event.pageY:g.event.originalEvent.pageY)-n.top;
var J=m.outerHeight();var Y=h<J/3?["b","i","a"]:h>J-J/3?["a","i","b"]:h>J/2?["i","a","b"]:["i","b","a"];f.each(Y,function(W,U){switch(U){case "b":r=n.left-6;u=n.top;v=l.get_parent(m);y=m.parent().index();P="jstree-below";break;case "i":L=l.settings.dnd.inside_pos;R=l.get_node(m.parent());r=n.left-2;u=n.top+J/2+1;v=R.id;y="first"===L?0:"last"===L?R.children.length:Math.min(L,R.children.length);P="jstree-inside";break;case "a":r=n.left-6,u=n.top+J,v=l.get_parent(m),y=m.parent().index()+1,P="jstree-above"}C=
...
escape:function(p){return a.vakata.html.div.text(p).html()},strip:function(p){return a.vakata.html.div.empty().append(a.parseHTML(p)).text()}};var d=!1,b=!1,c=!1,e=!1,h=!1,g=0,k=!1,l=0,m=0,n=0,r=0,u=!1,v=!1,y=!1;a.vakata.dnd={settings:{scroll_speed:10,scroll_proximity:20,helper_left:5,helper_top:10,threshold:5,threshold_touch:10},_trigger:function(p,D,K){K===B&&(K=a.vakata.dnd._get());K.event=D;a(x).triggerHandler("dnd_"+p+".vakata",K)},_get:function(){return{data:k,element:d,helper:h}},_clean:function(){h&&
h.remove();v&&(clearInterval(v),v=!1);h=e=c=b=d=!1;g=0;k=!1;r=n=m=l=0;y=v=u=!1;Q=null;a(x).off("mousemove.vakata.jstree touchmove.vakata.jstree",a.vakata.dnd.drag);a(x).off("mouseup.vakata.jstree touchend.vakata.jstree",a.vakata.dnd.stop)},_scroll:function(p){if(!u||!n&&!r)return v&&(clearInterval(v),v=!1),!1;if(!v)return v=setInterval(a.vakata.dnd._scroll,100),!1;if(!0===p)return!1;p=u.scrollTop();var D=u.scrollLeft();u.scrollTop(p+r*a.vakata.dnd.settings.scroll_speed);u.scrollLeft(D+n*a.vakata.dnd.settings.scroll_speed);
...
l)>(y?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold)||Math.abs(p.pageY-m)>(y?a.vakata.dnd.settings.threshold_touch:a.vakata.dnd.settings.threshold))h&&(h.appendTo(x.body),g=h.outerWidth()),e=!0,a(b).one("click.vakata",!1),a.vakata.dnd._trigger("start",p);else return;var D=!1,K=!1,T=!1,L=!1,R=!1,O=K=!1,P=!1;L=D=!1;n=r=0;u=!1;a(a(p.target).parentsUntil("body").addBack().get().reverse()).filter(function(){return/^auto|scroll$/.test(a(this).css("overflow"))&&(this.scrollHeight>
this.offsetHeight||this.scrollWidth>this.offsetWidth)}).each(function(){var X=a(this),J=X.offset();this.scrollHeight>this.offsetHeight&&(J.top+X.height()-p.pageY<a.vakata.dnd.settings.scroll_proximity&&(r=1),p.pageY-J.top<a.vakata.dnd.settings.scroll_proximity&&(r=-1));this.scrollWidth>this.offsetWidth&&(J.left+X.width()-p.pageX<a.vakata.dnd.settings.scroll_proximity&&(n=1),p.pageX-J.left<a.vakata.dnd.settings.scroll_proximity&&(n=-1));if(r||n)return u=a(this),!1});!u&&(D=a(x),K=a(window),T=D.height(),
L=K.height(),R=D.width(),K=K.width(),O=D.scrollTop(),P=D.scrollLeft(),T>L&&p.pageY-O<a.vakata.dnd.settings.scroll_proximity&&(r=-1),T>L&&L-(p.pageY-O)<a.vakata.dnd.settings.scroll_proximity&&(r=1),R>K&&p.pageX-P<a.vakata.dnd.settings.scroll_proximity&&(n=-1),R>K&&K-(p.pageX-P)<a.vakata.dnd.settings.scroll_proximity&&(n=1),r||n)&&(u=D);u&&a.vakata.dnd._scroll(!0);h&&(D=parseInt(p.pageY+a.vakata.dnd.settings.helper_top,10),L=parseInt(p.pageX+a.vakata.dnd.settings.helper_left,10),T&&D+25>T&&(D=T-50),
...
a.vakata.dnd._trigger("stop",p);else if("touchend"===p.type&&p.target===b){var D=setTimeout(function(){a(p.target).trigger("click")},100);a(p.target).one("click",function(){D&&clearTimeout(D)})}a.vakata.dnd._clean();return!1}}})(f);f.jstree.defaults.massload=null;f.jstree.plugins.massload=function(a,d){this.init=function(b,c){this._data.massload={};d.init.call(this,b,c)};this._load_nodes=function(b,c,e,h){var g=this.settings.massload,k=[],l=this._model.data,m,n;if(!e){var r=0;for(m=b.length;r<m;r++)if(!l[b[r]]||
!l[b[r]].state.loaded&&!l[b[r]].state.failed||h)k.push(b[r]),(n=this.get_node(b[r],!0))&&n.length&&n.addClass("jstree-loading").attr("aria-busy",!0);this._data.massload={};if(k.length){if(f.vakata.is_function(g))return g.call(this,k,function(u){if(u)for(v in u)u.hasOwnProperty(v)&&(this._data.massload[v]=u[v]);var v=0;for(u=b.length;v<u;v++)(n=this.get_node(b[v],!0))&&n.length&&n.removeClass("jstree-loading").attr("aria-busy",!1);d._load_nodes.call(this,b,c,e,h)}.bind(this));if("object"===typeof g&&
...
!0),this.redraw(!0))}.bind(this))};this.search=function(b,c,e,h,g,k){if(!1===b||""===f.vakata.trim(b.toString()))return this.clear_search();h=(h=this.get_node(h))&&h.id?h.id:null;b=b.toString();var l=this.settings.search,m=l.ajax?l.ajax:!1,n=this._model.data,r=null,u=[],v=[],y;this._data.search.res.length&&!g&&this.clear_search();e===B&&(e=l.show_only_matches);k===B&&(k=l.show_only_matches_children);if(!c&&!1!==m){if(f.vakata.is_function(m))return m.call(this,b,function(p){p&&p.d&&(p=p.d);this._load_nodes(f.vakata.is_array(p)?
...
b[c[k]].type=l;!0===b[c[k]].icon&&e[l].icon!==B&&(b[c[k]].icon=e[l].icon);if(e[l].li_attr!==B&&"object"===typeof e[l].li_attr)for(g in e[l].li_attr)e[l].li_attr.hasOwnProperty(g)&&"id"!==g&&(b[c[k]].li_attr[g]===B?b[c[k]].li_attr[g]=e[l].li_attr[g]:"class"===g&&(b[c[k]].li_attr["class"]=e[l].li_attr["class"]+" "+b[c[k]].li_attr["class"]));if(e[l].a_attr!==B&&"object"===typeof e[l].a_attr)for(g in e[l].a_attr)e[l].a_attr.hasOwnProperty(g)&&"id"!==g&&(b[c[k]].a_attr[g]===B?b[c[k]].a_attr[g]=e[l].a_attr[g]:
...
this._delete_ids(b.children));return b};this.check=function(b,c,e,h,g){if(!1===d.check.call(this,b,c,e,h,g))return!1;c=c&&c.id?c:this.get_node(c);e=e&&e.id?e:this.get_node(e);g=c&&c.id?g&&g.origin?g.origin:f.jstree.reference(c.id):null;var k,l;g=g&&g._model&&g._model.data?g._model.data:null;switch(b){case "create_node":case "move_node":case "copy_node":if("move_node"!==b||-1===f.inArray(c.id,e.children)){var m=this.get_rules(e);if(m.max_children!==B&&-1!==m.max_children&&m.max_children===e.children.length)return this._data.core.last_error=
{error:"check",plugin:"types",id:"types_01",reason:"max_children prevents function: "+b,data:JSON.stringify({chk:b,pos:h,obj:c&&c.id?c.id:!1,par:e&&e.id?e.id:!1})},!1;if(m.valid_children!==B&&-1!==m.valid_children&&-1===f.inArray(c.type||"default",m.valid_children))return this._data.core.last_error={error:"check",plugin:"types",id:"types_02",reason:"valid_children prevents function: "+b,data:JSON.stringify({chk:b,pos:h,obj:c&&c.id?c.id:!1,par:e&&e.id?e.id:!1})},!1;if(g&&c.children_d&&c.parents){var n=
k=0;for(l=c.children_d.length;n<l;n++)k=Math.max(k,g[c.children_d[n]].parents.length);k=k-c.parents.length+1}if(0>=k||k===B)k=1;do{if(m.max_depth!==B&&-1!==m.max_depth&&m.max_depth<k)return this._data.core.last_error={error:"check",plugin:"types",id:"types_03",reason:"max_depth prevents function: "+b,data:JSON.stringify({chk:b,pos:h,obj:c&&c.id?c.id:!1,par:e&&e.id?e.id:!1})},!1;e=this.get_node(e.parent);m=this.get_rules(e);k++}while(e)}}return!0};this.get_rules=function(b){b=this.get_node(b);if(!b)return!1;
b=this.get_type(b,!0);b.max_depth===B&&(b.max_depth=-1);b.max_children===B&&(b.max_children=-1);b.valid_children===B&&(b.valid_children=-1);return b};this.get_type=function(b,c){return(b=this.get_node(b))?c?f.extend({type:b.type},this.settings.types[b.type]):b.type:!1};this.set_type=function(b,c){var e=this._model.data,h,g,k,l;if(f.vakata.is_array(b)){b=b.slice();e=0;for(h=b.length;e<h;e++)this.set_type(b[e],c);return!0}h=this.settings.types;b=this.get_node(b);if(!h[c]||!b)return!1;(k=this.get_node(b,
!0))&&k.length&&(l=k.children(".jstree-anchor"));var m=b.type;var n=this.get_icon(b);b.type=c;(!0===n||!h[m]||h[m].icon!==B&&n===h[m].icon)&&this.set_icon(b,h[c].icon!==B?h[c].icon:!0);if(h[m]&&h[m].li_attr!==B&&"object"===typeof h[m].li_attr)for(g in h[m].li_attr)h[m].li_attr.hasOwnProperty(g)&&"id"!==g&&("class"===g?(e[b.id].li_attr["class"]=(e[b.id].li_attr["class"]||"").replace(h[m].li_attr[g],""),k&&k.removeClass(h[m].li_attr[g])):e[b.id].li_attr[g]===h[m].li_attr[g]&&(e[b.id].li_attr[g]=null,
k&&k.removeAttr(g)));if(h[m]&&h[m].a_attr!==B&&"object"===typeof h[m].a_attr)for(g in h[m].a_attr)h[m].a_attr.hasOwnProperty(g)&&"id"!==g&&("class"===g?(e[b.id].a_attr["class"]=(e[b.id].a_attr["class"]||"").replace(h[m].a_attr[g],""),l&&l.removeClass(h[m].a_attr[g])):e[b.id].a_attr[g]===h[m].a_attr[g]&&("href"===g?(e[b.id].a_attr[g]="#",l&&l.attr("href","#")):(delete e[b.id].a_attr[g],l&&l.removeAttr(g))));if(h[c].li_attr!==B&&"object"===typeof h[c].li_attr)for(g in h[c].li_attr)h[c].li_attr.hasOwnProperty(g)&&
"id"!==g&&(e[b.id].li_attr[g]===B?(e[b.id].li_attr[g]=h[c].li_attr[g],k&&("class"===g?k.addClass(h[c].li_attr[g]):k.attr(g,h[c].li_attr[g]))):"class"===g&&(e[b.id].li_attr["class"]=h[c].li_attr[g]+" "+e[b.id].li_attr["class"],k&&k.addClass(h[c].li_attr[g])));if(h[c].a_attr!==B&&"object"===typeof h[c].a_attr)for(g in h[c].a_attr)h[c].a_attr.hasOwnProperty(g)&&"id"!==g&&(e[b.id].a_attr[g]===B?(e[b.id].a_attr[g]=h[c].a_attr[g],l&&("class"===g?l.addClass(h[c].a_attr[g]):l.attr(g,h[c].a_attr[g]))):"href"===
...
if(!e||!e.children)return!0;var k="rename_node"===b?h:c.text,l=[],m=this.settings.unique.case_sensitive,n=this.settings.unique.trim_whitespace,r=this._model.data,u;var v=0;for(u=e.children.length;v<u;v++){var y=r[e.children[v]].text;m||(y=y.toLowerCase());n&&(y=y.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));l.push(y)}m||(k=k.toLowerCase());n&&(k=k.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));switch(b){case "rename_node":return y=c.text||"",m||(y=y.toLowerCase()),n&&(y=y.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
...
b,data:JSON.stringify({chk:b,pos:h,obj:c&&c.id?c.id:!1,par:e&&e.id?e.id:!1})}),v}return!0};this.create_node=function(b,c,e,h,g){if(!c||c.text===B){null===b&&(b=f.jstree.root);b=this.get_node(b);if(!b)return d.create_node.call(this,b,c,e,h,g);e=e===B?"last":e;if(!e.toString().match(/^(before|after)$/)&&!g&&!this.is_loaded(b))return d.create_node.call(this,b,c,e,h,g);c||(c={});var k,l,m=this._model.data,n=this.settings.unique.case_sensitive,r=this.settings.unique.trim_whitespace,u=this.settings.unique.duplicate;
var v=k=this.get_string("New node");var y=[];var p=0;for(l=b.children.length;p<l;p++){var D=m[b.children[p]].text;n||(D=D.toLowerCase());r&&(D=D.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));y.push(D)}p=1;D=v;n||(D=D.toLowerCase());for(r&&(D=D.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));-1!==f.inArray(D,y);)D=v=u.call(this,k,++p).toString(),n||(D=D.toLowerCase()),r&&(D=D.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""));c.text=v}return d.create_node.call(this,b,c,e,h,g)}};var V=x.createElement("DIV");
...
if(window.customElements&&Object&&Object.create){A=Object.create(HTMLElement.prototype);A.createdCallback=function(){var a={core:{},plugins:[]},d;for(d in f.jstree.plugins)f.jstree.plugins.hasOwnProperty(d)&&this.attributes[d]&&(a.plugins.push(d),this.getAttribute(d)&&JSON.parse(this.getAttribute(d))&&(a[d]=JSON.parse(this.getAttribute(d))));for(d in f.jstree.defaults.core)f.jstree.defaults.core.hasOwnProperty(d)&&this.attributes[d]&&(a.core[d]=JSON.parse(this.getAttribute(d))||this.getAttribute(d));
f(this).jstree(a)};try{window.customElements.define("vakata-jstree",function(){},{prototype:A})}catch(a){}}}});
(function(f,B){var I=0;f.widget("s3.hierarchicalopts",{options:{selected:null,multiple:!0,leafonly:!0,cascade:!1,bulkSelect:!1,cascadeOptionInTree:!0,noneSelectedText:"Select",selectedText:"selected",noOptionsText:"No options available",selectAllText:"Select All",deselectAllText:"Deselect All",icons:!1,sep:null,stripes:!0,htmlTitles:!0},_create:function(){var t=f(this.element),q=this.options;this.id=I;I+=1;this._namespace=".hierarchicalopts"+I;this.treeID=t.attr("id")+"-tree";this.input=t.find(".s3-hierarchy-input").first();
this.input.data("input",!0);var z=q.selected;z&&this.input.val(this._stringifySelection(z));this.button=f('<button type="button" class="s3-hierarchy-button ui-multiselect ui-widget ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></button>');this.buttonText=f("<span>"+q.noneSelectedText+"</span>").appendTo(this.button);this.noopts=f('<span class="no-options-available">'+q.noOptionsText+"</span>").hide();this.tree=t.find(".s3-hierarchy-tree").first();this.wrapper=this.tree.closest(".s3-hierarchy-wrapper").hide().before(this.noopts).before(this.button).detach().appendTo("body");
this.manualCascadeOption=this._isBulk=this._isOpen=!1},_init:function(){this.refresh()},_destroy:function(){f.Widget.prototype.destroy.call(this);this._unbindEvents();f(this.button).remove();f(this.noopts).remove();f(this.tree).detach().appendTo(this.element).show()},refresh:function(){this._unbindEvents();var t=this.options,q=this.tree,z=this;if(q.find("li").length){this.noopts.hide();this.button.attr("style","");this.input.next(".error_wrapper").insertAfter(this.button).one("click",function(){f(this).fadeOut()});
var w=this.input.val();if(w){w=this._parseSelection(w);var A=this.treeID;f.each(w,function(){f("#"+A+"-"+this).data("jstree",{selected:!0})})}w=q.find("> ul > li");if(1==w.length){w=w.first();var x=w.data("jstree");w.data("jstree",f.extend({},x,{opened:!0}))}w=t.multiple;x=t.leafonly;var F=t.cascade,M=!1,H=null,N=["sort","checkbox"];this.input.data("multiple",w);(F||x)&&w?M=!0:w&&(t.cascadeOptionInTree?this.manualCascadeOption=!0:(H=function(S){return q.jstree("is_parent",S)?(f.vakata.context.settings.icons=
!1,{select_all:{label:z.options.selectAllText,icon:!1,action:function(V){z._selectBranch(S)}},deselect_all:{label:z.options.deselectAllText,icon:!1,action:function(V){z._deselectBranch(S)}}}):null},N.push("contextmenu")));q.jstree({core:{themes:{icons:t.icons,stripes:t.stripes},animation:100,multiple:w,check_callback:!0},checkbox:{three_state:M},sort:function(S,V){var a=this.get_text(S)>this.get_text(V)?1:-1;try{var d=this.get_node(S).li_attr.rel}catch(c){d=null}try{var b=this.get_node(V).li_attr.rel}catch(c){b=
null}return"bulk"==d?-1:"bulk"==b?1:"none"==d?-1:"none"==b?1:a},contextmenu:{items:H,select_node:!1,icons:!1},plugins:N});var Q=jQuery.jstree.reference(q);w&&((t.bulkSelect||this.manualCascadeOption)&&t.cascadeOptionInTree?(this.wrapper.find(".s3-hierarchy-header").hide(),Q.create_node("#",{id:this.treeID+"-select-all",text:t.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first")):this.wrapper.find(".s3-hierarchy-header").removeClass("hide").show());q.on("ready.jstree",function(){var S=
Q.get_checked();z._updateButtonText(S)});this._bindEvents()}else this.button.attr("style","display:none!important"),this.noopts.show()},reload:function(t){var q=this;t+="?widget_id="+f(this.element).attr("id");this.tree.jstree("destroy");this.input.val("");f.getS3(t,function(z){q.tree.html(z);q.refresh()},"html")},_setOption:function(t,q){if("selected"===t){var z=jQuery.jstree.reference(f(this.tree));if(z&&(z.uncheck_all(),q)){this.input.val(this._stringifySelection(q));var w=this.treeID;f.each(q,
function(){z.check_node("#"+w+"-"+this)});this._updateButtonText(q)}}this._super(t,q)},_updateSelectedNodes:function(){var t=jQuery.jstree.reference(f(this.tree)),q=this._parseSelection(this.input.val()),z=[],w=[],A=this.options.leafonly,x=t.get_checked(!0);f(x).each(function(){var M=f(this).attr("id");if("bulk"!=f(this).attr("rel")&&M&&(!A||t.is_leaf(this))){var H=M.split("-").pop();"None"!=H&&(H=parseInt(H));H&&(z.push(H),w.push(M))}});x=!1;var F=f(z).not(q).get();F.length?x=!0:(F=f(q).not(z).get(),
F.length&&(x=!0));q=this.input.val(this._stringifySelection(z));this._updateButtonText(w);x&&(q.change(),f(this.element).trigger("select.s3hierarchy"));return!0},_updateButtonText:function(t){var q=this.options,z=0;t&&(z=t.length);if(z)if(1<z)t=q.selectedText.replace("#",z);else{for(var w=jQuery.jstree.reference(f(this.tree)),A=[],x,F,M=q.sep,H=0;H<z;H++){if(M)for(F=t[H],x=f("#"+F+" > a").text().replace(/^\s+|\s+$/g,""),F=w.get_parent(F);"#"!=F;)x=f("#"+F+" > a").text().replace(/^\s+|\s+$/g,"")+M+
x,F=w.get_parent(F);else x=f("#"+t[H]+" > a").text().replace(/^\s+|\s+$/g,"");A.push(x)}t=A.length?A.join(" "):q.noneSelectedText}else t=q.noneSelectedText;this.buttonText.text(t)},_updateAndClose:function(){if(!this._isBulk){this._updateSelectedNodes();var t=this.wrapper,q=this;if(q.options.multiple)t.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",function(){window.setTimeout(function(){q.closeMenu()},100)});else window.setTimeout(function(){q.closeMenu()},100)}},_selectNode:function(t){var q=
this.options,z=jQuery.jstree.reference(f(this.tree)),w=q.multiple,A=q.leafonly;if(w)this._isBulk||"bulk"!=t.li_attr.rel||((q=z.get_parent(t))&&"#"!=q?(q=z.get_node(q),this._selectBranch(q,!0)):z.select_all());else{var x=t.id;f(z.get_checked(!0)).each(function(){x==this.id||A&&!z.is_leaf(this)||z.uncheck_node(this)})}if(A&&!w&&!z.is_leaf(t))return z.deselect_node(t),!1;this._updateAndClose()},_deselectNode:function(t){var q=jQuery.jstree.reference(f(this.tree));if(!this._isBulk){if("bulk"==t.li_attr.rel)(t=
q.get_parent(t))&&"#"!=t?(t=q.get_node(t),this._deselectBranch(t,!0)):q.deselect_all();else if(t=q.get_parent(t))if(t=q.get_node(t+"-select-all"))this._isBulk=!0,q.uncheck_node(t),this._isBulk=!1;if(t=q.get_node(this.treeID+"-select-all"))this._isBulk=!0,q.uncheck_node(t),this._isBulk=!1}this._updateSelectedNodes()},_openNode:function(t){var q=jQuery.jstree.reference(f(this.tree)),z=q.get_parent(t);z.length&&q.open_node(z,!1,!0);if(this.manualCascadeOption){var w=t.id;z=q.get_node(w+"-select-all");
z||(t=q.create_node(t,{id:w+"-select-all",text:this.options.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first"),z=q.get_node(t));(t=q.get_node(this.treeID+"-select-all"))&&q.is_checked(t)&&(this._isBulk=!0,q.check_node(z),this._isBulk=!1)}},_selectBranch:function(t,q){var z=jQuery.jstree.reference(f(this.tree)),w=this;this._isBulk=!0;z.open_node(t,function(){var A=z.get_children_dom(t);f(A).each(function(){w._selectBranch(this)});q||z.check_node(t)});this._isBulk=!1;this._updateAndClose()},
_deselectBranch:function(t,q){var z=jQuery.jstree.reference(f(this.tree)),w=this;this._isBulk=!0;z.open_node(t,function(){var A=z.get_children_dom(t);f(A).each(function(){w._deselectBranch(this)});q||z.uncheck_node(t)});this._isBulk=!1;this._updateSelectedNodes()},set:function(t){var q=jQuery.jstree.reference(f(this.tree)),z=this.treeID;this._isBulk=!0;q.uncheck_all();q.close_all();if(t){var w=function(A,x){if(A=q.get_parent(A))"#"!=A?(w(A),q.open_node(A,x)):x&&x()};t.forEach(function(A){var x=q.get_node(z+
"-"+A);x&&w(x,function(){q.check_node(x)})})}this._isBulk=!1;this._updateSelectedNodes()},get:function(){return this._parseSelection(this.input.val())},reset:function(){var t=jQuery.jstree.reference(f(this.tree));this._isBulk=!0;t.uncheck_all();t.close_all();this._isBulk=!1;this._updateSelectedNodes();return!0},_setMenuPosition:function(t,q){var z=q.offset(),w={position:"absolute",top:z.top+q.outerHeight(),minWidth:q.outerWidth()-8};"rtl"===f("body").css("direction")?w.right=f(window).width()-(z.left+
q.outerWidth()):w.left=z.left;t.css(w)},openMenu:function(){this._isOpen&&this.closeMenu();var t=f(this.button),q=f(this.wrapper),z=this;this._setMenuPosition(q,t);f(window).on("resize"+this._namespace+"-mpos",function(){z._setMenuPosition(q,t)});q.show();f(this.tree).jstree("set_focus");this._isOpen=!0;t.addClass("ui-state-active");f(this).trigger("open")},closeMenu:function(){f(window).off(this._namespace+"-mpos");f(this.tree).jstree("unset_focus").unbind("click.hierarchicalopts").unbind("mouseleave.hierarchicalopts");
f(this.wrapper).fadeOut(50);this._isOpen=!1;f(this.button).removeClass("ui-state-active");f(this).trigger("close")},addNode:function(t,q,z,w){var A=this.tree,x=this.treeID;q=x+"-"+q;if(jQuery.jstree.reference(A)){var F="#";t&&(F=f("#"+x+"-"+t+"_anchor"),F.length||(F="#"));A.jstree("create_node",F,{id:q,text:z,li_attr:{rel:"leaf"}},"last");t&&(F.attr({rel:"parent"}),A.jstree("open_node",F))}else t='<li rel="leaf" class="s3-hierarchy-node" id="'+q+'">'+z+"</li>",f("#"+x).append(t),this.refresh();w&&
A.jstree("check_node",f("#"+q))},_parseSelection:function(t){if(t)t=JSON.parse(t);else return[];t?t.constructor!==Array&&(t=[t]):t=[];return t},_stringifySelection:function(t){if(!this.options.multiple)if(t.length)t=t[0];else return"";return JSON.stringify(t)},_bindEvents:function(){var t=this,q=f(this.wrapper),z=f(this.tree),w=f(this.button),A=this._namespace,x=this.options,F=jQuery.jstree.reference(z),M=f.vakata.context.settings.icons;f(document).bind("context_show.vakata",function(){q.unbind("mouseleave.hierarchicalopts");
f.vakata.context.settings.icons=M});z.bind("select_node.jstree",function(H,N){t._selectNode(N.node)}).bind("deselect_node.jstree",function(H,N){t._deselectNode(N.node)}).bind("open_node.jstree",function(H,N){t._openNode(N.node)});w.bind("click"+A,function(){t._isOpen?t.closeMenu():t.openMenu()}).bind("keyup"+A,function(H){H.preventDefault();switch(H.keyCode){case 27:case 38:case 37:t.closeMenu();break;case 39:case 40:t.openMenu()}}).bind("mouseenter"+A,function(){w.hasClass("ui-state-disabled")||
f(this).addClass("ui-state-hover")}).bind("mouseleave"+A,function(){f(this).removeClass("ui-state-hover")}).bind("focus"+A,function(){w.hasClass("ui-state-disabled")||f(this).addClass("ui-state-focus")}).bind("blur"+A,function(){f(this).removeClass("ui-state-focus")});x.multiple&&x.bulkSelect&&!x.cascadeOptionInTree&&(q.find(".s3-hierarchy-select-all").bind("click"+A,function(H){H.preventDefault();F.select_all();t._updateSelectedNodes()}),q.find(".s3-hierarchy-deselect-all").bind("click"+A,function(H){H.preventDefault();
F.deselect_all();t._updateSelectedNodes()}),q.find(".s3-hierarchy-header").bind("click"+A,function(H){H.preventDefault();H.stopPropagation()}).bind("mousedown"+A,function(H){H.preventDefault();H.stopPropagation()}));f(document).bind("mousedown"+A,function(H){var N=H.target;if(f(".jstree-contextmenu").has(N).length||3==H.which)return q.unbind("mouseleave.hierarchicalopts"),!0;z.is(N)||w.is(N)||0!==z.has(N).length||0!==w.has(N).length||t.closeMenu()});return!0},_unbindEvents:function(){var t=f(this.tree);
f(this.button);var q=this._namespace;t.unbind("select_node.jstree").unbind("deselect_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");f(this.button).unbind(q);f(document).unbind(q);return!0}})})(jQuery);
(function(f,B){var I=0;f.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,deleteRoot:!0,addTitle:"Add Record",addLabel:"Add",addURL:null,icons:!1,stripes:!0,htmlTitles:!0},_create:function(){this.treeID=f(this.element).attr("id")+"-tree";this.id=I;I+=1},_init:function(){this.tree=f(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){f.Widget.prototype.destroy.call(this)},
refresh:function(){var t=this.tree,q=this.options;this._unbindEvents();var z=t.find("> ul > li");if(1==z.length){z=z.first();var w=z.data("jstree");z.data("jstree",f.extend({},w,{opened:!0}))}var A=this;t.jstree({core:{themes:{icons:q.icons,stripes:q.stripes},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(x){var F=!0;"#"==t.jstree(!0).get_parent(x)&&(F=q.deleteRoot);var M={};q.openURL&&(M.open={label:q.openLabel,action:function(H){A._openNode(x)},separator_after:!0});q.editURL&&
(M.edit={label:q.editLabel,action:function(H){A._editNode(x)}});F&&q.deleteURL&&(M.delete={label:q.deleteLabel,separator_after:!0,action:function(H){A._deleteNode(x)}});q.addURL&&(M.add={label:q.addLabel,action:function(H){A._addNode(x)}});return M},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},reload:function(){var t=this.options.ajaxURL.replace("json","tree"),q=this;f.getS3(t,function(z){q.tree.html(z);q.refresh()},"html")},_openNode:function(t){var q=this.options.openURL;
t=t.id;q&&t&&(t=parseInt(t.split("-").pop()))&&(q=q.replace("[id]",t).replace("%5Bid%5D",t),window.location.href=q)},refreshNode:function(t){var q=this.options.ajaxURL,z=t.attr("id");if(q&&z&&(z=parseInt(z.split("-").pop()))){var w=this.tree,A=this.treeID;f.getJSONS3(q+"?node="+z,function(x){x.label&&w.jstree("rename_node",t,x.label);if(x=x.children){w.jstree("open_node",t,!1,!1);for(var F,M,H,N=0,Q=0,S=x.length;Q<S;Q++)F=x[Q],M=A+"-"+F.node,(H=w.jstree("get_node","#"+M,!0))?w.jstree("rename_node",
H,F.label):(w.jstree("create_node",t,{id:M,text:F.label,li_attr:{rel:"leaf"}}),N++);N&&(w.jstree("open_node",t),t.attr({rel:"parent"}))}})}},_editNode:function(t){var q=this.options.editURL;t=t.id;if(q&&t){var z=parseInt(t.split("-").pop());z&&(q=q.replace("[id]",z).replace("%5Bid%5D",z).split("?")[0],q+="?node="+t+"&hierarchy="+this.options.widgetID,t=S3.uid(),q=f('<iframe id="'+t+'" src='+q+" onload=\"S3.popup_loaded('"+t+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),
this._openPopup(q,this.options.editTitle))}},_addNode:function(t){var q=this.options.addURL;t=t.id;if(q&&t){var z=parseInt(t.split("-").pop());z&&(q=q.split("?")[0],q+="?node="+t+"&link_to_parent="+z+"&hierarchy="+this.options.widgetID,t=S3.uid(),q=f('<iframe id="'+t+'" src='+q+" onload=\"S3.popup_loaded('"+t+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(q,this.options.addTitle))}},_deleteNode:function(t){if(!confirm(i18n.delete_confirmation))return!1;
var q=this.options.deleteURL,z=t.id,w=this.tree;q&&z&&(z=parseInt(z.split("-").pop()))&&(q=q.replace("[id]",z).replace("%5Bid%5D",z).split("?")[0],f.ajaxS3({type:"POST",url:q+"?recursive=1",data:{},dataType:"JSON",success:function(A){w.jstree("delete_node",t)},error:function(A,x,F){x=A.responseText;if("{"==x[0])try{x=JSON.parse(A.responseText),S3.showAlert(x.message,"error")}catch(M){}}}))},_openPopup:function(t,q){t.dialog({close:function(z,w){if(self.parent){var A=self.parent.$("iframe.ui-dialog-content"),
x=A.width();A.width(0);window.setTimeout(function(){A.width(x)},300)}t.remove()},minHeight:480,modal:!0,open:function(z,w){f(".ui-widget-overlay").bind("click",function(){t.dialog("close")})},title:q,minWidth:320,closeText:""})},_bindEvents:function(){return!0},_unbindEvents:function(){this.tree.jstree("destroy","true");return!0}})})(jQuery);
