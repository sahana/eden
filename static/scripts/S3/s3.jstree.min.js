...
*/
(function(){if(!jQuery||!jQuery.jstree){var q=!1,t=!1,s=!1;(function(b){b.vakata={};b.vakata.css={get_css:function(a,b,c){a=a.toLowerCase();var e=c.cssRules||c.rules,d=0;do{if(e.length&&d>e.length+5)break;if(e[d].selectorText&&e[d].selectorText.toLowerCase()==a)return!0===b?(c.removeRule&&c.removeRule(d),c.deleteRule&&c.deleteRule(d),!0):e[d]}while(e[++d]);return!1},add_css:function(a,c){if(b.jstree.css.get_css(a,!1,c))return!1;c.insertRule?c.insertRule(a+" { }",0):c.addRule(a,null,0);return b.vakata.css.get_css(a)},
...
c=c&&b.isFunction(c[f])?c[f].apply(c,e):c;if("undefined"!==typeof c&&(0===f.indexOf("is_")||!0!==c&&!1!==c))return h=c,!1})}else this.each(function(){var c=b.data(this,"jstree_instance_id"),g=[],h=f?b.extend({},!0,f):{},n=b(this),r=!1,u=[],g=g.concat(e);n.data("jstree")&&g.push(n.data("jstree"));h=g.length?b.extend.apply(null,[!0,h].concat(g)):h;"undefined"!==typeof c&&a[c]&&a[c].destroy();c=parseInt(a.push({}),10)-1;b.data(this,"jstree_instance_id",c);h.plugins=b.isArray(h.plugins)?h.plugins:b.jstree.defaults.plugins.slice();
h.plugins.unshift("core");h.plugins=h.plugins.sort().join(",,").replace(/(,|^)([^,]+)(,,\2)+(,|$)/g,"$1$2$4").replace(/,,+/g,",").replace(/,$/,"").split(",");r=b.extend(!0,{},b.jstree.defaults,h);r.plugins=h.plugins;b.each(d,function(a,f){-1===b.inArray(a,r.plugins)?(r[a]=null,delete r[a]):u.push(a)});r.plugins=u;a[c]=new b.jstree._instance(c,b(this).addClass("jstree jstree-"+c),r);b.each(a[c]._get_settings().plugins,function(b,f){a[c].data[f]={}});b.each(a[c]._get_settings().plugins,function(b,f){d[f]&&
...
b.call(),!1;var e=c||q?0:this._get_settings().core.animation,d=this;this._is_loaded(a)?(this._get_settings().core.open_parents&&a.parentsUntil(".jstree",".jstree-closed").each(function(){d.open_node(this,!1,!0)}),e&&a.children("ul").css("display","none"),a.removeClass("jstree-closed").addClass("jstree-open").children("a").removeClass("jstree-loading"),e?a.children("ul").stop(!0,!0).slideDown(e,function(){this.style.display="";d.after_open(a)}):d.after_open(a),this.__callback({obj:a}),b&&b.call()):
(a.children("a").addClass("jstree-loading"),this.load_node(a,function(){d.open_node(a,b,c)},b))},after_open:function(a){this.__callback({obj:a})},close_node:function(a,b){a=this._get_node(a);var c=b||q?0:this._get_settings().core.animation,e=this;if(!a.length||!a.hasClass("jstree-open"))return!1;c&&a.children("ul").attr("style","display:block !important");a.removeClass("jstree-open").addClass("jstree-closed");c?a.children("ul").stop(!0,!0).slideUp(c,function(){this.style.display="";e.after_close(a)}):
...
(function(q,t){var s=0;q.widget("s3.hierarchicalopts",{options:{selected:null},_create:function(){var b=q(this.element);this.treeID=b.attr("id")+"-tree";this.input=b.find(".s3-hierarchy-input").first();this.tree=b.find(".s3-hierarchy-tree").first();this.id=s;s+=1},_init:function(){this.refresh()},_destroy:function(){},refresh:function(){this._unbindEvents();var b=[],a=this.options.selected;if(a)for(var c=this.treeID,d=0,e=a.length;d<e;d++)b.push(c+"-"+a[d]);q.jstree._themes=S3.Ap.concat("/static/styles/jstree/");
theme=(rtl="ltr"==q("body").css("direction")?!1:!0)?"default-rtl":"default";this.tree.jstree({core:{animation:100,rtl:rtl},themes:{theme:theme,icons:!1},ui:{initially_select:b},checkbox:{override_ui:!0},plugins:["themes","html_data","ui","checkbox","sort"]});this._bindEvents()},_updateSelectedNodes:function(b){b=this.input.val();var a=[];b=b?JSON.parse(b):[];var c=this.tree.jstree("get_checked",null,!0);q(c).each(function(){var b=q(this).attr("id");b&&(b=parseInt(b.split("-").pop()))&&a.push(b)});
var c=!1,d=q(a).not(b).get();d.length?c=!0:(d=q(b).not(a).get(),d.length&&(c=!0));this.input.val(JSON.stringify(a));c&&q(this.element).trigger("select.s3hierarchy");return!0},set:function(b){this.tree.jstree("uncheck_all");if(b)for(var a=0,c=b.length;a<c;a++)node=q("#"+this.treeID+"-"+b[a]),this.tree.jstree("check_node",node)},get:function(){var b=this.input.val();return b?JSON.parse(b):[]},reset:function(){this.tree.jstree("uncheck_all");this._updateSelectedNodes()},_bindEvents:function(){var b=
this;q(this.tree).bind("check_node.jstree",function(a,c){b._updateSelectedNodes()}).bind("uncheck_node.jstree",function(a,c){b._updateSelectedNodes()});return!0},_unbindEvents:function(){q(this.tree).unbind("check_node.jstree").unbind("uncheck_node.jstree");return!0}})})(jQuery);
