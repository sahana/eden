...
arguments);if(c&&a.checkbox){if(!this.settings.checkbox.tie_selection){this.uncheck_all();var g=this;d.each(a.checkbox,function(a,e){g.check_node(e)})}delete a.checkbox;return!1}return c}};var y=null,C,I;d.jstree.defaults.contextmenu={select_node:!0,show_at_node:!0,items:function(a,b){return{create:{separator_before:!1,separator_after:!0,_disabled:!1,label:"Create",action:function(a){var b=d.jstree.reference(a.reference);a=b.get_node(a.reference);b.create_node(a,{},"last",function(a){setTimeout(function(){b.edit(a)},
...
g.length?g:!1},_show_submenu:function(e){e=a(e);if(e.length&&e.children("ul").length){var c=e.children("ul"),d=e.offset().left+e.outerWidth(),f=e.offset().top,k=c.width(),g=c.height(),h=a(window).width()+a(window).scrollLeft(),m=a(window).height()+a(window).scrollTop();if(b)e[0>d-(k+10+e.outerWidth())?"addClass":"removeClass"]("vakata-context-left");else e[d+k+10>h?"addClass":"removeClass"]("vakata-context-right");f+g+10>m&&c.css("bottom","-1px");c.show()}},show:function(l,p,n){var q,t,v,B,w;e&&e.length&&
...
a.vakata.context.settings.hide_onmouseleave&&(c=setTimeout(function(e){return function(){a.vakata.context.hide()}}(this),a.vakata.context.settings.hide_onmouseleave))}).on("click","a",function(e){e.preventDefault();a(this).blur().parent().hasClass("vakata-context-disabled")||!1===a.vakata.context._execute(a(this).attr("rel"))||a.vakata.context.hide()}).on("keydown","a",function(c){var b;switch(c.which){case 13:case 32:c.type="mouseup";c.preventDefault();a(c.currentTarget).trigger(c);break;case 37:m&&
(e.find(".vakata-context-hover").last().closest("li").first().find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").focus(),c.stopImmediatePropagation(),c.preventDefault());break;case 38:m&&(b=e.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").prevAll("li:not(.vakata-context-separator)").first(),b.length||(b=e.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last()),
b.addClass("vakata-context-hover").children("a").focus(),c.stopImmediatePropagation(),c.preventDefault());break;case 39:m&&(e.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").focus(),c.stopImmediatePropagation(),c.preventDefault());break;case 40:m&&(b=e.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").nextAll("li:not(.vakata-context-separator)").first(),
b.length||(b=e.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").first()),b.addClass("vakata-context-hover").children("a").focus(),c.stopImmediatePropagation(),c.preventDefault());break;case 27:a.vakata.context.hide(),c.preventDefault()}}).on("keydown",function(a){a.preventDefault();a=e.find(".vakata-contextmenu-shortcut-"+a.which).parent();a.parent().not(".vakata-context-disabled")&&a.click()});a(document).on("mousedown.vakata.jstree",function(c){m&&!a.contains(e[0],
...
deselect_all:{label:y.options.deselectAllText,icon:!1,action:function(d){y._deselectBranch(h)}}}):null};w.push("contextmenu")}l.jstree({core:{themes:{name:"s3",icons:h.icons,stripes:h.stripes},animation:100,multiple:n,check_callback:!0},checkbox:{three_state:u},sort:function(d,h){var l=this.get_text(d)>this.get_text(h)?1:-1,n,a;try{n=this.get_node(d).li_attr.rel}catch(b){n=null}try{a=this.get_node(h).li_attr.rel}catch(b){a=null}return"bulk"==n?-1:"bulk"==a?1:"none"==n?-1:"none"==a?1:l},contextmenu:{items:z,
select_node:!1,icons:!1},plugins:w});t=jQuery.jstree.reference(l);n&&((h.bulkSelect||this.manualCascadeOption)&&h.cascadeOptionInTree?(this.wrapper.find(".s3-hierarchy-header").hide(),t.create_node("#",{id:this.treeID+"-select-all",text:h.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first")):this.wrapper.find(".s3-hierarchy-header").removeClass("hide").show());h=t.get_checked();this._updateButtonText(h);this._bindEvents()}else this.button.hide(),this.noopts.show()},_updateSelectedNodes:function(){var h=
jQuery.jstree.reference(d(this.tree)),l=this.input.val(),l=l?JSON.parse(l):[],n=[],q=[],t=this.options.leafonly,v=h.get_checked(!0);d(v).each(function(){var l=d(this).attr("id");if("bulk"!=d(this).attr("rel")&&l&&(!t||h.is_leaf(this))){var v=l.split("-").pop();"None"!=v&&(v=parseInt(v));v&&(n.push(v),q.push(l))}});var v=!1,u=d(n).not(l).get();u.length?v=!0:(u=d(l).not(n).get(),u.length&&(v=!0));this.input.val(JSON.stringify(n));this._updateButtonText(q);v&&(this.input.change(),d(this.element).trigger("select.s3hierarchy"));
return!0},_updateButtonText:function(h){var l=this.options,n=0;h&&(n=h.length);if(n)if(1<n)h=l.selectedText.replace("#",n);else{for(var q=[],t=0;t<n;t++)q.push(d("#"+h[t]+" > a").text().replace(/^\s+|\s+$/g,""));h=q.length?q.join(" "):l.noneSelectedText}else h=l.noneSelectedText;this.buttonText.text(h)},_updateAndClose:function(){if(!this._isBulk){this._updateSelectedNodes();var d=this.wrapper,l=this;if(l.options.multiple)d.unbind("mouseleave.hierarchicalopts").one("mouseleave.hierarchicalopts",function(){window.setTimeout(function(){l.closeMenu()},
100)});else window.setTimeout(function(){l.closeMenu()},100)}},_selectNode:function(h){var l=this.options,n=jQuery.jstree.reference(d(this.tree)),q=l.multiple,t=l.leafonly;if(q)this._isBulk||"bulk"!=h.li_attr.rel||((l=n.get_parent(h))&&"#"!=l?(l=n.get_node(l),this._selectBranch(l,!0)):n.select_all());else{var v=h.id;d(n.get_checked(!0)).each(function(){v!=this.id&&(t&&!n.is_leaf(this)||n.uncheck_node(this))})}if(t&&!q&&!n.is_leaf(h))return n.deselect_node(h),!1;this._updateAndClose()},_deselectNode:function(h){var l=
...
!1,!0);if(this.manualCascadeOption){var q=h.id,n=l.get_node(q+"-select-all");n||(h=l.create_node(h,{id:q+"-select-all",text:this.options.selectAllText,li_attr:{rel:"bulk","class":"s3-hierarchy-action-node"}},"first"),n=l.get_node(h));(h=l.get_node(this.treeID+"-select-all"))&&l.is_checked(h)&&(this._isBulk=!0,l.check_node(n),this._isBulk=!1)}},_selectBranch:function(h,l){var n=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;n.open_node(h,function(){var t=n.get_children_dom(h);d(t).each(function(){q._selectBranch(this)});
l||n.check_node(h)});this._isBulk=!1;this._updateAndClose()},_deselectBranch:function(h,l){var n=jQuery.jstree.reference(d(this.tree)),q=this;this._isBulk=!0;n.open_node(h,function(){var t=n.get_children_dom(h);d(t).each(function(){q._deselectBranch(this)});l||n.uncheck_node(h)});this._isBulk=!1;this._updateSelectedNodes()},set:function(h){var l=jQuery.jstree.reference(d(this.tree));l.uncheck_all();if(h)for(var n=0,q=h.length,t;n<q;n++)t=d("#"+this.treeID+"-"+h[n]),l.check_node(t)},get:function(){var d=
...
d(this.wrapper).fadeOut(50);this._isOpen=!1;d(this.button).removeClass("ui-state-active");d(this).trigger("close")},addNode:function(h,l,n,q){var t=this.tree,v=this.treeID,u="#";h&&(u=d("#"+v+"-"+h),u.length||(u="#"));l=v+"-"+l;t.jstree("create_node",u,{id:l,text:n,li_attr:{rel:"leaf"}},"last");h&&(u.attr({rel:"parent"}),t.jstree("open_node",u));q&&t.jstree("check_node",d("#"+l))},_bindEvents:function(){var h=this,l=d(this.wrapper),n=d(this.tree),q=d(this.button),t=this._namespace,v=this.options,
u=jQuery.jstree.reference(n),z=d.vakata.context.settings.icons;d(document).bind("context_show.vakata",function(){l.unbind("mouseleave.hierarchicalopts");d.vakata.context.settings.icons=z});n.bind("select_node.jstree",function(d,l){h._selectNode(l.node)}).bind("deselect_node.jstree",function(d,l){h._deselectNode(l.node)}).bind("open_node.jstree",function(d,l){h._openNode(l.node)});q.bind("click"+t,function(){h._isOpen?h.closeMenu():h.openMenu()}).bind("keyup"+t,function(d){d.preventDefault();switch(d.keyCode){case 27:case 38:case 37:h.closeMenu();
break;case 39:case 40:h.openMenu()}}).bind("mouseenter"+t,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-hover")}).bind("mouseleave"+t,function(){d(this).removeClass("ui-state-hover")}).bind("focus"+t,function(){q.hasClass("ui-state-disabled")||d(this).addClass("ui-state-focus")}).bind("blur"+t,function(){d(this).removeClass("ui-state-focus")});v.multiple&&v.bulkSelect&&!v.cascadeOptionInTree&&(l.find(".s3-hierarchy-select-all").bind("click"+t,function(d){d.preventDefault();
u.select_all();h._updateSelectedNodes()}),l.find(".s3-hierarchy-deselect-all").bind("click"+t,function(d){d.preventDefault();u.deselect_all();h._updateSelectedNodes()}),l.find(".s3-hierarchy-header").bind("click"+t,function(d){d.preventDefault();d.stopPropagation()}).bind("mousedown"+t,function(d){d.preventDefault();d.stopPropagation()}));d(document).bind("mousedown"+t,function(t){var v=t.target;if(d(".jstree-contextmenu").has(v).length||3==t.which)return l.unbind("mouseleave.hierarchicalopts"),!0;
n.is(v)||q.is(v)||0!==n.has(v).length||0!==q.has(v).length||h.closeMenu()});return!0},_unbindEvents:function(){var h=d(this.tree);d(this.button);var l=this._namespace;h.unbind("select_node.jstree").unbind("deselect_node.jstree").unbind("loaded.jstree").unbind("open_node.jstree");d(this.button).unbind(l);d(document).unbind(l);return!0}})})(jQuery);
(function(d,u){var E=0;d.widget("s3.hierarchicalcrud",{options:{widgetID:null,ajaxURL:null,openLabel:"Open",openURL:null,editTitle:"Edit Record",editLabel:"Edit",editURL:null,deleteLabel:"Delete",deleteURL:null,addTitle:"Add Record",addLabel:"Add",addURL:null,icons:!1,stripes:!0,htmlTitles:!0},_create:function(){this.treeID=d(this.element).attr("id")+"-tree";this.id=E;E+=1},_init:function(){this.tree=d(this.element).find(".s3-hierarchy-tree");this.refresh()},_destroy:function(){d.Widget.prototype.destroy.call(this)},
refresh:function(){var h=this.tree,l=this.options;this._unbindEvents();var n=h.find("> ul > li");if(1==n.length){var n=n.first(),q=n.data("jstree");n.data("jstree",d.extend({},q,{opened:!0}))}var t=this;h.jstree({core:{themes:{name:"s3",icons:l.icons,stripes:l.stripes},animation:100,multiple:!1,check_callback:!0},contextmenu:{items:function(d){return{open:{label:t.options.openLabel,action:function(h){t._openNode(d)},separator_after:!0},edit:{label:t.options.editLabel,action:function(h){t._editNode(d)}},
"delete":{label:t.options.deleteLabel,separator_after:!0,action:function(h){t._deleteNode(d)}},add:{label:t.options.addLabel,action:function(h){t._addNode(d)}}}},select_node:!0},plugins:["sort","contextmenu"]});this._bindEvents()},_openNode:function(d){var l=this.options.openURL;d=d.id;l&&d&&(d=parseInt(d.split("-").pop()))&&(l=l.replace("[id]",d).replace("%5Bid%5D",d),window.location.href=l)},refreshNode:function(h){var l=this.options.ajaxURL,n=h.attr("id");if(l&&n&&(n=parseInt(n.split("-").pop()))){var q=
this.tree,t=this.treeID;d.getJSONS3(l+"?node="+n,function(d){d.label&&q.jstree("rename_node",h,d.label);if(d=d.children){q.jstree("open_node",h,!1,!1);for(var l,n,u,y=0,C=0,E=d.length;C<E;C++)l=d[C],n=t+"-"+l.node,(u=q.jstree("get_node","#"+n,!0))?q.jstree("rename_node",u,l.label):(q.jstree("create_node",h,{id:n,text:l.label,li_attr:{rel:"leaf"}}),y++);y&&(q.jstree("open_node",h),h.attr({rel:"parent"}))}})}},_editNode:function(h){var l=this.options.editURL;h=h.id;if(l&&h){var n=parseInt(h.split("-").pop());
...
this.options.widgetID,h=S3.uid(),l=d('<iframe id="'+h+'" src='+l+" onload=\"S3.popup_loaded('"+h+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>').appendTo("body"),this._openPopup(l,this.options.addTitle))}},_deleteNode:function(h){if(!confirm(i18n.delete_confirmation))return!1;var l=this.options.deleteURL,n=h.id,q=this.tree;l&&n&&(n=parseInt(n.split("-").pop()))&&(l=l.replace("[id]",n).replace("%5Bid%5D",n).split("?")[0],d.ajaxS3({type:"POST",url:l+"?recursive=1",
data:{},dataType:"JSON",success:function(d){q.jstree("delete_node",h)},error:function(d,h,l){h=d.responseText;if("{"==h[0])try{h=JSON.parse(d.responseText),S3.showAlert(h.message,"error")}catch(n){}}}))},_openPopup:function(h,l){h.dialog({close:function(d,l){if(self.parent){var t=self.parent.$("iframe.ui-dialog-content"),u=t.width();t.width(0);window.setTimeout(function(){t.width(u)},300)}h.remove()},minHeight:480,modal:!0,open:function(l,q){d(".ui-widget-overlay").bind("click",function(){h.dialog("close")})},
