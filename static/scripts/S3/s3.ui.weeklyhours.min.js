...
refresh:function(){var a=this.element;this._unbindEvents();this._deserialize(!1);var c=this._renderRaster();a.hide().after(c);this._bindEvents()},_serialize:function(){var a=f(this.element),c=this.hoursMatrix.getRules();c.length?a.val(JSON.stringify(c)):a.val("")},_deserialize:function(a){var c=f(this.element).val(),b=[];if(c)try{b=JSON.parse(c)}catch(d){}this.hoursMatrix=new h(b);a&&this._updateRaster()},_renderRaster:function(){var a=this.options,c=a.weekdays;a=a.firstDoW;for(var b=f("<table>").addClass("wa-raster").append(this._renderHeader()),
d=a;d<a+7;d++){var e=d%7;c.hasOwnProperty(e)&&b.append(this._renderRow(e))}return this.raster=b},_renderHeader:function(){var a=this.options,c=a.hours,b=0,d=23;c.constructor===Array&&2==c.length&&(b=c[0]-0,d=c[1]-0);for(c=f("<tr>").append(f("<td>"));b<d+1;b++){var e=b.toString();10>b&&(e="0"+e);e=f("<td>").addClass("wa-hour-header").text(e);var g=a.ticks;g&&0<b&&0===b%g&&e.addClass("wa-tick");c.append(e)}return f("<thead>").append(c)},_renderRow:function(a){var c=this.options,b=c.weekdays;b=f("<td>").addClass("wa-day").text(b[a]);
b=f("<tr>").append(b);var d=c.hours,e=0;c=23;d.constructor===Array&&2==d.length&&(e=d[0]-0,c=d[1]-0);for(d=e;d<c+1;d++)b.append(this._renderHour(a,d));return b},_renderHour:function(a,c){var b=this.options,d=this.hoursMatrix.isSelected(a,c);a=f("<td>").data({day:a,hour:c,selected:d}).addClass("wa-hour");if(b.icons){var e=f("<i>").addClass(b.icons);d?e.addClass(b.iconSelected):e.addClass(b.iconDeselected);a.append(e)}d?a.addClass("wa-on"):a.addClass("wa-off");(b=b.ticks)&&0<c&&0===c%b&&a.addClass("wa-tick");
return a},_updateRaster:function(){var a=this.hoursMatrix,c=this;f("td.wa-hour",this.raster).each(function(){var b=f(this),d=b.data("day"),e=b.data("hour");c._selectHour(b,a.isSelected(d,e))})},_selectHour:function(a,c){a=f(a);if(a.data("selected")!==c){a.data("selected",c);this.hoursMatrix.setSelected(a.data("day"),a.data("hour"),c);var b=this.options,d=f("i."+b.icons,a);c?(a.removeClass("wa-off").addClass("wa-on"),d.removeClass(b.iconDeselected).addClass(b.iconSelected)):(a.removeClass("wa-on").addClass("wa-off"),
d.removeClass(b.iconSelected).addClass(b.iconDeselected))}},_bindEvents:function(){var a=f(this.raster),c=this.eventNamespace,b=this;f(document).on("mouseup"+c+" touchend"+c,function(){a.off("mouseenter"+c);b._serialize()});a.on("mousedown"+c+" touchstart"+c,".wa-hour",function(d){d.preventDefault();d=f(this).focus();var e=d.hasClass("wa-off"),g=".wa-off";e||(g=".wa-on");b._selectHour(d,e);a.off("mouseenter"+c).on("mouseenter"+c,".wa-hour"+g,function(){b._selectHour(f(this),e)})});return!0},_unbindEvents:function(){var a=
f(this.raster),c=this.eventNamespace;f(document).off(c);a.off(c);return!0}})})(jQuery);
