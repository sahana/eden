...
a.setVisibility(k);a.events.on({featureselected:onGeojsonFeatureSelect,featureunselected:onFeatureUnselect,loadstart:showThrobber,loadend:hideThrobber});map.addLayer(a);S3.gis.layers_all.push(a)}
...
a.title=e;a.body=f;a.setVisibility(h);a.events.on({featureselected:onKmlFeatureSelect,featureunselected:onFeatureUnselect,loadstart:showThrobber,loadend:hideThrobber});map.addLayer(a);S3.gis.layers_all.push(a)}var s3_gis_scaleImage=function(){var a=S3.gis.image.height/S3.gis.image.width,b=Math.min(S3.gis.image.width,S3.gis.max_w),a=b*a;a>S3.gis.max_h&&(a=S3.gis.max_h,b*=b/a);S3.gis.image.height=a;S3.gis.image.width=b};
...
function addOWMLayers(){var a=S3.gis.OWM,b;a.station&&(b=new OpenLayers.Layer.Vector.OWMStations(a.station.name,{dir:a.station.dir,s3_layer_id:a.station.id,s3_layer_type:"openweathermap"}),b.setVisibility(a.station.visibility),b.events.on({featureselected:b.onSelect,featureunselected:b.onUnselect,loadstart:showThrobber,loadend:hideThrobber}),map.addLayer(b),S3.gis.layers_all.push(b));a.city&&(b=new OpenLayers.Layer.Vector.OWMWeather(a.city.name,{dir:a.city.dir,s3_layer_id:a.city.id,s3_layer_type:"openweathermap"}),
b.setVisibility(a.city.visibility),b.events.on({featureselected:b.onSelect,featureunselected:b.onUnselect,loadstart:showThrobber,loadend:hideThrobber}),map.addLayer(b),S3.gis.layers_all.push(b))}
...
protocol:c,styleMap:o});a.title=d;a.setVisibility(p);a.events.on({featureselected:onWfsFeatureSelect,featureunselected:onFeatureUnselect,loadstart:showThrobber,loadend:hideThrobber});map.addLayer(a);S3.gis.layers_all.push(a)}
