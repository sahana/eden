...
Math.min(a.attributes.count/2,8)+10:a.attributes.size?a.attributes.size:10},fill:function(a){return a.cluster?"#8087ff":a.attributes.colour?a.attributes.colour:"#f5902e"},stroke:function(a){return a.cluster?"#2b2f76":a.attributes.colour?a.attributes.colour:"#f5902e"},label:function(a){var b="";if(a.cluster&&a.attributes.count>1)b=a.attributes.count;return b}}}),j=new OpenLayers.StyleMap({"default":j,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}}),b=new OpenLayers.Layer.Vector(b,{projection:a,
strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:g*1E3}),new OpenLayers.Strategy.Cluster({distance:l,threshold:k})],styleMap:j,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_geojson})});b.setVisibility(h);b.events.on({featureselected:onGeojsonFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
