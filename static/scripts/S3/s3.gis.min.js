...
function addToolbar(){var a=new Ext.Toolbar({height:34}),b=new GeoExt.Action({control:new OpenLayers.Control.ZoomToMaxExtent,map:map,iconCls:"zoomfull",tooltip:i18n.gis_zoomfull}),c=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox({out:!0}),map:map,iconCls:"zoomout",tooltip:i18n.gis_zoomout,toggleGroup:"controls"}),d=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox,map:map,iconCls:"zoomin",tooltip:i18n.gis_zoomin,toggleGroup:"controls"}),e,f,g;"active"==S3.gis.draw_polygon?(e=!0,
g=f=!1):("active"==S3.gis.draw_feature?(g=!0,f=!1):(f=!0,g=!1),e=!1);S3.gis.panButton=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:map,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:f});a.add(b);navigator.geolocation&&addGeolocateControl(a);void 0===S3.gis.loc_select&&(a.add(c),a.add(d),a.add(S3.gis.panButton),a.addSeparator());void 0===S3.gis.loc_select&&addNavigationControl(a);void 0===S3.gis.loc_select&&S3.auth&&addSaveButton(a);a.addSeparator();
addMeasureControls(a);S3.gis.mgrs_url&&addPdfControl(a);if(S3.gis.draw_feature||S3.gis.draw_polygon)a.addSeparator(),S3.gis.draw_feature&&addPointControl(a,g),S3.gis.draw_polygon&&addPolygonControl(a,e,!0);i18n.gis_get_feature_info&&addWMSGetFeatureInfoControl(a);S3.gis.osm_oauth&&addPotlatchButton(a);S3.gis.Google&&S3.gis.Google.StreetviewButton&&addGoogleStreetviewControl(a);try{S3.gis.Google.Earth&&google&addGoogleEarthControl(a)}catch(h){}i18n.gis_search&&(b=Math.min(350,S3.gis.map_width-680),
...
{isBaseLayer:!0,displayInLayerSwitcher:!0,s3_layer_id:S3.gis.EmptyLayer.id,s3_layer_type:"empty"}),map.addLayer(a),S3.gis.EmptyLayer.base&&map.setBaseLayer(a));try{addJSLayers()}catch(d){}if(S3.gis.layers_theme){b=S3.gis.layers_theme;for(a=b.length;0<a;a--)addGeoJSONLayer(b[a-1])}if(S3.gis.layers_geojson){b=S3.gis.layers_geojson;for(a=b.length;0<a;a--)addGeoJSONLayer(b[a-1])}if(S3.gis.layers_gpx){b=S3.gis.layers_gpx;for(a=b.length;0<a;a--)addGPXLayer(b[a-1])}if(S3.gis.layers_arcrest){b=S3.gis.layers_arcrest;
...
function addArcRESTLayer(a){var b=a.name,c=[a.url],d;d=void 0!=a.layers?a.layers.join():0;var e;void 0!=a.dir?(e=a.dir,-1==$.inArray(e,S3.gis.dirs)&&S3.gis.dirs.push(e)):e="";var f;f=void 0!=a.base?a.base:!1;var g;g=void 0!=a.transparent?a.transparent:!0;var h;h=void 0!=a.visibility?a.visibility:!0;b=new OpenLayers.Layer.ArcGIS93Rest(b,c,{layers:"show:"+d,isBaseLayer:f,transparent:g,dir:e,s3_layer_id:a.id,s3_layer_type:"arcrest"});b.setVisibility(h);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function addGeoJSONLayer(a){var b=a.name,c=a.url,d;if(void 0!=a.marker_image){d=S3.gis.marker_url+a.marker_image;var e=a.marker_height,f=a.marker_width}else d="";var g;g=void 0!=a.refresh?a.refresh:900;var h;void 0!=a.dir?(h=a.dir,-1==$.inArray(h,S3.gis.dirs)&&S3.gis.dirs.push(h)):h="";var l;l=void 0!=a.visibility?a.visibility:!0;var k;k=void 0!=a.opacity?a.opacity:1;var n;n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var s;s=void 0!=a.cluster_threshold?a.cluster_threshold:
...
property:"value",lowerBoundary:b.low,upperBoundary:b.high}),symbolizer:{fillColor:u,strokeColor:u,graphicName:"circle",pointRadius:10},title:b.low+"-"+b.high});t.push(c)});v.addRules(t)}v=new OpenLayers.StyleMap({"default":v,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:h,projection:p,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*g}),new OpenLayers.Strategy.AttributeCluster({attribute:"colour",
...
function addGPXLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width,g;g=void 0!=a.waypoints?a.waypoints:!0;var h;h=void 0!=a.tracks?a.tracks:!0;var l;l=void 0!=a.routes?a.routes:!0;var k;k=void 0!=a.visibility?a.visibility:!0;var n;void 0!=a.dir?(n=a.dir,-1==$.inArray(n,S3.gis.dirs)&&S3.gis.dirs.push(n)):n="";var s;s=void 0!=a.opacity?a.opacity:1;var p;p=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var r;r=void 0!=a.cluster_threshold?
a.cluster_threshold:S3.gis.cluster_threshold;var m=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);g?(m.graphicOpacity=s,m.graphicWidth=f,m.graphicHeight=e,m.graphicXOffset=-(f/2),m.graphicYOffset=-e,m.externalGraphic=d):m.externalGraphic="";m.strokeColor="blue";m.strokeWidth=6;m.strokeOpacity=s;a=new OpenLayers.Layer.Vector(b,{dir:n,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:p,threshold:r})],s3_layer_id:a.id,
s3_layer_type:"gpx",legendURL:d,style:m,protocol:new OpenLayers.Protocol.HTTP({url:c,format:new OpenLayers.Format.GPX({extractAttributes:!0,extractWaypoints:g,extractTracks:h,extractRoutes:l})})});a.setVisibility(k);a.events.on({featureselected:onGpxFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addKMLLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e;e=void 0!=a.title?a.title:"name";var f;f=void 0!=a.body?a.body:"description";var g;g=void 0!=a.refresh?a.refresh:900;var h;h=void 0!=a.visibility?a.visibility:!0;var l;void 0!=a.dir?(l=a.dir,-1==$.inArray(l,S3.gis.dirs)&&S3.gis.dirs.push(l)):l="";var k;k=void 0!=a.opacity?a.opacity:1;var n;n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var s;s=void 0!=a.cluster_threshold?a.cluster_threshold:
...
1<a.attributes.count&&(b=a.attributes.count);return b}}});k=new OpenLayers.StyleMap({"default":k,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:l,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:n,threshold:s}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*g})],s3_layer_id:a.id,s3_layer_type:"kml",legendURL:d,styleMap:k,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_kml})});
...
function addWMSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var d=a.layers,e;e=void 0!=a.visibility?a.visibility:!0;var f;void 0!=a.dir?(f=a.dir,-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)):f="";var g;g=void 0!=a.base?a.base:!1;var h;h=void 0!=a.transparent?a.transparent:!0;var l;l=void 0!=a.format?a.format:"image/png";var k;k=void 0!=a.version?a.version:"1.1.1";var n;n=void 0!=a.map?a.map:"";var s;s=void 0!=a.style?
a.style:"";var p;p=void 0!=a.bgcolor?"0x"+a.bgcolor:"";var r;r=void 0!=a.buffer?a.buffer:0;var m;m=void 0!=a.tiled?a.tiled:!1;var v;v=void 0!=a.opacity?a.opacity:1;var t;t=void 0!=a.queryable?a.queryable:1;var u;void 0!=a.legendURL&&(u=a.legendURL);b=new OpenLayers.Layer.WMS(b,c,{layers:d,transparent:h},{dir:f,wrapDateLine:!0,isBaseLayer:g,s3_layer_id:a.id,s3_layer_type:"wms",queryable:t,visibility:e});n&&(b.params.MAP=n);l&&(b.params.FORMAT=l);k&&(b.params.VERSION=k);s&&(b.params.STYLES=s);p&&(b.params.BGCOLOR=
p);m&&(b.params.TILED=!0,b.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom]);g||(b.opacity=v,b.buffer=r?r:0);u&&(b.legendURL=u);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function onGeojsonFeatureSelect(a){s3_gis_tooltipUnselect(a);a=a.feature;var b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=!1,e,f;if(a.cluster){var g;e=i18n.gis_cluster_multiple+":<ul>";for(var h=0;h<a.cluster.length;h++)f=void 0!=a.cluster[h].attributes.popup?a.cluster[h].attributes.popup.split("<br />",1)[0]:a.cluster[h].attributes.name,void 0!=a.cluster[h].attributes.url?(g=a.cluster[h].attributes.url,e+="<li><a href='javascript:s3_gis_loadClusterPopup(\""+g+'", "'+b+"\")'>"+f+"</a></li>"):
...
if(void 0==a.attributes.data)h="";else if(0===a.attributes.data.indexOf("http://"))var d=!0,l=S3.uid(),h='<div id="'+l+'">'+i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 /></div>";else h="<p>"+a.attributes.data+"</p>";var k;k=void 0==a.attributes.image?"":0===a.attributes.image.indexOf("http://")?'<img src="'+a.attributes.image+'" height=300 width=300>':"";e=f+e+g+h+k}c=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),e,null,!0,onPopupClose);void 0!=a.attributes.url?
...
function onKmlFeatureSelect(a){s3_gis_tooltipUnselect(a);a=a.feature;var b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d;if(a.cluster){var e;d=i18n.gis_cluster_multiple+":<ul>";for(var f=0;f<a.cluster.length;f++)e=a.cluster[f].attributes.name,d+="<li>"+e+"</li>";d=d+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{var g=a.attributes;if(void 0!=a.style.balloonStyle)d=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,
b){var c=g[b];return"string"===typeof c||"number"===typeof c?c:a});else{e=a.layer.title;d=typeof g[e];e="object"==d?g[e].value:g[e];f=a.layer.body.split(" ");content="";for(var h=0;h<f.length;h++){d=typeof g[f[h]];var l="";"object"==d?(d=g[f[h]].displayName,""===d&&(d=f[h]),l="<b>"+d+"</b>: "+g[f[h]].value+"<br />"):void 0!=g[f[h]]&&(l=g[f[h]]+"<br />");content+=l}d="<h3>"+e+"</h3>"+content}-1!=d.search("<script")&&(d="Content contained Javascript! Escaped content below.<br />"+d.replace(/</g,"<"))}b=
new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),d,null,!0,onPopupClose);a.popup=b;map.addPopup(b)}
function onWfsFeatureSelect(a){s3_gis_tooltipUnselect(a);a=a.feature;var b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=a.layer.title,e;if(a.cluster){var f;e=i18n.gis_cluster_multiple+":<ul>";for(var g=Math.min(a.cluster.length,9),h=0;h<g;h++)f=a.cluster[h].attributes[d],e+="<li>"+f+"</li>";e=e+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{e=a.attributes;var d=e[d],l="";$.each(e,function(a,b){l+="<b>"+a+":</b> "+
...
function getState(){var a={},b=map.getCenter();b.transform(map.getProjectionObject(),S3.gis.proj4326);a.lon=b.lon;a.lat=b.lat;a.zoom=map.getZoom();var c=[],d,e,f=map.baseLayer.s3_layer_id;Ext.iterate(map.layers,function(a,b,g){d=a.s3_layer_id;e={id:d};a.visibility&&(e.visible=a.visibility);d==f&&(e.base=!0);a.s3_style&&(e.style=a.s3_style);c.push(e)});a.layers=c;var g=[];Ext.iterate(S3.gis.plugins,function(a,b,c){a.getState&&g.push(a.getState())});a.plugins=g;return a}
...
function addLayerPropertiesButton(){var a=new Ext.Toolbar.Button({iconCls:"gxp-icon-layerproperties",tooltip:i18n.gis_properties,handler:function(){var a=S3.gis.layerTree.root.findChildBy(function(a){return a.isSelected()?a.leaf?!0:!1:!1},null,!0);if(a){var c=a.layer.s3_layer_type,d=S3.Ap.concat("/gis/layer_"+c+".plain?layer_"+c+".layer_id="+a.layer.s3_layer_id+"&update=1");Ext.Ajax.request({url:d,method:"GET",success:function(d,f){S3.gis.propertiesWindow&&S3.gis.propertiesWindow.close();var g;"feature"==
c?(g=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:d.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),g.items.items[1].on("activate",function(){var c;Ext.iterate(S3.gis.layers_features,function(d,e,f){d.id==a.layer.s3_layer_id&&(c=d.url.replace(/.geojson.+/,"/search.plain"))});Ext.get("s3_gis_layer_filter_tab").load({url:c,discardUrl:!1,callback:function(){S3.addTooltips();S3.search.select_letter_label()},text:"Loading...",timeout:30,scripts:!1})})):g=new Ext.Panel({title:"Layer Properties",
html:d.responseText});S3.gis.propertiesWindow=new Ext.Window({width:400,layout:"fit",items:[g]});S3.gis.propertiesWindow.show();$("#plain form").submit(function(){var a=$('#plain input[name="id"]').val(),a=S3.Ap.concat("/gis/layer_"+c+"/"+a+".plain/update"),b=$("#plain input"),d=[];Ext.iterate(b,function(a,b,c){b.id&&-1!=b.id.indexOf("gis_layer_")&&d.push(b.id)});b=[];for(i=0;i<d.length;i++)(q=$("#"+d[i]).serialize())&&b.push(q);(q=$('#plain input[name="id"]').serialize())&&b.push(q);(q=$('#plain input[name="_formkey"]').serialize())&&
