...
d="object"==c?h[a].value:h[a];g="<h3>"+d+"</h3>";for(var d=b.layer.body.split(" "),l,e=0;e<d.length;e++)c=typeof h[d[e]],"object"==c?(a=h[d[e]].displayName,""===a&&(a=d[e]),c=h[d[e]].value,l='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+c+"</div></div>"):l=void 0!=h[d[e]]?'<div class="gis_popup_row">'+h[d[e]]+"</div>":"",g+=l}-1!=g.search("<script")&&(g="Content contained Javascript! Escaped content below.<br />"+g.replace(/</g,"<"))}else if("gpx"!=
c)if("shapefile"==c)h=b.attributes,g="<div>",$.each(h,function(a,b){"id_orig"==a&&(a="id");l='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+b+"</div></div>";g+=l}),g+="</div>";else if("wfs"==c)h=b.attributes,d=h[a],g="<h3>"+d+"</h3>",$.each(h,function(a,b){l='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";g+=l});else if(void 0!=b.attributes.url)m=b.attributes.url;else{h=b.attributes;
d=void 0==h.name?"":"<h3>"+h.name+"</h3>";e=void 0==h.description?"":"<p>"+h.description+"</p>";a=void 0==h.link?"":'<a href="'+h.link+'" target="_blank">'+h.link+"</a>";if(void 0==h.data)c="";else if(0===h.data.indexOf("http://")){k=!0;var t=S3.uid(),c='<div id="'+t+'">'+i18n.gis_loading+"...<div class='throbber'></div></div>"}else c="<p>"+h.data+"</p>";n=void 0==h.image?"":0===h.image.indexOf("http://")?'<img src="'+h.image+'" height=300 width=300>':"";g=d+e+a+c+n}m=U(b,m,g,f);k&&T(b.attributes.data,
t,m)},F=function(b){b=b.feature;b.popup&&(b.layer.map.removePopup(b.popup),b.popup.destroy(),delete b.popup)},Ga=function(b){b=this.map;this.feature&&(delete this.feature.popup,b.s3.popupControl.unselect(this.feature));for(;b.popups.length;)b.removePopup(b.popups[0])};S3.gis.loadClusterPopup=function(b,a,c){var d="#"+c+"_contentDiv",e=$(d);e.html(i18n.gis_loading+"...<div class='throbber'></div>");var f=S3.gis.maps[b];$.getS3(a,function(a){e.html(a);f.popups[0].updateSize();a=$(d+" .dropdown-toggle");
