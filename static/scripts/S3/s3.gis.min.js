...
c.addPopup(e))}}},500)},S=function(b){b=b.feature;var a=b.layer.map;clearTimeout(S3.gis.maps[a.s3.id].tooltipTimeout);null!==b&&null!==b.popup&&(a.removePopup(b.popup),b.popup.destroy(),delete b.popup,a.s3.tooltipPopup=null,a.s3.lastFeature=null)};S3.gis.zoomToSelectedFeature=function(b,a,c,d){b=S3.gis.maps[b];a=new OpenLayers.LonLat(a,c);d=b.getZoom()+d;b.setCenter(a,d);for(d=0;d<b.popups.length;d++)b.removePopup(b.popups[d])};var U=function(b,a,c,d,e){void 0==d&&(d=S3.uid());e?(0===a.indexOf("http://")&&
(a=OpenLayers.ProxyHost+encodeURIComponent(a)),c='<iframe src="'+a+'" onload="S3.gis.popupLoaded(\''+d+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0" scrolling="auto"></iframe>'):void 0==c&&(c=i18n.gis_loading+"...<div class='throbber'></div>");var f=b.geometry.getBounds().getCenterLonLat();c=new OpenLayers.Popup.FramedCloud(d,f,new OpenLayers.Size(400,400),c,null,!0,Ga);b.popup=c;c.feature=b;b.layer.map.addPopup(c);e||void 0==a||T(a,d+"_contentDiv",c);return c};S3.gis.addPopup=
U;S3.gis.popupLoaded=function(b){$("#"+b+"_contentDiv iframe").contents().find("#popup form").show()};var T=function(b,a,c){0===b.indexOf("http://")&&(b=OpenLayers.ProxyHost+encodeURIComponent(b));$.ajaxS3({url:b,dataType:"html",success:function(b){try{$("#"+a).html(b),c.updateSize()}catch(e){}},error:function(b,e,f){msg="UNAUTHORIZED"==f?i18n.gis_requires_login:b.responseText;$("#"+a+"_contentDiv").html(msg);c.updateSize()}})},E=function(b){S(b);b=b.feature;var a=b.layer,c=a.s3_layer_type,d=a.map,
...
g&&(d=-Math.abs(d));a.geometry.resize(1+d,c);b.s3.draftLayer.drawFeature(a);f++},50,c,e)},la=function(b){var a=b.map,c=a.s3,d=new Ext.Toolbar.Button({iconCls:"googleearth",tooltip:c.options.Google.Earth,enableToggle:!0,toggleHandler:function(b,d){!0===d?(c.mapPanelContainer.getLayout().setActiveItem(1),c.mapWin.items.items[0].collapse(),c.googleEarthPanel.on("pluginready",function(){var b=a.s3.options.layers_feature;if(b)for(var c=0;c<b.length;c++){var d=b[c];if(void 0!=d.visibility?d.visibility:
...
d);break}}else if(document.location.pathname==S3.Ap.concat("/gis/index")||document.location.pathname==S3.Ap.concat("/gis/map_viewing_client"))d=document.location.pathname+"?config="+c,window.history.pushState({},document.title,d);d=S3.Ap.concat("/gis/config/",c,"/layer_entity");$("#gis_menu_config").attr("href",d)}},params:a})},Ja=function(b){var a={},c=b.getCenter();c.transform(b.getProjectionObject(),v);a.lon=c.lon;a.lat=c.lat;a.zoom=b.getZoom();var d=[],e,f,g=b.baseLayer.s3_layer_id;Ext.iterate(b.layers,
...
g){c&&c.close();var n;"feature"==f?(n=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:a.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),n.items.items[1].on("activate",function(){var a;Ext.iterate(b.s3.layers_feature,function(b,c,f){b.id==d.layer.s3_layer_id&&(a=b.url.replace(/.geojson.+/,"/search.plain"))});Ext.get("s3_gis_layer_filter_tab").load({url:a,discardUrl:!1,callback:function(){S3.addTooltips();S3.search.select_letter_label()},text:"Loading...",
timeout:30,scripts:!1})})):n=new Ext.Panel({title:"Layer Properties",html:a.responseText});c=new Ext.Window({width:400,layout:"fit",items:[n]});c.show();$("#plain form").submit(function(){var a=$('#plain input[name="id"]').val(),a=S3.Ap.concat("/gis/layer_"+f+"/"+a+".plain/update"),b=$("#plain input"),c=[];Ext.iterate(b,function(a,b,d){b.id&&-1!=b.id.indexOf("gis_layer_")&&c.push(b.id)});b=[];for(i=0;i<c.length;i++)(q=$("#"+c[i]).serialize())&&b.push(q);(q=$('#plain input[name="id"]').serialize())&&
b.push(q);(q=$('#plain input[name="_formkey"]').serialize())&&b.push(q);(q=$('#plain input[name="_formname"]').serialize())&&b.push(q);0<b.length&&(b=b.join("&"),$.ajaxS3({type:"POST",url:a,data:b,success:function(a){$("#plain").html(a)}}));return!1});S3.addTooltips();S3.autocomplete("role","admin","group","gis_layer_"+f+"_role_required")}})}}});a.getTopToolbar().add(d)},D=function(b,a){if(void 0!=a.marker)var c=a.marker,d=J+c.i,e=c.h,f=c.w;else d="";var g=a.opacity||1,k=a.style,c=new OpenLayers.Style({label:"${label}",
...
a.layer.s3_style,!m&&a.show_label&&(b=a.label));return b||""}}}),m="[object Array]"===Object.prototype.toString.call(k)?!0:!1;if(m){var n=[],p,r,h,l,t,s,v,x,w,u,y,z,A;$.each(k,function(a,b){var c={};void 0!=b.fallback?(c.title=b.fallback,elsefilter=c.elseFilter=!0):(p=void 0!=b.prop?b.prop:"value",void 0!=b.cat?(h=b.cat,c.title=b.label||h,c.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:p,value:h})):(c.title=b.label||b.low+"-"+b.high,c.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,
property:p,lowerBoundary:b.low,upperBoundary:b.high})));if(void 0!=b.externalGraphic){l=S3.Ap.concat("/static/"+b.externalGraphic);var d=new Image;d.src=l;t=d.height;s=d.width;v=-(s/2);x=-t}else l="",s=t=1,x=v=-1;void 0!=b.fill?w="#"+b.fill:void 0!=b.stroke&&(w="#"+b.stroke);u=void 0!=b.fillOpacity?b.fillOpacity:g;z=void 0!=b.strokeOpacity?b.strokeOpacity:1;graphic=void 0!=b.graphic?b.graphic:"square";y=void 0!=b.size?b.size:10;A=void 0!=b.strokeWidth?b.strokeWidth:2;c.symbolizer={externalGraphic:l,
