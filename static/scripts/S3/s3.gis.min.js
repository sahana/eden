...
d;for(d in b)"controls"!=d&&(a[d]=b[d]);c.addControl(new OpenLayers.Control.OverviewMap({mapOptions:a}))}Ha(c)},Ha=function(c){c.events.register("featureover",this,Ia);c.events.register("featureout",this,U);c.events.register("featureclick",this,Ja)},Ia=function(c){var a=c.feature,b=a.layer;if("OpenLayers.Handler.PointS3"!=b.name){a.renderIntent="select";b.drawFeature(a);var d=b.map;b.name in d.s3.layers_nopopups||(S3.gis.timeouts[a.id]=setTimeout(function(){if(!a.cluster&&a.geometry){var c=a.attributes,
f=a.geometry.getBounds().getCenterLonLat(),g;void 0!=c.popup?g=c.popup:void 0!=c.name?g=c.name:void 0!=b.title&&(c=c[b.title],g="object"==typeof c?c.value:c);g&&(OpenLayers.Popup.Tooltip=OpenLayers.Class(OpenLayers.Popup,{displayClass:"gis_tooltip",contentDisplayClass:"gis_tooltip_content",CLASS_NAME:"OpenLayers.Popup.Tooltip"}),f=new OpenLayers.Popup.Tooltip(a.id+"_tooltip",f,new OpenLayers.Size(80,12),g),f.autoSize=!0,a.popup=f,d.addPopup(f))}},500))}},U=function(c){c=c.feature;var a=c.layer,b=
a.map;"OpenLayers.Handler.PointS3"!=a.name&&(a.name in b.s3.layers_nopopups&&"OpenLayers.Popup.Tooltip"==c.popup.CLASS_NAME?(c.renderIntent="default",a.drawFeature(c)):c&&(clearTimeout(S3.gis.timeouts[c.id]),c.popup?"OpenLayers.Popup.Tooltip"==c.popup.CLASS_NAME&&(c.renderIntent="default",a.drawFeature(c),c.popup&&(b.removePopup(c.popup),c.popup.destroy()),delete c.popup):(c.renderIntent="default",a.drawFeature(c)),$("#"+c.id+"_tooltip").remove()))},W=function(c,a,b,d){var e=c.id+"_popup";d?(0===
a.indexOf("http://")&&(a=OpenLayers.ProxyHost+encodeURIComponent(a)),b='<iframe src="'+a+'" onload="S3.gis.popupLoaded(\''+e+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>'):void 0==b&&(b=i18n.gis_loading+'...<div class="throbber"></div>');var f=c.geometry.getBounds().getCenterLonLat();b=new OpenLayers.Popup.FramedCloud(e,f,new OpenLayers.Size(400,400),b,null,!0,Ka);c.popup=b;b.feature=c;b.maxSize=new OpenLayers.Size(750,660);c.layer.map.addPopup(b);d||void 0==a||
V(a,e+"_contentDiv",b);return b};S3.gis.addPopup=W;S3.gis.popupLoaded=function(c){$("#"+c+"_contentDiv iframe").contents().find("#popup form").show();var a=S3.gis.maps,b,d,e,f,g;for(b in a)for(d=a[b],e=d.popups,f=0,g=e.length;f<g;f++)d=e[f],d.id==c&&d.updateSize(!0)};var V=function(c,a,b){0===c.indexOf("http://")&&(c=OpenLayers.ProxyHost+encodeURIComponent(c));$.ajaxS3({url:c,dataType:"html",success:function(c){try{$("#"+a).html(c),b.updateSize(),$("#"+a+" a.btn.iframe").click(function(){var b=$(this).attr("href");
0===b.indexOf("http://")&&(b=OpenLayers.ProxyHost+encodeURIComponent(b));var c=a.slice(0,-11),b='<iframe src="'+b+'" onload="S3.gis.popupLoaded(\''+c+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>';$("#"+a).html(b);return!1})}catch(e){}},error:function(c,e,f){msg="UNAUTHORIZED"==f?i18n.gis_requires_login:c.responseText;$("#"+a+"_contentDiv").html(msg);b.updateSize()}})},Ja=function(c){var a=c.feature,b=a.layer,d=b.map.s3;if(!(b.name in d.layers_nopopups)){var e=a.geometry;
if("OpenLayers.Geometry.Point"!=e.CLASS_NAME)for(var f=0,g=d.clicking.length;f<g;++f)if("OpenLayers.Geometry.Point"==d.clicking[f].geometry.CLASS_NAME)return;U(c);a.renderIntent="select";b.drawFeature(a);f=b.s3_layer_type;c=e.getBounds().getCenterLonLat();var g=a.id+"_popup",e=void 0!=b.title?b.title:"name",h,l,m;if(a.cluster){var n=a.cluster;h=i18n.gis_cluster_multiple+":<ul>";for(var p=n.length,d=d.id,f=0;f<p;f++){var k=n[f].attributes,b=void 0!=k.popup?k.popup.split("<br />",1)[0]:k[e];h=void 0!=
k.url?h+("<li><a href='javascript:S3.gis.loadClusterPopup(\""+d+'", "'+k.url+'", "'+g+"\")'>"+b+"</a></li>"):h+("<li>"+b+"</li>")}h+="</ul>";h+="<div align='center'><a href='javascript:S3.gis.zoomToSelectedFeature(\""+d+'", '+c.lon+","+c.lat+", 3)'>"+i18n.gis_zoomin+"</a></div>"}else if("kml"==f){k=a.attributes;if(void 0!=a.style.balloonStyle)h=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,b){var c=k[b];return"string"===typeof c||"number"===typeof c?c:a});else{f=typeof k[e];f="object"==f?
k[e].value:k[e];h="<h3>"+f+"</h3>";for(var b=b.body.split(" "),r,d=0;d<b.length;d++)f=typeof k[b[d]],"object"==f?(f=k[b[d]].displayName,""===f&&(f=b[d]),e=k[b[d]].value,r='<div class="gis_popup_row"><div class="gis_popup_label">'+f+':</div><div class="gis_popup_cell">'+e+"</div></div>"):r=void 0!=k[b[d]]?'<div class="gis_popup_row">'+k[b[d]]+"</div>":"",h+=r}-1!=h.search("<script")&&(h="Content contained Javascript! Escaped content below.<br />"+h.replace(/</g,"<"))}else if("gpx"!=f)if("shapefile"==
f)k=a.attributes,h="<div>",$.each(k,function(a,b){"id_orig"==a&&(a="id");r='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+b+"</div></div>";h+=r}),h+="</div>";else if("wfs"==f)k=a.attributes,f=k[e],h="<h3>"+f+"</h3>",$.each(k,function(a,b){r='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";h+=r});else if(void 0!=a.attributes.url)m=a.attributes.url;else{k=a.attributes;b=void 0==k.name?
"":"<h3>"+k.name+"</h3>";f=void 0==k.description?"":"<p>"+k.description+"</p>";d=void 0==k.link?"":'<a href="'+k.link+'" target="_blank">'+k.link+"</a>";if(void 0==k.data)e="";else if(0===k.data.indexOf("http://")){l=!0;var s=S3.uid(),e='<div id="'+s+'">'+i18n.gis_loading+"...<div class='throbber'></div></div>"}else e="<p>"+k.data+"</p>";c=void 0==k.image?"":0===k.image.indexOf("http://")?'<img src="'+k.image+'" height=300 width=300>':"";h=b+f+d+e+c}m=W(a,m,h);l&&V(a.attributes.data,s,m)}},Ka=function(c){if(c=
this.feature){var a=c.layer;c.renderIntent="default";a&&a.drawFeature(c);c.popup&&(a&&a.map.removePopup(c.popup),c.popup.destroy());delete c.popup;$("#"+c.id+"_popup").remove();a&&a.name==i18n.gis_draft_layer&&c.destroy()}};S3.gis.loadClusterPopup=function(c,a,b){var d="#"+b+"_contentDiv",e=$(d);e.html(i18n.gis_loading+"...<div class='throbber'></div>");var f=S3.gis.maps[c];$.getS3(a,function(a){e.html(a);f.popups[0].updateSize();a=$(d+" .dropdown-toggle");a.length&&(e.parent().css("overflow","visible").parent().css("overflow",
...
var e=new OpenLayers.Feature.Vector(OpenLayers.Geometry.Polygon.createRegularPolygon(new OpenLayers.Geometry.Point(c.point.x,c.point.y),c.position.coords.accuracy/2,40,0),{},d);b.addFeatures([new OpenLayers.Feature.Vector(c.point,{},{graphicName:"cross",strokeColor:"#f00",strokeWidth:2,fillOpacity:0,pointRadius:10}),e]);a.zoomToExtent(b.getDataExtent());La(a,e)});e.events.register("locationfailed",this,function(){OpenLayers.Console.log("Location detection failed")});var f=new Ext.Toolbar.Button({iconCls:"geolocation",
tooltip:i18n.gis_geoLocate,handler:function(){b.removeAllFeatures();e.activate()}});c.addButton(f)},La=function(c,a){var b=a.geometry.getCentroid(),d=a.geometry.getBounds(),e=Math.abs((d.right-d.left)/2),f=0,g="up";window.resizeInterval=window.setInterval(function(){16<f&&clearInterval(window.resizeInterval);var d=.03*e/e;switch(f){case 4:case 12:g="down";break;case 8:g="up"}"up"!==g&&(d=-Math.abs(d));a.geometry.resize(1+d,b);c.s3.draftLayer.drawFeature(a);f++},50,b,e)},oa=function(c){var a=c.map,
...
(e.activate(),$(".olMapViewport").addClass("crosshair"))},Q=function(c,a,b,d){var e=c.s3.draftLayer;d=new OpenLayers.Control.DrawFeature(e,d?OpenLayers.Handler.Polygon:OpenLayers.Handler.RegularPolygon,{handlerOptions:d?{sides:4,snapAngle:90}:{},featureAdded:function(a){c.s3.lastDraftFeature?c.s3.lastDraftFeature.destroy():1<e.features.length&&e.features[0].destroy();var b=$("#gis_location_wkt");if(b.length){var d=a.geometry.transform(c.getProjectionObject(),u).toString();b.val(d);$("#gis_location_lat").val("");
$("#gis_location_lon").val("")}else b=$("#gis_search_polygon_input"),b.length&&(d=a.geometry.transform(c.getProjectionObject(),u).toString(),b.val(d).trigger("change"));void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);c.s3.lastDraftFeature=a}});if(a){var f=new GeoExt.Action({control:d,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},map:c,iconCls:"drawpolygon-off",tooltip:i18n.gis_draw_polygon,
...
"?lat="+c.lat+"&lon="+c.lon+"&zoom="+b;window.open(b)}}});c.addSeparator();c.addButton(b)},ia=function(c){var a=new Ext.Toolbar.Button({iconCls:"print",tooltip:i18n.gis_print,handler:function(){var a=H(c.map,!0),a=S3.Ap.concat("/gis/screenshot/")+a;window.open(a)}});c.addButton(a)},ja=function(c){var a=new Ext.Toolbar.Button({iconCls:"save",tooltip:i18n.gis_save,handler:function(){H(c.map)}});c.addButton(a)},pa=function(c){var a=c.s3,b=a.id;if(!$("#"+b+" .map_save_panel").length){var d='<div class="fleft"><div class="map_save_name">';
(a=a.options.config_name)&&(d+=a);d='<div class="map_save_panel off">'+(d+"</div></div>")+'<div class="btn map_save_button"><div class="map_save_label">'+i18n.gis_save_map+"</div></div></div>";$("#"+b).append(d);a&&$("#"+b+" .map_save_panel").removeClass("off");$("#"+b+" .map_save_button").click(function(){X(c)})}},X=function(c){var a=c.s3.id;$("#"+a+" .map_save_panel").removeClass("off");$("#"+a+" .map_save_panel .saved").remove();$("#"+a+" .map_save_panel .fleft").show();$("#"+a+" .map_save_label").html(i18n.save);
Y(c)},Y=function(c){var a=c.s3,b=a.id,d=a.options,e=d.config_id,f=d.config_name?d.config_name:"",g=$("#"+b+" .map_save_button"),h=b+"_save",a=$("#"+h);a.length||(a='<div class="hint">'+('<label for="'+h+'">'+i18n.gis_name_map+"</label>")+('<input id="'+h+'" value="'+f+'">')+"</div>",e='<div class="new_map"><input type="checkbox" class="checkbox"'+(e?"":' disabled="disabled" checked="checked"')+">"+i18n.gis_new_map+"</div>",$("#"+b+" .map_save_panel .fleft").html(a+e),$("#"+b+" .map_save_panel label").labelOver("over"));
g.unbind("click").click(function(){H(c);var a=$("#"+b+"_save").val();$("#"+b+" .map_save_name").html(a);d.config_name=a;a=d.pe_id?"?~.pe_id__belongs="+d.pe_id:"";a='<div class="saved"><p><i>'+i18n.saved+'</i></p><p><a href="'+S3.Ap.concat("/gis/config")+a+'">'+i18n.gis_my_maps+"</a></p></div>";$("#"+b+" .map_save_panel .fleft").hide().before(a);$("#"+b+" .map_save_panel .checkbox").prop("checked",!1).prop("disabled",!1);g.unbind("click").click(function(){X(c)})});var l=$("#"+b+" .map_save_panel");
$("html").unbind("click.cancelSave").bind("click.cancelSave",function(){l.addClass("off");g.unbind("click").click(function(){l.removeClass("off").unbind("click");Y(c)})});l.click(function(a){a.stopPropagation()})},H=function(c,a){var b=Na(c),d=JSON.stringify,e=d(b.layers),d=d(b.plugins),b={lat:b.lat,lon:b.lon,zoom:b.zoom,layers:e,plugins:d},e=c.s3,f=e.options;f.pe_id&&(b.pe_id=f.pe_id);if(a){var g,e=!1;b.temp=1}else e=e.id,d=$("#"+e+"_save"),g=f.config_id,d.length?(b.hide=1,b.name=d.val(),e=g?!$("#"+
e+' .map_save_panel input[type="checkbox"]').prop("checked"):!1):e=g?!0:!1;e=e?S3.Ap.concat("/gis/config/"+g+".url/update"):S3.Ap.concat("/gis/config.url/create");$.ajaxS3({async:!1,url:e,type:"POST",data:b,dataType:"json",success:function(b,c){g=b.id;if(!a&&g){f.config_id=g;if(history.pushState)if(document.location.search)for(var d=document.location.search.split("?")[1].split("&"),e=[],p=0;p<d.length;p++){if(e=d[p].split("="),"config"==decodeURIComponent(e[0])&&decodeURIComponent(e[1])!=g){d[p]=
"config="+g;d=document.location.pathname+"?"+d.join("&");window.history.pushState({},document.title,d);break}}else if(document.location.pathname==S3.Ap.concat("/gis/index")||document.location.pathname==S3.Ap.concat("/gis/map_viewing_client"))d=document.location.pathname+"?config="+g,window.history.pushState({},document.title,d);d=S3.Ap.concat("/gis/config/",g,"/layer_entity");$("#gis_menu_config").attr("href",d)}}});return g},Na=function(c){var a={},b=c.getCenter();b.transform(c.getProjectionObject(),
u);a.lon=b.lon;a.lat=b.lat;a.zoom=c.getZoom();var d=[],e,f,g=c.baseLayer.s3_layer_id;Ext.iterate(c.layers,function(a,b,c){e=a.s3_layer_id;f={id:e};a.visibility&&(f.visible=a.visibility);e==g&&(f.base=!0);a.s3_style&&(f.style=a.s3_style);d.push(f)});a.layers=d;var h=[];Ext.iterate(c.s3.plugins,function(a,b,c){a.getState&&h.push(a.getState())});a.plugins=h;return a},la=function(c){var a=c.map,b=a.s3.options;selectPdfControl=new OpenLayers.Control;OpenLayers.Util.extend(selectPdfControl,{draw:function(){this.box=
...
f+".plain?layer_"+f+".layer_id="+d.layer.s3_layer_id+"&update=1");Ext.Ajax.request({url:g,method:"GET",success:function(a,g){b&&b.close();var m;"feature"==f?(m=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:a.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),m.items.items[1].on("activate",function(){var a;Ext.iterate(c.s3.layers_feature,function(b,c,f){b.id==d.layer.s3_layer_id&&(a=b.url.replace(/.geojson.+/,"/search.plain"))});Ext.get("s3_gis_layer_filter_tab").load({url:a,
discardUrl:!1,callback:function(){S3.redraw()},text:"Loading...",timeout:30,scripts:!1})})):m=new Ext.Panel({title:"Layer Properties",html:a.responseText});b=new Ext.Window({width:400,layout:"fit",items:[m]});b.show();$("#plain form").submit(function(){var a=$('#plain input[name="id"]').val(),a=S3.Ap.concat("/gis/layer_"+f+"/"+a+".plain/update"),b=$("#plain input"),c=[];Ext.iterate(b,function(a,b,d){b.id&&-1!=b.id.indexOf("gis_layer_")&&c.push(b.id)});b=[];for(i=0;i<c.length;i++)(q=$("#"+c[i]).serialize())&&
b.push(q);(q=$('#plain input[name="id"]').serialize())&&b.push(q);(q=$('#plain input[name="_formkey"]').serialize())&&b.push(q);(q=$('#plain input[name="_formname"]').serialize())&&b.push(q);0<b.length&&(b=b.join("&"),$.ajaxS3({type:"POST",url:a,data:b,success:function(a){$("#plain").html(a)}}));return!1});S3.addTooltips();S3.autocomplete("role","admin","group","gis_layer_"+f+"_role_required")}})}}});a.getTopToolbar().add(d)},N=function(c,a){var b=new Ext.Toolbar.Button({iconCls:"icon-clearlayers",
tooltip:i18n.gis_clearlayers,handler:function(){layers=c.layers;i=0;for(len=layers.length;i<len;i++)layer=layers[i],layer.isBaseLayer||layer.setVisibility(!1)}});a.add(b)},C=function(c,a){if(void 0!=a.marker)var b=a.marker,d=E+b.i,e=b.h,f=b.w;else d="";var g=a.opacity||1,h=a.style,l="[object Array]"===Object.prototype.toString.call(h)?!0:!1,m=c.s3.options,b=new OpenLayers.Style({label:"${label}",labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:"${fillOpacity}",strokeColor:"${stroke}",
strokeWidth:"${strokeWidth}",strokeOpacity:"${strokeOpacity}",graphicHeight:"${graphicHeight}",graphicWidth:"${graphicWidth}",graphicName:"${graphicName}",graphicOpacity:g,graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",graphicZIndex:"${graphicZIndex}",externalGraphic:"${externalGraphic}",zIndex:"${zIndex}"},{context:{graphicWidth:function(a){var b=1;a.cluster||(a.attributes.marker_width?b=a.attributes.marker_width:h&&!l&&void 0==h.externalGraphic&&void 0==f&&"OpenLayers.Geometry.Point"==
a.geometry.CLASS_NAME?b=m.marker_default.w:void 0!=f&&(b=f));return b},graphicHeight:function(a){var b=1;a.cluster||(a.attributes.marker_height?b=a.attributes.marker_height:h&&!l&&void 0==h.externalGraphic&&void 0==e&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=m.marker_default.h:void 0!=e&&(b=e));return b},graphicXOffset:function(a){var b=-1;a.cluster||(a.attributes.marker_width?b=-(a.attributes.marker_width/2):h&&!l&&void 0==h.externalGraphic&&void 0==f&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?
b=-(m.marker_default.w/2):void 0!=f&&(b=-(f/2)));return b},graphicYOffset:function(a){var b=-1;a.cluster||(a.attributes.marker_height?b=-a.attributes.marker_height:h&&!l&&void 0==h.externalGraphic&&void 0==e&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=-m.marker_default.h:void 0!=e&&(b=-e));return b},graphicName:function(a){var b="circle";a.cluster||(a.attributes.shape?b=a.attributes.shape:h&&!l&&void 0!=h.graphic&&(b=h.graphic));return b},externalGraphic:function(a){var b="";if(!a.cluster)if(a.attributes.marker_url)b=
a.attributes.marker_url;else if(h){if(!l)if(void 0!=h.externalGraphic)b=S3.Ap.concat("/static/"+h.externalGraphic);else if("OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME){if(d)return d;b=E+m.marker_default.i}}else return d;return b},radius:function(a){var b=10;a.cluster?b=Math.min(a.attributes.count/2,8)+10:a.attributes.size?b=a.attributes.size:h&&!l&&(b=h.size);return b},fill:function(a){var b;a.cluster?b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#"+(m.cluster_fill||"8087ff"):
a.attributes.colour?b=a.attributes.colour:h?(l||(b=h.fill),b=void 0!=b?"#"+b:"#000000"):b="#f5902e";return b},fillOpacity:function(a){var b;a.cluster?b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:g:a.attributes.opacity?b=a.attributes.opacity:h&&!l&&(b=h.fillOpacity);return b||g},stroke:function(a){var b;a.cluster?b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#"+(m.cluster_stroke||"2b2f76"):a.attributes.colour?b=a.attributes.colour:h?(l||(b=h.stroke||h.fill),
b=void 0!=b?"#"+b:"#000000"):b="#f5902e";return b},strokeOpacity:function(a){var b;a.cluster?b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:g:a.attributes.opacity?b=a.attributes.opacity:h&&!l&&(b=h.strokeOpacity);return b||g},strokeWidth:function(a){var b=2;a.cluster?a.cluster[0].attributes.strokeWidth&&(b=a.cluster[0].attributes.strokeWidth):h&&!l&&(b=h.strokeWidth);return b||2},label:function(a){var b;a.cluster?m.cluster_label&&1<a.attributes.count&&(b=a.attributes.count):a.layer&&
void 0!=a.layer.s3_style&&(a=a.layer.s3_style,!l&&a.show_label&&(b=a.label));return b||""},zIndex:function(a){return"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==a.geometry.CLASS_NAME?5:0},graphicZIndex:function(a){return"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==a.geometry.CLASS_NAME?5:0}}});if(l){var n=S(a);b.addRules(n)}return[new OpenLayers.StyleMap({"default":b,select:1!=g?{graphicOpacity:1}:{fillColor:"#"+(m.select_fill||
"ffdc33"),strokeColor:"#"+(m.select_stroke||"ff9933")}}),d]},S=function(c){var a=[],b,d,e,f,g,h,l,m,n,p,k,r,s;$.each(c.style,function(v,t){var u={};void 0!=t.fallback?(u.title=t.fallback,elsefilter=u.elseFilter=!0):(b=void 0!=t.prop?t.prop:"value",void 0!=t.cat?(e=t.cat,u.title=t.label||e,u.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:b,value:e})):(u.title=t.label||t.low+"-"+t.high,u.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,
property:b,lowerBoundary:t.low,upperBoundary:t.high})));void 0!=t.externalGraphic?(h=!0,p=!1):void 0!=t.size?(h=!0,p=!1):h=!1;void 0!=t.fill?(p=!1,f="#"+t.fill):void 0!=t.stroke&&(p=!0,f="#"+t.stroke);g=void 0!=t.fillOpacity?t.fillOpacity:c.opacity||1;k=void 0!=t.strokeOpacity?t.strokeOpacity:1;graphic=void 0!=t.graphic?t.graphic:"square";r=void 0!=t.strokeWidth?t.strokeWidth:2;s={fillColor:f,fillOpacity:g,strokeColor:f,strokeOpacity:k,strokeWidth:r,graphicName:graphic};if(h){if(void 0!=t.externalGraphic){l=
S3.Ap.concat("/static/"+t.externalGraphic);var x=new Image;x.src=l;m=x.height;n=x.width;s.externalGraphic=l;s.graphicHeight=m;s.graphicWidth=n;s.graphicXOffset=-(n/2);s.graphicYOffset=-m}s.pointRadius=t.size||10;s.graphicZIndex=10;s.zIndex=10;s.Point=s}else p&&(s.graphicZIndex=5,s.zIndex=5,s.Line=s);u.symbolizer=s;d=new OpenLayers.Rule(u);a.push(d)});0!=c.cluster_threshold&&(d=new OpenLayers.Rule({elseFilter:!0,title:" "}),a.push(d));return a}})();
