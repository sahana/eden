...
0===b.indexOf("http://")&&(b=OpenLayers.ProxyHost+encodeURIComponent(b));var c=a.slice(0,-11),b='<iframe src="'+b+'" onload="S3.gis.popupLoaded(\''+c+'\')" class="loading" marginWidth="0" marginHeight="0" frameBorder="0"></iframe>';$("#"+a).html(b);return!1})}catch(e){}},error:function(c,e,f){msg="UNAUTHORIZED"==f?i18n.gis_requires_login:c.responseText;$("#"+a+"_contentDiv").html(msg);b.updateSize()}})},Ja=function(c){var a=c.feature,b=a.layer,d=b.map.s3;if(!("OpenLayers.Handler.PointS3"==b.name||
b.name in d.layers_nopopups)){var e=a.geometry;if("OpenLayers.Geometry.Point"!=e.CLASS_NAME)for(var f=0,g=d.clicking.length;f<g;++f)if("OpenLayers.Geometry.Point"==d.clicking[f].geometry.CLASS_NAME)return;U(c);a.renderIntent="select";b.drawFeature(a);f=b.s3_layer_type;c=e.getBounds().getCenterLonLat();var g=a.id+"_popup",e=void 0!=b.title?b.title:"name",h,l,m;if(a.cluster){var n=a.cluster;h=i18n.gis_cluster_multiple+":<ul>";for(var p=n.length,d=d.id,f=0;f<p;f++){var k=n[f].attributes,b=void 0!=k.popup?
k.popup.split("<br />",1)[0]:k[e];h=void 0!=k.url?h+("<li><a href='javascript:S3.gis.loadClusterPopup(\""+d+'", "'+k.url+'", "'+g+"\")'>"+b+"</a></li>"):h+("<li>"+b+"</li>")}h+="</ul>";h+="<div align='center'><a href='javascript:S3.gis.zoomToSelectedFeature(\""+d+'", '+c.lon+","+c.lat+", 3)'>"+i18n.gis_zoomin+"</a></div>"}else if("kml"==f){k=a.attributes;if(void 0!=a.style.balloonStyle)h=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,b){var c=k[b];return"string"===typeof c||"number"===typeof c?
c:a});else{f=typeof k[e];f="object"==f?k[e].value:k[e];h="<h3>"+f+"</h3>";for(var b=b.body.split(" "),r,d=0;d<b.length;d++)f=typeof k[b[d]],"object"==f?(f=k[b[d]].displayName,""===f&&(f=b[d]),e=k[b[d]].value,r='<div class="gis_popup_row"><div class="gis_popup_label">'+f+':</div><div class="gis_popup_cell">'+e+"</div></div>"):r=void 0!=k[b[d]]?'<div class="gis_popup_row">'+k[b[d]]+"</div>":"",h+=r}-1!=h.search("<script")&&(h="Content contained Javascript! Escaped content below.<br />"+h.replace(/</g,
"<"))}else if("gpx"!=f)if("shapefile"==f)k=a.attributes,h="<div>",$.each(k,function(a,b){"id_orig"==a&&(a="id");r='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+b+"</div></div>";h+=r}),h+="</div>";else if("wfs"==f)k=a.attributes,f=k[e],h="<h3>"+f+"</h3>",$.each(k,function(a,b){r='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";h+=r});else if(void 0!=a.attributes.url)m=a.attributes.url;
else{k=a.attributes;b=void 0==k.name?"":"<h3>"+k.name+"</h3>";f=void 0==k.description?"":"<p>"+k.description+"</p>";d=void 0==k.link?"":'<a href="'+k.link+'" target="_blank">'+k.link+"</a>";if(void 0==k.data)e="";else if(0===k.data.indexOf("http://")){l=!0;var s=S3.uid(),e='<div id="'+s+'">'+i18n.gis_loading+"...<div class='throbber'></div></div>"}else e="<p>"+k.data+"</p>";c=void 0==k.image?"":0===k.image.indexOf("http://")?'<img src="'+k.image+'" height=300 width=300>':"";h=b+f+d+e+c}m=W(a,m,h);
l&&V(a.attributes.data,s,m)}},Ka=function(c){if(c=this.feature){var a=c.layer;c.renderIntent="default";a&&a.drawFeature(c);c.popup&&(a&&a.map.removePopup(c.popup),c.popup.destroy());delete c.popup;$("#"+c.id+"_popup").remove();a&&a.name==i18n.gis_draft_layer&&c.destroy()}};S3.gis.loadClusterPopup=function(c,a,b){var d="#"+b+"_contentDiv",e=$(d);e.html(i18n.gis_loading+"...<div class='throbber'></div>");var f=S3.gis.maps[c];$.getS3(a,function(a){e.html(a);f.popups[0].updateSize();a=$(d+" .dropdown-toggle");
...
e.events.register("locationupdated",this,function(c){b.removeAllFeatures();var e=new OpenLayers.Feature.Vector(OpenLayers.Geometry.Polygon.createRegularPolygon(new OpenLayers.Geometry.Point(c.point.x,c.point.y),c.position.coords.accuracy/2,40,0),{},d);b.addFeatures([new OpenLayers.Feature.Vector(c.point,{},{graphicName:"cross",strokeColor:"#f00",strokeWidth:2,fillOpacity:0,pointRadius:10}),e]);a.zoomToExtent(b.getDataExtent());La(a,e)});e.events.register("locationfailed",this,function(){OpenLayers.Console.log("Location detection failed")});
var f=new Ext.Toolbar.Button({iconCls:"geolocation",tooltip:i18n.gis_geoLocate,handler:function(){b.removeAllFeatures();e.activate()}});c.addButton(f)},La=function(c,a){var b=a.geometry.getCentroid(),d=a.geometry.getBounds(),e=Math.abs((d.right-d.left)/2),f=0,g="up";window.resizeInterval=window.setInterval(function(){16<f&&clearInterval(window.resizeInterval);var d=.03*e/e;switch(f){case 4:case 12:g="down";break;case 8:g="up"}"up"!==g&&(d=-Math.abs(d));a.geometry.resize(1+d,b);c.s3.draftLayer.drawFeature(a);
f++},50,b,e)},oa=function(c){var a=c.map,b=a.s3,d=new Ext.Toolbar.Button({iconCls:"googleearth",tooltip:b.options.Google.Earth,enableToggle:!0,toggleHandler:function(c,d){!0===d?(b.mapPanelContainer.getLayout().setActiveItem(1),b.mapWin.items.items[0].collapse(),b.googleEarthPanel.on("pluginready",function(){var b=a.s3.options.layers_feature;if(b)for(var c=0;c<b.length;c++){var d=b[c];if(void 0!=d.visibility?d.visibility:1)d=S3.public_url+d.url.replace("geojson","kml"),google.earth.fetchKml(a.s3.googleEarthPanel.earth,
...
strokeOpacity:1,strokeColor:"#f5902e",fillColor:"white",fillOpacity:.5}}})]);var b=new OpenLayers.StyleMap({"default":b}),d=new OpenLayers.Control.Measure(OpenLayers.Handler.Path,{geodesic:!0,persist:!0,handlerOptions:{layerOptions:{styleMap:b}}});d.events.on({measure:function(a){alert(i18n.gis_length_message+" "+a.measure.toFixed(2)+" "+a.units)}});d=new GeoExt.Action({control:d,map:a,iconCls:"measure-off",tooltip:i18n.gis_length_tooltip,allowDepress:!0,enableToggle:!0,toggleGroup:"controls"});c.add(d);
!1===a.s3.options.area&&(b=new OpenLayers.Control.Measure(OpenLayers.Handler.Polygon,{geodesic:!0,persist:!0,handlerOptions:{layerOptions:{styleMap:b}}}),b.events.on({measure:function(a){alert(i18n.gis_area_message+" "+a.measure.toFixed(2)+" "+a.units+"2")}}),a=new GeoExt.Action({control:b,map:a,iconCls:"measure-area",tooltip:i18n.gis_area_tooltip,allowDepress:!0,enableToggle:!0,toggleGroup:"controls"}),c.add(a))},ga=function(c){var a=c.s3.id;$("#"+a).append('<div class="map_legend_div"><div class="map_legend_tab right"></div><div class="map_legend_panel"></div></div>');
var b=new GeoExt.LegendPanel({title:i18n.gis_legend,autoScroll:!0,border:!1}),d=$("#"+a+" .map_legend_panel"),d=Ext.get(d[0]);b.render(d);$("#"+a+" .map_legend_tab").click(function(){if($(this).hasClass("right")){var a=c.s3.id,b=$("#"+a+" .map_legend_panel").outerWidth();$("#"+a+" .map_legend_div").animate({marginRight:"-"+b+"px"});$("#"+a+" .map_legend_tab").removeClass("right").addClass("left")}else T(c)});return b},T=function(c){c=c.s3.id;$("#"+c+" .map_legend_div").animate({marginRight:0});$("#"+
c+" .map_legend_tab").removeClass("left").addClass("right")},O=function(c,a,b){OpenLayers.Handler.PointS3=OpenLayers.Class(OpenLayers.Handler.Point,{dblclick:function(a){return!0},CLASS_NAME:"OpenLayers.Handler.PointS3"});var d=c.s3.draftLayer,e=new OpenLayers.Control.DrawFeature(d,OpenLayers.Handler.PointS3,{featureAdded:function(a){c.s3.lastDraftFeature?c.s3.lastDraftFeature.destroy():1<d.features.length&&d.features[0].destroy();void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);c.s3.lastDraftFeature=
a}});if(a){var f=new GeoExt.Action({control:e,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},map:c,iconCls:"drawpoint-off",tooltip:i18n.gis_draw_feature,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:b});a.add(f);c.s3.pointButton=f}else c.addControl(e),b&&(e.activate(),$(".olMapViewport").addClass("crosshair"))},P=function(c,a,b){var d=c.s3.draftLayer,e=new OpenLayers.Control.DrawFeature(d,OpenLayers.Handler.Path,
{featureAdded:function(a){c.s3.lastDraftFeature?c.s3.lastDraftFeature.destroy():1<d.features.length&&d.features[0].destroy();void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);c.s3.lastDraftFeature=a}});if(a){var f=new GeoExt.Action({control:e,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},map:c,iconCls:"drawline-off",tooltip:i18n.gis_draw_line,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:b,activateOnEnable:!0,
deactivateOnDisable:!0});a.add(f);c.s3.lineButton=f}else c.addControl(e),b&&(e.activate(),$(".olMapViewport").addClass("crosshair"))},Q=function(c,a,b,d){var e=c.s3.draftLayer;d=new OpenLayers.Control.DrawFeature(e,d?OpenLayers.Handler.Polygon:OpenLayers.Handler.RegularPolygon,{handlerOptions:d?{sides:4,snapAngle:90}:{},featureAdded:function(a){c.s3.lastDraftFeature?c.s3.lastDraftFeature.destroy():1<e.features.length&&e.features[0].destroy();var b=$("#gis_location_wkt");if(b.length){var d=a.geometry.transform(c.getProjectionObject(),
u).toString();b.val(d);$("#gis_location_lat").val("");$("#gis_location_lon").val("")}else b=$("#gis_search_polygon_input"),b.length&&(d=a.geometry.transform(c.getProjectionObject(),u).toString(),b.val(d).trigger("change"));void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);void 0!=c.s3.pointPlaced&&c.s3.pointPlaced(a);c.s3.lastDraftFeature=a}});if(a){var f=new GeoExt.Action({control:d,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},
map:c,iconCls:"drawpolygon-off",tooltip:i18n.gis_draw_polygon,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:b,activateOnEnable:!0,deactivateOnDisable:!0});a.add(f);c.s3.polygonButton=f}else c.addControl(d),b&&(d.activate(),$(".olMapViewport").addClass("crosshair"))},ma=function(c){var a=c.map,b=new Ext.Toolbar.Button({iconCls:"potlatch",tooltip:i18n.gis_potlatch,handler:function(){var b=a.getZoom();if(14>b)alert(i18n.gis_osm_zoom_closer);else{var c=a.getCenter();c.transform(a.getProjectionObject(),
u);b=S3.Ap.concat("/gis/potlatch2/potlatch2.html")+"?lat="+c.lat+"&lon="+c.lon+"&zoom="+b;window.open(b)}}});c.addSeparator();c.addButton(b)},ia=function(c){var a=new Ext.Toolbar.Button({iconCls:"print",tooltip:i18n.gis_print,handler:function(){var a=H(c.map,!0),a=S3.Ap.concat("/gis/screenshot/")+a;window.open(a)}});c.addButton(a)},ja=function(c){var a=new Ext.Toolbar.Button({iconCls:"save",tooltip:i18n.gis_save,handler:function(){H(c.map)}});c.addButton(a)},pa=function(c){var a=c.s3,b=a.id;if(!$("#"+
b+" .map_save_panel").length){var d='<div class="fleft"><div class="map_save_name">';(a=a.options.config_name)&&(d+=a);d='<div class="map_save_panel off">'+(d+"</div></div>")+'<div class="btn map_save_button"><div class="map_save_label">'+i18n.gis_save_map+"</div></div></div>";$("#"+b).append(d);a&&$("#"+b+" .map_save_panel").removeClass("off");$("#"+b+" .map_save_button").click(function(){X(c)})}},X=function(c){var a=c.s3.id;$("#"+a+" .map_save_panel").removeClass("off");$("#"+a+" .map_save_panel .saved").remove();
$("#"+a+" .map_save_panel .fleft").show();$("#"+a+" .map_save_label").html(i18n.save);Y(c)},Y=function(c){var a=c.s3,b=a.id,d=a.options,e=d.config_id,f=d.config_name?d.config_name:"",g=$("#"+b+" .map_save_button"),h=b+"_save",a=$("#"+h);a.length||(a='<div class="hint">'+('<label for="'+h+'">'+i18n.gis_name_map+"</label>")+('<input id="'+h+'" value="'+f+'">')+"</div>",e='<div class="new_map"><input type="checkbox" class="checkbox"'+(e?"":' disabled="disabled" checked="checked"')+">"+i18n.gis_new_map+
"</div>",$("#"+b+" .map_save_panel .fleft").html(a+e),$("#"+b+" .map_save_panel label").labelOver("over"));g.unbind("click").click(function(){H(c);var a=$("#"+b+"_save").val();$("#"+b+" .map_save_name").html(a);d.config_name=a;a=d.pe_id?"?~.pe_id__belongs="+d.pe_id:"";a='<div class="saved"><p><i>'+i18n.saved+'</i></p><p><a href="'+S3.Ap.concat("/gis/config")+a+'">'+i18n.gis_my_maps+"</a></p></div>";$("#"+b+" .map_save_panel .fleft").hide().before(a);$("#"+b+" .map_save_panel .checkbox").prop("checked",
!1).prop("disabled",!1);g.unbind("click").click(function(){X(c)})});var l=$("#"+b+" .map_save_panel");$("html").unbind("click.cancelSave").bind("click.cancelSave",function(){l.addClass("off");g.unbind("click").click(function(){l.removeClass("off").unbind("click");Y(c)})});l.click(function(a){a.stopPropagation()})},H=function(c,a){var b=Na(c),d=JSON.stringify,e=d(b.layers),d=d(b.plugins),b={lat:b.lat,lon:b.lon,zoom:b.zoom,layers:e,plugins:d},e=c.s3,f=e.options;f.pe_id&&(b.pe_id=f.pe_id);if(a){var g,
e=!1;b.temp=1}else e=e.id,d=$("#"+e+"_save"),g=f.config_id,d.length?(b.hide=1,b.name=d.val(),e=g?!$("#"+e+' .map_save_panel input[type="checkbox"]').prop("checked"):!1):e=g?!0:!1;e=e?S3.Ap.concat("/gis/config/"+g+".url/update"):S3.Ap.concat("/gis/config.url/create");$.ajaxS3({async:!1,url:e,type:"POST",data:b,dataType:"json",success:function(b,c){g=b.id;if(!a&&g){f.config_id=g;if(history.pushState)if(document.location.search)for(var d=document.location.search.split("?")[1].split("&"),e=[],p=0;p<d.length;p++){if(e=
d[p].split("="),"config"==decodeURIComponent(e[0])&&decodeURIComponent(e[1])!=g){d[p]="config="+g;d=document.location.pathname+"?"+d.join("&");window.history.pushState({},document.title,d);break}}else if(document.location.pathname==S3.Ap.concat("/gis/index")||document.location.pathname==S3.Ap.concat("/gis/map_viewing_client"))d=document.location.pathname+"?config="+g,window.history.pushState({},document.title,d);d=S3.Ap.concat("/gis/config/",g,"/layer_entity");$("#gis_menu_config").attr("href",d)}}});
return g},Na=function(c){var a={},b=c.getCenter();b.transform(c.getProjectionObject(),u);a.lon=b.lon;a.lat=b.lat;a.zoom=c.getZoom();var d=[],e,f,g=c.baseLayer.s3_layer_id;Ext.iterate(c.layers,function(a,b,c){e=a.s3_layer_id;f={id:e};a.visibility&&(f.visible=a.visibility);e==g&&(f.base=!0);a.s3_style&&(f.style=a.s3_style);d.push(f)});a.layers=d;var h=[];Ext.iterate(c.s3.plugins,function(a,b,c){a.getState&&h.push(a.getState())});a.plugins=h;return a},la=function(c){var a=c.map,b=a.s3.options;selectPdfControl=
...
a.leaf?!0:!1:!1},null,!0);if(d){var f=d.layer.s3_layer_type,g=S3.Ap.concat("/gis/layer_"+f+".plain?layer_"+f+".layer_id="+d.layer.s3_layer_id+"&update=1");Ext.Ajax.request({url:g,method:"GET",success:function(a,g){b&&b.close();var m;"feature"==f?(m=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:a.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),m.items.items[1].on("activate",function(){var a;Ext.iterate(c.s3.layers_feature,function(b,c,f){b.id==d.layer.s3_layer_id&&
...
a.getTopToolbar().add(d)},N=function(c,a){var b=new Ext.Toolbar.Button({iconCls:"icon-clearlayers",tooltip:i18n.gis_clearlayers,handler:function(){layers=c.layers;i=0;for(len=layers.length;i<len;i++)layer=layers[i],layer.isBaseLayer||layer.setVisibility(!1)}});a.add(b)},C=function(c,a){if(void 0!=a.marker)var b=a.marker,d=E+b.i,e=b.h,f=b.w;else d="";var g=a.opacity||1,h=a.style,l="[object Array]"===Object.prototype.toString.call(h)?!0:!1,m=c.s3.options,b=new OpenLayers.Style({label:"${label}",labelAlign:"cm",
pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:"${fillOpacity}",strokeColor:"${stroke}",strokeWidth:"${strokeWidth}",strokeOpacity:"${strokeOpacity}",graphicHeight:"${graphicHeight}",graphicWidth:"${graphicWidth}",graphicName:"${graphicName}",graphicOpacity:g,graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",graphicZIndex:"${graphicZIndex}",externalGraphic:"${externalGraphic}",zIndex:"${zIndex}"},{context:{graphicWidth:function(a){var b=1;a.cluster||(a.attributes.marker_width?
b=a.attributes.marker_width:h&&!l&&void 0==h.externalGraphic&&void 0==f&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=m.marker_default.w:void 0!=f&&(b=f));return b},graphicHeight:function(a){var b=1;a.cluster||(a.attributes.marker_height?b=a.attributes.marker_height:h&&!l&&void 0==h.externalGraphic&&void 0==e&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=m.marker_default.h:void 0!=e&&(b=e));return b},graphicXOffset:function(a){var b=-1;a.cluster||(a.attributes.marker_width?b=-(a.attributes.marker_width/
2):h&&!l&&void 0==h.externalGraphic&&void 0==f&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=-(m.marker_default.w/2):void 0!=f&&(b=-(f/2)));return b},graphicYOffset:function(a){var b=-1;a.cluster||(a.attributes.marker_height?b=-a.attributes.marker_height:h&&!l&&void 0==h.externalGraphic&&void 0==e&&"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?b=-m.marker_default.h:void 0!=e&&(b=-e));return b},graphicName:function(a){var b="circle";a.cluster||(a.attributes.shape?b=a.attributes.shape:
h&&!l&&void 0!=h.graphic&&(b=h.graphic));return b},externalGraphic:function(a){var b="";if(!a.cluster)if(a.attributes.marker_url)b=a.attributes.marker_url;else if(h){if(!l)if(void 0!=h.externalGraphic)b=S3.Ap.concat("/static/"+h.externalGraphic);else if("OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME){if(d)return d;b=E+m.marker_default.i}}else return d;return b},radius:function(a){var b=10;a.cluster?b=Math.min(a.attributes.count/2,8)+10:a.attributes.size?b=a.attributes.size:h&&!l&&(b=h.size);return b},
fill:function(a){var b;a.cluster?b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#"+(m.cluster_fill||"8087ff"):a.attributes.colour?b=a.attributes.colour:h?(l||(b=h.fill),b=void 0!=b?"#"+b:"#000000"):b="#f5902e";return b},fillOpacity:function(a){var b;a.cluster?b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:g:a.attributes.opacity?b=a.attributes.opacity:h&&!l&&(b=h.fillOpacity);return b||g},stroke:function(a){var b;a.cluster?b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:
"#"+(m.cluster_stroke||"2b2f76"):a.attributes.colour?b=a.attributes.colour:h?(l||(b=h.stroke||h.fill),b=void 0!=b?"#"+b:"#000000"):b="#f5902e";return b},strokeOpacity:function(a){var b;a.cluster?b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:g:a.attributes.opacity?b=a.attributes.opacity:h&&!l&&(b=h.strokeOpacity);return b||g},strokeWidth:function(a){var b=2;a.cluster?a.cluster[0].attributes.strokeWidth&&(b=a.cluster[0].attributes.strokeWidth):h&&!l&&(b=h.strokeWidth);return b||
2},label:function(a){var b;a.cluster?m.cluster_label&&1<a.attributes.count&&(b=a.attributes.count):a.layer&&void 0!=a.layer.s3_style&&(a=a.layer.s3_style,!l&&a.show_label&&(b=a.label));return b||""},zIndex:function(a){return"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==a.geometry.CLASS_NAME?5:0},graphicZIndex:function(a){return"OpenLayers.Geometry.Point"==a.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==a.geometry.CLASS_NAME?5:0}}});if(l){var n=S(a);b.addRules(n)}return[new OpenLayers.StyleMap({"default":b,
select:1!=g?{graphicOpacity:1}:{fillColor:"#"+(m.select_fill||"ffdc33"),strokeColor:"#"+(m.select_stroke||"ff9933")}}),d]},S=function(c){var a=[],b,d,e,f,g,h,l,m,n,p,k,r,s;$.each(c.style,function(v,t){var u={};void 0!=t.fallback?(u.title=t.fallback,elsefilter=u.elseFilter=!0):(b=void 0!=t.prop?t.prop:"value",void 0!=t.cat?(e=t.cat,u.title=t.label||e,u.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:b,value:e})):(u.title=t.label||t.low+"-"+t.high,u.filter=
new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,property:b,lowerBoundary:t.low,upperBoundary:t.high})));void 0!=t.externalGraphic?(h=!0,p=!1):void 0!=t.size?(h=!0,p=!1):h=!1;void 0!=t.fill?(p=!1,f="#"+t.fill):void 0!=t.stroke&&(p=!0,f="#"+t.stroke);g=void 0!=t.fillOpacity?t.fillOpacity:c.opacity||1;k=void 0!=t.strokeOpacity?t.strokeOpacity:1;graphic=void 0!=t.graphic?t.graphic:"square";r=void 0!=t.strokeWidth?t.strokeWidth:2;s={fillColor:f,fillOpacity:g,strokeColor:f,strokeOpacity:k,
strokeWidth:r,graphicName:graphic};if(h){if(void 0!=t.externalGraphic){l=S3.Ap.concat("/static/"+t.externalGraphic);var x=new Image;x.src=l;m=x.height;n=x.width;s.externalGraphic=l;s.graphicHeight=m;s.graphicWidth=n;s.graphicXOffset=-(n/2);s.graphicYOffset=-m}s.pointRadius=t.size||10;s.graphicZIndex=10;s.zIndex=10;s.Point=s}else p&&(s.graphicZIndex=5,s.zIndex=5,s.Line=s);u.symbolizer=s;d=new OpenLayers.Rule(u);a.push(d)});0!=c.cluster_threshold&&(d=new OpenLayers.Rule({elseFilter:!0,title:" "}),a.push(d));
return a}})();
