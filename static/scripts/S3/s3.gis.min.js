...
function s3_gis_setCenter(a,b){a=new OpenLayers.LonLat(a[0],a[1]);a.transform(S3.gis.proj4326,S3.gis.projection_current);var c=a.lon,e=a.lat;b=new OpenLayers.LonLat(b[0],b[1]);b.transform(S3.gis.proj4326,S3.gis.projection_current);S3.gis.bounds=OpenLayers.Bounds.fromArray([c,e,b.lon,b.lat]);S3.gis.center=S3.gis.bounds.getCenterLonLat()}function addMap(){map=new OpenLayers.Map("center",S3.gis.options);addLayers();addControls()}
...
leaf:!1,expanded:!0}],b=S3.gis.dirs,c=0;c<b.length;c++){var e={text:b[c],nodeType:"gx_layercontainer",layerStore:S3.gis.mapPanel.layers,loader:{filter:function(a){return function(b){if("undefined"!==b.data.layer.dir)return b.data.layer.dir===a}}(b[c])},leaf:!1,expanded:!0};a.push(e)}a=new Ext.tree.AsyncTreeNode({expanded:!0,children:a});b=i18n.gis_uploadlayer||i18n.gis_properties?new Ext.Toolbar:null;S3.gis.layerTree=new Ext.tree.TreePanel({title:i18n.gis_layers,loader:new Ext.tree.TreeLoader({applyLoader:!1}),
...
function addToolbar(){var a=new Ext.Toolbar({height:34}),b=new GeoExt.Action({control:new OpenLayers.Control.ZoomToMaxExtent,map:map,iconCls:"zoomfull",tooltip:i18n.gis_zoomfull}),c=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox({out:!0}),map:map,iconCls:"zoomout",tooltip:i18n.gis_zoomout,toggleGroup:"controls"}),e=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox,map:map,iconCls:"zoomin",tooltip:i18n.gis_zoomin,toggleGroup:"controls"}),f,d,k;"active"==S3.gis.draw_polygon?(f=!0,
k=d=!1):("active"==S3.gis.draw_feature?(k=!0,d=!1):(d=!0,k=!1),f=!1);S3.gis.panButton=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:map,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:d});a.add(b);navigator.geolocation&&addGeolocateControl(a);void 0===S3.gis.loc_select&&(a.add(c),a.add(e),a.add(S3.gis.panButton),a.addSeparator());void 0===S3.gis.loc_select&&addNavigationControl(a);void 0===S3.gis.loc_select&&S3.auth&&addSaveButton(a);a.addSeparator();
addMeasureControls(a);S3.gis.mgrs_url&&addPdfControl(a);if(S3.gis.draw_feature||S3.gis.draw_polygon)a.addSeparator(),S3.gis.draw_feature&&addPointControl(a,k),S3.gis.draw_polygon&&addPolygonControl(a,f,!0);i18n.gis_get_feature_info&&addWMSGetFeatureInfoControl(a);S3.gis.osm_oauth&&addPotlatchButton(a);S3.gis.Google&&S3.gis.Google.StreetviewButton&&addGoogleStreetviewControl(a);try{S3.gis.Google.Earth&&google&addGoogleEarthControl(a)}catch(p){}i18n.gis_search&&(b=Math.min(350,S3.gis.map_width-680),
...
{isBaseLayer:!0,displayInLayerSwitcher:!0,s3_layer_id:S3.gis.EmptyLayer.id,s3_layer_type:"empty"}),map.addLayer(a),S3.gis.EmptyLayer.base&&map.setBaseLayer(a));try{addJSLayers()}catch(e){}if(S3.gis.layers_theme){b=S3.gis.layers_theme;for(a=b.length;0<a;a--)addGeoJSONLayer(b[a-1])}if(S3.gis.layers_geojson){b=S3.gis.layers_geojson;for(a=b.length;0<a;a--)addGeoJSONLayer(b[a-1])}if(S3.gis.layers_gpx){b=S3.gis.layers_gpx;for(a=b.length;0<a;a--)addGPXLayer(b[a-1])}if(S3.gis.layers_arcrest){b=S3.gis.layers_arcrest;
...
map.getProjectionObject();for(a=0;a<S3.gis.features.length;a++){var f=S3.gis.format_geojson.parseFeature(S3.gis.features[a]);f.geometry.transform(S3.gis.proj4326,b);S3.gis.draftLayer.addFeatures([f])}}}
function addArcRESTLayer(a){var b=a.name,c=[a.url],e;e=void 0!=a.layers?a.layers.join():0;var f;void 0!=a.dir?(f=a.dir,-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)):f="";var d;d=void 0!=a.base?a.base:!1;var k;k=void 0!=a.transparent?a.transparent:!0;var p;p=void 0!=a.visibility?a.visibility:!0;b=new OpenLayers.Layer.ArcGIS93Rest(b,c,{layers:"show:"+e,isBaseLayer:d,transparent:k,dir:f,s3_layer_id:a.id,s3_layer_type:"arcrest"});b.setVisibility(p);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function addDraftLayer(){var a=S3.gis.marker_url+S3.gis.marker_default,b=S3.gis.marker_default_height,c=S3.gis.marker_default_width,e=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);e.graphicOpacity=1;e.graphicWidth=c;e.graphicHeight=b;e.graphicXOffset=-(c/2);e.graphicYOffset=-b;e.externalGraphic=a;S3.gis.draftLayer=new OpenLayers.Layer.Vector(i18n.gis_draft_layer,{style:e,displayInLayerSwitcher:!1});S3.gis.draftLayer.setVisibility(!0);map.addLayer(S3.gis.draftLayer)}
...
function addGeoJSONLayer(a){var b=a.name,c=a.url,e;if(void 0!=a.marker_image){e=S3.gis.marker_url+a.marker_image;var f=a.marker_height,d=a.marker_width}else e="";var k;k=void 0!=a.refresh?a.refresh:900;var p;void 0!=a.dir?(p=a.dir,-1==$.inArray(p,S3.gis.dirs)&&S3.gis.dirs.push(p)):p="";var l;l=void 0!=a.visibility?a.visibility:!0;var h;h=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var g;g=void 0!=a.cluster_threshold?a.cluster_threshold:
S3.gis.cluster_threshold;var n;n=void 0!=a.projection?a.projection:4326;n=4326==n?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+n);var s;s=void 0!=a.type?a.type:"feature";var r=a.style,v=new OpenLayers.Style({label:"${label}",labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:"${fillOpacity}",strokeColor:"${stroke}",strokeWidth:"${strokeWidth}",strokeOpacity:h,graphicWidth:"${graphicWidth}",graphicHeight:"${graphicHeight}",graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",
graphicOpacity:h,graphicName:"${graphicName}",externalGraphic:"${externalGraphic}"},{context:{graphicWidth:function(a){return a.cluster?"":a.attributes.marker_width?a.attributes.marker_width:d},graphicHeight:function(a){return a.cluster?"":a.attributes.marker_height?a.attributes.marker_height:f},graphicXOffset:function(a){return a.cluster?"":a.attributes.marker_width?-(a.attributes.marker_width/2):-(d/2)},graphicYOffset:function(a){return a.cluster?"":a.attributes.marker_height?-a.attributes.marker_height:
-f},graphicName:function(a){return a.cluster?"circle":a.attributes.shape?a.attributes.shape:"circle"},externalGraphic:function(a){var b;if(a.cluster)b="";else if(a.attributes.marker_url)b=a.attributes.marker_url;else if(a.layer&&void 0!=a.layer.s3_style){var c=a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))void 0!=c.external_graphic&&(b=S3.Ap.concat("/static/"+c.external_graphic));else{var d,f;$.each(c,function(c,e){d=void 0!=e.attrib?e.attrib:"value";f=a.attributes[d];if(void 0!=
e.cat){if(f==e.cat)return b=S3.Ap.concat("/static/"+e.external_graphic),!1}else if(f>=e.low&&f<e.high)return b=S3.Ap.concat("/static/"+e.external_graphic),!1})}}return b||e},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:a.attributes.size?a.attributes.size:10},fill:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#8087ff";else if(a.attributes.colour)b=a.attributes.colour;else if(a.layer&&void 0!=a.layer.s3_style){var c=a.layer.s3_style;
if("[object Array]"!==Object.prototype.toString.call(c))b=c.fill;else{var e,d;$.each(c,function(c,f){e=void 0!=f.attrib?f.attrib:"value";d=a.attributes[e];if(void 0!=f.cat){if(d==f.cat)return b=f.fill,!1}else if(d>=f.low&&d<f.high)return b=f.fill,!1})}b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},fillOpacity:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:h;else if(a.attributes.opacity)b=a.attributes.opacity;else if(a.layer&&void 0!=a.layer.s3_style){var c=
a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.fill_opacity;else{var e,d;$.each(c,function(c,f){e=void 0!=f.attrib?f.attrib:"value";d=a.attributes[e];if(void 0!=f.cat){if(d==f.cat)return b=f.fill_opacity,!1}else if(d>=f.low&&d<f.high)return b=f.fill_opacity,!1})}}return b||h},stroke:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#2b2f76";else if(a.attributes.colour)b=a.attributes.colour;else if(a.layer&&void 0!=a.layer.s3_style){var c=
a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.stroke||c.fill;else{var e,f;$.each(c,function(c,d){e=void 0!=d.attrib?d.attrib:"value";f=a.attributes[e];if(void 0!=d.cat){if(f==d.cat)return b=d.stroke||d.fill,!1}else if(f>=d.low&&f<d.high)return b=d.stroke||d.fill,!1})}b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},strokeWidth:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.stroke_width?a.cluster[0].attributes.stroke_width:2;else if(a.layer&&void 0!=a.layer.s3_style){var c=
a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.stroke_width;else{var e,d;$.each(c,function(c,f){e=void 0!=f.attrib?f.attrib:"value";d=a.attributes[e];if(void 0!=f.cat){if(d==f.cat)return b=f.stroke_width,!1}else if(d>=f.low&&d<f.high)return b=f.stroke_width,!1})}}return b||2},label:function(a){var b;if(a.cluster)1<a.attributes.count&&(b=a.attributes.count);else if(a.layer&&void 0!=a.layer.s3_style){var c=a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=
c.label;else{var e,f;$.each(c,function(c,d){e=void 0!=d.attrib?d.attrib:"value";f=a.attributes[e];if(void 0!=d.cat){if(f==d.cat)return b=d.label,!1}else if(f>=d.low&&f<d.high)return b=d.label,!1})}}return b||""}}});if("[object Array]"===Object.prototype.toString.call(r)){var t=[],u,w,y,z,x;$.each(r,function(a,b){u=void 0!=b.attrib?b.attrib:"value";void 0!=b.cat?(x=b.cat,y=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:u,value:x})):(x=b.low+"-"+b.high,y=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,
property:u,lowerBoundary:b.low,upperBoundary:b.high}));void 0!=b.fill?w="#"+b.fill:void 0!=b.stroke&&(w="#"+b.stroke);z=new OpenLayers.Rule({filter:y,symbolizer:{fillColor:w,strokeColor:w,graphicName:"square",pointRadius:10},title:x});t.push(z)});v.addRules(t)}v=new OpenLayers.StyleMap({"default":v,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:p,projection:n,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,
interval:1E3*k}),new OpenLayers.Strategy.AttributeCluster({attribute:"colour",distance:m,threshold:g})],legendURL:e,s3_layer_id:a.id,s3_layer_type:s,s3_style:r,styleMap:v,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_geojson})});a.setVisibility(l);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
...
function addGPXLayer(a){var b=a.name,c=a.url,e=S3.gis.marker_url+a.marker_image,f=a.marker_height,d=a.marker_width,k;k=void 0!=a.waypoints?a.waypoints:!0;var p;p=void 0!=a.tracks?a.tracks:!0;var l;l=void 0!=a.routes?a.routes:!0;var h;h=void 0!=a.visibility?a.visibility:!0;var m;void 0!=a.dir?(m=a.dir,-1==$.inArray(m,S3.gis.dirs)&&S3.gis.dirs.push(m)):m="";var g;g=void 0!=a.opacity?a.opacity:1;var n;n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var s;s=void 0!=a.cluster_threshold?
a.cluster_threshold:S3.gis.cluster_threshold;var r=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);k?(r.graphicOpacity=g,r.graphicWidth=d,r.graphicHeight=f,r.graphicXOffset=-(d/2),r.graphicYOffset=-f,r.externalGraphic=e):r.externalGraphic="";r.strokeColor="blue";r.strokeWidth=6;r.strokeOpacity=g;a=new OpenLayers.Layer.Vector(b,{dir:m,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:n,threshold:s})],s3_layer_id:a.id,
s3_layer_type:"gpx",legendURL:e,style:r,protocol:new OpenLayers.Protocol.HTTP({url:c,format:new OpenLayers.Format.GPX({extractAttributes:!0,extractWaypoints:k,extractTracks:p,extractRoutes:l})})});a.setVisibility(h);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addKMLLayer(a){var b=a.name,c=a.url,e=S3.gis.marker_url+a.marker_image,f;f=void 0!=a.title?a.title:"name";var d;d=void 0!=a.body?a.body:"description";var k;k=void 0!=a.refresh?a.refresh:900;var p;p=void 0!=a.visibility?a.visibility:!0;var l;void 0!=a.dir?(l=a.dir,-1==$.inArray(l,S3.gis.dirs)&&S3.gis.dirs.push(l)):l="";var h;h=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var g;g=void 0!=a.cluster_threshold?a.cluster_threshold:
S3.gis.cluster_threshold;S3.gis.image=new Image;S3.gis.image.onload=s3_gis_scaleImage;S3.gis.image.src=e;h=new OpenLayers.Style({label:"${label}",labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:h,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:h,graphicWidth:"${graphicWidth}",graphicHeight:"${graphicHeight}",graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",graphicOpacity:h,graphicName:"circle",externalGraphic:"${externalGraphic}"},{context:{graphicWidth:function(a){return a.cluster?
"":S3.gis.image.width},graphicHeight:function(a){return a.cluster?"":S3.gis.image.height},graphicXOffset:function(a){return a.cluster?"":-(S3.gis.image.width/2)},graphicYOffset:function(a){return a.cluster?"":-S3.gis.image.height},externalGraphic:function(a){return a.cluster?"":e},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:10},fill:function(a){return a.cluster?"#8087ff":"#f5902e"},stroke:function(a){return a.cluster?"#2b2f76":"#f5902e"},label:function(a){var b="";a.cluster&&
1<a.attributes.count&&(b=a.attributes.count);return b}}});h=new OpenLayers.StyleMap({"default":h,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:l,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:m,threshold:g}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*k})],s3_layer_id:a.id,s3_layer_type:"kml",legendURL:e,styleMap:h,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_kml})});
a.title=f;a.body=d;a.setVisibility(p);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}var s3_gis_scaleImage=function(){var a=S3.gis.image.height/S3.gis.image.width,b=Math.min(S3.gis.image.width,S3.gis.max_w),a=b*a;a>S3.gis.max_h&&(a=S3.gis.max_h,b*=b/a);S3.gis.image.height=a;S3.gis.image.width=b};
function addOSMLayer(a){var b=a.name,c=[a.url1];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var e;e=void 0!=a.visibility?a.visibility:!0;var f;void 0!=a.dir?(f=a.dir,-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)):f="";b=new OpenLayers.Layer.TMS(b,c,{dir:f,type:"png",getURL:osm_getTileURL,displayOutsideMaxExtent:!0,numZoomLevels:void 0!=a.zoomLevels?a.zoomLevels:19,isBaseLayer:void 0!=a.base?a.base:!0,s3_layer_id:a.id,s3_layer_type:"openstreetmap"});void 0!=a.attribution&&(b.attribution=
a.attribution);b.setVisibility(e);map.addLayer(b);a._base&&map.setBaseLayer(b)}function osm_getTileURL(a){var b=this.map.getResolution(),c=Math.round((a.left-this.maxExtent.left)/(b*this.tileSize.w));a=Math.round((this.maxExtent.top-a.top)/(b*this.tileSize.h));var b=this.map.getZoom(),e=Math.pow(2,b);if(0>a||a>=e)return OpenLayers.Util.getImagesLocation()+"404.png";c=b+"/"+(c%e+e)%e+"/"+a+"."+this.type;a=this.url;a instanceof Array&&(a=this.selectUrl(c,a));return a+c}
...
function addTMSLayer(a){var b=a.name,c=[a.url];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var e=a.layername,f;f=void 0!=a.zoomLevels?a.zoomLevels:19;var d;void 0!=a.dir?(d=a.dir,-1==$.inArray(d,S3.gis.dirs)&&S3.gis.dirs.push(d)):d="";b=new OpenLayers.Layer.TMS(b,c,{dir:d,s3_layer_id:a.id,s3_layer_type:"tms",layername:e,type:void 0!=a.format?a.format:"png",numZoomLevels:f});void 0!=a.attribution&&(b.attribution=a.attribution);map.addLayer(b);a._base&&map.setBaseLayer(b)}
function addWFSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var e=a.title,f=a.featureType,d=a.featureNS,k=a.schema,p;p=void 0!=a.version?a.version:"1.1.0";var l;l=void 0!=a.geometryName?a.geometryName:"the_geom";var h;h=void 0!=a.styleField?a.styleField:"";var m;m=void 0!=a.styleValues?a.styleValues:{};var g;g=void 0!=a.visibility?a.visibility:!0;var n;void 0!=a.dir?(n=a.dir,-1==$.inArray(n,S3.gis.dirs)&&S3.gis.dirs.push(n)):
n="";var s;s=void 0!=a.opacity?a.opacity:1;var r;r=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var v;v=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;var t,u;void 0!=a.projection?(t=a.projection,u="EPSG:"+t):(t="4326",u="EPSG:4326");c=new OpenLayers.Protocol.WFS({version:p,srsName:u,url:c,featureType:f,featureNS:d,geometryName:l,schema:k});f={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b=
"#f5902e";a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}};h&&m&&(f.context.fill=function(a){var b;$.each(m,function(c,e){c==a.attributes[h]&&(b=e)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},f.context.stroke=function(a){var b;$.each(m,function(c,e){c==a.attributes[h]&&(b=e)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b});s=new OpenLayers.Style({label:"${label}",
labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:s/2,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:s},f);s=new OpenLayers.StyleMap({"default":s,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});t="4326"==t?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+t);a=new OpenLayers.Layer.Vector(b,{maxFeatures:1E3,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Cluster({distance:r,threshold:v})],dir:n,s3_layer_id:a.id,s3_layer_type:"wfs",projection:t,
protocol:c,styleMap:s});a.title=e;a.setVisibility(g);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addWMSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var e=a.layers,f;f=void 0!=a.visibility?a.visibility:!0;var d;void 0!=a.dir?(d=a.dir,-1==$.inArray(d,S3.gis.dirs)&&S3.gis.dirs.push(d)):d="";var k;k=void 0!=a.base?a.base:!1;var p;p=void 0!=a.transparent?a.transparent:!0;var l;l=void 0!=a.format?a.format:"image/png";var h;h=void 0!=a.version?a.version:"1.1.1";var m;m=void 0!=a.map?a.map:"";var g;g=void 0!=a.style?
a.style:"";var n;n=void 0!=a.bgcolor?"0x"+a.bgcolor:"";var s;s=void 0!=a.buffer?a.buffer:0;var r;r=void 0!=a.tiled?a.tiled:!1;var v;v=void 0!=a.opacity?a.opacity:1;var t;t=void 0!=a.queryable?a.queryable:1;var u;void 0!=a.legendURL&&(u=a.legendURL);b=new OpenLayers.Layer.WMS(b,c,{layers:e,transparent:p},{dir:d,wrapDateLine:!0,isBaseLayer:k,s3_layer_id:a.id,s3_layer_type:"wms",queryable:t,visibility:f});m&&(b.params.MAP=m);l&&(b.params.FORMAT=l);h&&(b.params.VERSION=h);g&&(b.params.STYLES=g);n&&(b.params.BGCOLOR=
n);r&&(b.params.TILED=!0,b.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom]);k||(b.opacity=v,b.buffer=s?s:0);u&&(b.legendURL=u);map.addLayer(b);a._base&&map.setBaseLayer(b)}
function addXYZLayer(a){var b=a.name,c=[a.url];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var e=a.layername,f;f=void 0!=a.zoomLevels?a.zoomLevels:19;var d;void 0!=a.dir?(d=a.dir,-1==$.inArray(d,S3.gis.dirs)&&S3.gis.dirs.push(d)):d="";b=new OpenLayers.Layer.XYZ(b,c,{dir:d,s3_layer_id:a.id,s3_layer_type:"xyz",layername:e,type:void 0!=a.format?a.format:"png",numZoomLevels:f});void 0!=a.attribution&&(b.attribution=a.attribution);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function s3_gis_loadDetails(a,b,c){$.ajax({url:a,success:function(a){$("#"+b).html(a);c.updateSize()},error:function(a,f,d){msg="UNAUTHORIZED"==d?i18n.gis_requires_login:a.responseText;$("#"+b+"_contentDiv").html(msg);c.updateSize()},dataType:"html"})}
function onFeatureSelect(a){s3_gis_tooltipUnselect(a);a=a.feature;var b=a.layer,c=b.s3_layer_type,e=a.geometry.getBounds().getCenterLonLat(),f=S3.uid(),b=void 0!=b.title?b.title:"name",d,k,p;if(a.cluster){var l=a.cluster;d=i18n.gis_cluster_multiple+":<ul>";for(var h=l.length,m=0;m<h;m++){var g=l[m].attributes,c=void 0!=g.popup?g.popup.split("<br />",1)[0]:g[b];d=void 0!=g.url?d+("<li><a href='javascript:s3_gis_loadClusterPopup(\""+g.url+'", "'+f+"\")'>"+c+"</a></li>"):d+("<li>"+c+"</li>")}d+="</ul>";
d+="<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+e.lon+","+e.lat+", 3)'>Zoom in</a></div>"}else if("kml"==c){g=a.attributes;if(void 0!=a.style.balloonStyle)d=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,b){var c=g[b];return"string"===typeof c||"number"===typeof c?c:a});else{l=typeof g[b];c="object"==l?g[b].value:g[b];d="<h3>"+c+"</h3>";for(var c=a.layer.body.split(" "),n,b=0;b<c.length;b++)l=typeof g[c[b]],"object"==l?(l=g[c[b]].displayName,""===l&&(l=c[b]),h=g[c[b]].value,
n='<div class="gis_popup_row"><div class="gis_popup_label">'+l+':</div><div class="gis_popup_cell">'+h+"</div></div>"):n=void 0!=g[c[b]]?'<div class="gis_popup_row">'+g[c[b]]+"</div>":"",d+=n}-1!=d.search("<script")&&(d="Content contained Javascript! Escaped content below.<br />"+d.replace(/</g,"<"))}else if("gpx"!=c)if("shapefile"==c)g=a.attributes,d="<div>",$.each(g,function(a,b){"id_orig"==a&&(a="id");n='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+
b+"</div></div>";d+=n}),d+="</div>";else if("wfs"==c)g=a.attributes,c=g[b],d="<h3>"+c+"</h3>",$.each(g,function(a,b){n='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";d+=n});else if(void 0!=a.attributes.url)p=a.attributes.url,d=i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 />";else{g=a.attributes;c=void 0==g.name?"":"<h3>"+g.name+"</h3>";b=void 0==g.description?"":"<p>"+g.description+"</p>";l=void 0==g.link?"":'<a href="'+
g.link+'" target="_blank">'+g.link+"</a>";if(void 0==g.data)h="";else if(0===g.data.indexOf("http://")){k=!0;var s=S3.uid(),h='<div id="'+s+'">'+i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 /></div>"}else h="<p>"+g.data+"</p>";m=void 0==g.image?"":0===g.image.indexOf("http://")?'<img src="'+g.image+'" height=300 width=300>':"";d=c+b+l+h+m}e=new OpenLayers.Popup.FramedCloud(f,e,new OpenLayers.Size(200,200),d,null,!0,onPopupClose);void 0!=p?s3_gis_loadDetails(p,f+"_contentDiv",e):
k&&s3_gis_loadDetails(a.attributes.data,s,e);a.popup=e;map.addPopup(e)}
...
function s3_gis_tooltipSelect(a){a=a.feature;if(!a.cluster&&null===a.popup){null!==S3.gis.tooltipPopup&&void 0!==S3.gis.tooltipPopup&&(map.removePopup(S3.gis.tooltipPopup),S3.gis.tooltipPopup.destroy(),null!==S3.gis.lastFeature&&delete S3.gis.lastFeature.popup,S3.gis.tooltipPopup=null);S3.gis.lastFeature=a;var b=a.geometry.getBounds().getCenterLonLat(),c=a.attributes,e;void 0!=c.popup?e=c.popup:void 0!=c.name?e=c.name:void 0!=a.layer.title&&(e=c[a.layer.title],e="object"==typeof e?e.value:e);e&&(S3.gis.tooltipPopup=
new OpenLayers.Popup("activetooltip",b,new OpenLayers.Size(80,12),e,!1));null!==S3.gis.tooltipPopup&&void 0!==S3.gis.tooltipPopup&&(S3.gis.tooltipPopup.contentDiv.style.backgroundColor="ffffcb",S3.gis.tooltipPopup.contentDiv.style.overflow="hidden",S3.gis.tooltipPopup.contentDiv.style.padding="3px",S3.gis.tooltipPopup.contentDiv.style.margin="10px",S3.gis.tooltipPopup.closeOnMove=!0,S3.gis.tooltipPopup.autoSize=!0,S3.gis.tooltipPopup.opacity=0.7,a.popup=S3.gis.tooltipPopup,map.addPopup(S3.gis.tooltipPopup))}}
...
function addGeolocateControl(a){var b=S3.gis.draftLayer,c={fillColor:"#000",fillOpacity:0.1,strokeWidth:0},e=new OpenLayers.Control.Geolocate({geolocationOptions:{enableHighAccuracy:!1,maximumAge:0,timeout:7E3}});map.addControl(e);e.events.register("locationupdated",this,function(a){b.removeAllFeatures();var e=new OpenLayers.Feature.Vector(OpenLayers.Geometry.Polygon.createRegularPolygon(new OpenLayers.Geometry.Point(a.point.x,a.point.y),a.position.coords.accuracy/2,40,0),{},c);b.addFeatures([new OpenLayers.Feature.Vector(a.point,
{},{graphicName:"cross",strokeColor:"#f00",strokeWidth:2,fillOpacity:0,pointRadius:10}),e]);map.zoomToExtent(b.getDataExtent());s3_gis_pulsate(e)});e.events.register("locationfailed",this,function(){OpenLayers.Console.log("Location detection failed")});S3.gis.geolocateControl=e;e=new Ext.Toolbar.Button({iconCls:"geolocation",tooltip:i18n.gis_geoLocate,handler:function(){S3.gis.draftLayer.removeAllFeatures();S3.gis.geolocateControl.activate()}});a.addButton(e)}
function s3_gis_pulsate(a){var b=a.geometry.getCentroid(),c=a.geometry.getBounds(),e=Math.abs((c.right-c.left)/2),f=0,d="up";window.resizeInterval=window.setInterval(function(){16<f&&clearInterval(window.resizeInterval);var c=0.03*e/e;switch(f){case 4:case 12:d="down";break;case 8:d="up"}"up"!==d&&(c=-Math.abs(c));a.geometry.resize(1+c,b);S3.gis.draftLayer.drawFeature(a);f++},50,b,e)}
...
function addSaveButton(a){var b=new Ext.Toolbar.Button({iconCls:"save",tooltip:i18n.gis_save,handler:function(){var a=getState(),b=Ext.util.JSON.encode(a.layers),f=Ext.util.JSON.encode(a.plugins),d;d=S3.gis.config_id?S3.Ap.concat("/gis/config/"+S3.gis.config_id+".url/update"):S3.Ap.concat("/gis/config.url/create");Ext.Ajax.request({url:d,method:"POST",success:function(a,b){var c=Ext.decode(a.responseText).message.split("=",2)[1];c&&(S3.gis.config_id=c,c=S3.Ap.concat("/gis/config/",c,"/layer_entity"),
$("#gis_menu_config").attr("href",c))},params:{lat:a.lat,lon:a.lon,zoom:a.zoom,layers:b,plugins:f}})}});a.addSeparator();a.addButton(b)}
function getState(){var a={},b=map.getCenter();b.transform(map.getProjectionObject(),S3.gis.proj4326);a.lon=b.lon;a.lat=b.lat;a.zoom=map.getZoom();var c=[],e,f,d=map.baseLayer.s3_layer_id;Ext.iterate(map.layers,function(a,b,h){e=a.s3_layer_id;f={id:e};a.visibility&&(f.visible=a.visibility);e==d&&(f.base=!0);a.s3_style&&(f.style=a.s3_style);c.push(f)});a.layers=c;var k=[];Ext.iterate(S3.gis.plugins,function(a,b,c){a.getState&&k.push(a.getState())});a.plugins=k;return a}
function addPdfControl(a){selectPdfControl=new OpenLayers.Control;OpenLayers.Util.extend(selectPdfControl,{draw:function(){this.box=new OpenLayers.Handler.Box(this,{done:this.getPdf});this.box.activate()},response:function(a){this.w.destroy();a=(new OpenLayers.Format.GML).read(a.responseText);var b=a.length+" pdfs. <br /><ul>";if(a.length)for(var f=0;f<a.length;f++)var d=a[f],b=b+("<li><a href='"+a[f].attributes.url+"'>"+(d.attributes.utm_zone+d.attributes.grid_zone+d.attributes.grid_square+d.attributes.easting+
...
function addLayerPropertiesButton(){var a=new Ext.Toolbar.Button({iconCls:"gxp-icon-layerproperties",tooltip:i18n.gis_properties,handler:function(){var a=S3.gis.layerTree.root.findChildBy(function(a){return a.isSelected()?a.leaf?!0:!1:!1},null,!0);if(a){var c=a.layer.s3_layer_type,e=S3.Ap.concat("/gis/layer_"+c+".plain?layer_"+c+".layer_id="+a.layer.s3_layer_id+"&update=1");Ext.Ajax.request({url:e,method:"GET",success:function(e,d){S3.gis.propertiesWindow&&S3.gis.propertiesWindow.close();var k;"feature"==
c?(k=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:e.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),k.items.items[1].on("activate",function(){var c;Ext.iterate(S3.gis.layers_features,function(d,e,f){d.id==a.layer.s3_layer_id&&(c=d.url.replace(/.geojson.+/,"/search.plain"))});Ext.get("s3_gis_layer_filter_tab").load({url:c,discardUrl:!1,callback:function(){S3.addTooltips();S3.search.select_letter_label()},text:"Loading...",timeout:30,scripts:!1})})):k=new Ext.Panel({title:"Layer Properties",
html:e.responseText});S3.gis.propertiesWindow=new Ext.Window({width:400,layout:"fit",items:[k]});S3.gis.propertiesWindow.show();$("#plain form").submit(function(){var a=$('#plain input[name="id"]').val(),a=S3.Ap.concat("/gis/layer_"+c+"/"+a+".plain/update"),b=$("#plain input"),d=[];Ext.iterate(b,function(a,b,c){b.id&&-1!=b.id.indexOf("gis_layer_")&&d.push(b.id)});b=[];for(i=0;i<d.length;i++)(q=$("#"+d[i]).serialize())&&b.push(q);(q=$('#plain input[name="id"]').serialize())&&b.push(q);(q=$('#plain input[name="_formkey"]').serialize())&&
