...
items:[a.mapPanel],activeItem:0,tbar:d,scope:this});return a.mapPanelContainer=b},ta=function(b){GeoExt.tree.LayerNodeUIS3=Ext.extend(GeoExt.tree.LayerNodeUI,{onClick:function(x){if(x.getTarget(".x-tree-node-cb",1)){var D=this.node,G=D.attributes,J=G.checkedGroup;J&&"baselayer"!==J?(J=!G.checked,G.checked=J,D.ui.checkbox.checked=J,D.layer.setVisibility(J),this.enforceOneVisible()):this.toggleCheck(this.isChecked())}else GeoExt.tree.LayerNodeUI.superclass.onClick.apply(this,arguments)},enforceOneVisible:function(){var x=
this.node.attributes,D=x.checkedGroup;if(D&&"baselayer"!==D){var G=this.node.layer,J=this.node.getOwnerTree().getChecked();Ext.each(J,function(K){var R=K.layer;K.hidden||K.attributes.checkedGroup!==D||R!=G&&x.checked&&R.setVisibility(!1)})}}});GeoExt.tree.LayerNodeS3=Ext.extend(GeoExt.tree.LayerNode,{constructor:function(){this.defaultUI=GeoExt.tree.LayerNodeUIS3;GeoExt.tree.LayerNodeS3.superclass.constructor.apply(this,arguments)}});Ext.tree.TreePanel.nodeTypes.gx_layer=GeoExt.tree.LayerNodeS3;var a=
b.s3,c=a.options;var d=c.hide_base?!1:!0;var e=c.hide_overlays?!1:!0;var g=c.folders_closed?!1:!0;var f=c.folders_radio?!0:!1;var k=c.wms_browser_url||c.legend&&"float"!=c.legend?!0:!1;var l=a.mapPanel.layers,n=[],h={click:function(x){var D=x.attributes;if("baselayer"==D.checkedGroup)x.ui.toggleCheck(!x.ui.isChecked());else{var G=!D.checked;D.checked=G;x.ui.checkbox.checked=G;x.layer.setVisibility(G)}}},m=function(){var x=a.westPanelContainer;x.fireEvent("collapse");window.setTimeout(function(){x.fireEvent("expand")},
...
0;A<H;A++){var B=0==A?d:B[E];var E=I[A];B.hasOwnProperty(E)||(B[E]={})}}for(u in d){E=d[u];B=[];for(C in E)E={listeners:h},f&&(E.checkedGroup=C),E=new GeoExt.tree.LayerLoaderS3({baseAttrs:E,filter:function(x,D){return function(G){if("undefined"!==G.data.layer.dir)return G.data.layer.dir===x+"/"+D}}(u,C)}),E={text:C,nodeType:"gx_layercontainer",layerStore:l,children:[],loader:E,leaf:!1,listeners:w,singleClickExpand:!0,expanded:g},B.push(E);E={listeners:h};f&&(E.checkedGroup=u);E=new GeoExt.tree.LayerLoaderS3({baseAttrs:E,
filter:function(x){return function(D){if("undefined"!==D.data.layer.dir)return D.data.layer.dir===x}}(u)});E={text:u,nodeType:"gx_layercontainer",layerStore:l,children:B,loader:E,leaf:!1,listeners:w,singleClickExpand:!0,expanded:g};n.push(E)}}g=new Ext.tree.AsyncTreeNode({expanded:!0,children:n});f=(c=c.clearlayers&"toolbar"!=c.clearlayers)||i18n.gis_properties||i18n.gis_uploadlayer?new Ext.Toolbar:null;k=new Ext.tree.TreePanel({title:i18n.gis_layers,loaderloader:new Ext.tree.TreeLoader({applyLoader:!1}),
root:g,rootVisible:!1,split:!0,collapsible:k,collapseMode:"mini",lines:!1,tbar:f,enableDD:!1});new Ext.tree.TreeSorter(k,{sortType:function(x,D){return"gx_baselayercontainer"==D.attributes.nodeType?" ":"gx_overlaylayercontainer"==D.attributes.nodeType?"!":D.text}});i18n.gis_uploadlayer&&za(b,k);i18n.gis_properties&&Aa(b,k);c&&ea(b,k.getTopToolbar());return k},ua=function(b){var a=b.s3.options,c=new Ext.tree.AsyncTreeNode({expanded:!0,loader:new GeoExt.tree.WMSCapabilitiesLoader({url:OpenLayers.ProxyHost+
...
k){f=a.features;d=f.length;for(b=0;b<d;b++)a.drawFeature(f[b]);if(k=a.map.s3.mapPanel.legendPanel)for(c=k.items.items,f=c.length,d=a.s3_layer_id,b=0;b<f;b++)if(a=c[b],a.layer&&a.layer.s3_layer_id==d){void 0!==r?"gx_vectorlegend"==a.xtype?(a.rules=r,a.update()):(r=a.layerRecord,k.removeLegend(r),k.addLegend(r,b)):void 0!==l&&("gx_urllegend"==a.xtype?(a.layerRecord.data.legendURL=l,a.update()):(r=a.layerRecord,r.data.legendURL=l,k.removeLegend(r),k.addLegend(r,b)));break}}}else P(a)},Ba=function(b){var a=
b.s3_style[0],c=a.prop,d=b.features,e=d.length,g,f=[];for(g=0;g<e;g++)f.push(d[g].attributes[c]);f.sort(function(m,w){return m-w});var k={};$.each(f,function(){k[this]=1});c=Object.keys(k).length;if(5<=c){c=5;var l=["ffffb2","fecc5c","fd8d3c","f03b20","bd0026"]}else 4==c?l=["ffffb2","fecc5c","fd8d3c","e31a1c"]:3==c?l=["ffeda0","feb24c","f03b20"]:2==c?l=["ffeda0","f03b20"]:1==c&&(l=["feb24c"]);var n=Math.round(e/c),h=n;d=[f[0]];for(g=1;g<c;g++)d[g]=f[h]||f[e-1],h+=n;d.push(f[e-1]);h=[];for(g=0;g<c;g++)e=
d[g],f=d[g+1],n=$.extend({},a),n.fill=l[g],n.low=e,n.high=f,n.label=e==f?e.toString():e+" - "+f,h.push(n);a=fa({style:h,cluster_threshold:0,opacity:.9});return b.styleMap.styles["default"].rules=a},S=function(b){ha(b.object.map)},ra=function(b){var a=b.s3,c=a.options;a.dirs=[];a.layers_loading=[];a.layers_nopopups=[];if(c.layers_osm){var d=c.layers_osm;for(a=d.length;0<a;a--)Ca(b,d[a-1])}try{c.Google&&Da(b)}catch(g){}c.Bing&&Ea(b);if(c.layers_tms)for(d=c.layers_tms,a=d.length;0<a;a--)Fa(b,d[a-1]);
...
return b.s3.draftLayer=c},O=function(b,a){var c=b.s3,d=a.name;a.no_popups&&c.layers_nopopups.push(d);var e=a.url;var g=-1!==e.indexOf("$search")?!0:!1;var f=void 0!==a.refresh?a.refresh:900;if(void 0!==a.dir){var k=a.dir;-1==$.inArray(k,c.dirs)&&c.dirs.push(k)}else k="";c=void 0!==a.visibility?a.visibility:!0;var l=void 0!==a.cluster_attribute?a.cluster_attribute:"colour";var n=void 0!==a.cluster_distance?a.cluster_distance:20;var h=void 0!==a.cluster_threshold?a.cluster_threshold:2;var m=void 0!==
a.projection?a.projection:4326;m=4326==m?q:new OpenLayers.Projection("EPSG:"+m);var w=void 0!==a.type?a.type:"feature";var r='<div class="gis_layer_legend"><div class="gis_legend_title">'+d+"</div>";void 0!==a.desc&&(r+='<div class="gis_legend_desc">'+a.desc+"</div>");if(void 0!==a.src||void 0!==a.src_url){var v='<div class="gis_legend_src">';void 0!==a.src_url?(v+='<a href="'+a.src_url+'" target="_blank">',v=void 0!==a.src?v+a.src:v+a.src_url,v+="</a>"):v+=a.src;r+=v+"</div>"}r+="</div>";var A=Q(b,
a);v=A[0];A=A[1];var C=[new OpenLayers.Strategy.ZoomBBOX({ratio:1.5})];f&&C.push(new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*f}));(h||a.cluster)&&C.push(new OpenLayers.Strategy.AttributeCluster({attribute:l,distance:n,threshold:h}));d=new OpenLayers.Layer.Vector(d,{dir:k,projection:m,protocol:new OpenLayers.Protocol.HTTP({url:e,format:p,readWithPOST:g}),legendURL:A,strategies:C,styleMap:v,s3_layer_id:a.id,s3_layer_type:w,s3_style:a.style,s3_url_format:a.url_format});d.legendTitle=r;void 0!==
a.popup_format&&(d.s3_popup_format=a.popup_format);d.setVisibility(c);d.events.on({loadstart:L,loadend:M,visibilitychanged:S});b.addLayer(d)},Da=function(b){var a=b.s3.options.Google;if(a.MapMaker||a.MapMakerHybrid){if(a.Satellite){var c=new OpenLayers.Layer.Google(a.Satellite.name,{type:G_SATELLITE_MAP,sphericalMercator:!0,s3_layer_id:a.Satellite.id,s3_layer_type:"google"});b.addLayer(c);"satellite"==a.Base&&b.setBaseLayer(c)}a.Maps&&(c=new OpenLayers.Layer.Google(a.Maps.name,{type:G_NORMAL_MAP,
...
a.dir){var n=a.dir;-1==$.inArray(n,d.dirs)&&d.dirs.push(n)}else n="";d=void 0!==a.cluster_distance?a.cluster_distance:20;var h=void 0!==a.cluster_threshold?a.cluster_threshold:2;var m=Q(b,a)[0],w=new OpenLayers.Format.KML({extractStyles:!0,extractAttributes:!0,maxDepth:2}),r=[new OpenLayers.Strategy.Fixed];k&&r.push(new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*k}));h&&r.push(new OpenLayers.Strategy.Cluster({distance:d,threshold:h}));a=new OpenLayers.Layer.Vector(c,{dir:n,projection:q,protocol:new OpenLayers.Protocol.HTTP({url:e,
...
f.events.on({loadstart:L,loadend:M});b.addLayer(f);a._base&&b.setBaseLayer(f)},Na=function(b,a){var c=a.featureType,d,e=a.name,g=a.title,f=a.url;void 0!==a.username&&void 0!==a.password&&(f=f.replace("://","://"+a.username+":"+a.password+"@"));var k=void 0!==a.featureNS?a.featureNS:null;if(void 0!==a.schema)var l=a.schema;var n=void 0!==a.version?a.version:"1.1.0";var h=void 0!==a.geometryName?a.geometryName:"the_geom";var m=void 0!==a.visibility?a.visibility:!0;if(void 0!==a.dir){var w=a.dir;-1==
$.inArray(w,b.s3.dirs)&&b.s3.dirs.push(w)}else w="";var r=void 0!==a.cluster_attribute?a.cluster_attribute:"colour";var v=void 0!==a.cluster_distance?a.cluster_distance:20;var A=void 0!==a.cluster_threshold?a.cluster_threshold:2;var C=void 0!==a.refresh?a.refresh:!1;var u=[new OpenLayers.Strategy.BBOX({ratio:1.5})];C&&u.push(new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*C}));A&&u.push(new OpenLayers.Strategy.AttributeCluster({attribute:r,distance:v,threshold:A}));r=void 0!==a.projection?
a.projection:4326;"1.0.0"==n?v="EPSG:"+r:(v="urn:ogc:def:crs:EPSG::"+r,S3.gis.yx.includes(r)&&(d=new OpenLayers.Format.WFST({version:n,featureType:c,featureNS:k,featurePrefix:"feature",geometryName:h,srsName:v,schema:l,xy:!1})));c=new OpenLayers.Protocol.WFS({url:f,version:n,featureType:c,featureNS:k,format:d,geometryName:h,srsName:v,schema:l});k='<div class="gis_layer_legend"><div class="gis_legend_title">'+e+"</div>";void 0!==a.desc&&(k+='<div class="gis_legend_desc">'+a.desc+"</div>");if(void 0!==
a.src||void 0!==a.src_url)d='<div class="gis_legend_src">',void 0!==a.src_url?(d+='<a href="'+a.src_url+'" target="_blank">',d=void 0!==a.src?d+a.src:d+a.src_url,d+="</a>"):d+=a.src,k+=d+"</div>";k+="</div>";h=Q(b,a);d=h[0];h=h[1];r=4326==r?q:new OpenLayers.Projection("EPSG:"+r);a=new OpenLayers.Layer.Vector(e,{maxFeatures:1E3,strategies:u,dir:w,legendURL:h,projection:r,protocol:c,styleMap:d,s3_layer_id:a.id,s3_layer_type:"wfs",s3_style:a.style});a.legendTitle=k;a.title=g;a.setVisibility(m);a.events.on({loadstart:L,
...
a.style?a.style:"";var r=void 0!==a.bgcolor?"0x"+a.bgcolor:"";var v=void 0!==a.buffer?a.buffer:0;var A=void 0!==a.tiled?a.tiled:!1;var C=void 0!==a.singleTile?a.singleTile:!1;var u=void 0!==a.opacity?a.opacity:1;var I=void 0!==a.queryable?a.queryable:1;var H='<div class="gis_layer_legend"><div class="gis_legend_title">'+c+"</div>";void 0!==a.desc&&(H+='<div class="gis_legend_desc">'+a.desc+"</div>");if(b.s3.options.metadata){if(void 0!==a.post_id)if(i18n.gis_metadata){var B=i18n.gis_metadata;var E=
S3.Ap.concat("/cms/page/"+a.post_id)}else B=i18n.gis_metadata_edit,E=S3.Ap.concat("/cms/post/"+a.post_id+"/update?layer_id="+a.id);else i18n.gis_metadata_create&&(B=i18n.gis_metadata_create,E=S3.Ap.concat("/cms/post/create?layer_id="+a.id));B&&(H+='<div class="gis_legend_src"><a href="'+E+'" target="_blank">'+B+"</a></div>")}else if(void 0!==a.src||void 0!==a.src_url)B='<div class="gis_legend_src">',void 0!==a.src_url?(B+='<a href="'+a.src_url+'" target="_blank">',B=void 0!==a.src?B+a.src:B+a.src_url,
B+="</a>"):B+=a.src,H+=B+"</div>";H+="</div>";if(void 0!==a.legendURL)var x=a.legendURL;f=new OpenLayers.Layer.WMS(c,d,{layers:e,transparent:l},{dir:f,isBaseLayer:k,singleTile:C,wrapDateLine:!0,s3_layer_id:a.id,s3_layer_type:"wms",queryable:I,visibility:g});m&&(f.params.MAP=m);n&&(f.params.FORMAT=n);h&&(f.params.VERSION=h);w&&(f.params.STYLES=w);r&&(f.params.BGCOLOR=r);A&&(f.params.TILESORIGIN=[b.maxExtent.left,b.maxExtent.bottom]);k||(f.opacity=u,f.buffer=v?v:0);f.legendTitle=H;x&&(f.legendURL=x);
...
l;if("OpenLayers.Geometry.Point"!=k.CLASS_NAME)for(d=0,l=e.clicking.length;d<l;++d)if("OpenLayers.Geometry.Point"==e.clicking[d].geometry.CLASS_NAME)return;ia(b);a.renderIntent="select";c.drawFeature(a);k=k.getBounds().getCenterLonLat();l=a.id+"_popup";b=void 0!==c.title?c.title:"name";if(a.cluster){var n=a.cluster;var h=i18n.gis_cluster_multiple+":<ul>";var m=n.length,w=e.id;for(d=0;d<m;d++){var r=n[d].attributes;if(void 0!==c.s3_popup_format){_.templateSettings={interpolate:/\{(.+?)\}/g};e=c.s3_popup_format;
f=_.template(e);var v={},A=e.split("{");for(e=0;e<A.length;e++){var C=A[e].split("}")[0];v[C]=""}_.defaults(r,v);e=f(r).split("<br/>",1)[0]}else e=void 0!==r.popup?r.popup.split("<br/>",1)[0]:r[b];void 0!==r.url?h+="<li><a href='javascript:S3.gis.loadClusterPopup(\""+w+'", "'+r.url+'", "'+l+"\")'>"+e+"</a></li>":void 0!==c.s3_url_format?(_.templateSettings={interpolate:/\{(.+?)\}/g},f=_.template(c.s3_url_format),r.id.constructor===Array&&(r.id=r.id[0]),f=f(r),h+="<li><a href='javascript:S3.gis.loadClusterPopup(\""+
w+'", "'+f+'", "'+l+"\")'>"+e+"</a></li>"):h+="<li>"+e+"</li>"}f=null;h+="</ul>";h+="<div align='center'><a href='javascript:S3.gis.zoomToSelectedFeature(\""+w+'", '+k.lon+","+k.lat+", 3)'>"+i18n.gis_zoomin+"</a></div>"}else if(d=c.s3_layer_type,"kml"==d){r=a.attributes;if(void 0!==a.style.balloonStyle)h=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(H,B){B=r[B];return"string"===typeof B||"number"===typeof B?B:H});else for(d=typeof r[b],d="object"==d?r[b].value:r[b],h="<h3>"+d+"</h3>",c=c.body.split(" "),
e=0;e<c.length;e++){d=typeof r[c[e]];if("object"==d){b=r[c[e]].displayName;""===b&&(b=c[e]);d=r[c[e]].value;var u='<div class="gis_popup_row"><div class="gis_popup_label">'+b+':</div><div class="gis_popup_cell">'+d+"</div></div>"}else u=void 0!==r[c[e]]?'<div class="gis_popup_row">'+r[c[e]]+"</div>":"";h+=u}-1!=h.search("<script")&&(h="Content contained Javascript! Escaped content below.<br />"+h.replace(/</g,"<"))}else if("gpx"!=d)if("shapefile"==d||"geojson"==d)r=a.attributes,h="<div>",$.each(r,
function(H,B){"id_orig"==H&&(H="id");u='<div class="gis_popup_row"><div class="gis_popup_label">'+H+':</div><div class="gis_popup_cell">'+B+"</div></div>";h+=u}),h+="</div>";else if("wfs"==d)r=a.attributes,d=r[b],h="<h3>"+d+"</h3>",$.each(r,function(H,B){u='<div class="gis_popup_row"><div class="gis_popup_label">'+H+':</div><div class="gis_popup_val">'+B+"</div></div>";h+=u});else if(void 0!==a.attributes.url)f=a.attributes.url;else if(void 0!==c.s3_url_format)_.templateSettings={interpolate:/\{(.+?)\}/g},
f=_.template(c.s3_url_format),a.attributes.id.constructor===Array&&(a.attributes.id=a.attributes.id[0]),f=f(a.attributes);else{r=a.attributes;e=void 0===r.name?"":"<h3>"+r.name+"</h3>";c=void 0===r.description?"":"<p>"+r.description+"</p>";d=void 0===r.link?"":'<a href="'+r.link+'" target="_blank">'+r.link+"</a>";if(void 0===r.data)b="";else if(0===r.data.indexOf("http://")){g=!0;var I=S3.uid();b='<div id="'+I+'">'+i18n.gis_loading+"...<div class='throbber'></div></div>"}else b="<p>"+r.data+"</p>";
k=void 0===r.image?"":0===r.image.indexOf("http://")?'<img src="'+r.image+'" height=300 width=300>':"";h=e+c+d+b+k}f=ka(a,f,h);g&&ja(a.attributes.data,I,f)}},Ta=function(){var b=this.feature;if(b){var a=b.layer;b.renderIntent="default";a&&a.drawFeature(b);b.popup&&(a&&a.map.removePopup(b.popup),b.popup.destroy(),delete b.popup);if(b.id)$("#"+b.id+"_popup").remove();else{var c=b.map;if(c)for(var d=c.popups,e=d.length-1;-1<e;e--)c.removePopup(d[e])}a&&a.name==i18n.gis_draft_layer&&b.destroy()}};S3.gis.loadClusterPopup=
...
new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:b,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:g});d.add(e);d.add(n);d.add(g);d.addSeparator();Va(d)}c.print&&(d.addSeparator(),Wa(d));c.save&&"float"!=c.save&&(d.addSeparator(),Xa(d));d.addSeparator();Ya(d);"toolbar"==c.clear_layers&&ea(b,d);c.mgrs_url&&Za(d);if(c.draw_feature||c.draw_line||c.draw_polygon||c.draw_circle){d.addSeparator();g=S3.gis.poi_resources;if(g)var h=g.length;if(c.draw_feature)if(g)for(e=
...
$("#"+e+" .map_legend_div").animate({marginRight:"-"+g+"px"});$("#"+e+" .map_legend_tab").removeClass("right").addClass("left")}else ha(b)});return c},ha=function(b){b=b.s3.id;$("#"+b+" .map_legend_div").animate({marginRight:0});$("#"+b+" .map_legend_tab").removeClass("left").addClass("right")},Va=function(b){var a=new OpenLayers.Control.NavigationHistory;b.map.addControl(a);a.activate();var c=new Ext.Button({iconCls:"back",tooltip:i18n.gis_navPrevious,handler:a.previous.trigger});a=new Ext.Button({iconCls:"next",
...
h.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==h.geometry.CLASS_NAME?5:0},graphicZIndex:function(h){return"OpenLayers.Geometry.Point"==h.geometry.CLASS_NAME?10:"OpenLayers.Geometry.Line"==h.geometry.CLASS_NAME?5:0}}});l&&(a=fa(a),b.addRules(a));1!=f?(a=Math.min(2*f,.8),a={fillOpacity:a,graphicOpacity:a}):a={fillColor:"#"+(n.select_fill||"ffdc33"),strokeColor:"#"+(n.select_stroke||"ff9933")};return[new OpenLayers.StyleMap({"default":b,select:a}),d]},fa=function(b){var a=[],c,d,e,g,f,k,l,n,h,
...
void 0!==u.size?(k=!0,m=!1):k=!1;void 0!==u.fill?(m=!1,g="#"+u.fill):void 0!==u.stroke&&(m=!0,g="#"+u.stroke);f=void 0!==u.fillOpacity?u.fillOpacity:b.opacity||1;w=void 0!==u.strokeOpacity?u.strokeOpacity:1;var I=void 0!==u.graphic?u.graphic:"square";r=void 0!==u.strokeWidth?u.strokeWidth:2;v={fillColor:g,fillOpacity:f,strokeColor:g,strokeOpacity:w,strokeWidth:r,graphicName:I};k?(void 0!==u.externalGraphic&&(l=S3.Ap.concat("/static/"+u.externalGraphic),I=new Image,I.src=l,n=I.height,h=I.width,v.externalGraphic=
