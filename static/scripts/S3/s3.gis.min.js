...
function addToolbar(){var a=new Ext.Toolbar({height:34}),b=new GeoExt.Action({control:new OpenLayers.Control.ZoomToMaxExtent,map:map,iconCls:"zoomfull",tooltip:i18n.gis_zoomfull}),c=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox({out:!0}),map:map,iconCls:"zoomout",tooltip:i18n.gis_zoomout,toggleGroup:"controls"}),d=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox,map:map,iconCls:"zoomin",tooltip:i18n.gis_zoomin,toggleGroup:"controls"}),e,f,h;"active"==S3.gis.draw_polygon?(e=!0,
h=f=!1):("active"==S3.gis.draw_feature?(h=!0,f=!1):(f=!0,h=!1),e=!1);S3.gis.panButton=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:map,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:f});a.add(b);navigator.geolocation&&addGeolocateControl(a);void 0===S3.gis.loc_select&&(a.add(c),a.add(d),a.add(S3.gis.panButton),a.addSeparator());void 0===S3.gis.loc_select&&addNavigationControl(a);void 0===S3.gis.loc_select&&S3.auth&&addSaveButton(a);a.addSeparator();
addMeasureControls(a);S3.gis.mgrs_url&&addPdfControl(a);if(S3.gis.draw_feature||S3.gis.draw_polygon)a.addSeparator(),S3.gis.draw_feature&&addPointControl(a,h),S3.gis.draw_polygon&&addPolygonControl(a,e,!0);i18n.gis_get_feature_info&&addWMSGetFeatureInfoControl(a);S3.gis.osm_oauth&&addPotlatchButton(a);S3.gis.Google&&S3.gis.Google.StreetviewButton&&addGoogleStreetviewControl(a);try{S3.gis.Google.Earth&&google&addGoogleEarthControl(a)}catch(g){}i18n.gis_search&&(b=Math.min(350,S3.gis.map_width-680),
