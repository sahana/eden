...
680),b=new GeoExt.ux.GeoNamesSearchCombo({map:map,width:b,listWidth:b,minChars:2,emptyText:S3.i18n.gis_search}),a.addSeparator(),a.add(b));b=new Ext.BoxComponent({autoEl:{tag:"img",src:S3.gis.ajax_loader},cls:"hide",id:"layer_throbber"});a.add(b);S3.gis.toolbar=a}
