...
function addArcRESTLayer(a){var b=a.name,c=[a.url],d;d=void 0!=a.layers?a.layers.join():0;var f;void 0!=a.dir?(f=a.dir,-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)):f="";var e;e=void 0!=a.base?a.base:!1;var l;l=void 0!=a.transparent?a.transparent:!0;var h;h=void 0!=a.visibility?a.visibility:!0;b=new OpenLayers.Layer.ArcGIS93Rest(b,c,{layers:"show:"+d,isBaseLayer:e,transparent:l,dir:f,s3_layer_id:a.id,s3_layer_type:"arcrest"});b.setVisibility(h);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function addGeoJSONLayer(a){var b=a.name,c=a.url,d;if(void 0!=a.marker_image){d=S3.gis.marker_url+a.marker_image;var f=a.marker_height,e=a.marker_width}else d="";var l;l=void 0!=a.refresh?a.refresh:900;var h;void 0!=a.dir?(h=a.dir,-1==$.inArray(h,S3.gis.dirs)&&S3.gis.dirs.push(h)):h="";var p;p=void 0!=a.visibility?a.visibility:!0;var k;k=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var g;g=void 0!=a.cluster_threshold?a.cluster_threshold:
...
graphicOpacity:k,graphicName:"${graphicName}",externalGraphic:"${externalGraphic}"},{context:{graphicWidth:function(a){return a.cluster?"":a.attributes.marker_width?a.attributes.marker_width:e},graphicHeight:function(a){return a.cluster?"":a.attributes.marker_height?a.attributes.marker_height:f},graphicXOffset:function(a){return a.cluster?"":a.attributes.marker_width?-(a.attributes.marker_width/2):-(e/2)},graphicYOffset:function(a){return a.cluster?"":a.attributes.marker_height?-a.attributes.marker_height:
-f},graphicName:function(a){return a.cluster?"circle":a.attributes.shape?a.attributes.shape:"circle"},externalGraphic:function(a){var b;a.cluster?b="":a.attributes.marker_url?b=a.attributes.marker_url:a.layer&&void 0!=a.layer.s3_style?(a=a.layer.s3_style,"[object Array]"!==Object.prototype.toString.call(a)&&void 0!=a.external_graphic&&(b=S3.Ap.concat("/static/img/"+a.external_graphic)),void 0==b&&(b=d)):b=d;return b},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:a.attributes.size?
...
function addGPXLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,f=a.marker_height,e=a.marker_width,l;l=void 0!=a.waypoints?a.waypoints:!0;var h;h=void 0!=a.tracks?a.tracks:!0;var p;p=void 0!=a.routes?a.routes:!0;var k;k=void 0!=a.visibility?a.visibility:!0;var m;void 0!=a.dir?(m=a.dir,-1==$.inArray(m,S3.gis.dirs)&&S3.gis.dirs.push(m)):m="";var g;g=void 0!=a.opacity?a.opacity:1;var n;n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var s;s=void 0!=a.cluster_threshold?
a.cluster_threshold:S3.gis.cluster_threshold;var r=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);l?(r.graphicOpacity=g,r.graphicWidth=e,r.graphicHeight=f,r.graphicXOffset=-(e/2),r.graphicYOffset=-f,r.externalGraphic=d):r.externalGraphic="";r.strokeColor="blue";r.strokeWidth=6;r.strokeOpacity=g;a=new OpenLayers.Layer.Vector(b,{dir:m,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:n,threshold:s})],s3_layer_id:a.id,
s3_layer_type:"gpx",legendURL:d,style:r,protocol:new OpenLayers.Protocol.HTTP({url:c,format:new OpenLayers.Format.GPX({extractAttributes:!0,extractWaypoints:l,extractTracks:h,extractRoutes:p})})});a.setVisibility(k);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addKMLLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,f;f=void 0!=a.title?a.title:"name";var e;e=void 0!=a.body?a.body:"description";var l;l=void 0!=a.refresh?a.refresh:900;var h;h=void 0!=a.visibility?a.visibility:!0;var p;void 0!=a.dir?(p=a.dir,-1==$.inArray(p,S3.gis.dirs)&&S3.gis.dirs.push(p)):p="";var k;k=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var g;g=void 0!=a.cluster_threshold?a.cluster_threshold:
...
function addTMSLayer(a){var b=a.name,c=[a.url];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var d=a.layername,f;f=void 0!=a.zoomLevels?a.zoomLevels:19;var e;void 0!=a.dir?(e=a.dir,-1==$.inArray(e,S3.gis.dirs)&&S3.gis.dirs.push(e)):e="";b=new OpenLayers.Layer.TMS(b,c,{dir:e,s3_layer_id:a.id,s3_layer_type:"tms",layername:d,type:void 0!=a.format?a.format:"png",numZoomLevels:f});void 0!=a.attribution&&(b.attribution=a.attribution);map.addLayer(b);a._base&&map.setBaseLayer(b)}
function addWFSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var d=a.title,f=a.featureType,e=a.featureNS,l=a.schema,h;h=void 0!=a.version?a.version:"1.1.0";var p;p=void 0!=a.geometryName?a.geometryName:"the_geom";var k;k=void 0!=a.styleField?a.styleField:"";var m;m=void 0!=a.styleValues?a.styleValues:{};var g;g=void 0!=a.visibility?a.visibility:!0;var n;void 0!=a.dir?(n=a.dir,-1==$.inArray(n,S3.gis.dirs)&&S3.gis.dirs.push(n)):
n="";var s;s=void 0!=a.opacity?a.opacity:1;var r;r=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var v;v=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;var t,u;void 0!=a.projection?(t=a.projection,u="EPSG:"+t):(t="4326",u="EPSG:4326");c=new OpenLayers.Protocol.WFS({version:h,srsName:u,url:c,featureType:f,featureNS:e,geometryName:p,schema:l});f={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b=
"#f5902e";a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}};k&&m&&(f.context.fill=function(a){var b;$.each(m,function(c,d){c==a.attributes[k]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},f.context.stroke=function(a){var b;$.each(m,function(c,d){c==a.attributes[k]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b});s=new OpenLayers.Style({label:"${label}",
...
protocol:c,styleMap:s});a.title=d;a.setVisibility(g);a.events.on({featureselected:onFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addWMSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var d=a.layers,f;f=void 0!=a.visibility?a.visibility:!0;var e;void 0!=a.dir?(e=a.dir,-1==$.inArray(e,S3.gis.dirs)&&S3.gis.dirs.push(e)):e="";var l;l=void 0!=a.base?a.base:!1;var h;h=void 0!=a.transparent?a.transparent:!0;var p;p=void 0!=a.format?a.format:"image/png";var k;k=void 0!=a.version?a.version:"1.1.1";var m;m=void 0!=a.map?a.map:"";var g;g=void 0!=a.style?
a.style:"";var n;n=void 0!=a.bgcolor?"0x"+a.bgcolor:"";var s;s=void 0!=a.buffer?a.buffer:0;var r;r=void 0!=a.tiled?a.tiled:!1;var v;v=void 0!=a.opacity?a.opacity:1;var t;t=void 0!=a.queryable?a.queryable:1;var u;void 0!=a.legendURL&&(u=a.legendURL);b=new OpenLayers.Layer.WMS(b,c,{layers:d,transparent:h},{dir:e,wrapDateLine:!0,isBaseLayer:l,s3_layer_id:a.id,s3_layer_type:"wms",queryable:t,visibility:f});m&&(b.params.MAP=m);p&&(b.params.FORMAT=p);k&&(b.params.VERSION=k);g&&(b.params.STYLES=g);n&&(b.params.BGCOLOR=
n);r&&(b.params.TILED=!0,b.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom]);l||(b.opacity=v,b.buffer=s?s:0);u&&(b.legendURL=u);map.addLayer(b);a._base&&map.setBaseLayer(b)}
function addXYZLayer(a){var b=a.name,c=[a.url];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var d=a.layername,f;f=void 0!=a.zoomLevels?a.zoomLevels:19;var e;void 0!=a.dir?(e=a.dir,-1==$.inArray(e,S3.gis.dirs)&&S3.gis.dirs.push(e)):e="";b=new OpenLayers.Layer.XYZ(b,c,{dir:e,s3_layer_id:a.id,s3_layer_type:"xyz",layername:d,type:void 0!=a.format?a.format:"png",numZoomLevels:f});void 0!=a.attribution&&(b.attribution=a.attribution);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function s3_gis_loadDetails(a,b,c){$.ajax({url:a,success:function(a){$("#"+b).html(a);c.updateSize()},error:function(a,f,e){msg="UNAUTHORIZED"==e?i18n.gis_requires_login:a.responseText;$("#"+b+"_contentDiv").html(msg);c.updateSize()},dataType:"html"})}
function onFeatureSelect(a){s3_gis_tooltipUnselect(a);a=a.feature;var b=a.layer,c=b.s3_layer_type,d=a.geometry.getBounds().getCenterLonLat(),f=S3.uid(),b=void 0!=b.title?b.title:"name",e,l,h,p;if(a.cluster){c=a.cluster;e=i18n.gis_cluster_multiple+":<ul>";for(var k=c.length,m=0;m<k;m++){var g=c[m].attributes;h=void 0!=g.popup?g.popup.split("<br />",1)[0]:g[b];e=void 0!=g.url?e+("<li><a href='javascript:s3_gis_loadClusterPopup(\""+g.url+'", "'+f+"\")'>"+h+"</a></li>"):e+("<li>"+h+"</li>")}e+="</ul>";
e+="<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+d.lon+","+d.lat+", 3)'>Zoom in</a></div>"}else if("kml"==c){g=a.attributes;if(void 0!=a.style.balloonStyle)e=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,b){var c=g[b];return"string"===typeof c||"number"===typeof c?c:a});else{c=typeof g[b];h="object"==c?g[b].value:g[b];e="<h3>"+h+"</h3>";h=a.layer.body.split(" ");for(var n,k=0;k<h.length;k++)c=typeof g[h[k]],"object"==c?(b=g[h[k]].displayName,""===b&&(b=h[k]),c=g[h[k]].value,
n='<div class="gis_popup_row"><div class="gis_popup_label">'+b+':</div><div class="gis_popup_cell">'+c+"</div></div>"):n=void 0!=g[h[k]]?'<div class="gis_popup_row">'+g[h[k]]+"</div>":"",e+=n}-1!=e.search("<script")&&(e="Content contained Javascript! Escaped content below.<br />"+e.replace(/</g,"<"))}else if("gpx"!=c)if("shapefile"==c){g=a.attributes;e="<div>";for(h in g)g.hasOwnProperty(h)&&(b="id_orig"==h?"id":h,c=g[h],n='<div class="gis_popup_row"><div class="gis_popup_label">'+b+':</div><div class="gis_popup_cell">'+
c+"</div></div>",e+=n);e+="</div>"}else if("wfs"==c)g=a.attributes,h=g[b],e="<h3>"+h+"</h3>",$.each(g,function(a,b){n='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";e+=n});else if(void 0!=a.attributes.url)p=a.attributes.url,e=i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 />";else{g=a.attributes;h=void 0==g.name?"":"<h3>"+g.name+"</h3>";b=void 0==g.description?"":"<p>"+g.description+"</p>";c=void 0==g.link?"":'<a href="'+
g.link+'" target="_blank">'+g.link+"</a>";if(void 0==g.data)k="";else if(0===g.data.indexOf("http://")){l=!0;var s=S3.uid(),k='<div id="'+s+'">'+i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 /></div>"}else k="<p>"+g.data+"</p>";m=void 0==g.image?"":0===g.image.indexOf("http://")?'<img src="'+g.image+'" height=300 width=300>':"";e=h+b+c+k+m}d=new OpenLayers.Popup.FramedCloud(f,d,new OpenLayers.Size(200,200),e,null,!0,onPopupClose);void 0!=p?s3_gis_loadDetails(p,f+"_contentDiv",d):
l&&s3_gis_loadDetails(a.attributes.data,s,d);a.popup=d;map.addPopup(d)}
...
function s3_gis_pulsate(a){var b=a.geometry.getCentroid(),c=a.geometry.getBounds(),d=Math.abs((c.right-c.left)/2),f=0,e="up";window.resizeInterval=window.setInterval(function(){16<f&&clearInterval(window.resizeInterval);var c=0.03*d/d;switch(f){case 4:case 12:e="down";break;case 8:e="up"}"up"!==e&&(c=-Math.abs(c));a.geometry.resize(1+c,b);S3.gis.draftLayer.drawFeature(a);f++},50,b,d)}
