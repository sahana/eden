...
a.geometry,l;if("OpenLayers.Geometry.Point"!=k.CLASS_NAME)for(d=0,l=e.clicking.length;d<l;++d)if("OpenLayers.Geometry.Point"==e.clicking[d].geometry.CLASS_NAME)return;ia(b);a.renderIntent="select";c.drawFeature(a);k=k.getBounds().getCenterLonLat();l=a.id+"_popup";b=void 0!==c.title?c.title:"name";if(a.cluster){var n=a.cluster;var h=i18n.gis_cluster_multiple+":<ul>";var m=n.length,w=e.id;for(d=0;d<m;d++){var r=n[d].attributes;if(void 0!==c.s3_popup_format){_.templateSettings={interpolate:/\{(.+?)\}/g};
e=c.s3_popup_format;f=_.template(e);var v={},A=e.split("{");for(e=0;e<A.length;e++){var C=A[e].split("}")[0];v[C]=""}_.defaults(r,v);e=f(r).split("<br/>",1)[0]}else e=void 0!==r.popup?r.popup.split("<br/>",1)[0]:r[b];void 0!==r.url?h+="<li><a href='javascript:S3.gis.loadClusterPopup(\""+w+'", "'+r.url+'", "'+l+"\")'>"+e+"</a></li>":void 0!==c.s3_url_format?(_.templateSettings={interpolate:/\{(.+?)\}/g},f=_.template(c.s3_url_format),r.id.constructor===Array&&(r.id=r.id[0]),f=f(r),h+="<li><a href='javascript:S3.gis.loadClusterPopup(\""+
