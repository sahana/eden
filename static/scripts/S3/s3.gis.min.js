...
function addGeoJSONLayer(a){var b=a.name,c=a.url,d;if(void 0!=a.marker_image){d=S3.gis.marker_url+a.marker_image;var e=a.marker_height,f=a.marker_width}else d="";var h;h=void 0!=a.refresh?a.refresh:900;var g;void 0!=a.dir?(g=a.dir,-1==$.inArray(g,S3.gis.dirs)&&S3.gis.dirs.push(g)):g="";var j;j=void 0!=a.visibility?a.visibility:!0;var k;k=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var p;p=void 0!=a.cluster_threshold?a.cluster_threshold:
S3.gis.cluster_threshold;var n;n=void 0!=a.projection?a.projection:4326;n=4326==n?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+n);var o;o=void 0!=a.type?a.type:"feature";var l;l=void 0!=a.style?a.style:[];var t=new OpenLayers.Style({label:"${label}",labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:"${fillOpacity}",strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:k,graphicWidth:"${graphicWidth}",graphicHeight:"${graphicHeight}",graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",
...
-e},graphicName:function(a){return a.cluster?"circle":a.attributes.shape?a.attributes.shape:"circle"},externalGraphic:function(a){return a.cluster?"":a.attributes.marker_url?a.attributes.marker_url:d},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:a.attributes.size?a.attributes.size:10},fill:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#8087ff";else if(a.attributes.colour)b=a.attributes.colour;else if(l.length){var c=a.attributes.value;
$.each(l,function(a,d){if(c>=d.low&&c<d.high){b=d.fill;return false}});b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},fillOpacity:function(a){return a.cluster?a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:k:a.attributes.opacity?a.attributes.opacity:k},stroke:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#2b2f76";else if(a.attributes.colour)b=a.attributes.colour;else if(l.length){var c=a.attributes.value;$.each(l,function(a,
d){if(c>=d.low&&c<d.high){b=d.fill;return false}});b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},label:function(a){var b="";if(a.cluster&&a.attributes.count>1)b=a.attributes.count;return b}}});if(l.length){var r=[],s;$.each(l,function(a,b){s="#"+b.fill;var c=new OpenLayers.Rule({filter:new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,property:"value",lowerBoundary:b.low,upperBoundary:b.high}),symbolizer:{fillColor:s,strokeColor:s,graphicName:"circle",pointRadius:10},
title:b.low+"-"+b.high});r.push(c)});t.addRules(r)}t=new OpenLayers.StyleMap({"default":t,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:g,projection:n,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*h}),new OpenLayers.Strategy.AttributeCluster({attribute:"colour",distance:m,threshold:p})],legendURL:d,s3_layer_id:a.id,s3_layer_type:o,s3_style:l,styleMap:t,protocol:new OpenLayers.Protocol.HTTP({url:c,
format:S3.gis.format_geojson})});a.setVisibility(j);a.events.on({featureselected:onGeojsonFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
...
function addGPXLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width,h;h=void 0!=a.waypoints?a.waypoints:!0;var g;g=void 0!=a.tracks?a.tracks:!0;var j;j=void 0!=a.routes?a.routes:!0;var k;k=void 0!=a.visibility?a.visibility:!0;var m;void 0!=a.dir?(m=a.dir,-1==$.inArray(m,S3.gis.dirs)&&S3.gis.dirs.push(m)):m="";var p;p=void 0!=a.opacity?a.opacity:1;var n;n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var o;o=void 0!=a.cluster_threshold?
a.cluster_threshold:S3.gis.cluster_threshold;var l=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);h?(l.graphicOpacity=p,l.graphicWidth=f,l.graphicHeight=e,l.graphicXOffset=-(f/2),l.graphicYOffset=-e,l.externalGraphic=d):l.externalGraphic="";l.strokeColor="blue";l.strokeWidth=6;l.strokeOpacity=p;a=new OpenLayers.Layer.Vector(b,{dir:m,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:n,threshold:o})],s3_layer_id:a.id,
s3_layer_type:"gpx",legendURL:d,style:l,protocol:new OpenLayers.Protocol.HTTP({url:c,format:new OpenLayers.Format.GPX({extractAttributes:!0,extractWaypoints:h,extractTracks:g,extractRoutes:j})})});a.setVisibility(k);a.events.on({featureselected:onGpxFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addKMLLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e;e=void 0!=a.title?a.title:"name";var f;f=void 0!=a.body?a.body:"description";var h;h=void 0!=a.refresh?a.refresh:900;var g;g=void 0!=a.visibility?a.visibility:!0;var j;void 0!=a.dir?(j=a.dir,-1==$.inArray(j,S3.gis.dirs)&&S3.gis.dirs.push(j)):j="";var k;k=void 0!=a.opacity?a.opacity:1;var m;m=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var p;p=void 0!=a.cluster_threshold?a.cluster_threshold:
...
"":S3.gis.image.width},graphicHeight:function(a){return a.cluster?"":S3.gis.image.height},graphicXOffset:function(a){return a.cluster?"":-(S3.gis.image.width/2)},graphicYOffset:function(a){return a.cluster?"":-S3.gis.image.height},externalGraphic:function(a){return a.cluster?"":d},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:10},fill:function(a){return a.cluster?"#8087ff":"#f5902e"},stroke:function(a){return a.cluster?"#2b2f76":"#f5902e"},label:function(a){var b="";if(a.cluster&&
a.attributes.count>1)b=a.attributes.count;return b}}});k=new OpenLayers.StyleMap({"default":k,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:j,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:m,threshold:p}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*h})],s3_layer_id:a.id,s3_layer_type:"kml",legendURL:d,styleMap:k,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_kml})});
...
function addWFSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var d=a.title,e=a.featureType,f=a.featureNS,h=a.schema,g;g=void 0!=a.version?a.version:"1.1.0";var j;j=void 0!=a.geometryName?a.geometryName:"the_geom";var k;k=void 0!=a.styleField?a.styleField:"";var m;m=void 0!=a.styleValues?a.styleValues:{};var p;p=void 0!=a.visibility?a.visibility:!0;var n;void 0!=a.dir?(n=a.dir,-1==$.inArray(n,S3.gis.dirs)&&S3.gis.dirs.push(n)):
n="";var o;o=void 0!=a.opacity?a.opacity:1;var l;l=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance;var t;t=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;var r,s;void 0!=a.projection?(r=a.projection,s="EPSG:"+r):(r="4326",s="EPSG:4326");c=new OpenLayers.Protocol.WFS({version:g,srsName:s,url:c,featureType:e,featureNS:f,geometryName:j,schema:h});e={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b=
"#f5902e";a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";if(a.cluster&&a.attributes.count>1)b=a.attributes.count;return b}}};k&&m&&(e.context.fill=function(a){var b;$.each(m,function(c,d){c==a.attributes[k]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},e.context.stroke=function(a){var b;$.each(m,function(c,d){c==a.attributes[k]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b});o=new OpenLayers.Style({label:"${label}",
labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:o/2,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:o},e);o=new OpenLayers.StyleMap({"default":o,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});r="4326"==r?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+r);a=new OpenLayers.Layer.Vector(b,{maxFeatures:1E3,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Cluster({distance:l,threshold:t})],dir:n,s3_layer_id:a.id,s3_layer_type:"wfs",projection:r,
protocol:c,styleMap:o});a.title=d;a.setVisibility(p);a.events.on({featureselected:onWfsFeatureSelect,featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
function addWMSLayer(a){var b=a.name,c=a.url;void 0!=a.username&&void 0!=a.password&&(c=c.replace("://","://"+a.username+":"+a.password+"@"));var d=a.layers,e;e=void 0!=a.visibility?a.visibility:!0;var f;void 0!=a.dir?(f=a.dir,-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)):f="";var h;h=void 0!=a.base?a.base:!1;var g;g=void 0!=a.transparent?a.transparent:!0;var j;j=void 0!=a.format?a.format:"image/png";var k;k=void 0!=a.version?a.version:"1.1.1";var m;m=void 0!=a.map?a.map:"";var p;p=void 0!=a.style?
a.style:"";var n;n=void 0!=a.bgcolor?"0x"+a.bgcolor:"";var o;o=void 0!=a.buffer?a.buffer:0;var l;l=void 0!=a.tiled?a.tiled:!1;var t;t=void 0!=a.opacity?a.opacity:1;var r;r=void 0!=a.queryable?a.queryable:1;var s;void 0!=a.legendURL&&(s=a.legendURL);b=new OpenLayers.Layer.WMS(b,c,{layers:d,transparent:g},{dir:f,wrapDateLine:!0,isBaseLayer:h,s3_layer_id:a.id,s3_layer_type:"wms",queryable:r,visibility:e});m&&(b.params.MAP=m);j&&(b.params.FORMAT=j);k&&(b.params.VERSION=k);p&&(b.params.STYLES=p);n&&(b.params.BGCOLOR=
n);l&&(b.params.TILED=!0,b.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom]);h||(b.opacity=t,b.buffer=o?o:0);s&&(b.legendURL=s);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function onGeojsonFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=!1,e,f;if(a.cluster){var h;e=i18n.gis_cluster_multiple+":<ul>";for(var g=0;g<a.cluster.length;g++)f=void 0!=a.cluster[g].attributes.popup?a.cluster[g].attributes.popup.split("<br />",1)[0]:a.cluster[g].attributes.name,void 0!=a.cluster[g].attributes.url?(h=a.cluster[g].attributes.url,e+="<li><a href='javascript:s3_gis_loadClusterPopup(\""+h+'", "'+b+"\")'>"+f+"</a></li>"):
...
function onKmlFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d;if(a.cluster){var e;d=i18n.gis_cluster_multiple+":<ul>";for(var f=0;f<a.cluster.length;f++)e=a.cluster[f].attributes.name,d+="<li>"+e+"</li>";d=d+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{var h=a.attributes;if(void 0!=a.style.balloonStyle)d=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,
b){var c=h[b];return"string"===typeof c||"number"===typeof c?c:a});else{e=a.layer.title;d=typeof h[e];e="object"==d?h[e].value:h[e];f=a.layer.body.split(" ");content="";for(var g=0;g<f.length;g++){d=typeof h[f[g]];var j="";"object"==d?(d=h[f[g]].displayName,""===d&&(d=f[g]),j="<b>"+d+"</b>: "+h[f[g]].value+"<br />"):void 0!=h[f[g]]&&(j=h[f[g]]+"<br />");content+=j}d="<h3>"+e+"</h3>"+content}-1!=d.search("<script")&&(d="Content contained Javascript! Escaped content below.<br />"+d.replace(/</g,"<"))}b=
new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),d,null,!0,onPopupClose);a.popup=b;map.addPopup(b)}
function onWfsFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=a.layer.title,e;if(a.cluster){var f;e=i18n.gis_cluster_multiple+":<ul>";for(var h=Math.min(a.cluster.length,9),g=0;g<h;g++)f=a.cluster[g].attributes[d],e+="<li>"+f+"</li>";e=e+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{e=a.attributes;var d=e[d],j="";$.each(e,function(a,b){j+="<b>"+a+":</b> "+
b+"<br />"});e="<h3>"+d+"</h3>"+j}b=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),e,null,!0,onPopupClose);a.popup=b;map.addPopup(b)}
