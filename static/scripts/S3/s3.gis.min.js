...
function addToolbar(){var a=new Ext.Toolbar({id:"gis_toolbar",height:34}),b=new GeoExt.Action({control:new OpenLayers.Control.ZoomToMaxExtent,map:map,iconCls:"zoomfull",tooltip:i18n.gis_zoomfull}),c=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox({out:!0}),map:map,iconCls:"zoomout",tooltip:i18n.gis_zoomout,toggleGroup:"controls"}),d=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox,map:map,iconCls:"zoomin",tooltip:i18n.gis_zoomin,toggleGroup:"controls"});if("active"==S3.gis.draw_polygon)var e=
!0,f=!1,g=!1;else"active"==S3.gis.draw_feature?(g=!0,f=!1):(f=!0,g=!1),e=!1;S3.gis.panButton=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:map,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:f});a.add(b);navigator.geolocation&&addGeolocateControl(a);void 0===S3.gis.loc_select&&(a.add(c),a.add(d),a.add(S3.gis.panButton),a.addSeparator());void 0===S3.gis.loc_select&&addNavigationControl(a);void 0===S3.gis.loc_select&&S3.auth&&addSaveButton(a);
a.addSeparator();addMeasureControls(a);S3.gis.mgrs_url&&addPdfControl(a);if(S3.gis.draw_feature||S3.gis.draw_polygon)a.addSeparator(),S3.gis.draw_feature&&addPointControl(a,g),S3.gis.draw_polygon&&addPolygonControl(a,e,!0);i18n.gis_get_feature_info&&addWMSGetFeatureInfoControl(a);S3.gis.osm_oauth&&addPotlatchButton(a);S3.gis.Google&&S3.gis.Google.StreetviewButton&&addGoogleStreetviewControl(a);try{S3.gis.Google.Earth&&google&addGoogleEarthControl(a)}catch(h){}i18n.gis_search&&(b=Math.min(350,S3.gis.map_width-
...
d.fill,!1});b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},label:function(a){var b="";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}});if(l.length){var s=[],r;$.each(l,function(a,b){r="#"+b.fill;var c=new OpenLayers.Rule({filter:new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,property:"value",lowerBoundary:b.low,upperBoundary:b.high}),symbolizer:{fillColor:r,strokeColor:r,graphicName:"circle",pointRadius:10},title:b.low+"-"+b.high});s.push(c)});
j.addRules(s)}j=new OpenLayers.StyleMap({"default":j,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});a=new OpenLayers.Layer.Vector(b,{dir:h,projection:n,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*g}),new OpenLayers.Strategy.AttributeCluster({attribute:"colour",distance:m,threshold:p})],legendURL:d,s3_layer_id:a.id,s3_layer_type:o,s3_style:l,styleMap:j,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_geojson})});
...
void 0!=a.opacity?a.opacity:1,l=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,s=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;if(void 0!=a.projection)var r=a.projection,t="EPSG:"+r;else r="4326",t="EPSG:4326";c=new OpenLayers.Protocol.WFS({version:h,srsName:t,url:c,featureType:e,featureNS:f,geometryName:k,schema:g});e={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b="#f5902e";
a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}};j&&m&&(e.context.fill=function(a){var b;$.each(m,function(c,d){c==a.attributes[j]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},e.context.stroke=function(a){var b;$.each(m,function(c,d){c==a.attributes[j]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b});o=new OpenLayers.Style({label:"${label}",
labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:o/2,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:o},e);o=new OpenLayers.StyleMap({"default":o,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});r="4326"==r?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+r);a=new OpenLayers.Layer.Vector(b,{maxFeatures:1E3,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Cluster({distance:l,threshold:s})],dir:n,s3_layer_id:a.id,s3_layer_type:"wfs",projection:r,
...
a.buffer:0,o=void 0!=a.tiled?a.tiled:!1,l=void 0!=a.opacity?a.opacity:1;if(void 0!=a.legendURL)var s=a.legendURL;b=new OpenLayers.Layer.WMS(b,c,{layers:d},{dir:f,wrapDateLine:!0,isBaseLayer:g,transparent:void 0!=a.transparent?a.transparent:!0,s3_layer_id:a.id,s3_layer_type:"wms",queryable:void 0!=a.queryable?a.queryable:1,visibility:e});j&&(b.params.MAP=j);h&&(b.params.FORMAT=h);k&&(b.params.VERSION=k);m&&(b.params.STYLES=m);p&&(b.params.BGCOLOR=p);o&&(b.params.TILED=!0,b.params.TILESORIGIN=[map.maxExtent.left,
map.maxExtent.bottom]);g||(b.opacity=l,b.buffer=n?n:0);s&&(b.legendURL=s);map.addLayer(b);a._base&&map.setBaseLayer(b)}
...
function onGeojsonFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=!1;if(a.cluster){for(var e,f,g=i18n.gis_cluster_multiple+":<ul>",h=0;h<a.cluster.length;h++)e=void 0!=a.cluster[h].attributes.popup?a.cluster[h].attributes.popup.split("<br />",1)[0]:a.cluster[h].attributes.name,void 0!=a.cluster[h].attributes.url?(f=a.cluster[h].attributes.url,g+="<li><a href='javascript:s3_gis_loadClusterPopup(\""+f+'", "'+b+"\")'>"+e+"</a></li>"):
g+="<li>"+e+"</li>";g=g+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else if(void 0!=a.attributes.url)g=i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 />";else{e=void 0==a.attributes.name?"":"<h3>"+a.attributes.name+"</h3>";f=void 0==a.attributes.description?"":"<p>"+a.attributes.description+"</p>";g=void 0==a.attributes.link?"":'<a href="'+a.attributes.link+'" target="_blank">'+a.attributes.link+"</a>";
...
function onKmlFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat();if(a.cluster){for(var d,e=i18n.gis_cluster_multiple+":<ul>",f=0;f<a.cluster.length;f++)d=a.cluster[f].attributes.name,e+="<li>"+d+"</li>";e=e+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{var g=a.attributes;if(void 0!=a.style.balloonStyle)e=a.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,
...
function onWfsFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=a.layer.title;if(a.cluster){for(var e,f=i18n.gis_cluster_multiple+":<ul>",g=Math.min(a.cluster.length,9),h=0;h<g;h++)e=a.cluster[h].attributes[d],f+="<li>"+e+"</li>";f=f+"</ul>"+("<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>")}else{e=a.attributes;var d=e[d],k="";$.each(e,function(a,b){k+="<b>"+a+":</b> "+
...
function addSaveButton(a){var b=new Ext.Toolbar.Button({iconCls:"save",tooltip:i18n.gis_save,handler:function(){var a=getState(),b=Ext.util.JSON.encode(a.layers),e=Ext.util.JSON.encode(a.plugins),f=S3.gis.config_id?S3.Ap.concat("/gis/config/"+S3.gis.config_id+".url/update"):S3.Ap.concat("/gis/config.url/create");Ext.Ajax.request({url:f,method:"POST",success:function(a){if(a=Ext.decode(a.responseText).message.split("=",2)[1])S3.gis.config_id=a,a=S3.Ap.concat("/gis/config/",a,"/layer_entity"),$("#gis_menu_config").attr("href",
