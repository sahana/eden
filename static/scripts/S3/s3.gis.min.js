...
a.style:"";var n;n=void 0!=a.bgcolor?"0x"+a.bgcolor:"";var o;o=void 0!=a.buffer?a.buffer:0;var l;l=void 0!=a.tiled?a.tiled:!1;var t;t=void 0!=a.opacity?a.opacity:1;var r;r=void 0!=a.queryable?a.queryable:1;var s;void 0!=a.legendURL&&(s=a.legendURL);b=new OpenLayers.Layer.WMS(b,c,{layers:d},{dir:f,wrapDateLine:!0,isBaseLayer:h,transparent:g,s3_layer_id:a.id,s3_layer_type:"wms",queryable:r,visibility:e});m&&(b.params.MAP=m);j&&(b.params.FORMAT=j);k&&(b.params.VERSION=k);p&&(b.params.STYLES=p);n&&(b.params.BGCOLOR=
