...
-e},graphicName:function(a){return a.cluster?"circle":a.attributes.shape?a.attributes.shape:"circle"},externalGraphic:function(a){return a.cluster?"":a.attributes.marker_url?a.attributes.marker_url:d},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:a.attributes.size?a.attributes.size:10},fill:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#8087ff";else if(a.attributes.colour)b=a.attributes.colour;else if(void 0!=a.layer.s3_style){var c=
a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.fill;else{var d=a.attributes.value;$.each(c,function(a,c){if(d>=c.low&&d<c.high)return b=c.fill,!1})}b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},fillOpacity:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.opacity?a.cluster[0].attributes.opacity:k;else if(a.attributes.opacity)b=a.attributes.opacity;else if(void 0!=a.layer.s3_style){var c=a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=
c.fill_opacity;else{var d=a.attributes.value;$.each(c,function(a,c){if(d>=c.low&&d<c.high)return b=c.fill_opacity,!1})}void 0==b&&(b=k)}else b=k;return b},stroke:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.colour?a.cluster[0].attributes.colour:"#2b2f76";else if(a.attributes.colour)b=a.attributes.colour;else if(void 0!=a.layer.s3_style){var c=a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.stroke||c.fill;else{var d=a.attributes.value;$.each(c,function(a,c){if(d>=
c.low&&d<c.high)return b=c.stroke||c.fill,!1})}b=void 0!=b?"#"+b:"#000000"}else b="#f5902e";return b},strokeWidth:function(a){var b;if(a.cluster)b=a.cluster[0].attributes.stroke_width?a.cluster[0].attributes.stroke_width:2;else if(void 0!=a.layer.s3_style){var c=a.layer.s3_style;if("[object Array]"!==Object.prototype.toString.call(c))b=c.stroke_width;else{var d=a.attributes.value;$.each(c,function(a,c){if(d>=c.low&&d<c.high)return b=c.stroke_width,!1})}void 0==b&&(b=2)}else b=2;return b},label:function(a){var b=
"";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}});if("[object Array]"===Object.prototype.toString.call(m)){var t=[],u;$.each(m,function(a,b){u="#"+b.fill;var c=new OpenLayers.Rule({filter:new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,property:"value",lowerBoundary:b.low,upperBoundary:b.high}),symbolizer:{fillColor:u,strokeColor:u,graphicName:"circle",pointRadius:10},title:b.low+"-"+b.high});t.push(c)});v.addRules(t)}v=new OpenLayers.StyleMap({"default":v,
...
featureunselected:onFeatureUnselect,loadstart:function(a){showThrobber(a.object.s3_layer_id)},loadend:function(a){hideThrobber(a.object.s3_layer_id)}});map.addLayer(a);S3.gis.layers_all.push(a)}
