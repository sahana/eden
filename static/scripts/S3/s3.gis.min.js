...
f,b.lon,b.lat]),b=e.getCenterLonLat());a.center=b;d=P(c,a);a.renderTo="map_panel";Q(d);e&&d.zoomToExtent(e);return d};var A=function(c){c=c.object;for(var a=c.getDataExtent(),b,d=c.strategies,e=0,f=d.length;e<f;e++)b=d[e],"OpenLayers.Strategy.AttributeCluster"==b.CLASS_NAME&&b.activate();c.map.zoomToExtent(a);c.events.un({loadend:A})};S3.gis.search_layer_loadend=A;S3.gis.refreshLayer=function(c,a){var b=S3.gis.maps,d,e,f,g,k,m,h,n,p;for(d in b)for(e=b[d],f=e.layers,g=0,k=f.length;g<k;g++)if(m=f[g],
m.s3_layer_id==c&&(h=m.protocol.url,h=S3.search.filterURL(h,a),m.protocol.options.url=h,e.s3.mapWin.isVisible())){m.events.on({loadend:A});m=m.strategies;n=m.length;for(h=0;h<n;h++)if(p=m[h],"OpenLayers.Strategy.AttributeCluster"==p.CLASS_NAME){p.deactivate();break}for(h=0;h<n;h++)if(p=m[h],"OpenLayers.Strategy.Refresh"==p.CLASS_NAME){p.refresh();break}}};var P=function(c,a){var b=new OpenLayers.Map("center",{controls:[],displayProjection:u,projection:a.projection_current,theme:null,maxResolution:a.maxResolution,
maxExtent:a.maxExtent,numZoomLevels:a.numZoomLevels,units:a.units});S3.gis.maps[c]=b;b.s3={};b.s3.id=c;b.s3.options=a;b.s3.plugins=[];b.registerPlugin=function(a){a.map=this;this.s3.plugins.push(a)};b.showThrobber=function(a){$(".layer_throbber").show().removeClass("hide");this.s3.layers_loading.pop(a);this.s3.layers_loading.push(a)};b.hideThrobber=function(a){this.s3.layers_loading.pop(a);0===this.s3.layers_loading.length&&$(".layer_throbber").hide().addClass("hide")};R(b);S(b);return b},Q=function(c){var a=
c.s3,b=a.options,d=new GeoExt.MapPanel({height:b.map_height,width:b.map_width,xtype:"gx_mappanel",map:c,center:b.center,zoom:b.zoom,plugins:[]});a.mapPanel=d;var e={};e.map=d;a.portal=e;if(i18n.gis_legend||b.layers_wms)for(var e=c.layers,d=d.layers.data.items,f=0;f<e.length;f++)e[f].legendURL&&(d[f].data.legendURL=e[f].legendURL),e[f].queryable&&(d[f].data.queryable=1);e=T(c);d=[e];b.wms_browser_url&&(f=U(c))&&d.push(f);i18n.gis_legend&&(f=new GeoExt.LegendPanel({title:i18n.gis_legend,defaults:{},
autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1}),d.push(f));for(var f=a.plugins,g=0,k=f.length;g<k;++g)f[g].setup(c),f[g].addToMapWindow(d);a.west_panel_items=d;b.window?E(c):F(c);e.root.eachChild(function(){this.eachChild(function(){if(this.isLeaf())this.on("checkchange",function(a,b){b||c.hideThrobber(this.layer.s3_layer_id)});else this.eachChild(function(){if(this.isLeaf())this.on("checkchange",function(a,b){b||c.hideThrobber(this.layer.s3_layer_id)})})})});Ext.QuickTips.init()},F=function(c){var a=
c.s3,b=a.options,d=G(c);c=H(c);b=new Ext.Panel({renderTo:b.renderTo,autoScroll:!0,titleCollapse:!0,height:b.map_height,width:b.map_width,layout:"border",items:[d,c]});a.mapWin=b};S3.gis.addMapPanel=F;var E=function(c){var a=c.s3,b=a.options,d=G(c);c=H(c);d=new Ext.Window({cls:"gis-map-window",collapsible:!1,constrain:!0,closable:!b.windowNotClosable,closeAction:"hide",autoScroll:!0,maximizable:b.maximizable,titleCollapse:!1,height:b.map_height,width:b.map_width,layout:"border",items:[d,c]});d.on("beforehide",
function(a){a.maximized&&a.restore()});b.windowHide||(d.show(),d.maximize());a.mapWin=d};S3.gis.addMapWindow=E;var G=function(c){c=c.s3;var a=c.options.west_collapsed||!1,b=new Ext.Panel({cls:"map_tools",header:!1,border:!1,split:!0,items:c.west_panel_items}),a=new Ext.Panel({region:"west",header:!1,border:!0,width:250,autoScroll:!0,collapsible:!0,collapseMode:"mini",collapsed:a,items:[b]});return c.westPanelContainer=a},H=function(c){var a=c.s3,b=a.options;if(b.toolbar){var d,e=c.s3.options;d=new Ext.Toolbar({height:34});
d.map=c;var f=new GeoExt.Action({control:new OpenLayers.Control.ZoomToMaxExtent,map:c,iconCls:"zoomfull",tooltip:i18n.gis_zoomfull}),g=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox({out:!0}),map:c,iconCls:"zoomout",tooltip:i18n.gis_zoomout,toggleGroup:"controls"}),k=new GeoExt.Action({control:new OpenLayers.Control.ZoomBox,map:c,iconCls:"zoomin",tooltip:i18n.gis_zoominbutton,toggleGroup:"controls"}),m,h,n;"active"==e.draw_polygon?(m=!0,n=h=!1):("active"==e.draw_feature?(n=!0,h=!1):(h=
!0,n=!1),m=!1);d.add(f);navigator.geolocation&&V(d);void 0===e.nav&&(f=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:c,iconCls:"pan-off",tooltip:i18n.gis_pan,allowDepress:!0,toggleGroup:"controls",pressed:h}),d.add(g),d.add(k),d.add(f),d.addSeparator(),k=new OpenLayers.Control.NavigationHistory,d.map.addControl(k),k.activate(),g=new Ext.Toolbar.Button({iconCls:"back",tooltip:i18n.gis_navPrevious,handler:k.previous.trigger}),k=new Ext.Toolbar.Button({iconCls:"next",tooltip:i18n.gis_navNext,
handler:k.next.trigger}),d.addButton(g),d.addButton(k));e.save&&W(d);d.addSeparator();X(d);e.mgrs_url&&Y(d);if(e.draw_feature||e.draw_polygon)d.addSeparator(),e.draw_feature&&I(c,d,n),e.draw_polygon&&Z(d,m,!0);i18n.gis_get_feature_info&&(m=new gxp.plugins.WMSGetFeatureInfo({actionTarget:"gis_toolbar",outputTarget:"map",outputConfig:{width:400,height:200},toggleGroup:"controls",format:"grid",infoActionTip:i18n.gis_get_feature_info,popupTitle:i18n.gis_feature_info}),m.target=c.s3,m.addActions());i18n.gis_potlatch&&
aa(d);e.Google&&e.Google.StreetviewButton&&ba(d);try{e.Google.Earth&&google&ca(d)}catch(p){}i18n.gis_search&&(e=Math.min(350,!1===e.nav?e.map_width-500:e.map_width-680),c=new GeoExt.ux.GeoNamesSearchCombo({map:c,width:e,listWidth:e,minChars:2,emptyText:i18n.gis_search}),d.addSeparator(),d.add(c));c=new Ext.BoxComponent({cls:"layer_throbber hide"});d.add(c)}else b.draw_feature&&I(c,null,"active"==b.draw_feature?!0:!1);d=new Ext.Panel({layout:"card",region:"center",cls:"mappnlcntr",defaults:{border:!1},
items:[a.mapPanel],activeItem:0,tbar:d,scope:this});a.mapPanelContainer=d;b.Google&&b.Google.Earth&&(b=new gxp.GoogleEarthPanel({mapPanel:a.mapPanel}),d.items.items.push(b),a.googleEarthPanel=b,S3.gis.googleEarthPanel=b);return d},T=function(c){for(var a=c.s3.mapPanel.layers,b=[{text:i18n.gis_base_layers,nodeType:"gx_baselayercontainer",layerStore:a,loader:{filter:function(a){a=a.getLayer();return!0===a.displayInLayerSwitcher&&!0===a.isBaseLayer&&(void 0===a.dir||""===a.dir)}},leaf:!1,expanded:!0},
{text:i18n.gis_overlays,nodeType:"gx_overlaylayercontainer",layerStore:a,loader:{filter:function(a){a=a.getLayer();return!0===a.displayInLayerSwitcher&&!1===a.isBaseLayer&&(void 0===a.dir||""===a.dir)}},leaf:!1,expanded:!0}],d=c.s3.dirs,e=0;e<d.length;e++){var f={text:d[e],nodeType:"gx_layercontainer",layerStore:a,loader:{filter:function(a){return function(b){if("undefined"!==b.data.layer.dir)return b.data.layer.dir===a}}(d[e])},leaf:!1,expanded:!0};b.push(f)}a=new Ext.tree.AsyncTreeNode({expanded:!0,
children:b});b=i18n.gis_properties||i18n.gis_uploadlayer?new Ext.Toolbar:null;a=new Ext.tree.TreePanel({title:i18n.gis_layers,loader:new Ext.tree.TreeLoader({applyLoader:!1}),root:a,rootVisible:!1,split:!0,autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1,tbar:b,enableDD:!0});i18n.gis_uploadlayer&&da(c,a);i18n.gis_properties&&ea(c,a);return a},U=function(c){var a=c.s3.options,b=new Ext.tree.AsyncTreeNode({expanded:!0,loader:new GeoExt.tree.WMSCapabilitiesLoader({url:OpenLayers.ProxyHost+a.wms_browser_url,
layerOptions:{buffer:1,singleTile:!1,ratio:1,wrapDateLine:!0},layerParams:{TRANSPARENT:"TRUE"},createNode:function(a){a.checked=a.leaf?!1:void 0;return GeoExt.tree.WMSCapabilitiesLoader.prototype.createNode.apply(this,[a])}})});return new Ext.tree.TreePanel({title:a.wms_browser_name,root:b,rootVisible:!1,split:!0,autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1,listeners:{checkchange:function(a,b){!0===b?c.addLayer(a.attributes.layer):c.removeLayer(a.attributes.layer)}}})},R=function(c){var a=
c.s3,b=a.options;a.layers_all=[];a.dirs=[];a.layers_loading=[];a.common_cluster_strategy=new OpenLayers.Strategy.AttributeClusterMultiple({attribute:"colour",distance:20,threshold:2});if(b.layers_osm)for(var d=b.layers_osm,a=d.length;0<a;a--)fa(c,d[a-1]);try{google&ga(c)}catch(e){}b.Bing&&ha(c);if(b.layers_tms)for(d=b.layers_tms,a=d.length;0<a;a--)ia(c,d[a-1]);if(b.layers_wms)for(d=b.layers_wms,a=d.length;0<a;a--)ja(c,d[a-1]);if(b.layers_xyz)for(d=b.layers_xyz,a=d.length;0<a;a--)ka(c,d[a-1]);b.EmptyLayer&&
(a=new OpenLayers.Layer(b.EmptyLayer.name,{isBaseLayer:!0,displayInLayerSwitcher:!0,s3_layer_id:b.EmptyLayer.id,s3_layer_type:"empty"}),c.addLayer(a),b.EmptyLayer.base&&c.setBaseLayer(a));if(b.layers_js)for(d=b.layers_js,a=d.length;0<a;a--)eval(c,d[a-1]);if(b.layers_theme)for(d=b.layers_theme,a=d.length;0<a;a--)v(c,d[a-1]);if(b.layers_geojson)for(d=b.layers_geojson,a=d.length;0<a;a--)v(c,d[a-1]);if(b.layers_gpx)for(d=b.layers_gpx,a=d.length;0<a;a--)la(c,d[a-1]);if(b.layers_arcrest)for(d=b.layers_arcrest,
a=d.length;0<a;a--)ma(c,d[a-1]);b.CoordinateGrid&&na(c);if(b.layers_georss)for(d=b.layers_georss,a=d.length;0<a;a--)v(c,d[a-1]);if(b.layers_kml)for(c.s3.format_kml=new OpenLayers.Format.KML({extractStyles:!0,extractAttributes:!0,maxDepth:2}),d=b.layers_kml,a=d.length;0<a;a--)oa(c,d[a-1]);b.OWM&&pa(c);if(b.layers_shapefile)for(d=b.layers_shapefile,a=d.length;0<a;a--)v(c,d[a-1]);if(b.layers_wfs)for(d=b.layers_wfs,a=d.length;0<a;a--)qa(c,d[a-1]);if(b.feature_queries)for(d=b.feature_queries,a=d.length;0<
a;a--)v(c,d[a-1]);if(b.feature_resources)for(d=b.feature_resources,a=d.length;0<a;a--)v(c,d[a-1]);if(b.layers_feature)for(d=b.layers_feature,a=d.length;0<a;a--)v(c,d[a-1]);if(b.features||b.draw_feature||b.draw_polygon||navigator.geolocation)var f=ra(c);if(b.features)for(b=b.features,c=c.getProjectionObject(),a=0;a<b.length;a++)d=y.parseFeature(b[a]),d.geometry.transform(u,c),f.addFeatures([d])},ma=function(c,a){var b=a.name,d=[a.url],e=void 0!=a.layers?a.layers.join():0;if(void 0!=a.dir){var f=a.dir;
-1==$.inArray(f,c.s3.dirs)&&c.s3.dirs.push(f)}else f="";var g=void 0!=a.visibility?a.visibility:!0,b=new OpenLayers.Layer.ArcGIS93Rest(b,d,{layers:"show:"+e,isBaseLayer:void 0!=a.base?a.base:!1,transparent:void 0!=a.transparent?a.transparent:!0,dir:f,s3_layer_id:a.id,s3_layer_type:"arcrest"});b.setVisibility(g);c.addLayer(b);a._base&&c.setBaseLayer(b)},ha=function(c){var a=c.s3.options.Bing,b=a.ApiKey,d;a.Aerial&&(d=new OpenLayers.Layer.Bing({key:b,type:"Aerial",name:a.Aerial.name,s3_layer_id:a.Aerial.id,
s3_layer_type:"bing"}),c.addLayer(d),"aerial"==a.Base&&c.setBaseLayer(d));a.Road&&(d=new OpenLayers.Layer.Bing({key:b,type:"Road",name:a.Road.name,s3_layer_id:a.Road.id,s3_layer_type:"bing"}),c.addLayer(d),"road"==a.Base&&c.setBaseLayer(d));a.Hybrid&&(d=new OpenLayers.Layer.Bing({key:b,type:"AerialWithLabels",name:a.Hybrid.name,s3_layer_id:a.Hybrid.id,s3_layer_type:"bing"}),c.addLayer(d),"hybrid"==a.Base&&c.setBaseLayer(d))},na=function(c){var a=c.s3.options.CoordinateGrid;c.addLayer(new OpenLayers.Layer.cdauth.CoordinateGrid(null,
...
b},v=function(c,a){var b=a.name,d=a.url,e=void 0!=a.refresh?a.refresh:900;if(void 0!=a.dir){var f=a.dir;-1==$.inArray(f,c.s3.dirs)&&c.s3.dirs.push(f)}else f="";var g=void 0!=a.visibility?a.visibility:!0,k=void 0!=a.cluster_attribute?a.cluster_attribute:"colour",m=void 0!=a.cluster_distance?a.cluster_distance:20,h=void 0!=a.cluster_threshold?a.cluster_threshold:2,n=void 0!=a.projection?a.projection:4326,n=4326==n?u:new OpenLayers.Projection("EPSG:"+n),p=void 0!=a.type?a.type:"feature",r=B(c,a),l=r[0],
r=r[1],b=new OpenLayers.Layer.Vector(b,{dir:f,projection:n,protocol:new OpenLayers.Protocol.HTTP({url:d,format:y}),strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*e}),new OpenLayers.Strategy.AttributeCluster({attribute:k,distance:m,threshold:h})],legendURL:r,styleMap:l,s3_layer_id:a.id,s3_layer_type:p,s3_style:a.style});b.setVisibility(g);b.events.on({featureselected:x,featureunselected:w,loadstart:function(a){c.showThrobber(a.object.s3_layer_id)},
loadend:function(a){c.hideThrobber(a.object.s3_layer_id)}});c.addLayer(b);c.s3.layers_all.push(b)},ga=function(c){var a=c.s3.options.Google,b;a.MapMaker||a.MapMakerHybrid?(a.Satellite&&(b=new OpenLayers.Layer.Google(a.Satellite.name,{type:G_SATELLITE_MAP,sphericalMercator:!0,s3_layer_id:a.Satellite.id,s3_layer_type:"google"}),c.addLayer(b),"satellite"==a.Base&&c.setBaseLayer(b)),a.Maps&&(b=new OpenLayers.Layer.Google(a.Maps.name,{type:G_NORMAL_MAP,sphericalMercator:!0,s3_layer_id:a.Maps.id,s3_layer_type:"google"}),
...
s3_layer_type:"google"}),c.addLayer(b),"terrain"==a.Base&&c.setBaseLayer(b)))},la=function(c,a){var b=a.name,d=a.url,e=a.marker,f=z+e.i,g=e.h,k=e.w,m=void 0!=a.waypoints?a.waypoints:!0,h=void 0!=a.tracks?a.tracks:!0,n=void 0!=a.routes?a.routes:!0,e=void 0!=a.visibility?a.visibility:!0;if(void 0!=a.dir){var p=a.dir;-1==$.inArray(p,c.s3.dirs)&&c.s3.dirs.push(p)}else p="";var r=void 0!=a.opacity?a.opacity:1,l=void 0!=a.cluster_distance?a.cluster_distance:20,t=void 0!=a.cluster_threshold?a.cluster_threshold:
...
d,{dir:g,s3_layer_id:a.id,s3_layer_type:"tms",layername:e,type:void 0!=a.format?a.format:"png",numZoomLevels:f});void 0!=a.attribution&&(b.attribution=a.attribution);c.addLayer(b);a._base&&c.setBaseLayer(b)},qa=function(c,a){var b=a.name,d=a.url;void 0!=a.username&&void 0!=a.password&&(d=d.replace("://","://"+a.username+":"+a.password+"@"));var e=a.title,f=a.featureType,g=a.featureNS,k=a.schema,m=void 0!=a.version?a.version:"1.1.0",h=void 0!=a.geometryName?a.geometryName:"the_geom",n=void 0!=a.visibility?
...
strokeColor:"#f5902e",strokeWidth:2,strokeOpacity:g,graphicWidth:1,graphicHeight:1,graphicXOffset:-1,graphicYOffset:-1,graphicOpacity:g,graphicName:"square",externalGraphic:""},b=new OpenLayers.Style(b),n=[],p,r,l,t,s,u,v,x,w,y;$.each(k,function(a,b){p=void 0!=b.prop?b.prop:"value";void 0!=b.cat?(y=b.cat,w=b.label||y,s=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:p,value:y})):(w=b.label||b.low+"-"+b.high,s=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,
property:p,lowerBoundary:b.low,upperBoundary:b.high}));r=void 0!=b.externalGraphic?S3.Ap.concat("/static/"+b.externalGraphic):"";void 0!=b.fill?l="#"+b.fill:void 0!=b.stroke&&(l="#"+b.stroke);t=void 0!=b.fillOpacity?b.fillOpacity:1;graphic=void 0!=b.graphic?b.graphic:"square";v=void 0!=b.size?b.size:10;x=void 0!=b.strokeWidth?b.strokeWidth:2;u=new OpenLayers.Rule({filter:s,symbolizer:{externalGraphic:r,fillColor:l,fillOpacity:t,strokeColor:l,strokeWidth:x,graphicName:graphic,pointRadius:v},title:w});
