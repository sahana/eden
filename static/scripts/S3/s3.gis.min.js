...
"visible").parent().css("overflow","visible"),a.dropdown())},"html")};S3.gis.zoomToSelectedFeature=function(b,a,c,d){b=S3.gis.maps[b];a=new OpenLayers.LonLat(a,c);d=b.getZoom()+d;b.setCenter(a,d);for(d=0;d<b.popups.length;d++)b.removePopup(b.popups[d])};var U=function(b,a,c,d){void 0==c&&(c=i18n.gis_loading+"...<div class='throbber'></div>");void 0==d&&(d=S3.uid());var e=b.geometry.getBounds().getCenterLonLat();c=new OpenLayers.Popup.FramedCloud(d,e,new OpenLayers.Size(400,400),c,null,!0,Ga);b.popup=
c;c.feature=b;b.layer.map.addPopup(c);void 0!=a&&T(a,d+"_contentDiv",c);return c};S3.gis.addPopup=U;var T=function(b,a,c){0===b.indexOf("http://")&&(b=OpenLayers.ProxyHost+encodeURIComponent(b));$.ajaxS3({url:b,dataType:"html",success:function(b){try{$("#"+a).html(b),c.updateSize()}catch(e){}},error:function(b,e,f){msg="UNAUTHORIZED"==f?i18n.gis_requires_login:b.responseText;$("#"+a+"_contentDiv").html(msg);c.updateSize()}})},E=function(b){S(b);b=b.feature;var a=b.layer,c=a.s3_layer_type,d=a.map,
e=b.geometry.getBounds().getCenterLonLat(),f=S3.uid(),a=void 0!=a.title?a.title:"name",g,k,m;if(b.cluster){c=b.cluster;g=i18n.gis_cluster_multiple+":<ul>";for(var n=c.length,p=d.s3.id,r=0;r<n;r++){var h=c[r].attributes,d=void 0!=h.popup?h.popup.split("<br />",1)[0]:h[a];g=void 0!=h.url?g+("<li><a href='javascript:S3.gis.loadClusterPopup(\""+p+'", "'+h.url+'", "'+f+"\")'>"+d+"</a></li>"):g+("<li>"+d+"</li>")}g+="</ul>";g+="<div align='center'><a href='javascript:S3.gis.zoomToSelectedFeature(\""+p+
'", '+e.lon+","+e.lat+", 3)'>"+i18n.gis_zoomin+"</a></div>"}else if("kml"==c){h=b.attributes;if(void 0!=b.style.balloonStyle)g=b.style.balloonStyle.replace(/{([^{}]*)}/g,function(a,b){var c=h[b];return"string"===typeof c||"number"===typeof c?c:a});else{c=typeof h[a];d="object"==c?h[a].value:h[a];g="<h3>"+d+"</h3>";for(var d=b.layer.body.split(" "),l,e=0;e<d.length;e++)c=typeof h[d[e]],"object"==c?(a=h[d[e]].displayName,""===a&&(a=d[e]),c=h[d[e]].value,l='<div class="gis_popup_row"><div class="gis_popup_label">'+
a+':</div><div class="gis_popup_cell">'+c+"</div></div>"):l=void 0!=h[d[e]]?'<div class="gis_popup_row">'+h[d[e]]+"</div>":"",g+=l}-1!=g.search("<script")&&(g="Content contained Javascript! Escaped content below.<br />"+g.replace(/</g,"<"))}else if("gpx"!=c)if("shapefile"==c)h=b.attributes,g="<div>",$.each(h,function(a,b){"id_orig"==a&&(a="id");l='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_cell">'+b+"</div></div>";g+=l}),g+="</div>";else if("wfs"==c)h=
b.attributes,d=h[a],g="<h3>"+d+"</h3>",$.each(h,function(a,b){l='<div class="gis_popup_row"><div class="gis_popup_label">'+a+':</div><div class="gis_popup_val">'+b+"</div></div>";g+=l});else if(void 0!=b.attributes.url)m=b.attributes.url,g=i18n.gis_loading+"...<div class='throbber'></div>";else{h=b.attributes;d=void 0==h.name?"":"<h3>"+h.name+"</h3>";e=void 0==h.description?"":"<p>"+h.description+"</p>";a=void 0==h.link?"":'<a href="'+h.link+'" target="_blank">'+h.link+"</a>";if(void 0==h.data)c=
"";else if(0===h.data.indexOf("http://")){k=!0;var t=S3.uid(),c='<div id="'+t+'">'+i18n.gis_loading+"...<div class='throbber'></div></div>"}else c="<p>"+h.data+"</p>";n=void 0==h.image?"":0===h.image.indexOf("http://")?'<img src="'+h.image+'" height=300 width=300>':"";g=d+e+a+c+n}m=U(b,m,g,f);k&&T(b.attributes.data,t,m)},F=function(b){b=b.feature;b.popup&&(b.layer.map.removePopup(b.popup),b.popup.destroy(),delete b.popup)},Ga=function(b){b=this.map;this.feature&&(delete this.feature.popup,b.s3.popupControl.unselect(this.feature));
for(;b.popups.length;)b.removePopup(b.popups[0])},fa=function(b){var a=b.map,c=a.s3.draftLayer,d={fillColor:"#000",fillOpacity:0.1,strokeWidth:0},e=new OpenLayers.Control.Geolocate({geolocationOptions:{enableHighAccuracy:!1,maximumAge:0,timeout:7E3}});a.addControl(e);e.events.register("locationupdated",this,function(b){c.removeAllFeatures();var e=new OpenLayers.Feature.Vector(OpenLayers.Geometry.Polygon.createRegularPolygon(new OpenLayers.Geometry.Point(b.point.x,b.point.y),b.position.coords.accuracy/
2,40,0),{},d);c.addFeatures([new OpenLayers.Feature.Vector(b.point,{},{graphicName:"cross",strokeColor:"#f00",strokeWidth:2,fillOpacity:0,pointRadius:10}),e]);a.zoomToExtent(c.getDataExtent());Ha(a,e)});e.events.register("locationfailed",this,function(){OpenLayers.Console.log("Location detection failed")});var f=new Ext.Toolbar.Button({iconCls:"geolocation",tooltip:i18n.gis_geoLocate,handler:function(){c.removeAllFeatures();e.activate()}});b.addButton(f)},Ha=function(b,a){var c=a.geometry.getCentroid(),
d=a.geometry.getBounds(),e=Math.abs((d.right-d.left)/2),f=0,g="up";window.resizeInterval=window.setInterval(function(){16<f&&clearInterval(window.resizeInterval);var d=0.03*e/e;switch(f){case 4:case 12:g="down";break;case 8:g="up"}"up"!==g&&(d=-Math.abs(d));a.geometry.resize(1+d,c);b.s3.draftLayer.drawFeature(a);f++},50,c,e)},la=function(b){var a=b.map,c=a.s3,d=new Ext.Toolbar.Button({iconCls:"googleearth",tooltip:c.options.Google.Earth,enableToggle:!0,toggleHandler:function(b,d){!0===d?(c.mapPanelContainer.getLayout().setActiveItem(1),
...
{dblclick:function(a){return!0},CLASS_NAME:"OpenLayers.Handler.PointS3"});var d=b.s3.draftLayer,e=new OpenLayers.Control.DrawFeature(d,OpenLayers.Handler.PointS3,{featureAdded:function(a){b.s3.lastDraftFeature?b.s3.lastDraftFeature.destroy():1<d.features.length&&d.features[0].destroy();void 0!=b.s3.pointPlaced&&b.s3.pointPlaced(a);b.s3.lastDraftFeature=a}});if(a){var f=new GeoExt.Action({control:e,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},
map:b,iconCls:"drawpoint-off",tooltip:i18n.gis_draw_feature,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:c});a.add(f);b.s3.pointButton=f}else b.addControl(e),c&&(e.activate(),$(".olMapViewport").addClass("crosshair"))},P=function(b,a,c){var d=b.s3.draftLayer,e=new OpenLayers.Control.DrawFeature(d,OpenLayers.Handler.Path,{featureAdded:function(a){b.s3.lastDraftFeature?b.s3.lastDraftFeature.destroy():1<d.features.length&&d.features[0].destroy();b.s3.lastDraftFeature=a}});if(a){var f=
new GeoExt.Action({control:e,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},map:b,iconCls:"drawline-off",tooltip:i18n.gis_draw_line,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:c,activateOnEnable:!0,deactivateOnDisable:!0});a.add(f);b.s3.lineButton=f}else b.addControl(e),c&&(e.activate(),$(".olMapViewport").addClass("crosshair"))},Q=function(b,a,c,d){var e=b.s3.draftLayer;d=new OpenLayers.Control.DrawFeature(e,
d?OpenLayers.Handler.Polygon:OpenLayers.Handler.RegularPolygon,{handlerOptions:d?{sides:4,snapAngle:90}:{},featureAdded:function(a){b.s3.lastDraftFeature?b.s3.lastDraftFeature.destroy():1<e.features.length&&e.features[0].destroy();var c=$("#gis_location_wkt");if(c.length){var d=a.geometry.transform(b.getProjectionObject(),v).toString();c.val(d);$("#gis_location_lat").val("");$("#gis_location_lon").val("")}else c=$("#gis_search_polygon_input"),c.length&&(d=a.geometry.transform(b.getProjectionObject(),
v).toString(),c.val(d).trigger("change"));b.s3.lastDraftFeature=a}});if(a){var f=new GeoExt.Action({control:d,handler:function(){f.items[0].pressed?$(".olMapViewport").addClass("crosshair"):$(".olMapViewport").removeClass("crosshair")},map:b,iconCls:"drawpolygon-off",tooltip:i18n.gis_draw_polygon,allowDepress:!0,enableToggle:!0,toggleGroup:"controls",pressed:c,activateOnEnable:!0,deactivateOnDisable:!0});a.add(f);b.s3.polygonButton=f}else b.addControl(d),c&&(d.activate(),$(".olMapViewport").addClass("crosshair"))},
ja=function(b){var a=b.map,c=new Ext.Toolbar.Button({iconCls:"potlatch",tooltip:i18n.gis_potlatch,handler:function(){var b=a.getZoom();if(14>b)alert(i18n.gis_osm_zoom_closer);else{var c=a.getCenter();c.transform(a.getProjectionObject(),v);b=S3.Ap.concat("/gis/potlatch2/potlatch2.html")+"?lat="+c.lat+"&lon="+c.lon+"&zoom="+b;window.open(b)}}});b.addSeparator();b.addButton(c)},ga=function(b){var a=new Ext.Toolbar.Button({iconCls:"save",tooltip:i18n.gis_save,handler:function(){V(b.map)}});b.addSeparator();
...
">"+i18n.gis_new_map+"</div>",$("#"+c+" .map_save_panel .fleft").html(a+e),$("#"+c+" .map_save_panel label").labelOver("over"));g.unbind("click").click(function(){V(b);var a=$("#"+c+"_save").val();$("#"+c+" .map_save_name").html(a);d.config_name=a;a=d.pe_id?"?~.pe_id__belongs="+d.pe_id:"";a='<div class="saved"><p><i>'+i18n.saved+'</i></p><p><a href="'+S3.Ap.concat("/gis/config")+a+'">'+i18n.gis_my_maps+"</a></p></div>";$("#"+c+" .map_save_panel .fleft").hide().before(a);$("#"+c+" .map_save_panel .checkbox").prop("checked",
...
a.leaf?!0:!1:!1},null,!0);if(d){var f=d.layer.s3_layer_type,g=S3.Ap.concat("/gis/layer_"+f+".plain?layer_"+f+".layer_id="+d.layer.s3_layer_id+"&update=1");Ext.Ajax.request({url:g,method:"GET",success:function(a,g){c&&c.close();var n;"feature"==f?(n=new Ext.TabPanel({activeTab:0,items:[{title:"Layer Properties",html:a.responseText},{title:"Filter",id:"s3_gis_layer_filter_tab",html:""}]}),n.items.items[1].on("activate",function(){var a;Ext.iterate(b.s3.layers_feature,function(b,c,f){b.id==d.layer.s3_layer_id&&
(a=b.url.replace(/.geojson.+/,"/search.plain"))});Ext.get("s3_gis_layer_filter_tab").load({url:a,discardUrl:!1,callback:function(){S3.addTooltips();S3.search.select_letter_label()},text:"Loading...",timeout:30,scripts:!1})})):n=new Ext.Panel({title:"Layer Properties",html:a.responseText});c=new Ext.Window({width:400,layout:"fit",items:[n]});c.show();$("#plain form").submit(function(){var a=$('#plain input[name="id"]').val(),a=S3.Ap.concat("/gis/layer_"+f+"/"+a+".plain/update"),b=$("#plain input"),
...
k&&!m&&(b=k.strokeWidth);return b||2},label:function(a){var b;a.cluster?1<a.attributes.count&&(b=a.attributes.count):a.layer&&void 0!=a.layer.s3_style&&(a=a.layer.s3_style,!m&&a.show_label&&(b=a.label));return b||""}}}),m="[object Array]"===Object.prototype.toString.call(k)?!0:!1;if(m){var n=[],p,r,h,l,t,s,v,x,w,u,y,z,A;$.each(k,function(a,b){var c={};void 0!=b.fallback?(c.title=b.fallback,elsefilter=c.elseFilter=!0):(p=void 0!=b.prop?b.prop:"value",void 0!=b.cat?(h=b.cat,c.title=b.label||h,c.filter=
new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO,property:p,value:h})):(c.title=b.label||b.low+"-"+b.high,c.filter=new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.BETWEEN,property:p,lowerBoundary:b.low,upperBoundary:b.high})));if(void 0!=b.externalGraphic){l=S3.Ap.concat("/static/"+b.externalGraphic);var d=new Image;d.src=l;t=d.height;s=d.width;v=-(s/2);x=-t}else l="",s=t=1,x=v=-1;void 0!=b.fill?w="#"+b.fill:void 0!=b.stroke&&(w="#"+b.stroke);u=void 0!=
b.fillOpacity?b.fillOpacity:g;z=void 0!=b.strokeOpacity?b.strokeOpacity:1;graphic=void 0!=b.graphic?b.graphic:"square";y=void 0!=b.size?b.size:10;A=void 0!=b.strokeWidth?b.strokeWidth:2;c.symbolizer={externalGraphic:l,fillColor:w,fillOpacity:u,strokeColor:w,strokeOpacity:z,strokeWidth:A,graphicName:graphic,graphicHeight:t,graphicWidth:s,graphicXOffset:v,graphicYOffset:x,pointRadius:y};r=new OpenLayers.Rule(c);n.push(r)});0!=a.cluster_threshold&&(r=new OpenLayers.Rule({elseFilter:!0,title:" "}),n.push(r));
c.addRules(n)}return[new OpenLayers.StyleMap({"default":c,select:1!=g?{graphicOpacity:1}:{fillColor:"#ffdc33",strokeColor:"#ff9933"}}),d]}})();
