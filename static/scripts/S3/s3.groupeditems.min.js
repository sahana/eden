...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,q,g){b instanceof String&&(b=String(b));for(var a=b.length,c=0;c<a;c++){var d=b[c];if(q.call(g,d,c,b))return{i:c,v:d}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,q,g){b!=Array.prototype&&b!=Object.prototype&&(b[q]=g.value)};
$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,q,g,a){if(q){g=$jscomp.global;b=b.split(".");for(a=0;a<b.length-1;a++){var c=b[a];c in g||(g[c]={});g=g[c]}b=b[b.length-1];a=g[b];q=q(a);q!=a&&null!=q&&$jscomp.defineProperty(g,b,{configurable:!0,writable:!0,value:q})}};
