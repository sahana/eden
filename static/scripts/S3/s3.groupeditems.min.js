...
e[m])||(c=!0):a&&a.hasOwnProperty(m)||k.push(h[n]));for(m in e)for(n=0,p=e[m].length;n<p;n++)c||-1!=f.inArray(e[m][n],h)||(c=!0),k.push(e[m][n]);a=k.join("&");b=d[0];a&&(b=b+"?"+a);this.options.ajaxURL=b;return c},_serialize:function(){var a=this.items;if(a){var b="";this.data&&(b=JSON.stringify(this.data));a.val(b)}return b},_deserialize:function(){this.data={};var a=this.items;a&&(a=a.val())&&(this.data=JSON.parse(a));return this.data},_bindEvents:function(){var a=this;f(this.element).delegate(".gi-export",
"click"+this.eventNamespace,function(){var b=f(this).data("url"),c=a._getFilters();c&&(b=S3.search.filterURL(b,c));window.open(b)})},_unbindEvents:function(){f(this.element).undelegate(this.eventNamespace)}})})(jQuery);
