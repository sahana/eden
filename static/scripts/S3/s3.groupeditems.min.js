...
e(this).data("url"),d=a._getFilters();d&&(b=S3.search.filterURL(b,d));window.open(b)})},_unbindEvents:function(){e(this.element).undelegate(this.namespace)}})})(jQuery);
