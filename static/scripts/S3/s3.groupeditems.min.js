...
$jscomp.global.Symbol(b):$jscomp.POLYFILL_PREFIX+g+"$"+b),$jscomp.defineProperty(a,$jscomp.propertyToPolyfillSymbol[b],{configurable:!0,writable:!0,value:k})))};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(k,g){return $jscomp.findInternal(this,k,g).v}},"es6","es3");
