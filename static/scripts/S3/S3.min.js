...
$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):b(jQuery)})(function(b){b.ui=b.ui||{};return b.ui.version="1.12.1"});
...
g=b(this),k=g.outerWidth(),h=g.outerHeight(),n=parseInt(b.css(this,"marginLeft"),10)||0,m=parseInt(b.css(this,"marginTop"),10)||0,p=k+n+(parseInt(b.css(this,"marginRight"),10)||0)+z.width,t=h+m+(parseInt(b.css(this,"marginBottom"),10)||0)+z.height,r=b.extend({},y),L=a(v.my,g.outerWidth(),g.outerHeight());"right"===d.my[0]?r.left-=k:"center"===d.my[0]&&(r.left-=k/2);"bottom"===d.my[1]?r.top-=h:"center"===d.my[1]&&(r.top-=h/2);r.left+=L[0];r.top+=L[1];var V={marginLeft:n,marginTop:m};b.each(["left",
"top"],function(a,e){if(b.ui.position[u[a]])b.ui.position[u[a]][e](r,{targetWidth:w,targetHeight:A,elemWidth:k,elemHeight:h,collisionPosition:V,collisionWidth:p,collisionHeight:t,offset:[G[0]+L[0],G[1]+L[1]],my:d.my,at:d.at,within:q,elem:g})});d.using&&(c=function(b){var a=B.left-r.left,c=a+w-k,q=B.top-r.top,n=q+A-h,m={target:{element:l,left:B.left,top:B.top,width:w,height:A},element:{element:g,left:r.left,top:r.top,width:k,height:h},horizontal:0>c?"left":0<a?"right":"center",vertical:0>n?"top":0<
q?"bottom":"middle"};w<k&&f(a+c)<w&&(m.horizontal="center");A<h&&f(q+n)<A&&(m.vertical="middle");e(f(a),f(c))>e(f(q),f(n))?m.important="horizontal":m.important="vertical";d.using.call(this,b,m)});g.offset(b.extend(r,{using:c}))})};b.ui.position={fit:{left:function(b,a){var c=a.within,d=c.isWindow?c.scrollLeft:c.offset.left,g=c.width,f=b.left-a.collisionPosition.marginLeft;c=d-f;var k=f+a.collisionWidth-g-d;a.collisionWidth>g?0<c&&0>=k?(a=b.left+c+a.collisionWidth-g-d,b.left+=c-a):b.left=0<k&&0>=c?
...
a||null==c)throw"Invalid arguments";c="object"===typeof c?c.toString():c+"";if(""===c)return null;var d,f=0;var g=(e?e.shortYearCutoff:null)||this._defaults.shortYearCutoff;g="string"!==typeof g?g:(new Date).getFullYear()%100+parseInt(g,10);var h=(e?e.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(e?e.dayNames:null)||this._defaults.dayNames,m=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort,u=(e?e.monthNames:null)||this._defaults.monthNames,v=e=-1,r=-1,w=-1,A=!1,B=function(b){(b=
d+1<a.length&&a.charAt(d+1)===b)&&d++;return b},y=function(a){var b=B(a);b="@"===a?14:"!"===a?20:"y"===a&&b?4:"o"===a?3:2;a=new RegExp("^\\d{"+("y"===a?b:1)+","+b+"}");a=c.substring(f).match(a);if(!a)throw"Missing number at position "+f;f+=a[0].length;return parseInt(a[0],10)},G=function(a,e,d){var g=-1;a=b.map(B(a)?d:e,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});b.each(a,function(a,b){a=b[1];if(c.substr(f,a.length).toLowerCase()===a.toLowerCase())return g=
b[0],f+=a.length,!1});if(-1!==g)return g+1;throw"Unknown name at position "+f;},H=function(){if(c.charAt(f)!==a.charAt(d))throw"Unexpected literal at position "+f;f++};for(d=0;d<a.length;d++)if(A)"'"!==a.charAt(d)||B("'")?H():A=!1;else switch(a.charAt(d)){case "d":r=y("d");break;case "D":G("D",h,k);break;case "o":w=y("o");break;case "m":v=y("m");break;case "M":v=G("M",m,u);break;case "y":e=y("y");break;case "@":var C=new Date(y("@"));e=C.getFullYear();v=C.getMonth()+1;r=C.getDate();break;case "!":C=
new Date((y("!")-this._ticksTo1970)/1E4);e=C.getFullYear();v=C.getMonth()+1;r=C.getDate();break;case "'":B("'")?H():A=!0;break;default:H()}if(f<c.length&&(h=c.substr(f),!/^\s+/.test(h)))throw"Extra/unparsed characters found in date: "+h;-1===e?e=(new Date).getFullYear():100>e&&(e+=(new Date).getFullYear()-(new Date).getFullYear()%100+(e<=g?0:-100));if(-1<w){v=1;r=w;do{g=this._getDaysInMonth(e,v-1);if(r<=g)break;v++;r-=g}while(1)}C=this._daylightSavingAdjust(new Date(e,v-1,r));if(C.getFullYear()!==
...
var K="";if(A){K+="<div class='ui-datepicker-group";if(1<v[1])switch(c){case 0:K+=" ui-datepicker-group-first";D=" ui-corner-"+(g?"right":"left");break;case v[1]-1:K+=" ui-datepicker-group-last";D=" ui-corner-"+(g?"left":"right");break;default:K+=" ui-datepicker-group-middle",D=""}K+="'>"}K+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+D+"'>"+(/all|left/.test(D)&&0===b?g?z:C:"")+(/all|right/.test(D)&&0===b?g?C:z:"")+this._generateMonthYearHeader(a,r,H,y,G,0<b||0<c,Y,aa)+
"</div><table class='ui-datepicker-calendar'><thead><tr>";var F=w?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(D=0;7>D;D++){var E=(D+u)%7;F+="<th scope='col'"+(5<=(D+u+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+U[E]+"'>"+x[E]+"</span></th>"}K+=F+"</tr></thead><tbody>";F=this._getDaysInMonth(H,r);H===a.selectedYear&&r===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,F));D=(this._getFirstDayOfMonth(H,r)-u+7)%7;F=Math.ceil((D+F)/7);this.maxRows=
F=A?this.maxRows>F?this.maxRows:F:F;E=this._daylightSavingAdjust(new Date(H,r,1-D));for(e=0;e<F;e++){K+="<tr>";var O=w?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(E)+"</td>":"";for(D=0;7>D;D++){var S=fa?fa.apply(a.input?a.input[0]:null,[E]):[!0,""];var X=(d=E.getMonth()!==r)&&!ba||!S[0]||y&&E<y||G&&E>G;O+="<td class='"+(5<=(D+u+6)%7?" ui-datepicker-week-end":"")+(d?" ui-datepicker-other-month":"")+(E.getTime()===R.getTime()&&r===a.selectedMonth&&a._keyEvent||L.getTime()===E.getTime()&&
L.getTime()===R.getTime()?" "+this._dayOverClass:"")+(X?" "+this._unselectableClass+" ui-state-disabled":"")+(d&&!N?"":" "+S[1]+(E.getTime()===B.getTime()?" "+this._currentClass:"")+(E.getTime()===f.getTime()?" ui-datepicker-today":""))+"'"+(d&&!N||!S[2]?"":" title='"+S[2].replace(/'/g,"&#39;")+"'")+(X?"":" data-handler='selectDay' data-event='click' data-month='"+E.getMonth()+"' data-year='"+E.getFullYear()+"'")+">"+(d&&!N?"&#xa0;":X?"<span class='ui-state-default'>"+E.getDate()+"</span>":"<a class='ui-state-default"+
(E.getTime()===f.getTime()?" ui-state-highlight":"")+(E.getTime()===B.getTime()?" ui-state-active":"")+(d?" ui-priority-secondary":"")+"' href='#'>"+E.getDate()+"</a>")+"</td>";E.setDate(E.getDate()+1);E=this._daylightSavingAdjust(E)}K+=O+"</tr>"}r++;11<r&&(r=0,H++);K+="</tbody></table>"+(A?"</div>"+(0<v[0]&&c===v[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");W+=K}V+=W}a._keyEvent=!1;return V+h},_generateMonthYearHeader:function(a,b,c,e,d,f,h,t){var g,l=this._get(a,"changeMonth"),k=this._get(a,
"changeYear"),q=this._get(a,"showMonthAfterYear"),n="<div class='ui-datepicker-title'>",p="";if(f||!l)p+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=e&&e.getFullYear()===c;var m=d&&d.getFullYear()===c;p+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(g=0;12>g;g++)(!h||g>=e.getMonth())&&(!m||g<=d.getMonth())&&(p+="<option value='"+g+"'"+(g===b?" selected='selected'":"")+">"+t[g]+"</option>");p+="</select>"}q||(n+=p+(!f&&l&&k?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml=
"",f||!k)n+="<span class='ui-datepicker-year'>"+c+"</span>";else{t=this._get(a,"yearRange").split(":");var y=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?y+parseInt(a,10):parseInt(a,10);return isNaN(a)?y:a};b=h(t[0]);t=Math.max(b,h(t[1]||""));b=e?Math.max(b,e.getFullYear()):b;t=d?Math.min(t,d.getFullYear()):t;for(a.yearshtml+="<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>";b<=t;b++)a.yearshtml+="<option value='"+
...
var n=1==this._get(a,"showMinutes"),q=this._get(a,"amPmText"),p=this._get(a,"rows"),t=0,z=0,u=e=0,v=0,r=0,w=[],A=this._get(a,"hours"),B=0;var y=this._get(a,"hourText");var G=this._get(a,"showCloseButton"),H=this._get(a,"closeButtonText"),C=this._get(a,"showNowButton"),U=this._get(a,"nowButtonText"),x=this._get(a,"showDeselectButton"),Y=this._get(a,"deselectButtonText"),aa=G||C||x;for(b=A.starts;b<=A.ends;b++)w.push(b);b=Math.ceil(w.length/p);if(d){for(B=0;B<w.length;B++)12>w[B]?e++:u++;B=0;t=Math.floor(e/
w.length*p);z=Math.floor(u/w.length*p);p!=t+z&&(e&&(!u||!t||z&&e/t>=u/z)?t++:z++);v=Math.min(t,1);r=t+1;b=0==t?Math.ceil(u/z):0==z?Math.ceil(e/t):Math.ceil(Math.max(e/t,u/z))}e='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(l){e+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+y+'</div><table class="ui-timepicker">';for(l=1;l<=p;l++){e+="<tr>";l==v&&d&&(e+='<th rowspan="'+t.toString()+'" class="periods" scope="row">'+
q[0]+"</th>");l==r&&d&&(e+='<th rowspan="'+z.toString()+'" class="periods" scope="row">'+q[1]+"</th>");for(y=1;y<=b;y++)d&&l<r&&12<=w[B]?e+=this._generateHTMLHourCell(a,void 0,c,m):(e+=this._generateHTMLHourCell(a,w[B],c,m),B++);e+="</tr>"}e+="</table></td>"}n&&(e=e+'<td class="ui-timepicker-minutes">'+this._generateHTMLMinutes(a),e+="</td>");e+="</tr>";aa&&(c='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">',C&&(c+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+
...
null,[b,a]);this._updateAlternate(a,b);return b},_getParsedTime:function(a){if(-1==a.hours&&-1==a.minutes)return"";if(a.hours<a.hours.starts||a.hours>a.hours.ends)a.hours=0;if(a.minutes<a.minutes.starts||a.minutes>a.minutes.ends)a.minutes=0;var b="",c=1==this._get(a,"showPeriod"),e=1==this._get(a,"showLeadingZero"),d=1==this._get(a,"showHours"),m=1==this._get(a,"showMinutes"),l=1==this._get(a,"optionalMinutes"),n=this._get(a,"amPmText"),q=a.hours?a.hours:0,p=a.minutes?a.minutes:0,t=q?q:0;q="";-1==
t&&(t=0);-1==p&&(p=0);c&&(0==a.hours&&(t=12),12>a.hours?b=n[0]:(b=n[1],12<t&&(t-=12)));c=t.toString();e&&10>t&&(c="0"+c);e=p.toString();10>p&&(e="0"+e);d&&(q+=c);!d||!m||l&&0==e||(q+=this._get(a,"timeSeparator"));!m||l&&0==e||(q+=e);d&&0<b.length&&(q+=this._get(a,"periodSeparator")+b);return q},_updateAlternate:function(a,c){(a=this._get(a,"altField"))&&b(a).each(function(a,e){b(e).val(c)})},_getTimeAsDateTimepicker:function(a){a=this._getInst(a);if(-1==a.hours&&-1==a.minutes)return"";if(a.hours<
...
{hour:f},c),r+='<td data-for="'+e+'">'+g+"</td>";else for(f=c[e+"Min"];f<=h[e];f+=parseInt(c[e+"Grid"],10))k[e]++,r+='<td data-for="'+e+'">'+(10>f?"0":"")+f+"</td>";r+="</tr></table></div>"}r+="</dd>"}w=null!==c.showTimezone?c.showTimezone:this.support.timezone;r+='<dt class="ui_tpicker_timezone_label"'+(w?"":' style="display:none;"')+">"+c.timezoneText+"</dt>";var B=b(r+('<dd class="ui_tpicker_timezone" '+(w?"":' style="display:none;"')+"></dd></dl></div>"));!0===c.timeOnly&&(B.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">'+
c.timeOnlyTitle+"</div></div>"),a.find(".ui-datepicker-header, .ui-datepicker-calendar").hide());w=0;for(A=d.units.length;w<A;w++)e=d.units[w],f=e.substr(0,1).toUpperCase()+e.substr(1),g=null!==c["show"+f]?c["show"+f]:this.support[e],d[e+"_slider"]=d.control.create(d,B.find(".ui_tpicker_"+e+"_slider"),e,d[e],c[e+"Min"],h[e],c["step"+f]),g&&0<c[e+"Grid"]&&(r=100*k[e]*c[e+"Grid"]/(h[e]-c[e+"Min"]),B.find(".ui_tpicker_"+e+" table").css({width:r+"%",marginLeft:c.isRTL?"0":r/(-2*k[e])+"%",marginRight:c.isRTL?
r/(-2*k[e])+"%":"0",borderCollapse:"collapse"}).find("td").click(function(a){var c=b(this),f=c.html();a=parseInt(f.replace(/[^0-9]/g),10);f=f.replace(/[^apm]/ig);c=c.data("for");"hour"===c&&(-1!==f.indexOf("p")&&12>a?a+=12:-1!==f.indexOf("a")&&12===a&&(a=0));d.control.value(d,d[c+"_slider"],e,a);d._onTimeChange();d._onSelectHandler()}).css({cursor:"pointer",width:100/k[e]+"%",textAlign:"center",overflow:"hidden"}));this.timezone_select=B.find(".ui_tpicker_timezone").append("<select></select>").find("select");
...
m(d);this.timezone_select.change(function(){d._onTimeChange();d._onSelectHandler()});c=a.find(".ui-datepicker-buttonpane");c.length?c.before(B):a.append(B);this.$timeObj=B.find(".ui_tpicker_time");null!==this.inst&&(a=this.timeDefined,this._onTimeChange(),this.timeDefined=a);if(this._defaults.addSliderAccess){var y=this._defaults.sliderAccessArgs,G=this._defaults.isRTL;y.isRTL=G;setTimeout(function(){if(0===B.find(".ui-slider-access").length){B.find(".ui-slider:visible").sliderAccess(y);var a=B.find(".ui-slider-access:eq(0)").outerWidth(!0);
a&&B.find("table:visible").each(function(){var c=b(this),e=c.outerWidth(),d=c.css(G?"marginRight":"marginLeft").toString().replace("%",""),f=e-a,g={width:f,marginRight:0,marginLeft:0};g[G?"marginRight":"marginLeft"]=d*f/e+"%";c.css(g)})}},10)}d._limitMinMaxDateTime(this.inst,!0)}},_limitMinMaxDateTime:function(a,c){var e=this._defaults,d=new Date(a.selectedYear,a.selectedMonth,a.selectedDay);if(this._defaults.showTimepicker){if(null!==b.datepicker._get(a,"minDateTime")&&void 0!==b.datepicker._get(a,
"minDateTime")&&d){var f=b.datepicker._get(a,"minDateTime"),g=new Date(f.getFullYear(),f.getMonth(),f.getDate(),0,0,0,0);if(null===this.hourMinOriginal||null===this.minuteMinOriginal||null===this.secondMinOriginal||null===this.millisecMinOriginal||null===this.microsecMinOriginal)this.hourMinOriginal=e.hourMin,this.minuteMinOriginal=e.minuteMin,this.secondMinOriginal=e.secondMin,this.millisecMinOriginal=e.millisecMin,this.microsecMinOriginal=e.microsecMin;a.settings.timeOnly||g.getTime()===d.getTime()?
...
(this._defaults.minuteMax-this._defaults.minuteMin)%this._defaults.stepMinute,10),e=parseInt(this._defaults.secondMax-(this._defaults.secondMax-this._defaults.secondMin)%this._defaults.stepSecond,10),d=parseInt(this._defaults.millisecMax-(this._defaults.millisecMax-this._defaults.millisecMin)%this._defaults.stepMillisec,10),f=parseInt(this._defaults.microsecMax-(this._defaults.microsecMax-this._defaults.microsecMin)%this._defaults.stepMicrosec,10),this.hour_slider&&(this.control.options(this,this.hour_slider,
...
max:e,step:this._defaults.stepSecond}),this.control.value(this,this.second_slider,"second",this.second-this.second%this._defaults.stepSecond)),this.millisec_slider&&(this.control.options(this,this.millisec_slider,"millisec",{min:this._defaults.millisecMin,max:d,step:this._defaults.stepMillisec}),this.control.value(this,this.millisec_slider,"millisec",this.millisec-this.millisec%this._defaults.stepMillisec)),this.microsec_slider&&(this.control.options(this,this.microsec_slider,"microsec",{min:this._defaults.microsecMin,
max:f,step:this._defaults.stepMicrosec}),this.control.value(this,this.microsec_slider,"microsec",this.microsec-this.microsec%this._defaults.stepMicrosec)))}},_onTimeChange:function(){if(this._defaults.showTimepicker){var a=this.hour_slider?this.control.value(this,this.hour_slider,"hour"):!1,c=this.minute_slider?this.control.value(this,this.minute_slider,"minute"):!1,e=this.second_slider?this.control.value(this,this.second_slider,"second"):!1,d=this.millisec_slider?this.control.value(this,this.millisec_slider,
"millisec"):!1,f=this.microsec_slider?this.control.value(this,this.microsec_slider,"microsec"):!1,g=this.timezone_select?this.timezone_select.val():!1,h=this._defaults,k=h.pickerTimeFormat||h.timeFormat,m=h.pickerTimeSuffix||h.timeSuffix;"object"===typeof a&&(a=!1);"object"===typeof c&&(c=!1);"object"===typeof e&&(e=!1);"object"===typeof d&&(d=!1);"object"===typeof f&&(f=!1);"object"===typeof g&&(g=!1);!1!==a&&(a=parseInt(a,10));!1!==c&&(c=parseInt(c,10));!1!==e&&(e=parseInt(e,10));!1!==d&&(d=parseInt(d,
10));!1!==f&&(f=parseInt(f,10));!1!==g&&(g=g.toString());var w=h[12>a?"amNames":"pmNames"][0],A=a!==parseInt(this.hour,10)||c!==parseInt(this.minute,10)||e!==parseInt(this.second,10)||d!==parseInt(this.millisec,10)||f!==parseInt(this.microsec,10)||0<this.ampm.length&&12>a!==(-1!==b.inArray(this.ampm.toUpperCase(),this.amNames))||null!==this.timezone&&g!==this.timezone.toString();A&&(!1!==a&&(this.hour=a),!1!==c&&(this.minute=c),!1!==e&&(this.second=e),!1!==d&&(this.millisec=d),!1!==f&&(this.microsec=
f),!1!==g&&(this.timezone=g),this.inst||(this.inst=b.datepicker._getInst(this.$input[0])),this._limitMinMaxDateTime(this.inst,!0));this.support.ampm&&(this.ampm=w);this.formattedTime=b.datepicker.formatTime(h.timeFormat,this,h);this.$timeObj&&(k===h.timeFormat?this.$timeObj.text(this.formattedTime+m):this.$timeObj.text(b.datepicker.formatTime(k,this,h)+m));this.timeDefined=!0;A&&this._updateDateTime()}},_onSelectHandler:function(){var a=this._defaults.onSelect||this.inst.settings.onSelect,b=this.$input?
this.$input[0]:null;a&&b&&a.apply(b,[this.formattedDateTime,this])},_updateDateTime:function(a){a=this.inst||a;var c=b.datepicker._daylightSavingAdjust(0<a.currentYear?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(a.selectedYear,a.selectedMonth,a.selectedDay)),e=b.datepicker._get(a,"dateFormat"),d=b.datepicker._getFormatConfig(a),f=null!==c&&this.timeDefined;e=this.formattedDate=b.datepicker.formatDate(e,null===c?new Date:c,d);""===a.lastVal&&(a.currentYear=a.selectedYear,a.currentMonth=
...
this.$input.val(this.formattedDate)):this.$altInput?(this.$input.val(e),a="",f=null!==this._defaults.altSeparator?this._defaults.altSeparator:this._defaults.separator,e=null!==this._defaults.altTimeSuffix?this._defaults.altTimeSuffix:this._defaults.timeSuffix,this._defaults.timeOnly||(a=this._defaults.altFormat?b.datepicker.formatDate(this._defaults.altFormat,null===c?new Date:c,d):this.formattedDate)&&(a+=f),a=null!==this._defaults.altTimeFormat?a+(b.datepicker.formatTime(this._defaults.altTimeFormat,
...
c,e,d,f,g,h){var l=a._defaults.isRTL;return c.prop("slide",null).slider({orientation:"horizontal",value:l?-1*d:d,min:l?-1*g:f,max:l?-1*f:g,step:h,slide:function(c,d){a.control.value(a,b(this),e,l?-1*d.value:d.value);a._onTimeChange()},stop:function(b,c){a._onSelectHandler()}})},options:function(a,b,c,e,d){if(a._defaults.isRTL){if("string"===typeof e)return"min"===e||"max"===e?void 0!==d?b.slider(e,-1*d):Math.abs(b.slider(e)):b.slider(e);a=e.min;c=e.max;e.min=e.max=null;void 0!==a&&(e.max=-1*a);void 0!==
c&&(e.min=-1*c);return b.slider(e)}return"string"===typeof e&&void 0!==d?b.slider(e,d):b.slider(e)},value:function(a,b,c,e){return a._defaults.isRTL?void 0!==e?b.slider("value",-1*e):Math.abs(b.slider("value")):void 0!==e?b.slider("value",e):b.slider("value")}},select:{create:function(a,c,e,d,f,g,h){for(var l='<select class="ui-timepicker-select ui-state-default ui-corner-all" data-unit="'+e+'" data-min="'+f+'" data-max="'+g+'" data-step="'+h+'">',k=a._defaults.pickerTimeFormat||a._defaults.timeFormat;f<=
g;f+=h)l+='<option value="'+f+'"'+(f===d?" selected":"")+">",l="hour"===e?l+b.datepicker.formatTime(b.trim(k.replace(/[^ht ]/ig,"")),{hour:f},a._defaults):"millisec"===e||"microsec"===e||10<=f?l+f:l+("0"+f.toString()),l+="</option>";l+="</select>";c.children("select").remove();b(l).appendTo(c).change(function(b){a._onTimeChange();a._onSelectHandler()});return c},options:function(a,b,c,e,d){c={};var f=b.children("select");if("string"===typeof e){if(void 0===d)return f.data(e);c[e]=d}else c=e;return a.control.create(a,
b,f.data("unit"),f.val(),c.min||f.data("min"),c.max||f.data("max"),c.step||f.data("step"))},value:function(a,b,c,e){a=b.children("select");return void 0!==e?a.val(e):a.val()}}}});b.fn.extend({timepicker:function(a){a=a||{};var c=Array.prototype.slice.call(arguments);"object"===typeof a&&(c[0]=b.extend(a,{timeOnly:!0}));return b(this).each(function(){b.fn.datetimepicker.apply(b(this),c)})},datetimepicker:function(a){a=a||{};var c=arguments;return"string"===typeof a?"getDate"===a||"option"===a&&2===
c.length&&"string"===typeof c[1]?b.fn.datepicker.apply(b(this[0]),c):this.each(function(){var a=b(this);a.datepicker.apply(a,c)}):this.each(function(){var c=b(this);c.datepicker(b.timepicker._newInst(c,a)._defaults)})}});b.datepicker.parseDateTime=function(a,b,c,e,d){a=k(a,b,c,e,d);a.timeObj&&(b=a.timeObj,a.date.setHours(b.hour,b.minute,b.second,b.millisec),a.date.setMicroseconds(b.microsec));return a.date};b.datepicker.parseTime=function(a,c,e){e=d(d({},b.timepicker._defaults),e||{});a.replace(/'.*?'/g,
"").indexOf("Z");var f=function(a,c,e){var d=function(a,c){var e=[];a&&b.merge(e,a);c&&b.merge(e,c);e=b.map(e,function(a){return a.replace(/[.*+?|()\[\]{}\\]/g,"\\$&")});return"("+e.join("|")+")?"},f="^"+a.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(a){var b=a.length;switch(a.charAt(0).toLowerCase()){case "h":return 1===b?"(\\d?\\d)":"(\\d{"+b+"})";case "m":return 1===b?"(\\d?\\d)":"(\\d{"+b+"})";case "s":return 1===b?"(\\d?\\d)":"(\\d{"+b+"})";case "l":return"(\\d?\\d?\\d)";
case "c":return"(\\d?\\d?\\d)";case "z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case "t":return d(e.amNames,e.pmNames);default:return"("+a.replace(/'/g,"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(a){return"\\"+a})+")?"}}).replace(/\s/g,"\\s?")+e.timeSuffix+"$";a=function(a){a=a.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g);var b={h:-1,m:-1,s:-1,l:-1,c:-1,t:-1,z:-1};if(a)for(var c=0;c<a.length;c++)-1===b[a[c].toString().charAt(0)]&&(b[a[c].toString().charAt(0)]=
c+1);return b}(a);var g="";c=c.match(new RegExp(f,"i"));f={hour:0,minute:0,second:0,millisec:0,microsec:0};return c?(-1!==a.t&&(void 0===c[a.t]||0===c[a.t].length?(g="",f.ampm=""):(g=-1!==b.inArray(c[a.t].toUpperCase(),e.amNames)?"AM":"PM",f.ampm=e["AM"===g?"amNames":"pmNames"][0])),-1!==a.h&&(f.hour="AM"===g&&"12"===c[a.h]?0:"PM"===g&&"12"!==c[a.h]?parseInt(c[a.h],10)+12:Number(c[a.h])),-1!==a.m&&(f.minute=Number(c[a.m])),-1!==a.s&&(f.second=Number(c[a.s])),-1!==a.l&&(f.millisec=Number(c[a.l])),
-1!==a.c&&(f.microsec=Number(c[a.c])),-1!==a.z&&void 0!==c[a.z]&&(f.timezone=b.timepicker.timezoneOffsetNumber(c[a.z])),f):!1},g=function(a,c,e){try{var d=new Date("2012-01-01 "+c);if(isNaN(d.getTime())&&(d=new Date("2012-01-01T"+c),isNaN(d.getTime())&&(d=new Date("01/01/2012 "+c),isNaN(d.getTime()))))throw"Unable to parse time with native Date: "+c;return{hour:d.getHours(),minute:d.getMinutes(),second:d.getSeconds(),millisec:d.getMilliseconds(),microsec:d.getMicroseconds(),timezone:-1*d.getTimezoneOffset()}}catch(w){try{return f(a,
c,e)}catch(A){b.timepicker.log("Unable to parse \ntimeString: "+c+"\ntimeFormat: "+a)}}return!1};return"function"===typeof e.parse?e.parse(a,c,e):"loose"===e.parse?g(a,c,e):f(a,c,e)};b.datepicker.formatTime=function(a,c,e){e=e||{};e=b.extend({},b.timepicker._defaults,e);c=b.extend({hour:0,minute:0,second:0,millisec:0,microsec:0,timezone:null},c);var d=e.amNames[0],g=parseInt(c.hour,10);11<g&&(d=e.pmNames[0]);return a=a.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(a){switch(a){case "HH":return("0"+
g).slice(-2);case "H":return g;case "hh":return("0"+f(g)).slice(-2);case "h":return f(g);case "mm":return("0"+c.minute).slice(-2);case "m":return c.minute;case "ss":return("0"+c.second).slice(-2);case "s":return c.second;case "l":return("00"+c.millisec).slice(-3);case "c":return("00"+c.microsec).slice(-3);case "z":return b.timepicker.timezoneOffsetString(null===c.timezone?e.timezone:c.timezone,!1);case "Z":return b.timepicker.timezoneOffsetString(null===c.timezone?e.timezone:c.timezone,!0);case "T":return d.charAt(0).toUpperCase();
case "TT":return d.toUpperCase();case "t":return d.charAt(0).toLowerCase();case "tt":return d.toLowerCase();default:return a.replace(/'/g,"")}})};b.datepicker._base_selectDate=b.datepicker._selectDate;b.datepicker._selectDate=function(a,c){var e=this._getInst(b(a)[0]),d=this._get(e,"timepicker");d&&e.settings.showTimepicker?(d._limitMinMaxDateTime(e,!0),d=e.inline,e.inline=e.stay_open=!0,this._base_selectDate(a,c),e.inline=d,e.stay_open=!1,this._notifyChange(e),this._updateDatepicker(e)):this._base_selectDate(a,
...
e=b.datepicker._get(c,"timepicker");if(e&&b.datepicker._get(c,"constrainInput")){var d=e.support.ampm,f=null!==e._defaults.showTimezone?e._defaults.showTimezone:e.support.timezone;c=b.datepicker._possibleChars(b.datepicker._get(c,"dateFormat"));e=e._defaults.timeFormat.toString().replace(/[hms]/g,"").replace(/TT/g,d?"APM":"").replace(/Tt/g,d?"AaPpMm":"").replace(/tT/g,d?"AaPpMm":"").replace(/T/g,d?"AP":"").replace(/tt/g,d?"apm":"").replace(/t/g,d?"ap":"")+" "+e._defaults.separator+e._defaults.timeSuffix+
(f?e._defaults.timezoneList.join(""):"")+e._defaults.amNames.join("")+e._defaults.pmNames.join("")+c;d=String.fromCharCode(void 0===a.charCode?a.keyCode:a.charCode);return a.ctrlKey||" ">d||!c||-1<e.indexOf(d)}return b.datepicker._base_doKeyPress(a)};b.datepicker._base_updateAlternate=b.datepicker._updateAlternate;b.datepicker._updateAlternate=function(a){var c=this._get(a,"timepicker");if(c){var e=c._defaults.altField;if(e){var d=this._getDate(a),f=b.datepicker._getFormatConfig(a),g=c._defaults.altSeparator?
c._defaults.altSeparator:c._defaults.separator;var h=c._defaults.altTimeSuffix?c._defaults.altTimeSuffix:c._defaults.timeSuffix;h=""+(b.datepicker.formatTime(null!==c._defaults.altTimeFormat?c._defaults.altTimeFormat:c._defaults.timeFormat,c,c._defaults)+h);c._defaults.timeOnly||c._defaults.altFieldTimeOnly||null===d||(h=c._defaults.altFormat?b.datepicker.formatDate(c._defaults.altFormat,d,f)+g+h:c.formattedDate+g+h);b(e).val(a.input.val()?h:"")}}else b.datepicker._base_updateAlternate(a)};b.datepicker._base_doKeyUp=
...
c=new Date,c.setHours(e.hour,e.minute,e.second,e.millisec),c.setMicroseconds(e.microsec)):(c=new Date(b.getTime()),c.setMicroseconds(b.getMicroseconds())),"Invalid Date"===c.toString()&&(c=void 0),this._setTime(a,c)))}};b.datepicker._base_setDateDatepicker=b.datepicker._setDateDatepicker;b.datepicker._setDateDatepicker=function(a,c){var e=this._getInst(a),d=c;if(e){"string"===typeof c&&(d=new Date(c),d.getTime()||(this._base_setDateDatepicker.apply(this,arguments),d=b(a).datepicker("getDate")));var f=
this._get(e,"timepicker");if(d instanceof Date){var g=new Date(d.getTime());g.setMicroseconds(d.getMicroseconds())}else g=d;f&&g&&(f.support.timezone||null!==f._defaults.timezone||(f.timezone=-1*g.getTimezoneOffset()),b.timepicker.timezoneAdjust(d,f.timezone),g=b.timepicker.timezoneAdjust(g,f.timezone));this._updateDatepicker(e);this._base_setDateDatepicker.apply(this,arguments);this._setTimeDatepicker(a,g,!0)}};b.datepicker._base_getDateDatepicker=b.datepicker._getDateDatepicker;b.datepicker._getDateDatepicker=
function(a,c){var e=this._getInst(a);if(e){var d=this._get(e,"timepicker");return d?(void 0===e.lastVal&&this._setDateFromField(e,c),(c=this._getDate(e))&&d._parseTime(b(a).val(),d.timeOnly)&&(c.setHours(d.hour,d.minute,d.second,d.millisec),c.setMicroseconds(d.microsec),null!=d.timezone&&(d.support.timezone||null!==d._defaults.timezone||(d.timezone=-1*c.getTimezoneOffset()),c=b.timepicker.timezoneAdjust(c,d.timezone))),c):this._base_getDateDatepicker(a,c)}};b.datepicker._base_parseDate=b.datepicker.parseDate;
b.datepicker.parseDate=function(a,c,e){try{var d=this._base_parseDate(a,c,e)}catch(t){if(0<=t.indexOf(":"))d=this._base_parseDate(a,c.substring(0,c.length-(t.length-t.indexOf(":")-2)),e),b.timepicker.log("Error parsing the date string: "+t+"\ndate string = "+c+"\ndate format = "+a);else throw t;}return d};b.datepicker._base_formatDate=b.datepicker._formatDate;b.datepicker._formatDate=function(a,b,c,e){return(b=this._get(a,"timepicker"))?(b._updateDateTime(a),b.$input.val()):this._base_formatDate(a)};
b.datepicker._base_optionDatepicker=b.datepicker._optionDatepicker;b.datepicker._optionDatepicker=function(a,e,d){var f=this._getInst(a);if(!f)return null;if(f=this._get(f,"timepicker")){var g=null,h=null,k=null,l=f._defaults.evnts,m={};if("string"===typeof e)if("minDate"===e||"minDateTime"===e)g=d;else if("maxDate"===e||"maxDateTime"===e)h=d;else if("onSelect"===e)k=d;else{if(l.hasOwnProperty(e)){if("undefined"===typeof d)return l[e];m[e]=d;var n={}}}else if("object"===typeof e)for(q in e.minDate?
g=e.minDate:e.minDateTime?g=e.minDateTime:e.maxDate?h=e.maxDate:e.maxDateTime&&(h=e.maxDateTime),l)l.hasOwnProperty(q)&&e[q]&&(m[q]=e[q]);for(q in m)m.hasOwnProperty(q)&&(l[q]=m[q],n||(n=b.extend({},e)),delete n[q]);if(n&&c(n))return;g?(g=0===g?new Date:new Date(g),f._defaults.minDate=g,f._defaults.minDateTime=g):h?(h=0===h?new Date:new Date(h),f._defaults.maxDate=h,f._defaults.maxDateTime=h):k&&(f._defaults.onSelect=k);if(g||h){f=b(a);var q=f.datetimepicker("getDate");a=this._base_optionDatepicker.call(b.datepicker,
a,n||e,d);f.datetimepicker("setDate",q);return a}}return void 0===d?this._base_optionDatepicker.call(b.datepicker,a,e):this._base_optionDatepicker.call(b.datepicker,a,n||e,d)};var c=function(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0},d=function(a,c){b.extend(a,c);for(var e in c)if(null===c[e]||void 0===c[e])a[e]=c[e];return a},e=function(a){var b=a.replace(/'.*?'/g,"").toLowerCase(),c=function(a,b){return-1!==a.indexOf(b)?!0:!1};return{hour:c(b,"h"),minute:c(b,"m"),second:c(b,"s"),
millisec:c(b,"l"),microsec:c(b,"c"),timezone:c(b,"z"),ampm:c(b,"t")&&c(a,"h"),iso8601:c(a,"Z")}},f=function(a){a%=12;0===a&&(a=12);return String(a)},h=function(a,c){return a&&a[c]?a[c]:b.timepicker._defaults[c]},g=function(a,b){var c=h(b,"separator");b=h(b,"timeFormat").split(c).length;var e=a.split(c),d=e.length;return 1<d?{dateString:e.splice(0,d-b).join(c),timeString:e.splice(0,b).join(c)}:{dateString:a,timeString:""}},k=function(a,c,e,d,f){e=g(e,f);a=b.datepicker._base_parseDate(a,e.dateString,
d);if(""===e.timeString)return{date:a};c=b.datepicker.parseTime(c,e.timeString,f);if(!c)throw"Wrong time format";return{date:a,timeObj:c}},m=function(a,b){a&&a.timezone_select&&a.timezone_select.val(-(b||new Date).getTimezoneOffset())};b.timepicker=new a;b.timepicker.timezoneOffsetString=function(a,b){if(isNaN(a)||840<a||-720>a)return a;var c=a%60;b=b?":":"";a=(0<=a?"+":"-")+("0"+Math.abs((a-c)/60)).slice(-2)+b+("0"+Math.abs(c)).slice(-2);return"+00:00"===a?"Z":a};b.timepicker.timezoneOffsetNumber=
...
a,c,e)};b.timepicker.dateRange=function(a,c,e){b.timepicker.handleRange("datepicker",a,c,e)};b.timepicker.handleRange=function(a,c,e,d){function f(b,f){var g=c[a]("getDate"),h=e[a]("getDate");b=b[a]("getDate");if(null!==g){var k=new Date(g.getTime()),l=new Date(g.getTime());k.setMilliseconds(k.getMilliseconds()+d.minInterval);l.setMilliseconds(l.getMilliseconds()+d.maxInterval);if(0<d.minInterval&&k>h)e[a]("setDate",k);else if(0<d.maxInterval&&l<h)e[a]("setDate",l);else if(g>h)f[a]("setDate",b)}}
function g(b,c,e){b.val()&&(b=b[a].call(b,"getDate"),null!==b&&0<d.minInterval&&("minDate"===e&&b.setMilliseconds(b.getMilliseconds()+d.minInterval),"maxDate"===e&&b.setMilliseconds(b.getMilliseconds()-d.minInterval)),b.getTime&&c[a].call(c,"option",e,b))}d=b.extend({},{minInterval:0,maxInterval:0,start:{},end:{}},d);var h=!1;"timepicker"===a&&(h=!0,a="datetimepicker");b.fn[a].call(c,b.extend({timeOnly:h,onClose:function(a,c){f(b(this),e)},onSelect:function(a){g(b(this),e,"minDate")}},d,d.start));
b.fn[a].call(e,b.extend({timeOnly:h,onClose:function(a,e){f(b(this),c)},onSelect:function(a){g(b(this),c,"maxDate")}},d,d.end));f(c,e);g(c,e,"minDate");g(e,c,"maxDate");return b([c.get(0),e.get(0)])};b.timepicker.log=function(){window.console&&window.console.log.apply(window.console,Array.prototype.slice.call(arguments))};b.timepicker._util={_extendRemove:d,_isEmptyObject:c,_convert24to12:f,_detectSupport:e,_selectLocalTimezone:m,_computeEffectiveSetting:h,_splitDateTime:g,_parseDateTimeInternal:k};
...
this.headerLinkContainer.find(".ui-multiselect-all, .ui-multiselect-none").hide();this.options.autoOpen&&this.open();this.element.is(":disabled")&&this.disable()},refresh:function(a){var e=this.element,d=this.options,g=this.menu,k=this.checkboxContainer,m=[],l="",n=e.attr("id")||c++;e.find("option").each(function(a){b(this);var c=this.parentNode,e=this.innerHTML,f=this.title,g=this.value;a="ui-multiselect-"+(this.id||n+"-option-"+a);var h=this.disabled,k=this.selected,p=["ui-corner-all"],q=(h?"ui-multiselect-disabled ":
" ")+this.className;if("OPTGROUP"===c.tagName){var y=c.getAttribute("label");-1===b.inArray(y,m)&&(l+='<li class="ui-multiselect-optgroup-label '+c.className+'"><a href="#">'+y+"</a></li>",m.push(y))}h&&p.push("ui-state-disabled");k&&!d.multiple&&p.push("ui-state-active");l+='<li class="'+q+'">';l+='<label for="'+a+'" title="'+f+'" class="'+p.join(" ")+'">';l+='<input id="'+a+'" name="multiselect_'+n+'" type="'+(d.multiple?"checkbox":"radio")+'" value="'+g+'" title="'+f+'"';k&&(l+=' checked="checked"',
l+=' aria-selected="true"');h&&(l+=' disabled="disabled"',l+=' aria-disabled="true"');l+=" /><span>"+e+"</span></label></li>"});if(!b.isEmptyObject(d.create)){var q=d.create;e=S3.Ap.concat("/",q.c,"/",q.f,"/create?format=popup&caller=",n);q.parent&&(e+="&parent="+q.parent);q.child&&(e+="&child="+q.child);q=q.label;l+='<li><a class="s3_modal" target="top" title="'+q+'" href="'+e+'"><label class="ui-corner-all"><span><i>'+q+"</i></span></label></a></li>"}k.html(l);b.isEmptyObject(d.create)||S3.addModals();
...
a));c.eq(0).focus();this.update();var d=c.map(function(){return this.value}).get();this.element.find("option").each(function(){!this.disabled&&-1<b.inArray(this.value,d)&&e._toggleState("selected",a).call(this)});c.length&&this.element.trigger("change")},_toggleDisabled:function(a){this.button.attr({disabled:a,"aria-disabled":a})[a?"addClass":"removeClass"]("ui-state-disabled");var c=this.menu.find("input");c=a?c.filter(":enabled").data("ech-multiselect-disabled",!0):c.filter(function(){return!0===
b.data(this,"ech-multiselect-disabled")}).removeData("ech-multiselect-disabled");c.attr({disabled:a,"arial-disabled":a}).parent()[a?"addClass":"removeClass"]("ui-state-disabled");this.element.attr({disabled:a,"aria-disabled":a})},open:function(a){a=this.button;var c=this.menu,e=this.speed,d=this.options,k=[];if(!1!==this._trigger("beforeopen")&&!a.hasClass("ui-state-disabled")&&!this._isOpen){var m=c.find("ul").last(),l=d.show;b.isArray(d.show)&&(l=d.show[0],e=d.show[1]||this.speed);l&&(k=[l,e]);
m.scrollTop(0).height(d.height);this.position();b.fn.show.apply(c,k);this.labels.filter(":not(.ui-state-disabled)").eq(0).trigger("mouseover").trigger("mouseenter").find("input").trigger("focus");a.addClass("ui-state-active");this._isOpen=!0;this._trigger("open")}},close:function(){if(!1!==this._trigger("beforeclose")){var a=this.options,c=a.hide,d=this.speed,g=[];b.isArray(a.hide)&&(c=a.hide[0],d=a.hide[1]||this.speed);c&&(g=[c,d]);b.fn.hide.apply(this.menu,g);this.button.removeClass("ui-state-active").trigger("blur").trigger("mouseleave");
...
a.placeholder+'" type="search"'+(/\d/.test(a.width)?'style="width:'+a.width+'px"':"")+" /></div>").prependTo(this.header);this.inputs=d.menu.find('input[type="checkbox"], input[type="radio"]');this.input=a.find("input").bind({keydown:function(a){13===a.which&&a.preventDefault()},keyup:b.proxy(this._handler,this),click:b.proxy(this._handler,this)});this.updateCache();d._toggleChecked=function(a,c){c=c&&c.length?c:this.labels.find("input");var e=this;c=c.not(e._isOpen?":disabled, :hidden":":disabled").each(this._toggleState("checked",
a));this.update();var d=c.map(function(){return this.value}).get();this.element.find("option").filter(function(){!this.disabled&&-1<b.inArray(this.value,d)&&e._toggleState("selected",a).call(this)});c.length&&this.element.trigger("change")};a=b(document).bind("multiselectrefresh."+d._namespaceID,b.proxy(function(){this.updateCache();this._handler()},this));this.options.autoReset&&a.bind("multiselectclose."+d._namespaceID,b.proxy(this._reset,this))},_handler:function(c){var d=b.trim(this.input[0].value.toLowerCase()),
...
(function(){var b=function(a){if("string"==typeof a)var b='[name="'+a+'"]';else{var c=a.prefix?a.prefix:"default";a.alias&&(c+=a.alias);var e=a.inlineType||"sub",d=a.inlineRows;void 0===d&&(d=!0);"sub"==e?(a=a.name,b=d?'[name^="'+c+'"][name*="_i_'+a+'_edit_"]':'[name="'+c+"-"+a+'"]'):"link"==e&&(b='[name="link_'+c+'"]')}return b},a=function(a,b){a.siblings("."+b+"-throbber").length||a.after('<div class="'+b+'-throbber throbber"/>')},c=function(a,b){a=a.siblings("."+b+"-throbber");a.length&&a.remove()},
d=function(a,b,c){$("a#"+a+"_add").each(function(){var a=this.search,e=[],d=!1;a&&a.substring(1).split("&").forEach(function(a){decodeURIComponent(a.split("=")[0])!=b&&e.push(a)});void 0!==c&&null!==c&&(d=encodeURIComponent(b)+"="+encodeURIComponent(c),e.push(d),d=!0);a=e.length?"?"+e.join("&"):"";a=this.protocol+"//"+this.host+this.pathname+a+this.hash;a=$(this).attr("href",a);d?a.parent().show():a.parent().hide()})},e=function(a,b){var c=[],e=0;if(0===a.length)((a=b.showEmptyField)||void 0===a)&&
c.push('<option value="">'+(b.msgNoRecords||"-")+"</option>");else{var d=b.fncPrep,f=null;if(d)try{f=d(a)}catch(r){}d=b.lookupField||"id";for(var g=b.fncRepresent,h,k,u,v=0;v<a.length;v++)h=a[v],k=h[d],0===v&&(e=k),u=g?g(h,f):h.name,h=h._tooltip?' title="'+h._tooltip+'"':"",c.push("<option"+h+' value="'+k+'">'+u+"</option>");b.optional&&(e=0,c.unshift('<option value=""></option>'))}return{options:c.join(""),defaultValue:e}},f=function(b,f,h,l,n){var g=!1;if(1<b.length)if("checkbox"==b.first().attr("type")){if(b.first().closest(".checkboxes-widget-s3")){s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, skipping");
...
!0,u.data("visible",!0),u.hasClass("groupedopts-widget")?u.groupedopts("hide"):u.hide(),a(u,m);z=$.ajaxS3({url:k,dataType:"html",success:function(a){var b=u;if(""!==a){var e=!1,g=!1;b.hasClass("groupedopts-widget")?e=!0:b.hasClass("multiselect-widget")&&(g=!0);var k;(e||g)&&"select"==b.prop("tagName").toLowerCase()&&(k=b.val());b.html(a).change().prop("disabled",!1);if(e||g){if(k){a=[];g=0;for(var l=k.length,r;g<l;g++)r=k[g],b.find("option[value="+r+"]").length&&a.push(r);b.val(a).change()}e?b.groupedopts("refresh"):
b.multiselect("refresh")}}else b.prop("disabled",!0);u=b;v&&(u.hasClass("groupedopts-widget")?u.find("option").length&&u.groupedopts("show"):u.show());c(u,m);d(m,f,h);n||S3ClearNavigateAwayConfirm()}})}else b.each(function(){var b=$(this);(b.hasClass("groupedopts-widget")?b.groupedopts("visible"):b.data("visible")||b.is(":visible"))?(b.data("visible",!0),b.hasClass("groupedopts-widget")?b.groupedopts("hide"):b.hide(),a(b,m)):b.data("visible",!1)}),z=$.ajaxS3({url:k,dataType:"json",success:function(a){var g=
e(a,l),k=0===a.length?!0:!1;b.each(function(){var a=$(this);a:if(a.hasClass("checkboxes-widget-s3"))s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, updateOptions aborted"),a=void 0;else{var b=g.options,e=g.defaultValue,d=[];if(!k){var f;if(a.hasClass("checkboxes-widget-s3")){a=void 0;break a}else{(f=a.val())||(f=a.prop("value"));$.isArray(f)||(f=[f]);for(var h=0,l=f.length,r;h<l;h++)(r=f[h])&&$(b).filter("option[value="+r+"]").length&&d.push(r)}d.length&&(e=d)}"INPUT"==a.prop("tagName")&&
(d=$("<select/>").addClass(a.attr("class")).attr("id",a.attr("id")).attr("name",a.attr("name")).data("visible",a.data("visible")).hide(),a.replaceWith(d),a=d);d=""===b;a.html(b).val(e).change().prop("disabled",d);a.hasClass("groupedopts-widget")?a.groupedopts("refresh"):a.hasClass("multiselect-widget")&&(a.multiselect("refresh"),d?a.multiselect("disable"):a.multiselect("enable"))}a.data("visible")&&(a.hasClass("groupedopts-widget")?k||a.groupedopts("show"):a.show());c(a,m)});d(m,f,h);n||S3ClearNavigateAwayConfirm()}});
...
var e=a.lookupKey||c,d=b(a.trigger),g=b(a.target);if(g){var q=$(g);if(q.length){var p=q.closest("form");if(d&&(q=p.find(d),q.length)){$(d).each(function(){var b=$(this);var c=b.closest(".inline-form");if(!c.length||!c.hasClass("empty-row")&&"none"!=c.css("display"))c="row"==a.scope?b.closest(".edit-row.inline-form,.add-row.inline-form"):p,b=h(b),c=c.find(g),f(c,e,b[1],a,!1)});var t="triggerUpdate."+c;p.undelegate(d,"change.s3options").delegate(d,"change.s3options",function(){var a=h($(this));p.trigger(t,
a)});p.on(t,function(b,c,d){b=("row"==a.scope?c.closest(".edit-row.inline-form,.add-row.inline-form"):p).find(g);f(b,e,d,a,!0)})}}}}})(jQuery);(function(){$.cancelButtonS3=function(b){var a=$(".s3-cancel");if(a.length){var c=document.referrer;if(c&&c.split("?")[0].split("#")[0]!=document.URL.split("?")[0].split("#")[0]){var d=document.createElement("a");d.href=c;d.host==window.location.host&&0===d.pathname.lastIndexOf(S3.Ap,0)?a.attr("href",c):b?a.attr("href",b):a.hide()}else b?a.attr("href",b):a.hide()}}})(jQuery);
...
b){},ajaxCache:!0,ajaxProcess:function(a){return a=a.replace(/<(script|style|title)[^<]+<\/(script|style|title)>/gm,"").replace(/<(link|meta)[^>]+>/g,"")},ajaxSettings:{dataType:"html"},debug:!1}};var a,c={},d=0,e=0;b.fn.attrProp=b.fn.prop||b.fn.attr;b.fn.cluetip=function(f,h){function g(a,c){var e=a||"";c=c||"";"object"==typeof c?b.each(c,function(a,b){e+="-"+a+"-"+b}):"string"==typeof c&&(e+=c);return e}function k(a,c,e){e="";c=c.dropShadow&&c.dropShadowSteps?+c.dropShadowSteps:0;if(b.support.boxShadow)return c&&
(e="1px 1px "+c+"px rgba(0,0,0,0.5)"),a.css(b.support.boxShadow,e),!1;e=a.find(".cluetip-drop-shadow");if(c==e.length)return e;e.remove();e=[];for(var d=0;d<c;)e[d++]='<div style="top:'+d+"px;left:"+d+'px;"></div>';return e=b(e.join("")).css({position:"absolute",backgroundColor:"#000",zIndex:v-1,opacity:.1}).addClass("cluetip-drop-shadow").prependTo(a)}var m,l;"object"==typeof f&&(h=f,f=null);if("destroy"==f){var n=this.data("cluetip");n&&(b(n.selector).remove(),b.removeData(this,"title"),b.removeData(this,
"cluetip"));b(document).unbind(".cluetip");return this.unbind(".cluetip")}h=b.extend(!0,{},b.cluetip.defaults,h||{});d++;n=b.cluetip.backCompat||!h.multiple?"cluetip":"cluetip-"+d;var q="#"+n,p=b.cluetip.backCompat?"#":".",t=b.cluetip.setup.insertionType,z=b.cluetip.setup.insertionElement||"body";t=/appendTo|prependTo|insertBefore|insertAfter/.test(t)?t:"appendTo";var u=b(q);if(!u.length){u=b(b.cluetip.template)[t](z).attr("id",n).css({position:"absolute",display:"none"});var v=+h.cluezIndex;var r=
u.find(p+"cluetip-outer").css({position:"relative",zIndex:v});var w=u.find(p+"cluetip-inner");var A=u.find(p+"cluetip-title")}a=b("#cluetip-waitimage");a.length||(a=b("<div></div>").attr("id","cluetip-waitimage").css({position:"absolute"}));a.insertBefore(u).hide();var B=(parseInt(u.css("paddingLeft"),10)||0)+(parseInt(u.css("paddingRight"),10)||0);this.each(function(d){function n(){return!1}function t(a,b){var c=a.status;b.beforeSend(a.xhr,b);if("error"==c)b[c](a.xhr,a.textStatus);else if("success"==
...
var L=parseInt(x.topOffset,10),V=parseInt(x.leftOffset,10),W,R,D=isNaN(parseInt(x.height,10))?"auto":/\D/g.test(x.height)?x.height:x.height+"px",K,F,E,O,S,X=parseInt(x.width,10)||275,P=X+B+x.dropShadowSteps,Q=this.offsetWidth,M,I,J,Z,T="title"!=x.attribute?y.attrProp(x.titleAttribute)||"":"";if(x.splitTitle){var ca=T.split(x.splitTitle);T=x.showTitle||""===ca[0]?ca.shift():""}x.escapeTitle&&(T=T.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));var ha=function(k){if(!1===x.onActivate.call(z,
k))return!1;aa=!0;u=b(q).css({position:"absolute"});r=u.find(p+"cluetip-outer");w=u.find(p+"cluetip-inner");A=u.find(p+"cluetip-title");m=u.find(p+"cluetip-arrows");u.removeClass().css({width:X});N==y.attr("href")&&y.css("cursor",x.cursor);x.hoverClass&&y.addClass(x.hoverClass);F=y.offset().top;M=y.offset().left;Q=y.innerWidth();k.type==focus?(J=M+Q/2+V,u.css({left:I}),O=F+L):(J=k.pageX,O=k.pageY);"area"!=z.tagName.toLowerCase()&&(K=b(document).scrollTop(),Z=b(window).width());if("fixed"==x.positionBy)I=
Q+M+V,u.css({left:I});else{I=Q>M&&M>P||M+Q+P+V>Z?M-P-V:Q+M+V;if("area"==z.tagName.toLowerCase()||"mouse"==x.positionBy||Q+P>Z)J+20+P>Z?(u.addClass("cluetip-"+ba),I=0<=J-P-V?J-P-V-parseInt(u.css("marginLeft"),10)+parseInt(w.css("marginRight"),10):J-P/2):I=J+V;var l=0>I?k.pageY+L:k.pageY;if(0>I||"bottomTop"==x.positionBy)I=J+P/2>Z?Z/2-P/2:Math.max(J-P/2,0)}m.css({zIndex:y.data("cluetip").zIndex+1});u.css({left:I,zIndex:y.data("cluetip").zIndex});R=b(window).height();if(f)"function"==typeof f&&(f=f.call(z)),
w.html(f),da(l);else if(ca){k=ca.length;w.html(k?ca[0]:"");if(1<k)for(var n=1;n<k;n++)w.append('<div class="split-body">'+ca[n]+"</div>");da(l)}else if(x.local||0===N.indexOf("#"))x.local&&(k=b(N+(/^#\S+$/.test(N)?"":":eq("+d+")")).clone(!0).show(),x.localIdSuffix&&k.attr("id",k[0].id+x.localIdSuffix),w.html(k),da(l));else if(/\.(jpe?g|tiff?|gif|png)(?:\?.*)?$/i.test(N))w.html('<img src="'+N+'" alt="'+T+'" />'),da(l);else{var B=x.ajaxSettings.beforeSend,G=x.ajaxSettings.error,H=x.ajaxSettings.success,
C=x.ajaxSettings.complete;var v=g(N,x.ajaxSettings.data);k=b.extend(!0,{},x.ajaxSettings,{cache:x.ajaxCache,url:N,beforeSend:function(b,c){B&&B.call(z,b,u,w,c);r.children().empty();x.waitImage&&a.css({top:O+20,left:J+20,zIndex:y.data("cluetip").zIndex-1}).show()},error:function(a,b){h.ajaxCache&&!c[v]&&(c[v]={status:"error",textStatus:b,xhr:a});aa&&(G?G.call(z,a,b,u,w):w.html("<i>sorry, the contents could not be loaded</i>"))},success:function(a,b,e){h.ajaxCache&&!c[v]&&(c[v]={status:"success",data:a,
textStatus:b,xhr:e});Y=x.ajaxProcess.call(z,a);"object"==typeof Y&&null!==Y&&(T=Y.title,Y=Y.content);aa&&(H&&H.call(z,a,b,u,w),w.html(Y))},complete:function(c,d){C&&C.call(z,c,d,u,w);var f=w[0].getElementsByTagName("img");e=f.length;c=0;for(d=f.length;c<d;c++)f[c].complete&&e--;e&&!b.browser.opera?b(f).bind("load.ct error.ct",function(){e--;0===e&&(a.hide(),b(f).unbind(".ct"),aa&&da(l))}):(a.hide(),aa&&da(l))}});c[v]?t(c[v],k):b.ajax(k)}},da=function(a){var c=T||x.showTitle&&"&nbsp;";var e="";var d=
"";u.addClass("cluetip-"+ba);if(x.truncate){var f=w.text().slice(0,x.truncate)+"...";w.html(f)}c?A.show().html(c):A.hide();x.sticky&&(c=b('<div class="cluetip-close"><a href="#">'+x.closeText+"</a></div>"),"bottom"==x.closePosition?c.appendTo(w):"title"==x.closePosition?c.prependTo(A):c.prependTo(w),c.bind("click.cluetip",function(){ea();return!1}),x.mouseOutClose?u.bind("mouseleave.cluetip",function(){ea()}):u.unbind("mouseleave.cluetip"));r.css({zIndex:y.data("cluetip").zIndex,overflow:"auto"==
D?"visible":"auto",height:D});W="auto"==D?Math.max(u.outerHeight(),u.height()):parseInt(D,10);E=F;S=K+R;"fixed"==x.positionBy?E=F-x.dropShadowSteps+L:I<J&&Math.max(I,0)+P>J||"bottomTop"==x.positionBy?F+W+L>S&&O-K>W+L?(E=O-W-L,d="top"):(E=O+L,d="bottom"):E=F+W+L>S?W>=R?K:S-W-L:"block"==y.css("display")||"area"==z.tagName.toLowerCase()||"mouse"==x.positionBy?a-L:F-x.dropShadowSteps;""===d&&(d=I<M?"left":"right");c=" clue-"+d+"-"+ba+" cluetip-"+ba;"rounded"==ba&&(c+=" ui-corner-all");u.css({top:E+"px"}).attrProp({className:"cluetip ui-widget ui-widget-content ui-cluetip"+
c});x.arrows?(/(left|right)/.test(d)&&(d=u.height()-m.height(),e=0<=I&&0<a?F-E-x.dropShadowSteps:0,e=(d>e?e:d)+"px"),m.css({top:e}).show()):m.hide();(l=k(u,x))&&l.length&&l.hide().css({height:W,width:X,zIndex:y.data("cluetip").zIndex-1}).show();u.hide()[x.fx.open](x.fx.openSpeed||0);b.fn.bgiframe&&u.bgiframe();0<x.delayedClose&&(fa=setTimeout(ea,x.delayedClose));x.onShow.call(z,u,w)},ia=function(b){aa=!1;a.hide();if(!x.sticky||/click|toggle/.test(x.activation))ea(),clearTimeout(fa);x.hoverClass&&
y.removeClass(x.hoverClass)},ea=function(a){a=a&&a.data("cluetip")?a:y;var c=a.data("cluetip")&&a.data("cluetip").selector,e=b(c||"div.cluetip"),d=e.find(p+"cluetip-inner"),f=e.find(p+"cluetip-arrows");e.hide().removeClass();x.onHide.call(a[0],e,d);c&&(a.removeClass("cluetip-clicked"),a.css("cursor",""));c&&T&&a.attrProp(x.titleAttribute,T);x.arrows&&f.css({top:""})};b(document).unbind("hideCluetip.cluetip").bind("hideCluetip.cluetip",function(a){ea(b(a.target))});if(/click|toggle/.test(x.activation))y.bind("click.cluetip",
function(a){u.is(":hidden")||!y.is(".cluetip-clicked")?(ha(a),b(".cluetip-clicked").removeClass("cluetip-clicked"),y.addClass("cluetip-clicked")):ia(a);return!1});else if("focus"==x.activation)y.bind("focus.cluetip",function(a){y.attrProp("title","");ha(a)}),y.bind("blur.cluetip",function(a){y.attrProp("title",y.data("cluetip").title);ia(a)});else{y[x.clickThrough?"unbind":"bind"]("click.cluetip",n);var ja=function(a){if(x.tracking){var b=I-a.pageX,c=E?E-a.pageY:F-a.pageY;y.bind("mousemove.cluetip",
...
function(a){y.attrProp("title",y.data("cluetip").title)})}});return this};(function(){b.support=b.support||{};for(var a=document.createElement("div").style,c=["boxShadow"],e=["moz","Moz","webkit","o"],d=0,m=c.length;d<m;d++){var l=c[d],n=l.charAt(0).toUpperCase()+l.slice(1);if("undefined"!==typeof a[l])b.support[l]=l;else for(var q=0,p=e.length;q<p;q++)if("undefined"!==typeof a[e[q]+n]){b.support[l]=e[q]+n;break}}})();b.fn.cluetip.defaults=b.cluetip.defaults})(jQuery);
...
"")&&b(this).html("");a.editing=!0;a.revert=b(a).html();b(a).html("");var p=b("<form />");d.cssclass&&("inherit"==d.cssclass?p.attr("class",b(a).attr("class")):p.attr("class",d.cssclass));d.style&&("inherit"==d.style?(p.attr("style",b(a).attr("style")),p.css("display",b(a).css("display"))):p.attr("style",d.style));var A=k.apply(p,[d,a]);if(d.loadurl){var B=setTimeout(function(){A.disabled=!0;g.apply(p,[d.loadtext,d,a])},100);r={};r[d.id]=a.id;b.isFunction(d.loaddata)?b.extend(r,d.loaddata.apply(a,
[a.revert,d])):b.extend(r,d.loaddata);b.ajax({type:d.loadtype,url:d.loadurl,data:r,async:!1,success:function(a){window.clearTimeout(B);y=a;A.disabled=!1}})}else if(d.data){var y=d.data;b.isFunction(d.data)&&(y=d.data.apply(a,[a.revert,d]))}else y=a.revert;g.apply(p,[y,d,a]);A.attr("name",d.name);h.apply(p,[d,a]);b(a).append(p);e.apply(p,[d,a]);b(":input:visible:enabled:first",p).focus();d.select&&A.select();A.keydown(function(b){27==b.keyCode&&(b.preventDefault(),m.apply(p,[d,a]))});"cancel"==d.onblur?
A.blur(function(b){B=setTimeout(function(){m.apply(p,[d,a])},500)}):"submit"==d.onblur?A.blur(function(a){B=setTimeout(function(){p.submit()},200)}):b.isFunction(d.onblur)?A.blur(function(b){d.onblur.apply(a,[A.val(),d])}):A.blur(function(a){});p.submit(function(c){B&&clearTimeout(B);c.preventDefault();if(!1!==q.apply(p,[d,a])&&!1!==f.apply(p,[d,a]))if(b.isFunction(d.target))c=d.target.apply(a,[A.val(),d]),b(a).html(c),a.editing=!1,l.apply(a,[a.innerHTML,d]),b.trim(b(a).html())||b(a).html(d.placeholder);
else{c={};c[d.name]=A.val();c[d.id]=a.id;b.isFunction(d.submitdata)?b.extend(c,d.submitdata.apply(a,[a.revert,d])):b.extend(c,d.submitdata);"PUT"==d.method&&(c._method="put");b(a).html(d.indicator);var e={type:"POST",data:c,dataType:"html",url:d.target,success:function(c,f){"html"==e.dataType&&b(a).html(c);a.editing=!1;l.apply(a,[c,d]);b.trim(b(a).html())||b(a).html(d.placeholder)},error:function(b,c,e){t.apply(p,[d,a,b])}};b.extend(e,d.ajaxoptions);b.ajax(e)}b(a).attr("title",d.tooltip);return!1})}});
...
this.__$containerElement.find(".range-picker-wrapper"),c=this.__selectCursors,e=this.__$rangepickerElement.width(),d=-c[0].getJQueryElement().position().top;!a(c[1])&&-c[1].getJQueryElement().position().top>d&&(d=-c[1].getJQueryElement().position().top);b.css("paddingTop",d+"px");var f=c[0].getJQueryElement();d=f.outerWidth()/2;c[0].render(this.__options.translateSelectLabel(0,e));f=f.outerWidth()/2;c[0].render(this.__options.translateSelectLabel(e,e));b.css({paddingLeft:f+"px",paddingRight:d+"px"})},
...
__template:"<span class='process'></span>",__init:function(){this.__$element=b(this.__template)},updatePosition:function(a){for(var b in a)a.hasOwnProperty(b)&&this.__$element.css(b,a[b]+"px")},getJQueryElement:function(){return this.__$element}};b.fn.rangepicker=function(a){return new d(this,a)}});S3.search={};
(function(){var b=function(a,b){if("GET"==a.type){a.type="POST";var c=function(a){var b=a[0];return"$filter"==a||"_"!=b&&(-1!=a.search(/\./)||"("==b&&-1!=a.search(/\)/))},e=a.url.split("#"),d=e[0],f=null,h=null;1<e.length&&(f=e[1]);e=d.split("?");d=e[0];1<e.length&&(h=e[1]);var g=a.data,k={};e={};var l,m,p,r,n=function(a,b,c){if(Array.isArray(c))for(p=0,l=c.length;p<l;p++)n(a,b,c[p]);else a.hasOwnProperty(b)?Array.isArray(a[b])?a[b].push(c):a[b]=[a[b],c]:a[b]=c};if(g){var q=0;for(m=g.length;q<m;q++){var w=
g[q];n(e,w.name,w.value)}}if(h)for(r in g=S3.queryString.parse(h),g)h=g[r],c(r)?n(k,r,h):n(e,r,h);a.data="ajax"==b?JSON.stringify(k):k;a.processData=!1;b=d+"?$search="+b;(c=S3.queryString.stringify(e))&&(b+="&"+c);null!==f&&(b+="#"+f);a.url=b}};S3.search.searchRewriteAjaxOptions=b;var a={timeout:1E4,retryLimit:5,dataType:"json",contentType:"application/json; charset=utf-8",processData:!1,async:!0,type:"POST"};$.searchS3=function(c){c=$.extend({},a,c);b(c,"ajax");return $.ajaxS3(c)};$.searchDownloadS3=
function(c,e){var d=$.extend({},a,{url:c});c=document.createElement("form");d.type="GET";b(d,"form");c.action=d.url;c.method="POST";c.target=e||"_self";c.enctype="multipart/form-data";if(e=d.data)for(var f in e)d=document.createElement("textarea"),d.name=f,d.value=JSON.stringify(e[f]),c.appendChild(d);c.style.display="none";document.body.appendChild(c);c.submit()};var c={},d=function(a){a&&(a=a.replace(/"/,'\\"'),-1!=a.search(/,/)&&(a='"'+a+'"'));return a},e=function(a){if(!a)return a;for(var b=[],
c=!1,e=0,d=0;d<a.length;d++){var f=a[d];b[e]=b[e]||"";'"'==f?c=!c:","!=f||c?b[e]+=f:("NONE"==b[e]&&(b[e]=null),++e)}return b},f=function(a){void 0===a&&(a=$("body").find("form.filter-form").first());a.data("noAutoSubmit",1);a.find(".text-filter").val("");a.find(".options-filter, .location-filter").each(function(){var a=$(this);if("select"==this.tagName.toLowerCase())a.val(""),a.hasClass("groupedopts-filter-widget")&&a.groupedopts("instance")?a.groupedopts("refresh"):a.hasClass("multiselect-filter-widget")&&
...
typeof a&&(a=$("body").find("form.filter-form").first());var b,c,e=[],f,g,k,l,m,p;a.find(".text-filter:visible").each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();if(k=f.val().trim()){l=k.split(" ");var a=f.data("match"),h=[];for(b=0;b<l.length;b++)if(m=$.trim(l[b]),""!==m){var p=d("*"+m+"*");"any"==a?h.push(p):e.push([g,p])}"any"==a&&e.push([g,h.join(",")])}else e.push([g,null])});a.find(".s3-groupedopts-widget:visible").prev(".options-filter.groupedopts-filter-widget").add(a.find(".ui-multiselect:visible").prev(".options-filter.multiselect-filter-widget")).add(a.find(".options-filter:visible,.options-filter.multiselect-filter-widget.active")).each(function(){f=
$(this);c=f.attr("id");g=$("#"+c+"-data").val();p=$("input:radio[name='"+c+"_filter']:checked").val();switch(p){case "any":g=g.replace(/__contains$|__belongs$/,"__anyof");break;case "all":g=g.replace(/__anyof$|__belongs$/,"__contains")}if("select"==this.tagName.toLowerCase()){if(k="",l=f.val())for(l instanceof Array||(l=l.split(",")),b=0;b<l.length;b++){var a=d(l[b]);k=""===k?a:k+","+a}}else k="",$("input[name='"+c+"']:checked").each(function(){k=""===k?d($(this).val()):k+","+d($(this).val())});""===
k||"*"==k?e.push([g,null]):e.push([g,k])});a.find(".map-filter").each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();(k=f.val())?e.push([g,k]):e.push([g,null])});a.find(".range-filter-input:visible").each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();(k=f.val())?e.push([g,k]):e.push([g,null])});a.find(".date-filter-input:visible").each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();k=f.val();p=c.split("-").pop();if(f.hasClass("datetimepicker"))var a=function(a){return a.getFullYear()+
"-"+("0"+(a.getMonth()+1)).slice(-2)+"-"+("0"+a.getDate()).slice(-2)+"T"+("0"+a.getHours()).slice(-2)+":"+("0"+a.getMinutes()).slice(-2)+":"+("0"+a.getSeconds()).slice(-2)};else{var b="";f.hasClass("hide-time")&&(b="le"==p?"T23:59:59":"T00:00:00");a=function(a){return a.getFullYear()+"-"+("0"+(a.getMonth()+1)).slice(-2)+"-"+("0"+a.getDate()).slice(-2)+b}}var d=!1;"le"==p&&(d=!0);if(f.hasClass("negative")){if(d){var l=!1;d=c.slice(0,-3);var m=$("#"+d+"-ge");var n=m.val();if(n){l=!0;m=m.calendarWidget("getJSDate",
!1);var q=a(m);var r=$("#"+d+"-ge-data").val();r=r.replace(h,"")}if(k){l=!0;m=f.calendarWidget("getJSDate",!0);var t=a(m);var w=g.replace(h,"")}l&&(a="("+$("#"+d+"-negative").val()+" eq NONE)",n&&(a+=" or ("+r+' lt "'+q+'")'),k&&(a+=" or ("+w+' gt "'+t+'")'),t=$("#"+d+"-filterby"),t.length&&(t=t.val(),d=$("#"+d+"-filter_opts").val(),a+=" or ("+t+' belongs "'+d+'")'),e.push(["$filter",a]))}}else k?(m=f.calendarWidget("getJSDate",d),t=a(m),d&&f.hasClass("end_date")?(d=g.replace(h,""),e.push(["$filter",
"("+d+" "+p+' "'+t+'") or ('+d+" eq None)"])):e.push([g,t])):e.push([g,null])});a.find(".s3-groupedopts-widget:visible").prev(".location-filter.groupedopts-filter-widget").add(a.find(".ui-multiselect:visible").prev(".location-filter.multiselect-filter-widget").add(a.find(".location-filter:visible,.location-filter.multiselect-filter-widget.active"))).each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();k="";if("select"==this.tagName.toLowerCase()){if(l=$(this).val(),l)for(b=0;b<l.length;b++){var a=
...
function(a,b){void 0===a&&(a=$("body").find("form.filter-form").first());a.data("noAutoSubmit",1);var c,d={},f,g,k;var l=0;for(f=b.length;l<f;l++){var m=b[l];var p=m[0];var n="string"==typeof m[1]?e(m[1]):m[1];d.hasOwnProperty(p)?d[p]=d[p].concat(n):d[p]=n}a.find(".text-filter").each(function(){g=$(this);c=g.attr("id");p=$("#"+c+"-data").val();if(d.hasOwnProperty(p)){g.is(":visible")||g.hasClass("active")||v(a);n=d[p];k="";if(n){var b;l=0;for(f=n.length;l<f;l++)if(b=n[l])0<l&&(k+=" "),"*"==b[0]&&
(b=b.slice(1)),"*"==b.slice(-1)&&(b=b.slice(0,-1)),k+=b}g.val(k)}});a.find(".options-filter").each(function(){g=$(this);c=g.attr("id");p=$("#"+c+"-data").val();var b=$('input:radio[name="'+c+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var e=!1,f=p.replace(h,"");if(d.hasOwnProperty(f+"__eq"))n=d[f+"__eq"],e=!0;else if(d.hasOwnProperty(f))n=d[f],e=!0;else if(d.hasOwnProperty(p))n=d[p],e=!0;else if("any"==b||"all"==b)d.hasOwnProperty(f+"__anyof")?(n=d[f+"__anyof"],
e=!0,$('input:radio[name="'+c+'_filter"][value="any"]').prop("checked",!0)):d.hasOwnProperty(f+"__contains")&&(n=d[f+"__contains"],e=!0,$('input:radio[name="'+c+'_filter"][value="all"]').prop("checked",!0));e&&(g.is(":visible")||g.hasClass("active")||v(a),g.val(n),g.hasClass("groupedopts-filter-widget")&&g.groupedopts("instance")?g.groupedopts("refresh"):g.hasClass("multiselect-filter-widget")&&g.multiselect("instance")&&g.multiselect("refresh"))}});a.find(".map-filter").each(function(){g=$(this);
c=g.attr("id");p=$("#"+c+"-data").val();if(d.hasOwnProperty(p))if(g.is(":visible")||g.hasClass("active")||v(a),n=d[p],n){g.val(n[0]);var b=c+"-map";S3.gis.maps[b].s3.polygonButtonLoaded()}else g.val(""),b=c+"-map",S3.gis.maps[b].s3.layerRefreshed()});a.find(".range-filter-input").each(function(){g=$(this);c=g.attr("id");p=$("#"+c+"-data").val();d.hasOwnProperty(p)&&(g.is(":visible")||g.hasClass("active")||v(a),(n=d[p])?g.val(n[0]):g.val(""))});a.find(".date-filter-input").each(function(){var b=$(this),
c=$("#"+b.attr("id")+"-data").val(),e=c.replace(h,""),f=!1;d.hasOwnProperty(c)?f=d[c]:d.hasOwnProperty(e)&&(f=d[e]);!1!==f&&(b.is(":visible")||b.hasClass("active")||v(a),f?(c=f[0].replace(" ","T"),b.calendarWidget("setJSDate",new Date(c))):b.calendarWidget("clear"),b.trigger("change"))});a.find(".location-filter").each(function(){g=$(this);c=g.attr("id");p=$("#"+c+"-data").val();var b=$('input:radio[name="'+c+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var e=
!1;if(d.hasOwnProperty(p))n=d[p],e=!0;else if("any"==b||"all"==b)b=p.replace(h,""),d.hasOwnProperty(b+"__anyof")?(n=d[b+"__anyof"],e=!0,$('input:radio[name="'+c+'_filter"][value="any"]').prop("checked",!0)):d.hasOwnProperty(b+"__contains")&&(n=d[b+"__contains"],e=!0,$('input:radio[name="'+c+'_filter"][value="all"]').prop("checked",!0));e&&(g.is(":visible")||g.hasClass("active")||v(a),g.val(n),g.hasClass("groupedopts-filter-widget")&&g.groupedopts("instance")?g.groupedopts("refresh"):g.hasClass("multiselect-filter-widget")&&
g.multiselect("instance")&&g.multiselect("refresh"),z(this))}});a.find(".hierarchy-filter:visible").each(function(){g=$(this);c=g.attr("id");p=$("#"+c+"-data").val();d.hasOwnProperty(p)&&(g.is(":visible")||g.hasClass("active")||v(a),n=d[p],g.hasClass("s3-cascade-select")?g.cascadeSelect("set",n):g.hierarchicalopts("set",n))});a.data("noAutoSubmit",0);a.trigger("optionChanged")};var k=function(a,b){void 0===b&&(b=g());a=a.split("?");var c={},e={},d,f=[];b=b.filter(function(a){return"$filter"==a[0]?
(f.push(a),!1):!0});f.length&&b.push(f.reduce(function(a,b){return["$filter","("+a[1]+") and ("+b[1]+")"]}));var h=0;for(d=b.length;h<d;h++){var k=b[h];var l=k[0];k=k[1];null===k?c.hasOwnProperty(l)||(e[l]=!0):(e.hasOwnProperty(l)&&(e[l]=!1),c[l]=!0)}var m=[];if(1!=S3.search.stripFilters&&1<a.length){var p=a[1].split("&");h=0;for(d=p.length;h<d;h++)k=p[h].split("="),1<k.length&&(l=decodeURIComponent(k[0]),e[l]||c[l]||m.push(p[h]))}h=0;for(d=b.length;h<d;h++)k=b[h],l=k[0],k=k[1],c[l]&&m.push(l+"="+
encodeURIComponent(k));b=m.join("&");a=a[0];b&&(a=a+"?"+b);return a};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(a,b){var c=$(a);a=c.find("input.filter-ajax-url");a.length&&(a=$(a[0]).val());$.ajax({url:a,dataType:"json"}).done(function(a){c.data("noAutoSubmit",1);for(var e in a){var d=$("#"+e);if(d.length){var f=a[e];if(d.hasClass("options-filter")){if("select"==d[0].tagName.toLowerCase()){var g=d.siblings(".no-options-available");if(f.hasOwnProperty("empty"))d.html(""),d.hasClass("multiselect-filter-widget")&&
d.multiselect("instance")?(d.multiselect("refresh"),d.multiselect("instance").button.hide()):d.hasClass("groupedopts-filter-widget")&&d.groupedopts("instance")?d.groupedopts("refresh"):d.hide(),g.length&&(g.html(f.empty),g.removeClass("hide").show());else{var h=d.val(),k=[],l="",m;if(f.hasOwnProperty("groups")){var p=0;for(m=f.groups.length;p<m;p++){var n=f.groups[p];n.label&&(l+='<optgroup label="'+n.label+'">');for(var q=0,t=n.items.length;q<t;q++){var r=n.items[q];var w=r[0].toString();h&&0<=$.inArray(w,
h)&&k.push(w);l+='<option value="'+w+'"';(w=r[3])&&(l+=' title="'+w+'"');r=r[1];l+=">"+r+"</option>"}n.label&&(l+="</optgroup>")}}else for(p=0,m=f.length;p<m;p++)r=f[p],w=r[0],w=null===w?"None":w.toString(),r=r[1],h&&0<=$.inArray(w,h)&&k.push(w),l+='<option value="'+w+'">'+r+"</option>";d.html(l);k&&d.val(k);g.length&&g.hide();d.hasClass("groupedopts-filter-widget")&&d.groupedopts("instance")?d.groupedopts("refresh"):d.hasClass("multiselect-filter-widget")&&d.multiselect("instance")?(d.multiselect("refresh"),
d.multiselect("instance").button.show()):d.removeClass("hide").show()}}}else d.hasClass("date-filter")&&(g=f.min,h=f.max,$("#"+e+"-ge").calendarWidget("instance").option("minDateTime",g).option("maxDateTime",h).refresh(),$("#"+e+"-le").calendarWidget("instance").option("minDateTime",g).option("maxDateTime",h).refresh(),d.find(".range-picker").trigger("resize",[g,h,f.ts]))}}c.data("noAutoSubmit",0);b&&b.apply()}).fail(function(a,b,c){console.log("UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText)})};
var m=function(a,b){$("#"+a[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var a=$(this),c=a.data("url");c&&a.data("url",k(c,b))})},l=function(a){var b=$("#"+a).find('input.filter-submit-url[type="hidden"]').first().val(),d=c[a],e;c[a]={};for(e in d){var f=$("#"+e);var h=f.is(":visible")?!0:!1;var l=d[e];f=l.needs_reload;if(h){if(f){var p=g($("#"+a));b=k(b,p);window.location.href=b}}else c[a][e]=l}for(e in d)f=$("#"+e),f.is(":visible")&&(l=d[e],f=$("#"+e),f.hasClass("dataTable")?
(a=f.dataTable(),l=l.ajaxurl,a.fnReloadAjax(l),m(a,p),$("#"+a[0].id+"_dataTable_filterURL").val(l)):f.hasClass("dl")?f.datalist("ajaxReload",l.queries):f.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",l.queries):f.hasClass("gi-container")?f.groupedItems("reload",null,l.queries):f.hasClass("pt-container")?f.pivottable("reload",null,l.queries):f.hasClass("tp-container")?f.timeplot("reload",null,l.queries):f.hasClass("s3-organizer")&&f.organizer("reload"))};S3.search.filterFormAutoSubmit=
function(a,b){a=$("#"+a);if(a.length&&b)a.on("optionChanged",function(){var a=$(this);if(!a.data("noAutoSubmit")){var c=a.data("autoSubmitTimeout");c&&clearTimeout(c);c=setTimeout(function(){u(a)},b);a.data("autoSubmitTimeout",c)}})};var n=function(){var a=new jQuery.Deferred;setTimeout(function A(){void 0!=S3.gis.maps?a.resolve("loaded"):"pending"===a.state()&&(a.notify("waiting for JS to load..."),setTimeout(A,500))},1);return a.promise()},q=function(a,b,d){void 0===d&&(d=g($("#"+a)));c.hasOwnProperty(a)||
...
a.DataTable())&&a.responsive&&a.responsive.recalc();else if(a.hasClass("doublescroll"))try{a.dataTableS3("doubleScroll")}catch(w){}},t=function(a,b){var c=b.find(".map_wrapper"),e=c.length;e?$.when(n()).then(function(){for(var b=S3.gis,d=0;d<e;d++){var f=c[d].attributes.id.value;void 0===b.maps[f]&&b.show_map(f,b.options[f])}l(a)},function(a){s3_debug(a)},function(a){s3_debug(a)}):l(a);b.find("table.dataTable.display").each(function(){p(this)})};S3.search.unhide_section=t;S3.search.summary_tabs=function(a,
b,c){if(c)for(var d=g($("#"+a)),e=c.split(","),f=0,h=e.length;f<h;f++)c=e[f],q(a,c,d);void 0!=b?($("#summary-tabs").tabs({active:b,activate:function(b,c){b=$(c.newPanel);b.removeClass("hide");if(c.newTab.length){var e=$(c.newTab).index();c=$("#"+a).find('input.filter-submit-url[type="hidden"]');if(c.length){c=c.first();var d=$(c).val(),f=d.split("?"),g=[];if(1<f.length){d=f[1].split("&");for(var h,k,l=0;l<d.length;l++)h=d[l].split("="),1<h.length&&(k=decodeURIComponent(h[0]),"t"!=k&&g.push(h[0]+"="+
h[1]));g.push("t="+e);e=g.join("&");f=f[0];e&&(f=f+"?"+e)}else f=d+"?t="+e;$(c).val(f)}}t(a,b)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){p(this)})):$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){p(this)})};S3.search.summary_maps=function(a){for(var b=$("#summary-common, #summary-sections").find(".map_wrapper"),c=0;c<b.length;c++){var e=b[c];if(!e.hidden){var d=
S3.gis;e=e.attributes.id.value;if(void 0===d.maps[e]){var f=d.options[e];void 0!=f&&(d.show_map(e,f),e=g($("#"+a)),d.refreshLayer("search_results",e))}}}};S3.search.s3map=function(a){var b=S3.gis;void 0===a&&(a="default_map");b.show_map(a,b.options[a]);a=g();b.refreshLayer("search_results",a)};var z=function(a){var b=a.name,c=b.slice(0,-1),e=parseInt(b.slice(-1)),d=$("#"+b);if(d.val()){var f=e+1,g=c+f,h=$("#"+g);h.length||(f=e+2,g=c+f,h=$("#"+g));if(h.length){var k=g.replace(/-/g,"_");S3[k]();h.next(".ui-multiselect").show();
k=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){h=!0;var l=S3.location_name_l10n}else h=!1;a.options1=[];a.options2=[];a.options3=[];a.options4=[];a.options5=[];for(b=e;0<=b&&!k.hasOwnProperty("L"+b);b--);var p=function(b){var e,d;for(e in b)if(b.hasOwnProperty(e)){e&&"null"!=e&&a["options"+f].push(e);var h=b[e];if("object"===typeof h&&(g=f+1,$("#"+c+g).length||(g=f+2),$("#"+c+g).length))for(d in h)h.hasOwnProperty(d)&&d&&"null"!=d&&a["options"+g].push(d)}},m=function(a,b){var d,
f,g=$("#"+c+b).val();for(f in a)if(a.hasOwnProperty(f))if(null===g)if(b===e)p(a[f]);else{var h=b+1;$("#"+c+h).length||h++;m(a[f],h)}else for(d in g)g[d]===f&&(b===e?p(a[f]):(h=b+1,$("#"+c+h).length||h++,m(a[f],h)))};m(k["L"+b],b);for(k=f;5>=k;k++){var n=$("#"+c+k);if(n.length){var q=a["options"+k];q.sort();var t="";for(var r in q)if(q.hasOwnProperty(r)){b=q[r];var z=h?l[b]||b:b;t+='<option value="'+b+'">'+z+"</option>"}n.html(t);if(n.hasClass("groupedopts-filter-widget")&&n.groupedopts("instance"))try{n.groupedopts("refresh")}catch(W){}else n.hasClass("multiselect-filter-widget")&&
n.multiselect("instance")&&n.multiselect("refresh");k===f&&(n.next("button").removeClass("hidden").show(),b=d.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),b.length&&(b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide())))))}}}}else{for(k=
e+1;5>=k;k++)if(n=$("#"+c+k),n.length)if(n.html(""),n.hasClass("groupedopts-filter-widget")&&n.groupedopts("instance"))try{n.groupedopts("refresh")}catch(W){}else n.hasClass("multiselect-filter-widget")&&n.multiselect("instance")&&n.multiselect("refresh");b=d.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=
b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide()))))}},u=function(a){S3.hideAlerts("warning");var b=a.attr("id"),e=a.find('input.filter-submit-url[type="hidden"]').val(),d=g(a);if(a.hasClass("filter-ajax")){a=a.find('input.filter-submit-target[type="hidden"]').val();c[b]={};a=a.split(" ");var f={},h;for(h=0;h<a.length;h++){var l=a[h];var p=$("#"+l);var n=p.is(":visible")?!0:!1;var q=!1;var t=null;p.hasClass("dataTable")?
(q=$("input#"+a[h]+"_configurations"),q.length&&(t=JSON.parse($(q).val()),t=t.ajaxUrl,t="undefined"!=typeof t?k(t,d):null),t?(f[a[h]]=t,q=!1):q=!0):p.hasClass("dl")||p.hasClass("map_wrapper")||p.hasClass("cms_content")||p.hasClass("gi-container")||p.hasClass("pt-container")||p.hasClass("tp-container")||p.hasClass("s3-target")||p.hasClass("s3-organizer")?q=!1:n?(e=k(e,d),window.location.href=e):q=!0;n||(c[b][l]={needs_reload:q,ajaxurl:t,queries:d})}for(h=0;h<a.length;h++)l=a[h],p=$("#"+l),p.is(":visible")&&
(p.hasClass("dataTable")?(b=p.dataTable(),l=f[l],b.fnReloadAjax(l),m(b,d),$("#"+b[0].id+"_dataTable_filterURL").val(l)):p.hasClass("dl")?p.datalist("ajaxReload",d):p.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",d):p.hasClass("gi-container")?p.groupedItems("reload",null,d):p.hasClass("pt-container")?p.pivottable("reload",null,d):p.hasClass("tp-container")?p.timeplot("reload",null,d):p.hasClass("s3-target")?p.s3Target("reload",k(e,d)):p.hasClass("s3-organizer")&&p.organizer("reload"))}else e=
k(e,d),window.location.href=e},v=function(a){a=$(a);var b;a.find(".advanced").each(function(){var a=$(this);a.hasClass("hide")?(a.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var a=$(this);a.addClass("active");a.hasClass("groupedopts-filter-widget")&&a.groupedopts("instance")?a.groupedopts("refresh"):a.hasClass("multiselect-filter-widget")&&a.multiselect("instance")&&a.multiselect("refresh")}),b=!0):(a.addClass("hide").hide().find(".multiselect-filter-widget,.groupedopts-filter-widget").removeClass("active"),
b=!1)});a=$(a.find(".filter-advanced-label"));b?a.text(a.data("off")).siblings().toggle():a.text(a.data("on")).siblings().toggle()};$(document).ready(function(){$(".groupedopts-filter-widget:visible,.multiselect-filter-widget:visible").addClass("active");$(".filter-clear").click(function(){var a=$(this).closest(".filter-form");f(a)});$(".show-filter-manager").click(function(){$(".filter-manager-row").removeClass("hide").show();$(".show-filter-manager").hide()});$(".filter-submit").click(function(){u($(this).closest(".filter-form"))});
...
function(){$(this).closest("form").trigger("optionChanged")});$('.s3-options-filter-anyall input[type="radio"]').on("change.autosubmit",function(){$(this).closest("form").trigger("optionChanged")});$(".hierarchy-filter").on("select.s3hierarchy",function(){$(this).closest("form").trigger("optionChanged")});$(".map-filter").each(function(){var a=$(this);$.when(n()).then(function(){var b=a.attr("id"),c=$("#"+b),e,d=S3.gis,f=d.maps[b+"-map"],g=f.s3;g.pointPlaced=function(a){var b={internalProjection:f.getProjectionObject(),
externalProjection:d.proj4326};e=(new OpenLayers.Format.WKT(b)).write(a);c.val('"'+e+'"').trigger("change")};g.polygonButtonOff=function(){c.val("").trigger("change")};g.layerRefreshed=function(){var a=g.polygonButton;a&&"drawpolygonclear-off"==a.getIconClass()&&(g.lastDraftFeature?g.lastDraftFeature.destroy():1<g.draftLayer.features.length&&g.draftLayer.features[0].destroy(),a.control.deactivate(),a.items[0].pressed=!0)};g.polygonButtonLoaded=function(){if(e=c.val()){g.polygonButton.items[0].btnEl.dom.click();
var a=OpenLayers.Geometry.fromWKT(e);a.transform(d.proj4326,f.getProjectionObject());a=new OpenLayers.Feature.Vector(a,{},null);var b=g.draftLayer;b.addFeatures([a]);g.lastDraftFeature=a;f.zoomToExtent(b.getDataExtent())}};g.polygonButtonLoaded()},function(a){s3_debug(a)},function(a){s3_debug(a)})});$(".date-filter").find(".range-picker").each(function(){function a(){for(var a,b,c=[],d=e.data("ts"),f=0;f<d.length;f++)a=d[f],b=moment(a[0]),c.push({x:b,y:a[1]});e.data("slots",c);return[{values:c,key:"",
color:"#3b6596",area:!0}]}function b(){Q=O.val();M=S.val();g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;Q?(I=moment(Q,d),D=I-g,Q=D/R*100+"%"):Q="0%";M?(J=moment(M,d),D=J-g,M=D/R*100+"%"):M="100%";F.updatePosition(M,Q)}function c(a){var b=v[a].x;try{var c=v[a+1].x}catch(ea){c=moment(e.data("max"))}var f=Z;Z+=4E3;f=setTimeout(function(){var f=c;e.data("slot",a);O.val(b.format(d));S.val(f.format(d));O.trigger("change")},f);T.push(f)}var e=$(this),d=e.data("fmt"),f=e.data("min");if(f)var g=
moment(f);else g=moment().subtract(5,"minutes"),e.data("min",g.format());f=e.data("max");if(f)var h=moment(f);else h=moment().subtract(5,"minutes"),e.data("max",h.format());var k=e.parent().attr("id"),l=g.format("YYYY"),p=moment(g);f="";for(var m=[{year:l,months:[]}],n=0,q;h>p||p.format("M")===h.format("M");)q=p.format("YYYY"),q!=l&&(m.push({year:q,months:[]}),l=q,n++),m[n].months.push(p.format("MMM YYYY")),p.add(1,"month");for(n=0;n<m.length;n++){l=m[n];p=l.months;l=l.year;f+='<optgroup label="'+
l+'">';for(l=0;l<p.length;l++)f+='<option value="'+p[l]+'">'+p[l]+"</option>";f+="</optgroup>"}e.before('<div class="range-coarse"><div class="range-coarse-start"><label for="'+k+'-cs">From:</label><select id="'+k+'-cs">'+f+'</select></div><div class="range-coarse-end"><label for="'+k+'-ce">to:</label><select id="'+k+'-ce">'+f+"</select></div></div>");f=$("#"+k+"-cs");m=$("#"+k+"-ce");f.val(g.format("MMM YYYY"));m.val(h.format("MMM YYYY"));a();e.before('<a class="button secondary tiny play"><i class="fa fa-play"></i> Play</a><a class="button secondary tiny hide pause"><i class="fa fa-pause"></i> Pause</a><a class="button secondary tiny hide stop"><i class="fa fa-stop"></i> Stop</a>');
var t=$("#"+k+" .play"),z=$("#"+k+" .pause"),u=$("#"+k+" .stop"),v=e.data("slots");3>v.length&&t.hide();var R,D,K,F=e.rangepicker({type:"double",startValue:g.format(d),endValue:h.format(d),translateSelectLabel:function(a,b){g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;D=a/b*R;K=new Date(+g+parseInt(D));return moment(K).format(d)}});e.before('<div id="'+k+'-chart"><svg></svg></div>');var E=function(a){a=a.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+
a.color+'">'+a.x.format(d)+'</div><div class="pt-tooltip-text">'+a.y+"</div></div>"};F.graph=function(){nv.addGraph(function(){var b=nv.models.lineChart().margin({left:0,right:0}).showLegend(!1).showYAxis(!1).showXAxis(!1);b.tooltip.contentGenerator(E);var c=a();d3.select("#"+k+"-chart svg").datum(c).call(b);nv.utils.windowResize(function(){b.update()});return b})};F.graph();var O=$("#"+k+"-ge"),S=$("#"+k+"-le"),X,P,Q,M,I,J;e.on("update",function(){X=F.getSelectValue();P=X.totalWidth;Q=X.start;M=
X.end;g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;D=Q/P*R;I=new Date(+g+parseInt(D));O.val(moment(I).format(d));D=M/P*R;J=new Date(+g+parseInt(D));S.val(moment(J).format(d));e.closest("form").trigger("optionChanged")});f.on("change",function(){g=moment($(this).val(),"MMM YYYY");e.data("min",g.format());I=g.format(d);F.refresh({startValue:I});O.val(I);e.closest("form").trigger("optionChanged")});m.on("change",function(){h=moment($(this).val(),"MMM YYYY").endOf("month");e.data("max",h.format());
J=h.format(d);F.refresh({endValue:J});S.val(J);e.closest("form").trigger("optionChanged")});O.on("change",function(){b()});S.on("change",function(){b()});e.on("clear",function(){F.updatePosition("100%","0%")});e.on("resize",function(a,b,c,f){e.data("min",b);e.data("max",c);F.refresh({startValue:moment(b).format(d),endValue:moment(c).format(d)});e.data("ts",f);F.graph();v=e.data("slots");2<v.length?t.show():t.hide()});var Z=0,T=[];e.data("slot",0);t.on("click",function(){var a=e.data("slot");t.hide();
z.removeClass("hide").show();u.removeClass("hide").show();v=e.data("slots");for(a;a<v.length;a++)c(a)});z.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());Z=0;z.hide();t.show()});u.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());e.data("slot",0);Z=0;z.hide();u.hide();t.show()})});$(".text-filter").keypress(function(a){return 13==a.which?(a.preventDefault(),!1):!0})})})();
...
b.ajaxS3({url:this.options.ajaxURL,type:"POST",dataType:"json",contentType:"application/json; charset=utf-8",data:JSON.stringify(h),success:function(e){if(e=e.created){c.options.filters[e]=h.query;var d=b('<option value="'+e+'">'+h.title+"</option>");b(a).append(d).val(e).change().prop("disabled",!1)}c._cancel()},error:function(){c._cancel()}})}},_save:function(){var a=this.element,c=this,f=this.options,h=b(a).val();if(h&&(!f.confirmUpdate||confirm(f.confirmUpdate))){this._hideCRUDButtons();this.throbber.show();
...
31,30,31,31,30,31,30,31][c]},_get_days_in_month_big:function(a){b(this.element);return this._get_days_in_month(a.getFullYear(),a.getMonth())},_add_months:function(a,c){b(this.element);var d=a.getDate();a.setDate(1);a.setMonth(a.getMonth()+c);a.setDate(Math.min(d,this._get_days_in_month_big(a)));return a}})})(jQuery);
...
c,f){for(var e="",d=0,k=f.length;d<k;d++)e+="<td>"+f[d]+"</td>";e=0!==b("#edt-"+a+"-none").length?e+('<td><div><div id="edt-'+a+"-"+c+'" class="inline-edt"></div></div></td>'):e+"<td></td>";e=0!==b("#rmv-"+a+"-none").length?e+('<td><div><div id="rmv-'+a+"-"+c+'" class="inline-rmv"></div></div></td>'):e+"<td></td>";a="read-row-"+a+"-"+c;c=b("#"+a);c.length||(c=b('<tr id="'+a+'" class="read-row">'));c.empty().html(e);return c},appendReadRow:function(a,c){b("#sub-"+a+" > table.embeddedComponent > tbody").append(c)},
appendError:function(a,c,f,h){var e=a+"_error";h='<div class="error">'+h+"</div>";var d=function(a){a=b(a+"> td");for(var c=0,e,d=a.len,f;e<d;e++)c=(f=a[e].attr("colspan"))?c+parseInt(f):c+1;return c},m=function(){return"none"==c?"#add-row-"+a:"#edit-row-"+a};null===f?(f=m(),h=b('<tr><td colspan="'+d(f)+'">'+h+"</td></tr>")):(f="#sub_"+a+"_"+a+"_i_"+f+"_edit_"+c,b(f).is('[type="hidden"]')&&(f=m(),h='<tr><td colspan="'+d(f)+'">'+h+"</td></tr>"),h=b(h));h.addClass(e).hide().insertAfter(f)},updateColumn:function(a,
...
this.eventNamespace+this.id,k=this;b.when.apply(null,d).then(function(){k.submitInProgress=!1;a.off(g).submit()},function(){k.submitInProgress=!1;a.find('input[type="submit"]').prop("disabled",!1)})},_collectData:function(a,c,f){var e=this.formname,d=a.data,k={},m=null;if("none"==c)var l=b("#add-row-"+e);else{l=b("#edit-row-"+e);var n=l.data("rowindex");"undefined"!=typeof n&&(m=d[n])}if(l.length&&(d=new b.Event("validate"),l.triggerHandler(d),d.isDefaultPrevented()))return null;null!==m&&(l=m._id,
"undefined"!=typeof l&&(k._id=l));d=a.fields;for(n=0;n<d.length;n++){var q=d[n].name;l="#sub_"+e+"_"+e+"_i_"+q+"_edit_"+c;var p=b(l);if(p.length)if(l=p.val(),"file"==p.attr("type")){l||!m||b("#"+e+"_i_"+q+"_edit_"+c+"__delete").prop("checked")||(l=m[q].value);p.clone().insertAfter(p);var t=b("#add-"+e+"-none").length||"none"!=c?f||c:"0";t="upload_"+e+"_"+q+"_"+t;b("#"+t).remove();var z=p.closest("form");p.css({display:"none"}).attr("id",t).attr("name",t).appendTo(z);l.match(/fakepath/)&&(l=l.replace(/(c:\\)*fakepath\\/i,
""))}else"checkbox"==p.attr("type")?l=p.prop("checked"):p.hasClass("s3-hierarchy-input")?l=l?JSON.parse(l):null:(p=p.attr("class"),"generic-widget"==p&&(p=parseInt(l,10),isNaN(p)||l!=""+p||(l=p)));else l=null!==m?m[q].value:a.defaults&&"undefined"!=typeof a.defaults[q]?a.defaults[q].value:"";k[q]=l}if(b("#read-row-"+e+"-"+c).hasClass("single")){c=!0;for(q in k)if("_id"!=q&&""!==k[q]){c=!1;break}c?b("#edit-row-"+e).hasClass("required")?(this._appendError(e,"0",q,i18n.enter_value),k._error=!0):k._delete=
!0:delete k._error}else{f=!1;if(b("#add-row-"+e).hasClass("required")||b("#edit-row-"+e).hasClass("required"))f=!0;if(f){delete k._error;f=!0;for(q in k)"_id"!=q&&""!==k[q]&&(f=!1);f&&(f="none","none"!=c&&(f="0"),b("#add-"+e+"-"+c).length?b("#read-row-"+e+"-0").length||(this._appendError(e,f,q,i18n.enter_value),k._error=!0):(this._appendError(e,f,q,i18n.enter_value),k._error=!0))}}a=a.defaults;for(q in a)k.hasOwnProperty(q)||(l=a[q].value,k[q]=l);return k},_validate:function(a,c,f){var e=this.formname,
d=b.Deferred();if(f._error)return this._displayErrors(),d.reject();var k=a.resource,m=a.component;a=S3.Ap.concat("/"+a.controller+"/"+a["function"]+"/validate.json");null!==k&&"undefined"!=typeof k?(a+="?resource="+k,k="&"):k="?";null!==m&&"undefined"!=typeof m&&(a+=k+"component="+m);f=JSON.stringify(f);var l=this;b.ajaxS3({type:"POST",url:a,data:f,dataType:"json",contentType:"application/json; charset=utf-8",success:function(a){var b=!1;a?a.hasOwnProperty("_error")&&(b=!0,l._appendError(e,c,null,
a._error)):(b=!0,l._appendError(e,c,null,"validation failed"));var f;for(f in a){var g=a[f];if(g.hasOwnProperty("_error")){var h=g._error;"invalid field"==h?g.text=g.value:(b=!0,l._appendError(e,c,f,h))}}b?(l._displayErrors(),d.reject()):d.resolve(a)}});return d.promise()},_updateUploadWidget:function(a,c){var e=a.val();a=a.closest(".s3-upload-widget");var d=a.data("base");var g=d?d.concat("/",c):S3.Ap.concat("/default/download",c);a.find(".s3-upload-link").each(function(){var a=b(this),d=a.find("a");
c&&!e?(d.attr("href",g),a.removeClass("hide").show()):(d.removeAttr("href"),a.hide())});var k=!1;c&&(d=c.substr(c.lastIndexOf(".")+1).toLowerCase(),-1!=["gif","png","jpg","jpeg","bmp"].indexOf(d)&&(k=!0));a.find(".s3-upload-preview").each(function(){var a=b(this),c=a.find("img");k&&!e?(c.attr("src",g),a.removeClass("hide").show()):(c.attr("src",""),a.hide())})},_ensureSelectable:function(a,b){(b?b.constructor===Array?b:[b]:[]).forEach(function(b){a.find('option[value="'+b+'"]').length||a.append('<option value="'+
...
"imageimage"!=d&&b("#read-row-"+h).hide();c=g.fields;for(g=0;g<c.length;g++){n=c[g].name;l=k[n].value;var p="#sub_"+d+"_"+d+"_i_"+n+"_edit_0";var t=b("select"+p);t.length&&this._ensureSelectable(t,l);p=b(p);if(p.length)if("file"==p.attr("type")){t=b("#upload_"+d+"_"+n+"_"+a);if(t.length){var z=p.attr("id"),u=p.attr("name");p.replaceWith(t);t.attr("id",z).attr("name",u).css({display:""});p=t}this._updateUploadWidget(p,l);b("#"+d+"_i_"+n+"_edit_0__delete").prop("checked",!1)}else"checkbox"==p.attr("type")?
...
if(b("#add-row-"+a).hasClass("required")){var l=!0;for(m in k)"_id"!=m&&""!==k[m]&&(l=!1);if(l&&b("#add-"+a+"-none").length&&b("#read-row-"+a+"-0").length)return h.hide(),c.removeClass("hide").show(),b.Deferred().resolve()}var n=this;return this._validate(g,"none",k).then(function(e){if(null!==e){e._changed=!0;var d=g.data.push(e)-1;e._index=d;n._serialize();if(f){for(var k=[],l=g.fields,m,q,r,w=0,A=l.length;w<A;w++)m=l[w].name,q=b("#upload_"+a+"_"+m+"_none"),q.length&&(r="upload_"+a+"_"+m+"_"+d,
b("#"+r).remove(),q.attr({id:r,name:r})),k.push(e[m].text);n._resetAddRow();e=n._renderReadRow(a,d,k);n._appendReadRow(a,e);n._showHeaders()}}f&&(h.hide(),c.removeClass("hide").show())},function(){f&&(h.hide(),c.removeClass("hide").show())})},_updateRow:function(a){var c=this.formname,d=b("#rdy-"+c+"-0"),h;if(h=d.length?!0:!1){d.hide();var g=b("#throbber-"+c+"-0").removeClass("hide").show();this._removeErrors()}var k=this._deserialize(),m=this._collectData(k,"0",a);if(null===m)return h&&(g.hide(),
d.removeClass("hide").show()),b.Deferred().reject();if(m._delete)return k.data[a]._delete=!0,this._serialize(),b.Deferred().resolve();var l=this;return this._validate(k,"0",m).then(function(e){if(null!==e&&(e._id=k.data[a]._id,e._changed=!0,e._index=a,k.data[a]=e,l._serialize(),h)){var f=[],p=k.fields,m,n=function(){l._markChanged(l);l._catchSubmit()};for(m=0;m<p.length;m++){var u=p[m].name;f.push(e[u].text);var v=b("#sub_"+c+"_"+c+"_i_"+u+"_edit_default");var r=b("#sub_"+c+"_"+c+"_i_"+u+"_edit_0");
"file"==r.attr("type")?(v=v.clone(),v.attr("id",r.attr("id")).attr("name",r.attr("name")).change(n),r.replaceWith(v)):(v=v.val(),r.val(v));v=b("#dummy_sub_"+c+"_"+c+"_i_"+u+"_edit_default").val();b("#dummy_sub_"+c+"_"+c+"_i_"+u+"_edit_0").val(v)}e=b("#edit-row-"+c);e.removeClass("changed");f=l._renderReadRow(c,a,f);e.hide().data("rowindex",null);f.removeClass("hide").show();l._enableAddRow();l._showHeaders()}h&&(g.hide(),d.removeClass("hide").show())},function(){h&&(g.hide(),d.removeClass("hide").show())})},
...
b(this),d=!0;if(e.hasClass("required")||e.hasClass("edit-row"))d=!1;else for(var f=e.find("input, select, textarea"),g,h,p=f.length;p--;){g=b(f[p]);if(g.is('[type="hidden"]')){if(!g.data("input"))continue}else if(!g.is(":visible"))continue;if("SELECT"==g.prop("tagName")&&!e.hasClass("single")&&(h=g.attr("id").split("_"),h.pop(),h.push("default"),h=b("#"+h.join("_")),h.length&&h.val()==g.val()))continue;if("checkbox"!=g.attr("type")&&g.val()||g.prop("checked")){d=!1;break}}d||(e.hasClass("add-row")?
...
this.options,d=e.columns,g=b.makeArray(a);e.sort&&g.sort(function(a,c){return b(a).text()<b(c).text()?-1:1});a=[];var k,m;if("columns"==e.orientation){var l=Math.ceil(g.length/d);for(k=0;k<d;k++)for(m=0;m<l;m++)g.length&&(a.length<m+1&&a.push([]),a[m].push(g.shift()))}else for(;g.length;){m=[];for(k=0;k<d&&g.length;k++)m.push(g.shift());a.push(m)}e=e.table;for(k=0;k<a.length;k++){d=e?b("<tr/>"):b('<div class="s3-groupedopts-row"/>');for(m=0;m<a[k].length;m++)this._renderItem(a[k][m],d,e);c.append(d)}},
_renderItem:function(a,c,f){var e=this.options.comment,d=this.multiple,k=b(a),m="s3-groupedopts-option-"+this.id+"-"+this.index,l=d?"checkbox":"radio";this.index+=1;a=k.val();var n=k.html(),q=k.attr("title");k=this.selected;var p='<label for="'+m+'"';q&&""!==q&&(p+=' title="'+q+'"');d||a==k||(p+=' class="inactive"');p+=">"+n+"</label>";m=b('<input type="'+l+'" id="'+m+'" name="'+this.name+'" class="s3-groupedopts-option" value="'+a+'"/>');0<=(d?b.inArray(a,k):a==k?1:-1)&&b(m).prop("checked",!0);f=
f?b("<td>").append(m).append(b(p)):b('<div class="s3-groupedopts-item">').append(m).append(b(p));e&&(_.templateSettings={interpolate:/\{(.+?)\}/g},e=_.template(e)({v:a}),f.append(b(e)));c.append(f)},_bindEvents:function(){var a=this;a.menu.find(".s3-groupedopts-option").click(function(){var c=b(this),d=c.val(),h=a.element,g=a.multiple,k=h.val();null===k&&g&&(k=[]);g?(g=b.inArray(d,k),c.is(":checked")?0>g&&k.push(d):0<=g&&k.splice(g,1)):c.is(":checked")&&(k=d,a.menu.find(".s3-groupedopts-option").each(function(){c=
...
(function(){S3.autocomplete={};S3.autocomplete.normal=function(a,b,e,f,h,g,k,m,l){var c="dummy_"+f,d=$("#"+c);if(d.length){b=S3.Ap.concat("/",b,"/",e,"/search_ac.json?field=",a);h&&(b+="&"+h);g&&(b+="&link="+g);var p=$("#"+f);p.hide();if(f=p.val())var t={value:f,label:d.val()};p.data("existing",t);p.data("url",b);p.parent().hasClass("controls")?p.next().find(".s3_add_resource_link"):p.parent().next().find(".s3_add_resource_link");var z=$("#"+c+"_throbber");void 0==m&&(m=800);void 0==l&&(l=2);d.val();
d.autocomplete({delay:m,minLength:l,source:function(b,c){$.ajax({url:p.data("url"),data:{term:b.term}}).done(function(b){if(0==b.length){p.val("").change();var e={id:0};e[a]=i18n.no_matching_records}else e={id:0},e[a]=i18n.none_of_the_above;b.push(e);c(b)})},search:function(a,b){z.removeClass("hide").show();return!0},response:function(a,b,c){z.hide();return c},focus:function(a,b){return!1},select:function(b,c){b=c.item;b.id?(d.val(b[a]),p.val(b.id).change(),t={value:b.id,label:b[a]}):(d.val(""),p.val("").change());
k&&eval(k);return!1}}).data("ui-autocomplete")._renderItem=function(b,c){var e=c.label?c.label:c[a];return $("<li>").data("item.autocomplete",c).append("<a>"+e+"</a>").appendTo(b)};d.blur(function(){t&&t.label!=d.val()&&p.val("").change()})}};S3.autocomplete.generic=function(a,b,e,f,h){var c="dummy_"+b,d=$("#"+c);if(d.length){var m=$("#"+b);m.hide();if(b=m.val())var l={value:b,name:d.val()};m.data("existing",l);m.data("url",a);m.parent().hasClass("controls")?m.next().find(".s3_add_resource_link"):
m.parent().next().find(".s3_add_resource_link");var n=$("#"+c+"_throbber");void 0==f&&(f=800);void 0==h&&(h=2);d.autocomplete({delay:f,minLength:h,source:function(a,b){$.ajax({url:m.data("url"),data:{term:a.term}}).done(function(a){0==a.length?(m.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){n.removeClass("hide").show();return!0},response:function(a,b,c){n.hide();return c},focus:function(a,
b){return!1},select:function(a,b){a=b.item;(b=a.id)?(d.val(a.name),m.val(b).change(),l={value:a.id,name:a.name}):(d.val(""),m.val("").change());e&&eval(e);return!1}}).data("ui-autocomplete")._renderItem=function(a,b){if(b.label)var c=b.label;else b.matchString?(c=b.matchString+"<b>"+b.nextString+"</b>",b.context&&(c+=" - "+b.context)):c=b.name;return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){l&&l.name!=d.val()&&m.val("").change()})}};S3.autocomplete.location=
function(a,b,e,f,h){var c="dummy_"+a,d=$("#"+c);if(d.length){var m=S3.Ap.concat("/gis/location/search_ac.json"),l=$("#"+a);l.hide();if(a=l.val())var n={value:a,name:d.val()};l.data("existing",n);l.data("url",m);l.parent().hasClass("controls")?l.next().find(".s3_add_resource_link"):l.parent().next().find(".s3_add_resource_link");var q=$("#"+c+"_throbber");b&&(m+="?level="+b);void 0==f&&(f=800);void 0==e&&(e=2);d.autocomplete({delay:f,minLength:e,source:function(a,b){$.ajax({url:l.data("url"),data:{term:a.term}}).done(function(a){0==
a.length?(l.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){q.removeClass("hide").show();return!0},response:function(a,b,c){q.hide();return c},focus:function(a,b){return!1},select:function(a,b){a=b.item;a.id?(d.val(b.item.name),l.val(a.id).change(),n={value:a.id,name:b.item.name}):(d.val(""),l.val("").change());h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(a,b){if(void 0!=
b.label)var c=b.label;else c=b.name?b.match_type?b.next_string?b.match_string+"<b>"+b.next_string+"</b>":b.match_string:b.name:"",b.addr&&(c=c?c+(", "+b.addr):b.addr),b.L5&&(c=c?c+(", "+b.L5):b.L5),b.L4&&(c=c?c+(", "+b.L4):b.L4),b.L3&&(c=c?c+(", "+b.L3):b.L3),b.L2&&(c=c?c+(", "+b.L2):b.L2),b.L1&&(c=c?c+(", "+b.L1):b.L1),b.L0&&(c=c?c+(", "+b.L0):b.L0);return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){n&&n.name!=d.val()&&l.val("").change()})}};var b=
function(b){return void 0!=b.label?b.label:b.org||b.job?a(b):b.name};S3.autocomplete.person=function(a,d,e,f,h,g,k){var c="dummy_"+e,l=$("#"+c);if(l.length){a=S3.Ap.concat("/",a,"/",d,"/search_ac.json");f&&(a+="?"+f);var n=$("#"+e);n.hide();if(e=n.val())var q={value:e,name:l.val()};n.data("existing",q);n.data("url",a);n.parent().hasClass("controls")?n.next().find(".s3_add_resource_link"):n.parent().next().find(".s3_add_resource_link");var p=$("#"+c+"_throbber");void 0==g&&(g=800);void 0==k&&(k=2);
l.autocomplete({delay:g,minLength:k,source:function(a,b){$.ajax({url:n.data("url"),data:{term:a.term}}).done(function(a){0==a.length?(n.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){p.removeClass("hide").show();return!0},response:function(a,b,c){p.hide();return c},focus:function(a,b){return!1},select:function(a,c){a=c.item;a.id?(c=b(a),l.val(c),n.val(a.id).change(),q={value:a.id,name:c}):(l.val(""),
n.val("").change());h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(a,c){var e=b(c);return $("<li>").data("item.autocomplete",c).append("<a>"+e+"</a>").appendTo(a)};l.blur(function(){q&&q.name!=l.val()&&n.val("").change()})}};S3.autocomplete.pentity=function(a,b,e,f,h,g,k){var c="dummy_"+e,d=$("#"+c);if(d.length){var n=S3.Ap.concat("/",a,"/",b,"/search_ac.json"),q=$("#"+e);q.hide();if(a=q.val())var p={value:a,name:d.val()};q.data("existing",p);q.data("url",n);q.parent().hasClass("controls")?
q.next().find(".s3_add_resource_link"):q.parent().next().find(".s3_add_resource_link");var t=$("#"+c+"_throbber");void 0==h&&(h=800);void 0==g&&(g=2);d.autocomplete({delay:h,minLength:g,source:function(a,b){n=q.data("url");k&&(n+="?types="+k);$.ajax({url:n,data:{term:a.term}}).done(function(a){0==a.length?(q.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){t.removeClass("hide").show();return!0},
response:function(a,b,c){t.hide();return c},focus:function(a,b){return!1},select:function(a,b){a=b.item;a.id?(d.val(a.name),q.val(a.id).change(),p={value:a.id,name:a.name}):(d.val(""),q.val("").change());f&&eval(f);return!1}}).data("ui-autocomplete")._renderItem=function(a,b){var c=b.label?b.label:b.name;return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){p&&p.name!=d.val()&&q.val("").change()})}};var a=function(a){if(void 0!=a.label)return a.label;var b=
a.name,c=a.org;a=a.job;if(c||a)a?(b+=" ("+a,c&&(b+=", "+c),b+=")"):b+=" ("+c+")";return b};S3.autocomplete.hrm=function(c,d,e,f,h){var g="dummy_"+d,k=$("#"+g);if(k.length){c="staff"==c?S3.Ap.concat("/hrm/hr_search/search_ac?group=staff"):"volunteer"==c?S3.Ap.concat("/vol/hr_search/search_ac"):"deploy"==c?S3.Ap.concat("/deploy/hr_search/search_ac"):S3.Ap.concat("/hrm/hr_search/search_ac");var m=$("#"+d);m.hide();if(d=m.val())var l={value:d,name:k.val()};m.data("existing",l);m.data("url",c);m.parent().hasClass("controls")?
...
c){n.hide();return c},focus:function(a,b){return!1},select:function(a,c){a=c.item;a.id?(c=b(a),k.val(c),m.val(a.id).change(),l={value:a.id,name:c}):(k.val(""),m.val("").change());e&&eval(e);return!1}}).data("ui-autocomplete")._renderItem=function(b,c){var e=a(c);return $("<li>").data("item.autocomplete",c).append("<a>"+e+"</a>").appendTo(b)};k.blur(function(){l&&l.name!=k.val()&&m.val("").change()})}};S3.autocomplete.org=function(a,b,e,f){var c="dummy_"+a,d=$("#"+c);if(d.length){var k=S3.Ap.concat("/org/organisation/search_ac.json"),
m=$("#"+a);m.hide();if(a=m.val())var l={value:a,name:d.val()};m.data("existing",l);m.data("url",k);m.parent().hasClass("controls")?m.next().find(".s3_add_resource_link"):m.parent().next().find(".s3_add_resource_link");var n=$("#"+c+"_throbber");void 0==e&&(e=800);void 0==f&&(f=2);d.autocomplete({delay:e,minLength:f,source:function(a,b){$.ajax({url:m.data("url"),data:{term:a.term}}).done(function(a){0==a.length?(m.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,
...
b.matchString+"<b>"+b.nextString+"</b>"):(c=b.matchString+"<b>"+b.nextString+"</b>",b.parent?c=b.parent+" > "+c:b.acronym&&(c+=" - "+b.acronym)):(c=b.name,b.parent?c=b.parent+" > "+b.name:b.acronym&&(c+=" ("+b.acronym+")"));return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){l&&l.name!=d.val()&&m.val("").change()})}};S3.autocomplete.site=function(a,b,e,f){var c="dummy_"+a,d=$("#"+c);if(d.length){var k=S3.Ap.concat("/org/site/search_ac.json"),m=$("#"+
a);m.hide();if(a=m.val())var l={value:a,name:d.val()};m.data("existing",l);m.data("url",k);m.parent().hasClass("controls")?m.next().find(".s3_add_resource_link"):m.parent().next().find(".s3_add_resource_link");var n=$("#"+c+"_throbber");void 0==e&&(e=800);void 0==f&&(f=2);d.autocomplete({delay:e,minLength:f,source:function(a,b){$.ajax({url:m.data("url"),data:{term:a.term}}).done(function(a){0==a.length?(m.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",
...
(c+=b.next_string),"name"==b.match_type){var e=b.addr,d=b.L4||b.L3||b.L2||b.L1;if(e||d)e?(c+=" ("+e,d&&(c+=", "+d),c+=")"):c+=" ("+d+")";var f=b.org;e=b.instance_type;if(f||e)e?(c+=" ("+S3.org_site_types[e],f&&(c+=", "+f),c+=")"):c+=" ("+f+")"}else if("addr"==b.match_type){if(c=b.name+" ("+c,c=(d=b.L4||b.L3||b.L2||b.L1)?c+(", "+d+")"):c+")",f=b.org,e=b.instance_type,f||e)e?(c+=" ("+S3.org_site_types[e],f&&(c+=", "+f),c+=")"):c+=" ("+f+")"}else if("org"==b.match_type){f=b.name;e=b.addr;d=b.L4||b.L3||
b.L2||b.L1;if(e||d)e?(f+=" ("+e,d&&(f+=", "+d),f+=")"):f+=" ("+d+")";c=(e=b.instance_type)?f+" ("+S3.org_site_types[e]+", "+c+")":f+" ("+c+")"}else{if(f=b.name,c=(e=b.addr)?f+" ("+e+", "+c+")":f+" ("+c+")",f=b.org,e=b.instance_type,f||e)e?(c+=" ("+S3.org_site_types[e],f&&(c+=", "+f),c+=")"):c+=" ("+f+")"}else c=b.name;return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){l&&l.name!=d.val()&&m.val("").change()})}}})();S3.supply={};
...
a).addClass("btn");b('form input[type="submit"]:not([class^="btn"]), form input[type="button"]:not([class^="btn"])',a).addClass("btn");b("input[type=password][data-w2p_entropy]",a).each(function(){d.validate_entropy(b(this))});b("ul.w2p_list",a).each(function(){function a(a,e){var d=b(a).find("li:first").clone(!0);d.find(":text").val("");c(a);b(e.target).parent().is(":visible")?d.insertAfter(b(e.target).parent()):d.appendTo(a);d.find(":text").focus();return!1}function c(a){b(a).find("li").each(function(){var a=
b.trim(b(this.firstChild).val());""===a?b(this).remove():b(this.firstChild).val(a)})}var e=this;b(e).find(":text").after('<a href="#">+</a>&nbsp;<a href="#">-</a>').keypress(function(b){return 13==b.which?a(e,b):!0}).next().click(function(b){a(e,b);b.preventDefault()}).next().click(function(a){1<b(e).children().length&&b(a.target).parent().remove();a.preventDefault()})})},ajax_init:function(a){b(".w2p_hidden",a).hide();d.manage_errors(a);d.ajax_fields(a);d.show_if_handler(a);d.component_handler(a)},
...
!1;if(Infinity==this.reload_counter)return!0;if(!isNaN(this.reload_counter))if(--this.reload_counter,0>this.reload_counter)this.run_once||clearInterval(this.timing);else return!0;return!1};isNaN(h)?(f.reload_counter=Infinity,d.ajax_page("get",a,null,c,k)):(f.timeout=h,f.reload_counter=g,1<g?(d.ajax_page("get",a,null,c,k),f.run_once=!1,f.timing=setInterval(n,h),--f.reload_counter):1==g&&(f.run_once=!0,f.setTimeout=setTimeout,f.timing=setTimeout(n,h)))})},updatePage:function(a,c){c=b("#"+c);var e=b.parseHTML(a.responseText,
document,!0),d=b(e).filter("title").add(b(e).find("title")),f=d.last().text();f&&(d.remove(),document.title=b.trim(f));d=a.getResponseHeader("web2py-component-content");"prepend"==d?c.prepend(a.responseText):"append"==d?c.append(a.responseText):"hide"!=d&&c.html(e)},calc_entropy:function(a){for(var b="abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789 !@#$%^&*() ~`-_=+[]{}|;:'\",.<>?/ 0123456789abcdefghijklmnopqrstuvwxyz".split(" "),c=0,e={},d={},m=null,l=a.split(""),n=0;n<l.length;n++){for(var q=
l[n],p=5,t=0;t<b.length;t++)if(-1!=b[t].indexOf(q)){p=t;break}p in d?q in e||(c+=1,e[q]=1):(d[p]=1,c+=b[p].length);p!=m&&(c+=1,m=p)}return Math.round(a.length*Math.log(c)/.6931471805599453*100)/100},validate_entropy:function(a,b){d.isUndefined(a.data("w2p_entropy"))||(b=a.data("w2p_entropy"));var c=function(){var c=(d.calc_entropy(a.val())||0)/b;if(.5>=c){var e=1;var f=2*c}else e=1-2*(Math.max(c,0)-.5),f=1;e="#"+Math.round(15*e).toString(16)+Math.round(15*f).toString(16)+(0).toString(16);a.css("background-color",
