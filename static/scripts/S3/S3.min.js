...
offset:c||d?{left:0,top:0}:b(a).offset(),scrollLeft:e.scrollLeft(),scrollTop:e.scrollTop(),width:e.outerWidth(),height:e.outerHeight()}}};b.fn.position=function(d){if(!d||!d.of)return n.apply(this,arguments);d=b.extend({},d);var l=b(d.of),p=b.position.getWithinInfo(d.within),z=b.position.getScrollInfo(p),t=(d.collision||"flip").split(" "),w={};var r=c(l);l[0].preventDefault&&(d.at="left top");var v=r.width;var B=r.height;var A=r.offset;var y=b.extend({},A);b.each(["my","at"],function(){var b=(d[this]||
"").split(" ");1===b.length&&(b=h.test(b[0])?b.concat(["center"]):g.test(b[0])?["center"].concat(b):["center","center"]);b[0]=h.test(b[0])?b[0]:"center";b[1]=g.test(b[1])?b[1]:"center";var a=k.exec(b[0]);var e=k.exec(b[1]);w[this]=[a?a[0]:0,e?e[0]:0];d[this]=[m.exec(b[0])[0],m.exec(b[1])[0]]});1===t.length&&(t[1]=t[0]);"right"===d.at[0]?y.left+=v:"center"===d.at[0]&&(y.left+=v/2);"bottom"===d.at[1]?y.top+=B:"center"===d.at[1]&&(y.top+=B/2);var G=a(w.at,v,B);y.left+=G[0];y.top+=G[1];return this.each(function(){var c,
g=b(this),k=g.outerWidth(),h=g.outerHeight(),n=parseInt(b.css(this,"marginLeft"),10)||0,m=parseInt(b.css(this,"marginTop"),10)||0,q=k+n+(parseInt(b.css(this,"marginRight"),10)||0)+z.width,u=h+m+(parseInt(b.css(this,"marginBottom"),10)||0)+z.height,r=b.extend({},y),L=a(w.my,g.outerWidth(),g.outerHeight());"right"===d.my[0]?r.left-=k:"center"===d.my[0]&&(r.left-=k/2);"bottom"===d.my[1]?r.top-=h:"center"===d.my[1]&&(r.top-=h/2);r.left+=L[0];r.top+=L[1];var V={marginLeft:n,marginTop:m};b.each(["left",
"top"],function(a,e){if(b.ui.position[t[a]])b.ui.position[t[a]][e](r,{targetWidth:v,targetHeight:B,elemWidth:k,elemHeight:h,collisionPosition:V,collisionWidth:q,collisionHeight:u,offset:[G[0]+L[0],G[1]+L[1]],my:d.my,at:d.at,within:p,elem:g})});d.using&&(c=function(b){var a=A.left-r.left,c=a+v-k,p=A.top-r.top,n=p+B-h,m={target:{element:l,left:A.left,top:A.top,width:v,height:B},element:{element:g,left:r.left,top:r.top,width:k,height:h},horizontal:0>c?"left":0<a?"right":"center",vertical:0>n?"top":0<
p?"bottom":"middle"};v<k&&f(a+c)<v&&(m.horizontal="center");B<h&&f(p+n)<B&&(m.vertical="middle");e(f(a),f(c))>e(f(p),f(n))?m.important="horizontal":m.important="vertical";d.using.call(this,b,m)});g.offset(b.extend(r,{using:c}))})};b.ui.position={fit:{left:function(b,a){var c=a.within,d=c.isWindow?c.scrollLeft:c.offset.left,g=c.width,f=b.left-a.collisionPosition.marginLeft;c=d-f;var k=f+a.collisionWidth-g-d;a.collisionWidth>g?0<c&&0>=k?(a=b.left+c+a.collisionWidth-g-d,b.left+=c-a):b.left=0<k&&0>=c?
...
a||null==c)throw"Invalid arguments";c="object"===typeof c?c.toString():c+"";if(""===c)return null;var d,f=0;var g=(e?e.shortYearCutoff:null)||this._defaults.shortYearCutoff;g="string"!==typeof g?g:(new Date).getFullYear()%100+parseInt(g,10);var h=(e?e.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(e?e.dayNames:null)||this._defaults.dayNames,m=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort,t=(e?e.monthNames:null)||this._defaults.monthNames,w=e=-1,r=-1,v=-1,B=!1,A=function(b){(b=
...
b[0],f+=a.length,!1});if(-1!==g)return g+1;throw"Unknown name at position "+f;},H=function(){if(c.charAt(f)!==a.charAt(d))throw"Unexpected literal at position "+f;f++};for(d=0;d<a.length;d++)if(B)"'"!==a.charAt(d)||A("'")?H():B=!1;else switch(a.charAt(d)){case "d":r=y("d");break;case "D":G("D",h,k);break;case "o":v=y("o");break;case "m":w=y("m");break;case "M":w=G("M",m,t);break;case "y":e=y("y");break;case "@":var C=new Date(y("@"));e=C.getFullYear();w=C.getMonth()+1;r=C.getDate();break;case "!":C=
new Date((y("!")-this._ticksTo1970)/1E4);e=C.getFullYear();w=C.getMonth()+1;r=C.getDate();break;case "'":A("'")?H():B=!0;break;default:H()}if(f<c.length&&(h=c.substr(f),!/^\s+/.test(h)))throw"Extra/unparsed characters found in date: "+h;-1===e?e=(new Date).getFullYear():100>e&&(e+=(new Date).getFullYear()-(new Date).getFullYear()%100+(e<=g?0:-100));if(-1<v){w=1;r=v;do{g=this._getDaysInMonth(e,w-1);if(r<=g)break;w++;r-=g}while(1)}C=this._daylightSavingAdjust(new Date(e,w-1,r));if(C.getFullYear()!==
e||C.getMonth()+1!==w||C.getDate()!==r)throw"Invalid date";return C},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:62135596800*1E7,formatDate:function(a,b,c){if(!b)return"";var e,d=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,f=(c?c.dayNames:null)||this._defaults.dayNames,g=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;
c=(c?c.monthNames:null)||this._defaults.monthNames;var h=function(b){(b=e+1<a.length&&a.charAt(e+1)===b)&&e++;return b},k=function(a,b,c){b=""+b;if(h(a))for(;b.length<c;)b="0"+b;return b},m=function(a,b,c,e){return h(a)?e[b]:c[b]},w="",r=!1;if(b)for(e=0;e<a.length;e++)if(r)"'"!==a.charAt(e)||h("'")?w+=a.charAt(e):r=!1;else switch(a.charAt(e)){case "d":w+=k("d",b.getDate(),2);break;case "D":w+=m("D",b.getDay(),d,f);break;case "o":w+=k("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-
(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":w+=k("m",b.getMonth()+1,2);break;case "M":w+=m("M",b.getMonth(),g,c);break;case "y":w+=h("y")?b.getFullYear():(10>b.getFullYear()%100?"0":"")+b.getFullYear()%100;break;case "@":w+=b.getTime();break;case "!":w+=1E4*b.getTime()+this._ticksTo1970;break;case "'":h("'")?w+="'":r=!0;break;default:w+=a.charAt(e)}return w},_possibleChars:function(a){var b,c="",e=!1,d=function(c){(c=b+1<a.length&&a.charAt(b+1)===c)&&b++;return c};for(b=0;b<
...
r&&(c.position.left=d._convertPositionTo("relative",{top:0,left:p}).left)}var v=z||t||w||r;"outer"!==f.snapMode&&(z=Math.abs(q-m)<=h,t=Math.abs(u-l)<=h,w=Math.abs(n-g)<=h,r=Math.abs(p-k)<=h,z&&(c.position.top=d._convertPositionTo("relative",{top:q,left:0}).top),t&&(c.position.top=d._convertPositionTo("relative",{top:u-d.helperProportions.height,left:0}).top),w&&(c.position.left=d._convertPositionTo("relative",{top:0,left:n}).left),r&&(c.position.left=d._convertPositionTo("relative",{top:0,left:p-
...
n,a.size.height=p,a.position.top=f.top-d;else if(/^(sw)$/.test(h))a.size.width=n,a.size.height=p,a.position.left=f.left-l;else{if(0>=p-m||0>=n-k)var w=a._getPaddingPlusBorderDimensions(this);0<p-m?(a.size.height=p,a.position.top=f.top-d):(p=m-w.height,a.size.height=p,a.position.top=f.top+e.height-p);0<n-k?(a.size.width=n,a.position.left=f.left-l):(n=k-w.width,a.size.width=n,a.position.left=f.left+e.width-n)}}});return b.ui.resizable});
...
var n=1==this._get(a,"showMinutes"),p=this._get(a,"amPmText"),q=this._get(a,"rows"),u=0,z=0,t=e=0,w=0,r=0,v=[],B=this._get(a,"hours"),A=0;var y=this._get(a,"hourText");var G=this._get(a,"showCloseButton"),H=this._get(a,"closeButtonText"),C=this._get(a,"showNowButton"),U=this._get(a,"nowButtonText"),x=this._get(a,"showDeselectButton"),Y=this._get(a,"deselectButtonText"),aa=G||C||x;for(b=B.starts;b<=B.ends;b++)v.push(b);b=Math.ceil(v.length/q);if(d){for(A=0;A<v.length;A++)12>v[A]?e++:t++;A=0;u=Math.floor(e/
v.length*q);z=Math.floor(t/v.length*q);q!=u+z&&(e&&(!t||!u||z&&e/u>=t/z)?u++:z++);w=Math.min(u,1);r=u+1;b=0==u?Math.ceil(t/z):0==z?Math.ceil(e/u):Math.ceil(Math.max(e/u,t/z))}e='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(l){e+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+y+'</div><table class="ui-timepicker">';for(l=1;l<=q;l++){e+="<tr>";l==w&&d&&(e+='<th rowspan="'+u.toString()+'" class="periods" scope="row">'+
p[0]+"</th>");l==r&&d&&(e+='<th rowspan="'+z.toString()+'" class="periods" scope="row">'+p[1]+"</th>");for(y=1;y<=b;y++)d&&l<r&&12<=v[A]?e+=this._generateHTMLHourCell(a,void 0,c,m):(e+=this._generateHTMLHourCell(a,v[A],c,m),A++);e+="</tr>"}e+="</table></td>"}n&&(e=e+'<td class="ui-timepicker-minutes">'+this._generateHTMLMinutes(a),e+="</td>");e+="</tr>";aa&&(c='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">',C&&(c+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+
...
{hour:f},c),r+='<td data-for="'+e+'">'+g+"</td>";else for(f=c[e+"Min"];f<=h[e];f+=parseInt(c[e+"Grid"],10))k[e]++,r+='<td data-for="'+e+'">'+(10>f?"0":"")+f+"</td>";r+="</tr></table></div>"}r+="</dd>"}v=null!==c.showTimezone?c.showTimezone:this.support.timezone;r+='<dt class="ui_tpicker_timezone_label"'+(v?"":' style="display:none;"')+">"+c.timezoneText+"</dt>";var A=b(r+('<dd class="ui_tpicker_timezone" '+(v?"":' style="display:none;"')+"></dd></dl></div>"));!0===c.timeOnly&&(A.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">'+
c.timeOnlyTitle+"</div></div>"),a.find(".ui-datepicker-header, .ui-datepicker-calendar").hide());v=0;for(B=d.units.length;v<B;v++)e=d.units[v],f=e.substr(0,1).toUpperCase()+e.substr(1),g=null!==c["show"+f]?c["show"+f]:this.support[e],d[e+"_slider"]=d.control.create(d,A.find(".ui_tpicker_"+e+"_slider"),e,d[e],c[e+"Min"],h[e],c["step"+f]),g&&0<c[e+"Grid"]&&(r=100*k[e]*c[e+"Grid"]/(h[e]-c[e+"Min"]),A.find(".ui_tpicker_"+e+" table").css({width:r+"%",marginLeft:c.isRTL?"0":r/(-2*k[e])+"%",marginRight:c.isRTL?
...
" ")+this.className;if("OPTGROUP"===c.tagName){var y=c.getAttribute("label");-1===b.inArray(y,m)&&(l+='<li class="ui-multiselect-optgroup-label '+c.className+'"><a href="#">'+y+"</a></li>",m.push(y))}h&&q.push("ui-state-disabled");k&&!e.multiple&&q.push("ui-state-active");l+='<li class="'+p+'">';l+='<label for="'+a+'" title="'+f+'" class="'+q.join(" ")+'">';l+='<input id="'+a+'" name="multiselect_'+n+'" type="'+(e.multiple?"checkbox":"radio")+'" value="'+g+'" title="'+f+'"';k&&(l+=' checked="checked"',
l+=' aria-selected="true"');h&&(l+=' disabled="disabled"',l+=' aria-disabled="true"');l+=" /><span>"+d+"</span></label></li>"});if(!b.isEmptyObject(e.create)){var p=e.create;d=S3.Ap.concat("/",p.c,"/",p.f,"/create?format=popup&caller=",n);p.parent&&(d+="&parent="+p.parent);p.child&&(d+="&child="+p.child);p=p.label;l+='<li><a class="s3_modal" target="top" title="'+p+'" href="'+d+'"><label class="ui-corner-all"><span><i>'+p+"</i></span></label></a></li>"}k.html(l);b.isEmptyObject(e.create)||S3.addModals();
...
c.push('<option value="">'+(b.msgNoRecords||"-")+"</option>");else{var e=b.fncPrep,f=null;if(e)try{f=e(a)}catch(r){}e=b.lookupField||"id";for(var g=b.fncRepresent,h,k,t,w=0;w<a.length;w++)h=a[w],k=h[e],0===w&&(d=k),t=g?g(h,f):h.name,h=h._tooltip?' title="'+h._tooltip+'"':"",c.push("<option"+h+' value="'+k+'">'+t+"</option>");b.optional&&(d=0,c.unshift('<option value=""></option>'))}return{options:c.join(""),defaultValue:d}},f=function(b,f,h,l,n){var g=!1;if(1<b.length)if("checkbox"==b.first().attr("type")){if(b.first().closest(".checkboxes-widget-s3")){s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, skipping");
...
l.lookupPrefix,"/",m,".json"),h){var z=m+"."+f+"="+h;k=-1!=k.indexOf("?")?k.concat("&"+z):k.concat("?"+z)}if(z=l.tooltip)z="tooltip="+z,k=-1!=k.indexOf("?")?k.concat("&"+z):k.concat("?"+z);if((z=l.represent)||"undefined"==typeof z)k=-1!=k.indexOf("?")?k.concat("&represent=1"):k.concat("?represent=1");z=null;if(l.getWidgetHTML){z=l.targetWidget||b.attr("name");var t=$('[name = "'+z+'"]');z=!0;var w=!1;if(z=t.hasClass("groupedopts-widget")?t.groupedopts("visible"):t.data("visible")||t.is(":visible"))w=
...
(d="1px 1px "+c+"px rgba(0,0,0,0.5)"),a.css(b.support.boxShadow,d),!1;d=a.find(".cluetip-drop-shadow");if(c==d.length)return d;d.remove();d=[];for(var e=0;e<c;)d[e++]='<div style="top:'+e+"px;left:"+e+'px;"></div>';return d=b(d.join("")).css({position:"absolute",backgroundColor:"#000",zIndex:w-1,opacity:.1}).addClass("cluetip-drop-shadow").prependTo(a)}var m,l;"object"==typeof f&&(h=f,f=null);if("destroy"==f){var n=this.data("cluetip");n&&(b(n.selector).remove(),b.removeData(this,"title"),b.removeData(this,
"cluetip"));b(document).unbind(".cluetip");return this.unbind(".cluetip")}h=b.extend(!0,{},b.cluetip.defaults,h||{});d++;n=b.cluetip.backCompat||!h.multiple?"cluetip":"cluetip-"+d;var p="#"+n,q=b.cluetip.backCompat?"#":".",u=b.cluetip.setup.insertionType,z=b.cluetip.setup.insertionElement||"body";u=/appendTo|prependTo|insertBefore|insertAfter/.test(u)?u:"appendTo";var t=b(p);if(!t.length){t=b(b.cluetip.template)[u](z).attr("id",n).css({position:"absolute",display:"none"});var w=+h.cluezIndex;var r=
t.find(q+"cluetip-outer").css({position:"relative",zIndex:w});var v=t.find(q+"cluetip-inner");var B=t.find(q+"cluetip-title")}a=b("#cluetip-waitimage");a.length||(a=b("<div></div>").attr("id","cluetip-waitimage").css({position:"absolute"}));a.insertBefore(t).hide();var A=(parseInt(t.css("paddingLeft"),10)||0)+(parseInt(t.css("paddingRight"),10)||0);this.each(function(d){function n(){return!1}function u(a,b){var c=a.status;b.beforeSend(a.xhr,b);if("error"==c)b[c](a.xhr,a.textStatus);else if("success"==
c)b[c](a.data,a.textStatus,a.xhr);b.complete(a.xhr,b.textStatus)}var z=this,y=b(this),x=b.extend(!0,{},h,b.metadata?y.metadata():b.meta?y.data():y.data("cluetip")||{}),Y=!1,aa=!1,fa=0,N=x[x.attribute]||("href"==x.attribute?y.attr(x.attribute):y.attrProp(x.attribute)||y.attr(x.attribute)),ba=x.cluetipClass;w=+x.cluezIndex;y.data("cluetip",{title:z.title,zIndex:w,selector:p});if(!N&&!x.splitTitle&&!f)return!0;x.local&&x.localPrefix&&(N=x.localPrefix+N);x.local&&x.hideLocal&&N&&b(N+":first").hide();
...
k))return!1;aa=!0;t=b(p).css({position:"absolute"});r=t.find(q+"cluetip-outer");v=t.find(q+"cluetip-inner");B=t.find(q+"cluetip-title");m=t.find(q+"cluetip-arrows");t.removeClass().css({width:X});N==y.attr("href")&&y.css("cursor",x.cursor);x.hoverClass&&y.addClass(x.hoverClass);F=y.offset().top;M=y.offset().left;Q=y.innerWidth();k.type==focus?(J=M+Q/2+V,t.css({left:I}),O=F+L):(J=k.pageX,O=k.pageY);"area"!=z.tagName.toLowerCase()&&(K=b(document).scrollTop(),Z=b(window).width());if("fixed"==x.positionBy)I=
Q+M+V,t.css({left:I});else{I=Q>M&&M>P||M+Q+P+V>Z?M-P-V:Q+M+V;if("area"==z.tagName.toLowerCase()||"mouse"==x.positionBy||Q+P>Z)J+20+P>Z?(t.addClass("cluetip-"+ba),I=0<=J-P-V?J-P-V-parseInt(t.css("marginLeft"),10)+parseInt(v.css("marginRight"),10):J-P/2):I=J+V;var l=0>I?k.pageY+L:k.pageY;if(0>I||"bottomTop"==x.positionBy)I=J+P/2>Z?Z/2-P/2:Math.max(J-P/2,0)}m.css({zIndex:y.data("cluetip").zIndex+1});t.css({left:I,zIndex:y.data("cluetip").zIndex});R=b(window).height();if(f)"function"==typeof f&&(f=f.call(z)),
v.html(f),da(l);else if(ca){k=ca.length;v.html(k?ca[0]:"");if(1<k)for(var n=1;n<k;n++)v.append('<div class="split-body">'+ca[n]+"</div>");da(l)}else if(x.local||0===N.indexOf("#"))x.local&&(k=b(N+(/^#\S+$/.test(N)?"":":eq("+d+")")).clone(!0).show(),x.localIdSuffix&&k.attr("id",k[0].id+x.localIdSuffix),v.html(k),da(l));else if(/\.(jpe?g|tiff?|gif|png)(?:\?.*)?$/i.test(N))v.html('<img src="'+N+'" alt="'+T+'" />'),da(l);else{var A=x.ajaxSettings.beforeSend,G=x.ajaxSettings.error,H=x.ajaxSettings.success,
C=x.ajaxSettings.complete;var w=g(N,x.ajaxSettings.data);k=b.extend(!0,{},x.ajaxSettings,{cache:x.ajaxCache,url:N,beforeSend:function(b,c){A&&A.call(z,b,t,v,c);r.children().empty();x.waitImage&&a.css({top:O+20,left:J+20,zIndex:y.data("cluetip").zIndex-1}).show()},error:function(a,b){h.ajaxCache&&!c[w]&&(c[w]={status:"error",textStatus:b,xhr:a});aa&&(G?G.call(z,a,b,t,v):v.html("<i>sorry, the contents could not be loaded</i>"))},success:function(a,b,d){h.ajaxCache&&!c[w]&&(c[w]={status:"success",data:a,
textStatus:b,xhr:d});Y=x.ajaxProcess.call(z,a);"object"==typeof Y&&null!==Y&&(T=Y.title,Y=Y.content);aa&&(H&&H.call(z,a,b,t,v),v.html(Y))},complete:function(c,d){C&&C.call(z,c,d,t,v);var f=v[0].getElementsByTagName("img");e=f.length;c=0;for(d=f.length;c<d;c++)f[c].complete&&e--;e&&!b.browser.opera?b(f).bind("load.ct error.ct",function(){e--;0===e&&(a.hide(),b(f).unbind(".ct"),aa&&da(l))}):(a.hide(),aa&&da(l))}});c[w]?u(c[w],k):b.ajax(k)}},da=function(a){var c=T||x.showTitle&&"&nbsp;";var d="";var e=
"";t.addClass("cluetip-"+ba);if(x.truncate){var f=v.text().slice(0,x.truncate)+"...";v.html(f)}c?B.show().html(c):B.hide();x.sticky&&(c=b('<div class="cluetip-close"><a href="#">'+x.closeText+"</a></div>"),"bottom"==x.closePosition?c.appendTo(v):"title"==x.closePosition?c.prependTo(B):c.prependTo(v),c.bind("click.cluetip",function(){ea();return!1}),x.mouseOutClose?t.bind("mouseleave.cluetip",function(){ea()}):t.unbind("mouseleave.cluetip"));r.css({zIndex:y.data("cluetip").zIndex,overflow:"auto"==
...
c});x.arrows?(/(left|right)/.test(e)&&(e=t.height()-m.height(),d=0<=I&&0<a?F-E-x.dropShadowSteps:0,d=(e>d?d:e)+"px"),m.css({top:d}).show()):m.hide();(l=k(t,x))&&l.length&&l.hide().css({height:W,width:X,zIndex:y.data("cluetip").zIndex-1}).show();t.hide()[x.fx.open](x.fx.openSpeed||0);b.fn.bgiframe&&t.bgiframe();0<x.delayedClose&&(fa=setTimeout(ea,x.delayedClose));x.onShow.call(z,t,v)},ia=function(b){aa=!1;a.hide();if(!x.sticky||/click|toggle/.test(x.activation))ea(),clearTimeout(fa);x.hoverClass&&
y.removeClass(x.hoverClass)},ea=function(a){a=a&&a.data("cluetip")?a:y;var c=a.data("cluetip")&&a.data("cluetip").selector,d=b(c||"div.cluetip"),e=d.find(q+"cluetip-inner"),f=d.find(q+"cluetip-arrows");d.hide().removeClass();x.onHide.call(a[0],d,e);c&&(a.removeClass("cluetip-clicked"),a.css("cursor",""));c&&T&&a.attrProp(x.titleAttribute,T);x.arrows&&f.css({top:""})};b(document).unbind("hideCluetip.cluetip").bind("hideCluetip.cluetip",function(a){ea(b(a.target))});if(/click|toggle/.test(x.activation))y.bind("click.cluetip",
...
!1);var p=a(m);var q=$("#"+d+"-ge-data").val();q=q.replace(h,"")}if(k){l=!0;m=f.calendarWidget("getJSDate",!0);var v=a(m);var A=g.replace(h,"")}l&&(a="("+$("#"+d+"-negative").val()+" eq NONE)",r&&(a+=" or ("+q+' lt "'+p+'")'),k&&(a+=" or ("+A+' gt "'+v+'")'),v=$("#"+d+"-filterby"),v.length&&(v=v.val(),d=$("#"+d+"-filter_opts").val(),a+=" or ("+v+' belongs "'+d+'")'),e.push(["$filter",a]))}}else k?(m=f.calendarWidget("getJSDate",d),v=a(m),d&&f.hasClass("end_date")?(d=g.replace(h,""),e.push(["$filter",
"("+d+" "+n+' "'+v+'") or ('+d+" eq None)"])):e.push([g,v])):e.push([g,null])});a.find(".s3-groupedopts-widget:visible").prev(".location-filter.groupedopts-filter-widget").add(a.find(".ui-multiselect:visible").prev(".location-filter.multiselect-filter-widget").add(a.find(".location-filter:visible,.location-filter.multiselect-filter-widget.active"))).each(function(){f=$(this);c=f.attr("id");g=$("#"+c+"-data").val();k="";if("select"==this.tagName.toLowerCase()){if(l=$(this).val(),l)for(b=0;b<l.length;b++){var a=
...
function(a,b){void 0===a&&(a=$("body").find("form.filter-form").first());a.data("noAutoSubmit",1);var c,d={},f,g,k;var l=0;for(f=b.length;l<f;l++){var m=b[l];var n=m[0];var r="string"==typeof m[1]?e(m[1]):m[1];d.hasOwnProperty(n)?d[n]=d[n].concat(r):d[n]=r}a.find(".text-filter").each(function(){g=$(this);c=g.attr("id");n=$("#"+c+"-data").val();if(d.hasOwnProperty(n)){g.is(":visible")||g.hasClass("active")||w(a);r=d[n];k="";if(r){var b;l=0;for(f=r.length;l<f;l++)if(b=r[l])0<l&&(k+=" "),"*"==b[0]&&
...
g.multiselect("instance")&&g.multiselect("refresh"),z(this))}});a.find(".hierarchy-filter:visible").each(function(){g=$(this);c=g.attr("id");n=$("#"+c+"-data").val();d.hasOwnProperty(n)&&(g.is(":visible")||g.hasClass("active")||w(a),r=d[n],g.hasClass("s3-cascade-select")?g.cascadeSelect("set",r):g.hierarchicalopts("set",r))});a.data("noAutoSubmit",0);a.trigger("optionChanged")};var k=function(a,b){void 0===b&&(b=g());a=a.split("?");var c={},d={},e,f=[];b=b.filter(function(a){return"$filter"==a[0]?
...
e.multiselect("instance")?(e.multiselect("refresh"),e.multiselect("instance").button.hide()):e.hasClass("groupedopts-filter-widget")&&e.groupedopts("instance")?e.groupedopts("refresh"):e.hide(),g.length&&(g.html(f.empty),g.removeClass("hide").show());else{var h=e.val(),k=[],l="",m;if(f.hasOwnProperty("groups")){var n=0;for(m=f.groups.length;n<m;n++){var r=f.groups[n];r.label&&(l+='<optgroup label="'+r.label+'">');for(var p=0,q=r.items.length;p<q;p++){var v=r.items[p];var A=v[0].toString();h&&0<=$.inArray(A,
h)&&k.push(A);l+='<option value="'+A+'"';(A=v[3])&&(l+=' title="'+A+'"');v=v[1];l+=">"+v+"</option>"}r.label&&(l+="</optgroup>")}}else for(n=0,m=f.length;n<m;n++)v=f[n],A=v[0],A=null===A?"None":A.toString(),v=v[1],h&&0<=$.inArray(A,h)&&k.push(A),l+='<option value="'+A+'">'+v+"</option>";e.html(l);k&&e.val(k);g.length&&g.hide();e.hasClass("groupedopts-filter-widget")&&e.groupedopts("instance")?e.groupedopts("refresh"):e.hasClass("multiselect-filter-widget")&&e.multiselect("instance")?(e.multiselect("refresh"),
...
h[1]));g.push("t="+d);d=g.join("&");f=f[0];d&&(f=f+"?"+d)}else f=e+"?t="+d;$(c).val(f)}}u(a,b)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){q(this)})):$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){q(this)})};S3.search.summary_maps=function(a){for(var b=$("#summary-common, #summary-sections").find(".map_wrapper"),c=0;c<b.length;c++){var d=b[c];if(!d.hidden){var e=
...
f,g=$("#"+c+b).val();for(f in a)if(a.hasOwnProperty(f))if(null===g)if(b===d)m(a[f]);else{var h=b+1;$("#"+c+h).length||h++;n(a[f],h)}else for(e in g)g[e]===f&&(b===d?m(a[f]):(h=b+1,$("#"+c+h).length||h++,n(a[f],h)))};n(k["L"+b],b);for(k=f;5>=k;k++){var p=$("#"+c+k);if(p.length){var q=a["options"+k];q.sort();var r="";for(var u in q)if(q.hasOwnProperty(u)){b=q[u];var t=h?l[b]||b:b;r+='<option value="'+b+'">'+t+"</option>"}p.html(r);if(p.hasClass("groupedopts-filter-widget")&&p.groupedopts("instance"))try{p.groupedopts("refresh")}catch(W){}else p.hasClass("multiselect-filter-widget")&&
p.multiselect("instance")&&p.multiselect("refresh");k===f&&(p.next("button").removeClass("hidden").show(),b=e.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),b.length&&(b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide())))))}}}}else{for(k=
d+1;5>=k;k++)if(p=$("#"+c+k),p.length)if(p.html(""),p.hasClass("groupedopts-filter-widget")&&p.groupedopts("instance"))try{p.groupedopts("refresh")}catch(W){}else p.hasClass("multiselect-filter-widget")&&p.multiselect("instance")&&p.multiselect("refresh");b=e.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=
b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide()))))}},t=function(a){S3.hideAlerts("warning");var b=a.attr("id"),d=a.find('input.filter-submit-url[type="hidden"]').val(),e=g(a);if(a.hasClass("filter-ajax")){a=a.find('input.filter-submit-target[type="hidden"]').val();c[b]={};a=a.split(" ");var f={},h;for(h=0;h<a.length;h++){var l=a[h];var n=$("#"+l);var p=n.is(":visible")?!0:!1;var q=!1;var r=null;n.hasClass("dataTable")?
(q=$("input#"+a[h]+"_configurations"),q.length&&(r=JSON.parse($(q).val()),r=r.ajaxUrl,r="undefined"!=typeof r?k(r,e):null),r?(f[a[h]]=r,q=!1):q=!0):n.hasClass("dl")||n.hasClass("map_wrapper")||n.hasClass("cms_content")||n.hasClass("gi-container")||n.hasClass("pt-container")||n.hasClass("tp-container")||n.hasClass("s3-target")||n.hasClass("s3-organizer")?q=!1:p?(d=k(d,e),window.location.href=d):q=!0;p||(c[b][l]={needs_reload:q,ajaxurl:r,queries:e})}for(h=0;h<a.length;h++)l=a[h],n=$("#"+l),n.is(":visible")&&
...
$(".filter-form").on("dataChanged",function(a,b,c){b&&(a=$(this).find("input.filter-submit-target").val())&&(a=a.split(" "),a.length&&-1!=$.inArray(b+"",a)&&S3.search.ajaxUpdateOptions(this,c));return!1});$(".filter-advanced").on("click",function(){w($(this).closest("form"))});$(".location-filter").on("change",function(){z(this)});$(".text-filter, .range-filter-input").on("input.autosubmit",function(){$(this).closest("form").trigger("optionChanged")});$(".options-filter, .location-filter, .date-filter-input, .age-filter-input, .map-filter, .value-filter").on("change.autosubmit",
...
moment(f);else g=moment().subtract(5,"minutes"),d.data("min",g.format());f=d.data("max");if(f)var h=moment(f);else h=moment().subtract(5,"minutes"),d.data("max",h.format());var k=d.parent().attr("id"),l=g.format("YYYY"),m=moment(g);f="";for(var n=[{year:l,months:[]}],p=0,q;h>m||m.format("M")===h.format("M");)q=m.format("YYYY"),q!=l&&(n.push({year:q,months:[]}),l=q,p++),n[p].months.push(m.format("MMM YYYY")),m.add(1,"month");for(p=0;p<n.length;p++){l=n[p];m=l.months;l=l.year;f+='<optgroup label="'+
...
var u=$("#"+k+" .play"),t=$("#"+k+" .pause"),w=$("#"+k+" .stop"),z=d.data("slots");3>z.length&&u.hide();var R,D,K,F=d.rangepicker({type:"double",startValue:g.format(e),endValue:h.format(e),translateSelectLabel:function(a,b){g=new Date(d.data("min"));h=new Date(d.data("max"));R=h-g;D=a/b*R;K=new Date(+g+parseInt(D));return moment(K).format(e)}});d.before('<div id="'+k+'-chart"><svg></svg></div>');var E=function(a){a=a.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+
...
t.removeClass("hide").show();w.removeClass("hide").show();z=d.data("slots");for(a;a<z.length;a++)c(a)});t.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());Z=0;t.hide();u.show()});w.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());d.data("slot",0);Z=0;t.hide();w.hide();u.show()})});$(".text-filter").keypress(function(a){return 13==a.which?(a.preventDefault(),!1):!0})})})();
...
_renderItem:function(a,c,f){var d=this.options.comment,e=this.multiple,k=b(a),m="s3-groupedopts-option-"+this.id+"-"+this.index,l=e?"checkbox":"radio";this.index+=1;a=k.val();var n=k.html(),p=k.attr("title");k=this.selected;var q='<label for="'+m+'"';p&&""!==p&&(q+=' title="'+p+'"');e||a==k||(q+=' class="inactive"');q+=">"+n+"</label>";m=b('<input type="'+l+'" id="'+m+'" name="'+this.name+'" class="s3-groupedopts-option" value="'+a+'"/>');0<=(e?b.inArray(a,k):a==k?1:-1)&&b(m).prop("checked",!0);f=
f?b("<td>").append(m).append(b(q)):b('<div class="s3-groupedopts-item">').append(m).append(b(q));d&&(_.templateSettings={interpolate:/\{(.+?)\}/g},d=_.template(d)({v:a}),f.append(b(d)));c.append(f)},_bindEvents:function(){var a=this;a.menu.find(".s3-groupedopts-option").click(function(){var c=b(this),d=c.val(),h=a.element,g=a.multiple,k=h.val();null===k&&g&&(k=[]);g?(g=b.inArray(d,k),c.is(":checked")?0>g&&k.push(d):0<=g&&k.splice(g,1)):c.is(":checked")&&(k=d,a.menu.find(".s3-groupedopts-option").each(function(){c=
...
"undefined"!=typeof l&&(k._id=l));e=a.fields;for(n=0;n<e.length;n++){var p=e[n].name;l="#sub_"+d+"_"+d+"_i_"+p+"_edit_"+c;var q=b(l);if(q.length)if(l=q.val(),"file"==q.attr("type")){l||!m||b("#"+d+"_i_"+p+"_edit_"+c+"__delete").prop("checked")||(l=m[p].value);q.clone().insertAfter(q);var u=b("#add-"+d+"-none").length||"none"!=c?f||c:"0";u="upload_"+d+"_"+p+"_"+u;b("#"+u).remove();var z=q.closest("form");q.css({display:"none"}).attr("id",u).attr("name",u).appendTo(z);l.match(/fakepath/)&&(l=l.replace(/(c:\\)*fakepath\\/i,
""))}else"checkbox"==q.attr("type")?l=q.prop("checked"):q.hasClass("s3-hierarchy-input")?l=l?JSON.parse(l):null:(q=q.attr("class"),"generic-widget"==q&&(q=parseInt(l,10),isNaN(q)||l!=""+q||(l=q)));else l=null!==m?m[p].value:a.defaults&&"undefined"!=typeof a.defaults[p]?a.defaults[p].value:"";k[p]=l}if(b("#read-row-"+d+"-"+c).hasClass("single")){c=!0;for(p in k)if("_id"!=p&&""!==k[p]){c=!1;break}c?b("#edit-row-"+d).hasClass("required")?(this._appendError(d,"0",p,i18n.enter_value),k._error=!0):k._delete=
!0:delete k._error}else{f=!1;if(b("#add-row-"+d).hasClass("required")||b("#edit-row-"+d).hasClass("required"))f=!0;if(f){delete k._error;f=!0;for(p in k)"_id"!=p&&""!==k[p]&&(f=!1);f&&(f="none","none"!=c&&(f="0"),b("#add-"+d+"-"+c).length?b("#read-row-"+d+"-0").length||(this._appendError(d,f,p,i18n.enter_value),k._error=!0):(this._appendError(d,f,p,i18n.enter_value),k._error=!0))}}a=a.defaults;for(p in a)k.hasOwnProperty(p)||(l=a[p].value,k[p]=l);return k},_validate:function(a,c,f){var d=this.formname,
