...
offset:c||d?{left:0,top:0}:b(a).offset(),scrollLeft:e.scrollLeft(),scrollTop:e.scrollTop(),width:e.outerWidth(),height:e.outerHeight()}}};b.fn.position=function(d){if(!d||!d.of)return n.apply(this,arguments);d=b.extend({},d);var l=b(d.of),p=b.position.getWithinInfo(d.within),z=b.position.getScrollInfo(p),t=(d.collision||"flip").split(" "),v={};var r=c(l);l[0].preventDefault&&(d.at="left top");var w=r.width;var B=r.height;var A=r.offset;var y=b.extend({},A);b.each(["my","at"],function(){var b=(d[this]||
...
g=b(this),k=g.outerWidth(),h=g.outerHeight(),n=parseInt(b.css(this,"marginLeft"),10)||0,m=parseInt(b.css(this,"marginTop"),10)||0,q=k+n+(parseInt(b.css(this,"marginRight"),10)||0)+z.width,u=h+m+(parseInt(b.css(this,"marginBottom"),10)||0)+z.height,r=b.extend({},y),L=a(v.my,g.outerWidth(),g.outerHeight());"right"===d.my[0]?r.left-=k:"center"===d.my[0]&&(r.left-=k/2);"bottom"===d.my[1]?r.top-=h:"center"===d.my[1]&&(r.top-=h/2);r.left+=L[0];r.top+=L[1];var V={marginLeft:n,marginTop:m};b.each(["left",
"top"],function(a,e){if(b.ui.position[t[a]])b.ui.position[t[a]][e](r,{targetWidth:w,targetHeight:B,elemWidth:k,elemHeight:h,collisionPosition:V,collisionWidth:q,collisionHeight:u,offset:[G[0]+L[0],G[1]+L[1]],my:d.my,at:d.at,within:p,elem:g})});d.using&&(c=function(b){var a=A.left-r.left,c=a+w-k,p=A.top-r.top,n=p+B-h,m={target:{element:l,left:A.left,top:A.top,width:w,height:B},element:{element:g,left:r.left,top:r.top,width:k,height:h},horizontal:0>c?"left":0<a?"right":"center",vertical:0>n?"top":0<
p?"bottom":"middle"};w<k&&f(a+c)<w&&(m.horizontal="center");B<h&&f(p+n)<B&&(m.vertical="middle");e(f(a),f(c))>e(f(p),f(n))?m.important="horizontal":m.important="vertical";d.using.call(this,b,m)});g.offset(b.extend(r,{using:c}))})};b.ui.position={fit:{left:function(b,a){var c=a.within,d=c.isWindow?c.scrollLeft:c.offset.left,g=c.width,f=b.left-a.collisionPosition.marginLeft;c=d-f;var k=f+a.collisionWidth-g-d;a.collisionWidth>g?0<c&&0>=k?(a=b.left+c+a.collisionWidth-g-d,b.left+=c-a):b.left=0<k&&0>=c?
...
"changeYear"),p=this._get(a,"showMonthAfterYear"),n="<div class='ui-datepicker-title'>",q="";if(f||!l)q+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=e&&e.getFullYear()===c;var m=d&&d.getFullYear()===c;q+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(g=0;12>g;g++)(!h||g>=e.getMonth())&&(!m||g<=d.getMonth())&&(q+="<option value='"+g+"'"+(g===b?" selected='selected'":"")+">"+u[g]+"</option>");q+="</select>"}p||(n+=q+(!f&&l&&k?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml=
...
m=d+a.helperProportions.height,l=b.offset.left,n=b.offset.top,p=l+b.proportions().width,q=n+b.proportions().height;switch(e){case "fit":return l<=c&&k<=p&&n<=d&&m<=q;case "intersect":return l<c+a.helperProportions.width/2&&k-a.helperProportions.width/2<p&&n<d+a.helperProportions.height/2&&m-a.helperProportions.height/2<q;case "pointer":a=f.pageY;e=b.proportions().height;if(n=a>=n&&a<n+e)f=f.pageX,b=b.proportions().width,n=f>=l&&f<l+b;return n;case "touch":return(d>=n&&d<=q||m>=n&&m<=q||d<n&&m>q)&&
(c>=l&&c<=p||k>=l&&k<=p||c<l&&k>p);default:return!1}}}();b.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(a,d){var c,f=b.ui.ddmanager.droppables[a.options.scope]||[],h=d?d.type:null,g=(a.currentItem||a.element).find(":data(ui-droppable)").addBack();var k=0;a:for(;k<f.length;k++)if(!(f[k].options.disabled||a&&!f[k].accept.call(f[k].element[0],a.currentItem||a.element))){for(c=0;c<g.length;c++)if(g[c]===f[k].element[0]){f[k].proportions().height=0;continue a}f[k].visible=
...
b(this).resizable("instance"),c=a.options,d=a.size,e=a.originalSize,f=a.originalPosition,h=a.axis,g="number"===typeof c.grid?[c.grid,c.grid]:c.grid,k=g[0]||1,m=g[1]||1,l=Math.round((d.width-e.width)/k)*k;d=Math.round((d.height-e.height)/m)*m;var n=e.width+l,p=e.height+d,q=c.maxWidth&&c.maxWidth<n,u=c.maxHeight&&c.maxHeight<p,z=c.minWidth&&c.minWidth>n,t=c.minHeight&&c.minHeight>p;c.grid=g;z&&(n+=k);t&&(p+=m);q&&(n-=k);u&&(p-=m);if(/^(se|s|e)$/.test(h))a.size.width=n,a.size.height=p;else if(/^(ne)$/.test(h))a.size.width=
n,a.size.height=p,a.position.top=f.top-d;else if(/^(sw)$/.test(h))a.size.width=n,a.size.height=p,a.position.left=f.left-l;else{if(0>=p-m||0>=n-k)var v=a._getPaddingPlusBorderDimensions(this);0<p-m?(a.size.height=p,a.position.top=f.top-d):(p=m-v.height,a.size.height=p,a.position.top=f.top+e.height-p);0<n-k?(a.size.width=n,a.position.left=f.left-l):(n=k-v.width,a.size.width=n,a.position.left=f.left+e.width-n)}}});return b.ui.resizable});
...
var n=1==this._get(a,"showMinutes"),p=this._get(a,"amPmText"),q=this._get(a,"rows"),u=0,z=0,t=e=0,v=0,r=0,w=[],B=this._get(a,"hours"),A=0;var y=this._get(a,"hourText");var G=this._get(a,"showCloseButton"),H=this._get(a,"closeButtonText"),C=this._get(a,"showNowButton"),U=this._get(a,"nowButtonText"),x=this._get(a,"showDeselectButton"),Y=this._get(a,"deselectButtonText"),aa=G||C||x;for(b=B.starts;b<=B.ends;b++)w.push(b);b=Math.ceil(w.length/q);if(d){for(A=0;A<w.length;A++)12>w[A]?e++:t++;A=0;u=Math.floor(e/
w.length*q);z=Math.floor(t/w.length*q);q!=u+z&&(e&&(!t||!u||z&&e/u>=t/z)?u++:z++);v=Math.min(u,1);r=u+1;b=0==u?Math.ceil(t/z):0==z?Math.ceil(e/u):Math.ceil(Math.max(e/u,t/z))}e='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(l){e+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+y+'</div><table class="ui-timepicker">';for(l=1;l<=q;l++){e+="<tr>";l==v&&d&&(e+='<th rowspan="'+u.toString()+'" class="periods" scope="row">'+
p[0]+"</th>");l==r&&d&&(e+='<th rowspan="'+z.toString()+'" class="periods" scope="row">'+p[1]+"</th>");for(y=1;y<=b;y++)d&&l<r&&12<=w[A]?e+=this._generateHTMLHourCell(a,void 0,c,m):(e+=this._generateHTMLHourCell(a,w[A],c,m),A++);e+="</tr>"}e+="</table></td>"}n&&(e=e+'<td class="ui-timepicker-minutes">'+this._generateHTMLMinutes(a),e+="</td>");e+="</tr>";aa&&(c='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">',C&&(c+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+
...
a.tpDiv.find("td.ui-timepicker-minutes").html(b);this._rebindDialogEvents(a)},_generateHTMLMinutes:function(a){var e,c="",d=this._get(a,"rows"),k=[];var m=this._get(a,"minutes");var l=null,n=0,p=1==this._get(a,"showMinutesLeadingZero"),q=this._get(a,"onMinuteShow"),u=this._get(a,"minuteText");m.starts||(m.starts=0);m.ends||(m.ends=59);m.manual||(m.manual=[]);for(e=m.starts;e<=m.ends;e+=m.interval)k.push(e);for(i=0;i<m.manual.length;i++)e=m.manual[i],"number"!=typeof e||0>e||59<e||0<=b.inArray(e,k)||
k.push(e);k.sort(function(a,b){return a-b});l=Math.round(k.length/d+.49);if(q&&0==q.apply(a.input?a.input[0]:null,[a.hours,a.minutes]))for(n=0;n<k.length;n+=1)if(e=k[n],q.apply(a.input?a.input[0]:null,[a.hours,e])){a.minutes=e;break}c+='<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+u+'</div><table class="ui-timepicker">';n=0;for(m=1;m<=d;m++){for(c+="<tr>";n<m*l;)e=k[n],q="",void 0!==e&&(q=10>e&&p?"0"+e.toString():e.toString()),c+=this._generateHTMLMinuteCell(a,
e,q),n++;c+="</tr>"}return c+"</table>"},_generateHTMLHourCell:function(a,b,c,d){var e=b;12<b&&c&&(e=b-12);0==e&&c&&(e=12);10>e&&d&&(e="0"+e);c=!0;d=this._get(a,"onHourShow");var f=this._get(a,"maxTime"),g=this._get(a,"minTime");if(void 0==b)return'<td><span class="ui-state-default ui-state-disabled">&nbsp;</span></td>';d&&(c=d.apply(a.input?a.input[0]:null,[b]));c&&(!isNaN(parseInt(f.hour))&&b>f.hour&&(c=!1),!isNaN(parseInt(g.hour))&&b<g.hour&&(c=!1));return c?'<td class="ui-timepicker-hour-cell" data-timepicker-instance-id="#'+
...
e.attr("id")}},_isDisabledTimepicker:function(a){if(!a)return!1;for(var b=0;b<this._disabledInputs.length;b++)if(this._disabledInputs[b]==a)return!0;return!1},_checkOffset:function(a,c,d){var e=a.tpDiv.outerWidth(),f=a.tpDiv.outerHeight(),h=a.input?a.input.outerWidth():0,l=a.input?a.input.outerHeight():0,n=document.documentElement.clientWidth+b(document).scrollLeft(),p=document.documentElement.clientHeight+b(document).scrollTop();c.left-=this._get(a,"isRTL")?e-h:0;c.left-=d&&c.left==a.input.offset().left?
b(document).scrollLeft():0;c.top-=d&&c.top==a.input.offset().top+l?b(document).scrollTop():0;c.left-=Math.min(c.left,c.left+e>n&&n>e?Math.abs(c.left+e-n):0);c.top-=Math.min(c.top,c.top+f>p&&p>f?Math.abs(f+l):0);return c},_findPos:function(a){var c=this._getInst(a);for(c=this._get(c,"isRTL");a&&("hidden"==a.type||1!=a.nodeType);)a=a[c?"previousSibling":"nextSibling"];a=b(a).offset();return[a.left,a.top]},_getBorders:function(a){var b=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(b(a.css("border-left-width"))),
...
null,[b,a]);this._updateAlternate(a,b);return b},_getParsedTime:function(a){if(-1==a.hours&&-1==a.minutes)return"";if(a.hours<a.hours.starts||a.hours>a.hours.ends)a.hours=0;if(a.minutes<a.minutes.starts||a.minutes>a.minutes.ends)a.minutes=0;var b="",c=1==this._get(a,"showPeriod"),e=1==this._get(a,"showLeadingZero"),d=1==this._get(a,"showHours"),m=1==this._get(a,"showMinutes"),l=1==this._get(a,"optionalMinutes"),n=this._get(a,"amPmText"),p=a.hours?a.hours:0,q=a.minutes?a.minutes:0,u=p?p:0;p="";-1==
u&&(u=0);-1==q&&(q=0);c&&(0==a.hours&&(u=12),12>a.hours?b=n[0]:(b=n[1],12<u&&(u-=12)));c=u.toString();e&&10>u&&(c="0"+c);e=q.toString();10>q&&(e="0"+e);d&&(p+=c);!d||!m||l&&0==e||(p+=this._get(a,"timeSeparator"));!m||l&&0==e||(p+=e);d&&0<b.length&&(p+=this._get(a,"periodSeparator")+b);return p},_updateAlternate:function(a,c){(a=this._get(a,"altField"))&&b(a).each(function(a,e){b(e).val(c)})},_getTimeAsDateTimepicker:function(a){a=this._getInst(a);if(-1==a.hours&&-1==a.minutes)return"";if(a.hours<
...
try{var d=k(c,this._defaults.timeFormat,a,b.datepicker._getFormatConfig(this.inst),this._defaults);if(!d.timeObj)return!1;b.extend(this,d.timeObj)}catch(q){return b.timepicker.log("Error parsing the date/time string: "+q+"\ndate/time string = "+a+"\ntimeFormat = "+this._defaults.timeFormat+"\ndateFormat = "+c),!1}}else{a=b.datepicker.parseTime(this._defaults.timeFormat,a,this._defaults);if(!a)return!1;b.extend(this,a)}return!0},_injectTimePicker:function(){var a=this.inst.dpDiv,c=this.inst.settings,
...
" ")+this.className;if("OPTGROUP"===c.tagName){var y=c.getAttribute("label");-1===b.inArray(y,m)&&(l+='<li class="ui-multiselect-optgroup-label '+c.className+'"><a href="#">'+y+"</a></li>",m.push(y))}h&&q.push("ui-state-disabled");k&&!d.multiple&&q.push("ui-state-active");l+='<li class="'+p+'">';l+='<label for="'+a+'" title="'+f+'" class="'+q.join(" ")+'">';l+='<input id="'+a+'" name="multiselect_'+n+'" type="'+(d.multiple?"checkbox":"radio")+'" value="'+g+'" title="'+f+'"';k&&(l+=' checked="checked"',
l+=' aria-selected="true"');h&&(l+=' disabled="disabled"',l+=' aria-disabled="true"');l+=" /><span>"+e+"</span></label></li>"});if(!b.isEmptyObject(d.create)){var p=d.create;e=S3.Ap.concat("/",p.c,"/",p.f,"/create?format=popup&caller=",n);p.parent&&(e+="&parent="+p.parent);p.child&&(e+="&child="+p.child);p=p.label;l+='<li><a class="s3_modal" target="top" title="'+p+'" href="'+e+'"><label class="ui-corner-all"><span><i>'+p+"</i></span></label></a></li>"}k.html(l);b.isEmptyObject(d.create)||S3.addModals();
...
c.push('<option value="">'+(b.msgNoRecords||"-")+"</option>");else{var d=b.fncPrep,f=null;if(d)try{f=d(a)}catch(r){}d=b.lookupField||"id";for(var g=b.fncRepresent,h,k,t,v=0;v<a.length;v++)h=a[v],k=h[d],0===v&&(e=k),t=g?g(h,f):h.name,h=h._tooltip?' title="'+h._tooltip+'"':"",c.push("<option"+h+' value="'+k+'">'+t+"</option>");b.optional&&(e=0,c.unshift('<option value=""></option>'))}return{options:c.join(""),defaultValue:e}},f=function(b,f,h,l,n){var g=!1;if(1<b.length)if("checkbox"==b.first().attr("type")){if(b.first().closest(".checkboxes-widget-s3")){s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, skipping");
...
var e=a.lookupKey||c,d=b(a.trigger),g=b(a.target);if(g){var p=$(g);if(p.length){var q=p.closest("form");if(d&&(p=q.find(d),p.length)){$(d).each(function(){var b=$(this);var c=b.closest(".inline-form");if(!c.length||!c.hasClass("empty-row")&&"none"!=c.css("display"))c="row"==a.scope?b.closest(".edit-row.inline-form,.add-row.inline-form"):q,b=h(b),c=c.find(g),f(c,e,b[1],a,!1)});var u="triggerUpdate."+c;q.undelegate(d,"change.s3options").delegate(d,"change.s3options",function(){var a=h($(this));q.trigger(u,
a)});q.on(u,function(b,c,d){b=("row"==a.scope?c.closest(".edit-row.inline-form,.add-row.inline-form"):q).find(g);f(b,e,d,a,!0)})}}}}})(jQuery);(function(){$.cancelButtonS3=function(b){var a=$(".s3-cancel");if(a.length){var c=document.referrer;if(c&&c.split("?")[0].split("#")[0]!=document.URL.split("?")[0].split("#")[0]){var d=document.createElement("a");d.href=c;d.host==window.location.host&&0===d.pathname.lastIndexOf(S3.Ap,0)?a.attr("href",c):b?a.attr("href",b):a.hide()}else b?a.attr("href",b):a.hide()}}})(jQuery);
...
textStatus:b,xhr:e});Y=x.ajaxProcess.call(z,a);"object"==typeof Y&&null!==Y&&(T=Y.title,Y=Y.content);aa&&(H&&H.call(z,a,b,t,w),w.html(Y))},complete:function(c,d){C&&C.call(z,c,d,t,w);var f=w[0].getElementsByTagName("img");e=f.length;c=0;for(d=f.length;c<d;c++)f[c].complete&&e--;e&&!b.browser.opera?b(f).bind("load.ct error.ct",function(){e--;0===e&&(a.hide(),b(f).unbind(".ct"),aa&&da(l))}):(a.hide(),aa&&da(l))}});c[v]?u(c[v],k):b.ajax(k)}},da=function(a){var c=T||x.showTitle&&"&nbsp;";var e="";var d=
...
c});x.arrows?(/(left|right)/.test(d)&&(d=t.height()-m.height(),e=0<=I&&0<a?F-E-x.dropShadowSteps:0,e=(d>e?e:d)+"px"),m.css({top:e}).show()):m.hide();(l=k(t,x))&&l.length&&l.hide().css({height:W,width:X,zIndex:y.data("cluetip").zIndex-1}).show();t.hide()[x.fx.open](x.fx.openSpeed||0);b.fn.bgiframe&&t.bgiframe();0<x.delayedClose&&(fa=setTimeout(ea,x.delayedClose));x.onShow.call(z,t,w)},ia=function(b){aa=!1;a.hide();if(!x.sticky||/click|toggle/.test(x.activation))ea(),clearTimeout(fa);x.hoverClass&&
y.removeClass(x.hoverClass)},ea=function(a){a=a&&a.data("cluetip")?a:y;var c=a.data("cluetip")&&a.data("cluetip").selector,e=b(c||"div.cluetip"),d=e.find(q+"cluetip-inner"),f=e.find(q+"cluetip-arrows");e.hide().removeClass();x.onHide.call(a[0],e,d);c&&(a.removeClass("cluetip-clicked"),a.css("cursor",""));c&&T&&a.attrProp(x.titleAttribute,T);x.arrows&&f.css({top:""})};b(document).unbind("hideCluetip.cluetip").bind("hideCluetip.cluetip",function(a){ea(b(a.target))});if(/click|toggle/.test(x.activation))y.bind("click.cluetip",
...
"")&&b(this).html("");a.editing=!0;a.revert=b(a).html();b(a).html("");var q=b("<form />");d.cssclass&&("inherit"==d.cssclass?q.attr("class",b(a).attr("class")):q.attr("class",d.cssclass));d.style&&("inherit"==d.style?(q.attr("style",b(a).attr("style")),q.css("display",b(a).css("display"))):q.attr("style",d.style));var B=k.apply(q,[d,a]);if(d.loadurl){var A=setTimeout(function(){B.disabled=!0;g.apply(q,[d.loadtext,d,a])},100);r={};r[d.id]=a.id;b.isFunction(d.loaddata)?b.extend(r,d.loaddata.apply(a,
[a.revert,d])):b.extend(r,d.loaddata);b.ajax({type:d.loadtype,url:d.loadurl,data:r,async:!1,success:function(a){window.clearTimeout(A);y=a;B.disabled=!1}})}else if(d.data){var y=d.data;b.isFunction(d.data)&&(y=d.data.apply(a,[a.revert,d]))}else y=a.revert;g.apply(q,[y,d,a]);B.attr("name",d.name);h.apply(q,[d,a]);b(a).append(q);e.apply(q,[d,a]);b(":input:visible:enabled:first",q).focus();d.select&&B.select();B.keydown(function(b){27==b.keyCode&&(b.preventDefault(),m.apply(q,[d,a]))});"cancel"==d.onblur?
B.blur(function(b){A=setTimeout(function(){m.apply(q,[d,a])},500)}):"submit"==d.onblur?B.blur(function(a){A=setTimeout(function(){q.submit()},200)}):b.isFunction(d.onblur)?B.blur(function(b){d.onblur.apply(a,[B.val(),d])}):B.blur(function(a){});q.submit(function(c){A&&clearTimeout(A);c.preventDefault();if(!1!==p.apply(q,[d,a])&&!1!==f.apply(q,[d,a]))if(b.isFunction(d.target))c=d.target.apply(a,[B.val(),d]),b(a).html(c),a.editing=!1,l.apply(a,[a.innerHTML,d]),b.trim(b(a).html())||b(a).html(d.placeholder);
else{c={};c[d.name]=B.val();c[d.id]=a.id;b.isFunction(d.submitdata)?b.extend(c,d.submitdata.apply(a,[a.revert,d])):b.extend(c,d.submitdata);"PUT"==d.method&&(c._method="put");b(a).html(d.indicator);var e={type:"POST",data:c,dataType:"html",url:d.target,success:function(c,f){"html"==e.dataType&&b(a).html(c);a.editing=!1;l.apply(a,[c,d]);b.trim(b(a).html())||b(a).html(d.placeholder)},error:function(b,c,e){u.apply(q,[d,a,b])}};b.extend(e,d.ajaxoptions);b.ajax(e)}b(a).attr("title",d.tooltip);return!1})}});
this.reset=function(c){this.editing&&!1!==q.apply(c,[d,a])&&(b(a).html(a.revert),a.editing=!1,b.trim(b(a).html())||b(a).html(d.placeholder),d.tooltip&&b(a).attr("title",d.tooltip))}})}};b.editable={types:{defaults:{element:function(a,c){a=b('<input type="hidden"></input>');b(this).append(a);return a},content:function(a,c,d){b(":input:first",this).val(a)},reset:function(a,b){b.reset(this)},buttons:function(a,c){var d=this;if(a.submit){if(a.submit.match(/>$/))var e=b(a.submit).click(function(){"submit"!=
...
(function(){S3.autocomplete={};S3.autocomplete.normal=function(a,b,e,f,h,g,k,m,l){var c="dummy_"+f,d=$("#"+c);if(d.length){b=S3.Ap.concat("/",b,"/",e,"/search_ac.json?field=",a);h&&(b+="&"+h);g&&(b+="&link="+g);var q=$("#"+f);q.hide();if(f=q.val())var u={value:f,label:d.val()};q.data("existing",u);q.data("url",b);q.parent().hasClass("controls")?q.next().find(".s3_add_resource_link"):q.parent().next().find(".s3_add_resource_link");var z=$("#"+c+"_throbber");void 0==m&&(m=800);void 0==l&&(l=2);d.val();
d.autocomplete({delay:m,minLength:l,source:function(b,c){$.ajax({url:q.data("url"),data:{term:b.term}}).done(function(b){if(0==b.length){q.val("").change();var e={id:0};e[a]=i18n.no_matching_records}else e={id:0},e[a]=i18n.none_of_the_above;b.push(e);c(b)})},search:function(a,b){z.removeClass("hide").show();return!0},response:function(a,b,c){z.hide();return c},focus:function(a,b){return!1},select:function(b,c){b=c.item;b.id?(d.val(b[a]),q.val(b.id).change(),u={value:b.id,label:b[a]}):(d.val(""),q.val("").change());
k&&eval(k);return!1}}).data("ui-autocomplete")._renderItem=function(b,c){var e=c.label?c.label:c[a];return $("<li>").data("item.autocomplete",c).append("<a>"+e+"</a>").appendTo(b)};d.blur(function(){u&&u.label!=d.val()&&q.val("").change()})}};S3.autocomplete.generic=function(a,b,e,f,h){var c="dummy_"+b,d=$("#"+c);if(d.length){var m=$("#"+b);m.hide();if(b=m.val())var l={value:b,name:d.val()};m.data("existing",l);m.data("url",a);m.parent().hasClass("controls")?m.next().find(".s3_add_resource_link"):
...
function(a,b,e,f,h){var c="dummy_"+a,d=$("#"+c);if(d.length){var m=S3.Ap.concat("/gis/location/search_ac.json"),l=$("#"+a);l.hide();if(a=l.val())var n={value:a,name:d.val()};l.data("existing",n);l.data("url",m);l.parent().hasClass("controls")?l.next().find(".s3_add_resource_link"):l.parent().next().find(".s3_add_resource_link");var p=$("#"+c+"_throbber");b&&(m+="?level="+b);void 0==f&&(f=800);void 0==e&&(e=2);d.autocomplete({delay:f,minLength:e,source:function(a,b){$.ajax({url:l.data("url"),data:{term:a.term}}).done(function(a){0==
a.length?(l.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){p.removeClass("hide").show();return!0},response:function(a,b,c){p.hide();return c},focus:function(a,b){return!1},select:function(a,b){a=b.item;a.id?(d.val(b.item.name),l.val(a.id).change(),n={value:a.id,name:b.item.name}):(d.val(""),l.val("").change());h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(a,b){if(void 0!=
...
function(b){return void 0!=b.label?b.label:b.org||b.job?a(b):b.name};S3.autocomplete.person=function(a,d,e,f,h,g,k){var c="dummy_"+e,l=$("#"+c);if(l.length){a=S3.Ap.concat("/",a,"/",d,"/search_ac.json");f&&(a+="?"+f);var n=$("#"+e);n.hide();if(e=n.val())var p={value:e,name:l.val()};n.data("existing",p);n.data("url",a);n.parent().hasClass("controls")?n.next().find(".s3_add_resource_link"):n.parent().next().find(".s3_add_resource_link");var q=$("#"+c+"_throbber");void 0==g&&(g=800);void 0==k&&(k=2);
l.autocomplete({delay:g,minLength:k,source:function(a,b){$.ajax({url:n.data("url"),data:{term:a.term}}).done(function(a){0==a.length?(n.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){q.removeClass("hide").show();return!0},response:function(a,b,c){q.hide();return c},focus:function(a,b){return!1},select:function(a,c){a=c.item;a.id?(c=b(a),l.val(c),n.val(a.id).change(),p={value:a.id,name:c}):(l.val(""),
n.val("").change());h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(a,c){var e=b(c);return $("<li>").data("item.autocomplete",c).append("<a>"+e+"</a>").appendTo(a)};l.blur(function(){p&&p.name!=l.val()&&n.val("").change()})}};S3.autocomplete.pentity=function(a,b,e,f,h,g,k){var c="dummy_"+e,d=$("#"+c);if(d.length){var n=S3.Ap.concat("/",a,"/",b,"/search_ac.json"),p=$("#"+e);p.hide();if(a=p.val())var q={value:a,name:d.val()};p.data("existing",q);p.data("url",n);p.parent().hasClass("controls")?
p.next().find(".s3_add_resource_link"):p.parent().next().find(".s3_add_resource_link");var u=$("#"+c+"_throbber");void 0==h&&(h=800);void 0==g&&(g=2);d.autocomplete({delay:h,minLength:g,source:function(a,b){n=p.data("url");k&&(n+="?types="+k);$.ajax({url:n,data:{term:a.term}}).done(function(a){0==a.length?(p.val("").change(),a.push({id:0,value:"",label:i18n.no_matching_records})):a.push({id:0,value:"",label:i18n.none_of_the_above});b(a)})},search:function(a,b){u.removeClass("hide").show();return!0},
response:function(a,b,c){u.hide();return c},focus:function(a,b){return!1},select:function(a,b){a=b.item;a.id?(d.val(a.name),p.val(a.id).change(),q={value:a.id,name:a.name}):(d.val(""),p.val("").change());f&&eval(f);return!1}}).data("ui-autocomplete")._renderItem=function(a,b){var c=b.label?b.label:b.name;return $("<li>").data("item.autocomplete",b).append("<a>"+c+"</a>").appendTo(a)};d.blur(function(){q&&q.name!=d.val()&&p.val("").change()})}};var a=function(a){if(void 0!=a.label)return a.label;var b=
...
g.multiselect("instance")&&g.multiselect("refresh"),z(this))}});a.find(".hierarchy-filter:visible").each(function(){g=$(this);c=g.attr("id");n=$("#"+c+"-data").val();d.hasOwnProperty(n)&&(g.is(":visible")||g.hasClass("active")||v(a),r=d[n],g.hasClass("s3-cascade-select")?g.cascadeSelect("set",r):g.hierarchicalopts("set",r))});a.data("noAutoSubmit",0);a.trigger("optionChanged")};var k=function(a,b){void 0===b&&(b=g());a=a.split("?");var c={},e={},d;var f=0;for(d=b.length;f<d;f++){var h=b[f];var k=
h[0];h=h[1];null===h?c.hasOwnProperty(k)||(e[k]=!0):(e.hasOwnProperty(k)&&(e[k]=!1),c[k]=!0)}var l=[];if(1!=S3.search.stripFilters&&1<a.length){var m=a[1].split("&");f=0;for(d=m.length;f<d;f++)h=m[f].split("="),1<h.length&&(k=decodeURIComponent(h[0]),e[k]||c[k]||l.push(m[f]))}f=0;for(d=b.length;f<d;f++)h=b[f],k=h[0],h=h[1],c[k]&&l.push(k+"="+encodeURIComponent(h));b=l.join("&");a=a[0];b&&(a=a+"?"+b);return a};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(a,b){var c=$(a);a=c.find("input.filter-ajax-url");
a.length&&(a=$(a[0]).val());$.ajax({url:a,dataType:"json"}).done(function(a){c.data("noAutoSubmit",1);for(var e in a){var d=$("#"+e);if(d.length){var f=a[e];if(d.hasClass("options-filter")){if("select"==d[0].tagName.toLowerCase()){var g=d.siblings(".no-options-available");if(f.hasOwnProperty("empty"))d.html(""),d.hasClass("multiselect-filter-widget")&&d.multiselect("instance")?(d.multiselect("refresh"),d.multiselect("instance").button.hide()):d.hasClass("groupedopts-filter-widget")&&d.groupedopts("instance")?
d.groupedopts("refresh"):d.hide(),g.length&&(g.html(f.empty),g.removeClass("hide").show());else{var h=d.val(),k=[],l="",m;if(f.hasOwnProperty("groups")){var n=0;for(m=f.groups.length;n<m;n++){var r=f.groups[n];r.label&&(l+='<optgroup label="'+r.label+'">');for(var p=0,q=r.items.length;p<q;p++){var w=r.items[p];var A=w[0].toString();h&&0<=$.inArray(A,h)&&k.push(A);l+='<option value="'+A+'"';(A=w[3])&&(l+=' title="'+A+'"');w=w[1];l+=">"+w+"</option>"}r.label&&(l+="</optgroup>")}}else for(n=0,m=f.length;n<
m;n++)w=f[n],A=w[0],A=null===A?"None":A.toString(),w=w[1],h&&0<=$.inArray(A,h)&&k.push(A),l+='<option value="'+A+'">'+w+"</option>";d.html(l);k&&d.val(k);g.length&&g.hide();d.hasClass("groupedopts-filter-widget")&&d.groupedopts("instance")?d.groupedopts("refresh"):d.hasClass("multiselect-filter-widget")&&d.multiselect("instance")?(d.multiselect("refresh"),d.multiselect("instance").button.show()):d.removeClass("hide").show()}}}else d.hasClass("date-filter")&&(g=f.min,h=f.max,$("#"+e+"-ge").calendarWidget("instance").option("minDateTime",
g).option("maxDateTime",h).refresh(),$("#"+e+"-le").calendarWidget("instance").option("minDateTime",g).option("maxDateTime",h).refresh(),d.find(".range-picker").trigger("resize",[g,h,f.ts]))}}c.data("noAutoSubmit",0);b&&b.apply()}).fail(function(a,b,c){console.log("UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText)})};var m=function(a,b){$("#"+a[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var a=$(this),c=a.data("url");c&&a.data("url",k(c,b))})},l=function(a){var b=$("#"+
...
S3.gis.refreshLayer("search_results",l.queries):f.hasClass("gi-container")?f.groupedItems("reload",null,l.queries):f.hasClass("pt-container")?f.pivottable("reload",null,l.queries):f.hasClass("tp-container")?f.timeplot("reload",null,l.queries):f.hasClass("s3-organizer")&&f.organizer("reload"))};S3.search.filterFormAutoSubmit=function(a,b){a=$("#"+a);if(a.length&&b)a.on("optionChanged",function(){var a=$(this);if(!a.data("noAutoSubmit")){var c=a.data("autoSubmitTimeout");c&&clearTimeout(c);c=setTimeout(function(){t(a)},
b);a.data("autoSubmitTimeout",c)}})};var n=function(){var a=new jQuery.Deferred;setTimeout(function B(){void 0!=S3.gis.maps?a.resolve("loaded"):"pending"===a.state()&&(a.notify("waiting for JS to load..."),setTimeout(B,500))},1);return a.promise()},p=function(a,b,d){void 0===d&&(d=g($("#"+a)));c.hasOwnProperty(a)||(c[a]={});if(!c[a].hasOwnProperty(b)){var e=$("#"+b);if(e.hasClass("dl")||e.hasClass("gi-container")||e.hasClass("pt-container")||e.hasClass("tp-container")||e.hasClass("map_wrapper")||
e.hasClass("s3-organizer"))var f=null;else if(e.hasClass("dataTable")){if(e=$("input#"+b+"_configurations"),e.length)if(f=JSON.parse($(e).val()).ajaxUrl,"undefined"!=typeof f)f=k(f,d);else return}else return;c[a][b]={needs_reload:!1,ajaxurl:f,queries:d}}};S3.search.setup_hidden_widget=p;var q=function(a){a=$(a);if(a.hasClass("responsive"))(a=a.DataTable())&&a.responsive&&a.responsive.recalc();else if(a.hasClass("doublescroll"))try{a.dataTableS3("doubleScroll")}catch(w){}},u=function(a,b){var c=b.find(".map_wrapper"),
e=c.length;e?$.when(n()).then(function(){for(var b=S3.gis,d=0;d<e;d++){var f=c[d].attributes.id.value;void 0===b.maps[f]&&b.show_map(f,b.options[f])}l(a)},function(a){s3_debug(a)},function(a){s3_debug(a)}):l(a);b.find("table.dataTable.display").each(function(){q(this)})};S3.search.unhide_section=u;S3.search.summary_tabs=function(a,b,c){if(c)for(var e=g($("#"+a)),d=c.split(","),f=0,h=d.length;f<h;f++)c=d[f],p(a,c,e);void 0!=b?($("#summary-tabs").tabs({active:b,activate:function(b,c){b=$(c.newPanel);
b.removeClass("hide");if(c.newTab.length){var e=$(c.newTab).index();c=$("#"+a).find('input.filter-submit-url[type="hidden"]');if(c.length){c=c.first();var d=$(c).val(),f=d.split("?"),g=[];if(1<f.length){d=f[1].split("&");for(var h,k,l=0;l<d.length;l++)h=d[l].split("="),1<h.length&&(k=decodeURIComponent(h[0]),"t"!=k&&g.push(h[0]+"="+h[1]));g.push("t="+e);e=g.join("&");f=f[0];e&&(f=f+"?"+e)}else f=d+"?t="+e;$(c).val(f)}}u(a,b)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){q(this)})):
$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){q(this)})};S3.search.summary_maps=function(a){for(var b=$("#summary-common, #summary-sections").find(".map_wrapper"),c=0;c<b.length;c++){var e=b[c];if(!e.hidden){var d=S3.gis;e=e.attributes.id.value;if(void 0===d.maps[e]){var f=d.options[e];void 0!=f&&(d.show_map(e,f),e=g($("#"+a)),d.refreshLayer("search_results",e))}}}};S3.search.s3map=function(a){var b=S3.gis;void 0===a&&(a="default_map");b.show_map(a,
b.options[a]);a=g();b.refreshLayer("search_results",a)};var z=function(a){var b=a.name,c=b.slice(0,-1),e=parseInt(b.slice(-1)),d=$("#"+b);if(d.val()){var f=e+1,g=c+f,h=$("#"+g);h.length||(f=e+2,g=c+f,h=$("#"+g));if(h.length){var k=g.replace(/-/g,"_");S3[k]();h.next(".ui-multiselect").show();k=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){h=!0;var l=S3.location_name_l10n}else h=!1;a.options1=[];a.options2=[];a.options3=[];a.options4=[];a.options5=[];for(b=e;0<=b&&!k.hasOwnProperty("L"+
b);b--);var m=function(b){var e,d;for(e in b)if(b.hasOwnProperty(e)){e&&"null"!=e&&a["options"+f].push(e);var h=b[e];if("object"===typeof h&&(g=f+1,$("#"+c+g).length||(g=f+2),$("#"+c+g).length))for(d in h)h.hasOwnProperty(d)&&d&&"null"!=d&&a["options"+g].push(d)}},n=function(a,b){var d,f,g=$("#"+c+b).val();for(f in a)if(a.hasOwnProperty(f))if(null===g)if(b===e)m(a[f]);else{var h=b+1;$("#"+c+h).length||h++;n(a[f],h)}else for(d in g)g[d]===f&&(b===e?m(a[f]):(h=b+1,$("#"+c+h).length||h++,n(a[f],h)))};
n(k["L"+b],b);for(k=f;5>=k;k++){var p=$("#"+c+k);if(p.length){var q=a["options"+k];q.sort();var r="";for(var u in q)if(q.hasOwnProperty(u)){b=q[u];var t=h?l[b]||b:b;r+='<option value="'+b+'">'+t+"</option>"}p.html(r);if(p.hasClass("groupedopts-filter-widget")&&p.groupedopts("instance"))try{p.groupedopts("refresh")}catch(W){}else p.hasClass("multiselect-filter-widget")&&p.multiselect("instance")&&p.multiselect("refresh");k===f&&(p.next("button").removeClass("hidden").show(),b=d.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),
b.length&&(b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide())))))}}}}else{for(k=e+1;5>=k;k++)if(p=$("#"+c+k),p.length)if(p.html(""),p.hasClass("groupedopts-filter-widget")&&p.groupedopts("instance"))try{p.groupedopts("refresh")}catch(W){}else p.hasClass("multiselect-filter-widget")&&
p.multiselect("instance")&&p.multiselect("refresh");b=d.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&(b.hide(),b=b.next(".location-filter").next(".ui-multiselect"),b.length&&b.hide()))))}},t=function(a){S3.hideAlerts("warning");var b=a.attr("id"),
e=a.find('input.filter-submit-url[type="hidden"]').val(),d=g(a);if(a.hasClass("filter-ajax")){a=a.find('input.filter-submit-target[type="hidden"]').val();c[b]={};a=a.split(" ");var f={},h;for(h=0;h<a.length;h++){var l=a[h];var n=$("#"+l);var p=n.is(":visible")?!0:!1;var q=!1;var r=null;n.hasClass("dataTable")?(q=$("input#"+a[h]+"_configurations"),q.length&&(r=JSON.parse($(q).val()),r=r.ajaxUrl,r="undefined"!=typeof r?k(r,d):null),r?(f[a[h]]=r,q=!1):q=!0):n.hasClass("dl")||n.hasClass("map_wrapper")||
n.hasClass("cms_content")||n.hasClass("gi-container")||n.hasClass("pt-container")||n.hasClass("tp-container")||n.hasClass("s3-target")||n.hasClass("s3-organizer")?q=!1:p?(e=k(e,d),window.location.href=e):q=!0;p||(c[b][l]={needs_reload:q,ajaxurl:r,queries:d})}for(h=0;h<a.length;h++)l=a[h],n=$("#"+l),n.is(":visible")&&(n.hasClass("dataTable")?(b=n.dataTable(),l=f[l],b.fnReloadAjax(l),m(b,d),$("#"+b[0].id+"_dataTable_filterURL").val(l)):n.hasClass("dl")?n.datalist("ajaxReload",d):n.hasClass("map_wrapper")?
S3.gis.refreshLayer("search_results",d):n.hasClass("gi-container")?n.groupedItems("reload",null,d):n.hasClass("pt-container")?n.pivottable("reload",null,d):n.hasClass("tp-container")?n.timeplot("reload",null,d):n.hasClass("s3-target")?n.s3Target("reload",k(e,d)):n.hasClass("s3-organizer")&&n.organizer("reload"))}else e=k(e,d),window.location.href=e},v=function(a){a=$(a);var b;a.find(".advanced").each(function(){var a=$(this);a.hasClass("hide")?(a.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var a=
...
$(".filter-clear").click(function(){var a=$(this).closest(".filter-form");f(a)});$(".show-filter-manager").click(function(){$(".filter-manager-row").removeClass("hide").show();$(".show-filter-manager").hide()});$(".filter-submit").click(function(){t($(this).closest(".filter-form"))});$(".filter-form").on("dataChanged",function(a,b,c){b&&(a=$(this).find("input.filter-submit-target").val())&&(a=a.split(" "),a.length&&-1!=$.inArray(b+"",a)&&S3.search.ajaxUpdateOptions(this,c));return!1});$(".filter-advanced").on("click",
...
$(".hierarchy-filter").on("select.s3hierarchy",function(){$(this).closest("form").trigger("optionChanged")});$(".map-filter").each(function(){var a=$(this);$.when(n()).then(function(){var b=a.attr("id"),c=$("#"+b),e,d=S3.gis,f=d.maps[b+"-map"],g=f.s3;g.pointPlaced=function(a){var b={internalProjection:f.getProjectionObject(),externalProjection:d.proj4326};e=(new OpenLayers.Format.WKT(b)).write(a);c.val('"'+e+'"').trigger("change")};g.polygonButtonOff=function(){c.val("").trigger("change")};g.layerRefreshed=
function(){var a=g.polygonButton;a&&"drawpolygonclear-off"==a.getIconClass()&&(g.lastDraftFeature?g.lastDraftFeature.destroy():1<g.draftLayer.features.length&&g.draftLayer.features[0].destroy(),a.control.deactivate(),a.items[0].pressed=!0)};g.polygonButtonLoaded=function(){if(e=c.val()){g.polygonButton.items[0].btnEl.dom.click();var a=OpenLayers.Geometry.fromWKT(e);a.transform(d.proj4326,f.getProjectionObject());a=new OpenLayers.Feature.Vector(a,{},null);var b=g.draftLayer;b.addFeatures([a]);g.lastDraftFeature=
a;f.zoomToExtent(b.getDataExtent())}};g.polygonButtonLoaded()},function(a){s3_debug(a)},function(a){s3_debug(a)})});$(".date-filter").find(".range-picker").each(function(){function a(){for(var a,b,c=[],d=e.data("ts"),f=0;f<d.length;f++)a=d[f],b=moment(a[0]),c.push({x:b,y:a[1]});e.data("slots",c);return[{values:c,key:"",color:"#3b6596",area:!0}]}function b(){Q=O.val();M=S.val();g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;Q?(I=moment(Q,d),D=I-g,Q=D/R*100+"%"):Q="0%";M?(J=moment(M,d),D=
J-g,M=D/R*100+"%"):M="100%";F.updatePosition(M,Q)}function c(a){var b=z[a].x;try{var c=z[a+1].x}catch(ea){c=moment(e.data("max"))}var f=Z;Z+=4E3;f=setTimeout(function(){var f=c;e.data("slot",a);O.val(b.format(d));S.val(f.format(d));O.trigger("change")},f);T.push(f)}var e=$(this),d=e.data("fmt"),f=e.data("min");if(f)var g=moment(f);else g=moment().subtract(5,"minutes"),e.data("min",g.format());f=e.data("max");if(f)var h=moment(f);else h=moment().subtract(5,"minutes"),e.data("max",h.format());var k=
e.parent().attr("id"),l=g.format("YYYY"),m=moment(g);f="";for(var n=[{year:l,months:[]}],p=0,q;h>m||m.format("M")===h.format("M");)q=m.format("YYYY"),q!=l&&(n.push({year:q,months:[]}),l=q,p++),n[p].months.push(m.format("MMM YYYY")),m.add(1,"month");for(p=0;p<n.length;p++){l=n[p];m=l.months;l=l.year;f+='<optgroup label="'+l+'">';for(l=0;l<m.length;l++)f+='<option value="'+m[l]+'">'+m[l]+"</option>";f+="</optgroup>"}e.before('<div class="range-coarse"><div class="range-coarse-start"><label for="'+k+
'-cs">From:</label><select id="'+k+'-cs">'+f+'</select></div><div class="range-coarse-end"><label for="'+k+'-ce">to:</label><select id="'+k+'-ce">'+f+"</select></div></div>");f=$("#"+k+"-cs");n=$("#"+k+"-ce");f.val(g.format("MMM YYYY"));n.val(h.format("MMM YYYY"));a();e.before('<a class="button secondary tiny play"><i class="fa fa-play"></i> Play</a><a class="button secondary tiny hide pause"><i class="fa fa-pause"></i> Pause</a><a class="button secondary tiny hide stop"><i class="fa fa-stop"></i> Stop</a>');
var u=$("#"+k+" .play"),t=$("#"+k+" .pause"),v=$("#"+k+" .stop"),z=e.data("slots");3>z.length&&u.hide();var R,D,K,F=e.rangepicker({type:"double",startValue:g.format(d),endValue:h.format(d),translateSelectLabel:function(a,b){g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;D=a/b*R;K=new Date(+g+parseInt(D));return moment(K).format(d)}});e.before('<div id="'+k+'-chart"><svg></svg></div>');var E=function(a){a=a.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+
...
X.end;g=new Date(e.data("min"));h=new Date(e.data("max"));R=h-g;D=Q/P*R;I=new Date(+g+parseInt(D));O.val(moment(I).format(d));D=M/P*R;J=new Date(+g+parseInt(D));S.val(moment(J).format(d));e.closest("form").trigger("optionChanged")});f.on("change",function(){g=moment($(this).val(),"MMM YYYY");e.data("min",g.format());I=g.format(d);F.refresh({startValue:I});O.val(I);e.closest("form").trigger("optionChanged")});n.on("change",function(){h=moment($(this).val(),"MMM YYYY").endOf("month");e.data("max",h.format());
J=h.format(d);F.refresh({endValue:J});S.val(J);e.closest("form").trigger("optionChanged")});O.on("change",function(){b()});S.on("change",function(){b()});e.on("clear",function(){F.updatePosition("100%","0%")});e.on("resize",function(a,b,c,f){e.data("min",b);e.data("max",c);F.refresh({startValue:moment(b).format(d),endValue:moment(c).format(d)});e.data("ts",f);F.graph();z=e.data("slots");2<z.length?u.show():u.hide()});var Z=0,T=[];e.data("slot",0);u.on("click",function(){var a=e.data("slot");u.hide();
t.removeClass("hide").show();v.removeClass("hide").show();z=e.data("slots");for(a;a<z.length;a++)c(a)});t.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());Z=0;t.hide();u.show()});v.on("click",function(){for(var a=0;a<T.length;a++)clearTimeout(T.pop());e.data("slot",0);Z=0;t.hide();v.hide();u.show()})});$(".text-filter").keypress(function(a){return 13==a.which?(a.preventDefault(),!1):!0})})})();
...
_renderItem:function(a,c,f){var e=this.options.comment,d=this.multiple,k=b(a),m="s3-groupedopts-option-"+this.id+"-"+this.index,l=d?"checkbox":"radio";this.index+=1;a=k.val();var n=k.html(),p=k.attr("title");k=this.selected;var q='<label for="'+m+'"';p&&""!==p&&(q+=' title="'+p+'"');d||a==k||(q+=' class="inactive"');q+=">"+n+"</label>";m=b('<input type="'+l+'" id="'+m+'" name="'+this.name+'" class="s3-groupedopts-option" value="'+a+'"/>');0<=(d?b.inArray(a,k):a==k?1:-1)&&b(m).prop("checked",!0);f=
f?b("<td>").append(m).append(b(q)):b('<div class="s3-groupedopts-item">').append(m).append(b(q));e&&(_.templateSettings={interpolate:/\{(.+?)\}/g},e=_.template(e)({v:a}),f.append(b(e)));c.append(f)},_bindEvents:function(){var a=this;a.menu.find(".s3-groupedopts-option").click(function(){var c=b(this),d=c.val(),h=a.element,g=a.multiple,k=h.val();null===k&&g&&(k=[]);g?(g=b.inArray(d,k),c.is(":checked")?0>g&&k.push(d):0<=g&&k.splice(g,1)):c.is(":checked")&&(k=d,a.menu.find(".s3-groupedopts-option").each(function(){c=
...
"undefined"!=typeof l&&(k._id=l));d=a.fields;for(n=0;n<d.length;n++){var p=d[n].name;l="#sub_"+e+"_"+e+"_i_"+p+"_edit_"+c;var q=b(l);if(q.length)if(l=q.val(),"file"==q.attr("type")){l||!m||b("#"+e+"_i_"+p+"_edit_"+c+"__delete").prop("checked")||(l=m[p].value);q.clone().insertAfter(q);var u=b("#add-"+e+"-none").length||"none"!=c?f||c:"0";u="upload_"+e+"_"+p+"_"+u;b("#"+u).remove();var z=q.closest("form");q.css({display:"none"}).attr("id",u).attr("name",u).appendTo(z);l.match(/fakepath/)&&(l=l.replace(/(c:\\)*fakepath\\/i,
""))}else"checkbox"==q.attr("type")?l=q.prop("checked"):q.hasClass("s3-hierarchy-input")?l=l?JSON.parse(l):null:(q=q.attr("class"),"generic-widget"==q&&(q=parseInt(l,10),isNaN(q)||l!=""+q||(l=q)));else l=null!==m?m[p].value:a.defaults&&"undefined"!=typeof a.defaults[p]?a.defaults[p].value:"";k[p]=l}if(b("#read-row-"+e+"-"+c).hasClass("single")){c=!0;for(p in k)if("_id"!=p&&""!==k[p]){c=!1;break}c?b("#edit-row-"+e).hasClass("required")?(this._appendError(e,"0",p,i18n.enter_value),k._error=!0):k._delete=
!0:delete k._error}else{f=!1;if(b("#add-row-"+e).hasClass("required")||b("#edit-row-"+e).hasClass("required"))f=!0;if(f){delete k._error;f=!0;for(p in k)"_id"!=p&&""!==k[p]&&(f=!1);f&&(f="none","none"!=c&&(f="0"),b("#add-"+e+"-"+c).length?b("#read-row-"+e+"-0").length||(this._appendError(e,f,p,i18n.enter_value),k._error=!0):(this._appendError(e,f,p,i18n.enter_value),k._error=!0))}}a=a.defaults;for(p in a)k.hasOwnProperty(p)||(l=a[p].value,k[p]=l);return k},_validate:function(a,c,f){var e=this.formname,
...
b+'">-</option>')})},_editRow:function(a){var c=this.options,d=this.formname,h=d+"-"+a;this._removeErrors();var g=this._deserialize(),k=g.data[a];if(!k._readonly){var m=b("#edit-row-"+d),l=m.data("rowindex");if(l&&m.hasClass("changed")){var n=!1;switch(c.implicitCancelEdit){case "refuse":break;case "submit":var p=this;this._updateRow(l).then(function(){p._editRow(a)});break;case "cancel":n=!0;break;default:confirm(c.confirmCancelEdit)&&(n=!0)}if(!n)return}b("#sub-"+d+" .read-row").removeClass("hide").show();
"imageimage"!=d&&b("#read-row-"+h).hide();c=g.fields;for(g=0;g<c.length;g++){n=c[g].name;l=k[n].value;var q="#sub_"+d+"_"+d+"_i_"+n+"_edit_0";var u=b("select"+q);u.length&&this._ensureSelectable(u,l);q=b(q);if(q.length)if("file"==q.attr("type")){u=b("#upload_"+d+"_"+n+"_"+a);if(u.length){var z=q.attr("id"),t=q.attr("name");q.replaceWith(u);u.attr("id",z).attr("name",t).css({display:""});q=u}this._updateUploadWidget(q,l);b("#"+d+"_i_"+n+"_edit_0__delete").prop("checked",!1)}else"checkbox"==q.attr("type")?
...
c=a.heightStyle,d=this.element.parent();this.active=this._findActive(a.active);this._addClass(this.active,"ui-accordion-header-active","ui-state-active")._removeClass(this.active,"ui-accordion-header-collapsed");this._addClass(this.active.next(),"ui-accordion-content-active");this.active.next().show();this.headers.attr("role","tab").each(function(){var a=b(this),c=a.uniqueId().attr("id"),e=a.next(),d=e.uniqueId().attr("id");a.attr("aria-controls",d);e.attr("aria-labelledby",c)}).next().attr("role",
...
l;var n=function(){h._toggleComplete(d)};"number"===typeof m&&(f=m);"string"===typeof m&&(c=m);c=c||m.easing||l.easing;f=f||m.duration||l.duration;if(!b.length)return a.animate(this.showProps,f,c,n);if(!a.length)return b.animate(this.hideProps,f,c,n);var p=a.show().outerHeight();b.animate(this.hideProps,{duration:f,easing:c,step:function(a,b){b.now=Math.round(a)}});a.hide().animate(this.showProps,{duration:f,easing:c,complete:n,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?"content-box"===
k&&(g+=c.now):"content"!==h.options.heightStyle&&(c.now=Math.round(p-b.outerHeight()-g),g=0)}})},_toggleComplete:function(a){var b=a.oldPanel,d=b.prev();this._removeClass(b,"ui-accordion-content-active");this._removeClass(d,"ui-accordion-header-active")._addClass(d,"ui-accordion-header-collapsed");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}})});
...
g){g="undefined"!==typeof g?g:{};var e="";if("string"==typeof c)(c=b(c).serialize())&&(e=c);else{var f=[];if(null!==c&&!d.isUndefined(c))for(var l=0;l<c.length;l++){var n=b("[name="+c[l]+"]").serialize();n&&f.push(n)}0<f.length&&(e=f.join("&"))}c=[function(a){h&&(":eval"==h?eval(a):"string"==typeof h?b("#"+h).html(a):h(a))}];b.isArray(g.done)?c=b.merge(c,g.done):c.push(g.done);a={type:"POST",url:a,data:e,success:c};delete g.done;for(var p in g)a[p]=g[p];b.ajax(a)},ajax_fields:function(a){b('button:not([class^="btn"])',
...
document,!0),d=b(e).filter("title").add(b(e).find("title")),f=d.last().text();f&&(d.remove(),document.title=b.trim(f));d=a.getResponseHeader("web2py-component-content");"prepend"==d?c.prepend(a.responseText):"append"==d?c.append(a.responseText):"hide"!=d&&c.html(e)},calc_entropy:function(a){for(var b="abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789 !@#$%^&*() ~`-_=+[]{}|;:'\",.<>?/ 0123456789abcdefghijklmnopqrstuvwxyz".split(" "),c=0,e={},d={},m=null,l=a.split(""),n=0;n<l.length;n++){for(var p=
l[n],q=5,u=0;u<b.length;u++)if(-1!=b[u].indexOf(p)){q=u;break}q in d?p in e||(c+=1,e[p]=1):(d[q]=1,c+=b[q].length);q!=m&&(c+=1,m=q)}return Math.round(a.length*Math.log(c)/.6931471805599453*100)/100},validate_entropy:function(a,b){d.isUndefined(a.data("w2p_entropy"))||(b=a.data("w2p_entropy"));var c=function(){var c=(d.calc_entropy(a.val())||0)/b;if(.5>=c){var e=1;var f=2*c}else e=1-2*(Math.max(c,0)-.5),f=1;e="#"+Math.round(15*e).toString(16)+Math.round(15*f).toString(16)+(0).toString(16);a.css("background-color",
