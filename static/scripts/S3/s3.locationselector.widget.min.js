...
0,e=$(".minutes",b).val()||0,i=$(".seconds",b).val()||0,j=c($(".degrees",b)),k=c($(".minutes",b)),l=c($(".seconds",b)),o=c($(".decimal",b)),b="gis_location_lat"==$(".decimal",b).attr("id");a(d)?(d=Number(d),Math.abs(d)>(b?90:180)?(alert(h.degrees[b?"lat":"lon"]),j()):a(e)?(e=Math.abs(e),60<e?(alert(h.minutes),k()):a(i)?(i=Math.abs(i),60<=i?(alert(h.seconds),l()):(d=(0>d?-1:1)*(Math.abs(d)+e/60+i/3600),Math.abs(d)>(b?90:180)?alert(h.decimal[b?"lat":"lon"]):(e=f(d),o(""+d),j(e.d||"0"),k(e.m||"0"),l(e.s||
"0")))):(alert(g.seconds),l())):(alert(g.minutes),k())):(alert(g.degrees),j())}function e(c){var b=$(".decimal",c),d=b.val(),e="gis_location_lat"==$(".decimal",c).attr("id");""!=d&&(a(d)?(d=Number(d),Math.abs(d)>(e?90:180)?(alert(h.decimal[e?"lat":"lon"]),b.focus()):(b=f(d),$(".degrees",c).val(b.d||"0"),$(".minutes",c).val(b.m||"0"),$(".seconds",c).val(b.s||"0"))):(alert(g.decimal),b.val("").focus()))}var g=i18n.gis_only_numbers,h=i18n.gis_range_error;$(".gis_coord_dms input").blur(function(){d(b($(this)))}).keypress(function(a){13==
...
$("#gis_location_L3").val(),d=$("#gis_location_L4").val(),e=$("#gis_location_L5").val();if(!$("#gis_location_L0").val()){var b=S3.gis.site?"":$("#gis_location_name").val(),g=$("#gis_location_street").val(),h=$("#gis_location_postcode").val(),m=$("#gis_location_lat").val(),n=$("#gis_location_lon").val();if(a||c||f||d||e||b||g||h||m||n)return void 0==$("#country__error").val()&&$("#gis_location_L0").after('<div id="country__error" class="error" style="display: block;">'+i18n.gis_country_required+"</div>"),
