...
!0),$("#gis_location_L1__row").show());$("#gis_location_map-btn").html(i18n.gis_view_on_map);$("#gis_location_map_button_row").show();$("#gis_loc_view_tab").removeClass("tab_other").addClass("tab_here");$("#gis_loc_edit_tab").removeClass("tab_here").addClass("tab_last")}
