...
$("#gis_location_expand").addClass("expanded"),$("#gis_location_expand").removeClass("expand")):(s3_gis_show_tab("add"),$("#gis_location_expand").addClass("expand"),$("#gis_location_expand").removeClass("expanded"));a.preventDefault()});$("#gis_location_search_select-btn").click(function(a){s3_gis_select_search_result();a.preventDefault()});$("form").submit(function(){S3ClearNavigateAwayConfirm();return s3_gis_save_locations()?!0:!1})}var b=$("#gis_location_map-btn");b&&b.click(function(){var a=b.attr("map");
void 0==a&&(a="default_map");a=S3.gis.maps[a];a.s3.mapWin.show();if(a.s3.polygonButton)$("#gis_location_wkt").val()||($(".olMapViewport").addClass("crosshair"),a.s3.polygonButton.control.activate());else{var e=$("#gis_location_lat").val(),d=$("#gis_location_lon").val();e&&d||($(".olMapViewport").addClass("crosshair"),a.s3.pointButton.control.activate())}})}
