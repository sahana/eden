...
return d},focus:function(b,e){e.item.id&&a.val(e.item.name);return!1},select:function(b,e){var d=e.item;d.id?(a.val(d.name),$("ul.ui-autocomplete").hide(),s3_gis_ac_search_selected(d)):a.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){var d;d=b.name&&b.addr_street?"<a>"+b.name+",  "+b.addr_street.split(",")[0].split("\n")[0]+"</a>":b.name?"<a>"+b.name+"</a>":"<a>"+b.addr_street.split(",")[0].split("\n")[0]+"</a>";return $("<li></li>").data("item.autocomplete",b).append(d).appendTo(a)}}}
