...
function s3_gis_locationselector_Ext_onReady(){var a=Ext.get("gis_location_map-btn");if(a)a.on("click",function(){var a=$("#gis_location_map-btn").attr("map");void 0==a&&(a="default_map");a=S3.gis.maps[a];a.s3.mapWin.show();if(a.s3.polygonButton)$("#gis_location_wkt").val()||($(".olMapViewport").addClass("crosshair"),a.s3.polygonButton.control.activate());else{var c=$("#gis_location_lat").val(),e=$("#gis_location_lon").val();if(!c||!e)$(".olMapViewport").addClass("crosshair"),a.s3.pointButton.control.activate()}})}
function s3_gis_locationselector_activate(){s3_gis_locationselector_jQuery_onReady();s3_gis_locationselector_Ext_onReady()}function s3_gis_autocompletes(){s3_gis_autocomplete(1);s3_gis_autocomplete(2);s3_gis_autocomplete(3);s3_gis_autocomplete(4);s3_gis_autocomplete(5);s3_gis_autocomplete_search()}
