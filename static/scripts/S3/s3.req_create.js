...
$(document).ready(function() {
    ...
    function type_9() {
        ...
        $('#req_req_sub_req_skill_skill_id__row1').hide();
        $('#req_req_sub_req_skill_skill_id__row').hide();
        $('#req_req_sub_req_skill_quantity__row1').hide();
        $('#req_req_sub_req_skill_quantity__row').hide();
    ...
    function type_next(type) {
        ...
        if (type == 1) {
            ...
            $('#req_req_sub_defaultreq_item__row1').hide();
            $('#req_req_sub_defaultreq_item__row').hide();
            $('#req_req_sub_req_skill_skill_id__row1').show();
            $('#req_req_sub_req_skill_skill_id__row').show();
            $('#req_req_sub_req_skill_quantity__row1').show();
            $('#req_req_sub_req_skill_quantity__row').show();
