...
a(this),e=d.attr("id");e&&e.match("__row$")&&(e=e.replace(tablename+"_","").replace("__row",""),d=d.find("td.w2p_fc")||d.find("td").eq(1),0<=fields.indexOf(e)&&m(e,d))})}var D=function(){a(".cap-clone-update").off(".cap").on("click.cap",function(){C(a(this).attr("data"))})},C=function(b){var q=b.split("/")[0];(b=b.split("/").pop())&&a.ajax({url:S3.Ap.concat("/cap/alert/")+b+"/clone?msg_type="+q,success:function(m){window.location.href=S3.Ap.concat("/cap/alert/")+m.message},error:function(m,d,e){console.log("UNAUTHORIZED"==
e?i18n.gis_requires_login:m.responseText)},type:"POST",dataType:"json"})};window.fields=u;a(document).ready(function(){a("form").each(function(){""!==r(a(this))&&(z(a(this)),(0<a(".cap_template_form").length||w())&&B(a(this)))});D()})})(jQuery,JSON,void 0);
