...
p(b),a.val(c);else{var e=$(d+"_address").val(),h=$(d+"_lat").val(),d=$(d+"_lon").val();e||h||d?(c.val("dummy"),c=p(b),a.val(c)):(b=p(b),c.val(b),a.val(""))}},C=function(b){var d="#"+b;$(d+"_address__row").show();$(d+"_address").change(function(){m(b)})},w=function(b){var d="#"+b,a=$(d+"_map_icon");a.unbind("click");a.click(function(){r(b)});$(d+"_map_wrapper").hide();S3.gis.maps["location_selector_"+b].s3.draftLayer.removeAllFeatures();$(d+"_lat").val("");$(d+"_lon").val("");m(b)},r=function(b,d){var a=
"#"+b,c=$(a+"_map_icon");c.unbind("click");c.click(function(){w(b)});$(a+"_map_wrapper").show();var c="location_selector_"+b,e=S3.gis;if(!e.maps||!e.maps[c]){var h=e.show_map(c);$(a);$(a+"_parent");(c=p(b))||(c="d");s(b,c);var g=$(a+"_lat"),q=$(a+"_lon"),a=g.val(),c=q.val();void 0!=a&&(a=new OpenLayers.Geometry.Point(parseFloat(c),parseFloat(a)),a.transform(e.proj4326,h.getProjectionObject()),a=new OpenLayers.Feature.Vector(a),h.s3.draftLayer.addFeatures([a]),m(b));for(var f,a=h.controls,c=0,r=a.length;c<
r;c++)"OpenLayers.Control.DrawFeature"==a[c].CLASS_NAME&&(f=a[c]);f&&f.events.register("featureadded",null,function(a){a=a.feature.geometry.getBounds().getCenterLonLat();a.transform(h.getProjectionObject(),e.proj4326);g.val(a.lat);q.val(a.lon);m(b)})}},s=function(b,d){if(S3.gis.maps){var a=S3.gis.maps["location_selector_"+b];if(a){var c=l[d].b;if(!c){var e=l[d].f;if(e=l[e])if(c=e.b,!c&&(e=e.f,e=l[e]))if(c=e.b,!c&&(e=e.f,e=l[e]))c=e.b}c&&(c=OpenLayers.Bounds.fromArray(c).transform(S3.gis.proj4326,
