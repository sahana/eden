...
500))},1);return b.promise()},L=function(b,a){var e="#"+b;$(e+"_map_icon").unbind("click").click(function(){T(b)});$(e+"_map_wrapper").removeClass("hide").show();$.when(U()).then(function(a){a="location_selector_"+b;var f=S3.gis;if(!f.maps[a]){var m=f.show_map(a),g=$(e);$(e+"_parent");B(b);var s=$(e+"_lat"),q=$(e+"_lon"),p=$(e+"_wkt");a=s.val();var d=q.val(),k=p.val();if(a||d||k)void 0!=k?(a={internalProjection:m.getProjectionObject(),externalProjection:f.proj4326},a=(new OpenLayers.Format.WKT(a)).read(k)):
(a=new OpenLayers.Geometry.Point(parseFloat(d),parseFloat(a)),a.transform(f.proj4326,m.getProjectionObject()),a=new OpenLayers.Feature.Vector(a)),m.s3.draftLayer.addFeatures([a]),u(b);var r;a=m.controls;for(var d=0,t=a.length;d<t;d++)if("OpenLayers.Control.DrawFeature"==a[d].CLASS_NAME){r=a[d];break}r&&(m.s3.pointPlaced=function(a){$(e+"_geocode .geocode_fail").hide();$(e+"_geocode .geocode_success").hide();var c=a.geometry;"OpenLayers.Geometry.Point"==c.CLASS_NAME?(a=c.getBounds().getCenterLonLat(),
a.transform(m.getProjectionObject(),f.proj4326),s.val(a.lat),q.val(a.lon),g.data("manually_geocoded",!0),S(b)):(c={internalProjection:m.getProjectionObject(),externalProjection:f.proj4326},k=(new OpenLayers.Format.WKT(c)).write(a),p.val(k));u(b)})}},function(a){s3_debug(a)},function(a){s3_debug(a)})},B=function(b,a){var e=S3.gis;if(e.maps&&(e=e.maps["location_selector_"+b])){var c="#"+b,f=$(c+"_lat").val(),c=$(c+"_lon").val();if(f&&c)f=[c-0.032,f-0.032,c+0.032,f+0.032];else if(a||(a=z(b)||"d"),f=
l[a].b,!f&&(c=l[a].f,c=l[c]))if(f=c.b,!f&&(c=c.f,c=l[c]))if(f=c.b,!f&&(c=c.f,c=l[c]))f=c.b;f&&(f=OpenLayers.Bounds.fromArray(f),S3.gis.zoomBounds(e,f))}}})();
