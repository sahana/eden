...
$jscomp.polyfillIsolated=function(a,g,e,h){var b=a.split(".");a=1===b.length;h=b[0];h=!a&&h in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var c=0;c<b.length-1;c++){var d=b[c];if(!(d in h))return;h=h[d]}b=b[b.length-1];e=$jscomp.IS_SYMBOL_NATIVE&&"es6"===e?h[b]:null;g=g(e);null!=g&&(a?$jscomp.defineProperty($jscomp.polyfills,b,{configurable:!0,writable:!0,value:g}):g!==e&&(void 0===$jscomp.propertyToPolyfillSymbol[b]&&($jscomp.propertyToPolyfillSymbol[b]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(b):
$jscomp.POLYFILL_PREFIX+b),$jscomp.defineProperty(h,$jscomp.propertyToPolyfillSymbol[b],{configurable:!0,writable:!0,value:g})))};$jscomp.initSymbol=function(){};
$jscomp.polyfill("Symbol",function(a){if(a)return a;var g=function(b,c){this.$jscomp$symbol$id_=b;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:c})};g.prototype.toString=function(){return this.$jscomp$symbol$id_};var e=0,h=function(b){if(this instanceof h)throw new TypeError("Symbol is not a constructor");return new g("jscomp_symbol_"+(b||"")+"_"+e++,b)};return h},"es6","es3");
