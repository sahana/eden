...
$jscomp.polyfillIsolated=function(a,g,e,h){var b=a.split(".");a=1===b.length;h=b[0];h=!a&&h in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var c=0;c<b.length-1;c++){var d=b[c];if(!(d in h))return;h=h[d]}b=b[b.length-1];e=$jscomp.IS_SYMBOL_NATIVE&&"es6"===e?h[b]:null;g=g(e);null!=g&&(a?$jscomp.defineProperty($jscomp.polyfills,b,{configurable:!0,writable:!0,value:g}):g!==e&&(void 0===$jscomp.propertyToPolyfillSymbol[b]&&(e=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[b]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(b):$jscomp.POLYFILL_PREFIX+e+"$"+b),$jscomp.defineProperty(h,$jscomp.propertyToPolyfillSymbol[b],{configurable:!0,writable:!0,value:g})))};$jscomp.initSymbol=function(){};
$jscomp.polyfill("Symbol",function(a){if(a)return a;var g=function(c,d){this.$jscomp$symbol$id_=c;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:d})};g.prototype.toString=function(){return this.$jscomp$symbol$id_};var e="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",h=0,b=function(c){if(this instanceof b)throw new TypeError("Symbol is not a constructor");return new g(e+(c||"")+"_"+h++,c)};return b},"es6","es3");
...
"es3");$jscomp.iteratorPrototype=function(a){a={next:a};a[Symbol.iterator]=function(){return this};return a};$jscomp.iteratorFromArray=function(a,g){a instanceof String&&(a+="");var e=0,h=!1,b={next:function(){if(!h&&e<a.length){var c=e++;return{value:g(c,a[c]),done:!1}}h=!0;return{done:!0,value:void 0}}};b[Symbol.iterator]=function(){return b};return b};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(g){return g})}},"es6","es3");
