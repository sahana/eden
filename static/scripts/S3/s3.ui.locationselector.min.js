...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(d,p,l){d instanceof String&&(d=String(d));for(var f=d.length,g=0;g<f;g++){var b=d[g];if(p.call(l,b,g,d))return{i:g,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,p,l){d!=Array.prototype&&d!=Object.prototype&&(d[p]=l.value)};
$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(d,p,l,f){if(p){l=$jscomp.global;d=d.split(".");for(f=0;f<d.length-1;f++){var g=d[f];g in l||(l[g]={});l=l[g]}d=d[d.length-1];f=l[d];p=p(f);p!=f&&null!=p&&$jscomp.defineProperty(l,d,{configurable:!0,writable:!0,value:p})}};
