...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,w,x){b instanceof String&&(b=String(b));for(var f=b.length,l=0;l<f;l++){var p=b[l];if(w.call(x,p,l,b))return{i:l,v:p}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,w,x){if(b==Array.prototype||b==Object.prototype)return b;b[w]=x.value;return b};$jscomp.getGlobal=function(b){b=["object"==typeof globalThis&&globalThis,b,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var w=0;w<b.length;++w){var x=b[w];if(x&&x.Math==Math)return x}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(b,w){var x=$jscomp.propertyToPolyfillSymbol[w];if(null==x)return b[w];x=b[x];return void 0!==x?x:b[w]};
$jscomp.polyfill=function(b,w,x,f){w&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(b,w,x,f):$jscomp.polyfillUnisolated(b,w,x,f))};$jscomp.polyfillUnisolated=function(b,w,x,f){x=$jscomp.global;b=b.split(".");for(f=0;f<b.length-1;f++){var l=b[f];if(!(l in x))return;x=x[l]}b=b[b.length-1];f=x[b];w=w(f);w!=f&&null!=w&&$jscomp.defineProperty(x,b,{configurable:!0,writable:!0,value:w})};
$jscomp.polyfillIsolated=function(b,w,x,f){var l=b.split(".");b=1===l.length;f=l[0];f=!b&&f in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var p=0;p<l.length-1;p++){var c=l[p];if(!(c in f))return;f=f[c]}l=l[l.length-1];x=$jscomp.IS_SYMBOL_NATIVE&&"es6"===x?f[l]:null;w=w(x);null!=w&&(b?$jscomp.defineProperty($jscomp.polyfills,l,{configurable:!0,writable:!0,value:w}):w!==x&&(void 0===$jscomp.propertyToPolyfillSymbol[l]&&($jscomp.propertyToPolyfillSymbol[l]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(l):
$jscomp.POLYFILL_PREFIX+l),$jscomp.defineProperty(f,$jscomp.propertyToPolyfillSymbol[l],{configurable:!0,writable:!0,value:w})))};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(w,x){return $jscomp.findInternal(this,w,x).v}},"es6","es3");
(function(b,w){var x=0,f={},l={},p={};b.widget("s3.locationselector",{options:{hideLx:!0,reverseLx:!1,locations:null,labels:null,minBBOX:.05,showLabels:!0,featureRequired:null,latlonMode:"decimal",latlonModeToggle:!0,openMapOnLoad:!1},_create:function(){this.id=x;x+=1;this.eventNamespace=".locationselector"},_init:function(){var c=b(this.element),a=this.options,d=c.attr("id");if(!d)throw"Location selector widget: real input field without id";this.fieldname=d;this.input=c;this.data=null;this._storeHierarchyData(a.labels,
a.locations);this.refresh()},_destroy:function(){b.Widget.prototype.destroy.call(this)},refresh:function(){this._unbindEvents();var c=this._deserialize();this._renderWidget();var a="#"+this.fieldname,d=this.options;b(a+"_geocode button").length?this.useGeocoder=!0:this.useGeocoder=!1;var e=b(a+"_postcode").data("k");this.postcodeToAddress=e?e:!1;e=b(a+"_L0__row");if(e.length){var k=[];for(n in f){var g=f[n];0===g.l&&(g.i=n,k.push(g))}k.sort(function(v,y){return v.n.localeCompare(y.n)});for(var h=
b(a+"_L0"),m=0,q=k.length;m<q;m++){g=k[m];var n=g.i;n='<option value="'+n+'">'+g.n+"</option>";h.append(n)}this.postcodeToAddress||(e.removeClass("hide").show(),e=b(a+"_L0__row1"),e.length&&e.removeClass("hide").show())}var t;this.postcodeToAddress&&!c.address&&(t=!0);var u=this;e=c.L0;k=c.L1;n=c.L2;h=c.L3;m=c.L4;q=c.L5;var r;[e,k||n,n||h,h||m,m||q,q].forEach(function(v,y){v&&(r=r?r.then(function(){return u.lxSelect(y,v,!0,t)}):u.lxSelect(y,v,!0,t))});this.lx=[e,k,n,h,m,q].join("|");e=c.address;b(a+
...
b(a+"_L1__row");var n=b(a+"_L2__row"),t=b(a+"_L3__row"),u=b(a+"_L4__row"),r=b(a+"_L5__row"),v=b(a+"_address__row"),y=b(a+"_postcode_to_address__row"),A=b(a+"_lat__row"),z=b(a+"_lon__row");a=b(a+"_latlon_toggle__row");d?k.hide().after(e).after(h).after(a).after(z).after(A).after(m).after(c).after(n).after(t).after(u).after(r).after(y).after(q).after(v).after(g):k.hide().after(e).after(h).after(a).after(z).after(A).after(y).after(q).after(v).after(r).after(u).after(t).after(n).after(c).after(m).after(g)}else k.parent().is(".inline-form")?
...
q.multiselect("refresh")):a=parseInt(q.val(),10);if(0===c){var t=g._readLabels(a),u=l.d,r=["1","2","3","4","5"],v,y,A;t.then(function(K){for(A=0;5>A;A++)n=r[A],v=K[n]||u[n],z=h+"_L"+n,q=b(z),y=m.showLabels?q.hasClass("required")?"<div>"+v+':<span class="req"> *</span></div>':v+":":"",b(z+"__row label").html(y),b(z+"__row1 label").html(y),b(z+' option[value=""]').html(i18n.select+" "+v),q.hasClass("multiselect")&&q.multiselect("instance")&&q.multiselect("refresh")})}t=m.hideLx;for(n=c+1;6>n;n++){var z=
...
a,function(){b(this).hide();k._geocode()}):this._geocode()}},_geocode:function(){for(var c=this.fieldname,a=this,d="#"+c,e=b(d+"_geocode .geocode_fail").hide(),k=b(d+"_geocode .geocode_success").hide(),g=b(d+"_geocode .throbber").removeClass("hide").show(),h=this.data,m={address:h.address},q="postcode L0 L1 L2 L3 L4 L5".split(" "),n=0,t,u;7>n;n++)t=q[n],(u=h[t])&&(m[t]=u);m.k=b(d+"_geocode button").data("k");d=S3.Ap.concat("/gis/geocode");b.ajaxS3({url:d,type:"POST",data:m,dataType:"json",success:function(r){var v=
r.lat,y=r.lon;if(v||y){h.lat=parseFloat(v);h.lon=parseFloat(y);a._collectData();v=S3.gis;if(v.maps&&(y=v.maps["location_selector_"+c])){r=y.s3.draftLayer;r.removeAllFeatures();var A=new OpenLayers.Geometry.Point(h.lon,h.lat);A.transform(v.proj4326,y.getProjectionObject());v=new OpenLayers.Feature.Vector(A);r.addFeatures([v]);a._zoomMap()}g.hide();k.html(i18n.address_mapped).removeClass("hide").show()}else g.hide(),e.html(i18n.address_not_mapped).removeClass("hide").show(),s3_debug(r)},error:function(r,
v,y){r="UNAUTHORIZED"==y?i18n.gis_requires_login:r.responseText;g.hide();e.html(i18n.address_not_mapped).removeClass("hide").show();s3_debug(r)}})},_geocodeReverse:function(){var c=this,a="#"+this.fieldname,d=b(a+"_geocode .geocode_fail").hide(),e=b(a+"_geocode .geocode_success").hide(),k=b(a+"_geocode .throbber").removeClass("hide").show(),g=this.data;g={lat:g.lat,lon:g.lon};g.k=b(a+"_geocode button").data("k");a=S3.Ap.concat("/gis/geocode_r");b.ajaxS3({async:!1,url:a,type:"POST",data:g,dataType:"json",
success:function(h){var m=h.L0,q=h.L1,n=h.L2,t=h.L3,u=h.L4;h=h.L5;if(m){c.useGeocoder=!1;var r;[m,q||n,n||t,t||u,u||h,h].forEach(function(v,y){v&&(r=r?r.then(function(){return c.lxSelect(y,v)}):c.lxSelect(y,v))});c.useGeocoder=!0;k.hide();e.html(i18n.location_found).removeClass("hide").show()}else k.hide(),d.html(i18n.location_not_found).removeClass("hide").show()},error:function(h,m,q){h="UNAUTHORIZED"==q?i18n.gis_requires_login:h.responseText;k.hide();d.html(i18n.location_not_found).removeClass("hide").show();
...
n.lon,u=n.wkt;if(m||t||u)q.s3.draftLayer.removeAllFeatures(),u!=w&&u?(m={internalProjection:q.getProjectionObject(),externalProjection:h.proj4326},m=(new OpenLayers.Format.WKT(m)).read(u)):(m=new OpenLayers.Geometry.Point(parseFloat(t),parseFloat(m)),m.transform(h.proj4326,q.getProjectionObject()),m=new OpenLayers.Feature.Vector(m)),q.s3.draftLayer.addFeatures([m]),q.s3.lastDraftFeature=m;m=q.controls;t=0;for(var r=m.length;t<r;t++)if("OpenLayers.Control.DrawFeature"==m[t].CLASS_NAME){var v=m[t];
break}v&&(q.s3.pointPlaced=function(y){b(k+"_geocode .geocode_fail").hide();b(k+"_geocode .geocode_success").hide();var A=y.geometry;if("OpenLayers.Geometry.Point"==A.CLASS_NAME)y=A.getBounds().getCenterLonLat(),y.transform(q.getProjectionObject(),h.proj4326),n.wkt=null,n.lat=y.lat,n.lon=y.lon,!n.address&&e.useGeocoder&&e._geocodeReverse();else{A={internalProjection:q.getProjectionObject(),externalProjection:h.proj4326};n.radius=null;var z=new OpenLayers.Geometry.LinearRing(y.geometry.components[0].components);
