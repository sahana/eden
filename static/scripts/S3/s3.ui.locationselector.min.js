...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,v,w){c instanceof String&&(c=String(c));for(var g=c.length,m=0;m<g;m++){var q=c[m];if(v.call(w,q,m,c))return{i:m,v:q}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
