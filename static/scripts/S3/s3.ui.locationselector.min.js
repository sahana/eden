...
m=d(b+"_map_icon__row"),h=d(b+"_L0__row"),p=d(b+"_postcode__row");if(f.is(".control-group, .form-row")){var a=d(b+"_L1__row"),k=d(b+"_L2__row"),l=d(b+"_L3__row"),r=d(b+"_L4__row"),t=d(b+"_L5__row"),u=d(b+"_address__row"),y=d(b+"_lat__row"),z=d(b+"_lon__row"),b=d(b+"_latlon_toggle__row");c?f.hide().after(e).after(m).after(b).after(z).after(y).after(h).after(a).after(k).after(l).after(r).after(t).after(p).after(u).after(g):f.hide().after(e).after(m).after(b).after(z).after(y).after(p).after(u).after(t).after(r).after(l).after(k).after(a).after(h).after(g)}else f.parent().is(".inline-form")?
f.show():(d(b+"__row1").hide(),f.hide().after(g),m.detach(),f.siblings('[id^="'+a+'"][id$="__row"]').last().after(e).after(m));if(g.length)g.one("click"+this.namespace,function(){var a=d(this);a.fadeOut("slow",function(){a.remove()})})},_lxSelect:function(a,b,c){var e="#"+this.fieldname,f=this.options,g=d(e+"_L"+a);b?(g.val(b),g.hasClass("multiselect")&&g.multiselect("instance")&&g.multiselect("refresh")):b=parseInt(g.val(),10);if(0===a){var m=this._readLabels(b),q=l.d,p=["1","2","3","4","5"],k,w,
r,t;for(r=0;5>r;r++)g=p[r],k=m[g]||q[g],t=e+"_L"+g,g=d(t),w=f.showLabels?g.hasClass("required")?"<div>"+k+':<span class="req"> *</span></div>':k+":":"",d(t+"__row label").html(w),d(t+"__row1 label").html(w),d(t+' option[value=""]').html(i18n.select+" "+k),g.hasClass("multiselect")&&g.multiselect("instance")&&g.multiselect("refresh")}r=f.hideLx;for(g=a+1;6>g;g++)t=e+"_L"+g,r?(d(t+"__row").hide(),d(t+"__row1").hide()):d(t+" option").remove('[value != ""]'),d(t).val("");if(b)if(t=a+1,f=d(e+"_L"+t+"__row"),
f.length){var u;if(d(e+"_L"+a+' option[value="'+b+'"]').hasClass("missing"))k=h[b],k.i=b,q=[k];else{r=!0;for(u in h)if(h[u].f==b){r=!1;break}r&&this._readHierarchy(b,t);q=[];for(u in h)k=h[u],k.f==b&&(k.i=u,q.push(k))}if(a=q.length){q.sort(function(a,b){return a.n.localeCompare(b.n)});u=e+"_L"+t;m=d(u);p=d(u+' option[value=""]').html();d(u+" option").remove('[value != ""]');u=null;for(r=0;r<a;r++)k=q[r],u=k.i,g=b==u?' selected="selected"':"",w=k.l==t?"":' class="missing"',k='<option value="'+u+'"'+
g+w+">"+k.n+"</option>",m.append(k);f.removeClass("hide").show();d(e+"_L"+t+"__row1").removeClass("hide").show();m.hasClass("multiselect")&&(b={header:"",height:300,minWidth:0,selectedList:1,noneSelectedText:p,multiple:!1},m.hasClass("search")?(m.multiselect(b).multiselectfilter({label:"",placeholder:i18n.search}),d(".ui-multiselect-header").show()):(b.header=!1,m.multiselect(b)));1==a&&u&&this._lxSelect(t,u,c)}}else this.useGeocoder&&!c&&this._geocodeDecision();c?this._serialize():this._collectData();
...
_collectLx:function(){var a=this.data,b="#"+this.fieldname,c,e;for(e=0;6>e;e++)c=d(b+"_L"+e),c.length&&(c=c.val(),a["L"+e]=c?parseInt(c,10):null);this._serialize()},_hasData:function(){var a=this.data,b=!1;a.specific||a.address||a.postcode||a.lat||a.lon||a.wkt?b=!0:[a.L0,a.L1,a.L2,a.L3,a.L4,a.L5].join("|")!=this.lx&&(b=!0);return b},_lookupParent:function(){this._collectLx();var a=this.data;parent;for(var b=5;-1<b;b--)if(parent=a["L"+b])return parent;return(a=h.d)?a.i:null},_readLabels:function(a){a||
(a="d");var b=l[a];if(b==x){var c=S3.Ap.concat("/gis/hdata/"+a);d.ajaxS3({async:!1,url:c,dataType:"script",success:function(c){b={};try{for(var d in n)b[d]=n[d];l[a]=b;n=null}catch(g){}},error:function(a,b,c){s3_debug("UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText)}})}return b},_readHierarchy:function(a,b){var c="#"+this.fieldname,e=d(c+"_L"+b),f=!1;e.hide();if(e.hasClass("multiselect"))var f=!0,g=d(c+"_L"+b+"__row button").hide();var m=d(c+"_L"+b+"__throbber").removeClass("hide").show(),
c=S3.Ap.concat("/gis/ldata/"+a);d.ajaxS3({async:!1,url:c,dataType:"script",success:function(a){for(var b in n)h[b]=n[b];n=null;m.hide();f?g.removeClass("hide").show():e.removeClass("hide").show()},error:function(a,b,c){a="UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText;s3_debug(a);S3.showAlert(a,"error");m.hide();f?g.removeClass("hide").show():e.removeClass("hide").show()}})},_geocodeDecision:function(){var a="#"+this.fieldname,b=this.data;this._collectData();if(b.address){for(var b=["1",
"2","3","4","5"],c=0,e;5>c;c++)if(e=d(a+"_L"+b[c]),e.length&&!e.val()&&1<e[0].options.length)return;d(a+"_geocode .geocode_success,"+a+"_geocode .geocode_fail").hide();var f=this,b=this.namespace;this.input.data("manually_geocoded")?d(a+"_geocode button").removeClass("hide").show().unbind(b).bind("click"+b,function(){d(this).hide();f._geocode()}):this._geocode()}},_geocode:function(){for(var a=this.fieldname,b=this,c="#"+a,e=d(c+"_geocode .geocode_fail").hide(),f=d(c+"_geocode .geocode_success").hide(),
g=d(c+"_geocode .throbber").removeClass("hide").show(),m=this.data,c={address:m.address},h="postcode L0 L1 L2 L3 L4 L5".split(" "),p=0,k,l;7>p;p++)k=h[p],(l=m[k])&&(c[k]=l);h=S3.Ap.concat("/gis/geocode");d.ajaxS3({url:h,type:"POST",data:c,dataType:"json",success:function(c){var d=c.lat,h=c.lon;if(d||h){m.lat=parseFloat(d);m.lon=parseFloat(h);b._collectData();d=S3.gis;if(d.maps&&(h=d.maps["location_selector_"+a])){c=h.s3.draftLayer;c.removeAllFeatures();var k=new OpenLayers.Geometry.Point(m.lon,m.lat);
k.transform(d.proj4326,h.getProjectionObject());d=new OpenLayers.Feature.Vector(k);c.addFeatures([d]);b._zoomMap()}g.hide();f.html(i18n.address_mapped).removeClass("hide").show()}else g.hide(),e.html(i18n.address_not_mapped).removeClass("hide").show(),s3_debug(c)},error:function(a,b,c){a="UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText;g.hide();e.html(i18n.address_not_mapped).removeClass("hide").show();s3_debug(a)}})},_geocodeReverse:function(){var a=this,b="#"+this.fieldname,c=d(b+"_geocode .geocode_fail").hide(),
e=d(b+"_geocode .geocode_success").hide(),f=d(b+"_geocode .throbber").removeClass("hide").show(),b=this.data,b={lat:b.lat,lon:b.lon},g=S3.Ap.concat("/gis/geocode_r");d.ajaxS3({async:!1,url:g,type:"POST",data:b,dataType:"json",success:function(b){b.L0?(a.useGeocoder=!1,a._lxSelect(0,b.L0),b.L1&&a._lxSelect(1,b.L1),b.L2&&a._lxSelect(2,b.L2),b.L3&&a._lxSelect(3,b.L3),b.L4&&a._lxSelect(4,b.L4),b.L5&&a._lxSelect(5,b.L5),a.useGeocoder=!0,f.hide(),e.html(i18n.location_found).removeClass("hide").show()):
(f.hide(),c.html(i18n.location_not_found).removeClass("hide").show())},error:function(a,b,d){a="UNAUTHORIZED"==d?i18n.gis_requires_login:a.responseText;f.hide();c.html(i18n.location_not_found).removeClass("hide").show();s3_debug(a)}})},_latlonInput:function(){var a=this.fieldname,b=this.data,c="#"+a,e=d(c+"_lat").val(),c=d(c+"_lon").val();e||c?(e=e?parseFloat(e):0,c=c?parseFloat(c):0,b.lat=e,b.lon=c,b.wkt=null,this.input.data("manually_geocoded",!0)):(b.lat=null,b.lon=null,b.wkt||this.input.data("manually_geocoded",
!1));this._serialize();e=S3.gis;e.maps&&(a=e.maps["location_selector_"+a])&&(c=a.s3.draftLayer,c.removeAllFeatures(),null!==b.lat&&null!==b.lon&&(b=new OpenLayers.Geometry.Point(b.lon,b.lat),b.transform(e.proj4326,a.getProjectionObject()),b=new OpenLayers.Feature.Vector(b),c.addFeatures([b]),a.s3.lastDraftFeature=b),this._zoomMap())},_showMap:function(a){var b=this.fieldname,c=this.namespace,e=this,f="#"+b;d(f+"_map_icon").unbind(c).bind("click"+c,function(){e._hideMap()});d(f+"_map_icon span").html(i18n.hide_map);
c=d(f+"_map_wrapper").hide().removeClass("hide").slideDown("medium");c.length&&a&&d("html,body").animate({scrollTop:c.offset().top},250);var g=this.input;d.when(this._jsLoaded()).then(function(a){var c=S3.gis;a="location_selector_"+b;var h;h=c.maps[a]?c.maps[a]:c.show_map(a);e._zoomMap();var k=e.data;a=k.lat;var l=k.lon,r=k.wkt;if(a||l||r)h.s3.draftLayer.removeAllFeatures(),r!=x&&r?(a={internalProjection:h.getProjectionObject(),externalProjection:c.proj4326},a=(new OpenLayers.Format.WKT(a)).read(r)):
(a=new OpenLayers.Geometry.Point(parseFloat(l),parseFloat(a)),a.transform(c.proj4326,h.getProjectionObject()),a=new OpenLayers.Feature.Vector(a)),h.s3.draftLayer.addFeatures([a]),h.s3.lastDraftFeature=a;a=h.controls;for(var t,l=0,u=a.length;l<u;l++)if("OpenLayers.Control.DrawFeature"==a[l].CLASS_NAME){t=a[l];break}t&&(h.s3.pointPlaced=function(a){d(f+"_geocode .geocode_fail").hide();d(f+"_geocode .geocode_success").hide();var b=a.geometry;"OpenLayers.Geometry.Point"==b.CLASS_NAME?(a=b.getBounds().getCenterLonLat(),
a.transform(h.getProjectionObject(),c.proj4326),k.wkt=null,k.lat=a.lat,k.lon=a.lon,!k.address&&this.useGeocoder&&e._geocodeReverse()):(b={internalProjection:h.getProjectionObject(),externalProjection:c.proj4326},r=(new OpenLayers.Format.WKT(b)).write(a),k.wkt=r,k.lat=null,k.lon=null);g.data("manually_geocoded",!0);e._collectData();e._removeErrors()})},function(a){s3_debug(a)},function(a){s3_debug(a)})},_hideMap:function(){var a=this.fieldname,b=this.namespace,c="#"+a,e=this;d(c+"_map_icon").unbind(b).bind("click"+
...
b.lat||b.lon;break;case "wkt":e=b.wkt;break;default:e=b.lat||b.lon||b.wkt}if(!e)return S3.fieldError(a+"_map_icon",i18n.map_feature_required),!1}var f=b.id,c="address L5 L4 L3 L2 L1 L0".split(" "),g,e=function(a){return a.hasClass("multiselect")?a.next("button.ui-multiselect").is(":visible"):a.is(":visible")};if(f){if(!h[f])return!0;for(var l=h[f].l,b=0;b<6-l;b++)if(f=a+"_"+c[b],g=d(f),g.length&&g.hasClass("required")&&e(g))return S3.fieldError(f,i18n.enter_value),!1}else{if(b.lat||b.lon||b.wkt||
b.address||b.postcode)return!0;for(b=0;7>b;b++)if(f=a+"_"+c[b],g=d(f),g.length&&g.hasClass("required")&&e(g))return S3.fieldError(f,i18n.enter_value),!1}return!0},_serialize:function(){var a=JSON.stringify(this.data);this.input.val(a);return a},_deserialize:function(){var a=this.input.val();return this.data=JSON.parse(a)},_storeHierarchyData:function(a,b){var c;if(b)for(c in b)h[c]=b[c];if(a)for(c in a)l[c]=a[c]},_jsLoaded:function(){var a=new jQuery.Deferred;setTimeout(function c(){S3.gis.maps!=
...
h.val();if(!this.input){var a=d("<div>").hide().insertAfter(h),b=d('<input type="text" class="dms-input" size="18">').hide();this.decimalInput=b;var c=l.labels,e=d('<input type="text" class="integer dms-input" size="5">'),f=d('<span class="dms-label">'+c.deg+"</span>"),g=d('<input type="text" class="integer dms-input" size="5">'),m=d('<span class="dms-label">'+c.min+"</span>"),q=d('<input type="text" class="double dms-input" size="8">'),c=d('<span class="dms-label">'+c.sec+"</span>");this.degInput=
e;this.minInput=g;this.secInput=q;this.dmsInput=e=d("<span>").append(e).append(f).append(g).append(m).append(q).append(c).hide();this.input=a.append(b).append(e).show()}this._removeErrors();"dms"==l.mode?(h=this._getDMS(),this.degInput.val(h.d),this.minInput.val(h.m),this.secInput.val(h.s),this.decimalInput.hide(),this.dmsInput.show()):(this.decimalInput.val(h.val()),this.dmsInput.hide(),this.decimalInput.show());this._bindEvents()},_getDMS:function(){var h=d(this.element).val();if(isNaN(parseFloat(h))||
...
(b=e[0]||e[7])&&(b=a[b]);a=[];var c=[],q,p,k;for(k=1;6>k;k+=2)q=e[k],(p=e[k+1])?(a.push(parseFloat(q)||0),c.push(p)):q&&(a.push(parseFloat(q)),c.push(null));if(e=a.length){for(k=1;k<e;k++)a[k]=Math.abs(a[k]);q=a[0];Math.abs(q)!=q&&(b=1);if(1==e)p=c[0],'"'==p?m=a[0]:"'"==p?g=a[0]:p&&"\u00b0"!=p||(f=a[0]);else if(2==e)if(e=c[0],c=c[1],"\u00b0"==e)f=a[0],'"'==c?m=a[1]:"'"!=c&&c||(g=a[1]);else if(e){if("'"!=e||c&&'"'!=c)return null;g=a[0];m=a[1]}else'"'==c?(g=a[0],m=a[1]):"'"!=c&&c||(f=a[0],g=a[1]);else{if(c[0]&&
