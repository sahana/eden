...
a.lat||a.lon||a.wkt?(this.input.data("manually_geocoded",!0),this._showMap()):this._hideMap();this._bindEvents()},_renderWidget:function(){var a="#"+this.fieldname,b=this.options.reverseLx,c=d(a+"_map_icon__row .map_wrapper");c.attr("id",this.fieldname+"_map_wrapper");var e=d(a+"__row"),f=this.input.next(".error_wrapper"),g=d(a+"_map_icon__row"),k=d(a+"_L0__row"),l=d(a+"_postcode__row");if(e.is(".control-group, .form-row")){var m=d(a+"_L1__row"),h=d(a+"_L2__row"),r=d(a+"_L3__row"),p=d(a+"_L4__row"),
q=d(a+"_L5__row"),a=d(a+"_address__row");b?e.hide().after(c).after(g).after(k).after(m).after(h).after(r).after(p).after(q).after(l).after(a).after(f):e.hide().after(c).after(g).after(l).after(a).after(q).after(p).after(r).after(h).after(m).after(k).after(f)}else e.parent().is(".inline-form")?e.show():(d(a+"__row1").hide(),e.hide().after(f),b?k.after(c).after(g):l.after(c).after(g));if(f.length)f.one("click"+this.namespace,function(){var a=d(this);a.fadeOut("slow",function(){a.remove()})})},_lxSelect:function(a,
b,c){var e="#"+this.fieldname,f=this.options,g=d(e+"_L"+a);b?(g.val(b),g.hasClass("multiselect")&&g.multiselect("instance")&&g.multiselect("refresh")):b=parseInt(g.val());if(0===a){var k=this._readLabels(b),l=u.d,m=["1","2","3","4","5"],h,r,p,q;for(p=0;5>p;p++)g=m[p],h=k[g]||l[g],q=e+"_L"+g,g=d(q),r=g.hasClass("required")?"<div>"+h+':<span class="req"> *</span></div>':h+":",d(q+"__row label").html(r),d(q+"__row1 label").html(r),d(q+' option[value=""]').html(i18n.select+" "+h),g.hasClass("multiselect")&&
g.multiselect("instance")&&g.multiselect("refresh")}p=f.hideLx;for(g=a+1;6>g;g++)q=e+"_L"+g,p?(d(q+"__row").hide(),d(q+"__row1").hide()):d(q+" option").remove('[value != ""]'),d(q).val("");if(b)if(q=a+1,f=d(e+"_L"+q+"__row"),f.length){var s;if(d(e+"_L"+a+' option[value="'+b+'"]').hasClass("missing"))h=t[b],h.i=b,l=[h];else{p=!0;for(s in t)if(t[s].f==b){p=!1;break}p&&this._readHierarchy(b,q);l=[];for(s in t)h=t[s],h.f==b&&(h.i=s,l.push(h))}if(a=l.length){l.sort(function(a,b){return a.n.localeCompare(b.n)});
s=e+"_L"+q;k=d(s);m=d(s+' option[value=""]').html();d(s+" option").remove('[value != ""]');s=null;for(p=0;p<a;p++)h=l[p],s=h.i,g=b==s?' selected="selected"':"",r=h.l==q?"":' class="missing"',h='<option value="'+s+'"'+g+r+">"+h.n+"</option>",k.append(h);f.removeClass("hide").show();d(e+"_L"+q+"__row1").removeClass("hide").show();k.hasClass("multiselect")&&(b={header:"",height:300,minWidth:0,selectedList:1,noneSelectedText:m,multiple:!1},k.hasClass("search")?(k.multiselect(b).multiselectfilter({label:"",
placeholder:i18n.search}),d(".ui-multiselect-header").show()):(b.header=!1,k.multiselect(b)));1==a&&s&&this._lxSelect(q,s,c)}}else this.useGeocoder&&!c&&this._geocodeDecision();c?this._serialize():this._collectData();this._zoomMap()},_collectData:function(){var a=this.data,b="#"+this.fieldname,c=this._lookupParent(),e=d(b+"_address").val(),b=d(b+"_postcode").val();a.address=e;a.postcode=b;if(a.specific)a.id=a.specific,a.parent=c;else{var f=a.lat,g=a.lon,k=a.wkt;e||b||f||g||k?(a.id=null,a.parent=c):
...
d(c+"_map_icon span").html(f)},_zoomMap:function(a){var b=this.fieldname,c=S3.gis;if(c.maps&&(b=c.maps["location_selector_"+b])){var d=this.data,c=d.lat,f=d.lon,d=d.wkt,g;if(c&&f)g=[f,c,f,c];else if(d)a=new OpenLayers.Feature.Vector(OpenLayers.Geometry.fromWKT(d)),S3.gis.zoomBounds(b,a.geometry.getBounds());else if(a||(a=this._lookupParent()||"d"),g=t[a].b,!g||!g.length)for(c=t[a].f,a=4;c&&a&&(a--,c=t[c],!(g=c.b)&&0!==c.l);)c=c.f;g&&(g=OpenLayers.Bounds.fromArray(g),S3.gis.zoomBounds(b,g))}},_submitForm:function(){var a=
