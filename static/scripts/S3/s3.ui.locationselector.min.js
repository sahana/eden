...
this.data,b="#"+this.fieldname,c=this._lookupParent(),e=d(b+"_address").val(),f=d(b+"_postcode").val();a.address=e;a.postcode=f;if(a.specific)a.id=a.specific,a.parent=c;else{var g=a.lat,m=a.lon,h=a.wkt;e||f||g||m||h?(a.id=null,a.parent=c):(a.id=c,a.parent=null)}this._serialize();d(b+"_lat").val(a.lat).trigger("setvalue");d(b+"_lon").val(a.lon).trigger("setvalue");this.input.data("input",this._hasData());"sub_"==this.fieldname.slice(0,4)&&this.input.change()},_collectLx:function(){var a=this.data,
b="#"+this.fieldname,c,e;for(e=0;6>e;e++)c=d(b+"_L"+e),c.length&&(c=c.val(),a["L"+e]=c?parseInt(c,10):null);this._serialize()},_hasData:function(){var a=this.data,b=!1;a.specific||a.address||a.postcode||a.lat||a.lon||a.wkt?b=!0:[a.L0,a.L1,a.L2,a.L3,a.L4,a.L5].join("|")!=this.lx&&(b=!0);return b},_lookupParent:function(){this._collectLx();var a=this.data;parent;for(var b=5;-1<b;b--)if(parent=a["L"+b])return parent;return(a=h.d)?a.i:null},_readLabels:function(a){a||(a="d");var b=l[a];if(b==x){var c=
S3.Ap.concat("/gis/hdata/"+a);d.ajaxS3({async:!1,url:c,dataType:"script",success:function(c){b={};try{for(var d in n)b[d]=n[d];l[a]=b;n=null}catch(g){}},error:function(a,b,c){s3_debug("UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText)}})}return b},_readHierarchy:function(a,b){var c="#"+this.fieldname,e=d(c+"_L"+b),f=!1;e.hide();if(e.hasClass("multiselect"))var f=!0,g=d(c+"_L"+b+"__row button").hide();var m=d(c+"_L"+b+"__throbber").removeClass("hide").show(),c=S3.Ap.concat("/gis/ldata/"+a);
d.ajaxS3({async:!1,url:c,dataType:"script",success:function(a){for(var b in n)h[b]=n[b];n=null;m.hide();f?g.removeClass("hide").show():e.removeClass("hide").show()},error:function(a,b,c){a="UNAUTHORIZED"==c?i18n.gis_requires_login:a.responseText;s3_debug(a);S3.showAlert(a,"error");m.hide();f?g.removeClass("hide").show():e.removeClass("hide").show()}})},_geocodeDecision:function(){var a="#"+this.fieldname,b=this.data;this._collectData();if(b.address){for(var b=["1","2","3","4","5"],c=0,e;5>c;c++)if(e=
...
c.length&&a&&d("html,body").animate({scrollTop:c.offset().top},250);var g=this.input;d.when(this._jsLoaded()).then(function(a){var c=S3.gis;a="location_selector_"+b;var h;h=c.maps[a]?c.maps[a]:c.show_map(a);e._zoomMap();var k=e.data;a=k.lat;var l=k.lon,r=k.wkt;if(a||l||r)h.s3.draftLayer.removeAllFeatures(),r!=x&&r?(a={internalProjection:h.getProjectionObject(),externalProjection:c.proj4326},a=(new OpenLayers.Format.WKT(a)).read(r)):(a=new OpenLayers.Geometry.Point(parseFloat(l),parseFloat(a)),a.transform(c.proj4326,
h.getProjectionObject()),a=new OpenLayers.Feature.Vector(a)),h.s3.draftLayer.addFeatures([a]),h.s3.lastDraftFeature=a;a=h.controls;for(var t,l=0,u=a.length;l<u;l++)if("OpenLayers.Control.DrawFeature"==a[l].CLASS_NAME){t=a[l];break}t&&(h.s3.pointPlaced=function(a){d(f+"_geocode .geocode_fail").hide();d(f+"_geocode .geocode_success").hide();var b=a.geometry;"OpenLayers.Geometry.Point"==b.CLASS_NAME?(a=b.getBounds().getCenterLonLat(),a.transform(h.getProjectionObject(),c.proj4326),k.wkt=null,k.lat=a.lat,
k.lon=a.lon,!k.address&&this.useGeocoder&&e._geocodeReverse()):(b={internalProjection:h.getProjectionObject(),externalProjection:c.proj4326},r=(new OpenLayers.Format.WKT(b)).write(a),k.wkt=r,k.lat=null,k.lon=null);g.data("manually_geocoded",!0);e._collectData();e._removeErrors()})},function(a){s3_debug(a)},function(a){s3_debug(a)})},_hideMap:function(){var a=this.fieldname,b=this.namespace,c="#"+a,e=this;d(c+"_map_icon").unbind(b).bind("click"+b,function(a){e._showMap(a)});d(c+"_map_wrapper").slideUp("medium");
