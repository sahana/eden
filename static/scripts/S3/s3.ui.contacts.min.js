/*
 ...
 @license MIT
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,g,f){b instanceof String&&(b=String(b));for(var c=b.length,a=0;a<c;a++){var d=b[a];if(g.call(f,d,a,b))return{i:a,v:d}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(b,g,f){b!=Array.prototype&&b!=Object.prototype&&(b[g]=f.value)};$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};
$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,g,f,c){if(g){f=$jscomp.global;b=b.split(".");for(c=0;c<b.length-1;c++){var a=b[c];a in f||(f[a]={});f=f[a]}b=b[b.length-1];c=f[b];g=g(c);g!=c&&null!=g&&$jscomp.defineProperty(f,b,{configurable:!0,writable:!0,value:g})}};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,f){return $jscomp.findInternal(this,b,f).v}},"es6-impl","es3");
...
e=d.access,l=d.personID,m=d.controller,a=S3.Ap.concat("/pr/contact/create.iframe?person="+l);e&&(a+="&access="+e);b.get(a,function(a){var k=b('<div class="iframe-container">').hide().html(a);a=S3.Ap.concat("/pr/contact/create?person="+l+"&controller="+m);e&&(a+="&access="+e);var h=k.find("form").attr("action",a);a=b('<a class="cancel action-lnk">'+d.cancelButtonText+"</a>").bind("click",function(){h.slideUp("mediun",function(){k.remove()});b(c).show()});h.find('input[type="submit"]').after(a);k.find("#popup").show();
h.show();k.insertAfter(c).slideDown("medium",function(){b(c).siblings(".throbber").hide()})})},_addEmergencyContact:function(c){var a=b(c);b(".iframe-container").remove();this._showAll();a.hide().siblings(".throbber").removeClass("hide").show();var d=this.options,e=d.access,l=d.personID,m=d.controller,a=S3.Ap.concat("/pr/contact_emergency/create.iframe?person_id="+l);e&&(a+="&access="+e);b.get(a,function(a){var f=b('<div class="iframe-container">').hide().html(a);a=S3.Ap.concat("/pr/contact_emergency/create?person="+
l+"&controller="+m);e&&(a+="&access="+e);var h=f.find("form").attr("action",a);a=b('<a class="cancel action-lnk">'+d.cancelButtonText+"</a>").bind("click",function(){h.slideUp("mediun",function(){f.remove()});b(c).show()});h.find('input[type="submit"]').after(a);h.show();f.insertAfter(c).slideDown("medium",function(){b(c).siblings(".throbber").hide()})})},_editContact:function(c){var a=b(c),d=this.options,e=this;b(".iframe-container").remove();this._showAll();a.find(".pr-contact-actions").children().toggle();
var l=d.personID,m=d.controller,f=a.data("id"),g=d.access;c=S3.Ap.concat("/pr/contact/"+f+".iframe/update?person="+l);b.get(c,function(c){var h=b('<div class="iframe-container">').hide().html(c);c=S3.Ap.concat("/pr/contact/"+f+"/update?person="+l+"&controller="+m);g&&(c+="&access="+g);var k=h.find("form").attr("action",c);c=b('<a class="cancel action-lnk">'+d.cancelButtonText+"</a>").bind("click",function(){k.slideUp("mediun",function(){h.remove()});e._showAll()});k.find('input[type="submit"]').after(c);
a.after(h).hide();k.show();h.slideDown("medium")})},_editEmergencyContact:function(c){var a=b(c),d=this.options,e=this;b(".iframe-container").remove();this._showAll();a.find(".pr-contact-actions").children().toggle();var l=d.personID,m=d.controller,f=a.data("id"),g=d.access;c=S3.Ap.concat("/pr/contact_emergency/"+f+".iframe/update?person="+l);b.get(c,function(c){var k=b('<div class="iframe-container">').hide().html(c);c=S3.Ap.concat("/pr/contact_emergency/"+f+"/update?person="+l+"&controller="+m);
g&&(c+="&access="+g);var h=k.find("form").attr("action",c);c=b('<a class="cancel action-lnk">'+d.cancelButtonText+"</a>").bind("click",function(){h.slideUp("mediun",function(){k.remove()});e._showAll()});h.find('input[type="submit"]').after(c);a.after(k).hide();h.show();k.slideDown("medium")})},_deleteContact:function(c){if(confirm(i18n.delete_confirmation)){var a=c.data("id");b.post(S3.Ap.concat("/pr/contact/"+a+"/delete.json"));c.hide()}},_deleteEmergencyContact:function(c){if(confirm(i18n.delete_confirmation)){var a=
