...
cssclass:"pr-contacts-editable",data:function(b){for(var c="{",l=1;10>l;l++)c+='"'+l+'":"'+l+'",';return c+('"selected":"'+b+'"}')},type:"select",submit:"ok"});return!0},_unbindEvents:function(){var a=d(this.element),e=this.eventNamespace;a.undelegate(e);a.find(".pr-contact-add, .pr-emergency-add, .pr-contact-form").unbind(e);return!0}})})(jQuery);
