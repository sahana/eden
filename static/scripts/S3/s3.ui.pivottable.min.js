...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,q,m){b instanceof String&&(b=String(b));for(var a=b.length,d=0;d<a;d++){var c=b[d];if(q.call(m,c,d,b))return{i:d,v:c}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,q,m){b!=Array.prototype&&b!=Object.prototype&&(b[q]=m.value)};$jscomp.getGlobal=function(b){b=["object"==typeof globalThis&&globalThis,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,b];for(var q=0;q<b.length;++q){var m=b[q];if(m&&m.Math==Math)return m}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(b,q,m,a){if(q){m=$jscomp.global;b=b.split(".");for(a=0;a<b.length-1;a++){var d=b[a];d in m||(m[d]={});m=m[d]}b=b[b.length-1];a=m[b];q=q(a);q!=a&&null!=q&&$jscomp.defineProperty(m,b,{configurable:!0,writable:!0,value:q})}};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,m){return $jscomp.findInternal(this,b,m).v}},"es6","es3");
(function(b,q){var m=0;b.widget("s3.pivottable",{options:{showTotals:!0,ajaxURL:null,defaultChart:{type:"breakdown",axis:"rows"},renderFilter:!0,renderOptions:!0,renderChart:!0,renderTable:!0,collapseFilter:!1,collapseOptions:!0,collapseChart:!0,collapseTable:!1,exploreChart:!1,filterURL:null,filterForm:null,filterTab:null,autoSubmit:1E3,timeout:1E4,thousandSeparator:" ",thousandGrouping:"3",minTickSize:null,precision:null,textAll:"All",labelRecords:"Records"},_create:function(){this.id=m;m+=1;this.openRequest=
...
this._bindEvents();a.find(".pt-throbber").hide()},_renderTable:function(){var a=b(this.element),d=a.find(".pt-table").first().empty();this.table=null;var c=this.data;if(!c.empty)if(this.options.renderTable){var e=c.cells.slice(0),f=c.cols,h=c.rows,k=c.total,g=c.labels,l=!1,r=!1;c=c.facts;1==c.length&&"list"!=c[0][1]&&(1==h.length&&null===h[0][4]&&(l=!0),1==f.length&&null===f[0][4]&&(r=!0));c=this.options;var t=c.showTotals,p;if(r&&t)for(f=[],p=0;p<h.length;p++)e[p]=[];else{var w=function(a,b){return"__other__"!=
f[b][0]};for(p=0;p<h.length;p++)e[p]=e[p].filter(w);f=f.filter(function(a){return"__other__"!=a[0]})}l&&t?(h=[],e=[]):(e=e.filter(function(a,b){return"__other__"!=h[b][0]}),h=h.filter(function(a){return"__other__"!=a[0]}));d=d3.select(d.get(0)).append("table").attr("class","dataTable display report");d.append("thead").call(this._renderHeader,f,g,c).call(this._renderColumns,f,g,r);l&&t||d.append("tbody").call(this._renderRows,this,h,f,g,e,c);t&&d.append("tfoot").call(this._renderFooter,h,f,g,k);this.table=
...
"pt-total").text(f);return a},_renderChartOptions:function(){var a=b(this.element),d=a.find(".pt-chart-controls").first().empty(),c=this.data;if(!c.empty&&this.options.renderChart){c=c.labels;var e=a.attr("id");a=c.layer;var f=c.rows,h=c.cols,k=c.per,g=b('<div class="pt-chart-opts">'),l=e+"-pchart-rows",r=e+"-vchart-rows",t=e+"-hchart-rows",p=e+"-schart-rows",w=e+"-pchart-cols",n=e+"-vchart-cols",m=e+"-hchart-cols";e+="-schart-cols";a&&b(g).append(b('<span class="pt-chart-label">'+a+": </span>"));
f&&b(g).append(b('<div id="'+l+'" class="pt-chart-icon pt-pchart"/><div id="'+r+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+k+" "+f+"</span>"));h&&b(g).append(b('<div id="'+w+'" class="pt-chart-icon pt-pchart"/><div id="'+n+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+k+" "+h+"</span>"));f&&h&&b(g).append(b('<span class="pt-chart-label">| '+c.breakdown+': </span><div id="'+p+'" class="pt-chart-icon pt-schart"/><div id="'+t+'" class="pt-chart-icon pt-hchart"/><span class="pt-chart-label">'+
...
e;"__other__"==a.data.filterIndex&&(c+="__belongs");n._chartExplore([[c,b]])});nv.utils.windowResize(a.update);return a})}},_renderBreakDown:function(a,d,c,e){var f=this.chart;if(f){b(f).closest(".pt-chart-contents").show().css({width:"96%"});var h=a.cells,k=[],g=[];if(0===d){var l=a.rows;var r=a.cols;a=function(a,b){return h[k[a]][g[b]].v[0]};var t=e[0];var p=e[1]}else l=a.cols,r=a.rows,a=function(a,b){return h[g[b]][k[a]].v[0]},t=e[1],p=e[0];var m;e=[];d=[];var n=0;for(m=l.length;n<m;n++)l[n][1]||
(e.push(l[n]),k.push(n));n=0;for(m=r.length;n<m;n++)r[n][1]||(d.push(r[n]),g.push(n));var q=[];for(l=0;l<d.length;l++){r={key:d[l][4],filterIndex:d[l][0],filterKey:d[l][3]};n=[];for(m=0;m<e.length;m++)n.push({label:e[m][4],filterIndex:e[m][0],filterKey:e[m][3],value:a(m,l)});r.values=n;q.push(r)}a=Math.max(e.length*Math.max(16*(d.length+1),50)+70,360);b(f).css({height:a+"px"});c?b(f).siblings(".pt-chart-title").html("<h4>"+c+"</h4>"):b(f).siblings(".pt-chart-title").empty();var y=function(a){var b=
a.series[0];a=a.data;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+nv.utils.defaultColor()({},a.index)+'">'+b.key+'</div><div class="pt-tooltip-text">'+a.label+': <span class="pt-tooltip-value">'+a.value+"</span></div></div>"},z=this,u=this.options.numberFormatter,A=this._truncateLabel;nv.addGraph(function(){var a=nv.models.multiBarHorizontalChart().x(function(a){return a.label}).y(function(a){return a.value}).margin({top:20,right:20,bottom:20,left:175}).showValues(!0).duration(350).showControls(!0);
a.tooltip.contentGenerator(y);a.valueFormat(u);a.yAxis.tickFormat(u);a.xAxis.tickFormat(function(a){return A(a,24)});d3.select(b(f).get(0)).append("svg").attr("class","nv").datum(q).call(a);if(z.options.exploreChart&&t&&p)a.multibar.dispatch.on("elementClick",function(a){a=a.data;var b=d3.event.currentTarget.parentElement.__data__,c=b.filterKey;null===c&&(c="None");b="__other__"==b.filterIndex?p+"__belongs":p;var d=a.filterKey;null===d&&(d="None");z._chartExplore([["__other__"==a.filterIndex?t+"__belongs":
t,d],[b,c]])});nv.utils.windowResize(a.update);return a})}},_renderSpectrum:function(a,d,c){var e=this.chart;if(e){var f=this,h=a.cells,k=a.labels;if("rows"==d){var g=a.rows;var l=a.cols;d=k.rows;var r=k.cols;var m=c[0];var p=c[1];var w=function(a,b){return h[a][b]}}else g=a.cols,l=a.rows,d=k.cols,r=k.rows,m=c[1],p=c[0],w=function(a,b){return h[b][a]};var n=function(a,b){return null===a?l[b]:null===b?g[a]:w(a,b)},C=function(a,b){b===q&&(b="silver");for(var c=[],d,e,f=0;f<l.length;f++)d=n(null,f),
e=null===a?d[2][0]:n(a,f).v[0],!d[1]&&0<=d[2][0]&&c.push({filterIndex:d[0],filterKey:d[3],label:d[4],value:e,color:b});return c},y=[],z=0;for(c=0;c<g.length;c++){var u=n(c,null);!u[1]&&0<=u[2][0]&&(y.push({position:c,filterIndex:u[0],filterKey:u[3],label:u[4],value:u[2][0]}),z+=u[2][0])}f.chartOptions.currentDataIndex=null;b(e).removeAttr("style").closest(".pt-chart-contents").css({width:"98%",height:"auto"}).show();b(e).siblings(".pt-chart-title").empty();c=b('<div class="pt-spectrum-pie">').appendTo(e);
e=b('<div class="pt-spectrum-bar">').appendTo(e);var A=this.options.numberFormatter,H=this._truncateLabel,v=nv.models.discreteBarChart().x(function(a){return a.label}).y(function(a){return a.value}).color(["silver"]).staggerLabels(!0).showValues(!0);v.tooltip.contentGenerator(function(a){a=a.data;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+(a.color||["silver"])+'">'+a.label+'</div><div class="pt-tooltip-text">'+A(a.value)+"</div></div>"});v.valueFormat(A);v.yAxis.tickFormat(A);
v.xAxis.tickFormat(function(a){return H(a,18)});var D=d3.select(b(e).get(0)).append("svg").attr("class","nv");e=Math.floor(c.width()/2)-30;var x=nv.models.pieChart().x(function(a){return a.label}).y(function(a){return a.value}).height(280).width(e).margin({top:-20,left:20}).labelType("percent").labelThreshold(.1).showLegend(!1).donut(!0).donutRatio(.35);x.tooltip.enabled(!1);x.legend.align(!0).rightAlign(!1);x.pie.startAngle(function(a){return a.startAngle/2-Math.PI/2}).endAngle(function(a){return a.endAngle/
...
h=!1;if(1<e.length){var k=e[1];k=k.split("&")}else k="",k=[];if(a)for(m in a){var g=a[m];var l=m+"="+g;"totals"==m?this.options.showTotals=g?!0:!1:h||-1!=b.inArray(l,k)||(h=!0);f.push(l)}var m={};var q={},p;if(d){var w=function(a){var b,c,d=[];["contains","anyof","belongs","eq"].forEach(function(e){b=new RegExp("__"+e+"$","g");a.match(b)?c=b:d.push(e)});c&&d.forEach(function(b){q[a.replace(c,"__"+b)]=!0})};g=0;for(p=d.length;g<p;g++){l=d[g];var n=l[0];l=l[1];w(n);null===l?m[n]||(q[n]=!0):(q[n]&&(q[n]=
!1),l=n+"="+encodeURIComponent(l),m[n]?m[n].push(l):m[n]=[l])}}g=0;for(p=k.length;g<p;g++)l=k[g].split("="),1<l.length&&(n=decodeURIComponent(l[0]),l=decodeURIComponent(l[1]),q[n]?h=!0:m[n]?h||-1!=b.inArray(n+"="+l,m[n])||(h=!0):"aggregate"!=n&&(a&&a.hasOwnProperty(n)||f.push(k[g])));for(n in m)for(g=0,p=m[n].length;g<p;g++)h||-1!=b.inArray(m[n][g],k)||(h=!0),f.push(m[n][g]);a=f.join("&");e=e[0];a&&(e=e+"?"+a);if(c)return e;this.options.ajaxURL=e;return h},_setExtension:function(a,b){var c=document.createElement("a");
