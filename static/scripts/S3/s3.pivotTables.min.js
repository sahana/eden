...
{value:u[a],enumerable:!1})}catch(l){c.prototype=u}}function q(){}function p(c){return eb+c in this}function f(){var c=[];this.forEach(function(u){c.push(u)});return c}function g(){var c=0,u;for(u in this)u.charCodeAt(0)===Rb&&++c;return c}function t(){for(var c in this)if(c.charCodeAt(0)===Rb)return!1;return!0}function r(){}function I(c,u,a){return function(){var l=a.apply(u,arguments);return l===u?c:l}}function B(c,u){if(u in c)return u;u=u.charAt(0).toUpperCase()+u.substring(1);for(var a=0,l=Rd.length;a<
l;++a){var h=Rd[a]+u;if(h in c)return h}}function A(){}function E(){}function D(c){function u(){for(var u=a,l=-1,ga=u.length,x;++l<ga;)(x=u[l].on)&&x.apply(this,arguments);return c}var a=[],l=new q;u.on=function(u,n){var ga=l.get(u),x;if(2>arguments.length)return ga&&ga.on;ga&&(ga.on=null,a=a.slice(0,x=a.indexOf(ga)).concat(a.slice(x+1)),l.remove(u));n&&a.push(l.set(u,{on:n}));return c};return u}function L(){w.event.preventDefault()}function S(){for(var c=w.event,u;u=c.sourceEvent;)c=u;return c}function C(c){for(var u=
...
(c?Math.ceil(Math.log(c)/Math.LN10):1)}function mg(c){var a=c.decimal,e=c.thousands,l=c.grouping,h=c.currency,n=l?function(c){for(var a=c.length,u=[],h=0,n=l[0];0<a&&0<n;)u.push(c.substring(a-=n,a+n)),n=l[h=(h+1)%l.length];return u.reverse().join(e)}:wa;return function(c){c=ee.exec(c);var e=c[1]||" ",l=c[2]||">",b=c[3]||"",m=c[4]||"",f=c[5],g=+c[6],k=c[7],p=c[8],r=c[9],t=1,q="",z="",y=!1;p&&(p=+p.substring(1));if(f||"0"===e&&"="===l)f=e="0",l="=",k&&(g-=Math.floor((g-1)/4));switch(r){case "n":k=!0;
r="g";break;case "%":t=100;z="%";r="f";break;case "p":t=100;z="%";r="r";break;case "b":case "o":case "x":case "X":"#"===m&&(q="0"+r.toLowerCase());case "c":case "d":y=!0;p=0;break;case "s":t=-1,r="r"}"$"===m&&(q=h[0],z=h[1]);"r"!=r||p||(r="g");if(null!=p)if("g"==r)p=Math.max(1,Math.min(21,p));else if("e"==r||"f"==r)p=Math.max(0,Math.min(20,p));var r=ng.get(r)||og,Q=f&&k;return function(c){var h=z;if(y&&c%1)return"";var ga=0>c||0===c&&0>1/c?(c=-c,"-"):b;0>t?(h=w.formatPrefix(c,p),c=h.scale(c),h=h.symbol+
z):c*=t;c=r(c,p);var m=c.lastIndexOf("."),Pa=0>m?c:c.substring(0,m);c=0>m?"":a+c.substring(m+1);!f&&k&&(Pa=n(Pa));var m=q.length+Pa.length+c.length+(Q?0:ga.length),C=m<g?Array(m=g-m+1).join(e):"";Q&&(Pa=n(C+Pa));ga+=q;c=Pa+c;return("<"===l?ga+c+C:">"===l?C+ga+c:"^"===l?C.substring(0,m>>=1)+ga+c+C.substring(m):ga+(Q?c:C+c))+h}}}function og(c){return c+""}function Ta(){this._=new Date(1<arguments.length?Date.UTC.apply(this,arguments):arguments[0])}function fb(c,a,e){function l(a){var u=c(a),e=n(u,1);
...
M:function(c,a){return Ca(c.getMinutes(),a,2)},p:function(c){return b[+(12<=c.getHours())]},S:function(c,a){return Ca(c.getSeconds(),a,2)},U:function(c,a){return Ca(Z.sundayOfYear(c),a,2)},w:function(c){return c.getDay()},W:function(c,a){return Ca(Z.mondayOfYear(c),a,2)},x:a(h),X:a(n),y:function(c,a){return Ca(c.getFullYear()%100,a,2)},Y:function(c,a){return Ca(c.getFullYear()%1E4,a,4)},Z:rg,"%":function(){return"%"}},Q={a:function(c,a,u){p.lastIndex=0;return(a=p.exec(a.substring(u)))?(c.w=r.get(a[0].toLowerCase()),
u+a[0].length):-1},A:function(c,a,u){g.lastIndex=0;return(a=g.exec(a.substring(u)))?(c.w=k.get(a[0].toLowerCase()),u+a[0].length):-1},b:function(c,a,u){z.lastIndex=0;return(a=z.exec(a.substring(u)))?(c.m=C.get(a[0].toLowerCase()),u+a[0].length):-1},B:function(c,a,u){t.lastIndex=0;return(a=t.exec(a.substring(u)))?(c.m=q.get(a[0].toLowerCase()),u+a[0].length):-1},c:function(c,a,u){return e(c,y.c.toString(),a,u)},d:ge,e:ge,H:he,I:he,j:sg,L:tg,m:ug,M:vg,p:function(c,a,u){a=f.get(a.substring(u,u+=2).toLowerCase());
return null==a?-1:(c.p=a,u)},S:wg,U:xg,w:yg,W:zg,x:function(c,a,u){return e(c,y.x.toString(),a,u)},X:function(c,a,u){return e(c,y.X.toString(),a,u)},y:Ag,Y:Bg,Z:Cg,"%":Dg};return a}function Ca(c,a,e){var l=0>c?"-":"";c=(l?-c:c)+"";var h=c.length;return l+(h<e?Array(e-h+1).join(a)+c:c)}function ac(c){return new RegExp("^(?:"+c.map(w.requote).join("|")+")","i")}function bc(c){for(var a=new q,e=-1,l=c.length;++e<l;)a.set(c[e].toLowerCase(),e);return a}function yg(c,a,e){ua.lastIndex=0;return(a=ua.exec(a.substring(e,
...
x[c])[0],X[1]);else l(ea.x,ea.p.x,-1,h);ea=ea.p}ea=ea.o;x=ea.z;m=!m}while(!ea.v);h.lineEnd()}}}function pe(c){if(a=c.length){for(var a,e=0,l=c[0],h;++e<a;)l.n=h=c[e],h.p=l,l=h;l.n=h=c[0];h.p=l}}function jc(c,a,e,l){this.x=c;this.z=a;this.o=e;this.e=l;this.v=!1;this.n=this.p=null}function qe(c,a,e,l){return function(h,n){function b(a,u){var e=h(a,u);c(a=e[0],u=e[1])&&n.point(a,u)}function x(c,a){var u=h(c,a);k.point(u[0],u[1])}function X(){r.point=x;k.lineStart()}function ea(){r.point=b;k.lineEnd()}
function m(c,a){Q.push([c,a]);var u=h(c,a);z.point(u[0],u[1])}function f(){z.lineStart();Q=[]}function g(){m(Q[0][0],Q[0][1]);z.lineEnd();var c=z.clean(),a=q.buffer(),u=a.length;Q.pop();C.push(Q);Q=null;if(u)if(c&1){var c=a[0],u=c.length-1,a=-1,e;if(0<u){y||(n.polygonStart(),y=!0);for(n.lineStart();++a<u;)n.point((e=c[a])[0],e[1]);n.lineEnd()}}else 1<u&&c&2&&a.push(a.pop().concat(a.shift())),t.push(a.filter(Gg))}var k=a(n),p=h.invert(l[0],l[1]),r={point:b,lineStart:X,lineEnd:ea,polygonStart:function(){r.point=
m;r.lineStart=f;r.lineEnd=g;t=[];C=[]},polygonEnd:function(){r.point=b;r.lineStart=X;r.lineEnd=ea;t=w.merge(t);var c,a=p;c=C;var u=a[0],l=a[1],h=[Math.sin(u),-Math.cos(u),0],x=0,m=0;gb.reset();for(var f=0,g=c.length;f<g;++f){var k=c[f],Pa=k.length;if(Pa)for(var q=k[0],Qa=q[0],a=q[1]/2+la/4,z=Math.sin(a),Td=Math.cos(a),Q=1;;){Q===Pa&&(Q=0);var a=k[Q],F=a[0],H=a[1]/2+la/4,K=Math.sin(H),H=Math.cos(H),v=F-Qa,O=0<=v?1:-1,V=O*v,U=V>la,z=z*K;gb.add(Math.atan2(z*O*Math.sin(V),Td*H+z*Math.cos(V)));x+=U?v+
O*Ea:v;U^Qa>=u^F>=u&&(q=sb(hb(q),hb(a)),fc(q),Qa=sb(h,q),fc(Qa),Qa=(U^0<=v?-1:1)*na(Qa[2]),l>Qa||l===Qa&&(q[0]||q[1]))&&(m+=U^0<=v?1:-1);if(!Q++)break;Qa=F;z=K;Td=H;q=a}}c=(-1E-6>x||1E-6>x&&0>gb)^m&1;t.length?(y||(n.polygonStart(),y=!0),oe(t,Hg,c,e,n)):c&&(y||(n.polygonStart(),y=!0),n.lineStart(),e(null,null,1,n),n.lineEnd());y&&(n.polygonEnd(),y=!1);t=C=null},sphere:function(){n.polygonStart();n.lineStart();e(null,null,1,n);n.lineEnd();n.polygonEnd()}},t,q=re(),z=a(q),y=!1,C,Q;return r}}function Gg(c){return 1<
...
Math.cos(c),n=0<h,b=1E-6<ma(h),x=bd(c,6*ka);return qe(a,function(c){var h,x,m,f,g;return{lineStart:function(){f=m=!1;g=1},point:function(k,r){var p=[k,r],q,t=a(k,r),z=n?t?0:l(k,r):t?l(k+(0>k?la:-la),r):0;!h&&(f=m=t)&&c.lineStart();t!==m&&(q=e(h,p),hc(h,q)||hc(p,q))&&(p[0]+=1E-6,p[1]+=1E-6,t=a(p[0],p[1]));if(t!==m)g=0,t?(c.lineStart(),q=e(p,h),c.point(q[0],q[1])):(q=e(h,p),c.point(q[0],q[1]),c.lineEnd()),h=q;else if(b&&h&&n^t){var y;z&x||!(y=e(p,h,!0))||(g=0,n?(c.lineStart(),c.point(y[0][0],y[0][1]),
...
a){var u=h(c,1),e=h(a,1);return u!==e?u-e:0===u?a[1]-c[1]:1===u?c[0]-a[0]:2===u?c[1]-a[1]:a[0]-c[0]}return function(x){function X(n,x,X,ea){var m=0,f=0;if(null==n||(m=h(n,X))!==(f=h(x,X))||0>b(n,x)^0<X){do ea.point(0===m||3===m?c:e,1<m?l:a);while((m=(m+X+4)%4)!==f)}else ea.point(x[0],x[1])}function ea(h,n){c<=h&&h<=e&&a<=n&&n<=l&&x.point(h,n)}function m(h,n){h=Math.max(-1E9,Math.min(1E9,h));n=Math.max(-1E9,Math.min(1E9,n));var b=c<=h&&h<=e&&a<=n&&n<=l;r&&q.push([h,n]);if(K)z=h,y=n,Q=b,K=!1,b&&(x.lineStart(),
x.point(h,n));else if(b&&H)x.point(h,n);else{var ga={a:{x:C,y:F},b:{x:h,y:n}};k(ga)?(H||(x.lineStart(),x.point(ga.a.x,ga.a.y)),x.point(ga.b.x,ga.b.y),b||x.lineEnd(),v=!1):b&&(x.lineStart(),x.point(h,n),v=!1)}C=h;F=n;H=b}var f=x,g=re(),k=se(c,a,e,l),p,r,q,t={point:ea,lineStart:function(){t.point=m;r&&r.push(q=[]);K=!0;H=!1;C=F=NaN},lineEnd:function(){p&&(m(z,y),Q&&H&&g.rejoin(),p.push(g.buffer()));t.point=ea;H&&x.lineEnd()},polygonStart:function(){x=g;p=[];r=[];v=!0},polygonEnd:function(){x=f;p=w.merge(p);
var a;a=[c,l];for(var u=0,e=r.length,h=a[1],b=0;b<e;++b)for(var ga=1,m=r[b],ea=m.length,g=m[0],k;ga<ea;++ga)k=m[ga],g[1]<=h?k[1]>h&&0<ca(g,k,a)&&++u:k[1]<=h&&0>ca(g,k,a)&&--u,g=k;a=0!==u;u=v&&a;e=p.length;if(u||e)x.polygonStart(),u&&(x.lineStart(),X(null,null,1,x),x.lineEnd()),e&&oe(p,n,a,X,x),x.polygonEnd();p=r=q=null}},z,y,Q,C,F,H,K,v;return t}}function ue(c,a){function e(e,h){return e=c(e,h),a(e[0],e[1])}c.invert&&a.invert&&(e.invert=function(e,h){return e=a.invert(e,h),e&&c.invert(e[0],e[1])});
...
l:e)(c)}function e(a){return Ae(a,function(u,e){u=c(u,e);a.point(u[0],u[1])})}function l(a){function u(e,l){e=c(e,l);a.point(e[0],e[1])}function e(){z=NaN;w.point=l;a.lineStart()}function l(u,e){var n=hb([u,e]),b=c(u,e);h(z,y,t,Q,C,H,z=b[0],y=b[1],t=u,Q=n[0],C=n[1],H=n[2],x,a);a.point(z,y)}function n(){w.point=u;a.lineEnd()}function b(){e();w.point=ga;w.lineEnd=m}function ga(c,a){l(f=c,a);g=z;k=y;p=Q;r=C;q=H;w.point=l}function m(){h(z,y,t,Q,C,H,g,k,f,p,r,q,x,a);w.lineEnd=n;n()}var f,g,k,p,r,q,t,z,
y,Q,C,H,w={point:u,lineStart:e,lineEnd:n,polygonStart:function(){a.polygonStart();w.lineStart=b},polygonEnd:function(){a.polygonEnd();w.lineStart=e}};return w}function h(a,u,e,l,x,m,f,g,k,p,r,q,t,z){var y=f-a,Q=g-u,C=y*y+Q*Q;if(C>4*n&&t--){var w=l+p,H=x+r,F=m+q,K=Math.sqrt(w*w+H*H+F*F),v=Math.asin(F/=K),O=1E-6>ma(ma(F)-1)||1E-6>ma(e-k)?(e+k)/2:Math.atan2(H,w),V=c(O,v),v=V[0],V=V[1],U=v-a,G=V-u,D=Q*U-y*G;if(D*D/C>n||.3<ma((y*U+Q*G)/C-.5)||l*p+x*r+m*q<b)h(a,u,e,l,x,m,v,V,O,w/=K,H/=K,F,t,z),z.point(v,
V),h(v,V,O,w,H,F,f,g,k,p,r,q,t,z)}}var n=.5,b=Math.cos(30*ka),x=16;a.precision=function(c){if(!arguments.length)return Math.sqrt(n);x=0<(n=c*c)&&16;return a};return a}function Ng(c){var a=ze(function(a,u){return c([a*ta,u*ta])});return function(c){return Be(a(c))}}function Ce(c){this.stream=c}function Ae(c,a){return{point:a,sphere:function(){c.sphere()},lineStart:function(){c.lineStart()},lineEnd:function(){c.lineEnd()},polygonStart:function(){c.polygonStart()},polygonEnd:function(){c.polygonEnd()}}}
function bb(c){return dd(function(){return c})()}function dd(c){function a(c){c=x(c[0]*ka,c[1]*ka);return[c[0]*m+z,y-c[1]*m]}function e(c){return(c=x.invert((c[0]-z)/m,(y-c[1])/m))&&[c[0]*ta,c[1]*ta]}function l(){x=ue(b=fd(r,q,t),n);var c=n(k,p);z=f-c[0]*m;y=g+c[1]*m;return h()}function h(){v&&(v.valid=!1,v=null);return a}var n,b,x,X=ze(function(c,a){c=n(c,a);return[c[0]*m+z,y-c[1]*m]}),m=150,f=480,g=250,k=0,p=0,r=0,q=0,t=0,z,y,Q=De,C=wa,H=null,F=null,v;a.stream=function(c){v&&(v.valid=!1);v=Be(Q(b,
...
k[f])&&g.prepare())for(r=g.edges,q=r.length,p=0;p<q;)if(t=r[p].end(),x=t.x,m=t.y,z=r[++p%q].start(),b=z.x,z=z.y,1E-6<ma(x-b)||1E-6<ma(m-z))r.splice(p,0,new nc(Tg(g.site,t,1E-6>ma(x-e)&&1E-6<n-m?{x:e,y:1E-6>ma(b-e)?z:n}:1E-6>ma(m-n)&&1E-6<l-x?{x:1E-6>ma(z-n)?b:l,y:n}:1E-6>ma(x-l)&&1E-6<m-h?{x:l,y:1E-6>ma(b-l)?z:h}:1E-6>ma(m-h)&&1E-6<x-e?{x:1E-6>ma(z-h)?b:e,y:h}:null),g.site,null)),++q}e={cells:lb,edges:Ab};yb=Jb=Ab=lb=null;return e}function Ug(c,a){return a.y-c.y||a.x-c.x}function Vg(c){return c.x}
...
c._pack_next=a;a._pack_prev=c;a._pack_next=e;e._pack_prev=a}function lf(c,a){c._pack_next=a;a._pack_prev=c}function mf(c,a){var e=a.x-c.x,l=a.y-c.y,h=c.r+a.r;return.999*h*h>e*e+l*l}function nf(c){function a(c){l=Math.min(c.x-c.r,l);h=Math.max(c.x+c.r,h);n=Math.min(c.y-c.r,n);b=Math.max(c.y+c.r,b)}if((e=c.children)&&(r=e.length)){var e,l=Infinity,h=-Infinity,n=Infinity,b=-Infinity,x,m,f,k,g,p,r;e.forEach(yh);x=e[0];x.x=-x.r;x.y=0;a(x);if(1<r&&(m=e[1],m.x=m.r,m.y=0,a(m),2<r))for(f=e[2],of(x,m,f),a(f),
td(x,f),x._pack_prev=f,td(f,m),m=x._pack_next,k=3;k<r;k++){of(x,m,f=e[k]);var q=0,t=1,z=1;for(g=m._pack_next;g!==m;g=g._pack_next,t++)if(mf(g,f)){q=1;break}if(1==q)for(p=x._pack_prev;p!==g._pack_prev&&!mf(p,f);p=p._pack_prev,z++);q?(t<z||t==z&&m.r<x.r?lf(x,m=g):lf(x=p,m),k--):(td(x,f),m=f,a(f))}x=(l+h)/2;m=(n+b)/2;for(k=g=0;k<r;k++)f=e[k],f.x-=x,f.y-=m,g=Math.max(g,f.r+Math.sqrt(f.x*f.x+f.y*f.y));c.r=g;e.forEach(zh)}}function yh(c){c._pack_next=c._pack_prev=c}function zh(c){delete c._pack_next;delete c._pack_prev}
...
function l(a,e){return w.range(c.length).map(function(c){return a+e*c})}var h,b,m;e.domain=function(l){if(!arguments.length)return c;c=[];h=new q;for(var b=-1,n=l.length,m;++b<n;)h.has(m=l[b])||h.set(m,c.push(m));return e[a.t].apply(e,a.a)};e.range=function(c){if(!arguments.length)return b;b=c;m=0;a={t:"range",a:arguments};return e};e.rangePoints=function(h,f){2>arguments.length&&(f=0);var k=h[0],g=h[1],p=(g-k)/(Math.max(1,c.length-1)+f);b=l(2>c.length?(k+g)/2:k+p*f/2,p);m=0;a={t:"rangePoints",a:arguments};
return e};e.rangeBands=function(h,f,k){2>arguments.length&&(f=0);3>arguments.length&&(k=f);var g=h[1]<h[0],p=h[g-0],r=(h[1-g]-p)/(c.length-f+2*k);b=l(p+r*k,r);g&&b.reverse();m=r*(1-f);a={t:"rangeBands",a:arguments};return e};e.rangeRoundBands=function(h,f,k){2>arguments.length&&(f=0);3>arguments.length&&(k=f);var g=h[1]<h[0],p=h[g-0],r=h[1-g],q=Math.floor((r-p)/(c.length-f+2*k));b=l(p+Math.round((r-p-(c.length-f)*q)/2),q);g&&b.reverse();m=Math.round(q*(1-f));a={t:"rangeRoundBands",a:arguments};return e};
...
e;)l=c[a],m.shift(),m.push(l[0]),x.shift(),x.push(l[1]),Dd(b,m,x);c.pop();b.push("L",l);return b.join("")}function Ga(c,a){return c[0]*a[0]+c[1]*a[1]+c[2]*a[2]+c[3]*a[3]}function Dd(c,a,e){c.push("C",Ga(If,a),",",Ga(If,e),",",Ga(Jf,a),",",Ga(Jf,e),",",Ga(db,a),",",Ga(db,e))}function Ed(c,a){return(a[1]-c[1])/(a[0]-c[0])}function Kf(c){for(var a,e=-1,l=c.length,b,n;++e<l;)a=c[e],b=a[0],n=a[1]+nb,a[0]=b*Math.cos(n),a[1]=b*Math.sin(n);return c}function Lf(c){function a(u){function f(){r.push("M",x(c(t),
p),g,k(c(q.reverse()),p),"Z")}for(var r=[],q=[],t=[],X=-1,z=u.length,y,Q=sa(e),C=sa(b),w=e===l?function(){return F}:sa(l),H=b===n?function(){return v}:sa(n),F,v;++X<z;)m.call(this,y=u[X],X)?(q.push([F=+Q.call(this,y,X),v=+C.call(this,y,X)]),t.push([+w.call(this,y,X),+H.call(this,y,X)])):q.length&&(f(),q=[],t=[]);q.length&&f();return r.length?r.join(""):null}var e=wb,l=wb,b=0,n=Ib,m=vb,x=Fa,f=x.key,k=x,g="L",p=.7;a.x=function(c){if(!arguments.length)return l;e=l=c;return a};a.x0=function(c){if(!arguments.length)return e;
...
l(e.call(c,c.__data__,m,x)))}:(e=l(e),function(c){c.__transition__[b].tween.set(a,e)}))}function Oh(c){null==c&&(c="");return function(){this.textContent=c}}function uc(c,a,e,l){var b=c.__transition__||(c.__transition__={active:0,count:0}),n=b[e];if(!n){var m=l.time,n=b[e]={tween:new q,time:m,ease:l.ease,delay:l.delay,duration:l.duration};++b.count;w.timer(function(l){function f(l){if(b.active>e)return g();b.active=e;n.event&&n.event.start.call(c,p,a);n.tween.forEach(function(e,l){(l=l.call(c,p,a))&&
y.push(l)});w.timer(function(){z.c=k(l||1)?vb:k;return 1},0,m)}function k(l){if(b.active!==e)return g();l/=t;for(var m=r(l),x=y.length;0<x;)y[--x].call(c,m);if(1<=l)return n.event&&n.event.end.call(c,p,a),g()}function g(){--b.count?delete b[e]:delete c.__transition__;return 1}var p=c.__data__,r=n.ease,q=n.delay,t=n.duration,z=Sa,y=[];z.t=q+m;if(q<=l)return f(l-q);z.c=f},0,m)}}function Of(c,a){c.attr("transform",function(c){return"translate("+a(c)+",0)"})}function Pf(c,a){c.attr("transform",function(c){return"translate(0,"+
...
e)for(;(m=c+e*++n)>a;)b.push(m/h);else for(;(m=c+e*++n)<a;)b.push(m/h);return b};w.map=function(c){var a=new q;if(c instanceof q)c.forEach(function(c,e){a.set(c,e)});else for(var e in c)a.set(e,c[e]);return a};k(q,{has:p,get:function(c){return this[eb+c]},set:function(c,a){return this[eb+c]=a},remove:function(c){c=eb+c;return c in this&&delete this[c]},keys:f,values:function(){var c=[];this.forEach(function(a,e){c.push(e)});return c},entries:function(){var c=[];this.forEach(function(a,e){c.push({key:a,
value:e})});return c},size:g,empty:t,forEach:function(c){for(var a in this)a.charCodeAt(0)===Rb&&c.call(this,a.substring(1),this[a])}});var eb="\x00",Rb=eb.charCodeAt(0);w.nest=function(){function c(a,u,h){if(h>=b.length)return m?m.call(e,u):n?u.sort(n):u;for(var f=-1,k=u.length,g=b[h++],p,r,t=new q,z;++f<k;)(z=t.get(p=g(r=u[f])))?z.push(r):t.set(p,[r]);a?(r=a(),u=function(e,b){r.set(e,c(a,b,h))}):(r={},u=function(e,b){r[e]=c(a,b,h)});t.forEach(u);return r}function a(c,e){if(e>=b.length)return c;
var n=[],m=h[e++];c.forEach(function(c,b){n.push({key:c,values:a(b,e)})});return m?n.sort(function(c,a){return m(c.key,a.key)}):n}var e={},b=[],h=[],n,m;e.map=function(a,e){return c(e,a,0)};e.entries=function(e){return a(c(w.map,e,0),0)};e.key=function(c){b.push(c);return e};e.sortKeys=function(c){h[b.length-1]=c;return e};e.sortValues=function(c){n=c;return e};e.rollup=function(c){m=c;return e};return e};w.set=function(c){var a=new r;if(c)for(var e=0,b=c.length;e<b;++e)a.add(c[e]);return a};k(r,
{has:p,add:function(c){this[eb+c]=!0;return c},remove:function(c){c=eb+c;return c in this&&delete this[c]},values:f,size:g,empty:t,forEach:function(c){for(var a in this)a.charCodeAt(0)===Rb&&c.call(this,a.substring(1))}});w.behavior={};w.rebind=function(c,a){for(var e=1,b=arguments.length,h;++e<b;)c[h=arguments[e]]=I(c,a,a[h]);return c};var Rd="webkit ms moz Moz o O".split(" ");w.dispatch=function(){for(var c=new E,a=-1,e=arguments.length;++a<e;)c[arguments[a]]=D(c);return c};E.prototype.on=function(c,
...
this.node().innerHTML};pa.append=function(c){c=z(c);return this.select(function(){return this.appendChild(c.apply(this,arguments))})};pa.insert=function(c,a){c=z(c);a=N(a);return this.select(function(){return this.insertBefore(c.apply(this,arguments),a.apply(this,arguments)||null)})};pa.remove=function(){return this.each(function(){var c=this.parentNode;c&&c.removeChild(this)})};pa.data=function(c,a){function e(c,e){var b,l=c.length,h=e.length,n=Math.min(l,h),m=Array(h),p=Array(h),r=Array(l),t,z;
if(a){var n=new q,y=new q,Q=[],C;for(b=-1;++b<l;)C=a.call(t=c[b],t.__data__,b),n.has(C)?r[b]=t:n.set(C,t),Q.push(C);for(b=-1;++b<h;)C=a.call(e,z=e[b],b),(t=n.get(C))?(m[b]=t,t.__data__=z):y.has(C)||(p[b]={__data__:z}),y.set(C,z),n.remove(C);for(b=-1;++b<l;)n.has(Q[b])&&(r[b]=c[b])}else{for(b=-1;++b<n;)t=c[b],z=e[b],t?(t.__data__=z,m[b]=t):p[b]={__data__:z};for(;b<h;++b)p[b]={__data__:e[b]};for(;b<l;++b)r[b]=c[b]}p.update=m;p.parentNode=m.parentNode=r.parentNode=c.parentNode;f.push(p);k.push(m);g.push(r)}
...
h).on("touchstart.drag",n)}function a(c,h,n,u,m){return function(){var a=w.event.target,f=this.parentNode,k=e.of(this,arguments),g=0,p=c(),r=".drag"+(null==p?"":"-"+p),t,q=w.select(n()).on(u+r,function(){var c=h(f,p),a,e;c&&(a=c[0]-y[0],e=c[1]-y[1],g|=a|e,y=c,k({type:"drag",x:c[0]+t[0],y:c[1]+t[1],dx:a,dy:e}))}).on(m+r,function(){h(f,p)&&(q.on(u+r,null).on(m+r,null),z(g&&w.event.target===a),k({type:"dragend"}))}),z=qa(),y=h(f,p);b?(t=b.apply(this,arguments),t=[t.x-y[0],t.y-y[1]]):t=[0,0];k({type:"dragstart"})}}
var e=C(c,"drag","dragstart","dragend"),b=null,h=a(A,w.mouse,ja,"mousemove","mouseup"),n=a(Y,w.touch,fa,"touchmove","touchend");c.origin=function(a){if(!arguments.length)return b;b=a;return c};return w.rebind(c,e,"on")};var la=Math.PI,Ea=2*la,xa=la/2,ka=la/180,ta=180/la,yc=Math.SQRT2;w.interpolateZoom=function(c,a){function e(c){var a=c*z;if(q){c=ha(t);var e,u=yc*a+t;e=((u=Math.exp(2*u))-1)/(u+1);var m=t,u=((m=Math.exp(m))-1/m)/2;e=n/(2*p)*(c*e-u);return[b+e*f,h+e*k,n*c/ha(yc*a+t)]}return[b+c*f,h+
c*k,n*Math.exp(yc*a)]}var b=c[0],h=c[1],n=c[2],m=a[2],f=a[0]-b,k=a[1]-h,g=f*f+k*k,p=Math.sqrt(g),r=(m*m-n*n+4*g)/(4*n*p),g=(m*m-n*n-4*g)/(4*m*p),t=Math.log(Math.sqrt(r*r+1)-r),q=Math.log(Math.sqrt(g*g+1)-g)-t,z=(q||Math.log(m/n))/yc;e.duration=1E3*z;return e};w.behavior.zoom=function(){function c(c){c.on("mousedown.zoom",k).on(Xh+".zoom",p).on("mousemove.zoom",r).on("dblclick.zoom",t).on("touchstart.zoom",g)}function a(c){return[(c[0]-q.x)/q.k,(c[1]-q.y)/q.k]}function e(c){q.k=Math.max(H[0],Math.min(H[1],
c))}function b(c,a){a=[a[0]*q.k+q.x,a[1]*q.k+q.y];q.x+=c[0]-a[0];q.y+=c[1]-a[1]}function h(){V&&V.domain(O.range().map(function(c){return(c-q.x)/q.k}).map(O.invert));G&&G.domain(U.range().map(function(c){return(c-q.y)/q.k}).map(U.invert))}function n(c){c({type:"zoomstart"})}function m(c){h();c({type:"zoom",scale:q.k,translate:[q.x,q.y]})}function f(c){c({type:"zoomend"})}function k(){var c=this,e=w.event.target,h=K.of(c,arguments),g=0,p=w.select(za).on("mousemove.zoom",function(){g=1;b(w.mouse(c),
q);m(h)}).on("mouseup.zoom",function(){p.on("mousemove.zoom",za===c?r:null).on("mouseup.zoom",null);t(g&&w.event.target===e);f(h)}),q=a(w.mouse(c)),t=qa();W.call(c);n(h)}function g(){function c(){var e=w.touches(t);C=q.k;e.forEach(function(c){c.identifier in y&&(y[c.identifier]=a(c))});return e}function h(){var a=w.event.target;w.select(a).on(F,p).on(O,r);V.push(a);for(var a=w.event.changedTouches,n=0,u=a.length;n<u;++n)y[a[n].identifier]=null;u=c();n=Date.now();1===u.length?(500>n-v&&(a=u[0],u=y[a.identifier],
e(2*q.k),b(a,u),L(),m(z)),v=n):1<u.length&&(a=u[0],u=u[1],n=a[0]-u[0],a=a[1]-u[1],Q=n*n+a*a)}function p(){for(var c=w.touches(t),a,h,n,u,f=0,x=c.length;f<x;++f,u=null)if(n=c[f],u=y[n.identifier]){if(h)break;a=n;h=u}if(u){var k=(k=n[0]-a[0])*k+(k=n[1]-a[1])*k,c=Q&&Math.sqrt(k/Q);a=[(a[0]+n[0])/2,(a[1]+n[1])/2];h=[(h[0]+u[0])/2,(h[1]+u[1])/2];e(c*C)}v=null;b(a,h);m(z)}function r(){if(w.event.touches.length){for(var a=w.event.changedTouches,e=0,b=a.length;e<b;++e)delete y[a[e].identifier];for(var l in y)return void c()}w.selectAll(V).on(H,
null);U.on("mousedown.zoom",k).on("touchstart.zoom",g);G();f(z)}var t=this,z=K.of(t,arguments),y={},Q=0,C,H=".zoom-"+w.event.changedTouches[0].identifier,F="touchmove"+H,O="touchend"+H,V=[],U=w.select(t).on("mousedown.zoom",null).on("touchstart.zoom",h),G=qa();W.call(t);h();n(z)}function p(){var c=K.of(this,arguments);F?clearTimeout(F):(W.call(this),n(c));F=setTimeout(function(){F=null;f(c)},50);L();var h=y||w.mouse(this);z||(z=a(h));e(Math.pow(2,.002*zc())*q.k);b(h,z);m(c)}function r(){z=null}function t(){var c=
K.of(this,arguments),h=w.mouse(this),k=a(h),g=Math.log(q.k)/Math.LN2;n(c);e(Math.pow(2,w.event.shiftKey?Math.ceil(g)-1:Math.floor(g)+1));b(h,k);m(c);f(c)}var q={x:0,y:0,k:1},z,y,Q=[960,500],H=Vf,F,v,K=C(c,"zoomstart","zoom","zoomend"),O,V,U,G;c.event=function(c){c.each(function(){var c=K.of(this,arguments),a=q;pb?w.select(this).transition().each("start.zoom",function(){q=this.__chart__||{x:0,y:0,k:1};n(c)}).tween("zoom:zoom",function(){var e=Q[0],b=e/2,l=Q[1]/2,h=w.interpolateZoom([(b-q.x)/q.k,(l-
q.y)/q.k,e/q.k],[(b-a.x)/a.k,(l-a.y)/a.k,e/a.k]);return function(a){a=h(a);var n=e/a[2];this.__chart__=q={x:b-a[0]*n,y:l-a[1]*n,k:n};m(c)}}).each("end.zoom",function(){f(c)}):(this.__chart__=q,n(c),m(c),f(c))})};c.translate=function(a){if(!arguments.length)return[q.x,q.y];q={x:+a[0],y:+a[1],k:q.k};h();return c};c.scale=function(a){if(!arguments.length)return q.k;q={x:q.x,y:q.y,k:+a};h();return c};c.scaleExtent=function(a){if(!arguments.length)return H;H=null==a?Vf:[+a[0],+a[1]];return c};c.center=
function(a){if(!arguments.length)return y;y=a&&[+a[0],+a[1]];return c};c.size=function(a){if(!arguments.length)return Q;Q=a&&[+a[0],+a[1]];return c};c.x=function(a){if(!arguments.length)return V;V=a;O=a.copy();q={x:0,y:0,k:1};return c};c.y=function(a){if(!arguments.length)return G;G=a;U=a.copy();q={x:0,y:0,k:1};return c};return w.rebind(c,K,"on")};var Vf=[0,Infinity],zc,Xh="onwheel"in La?(zc=function(){return-w.event.deltaY*(w.event.deltaMode?120:1)},"wheel"):"onmousewheel"in La?(zc=function(){return w.event.wheelDelta},
...
e.format=function(a){if(Array.isArray(a[0]))return e.formatRows(a);var b=new r,l=[];a.forEach(function(c){for(var a in c)b.has(a)||l.push(b.add(a))});return[l.map(m).join(c)].concat(a.map(function(a){return l.map(function(c){return m(a[c])}).join(c)})).join("\n")};e.formatRows=function(c){return c.map(n).join("\n")};return e};w.csv=w.dsv(",","text/csv");w.tsv=w.dsv("\t","text/tab-separated-values");w.touch=function(c,a,e){3>arguments.length&&(e=a,a=S().changedTouches);if(a)for(var b=0,h=a.length,
...
a)}};w.geo.area=function(a){Dc=0;w.geo.stream(a,Da);return Dc};var Dc,gb=new Yc,Da={sphere:function(){Dc+=4*la},point:A,lineStart:A,lineEnd:A,polygonStart:function(){gb.reset();Da.lineStart=Eg},polygonEnd:function(){var a=2*gb;Dc+=0>a?4*la+a:a;Da.lineStart=Da.lineEnd=Da.point=A}};w.geo.bounds=function(){function a(c,e){F.push(v=[p=c,q=c]);e<r&&(r=e);e>t&&(t=e)}function b(e,l){var h=hb([e*ka,l*ka]);if(C){var n=sb(C,h),n=sb([n[1],-n[0],0],n);fc(n);var n=gc(n),u=e-z,m=0<u?1:-1,k=n[0]*ta*m,u=180<ma(u);
u^(m*z<k&&k<m*e)?(n=n[1]*ta,n>t&&(t=n)):(k=(k+360)%360-180,u^(m*z<k&&k<m*e))?(n=-n[1]*ta,n<r&&(r=n)):(l<r&&(r=l),l>t&&(t=l));u?e<z?f(p,e)>f(p,q)&&(q=e):f(e,q)>f(p,q)&&(p=e):q>=p?(e<p&&(p=e),e>q&&(q=e)):e>z?f(p,e)>f(p,q)&&(q=e):f(e,q)>f(p,q)&&(p=e)}else a(e,l);C=h;z=e}function e(){K.point=b}function l(){v[0]=p;v[1]=q;K.point=a;C=null}function h(a,c){if(C){var e=a-z;H+=180<ma(e)?e+(0<e?360:-360):e}else y=a,Q=c;Da.point(a,c);b(a,c)}function n(){Da.lineStart()}function m(){h(y,Q);Da.lineEnd();1E-6<ma(H)&&
(p=-(q=180));v[0]=p;v[1]=q;C=null}function f(a,c){return 0>(c-=a)?c+360:c}function k(a,c){return a[0]-c[0]}function g(a,c){return c[0]<=c[1]?c[0]<=a&&a<=c[1]:a<c[0]||c[1]<a}var p,r,q,t,z,y,Q,C,H,F,v,K={point:a,lineStart:e,lineEnd:l,polygonStart:function(){K.point=h;K.lineStart=n;K.lineEnd=m;H=0;Da.polygonStart()},polygonEnd:function(){Da.polygonEnd();K.point=a;K.lineStart=e;K.lineEnd=l;0>gb?(p=-(q=180),r=-(t=90)):1E-6<H?t=90:-1E-6>H&&(r=-90);v[0]=p;v[1]=q}};return function(a){t=q=-(p=r=Infinity);
F=[];w.geo.stream(a,K);if(a=F.length){F.sort(k);for(var c=1,e=F[0],b,l=[e];c<a;++c)b=F[c],g(b[0],e)||g(b[1],e)?(f(e[0],b[1])>f(e[0],e[1])&&(e[1]=b[1]),f(b[0],e[1])>f(e[0],e[1])&&(e[0]=b[0])):l.push(e=b);var n=-Infinity,h;a=l.length-1;c=0;for(e=l[a];c<=a;e=b,++c)b=l[c],(h=f(e[1],b[0]))>n&&(n=h,p=b[0],q=e[1])}F=v=null;return Infinity===p||Infinity===r?[[NaN,NaN],[NaN,NaN]]:[[p,r],[q,t]]}}();w.geo.centroid=function(a){Fb=ic=ib=jb=Ua=Ya=Za=Ma=tb=ub=$a=0;w.geo.stream(a,Ja);a=tb;var b=ub,e=$a,l=a*a+b*b+
...
L=k||960,S=q||400,C=D.selectAll("g.nv-wrap.nv-interactiveLineLayer").data([B]);C.enter().append("g").attr("class"," nv-wrap nv-interactiveLineLayer").append("g").attr("class","nv-interactiveGuideLine");r&&(r.on("mousemove",E,!0).on("mouseout",E,!0).on("dblclick",E),a.renderGuideLine=function(a){t&&(a=C.select(".nv-interactiveGuideLine").selectAll("line").data(null!=a?[v.utils.NaNtoZero(a)]:[],String),a.enter().append("line").attr("class","nv-guideline").attr("x1",function(a){return a}).attr("x2",
function(a){return a}).attr("y1",S).attr("y2",0),a.exit().remove())})})}var b=v.models.tooltip(),k=null,q=null,p={left:0,top:0},f=d3.scale.linear();d3.scale.linear();var g=d3.dispatch("elementMousemove","elementMouseout","elementDblclick"),t=!0,r=null,I=-1!==navigator.userAgent.indexOf("MSIE");a.dispatch=g;a.tooltip=b;a.margin=function(b){if(!arguments.length)return p;p.top="undefined"!=typeof b.top?b.top:p.top;p.left="undefined"!=typeof b.left?b.left:p.left;return a};a.width=function(b){if(!arguments.length)return k;
k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.showGuideLine=function(b){if(!arguments.length)return t;t=b;return a};a.svgContainer=function(b){if(!arguments.length)return r;r=b;return a};return a};v.interactiveBisect=function(a,b,k){if(!a instanceof Array)return null;"function"!==typeof k&&(k=function(a,b){return a.x});var q=d3.bisector(k).left,q=d3.max([0,q(a,b)-1]),p=k(a[q],q);"undefined"===typeof p&&
(p=q);if(p===b)return q;var f=d3.min([q+1,a.length-1]);a=k(a[f],f);"undefined"===typeof a&&(a=f);return Math.abs(a-b)>=Math.abs(p-b)?q:f};v.nearestValueIndex=function(a,b,k){var q=Infinity,p=null;a.forEach(function(a,g){var t=Math.abs(b-a);t<=q&&t<k&&(q=t,p=g)});return p};(function(){window.nv.tooltip={};window.nv.models.tooltip=function(){function a(){if(A){var b;b=k&&k.series&&0<k.series.length?!0:!1;if(b){if(r){b=d3.select(r);"svg"!==b.node().tagName&&(b=b.select("svg"));var D=b.node()?b.attr("viewBox"):
null;D&&(D=D.split(" "),b=parseInt(b.style("width"))/D[2],B.left*=b,B.top*=b)}b=B.left;var D=null!=g?g:B.top,L;L=S(k);var G;G=r?d3.select(r):d3.select("body");var T=G.select(".nvtooltip");null===T.node()&&(T=G.append("div").attr("class","nvtooltip "+(t?t:"xy-tooltip")).attr("id",E));T.node().innerHTML=L;T.style("top",0).style("left",0).style("opacity",0);T.selectAll("div, table, td, tr").classed("nv-pointer-events-none",!0);T.classed("nv-pointer-events-none",!0);I=L=T.node();if(r){(T=r.getElementsByTagName("svg")[0])?
T.getBoundingClientRect():r.getBoundingClientRect();var M=0;G=0;if(T){T=T.getBoundingClientRect();M=r.getBoundingClientRect();G=T.top;if(0>G){var R=r.getBoundingClientRect();G=Math.abs(G)>R.height?0:G}G=Math.abs(G-M.top);M=Math.abs(T.left-M.left)}b+=r.offsetLeft+M-2*r.scrollLeft;D+=r.offsetTop+G-2*r.scrollTop}f&&0<f&&(D=Math.floor(D/f)*f);v.tooltip.calcTooltipPosition([b,D],q,p,L);return a}}}var b=null,k=null,q="w",p=50,f=25,g=null,t=null,r=null,I=null,B={left:null,top:null},A=!0,E="nvtooltip-"+Math.floor(1E5*
...
a.footer+"</div>");return f};a.nvPointerEventsClass="nv-pointer-events-none";a.content=function(f){if(!arguments.length)return b;b=f;return a};a.tooltipElem=function(){return I};a.contentGenerator=function(b){if(!arguments.length)return S;"function"===typeof b&&(S=b);return a};a.data=function(b){if(!arguments.length)return k;k=b;return a};a.gravity=function(b){if(!arguments.length)return q;q=b;return a};a.distance=function(b){if(!arguments.length)return p;p=b;return a};a.snapDistance=function(b){if(!arguments.length)return f;
f=b;return a};a.classes=function(b){if(!arguments.length)return t;t=b;return a};a.chartContainer=function(b){if(!arguments.length)return r;r=b;return a};a.position=function(b){if(!arguments.length)return B;B.left="undefined"!==typeof b.left?b.left:B.left;B.top="undefined"!==typeof b.top?b.top:B.top;return a};a.fixedTop=function(b){if(!arguments.length)return g;g=b;return a};a.enabled=function(b){if(!arguments.length)return A;A=b;return a};a.valueFormatter=function(b){if(!arguments.length)return D;
"function"===typeof b&&(D=b);return a};a.headerFormatter=function(b){if(!arguments.length)return L;"function"===typeof b&&(L=b);return a};a.id=function(){return E};return a};v.tooltip.show=function(a,b,k,q,p,f){var g=document.createElement("div");g.className="nvtooltip "+(f?f:"xy-tooltip");f=p;if(!p||p.tagName.match(/g|svg/i))f=document.getElementsByTagName("body")[0];g.style.left=0;g.style.top=0;g.style.opacity=0;g.innerHTML=b;f.appendChild(g);p&&(a[0]-=p.scrollLeft,a[1]-=p.scrollTop);v.tooltip.calcTooltipPosition(a,
k,q,g)};v.tooltip.findFirstNonSVGParent=function(a){for(;null!==a.tagName.match(/^g|svg$/i);)a=a.parentNode;return a};v.tooltip.findTotalOffsetTop=function(a,b){var k=b;do isNaN(a.offsetTop)||(k+=a.offsetTop);while(a=a.offsetParent);return k};v.tooltip.findTotalOffsetLeft=function(a,b){var k=b;do isNaN(a.offsetLeft)||(k+=a.offsetLeft);while(a=a.offsetParent);return k};v.tooltip.calcTooltipPosition=function(a,b,k,q){var p=parseInt(q.offsetHeight),f=parseInt(q.offsetWidth),g=v.utils.windowSize().width,
t=v.utils.windowSize().height,r=window.pageYOffset,I=window.pageXOffset,B,A,t=window.innerWidth>=document.body.scrollWidth?t:t-16,g=window.innerHeight>=document.body.scrollHeight?g:g-16;k=k||20;var E=function(a){return v.tooltip.findTotalOffsetTop(a,A)},D=function(a){return v.tooltip.findTotalOffsetLeft(a,B)};switch(b||"s"){case "e":B=a[0]-f-k;A=a[1]-p/2;b=D(q);E=E(q);b<I&&(B=a[0]+k>I?a[0]+k:I-b+B);E<r&&(A=r-E+A);E+p>r+t&&(A=r+t-E+A-p);break;case "w":B=a[0]+k;A=a[1]-p/2;b=D(q);E=E(q);b+f>g&&(B=a[0]-
f-k);E<r&&(A=r+5);E+p>r+t&&(A=r+t-E+A-p);break;case "n":B=a[0]-f/2-5;A=a[1]+k;b=D(q);E=E(q);b<I&&(B=I+5);b+f>g&&(B=B-f/2+5);E+p>r+t&&(A=r+t-E+A-p);break;case "s":B=a[0]-f/2;A=a[1]-p-k;b=D(q);E=E(q);b<I&&(B=I+5);b+f>g&&(B=B-f/2+5);r>E&&(A=r);break;case "none":B=a[0],A=a[1]-k,b=D(q),E=E(q)}q.style.left=B+"px";q.style.top=A+"px";q.style.opacity=1;q.style.position="absolute";return q};v.tooltip.cleanup=function(){for(var a=document.getElementsByClassName("nvtooltip"),b=[];a.length;)b.push(a[0]),a[0].style.transitionDelay=
...
k){return b.color||a[k%a.length]}};v.utils.customTheme=function(a,b,k){b=b||function(a){return a.key};k=k||d3.scale.category20().range();var q=k.length;return function(p,f){var g=b(p);q||(q=k.length);return"undefined"!==typeof a[g]?"function"===typeof a[g]?a[g]():a[g]:k[--q]}};v.utils.pjax=function(a,b){function k(k){d3.html(k,function(k){var f=d3.select(b).node();f.parentNode.replaceChild(d3.select(k).select(b).node(),f);v.utils.pjax(a,b)})}d3.selectAll(a).on("click",function(){history.pushState(this.href,
...
"nv-axislabel");M=2==f.range().length?f.range()[1]:f.range()[f.range().length-1]+(f.range()[1]-f.range()[0]);v.attr("text-anchor","middle").attr("y",R).attr("x",M/2);t&&(M=a.selectAll("g.nv-axisMaxMin").data([f.domain()[0],f.domain()[f.domain().length-1]]),M.enter().append("g").attr("class","nv-axisMaxMin").append("text"),M.exit().remove(),M.attr("transform",function(a,b){return"translate("+(f(a)+(E?f.rangeBand()/2:0))+",0)"}).select("text").attr("dy",".71em").attr("y",b.tickPadding()).attr("transform",
...
B?-Math.max(k.right,q)+12:-10).attr("x",B?f.range()[0]/2:b.tickPadding());t&&(M=a.selectAll("g.nv-axisMaxMin").data(f.domain()),M.enter().append("g").attr("class","nv-axisMaxMin").append("text").style("opacity",0),M.exit().remove(),M.attr("transform",function(a,b){return"translate(0,"+f(a)+")"}).select("text").attr("dy",".32em").attr("y",0).attr("x",b.tickPadding()).style("text-anchor","start").text(function(a,b){var f=C(a);return(""+f).match("NaN")?"":f}),M.transition().attr("transform",function(a,
b){return"translate(0,"+f.range()[b]+")"}).select("text").style("opacity",1));break;case "left":v.enter().append("text").attr("class","nv-axislabel"),v.style("text-anchor",B?"middle":"end").attr("transform",B?"rotate(-90)":"").attr("y",B?-Math.max(k.left,q)+L:-10).attr("x",B?-f.range()[0]/2:-b.tickPadding()),t&&(M=a.selectAll("g.nv-axisMaxMin").data(f.domain()),M.enter().append("g").attr("class","nv-axisMaxMin").append("text").style("opacity",0),M.exit().remove(),M.attr("transform",function(a,b){return"translate(0,"+
S(a)+")"}).select("text").attr("dy",".32em").attr("y",0).attr("x",-b.tickPadding()).attr("text-anchor","end").text(function(a,b){var f=C(a);return(""+f).match("NaN")?"":f}),M.transition().attr("transform",function(a,b){return"translate(0,"+f.range()[b]+")"}).select("text").style("opacity",1))}v.text(function(a){return a});!t||"left"!==b.orient()&&"right"!==b.orient()||(p.selectAll("g").each(function(a,b){d3.select(this).select("text").attr("opacity",1);if(f(a)<f.range()[1]+10||f(a)>f.range()[0]-10)(1E-10<
a||-1E-10>a)&&d3.select(this).attr("opacity",0),d3.select(this).select("text").attr("opacity",0)}),f.domain()[0]==f.domain()[1]&&0==f.domain()[0]&&a.selectAll("g.nv-axisMaxMin").style("opacity",function(a,b){return b?0:1}));if(t&&("top"===b.orient()||"bottom"===b.orient())){var K=[];a.selectAll("g.nv-axisMaxMin").each(function(a,b){try{b?K.push(f(a)-this.getBBox().width-4):K.push(f(a)+this.getBBox().width+4)}catch(g){b?K.push(f(a)-4):K.push(f(a)+4)}});p.selectAll("g").each(function(a,b){if(f(a)<K[0]||
f(a)>K[1])1E-10<a||-1E-10>a?d3.select(this).remove():d3.select(this).select("text").remove()})}r&&p.selectAll(".tick").filter(function(a){return!parseFloat(Math.round(1E5*a.__data__)/1E6)&&void 0!==a.__data__}).classed("zero",!0);S=f.copy()});return a}var b=d3.svg.axis(),k={top:0,right:0,bottom:0,left:0},q=75,p=60,f=d3.scale.linear(),g=null,t=!0,r=!0,I=0,B=!0,A=!1,E=!1,D=null,L=12;b.scale(f).orient("bottom").tickFormat(function(a){return a});var S;a.axis=b;d3.rebind(a,b,"orient","tickValues","tickSubdivide",
"tickSize","tickPadding","tickFormat");d3.rebind(a,f,"domain","range","rangeBand","rangeBands");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return k;k.top="undefined"!=typeof b.top?b.top:k.top;k.right="undefined"!=typeof b.right?b.right:k.right;k.bottom="undefined"!=typeof b.bottom?b.bottom:k.bottom;k.left="undefined"!=typeof b.left?b.left:k.left;return a};a.width=function(b){if(!arguments.length)return q;q=b;return a};a.ticks=function(b){if(!arguments.length)return D;
D=b;return a};a.height=function(b){if(!arguments.length)return p;p=b;return a};a.axisLabel=function(b){if(!arguments.length)return g;g=b;return a};a.showMaxMin=function(b){if(!arguments.length)return t;t=b;return a};a.highlightZero=function(b){if(!arguments.length)return r;r=b;return a};a.scale=function(g){if(!arguments.length)return f;f=g;b.scale(f);E="function"===typeof f.rangeBands;d3.rebind(a,f,"domain","range","rangeBand","rangeBands");return a};a.rotateYLabel=function(b){if(!arguments.length)return B;
B=b;return a};a.rotateLabels=function(b){if(!arguments.length)return I;I=b;return a};a.staggerLabels=function(b){if(!arguments.length)return A;A=b;return a};a.axisLabelDistance=function(b){if(!arguments.length)return L;L=b;return a};return a};v.models.historicalBar=function(){function a(T){T.each(function(a){var T=k-b.left-b.right,y=q-b.top-b.bottom,F=d3.select(this);f.domain(L||d3.extent(a[0].values.map(t).concat(I)));A?f.range(C||[.5*T/a[0].values.length,T*(a[0].values.length-.5)/a[0].values.length]):
f.range(C||[0,T]);g.domain(S||d3.extent(a[0].values.map(r).concat(B))).range(P||[y,0]);f.domain()[0]===f.domain()[1]&&(f.domain()[0]?f.domain([f.domain()[0]-.01*f.domain()[0],f.domain()[1]+.01*f.domain()[1]]):f.domain([-1,1]));g.domain()[0]===g.domain()[1]&&(g.domain()[0]?g.domain([g.domain()[0]+.01*g.domain()[0],g.domain()[1]-.01*g.domain()[1]]):g.domain([-1,1]));var K=F.selectAll("g.nv-wrap.nv-historicalBar-"+p).data([a[0].values]),z=K.enter().append("g").attr("class","nvd3 nv-wrap nv-historicalBar-"+
...
b){return t(a,b)});y.exit().remove();y.enter().append("rect").attr("x",0).attr("y",function(a,b){return v.utils.NaNtoZero(g(Math.max(0,r(a,b))))}).attr("height",function(a,b){return v.utils.NaNtoZero(Math.abs(g(r(a,b))-g(0)))}).attr("transform",function(b,g){return"translate("+(f(t(b,g))-T/a[0].values.length*.45)+",0)"}).on("mouseover",function(b,k){G&&(d3.select(this).classed("hover",!0),N.elementMouseover({point:b,series:a[0],pos:[f(t(b,k)),g(r(b,k))],pointIndex:k,seriesIndex:0,e:d3.event}))}).on("mouseout",
function(b,f){G&&(d3.select(this).classed("hover",!1),N.elementMouseout({point:b,series:a[0],pointIndex:f,seriesIndex:0,e:d3.event}))}).on("click",function(a,b){G&&(N.elementClick({value:r(a,b),data:a,index:b,pos:[f(t(a,b)),g(r(a,b))],e:d3.event,id:p}),d3.event.stopPropagation())}).on("dblclick",function(a,b){G&&(N.elementDblClick({value:r(a,b),data:a,index:b,pos:[f(t(a,b)),g(r(a,b))],e:d3.event,id:p}),d3.event.stopPropagation())});y.attr("fill",function(a,b){return D(a,b)}).attr("class",function(a,
b,f){return(0>r(a,b)?"nv-bar negative":"nv-bar positive")+" nv-bar-"+f+"-"+b}).transition().attr("transform",function(b,g){return"translate("+(f(t(b,g))-T/a[0].values.length*.45)+",0)"}).attr("width",T/a[0].values.length*.9);y.transition().attr("y",function(a,b){var f=0>r(a,b)?g(0):1>g(0)-g(r(a,b))?g(0)-1:g(r(a,b));return v.utils.NaNtoZero(f)}).attr("height",function(a,b){return v.utils.NaNtoZero(Math.max(Math.abs(g(r(a,b))-g(0)),1))})});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,
p=Math.floor(1E4*Math.random()),f=d3.scale.linear(),g=d3.scale.linear(),t=function(a){return a.x},r=function(a){return a.y},I=[],B=[0],A=!1,E=!0,D=v.utils.defaultColor(),L,S,C,P,N=d3.dispatch("chartClick","elementClick","elementDblClick","elementMouseover","elementMouseout"),G=!0;a.highlightPoint=function(a,b){d3.select(".nv-historicalBar-"+p).select(".nv-bars .nv-bar-0-"+a).classed("hover",b)};a.clearHighlights=function(){d3.select(".nv-historicalBar-"+p).select(".nv-bars .nv-bar.hover").classed("hover",
!1)};a.dispatch=N;a.options=v.utils.optionsFunc.bind(a);a.x=function(b){if(!arguments.length)return t;t=b;return a};a.y=function(b){if(!arguments.length)return r;r=b;return a};a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};
a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.yScale=function(b){if(!arguments.length)return g;g=b;return a};a.xDomain=function(b){if(!arguments.length)return L;L=b;return a};a.yDomain=function(b){if(!arguments.length)return S;S=b;return a};a.xRange=function(b){if(!arguments.length)return C;C=b;return a};a.yRange=function(b){if(!arguments.length)return P;P=b;return a};a.forceX=function(b){if(!arguments.length)return I;
...
r-b.left-b.right,D=I-b.top-b.bottom,B=d3.select(this),G=p.call(this,a,k).slice().sort(d3.descending),T=f.call(this,a,k).slice().sort(d3.descending),M=g.call(this,a,k).slice().sort(d3.descending),R=(a.rangeLabels?a.rangeLabels:[]).slice(),y=(a.markerLabels?a.markerLabels:[]).slice(),F=(a.measureLabels?a.measureLabels:[]).slice(),K=d3.scale.linear().domain(d3.extent(d3.merge([t,G]))).range(q?[v,0]:[0,v]);this.__chart__||d3.scale.linear().domain([0,Infinity]).range(K.range());this.__chart__=K;var v=
...
label:y[0]||"Previous"})});else O.selectAll("path.nv-markerTriangle").remove();B.selectAll(".nv-range").on("mouseover",function(a,b){E.elementMouseover({value:a,label:R[b]||(b?1==b?"Mean":"Minimum":"Maximum"),pos:[K(a),D/2]})}).on("mouseout",function(a,b){E.elementMouseout({value:a,label:R[b]||(b?1==b?"Mean":"Minimum":"Maximum")})})});return a}var b={top:0,right:0,bottom:0,left:0},k="left",q=!1,p=function(a){return a.ranges},f=function(a){return a.markers},g=function(a){return a.measures},t=[0],r=
380,I=30,B=null,A=v.utils.getColor(["#1f77b4"]),E=d3.dispatch("elementMouseover","elementMouseout");a.dispatch=E;a.options=v.utils.optionsFunc.bind(a);a.orient=function(b){if(!arguments.length)return k;k=b;q="right"==k||"bottom"==k;return a};a.ranges=function(b){if(!arguments.length)return p;p=b;return a};a.markers=function(b){if(!arguments.length)return f;f=b;return a};a.measures=function(b){if(!arguments.length)return g;g=b;return a};a.forceX=function(b){if(!arguments.length)return t;t=b;return a};
a.width=function(b){if(!arguments.length)return r;r=b;return a};a.height=function(b){if(!arguments.length)return I;I=b;return a};a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.tickFormat=function(b){if(!arguments.length)return B;B=b;return a};a.color=function(b){if(!arguments.length)return A;
A=v.utils.getColor(b);return a};return a};v.models.bulletChart=function(){function a(k){k.each(function(C,P){var N=d3.select(this),G=(r||parseInt(N.style("width"))||960)-p.left-p.right,T=I-p.top-p.bottom,M=this;a.update=function(){a(k)};a.container=this;if(C&&f.call(this,C,P))N.selectAll(".nv-noData").remove();else return N=N.selectAll(".nv-noData").data([D]),N.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),N.attr("x",p.left+G/2).attr("y",18+
p.top+T/2).text(function(a){return a}),a;var R=f.call(this,C,P).slice().sort(d3.descending),y=g.call(this,C,P).slice().sort(d3.descending),F=t.call(this,C,P).slice().sort(d3.descending),K=N.selectAll("g.nv-wrap.nv-bulletChart").data([C]),z=K.enter().append("g").attr("class","nvd3 nv-wrap nv-bulletChart").append("g"),N=K.select("g");z.append("g").attr("class","nv-bulletWrap");z.append("g").attr("class","nv-titles");K.attr("transform","translate("+p.left+","+p.top+")");var V=d3.scale.linear().domain([0,
Math.max(R[0],y[0],F[0])]).range(q?[G,0]:[0,G]),O=this.__chart__||d3.scale.linear().domain([0,Infinity]).range(V.range());this.__chart__=V;R=z.select(".nv-titles").append("g").attr("text-anchor","end").attr("transform","translate(-6,"+(I-p.top-p.bottom)/2+")");R.append("text").attr("class","nv-title").text(function(a){return a.title});R.append("text").attr("class","nv-subtitle").attr("dy","1em").text(function(a){return a.subtitle});b.width(G).height(T);R=N.select(".nv-bulletWrap");d3.transition(R).call(b);
...
T).attr("y2",7*T/6);N.select("text").attr("y",7*T/6);d3.transition(G.exit()).attr("transform",function(a){return"translate("+V(a)+",0)"}).style("opacity",1E-6).remove();L.on("tooltipShow",function(b){b.key=C.title;if(A){var f=M.parentNode,g=b.pos[0]+(f.offsetLeft||0)+p.left,m=b.pos[1]+(f.offsetTop||0)+p.top,k=E(b.key,b.label,b.value,b,a);v.tooltip.show([g,m],k,0>b.value?"e":"w",null,f)}})});d3.timer.flush();return a}var b=v.models.bullet(),k="left",q=!1,p={top:5,right:40,bottom:20,left:120},f=function(a){return a.ranges},
g=function(a){return a.markers},t=function(a){return a.measures},r=null,I=55,B=null,A=!0,E=function(a,b,f,g,k){return"<h3>"+b+"</h3><p>"+f+"</p>"},D="No Data Available.",L=d3.dispatch("tooltipShow","tooltipHide");b.dispatch.on("elementMouseover.tooltip",function(a){L.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){L.tooltipHide(a)});L.on("tooltipHide",function(){A&&v.tooltip.cleanup()});a.dispatch=L;a.bullet=b;d3.rebind(a,b,"color");a.options=v.utils.optionsFunc.bind(a);a.orient=
function(b){if(!arguments.length)return k;k=b;q="right"==k||"bottom"==k;return a};a.ranges=function(b){if(!arguments.length)return f;f=b;return a};a.markers=function(b){if(!arguments.length)return g;g=b;return a};a.measures=function(b){if(!arguments.length)return t;t=b;return a};a.width=function(b){if(!arguments.length)return r;r=b;return a};a.height=function(b){if(!arguments.length)return I;I=b;return a};a.margin=function(b){if(!arguments.length)return p;p.top="undefined"!=typeof b.top?b.top:p.top;
...
var b=a.transitionDuration();a.transitionDuration(0);a.update();a.transitionDuration(b)}var J=d3.select(this).classed("nv-chart-"+y,!0),ia=this,Y=(B||parseInt(J.style("width"))||960)-r.left-r.right,fa=(A||parseInt(J.style("height"))||400)-r.top-r.bottom;a.update=function(){J.transition().duration(U).call(a)};a.container=this;F.disabled=m.map(function(a){return!!a.disabled});if(!K){var ja;K={};for(ja in F)K[ja]=F[ja]instanceof Array?F[ja].slice(0):F[ja]}ja=d3.behavior.drag().on("dragstart",function(b,
...
r.left+Y/2).attr("y",r.top+fa/2).text(function(a){return a}),a;M=k.xScale();R=k.yScale();if(G)k.yDomain(null);else{var ca=m.filter(function(a){return!a.disabled}).map(function(a,b){var m=d3.extent(a.values,k.y());-.95>m[0]&&(m[0]=-.95);return[(m[0]-m[1])/(1+m[1]),(m[1]-m[0])/(1+m[0])]}),ca=[d3.min(ca,function(a){return a[0]}),d3.max(ca,function(a){return a[1]})];k.yDomain(ca)}ba.domain([0,m[0].values.length-1]).range([0,Y]).clamp(!0);m=b(W.i,m);var aa=N?"none":"all",na=J.selectAll("g.nv-wrap.nv-cumulativeLine").data([m]),
...
ha.append("g").attr("class","nv-controlsWrap");E&&(f.width(Y),ca.select(".nv-legendWrap").datum(m).call(f),r.top!=f.height()&&(r.top=f.height(),fa=(A||parseInt(J.style("height"))||400)-r.top-r.bottom),ca.select(".nv-legendWrap").attr("transform","translate(0,"+-r.top+")"));P&&(aa=[{key:"Re-scale y-axis",disabled:!G}],g.width(140).color(["#444","#444","#444"]).rightAlign(!1).margin({top:5,right:0,bottom:5,left:20}),ca.select(".nv-controlsWrap").datum(aa).attr("transform","translate(0,"+-r.top+")").call(g));
na.attr("transform","translate("+r.left+","+r.top+")");S&&ca.select(".nv-y.nv-axis").attr("transform","translate("+Y+",0)");aa=m.filter(function(a){return a.tempDisabled});na.select(".tempDisabled").remove();aa.length&&na.append("text").attr("class","tempDisabled").attr("x",Y/2).attr("y","-.71em").style("text-anchor","end").text(aa.map(function(a){return a.key}).join(", ")+" values cannot be calculated for this time period.");N&&(t.width(Y).height(fa).margin({left:r.left,top:r.top}).svgContainer(J).xScale(M),
na.select(".nv-interactive").call(t));ha.select(".nv-background").append("rect");ca.select(".nv-background rect").attr("width",Y).attr("height",fa);k.y(function(a){return a.display.y}).width(Y).height(fa).color(m.map(function(a,b){return a.color||I(a,b)}).filter(function(a,b){return!m[b].disabled&&!m[b].tempDisabled}));na=ca.select(".nv-linesWrap").datum(m.filter(function(a){return!a.disabled&&!a.tempDisabled}));na.call(k);m.forEach(function(a,b){a.seriesIndex=b});ha=m.filter(function(a){return!a.disabled&&
...
F,K);null!==F&&(y[F].highlight=!0)}F=q.tickFormat()(a.x()(f,g),g);t.tooltip.position({left:z+r.left,top:b.mouseY+r.top}).chartContainer(ia.parentNode).enabled(C).valueFormatter(function(a,b){return p.tickFormat()(a)}).data({value:F,series:y})();t.renderGuideLine(z)});t.dispatch.on("elementMouseout",function(a){O.tooltipHide();k.clearHighlights()});O.on("tooltipShow",function(b){if(C){var m=ia.parentNode,f=b.pos[0]+(m.offsetLeft||0),g=b.pos[1]+(m.offsetTop||0),r=q.tickFormat()(k.x()(b.point,b.pointIndex)),
t=p.tickFormat()(k.y()(b.point,b.pointIndex));b=T(b.series.key,r,t,b,a);v.tooltip.show([f,g],b,null,null,m)}});O.on("changeState",function(b){"undefined"!==typeof b.disabled&&(m.forEach(function(a,m){a.disabled=b.disabled[m]}),F.disabled=b.disabled);"undefined"!==typeof b.index&&(W.i=b.index,W.x=ba(W.i),F.index=b.index,oa.data([W]));"undefined"!==typeof b.rescaleY&&(G=b.rescaleY);a.update()})});return a}function b(a,b){return b.map(function(b,f){if(!b.values)return b;var g=b.values[a];if(null==g)return b;
var p=k.y()(g,a);if(-.95>p&&!H)return b.tempDisabled=!0,b;b.tempDisabled=!1;b.values=b.values.map(function(a,b){a.display={y:(k.y()(a,b)-p)/(1+p)};return a});return b})}var k=v.models.line(),q=v.models.axis(),p=v.models.axis(),f=v.models.legend(),g=v.models.legend(),t=v.interactiveGuideline(),r={top:30,right:30,bottom:50,left:60},I=v.utils.defaultColor(),B=null,A=null,E=!0,D=!0,L=!0,S=!1,C=!0,P=!0,N=!1,G=!0,T=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},M,R,y=k.id(),F={index:0,
rescaleY:G},K=null,z="No Data Available.",V=function(a){return a.average},O=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),U=250,H=!1;q.orient("bottom").tickPadding(7);p.orient(S?"right":"left");g.updateState(!1);var ba=d3.scale.linear(),W={i:0,x:0};k.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+r.left,a.pos[1]+r.top];O.tooltipShow(a)});k.dispatch.on("elementMouseout.tooltip",function(a){O.tooltipHide(a)});O.on("tooltipHide",function(){C&&v.tooltip.cleanup()});
a.dispatch=O;a.lines=k;a.legend=f;a.xAxis=q;a.yAxis=p;a.interactiveLayer=t;d3.rebind(a,k,"defined","isArea","x","y","xScale","yScale","size","xDomain","yDomain","xRange","yRange","forceX","forceY","interactive","clipEdge","clipVoronoi","useVoronoi","id");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return r;r.top="undefined"!=typeof b.top?b.top:r.top;r.right="undefined"!=typeof b.right?b.right:r.right;r.bottom="undefined"!=typeof b.bottom?b.bottom:r.bottom;r.left=
...
p.transition().style("stroke-opacity",1).style("fill-opacity",.75);p=p.selectAll("g.nv-bar").data(function(a){return a.values});p.exit().remove();y=p.enter().append("g").attr("transform",function(a,b,k){return"translate("+(f(t(a,b))+.05*f.rangeBand())+", "+g(0)+")"}).on("mouseover",function(b,k){d3.select(this).classed("hover",!0);P.elementMouseover({value:r(b,k),point:b,series:a[b.series],pos:[f(t(b,k))+f.rangeBand()*(b.series+.5)/a.length,g(r(b,k))],pointIndex:k,seriesIndex:b.series,e:d3.event})}).on("mouseout",
function(b,f){d3.select(this).classed("hover",!1);P.elementMouseout({value:r(b,f),point:b,series:a[b.series],pointIndex:f,seriesIndex:b.series,e:d3.event})}).on("click",function(b,k){P.elementClick({value:r(b,k),point:b,series:a[b.series],pos:[f(t(b,k))+f.rangeBand()*(b.series+.5)/a.length,g(r(b,k))],pointIndex:k,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()}).on("dblclick",function(b,k){P.elementDblClick({value:r(b,k),point:b,series:a[b.series],pos:[f(t(b,k))+f.rangeBand()*(b.series+
.5)/a.length,g(r(b,k))],pointIndex:k,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()});y.append("rect").attr("height",0).attr("width",.9*f.rangeBand()/a.length);A?(y.append("text").attr("text-anchor","middle"),p.select("text").text(function(a,b){return E(r(a,b))}).transition().attr("x",.9*f.rangeBand()/2).attr("y",function(a,b){return 0>r(a,b)?g(r(a,b))-g(0)+12:-4})):p.selectAll("text").remove();p.attr("class",function(a,b){return 0>r(a,b)?"nv-bar negative":"nv-bar positive"}).style("fill",
function(a,b){return a.color||B(a,b)}).style("stroke",function(a,b){return a.color||B(a,b)}).select("rect").attr("class",N).transition().attr("width",.9*f.rangeBand()/a.length);p.transition().attr("transform",function(a,b){var k=f(t(a,b))+.05*f.rangeBand(),p=0>r(a,b)?g(0):1>g(0)-g(r(a,b))?g(0)-1:g(r(a,b));return"translate("+k+", "+p+")"}).select("rect").attr("height",function(a,b){return Math.max(Math.abs(g(r(a,b))-g(L&&L[0]||0))||1)});f.copy();G=g.copy()});return a}var b={top:0,right:0,bottom:0,
left:0},k=960,q=500,p=Math.floor(1E4*Math.random()),f=d3.scale.ordinal(),g=d3.scale.linear(),t=function(a){return a.x},r=function(a){return a.y},I=[0],B=v.utils.defaultColor(),A=!1,E=d3.format(",.2f"),D,L,S,C,P=d3.dispatch("chartClick","elementClick","elementDblClick","elementMouseover","elementMouseout"),N="discreteBar",G;a.dispatch=P;a.options=v.utils.optionsFunc.bind(a);a.x=function(b){if(!arguments.length)return t;t=b;return a};a.y=function(b){if(!arguments.length)return r;r=b;return a};a.margin=
function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.yScale=function(b){if(!arguments.length)return g;g=b;
...
A=b;return a};a.valueFormat=function(b){if(!arguments.length)return E;E=b;return a};a.rectClass=function(b){if(!arguments.length)return N;N=b;return a};return a};v.models.discreteBarChart=function(){function a(t){t.each(function(t){var G=d3.select(this),R=this,y=(f||parseInt(G.style("width"))||960)-p.left-p.right,F=(g||parseInt(G.style("height"))||400)-p.top-p.bottom;a.update=function(){P.beforeUpdate();G.transition().duration(N).call(a)};a.container=this;if(t&&t.length&&t.filter(function(a){return a.values.length}).length)G.selectAll(".nv-noData").remove();
else return t=G.selectAll(".nv-noData").data([C]),t.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),t.attr("x",p.left+y/2).attr("y",p.top+F/2).text(function(a){return a}),a;L=b.xScale();S=b.yScale().clamp(!0);var K=G.selectAll("g.nv-wrap.nv-discreteBarWithAxes").data([t]),z=K.enter().append("g").attr("class","nvd3 nv-wrap nv-discreteBarWithAxes").append("g"),V=z.append("defs"),K=K.select("g");z.append("g").attr("class","nv-x nv-axis");z.append("g").attr("class",
"nv-y nv-axis").append("g").attr("class","nv-zeroLine").append("line");z.append("g").attr("class","nv-barsWrap");K.attr("transform","translate("+p.left+","+p.top+")");B&&K.select(".nv-y.nv-axis").attr("transform","translate("+y+",0)");b.width(y).height(F);K.select(".nv-barsWrap").datum(t.filter(function(a){return!a.disabled})).transition().call(b);V.append("clipPath").attr("id","nv-x-label-clip-"+b.id()).append("rect");K.select("#nv-x-label-clip-"+b.id()+" rect").attr("width",L.rangeBand()*(A?2:1)).attr("height",
16).attr("x",-L.rangeBand()/(A?1:2));r&&(k.scale(L).ticks(y/100).tickSize(-F,0),K.select(".nv-x.nv-axis").attr("transform","translate(0,"+(S.range()[0]+(b.showValues()&&0>S.domain()[0]?16:0))+")"),K.select(".nv-x.nv-axis").transition().call(k),t=K.select(".nv-x.nv-axis").selectAll("g"),A&&t.selectAll("text").attr("transform",function(a,b,f){return"translate(0,"+(0==f%2?"5":"17")+")"}));I&&(q.scale(S).ticks(F/36).tickSize(-y,0),K.select(".nv-y.nv-axis").transition().call(q));K.select(".nv-zeroLine line").attr("x1",
0).attr("x2",y).attr("y1",S(0)).attr("y2",S(0));P.on("tooltipShow",function(f){if(E){var g=R.parentNode,p=f.pos[0]+(g.offsetLeft||0),r=f.pos[1]+(g.offsetTop||0),t=k.tickFormat()(b.x()(f.point,f.pointIndex)),m=q.tickFormat()(b.y()(f.point,f.pointIndex)),t=D(f.series.key,t,m,f,a);v.tooltip.show([p,r],t,0>f.value?"n":"s",null,g)}})});return a}var b=v.models.discreteBar(),k=v.models.axis(),q=v.models.axis(),p={top:15,right:10,bottom:50,left:60},f=null,g=null,t=v.utils.getColor(),r=!0,I=!0,B=!1,A=!1,E=
!0,D=function(a,b,f,g,k){return"<h3>"+b+"</h3><p>"+f+"</p>"},L,S,C="No Data Available.",P=d3.dispatch("tooltipShow","tooltipHide","beforeUpdate"),N=250;k.orient("bottom").highlightZero(!1).showMaxMin(!1).tickFormat(function(a){return a});q.orient(B?"right":"left").tickFormat(d3.format(",.1f"));b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+p.left,a.pos[1]+p.top];P.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){P.tooltipHide(a)});P.on("tooltipHide",function(){E&&
v.tooltip.cleanup()});a.dispatch=P;a.discretebar=b;a.xAxis=k;a.yAxis=q;d3.rebind(a,b,"x","y","xDomain","yDomain","xRange","yRange","forceX","forceY","id","showValues","valueFormat");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return p;p.top="undefined"!=typeof b.top?b.top:p.top;p.right="undefined"!=typeof b.right?b.right:p.right;p.bottom="undefined"!=typeof b.bottom?b.bottom:p.bottom;p.left="undefined"!=typeof b.left?b.left:p.left;return a};a.width=function(b){if(!arguments.length)return f;
f=b;return a};a.height=function(b){if(!arguments.length)return g;g=b;return a};a.color=function(f){if(!arguments.length)return t;t=v.utils.getColor(f);b.color(t);return a};a.showXAxis=function(b){if(!arguments.length)return r;r=b;return a};a.showYAxis=function(b){if(!arguments.length)return I;I=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return B;B=b;q.orient(b?"right":"left");return a};a.staggerLabels=function(b){if(!arguments.length)return A;A=b;return a};a.tooltips=function(b){if(!arguments.length)return E;
E=b;return a};a.tooltipContent=function(b){if(!arguments.length)return D;D=b;return a};a.noData=function(b){if(!arguments.length)return C;C=b;return a};a.transitionDuration=function(b){if(!arguments.length)return N;N=b;return a};return a};v.models.distribution=function(){function a(k){k.each(function(a){var k="x"==p?"y":"x",v=d3.select(this);r=r||t;a=v.selectAll("g.nv-distribution").data([a]);a.enter().append("g").attr("class","nvd3 nv-distribution").append("g");v=a.select("g");a.attr("transform",
"translate("+b.left+","+b.top+")");a=v.selectAll("g.nv-dist").data(function(a){return a},function(a){return a.key});a.enter().append("g");a.attr("class",function(a,b){return"nv-dist nv-series-"+b}).style("stroke",function(a,b){return g(a,b)});v=a.selectAll("line.nv-dist"+p).data(function(a){return a.values});v.enter().append("line").attr(p+"1",function(a,b){return r(f(a,b))}).attr(p+"2",function(a,b){return r(f(a,b))});a.exit().selectAll("line.nv-dist"+p).transition().attr(p+"1",function(a,b){return t(f(a,
b))}).attr(p+"2",function(a,b){return t(f(a,b))}).style("stroke-opacity",0).remove();v.attr("class",function(a,b){return"nv-dist"+p+" nv-dist"+p+"-"+b}).attr(k+"1",0).attr(k+"2",q);v.transition().attr(p+"1",function(a,b){return t(f(a,b))}).attr(p+"2",function(a,b){return t(f(a,b))});r=t.copy()});return a}var b={top:0,right:0,bottom:0,left:0},k=400,q=8,p="x",f=function(a){return a[p]},g=v.utils.defaultColor(),t=d3.scale.linear(),r;a.options=v.utils.optionsFunc.bind(a);a.margin=function(f){if(!arguments.length)return b;
b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.axis=function(b){if(!arguments.length)return p;p=b;return a};a.size=function(b){if(!arguments.length)return q;q=b;return a};a.getData=function(b){if(!arguments.length)return f;f=d3.functor(b);return a};a.scale=function(b){if(!arguments.length)return t;
t=b;return a};a.color=function(b){if(!arguments.length)return g;g=v.utils.getColor(b);return a};return a};v.models.historicalBarChart=function(){function a(R){R.each(function(y){var F=d3.select(this),K=this,z=(t||parseInt(F.style("width"))||960)-f.left-f.right,V=(r||parseInt(F.style("height"))||400)-f.top-f.bottom;a.update=function(){F.transition().duration(M).call(a)};a.container=this;P.disabled=y.map(function(a){return!!a.disabled});if(!N){var O;N={};for(O in P)N[O]=P[O]instanceof Array?P[O].slice(0):
...
"translate("+z+",0)");b.width(z).height(V).color(y.map(function(a,b){return a.color||g(a,b)}).filter(function(a,b){return!y[b].disabled}));H.select(".nv-barsWrap").datum(y.filter(function(a){return!a.disabled})).transition().call(b);B&&(k.scale(S).tickSize(-V,0),H.select(".nv-x.nv-axis").attr("transform","translate(0,"+C.range()[0]+")"),H.select(".nv-x.nv-axis").transition().call(k));A&&(q.scale(C).ticks(V/36).tickSize(-z,0),H.select(".nv-y.nv-axis").transition().call(q));p.dispatch.on("legendClick",
...
if(g){var m=d3.select(g).select("svg"),p=m.node()?m.attr("viewBox"):null;p&&(p=p.split(" "),m=parseInt(m.style("width"))/p[2],f.pos[0]*=m,f.pos[1]*=m)}var m=f.pos[0]+(g.offsetLeft||0),p=f.pos[1]+(g.offsetTop||0),r=k.tickFormat()(b.x()(f.point,f.pointIndex)),t=q.tickFormat()(b.y()(f.point,f.pointIndex));f=L(f.series.key,r,t,f,a);v.tooltip.show([m,p],f,null,null,g)}});T.on("changeState",function(b){"undefined"!==typeof b.disabled&&(y.forEach(function(a,m){a.disabled=b.disabled[m]}),P.disabled=b.disabled);
a.update()})});return a}var b=v.models.historicalBar(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f={top:30,right:90,bottom:50,left:90},g=v.utils.defaultColor(),t=null,r=null,I=!1,B=!0,A=!0,E=!1,D=!0,L=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},S,C,P={},N=null,G="No Data Available.",T=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),M=250;k.orient("bottom").tickPadding(7);q.orient(E?"right":"left");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=
[a.pos[0]+f.left,a.pos[1]+f.top];T.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){T.tooltipHide(a)});T.on("tooltipHide",function(){D&&v.tooltip.cleanup()});a.dispatch=T;a.bars=b;a.legend=p;a.xAxis=k;a.yAxis=q;d3.rebind(a,b,"defined","isArea","x","y","size","xScale","yScale","xDomain","yDomain","xRange","yRange","forceX","forceY","interactive","clipEdge","clipVoronoi","id","interpolate","highlightPoint","clearHighlights","interactive");a.options=v.utils.optionsFunc.bind(a);a.margin=
...
I=b;return a};a.showXAxis=function(b){if(!arguments.length)return B;B=b;return a};a.showYAxis=function(b){if(!arguments.length)return A;A=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return E;E=b;q.orient(b?"right":"left");return a};a.tooltips=function(b){if(!arguments.length)return D;D=b;return a};a.tooltipContent=function(b){if(!arguments.length)return L;L=b;return a};a.state=function(b){if(!arguments.length)return P;P=b;return a};a.defaultState=function(b){if(!arguments.length)return N;
...
a.update()}function k(a){return a._values&&a._values.length?A:a.values&&a.values.length?E:""}function p(a){return a._values&&a._values.length}function v(a){return(a=a.values||a._values)&&a.length}var C=1,y=d3.select(this),F=d3.layout.tree().children(function(a){return a.values}).size([q,20]);a.update=function(){y.transition().duration(600).call(a)};b[0]||(b[0]={key:r});var C=F.nodes(b[0]),K=d3.select(this).selectAll("div").data([[C]]);b=K.enter().append("div").attr("class","nvd3 nv-wrap nv-indentedtree").append("table");
K=K.select("table").attr("width","100%").attr("class",B);if(g){var z=b.append("thead").append("tr");I.forEach(function(a){z.append("th").attr("width",a.width?a.width:"10%").style("text-align","numeric"==a.type?"right":"left").append("span").text(a.label)})}b=K.selectAll("tbody").data(function(a){return a});b.enter().append("tbody");C=d3.max(C,function(a){return a.depth});F.size([q,20*C]);var V=b.selectAll("tr").data(function(a){return a.filter(function(a){return t&&!a.children?t(a):!0})},function(a,
...
P[N],G+=P[N++];for(0===N&&(N=1);G>A&&1<N;){C=[];N--;for(G=0;G<P.length;G++)P[G]>(C[G%N]||0)&&(C[G%N]=P[G]);G=C.reduce(function(a,b,f,g){return a+b})}for(var T=[],M=A=0;A<N;A++)T[A]=M,M+=C[A];L.attr("transform",function(a,b){return"translate("+T[b%N]+","+(5+20*Math.floor(b/N))+")"});t?S.attr("transform","translate("+(k-b.right-G)+","+b.top+")"):S.attr("transform","translate(0,"+b.top+")");q=b.top+b.bottom+20*Math.ceil(P.length/N)}else{var R=5,y=5,F=0,K;L.attr("transform",function(a,f){var g=d3.select(this).select("text").node().getComputedTextLength()+
28;K=y;k<b.left+b.right+K+g&&(y=K=5,R+=20);y+=g;y>F&&(F=y);return"translate("+K+","+R+")"});S.attr("transform","translate("+(k-b.right-F)+","+b.top+")");q=b.top+b.bottom+R+15}});return a}var b={top:5,right:0,bottom:5,left:0},k=400,q=20,p=function(a){return a.key},f=v.utils.defaultColor(),g=!0,t=!0,r=!0,I=!1,B=d3.dispatch("legendClick","legendDblclick","legendMouseover","legendMouseout","stateChange");a.dispatch=B;a.options=v.utils.optionsFunc.bind(a);a.margin=function(f){if(!arguments.length)return b;
b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.key=function(b){if(!arguments.length)return p;p=b;return a};a.color=function(b){if(!arguments.length)return f;f=v.utils.getColor(b);return a};a.align=function(b){if(!arguments.length)return g;
g=b;return a};a.rightAlign=function(b){if(!arguments.length)return t;t=b;return a};a.updateState=function(b){if(!arguments.length)return r;r=b;return a};a.radioButtonMode=function(b){if(!arguments.length)return I;I=b;return a};return a};v.models.line=function(){function a(C){C.each(function(a){var C=q-k.left-k.right,G=p-k.top-k.bottom,T=d3.select(this);A=b.xScale();E=b.yScale();L=L||A;S=S||E;a=T.selectAll("g.nv-wrap.nv-line").data([a]);var M=a.enter().append("g").attr("class","nvd3 nv-wrap nv-line"),
...
[a]:[]});G.enter().append("path").attr("class","nv-area").attr("d",function(a){return d3.svg.area().interpolate(D).defined(r).x(function(a,b){return v.utils.NaNtoZero(L(g(a,b)))}).y0(function(a,b){return v.utils.NaNtoZero(S(t(a,b)))}).y1(function(a,b){return S(0>=E.domain()[0]?0<=E.domain()[1]?0:E.domain()[1]:E.domain()[0])}).apply(this,[a.values])});C.exit().selectAll("path.nv-area").remove();G.transition().attr("d",function(a){return d3.svg.area().interpolate(D).defined(r).x(function(a,b){return v.utils.NaNtoZero(A(g(a,
b)))}).y0(function(a,b){return v.utils.NaNtoZero(E(t(a,b)))}).y1(function(a,b){return E(0>=E.domain()[0]?0<=E.domain()[1]?0:E.domain()[1]:E.domain()[0])}).apply(this,[a.values])});C=C.selectAll("path.nv-line").data(function(a){return[a.values]});C.enter().append("path").attr("class","nv-line").attr("d",d3.svg.line().interpolate(D).defined(r).x(function(a,b){return v.utils.NaNtoZero(L(g(a,b)))}).y(function(a,b){return v.utils.NaNtoZero(S(t(a,b)))}));C.transition().attr("d",d3.svg.line().interpolate(D).defined(r).x(function(a,
b){return v.utils.NaNtoZero(A(g(a,b)))}).y(function(a,b){return v.utils.NaNtoZero(E(t(a,b)))}));L=A.copy();S=E.copy()});return a}var b=v.models.scatter(),k={top:0,right:0,bottom:0,left:0},q=960,p=500,f=v.utils.defaultColor(),g=function(a){return a.x},t=function(a){return a.y},r=function(a,b){return!isNaN(t(a,b))&&null!==t(a,b)},I=function(a){return a.area},B=!1,A,E,D="linear";b.size(16).sizeDomain([16,256]);var L,S;a.dispatch=b.dispatch;a.scatter=b;d3.rebind(a,b,"id","interactive","size","xScale",
...
q=b;return a};a.height=function(b){if(!arguments.length)return p;p=b;return a};a.x=function(f){if(!arguments.length)return g;g=f;b.x(f);return a};a.y=function(f){if(!arguments.length)return t;t=f;b.y(f);return a};a.clipEdge=function(b){if(!arguments.length)return B;B=b;return a};a.color=function(g){if(!arguments.length)return f;f=v.utils.getColor(g);b.color(f);return a};a.interpolate=function(b){if(!arguments.length)return D;D=b;return a};a.defined=function(b){if(!arguments.length)return r;r=b;return a};
a.isArea=function(b){if(!arguments.length)return I;I=d3.functor(b);return a};return a};v.models.lineChart=function(){function a(F){F.each(function(F){var z=d3.select(this),V=this,O=(r||parseInt(z.style("width"))||960)-g.left-g.right,U=(I||parseInt(z.style("height"))||400)-g.top-g.bottom;a.update=function(){z.transition().duration(y).call(a)};a.container=this;G.disabled=F.map(function(a){return!!a.disabled});if(!T){var H;T={};for(H in G)T[H]=G[H]instanceof Array?G[H].slice(0):G[H]}if(F&&F.length&&
...
H.attr("transform","translate("+g.left+","+g.top+")");D&&W.select(".nv-y.nv-axis").attr("transform","translate("+O+",0)");L&&(f.width(O).height(U).margin({left:g.left,top:g.top}).svgContainer(z).xScale(P),H.select(".nv-interactive").call(f));b.width(O).height(U).color(F.map(function(a,b){return a.color||t(a,b)}).filter(function(a,b){return!F[b].disabled}));W.select(".nv-linesWrap").datum(F.filter(function(a){return!a.disabled})).transition().call(b);A&&(k.scale(P).ticks(O/100).tickSize(-U,0),W.select(".nv-x.nv-axis").attr("transform",
"translate(0,"+N.range()[0]+")"),W.select(".nv-x.nv-axis").transition().call(k));E&&(q.scale(N).ticks(U/36).tickSize(-O,0),W.select(".nv-y.nv-axis").transition().call(q));p.dispatch.on("stateChange",function(b){G=b;R.stateChange(G);a.update()});f.dispatch.on("elementMousemove",function(m){b.clearHighlights();var p,r,y,z=[];F.filter(function(a,b){a.seriesIndex=b;return!a.disabled}).forEach(function(f,g){r=v.interactiveBisect(f.values,m.pointXValue,a.x());b.highlightPoint(g,r,!0);var k=f.values[r];
"undefined"!==typeof k&&("undefined"===typeof p&&(p=k),"undefined"===typeof y&&(y=a.xScale()(a.x()(k,r))),z.push({key:f.key,value:a.y()(k,r),color:t(f,f.seriesIndex)}))});if(2<z.length){var H=a.yScale().invert(m.mouseY),C=.03*Math.abs(a.yScale().domain()[0]-a.yScale().domain()[1]),H=v.nearestValueIndex(z.map(function(a){return a.value}),H,C);null!==H&&(z[H].highlight=!0)}H=k.tickFormat()(a.x()(p,r));f.tooltip.position({left:y+g.left,top:m.mouseY+g.top}).chartContainer(V.parentNode).enabled(S).valueFormatter(function(a,
b){return q.tickFormat()(a)}).data({value:H,series:z})();f.renderGuideLine(y)});f.dispatch.on("elementMouseout",function(a){R.tooltipHide();b.clearHighlights()});R.on("tooltipShow",function(f){if(S){var g=V.parentNode,p=f.pos[0]+(g.offsetLeft||0),r=f.pos[1]+(g.offsetTop||0),t=k.tickFormat()(b.x()(f.point,f.pointIndex)),y=q.tickFormat()(b.y()(f.point,f.pointIndex));f=C(f.series.key,t,y,f,a);v.tooltip.show([p,r],f,null,null,g)}});R.on("changeState",function(b){"undefined"!==typeof b.disabled&&F.length===
b.disabled.length&&(F.forEach(function(a,f){a.disabled=b.disabled[f]}),G.disabled=b.disabled);a.update()})});return a}var b=v.models.line(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f=v.interactiveGuideline(),g={top:30,right:20,bottom:50,left:60},t=v.utils.defaultColor(),r=null,I=null,B=!0,A=!0,E=!0,D=!1,L=!1,S=!0,C=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},P,N,G={},T=null,M="No Data Available.",R=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),
y=250;k.orient("bottom").tickPadding(7);q.orient(D?"right":"left");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+g.left,a.pos[1]+g.top];R.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){R.tooltipHide(a)});R.on("tooltipHide",function(){S&&v.tooltip.cleanup()});a.dispatch=R;a.lines=b;a.legend=p;a.xAxis=k;a.yAxis=q;a.interactiveLayer=f;d3.rebind(a,b,"defined","isArea","x","y","size","xScale","yScale","xDomain","yDomain","xRange","yRange","forceX","forceY",
"interactive","clipEdge","clipVoronoi","useVoronoi","id","interpolate");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return g;g.top="undefined"!=typeof b.top?b.top:g.top;g.right="undefined"!=typeof b.right?b.right:g.right;g.bottom="undefined"!=typeof b.bottom?b.bottom:g.bottom;g.left="undefined"!=typeof b.left?b.left:g.left;return a};a.width=function(b){if(!arguments.length)return r;r=b;return a};a.height=function(b){if(!arguments.length)return I;I=b;return a};a.color=
function(b){if(!arguments.length)return t;t=v.utils.getColor(b);p.color(t);return a};a.showLegend=function(b){if(!arguments.length)return B;B=b;return a};a.showXAxis=function(b){if(!arguments.length)return A;A=b;return a};a.showYAxis=function(b){if(!arguments.length)return E;E=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return D;D=b;q.orient(b?"right":"left");return a};a.useInteractiveGuideline=function(b){if(!arguments.length)return L;L=b;!0===b&&(a.interactive(!1),a.useVoronoi(!1));
...
d3.select(this),z=this,B=(r||parseInt(K.style("width"))||960)-t.left-t.right,O=(I||parseInt(K.style("height"))||400)-t.top-t.bottom;a.update=function(){K.transition().call(a)};G.disabled=y.map(function(a){return!!a.disabled});if(!T){var A;T={};for(A in G)T[A]=G[A]instanceof Array?G[A].slice(0):G[A]}if(y&&y.length&&y.filter(function(a){return a.values.length}).length)K.selectAll(".nv-noData").remove();else return A=K.selectAll(".nv-noData").data([M]),A.enter().append("text").attr("class","nvd3 nv-noData").attr("dy",
"-.7em").style("text-anchor","middle"),A.attr("x",t.left+B/2).attr("y",t.top+O/2).text(function(a){return a}),a;A=y.filter(function(a){return!a.disabled&&a.bar});var H=y.filter(function(a){return!a.bar});C=H.filter(function(a){return!a.disabled}).length&&H.filter(function(a){return!a.disabled})[0].values.length?b.xScale():k.xScale();P=k.yScale();N=b.yScale();var ba=d3.select(this).selectAll("g.nv-wrap.nv-linePlusBar").data([y]),W=ba.enter().append("g").attr("class","nvd3 nv-wrap nv-linePlusBar").append("g"),
...
g.height(),O=(I||parseInt(K.style("height"))||400)-t.top-t.bottom),m.select(".nv-legendWrap").attr("transform","translate("+B/2+","+-t.top+")"));ba.attr("transform","translate("+t.left+","+t.top+")");b.width(B).height(O).color(y.map(function(a,b){return a.color||E(a,b)}).filter(function(a,b){return!y[b].disabled&&!y[b].bar}));k.width(B).height(O).color(y.map(function(a,b){return a.color||E(a,b)}).filter(function(a,b){return!y[b].disabled&&y[b].bar}));ba=m.select(".nv-barsWrap").datum(A.length?A:[{values:[]}]);
W=m.select(".nv-linesWrap").datum(H[0]&&!H[0].disabled?H:[{values:[]}]);d3.transition(ba).call(k);d3.transition(W).call(b);q.scale(C).ticks(B/100).tickSize(-O,0);m.select(".nv-x.nv-axis").attr("transform","translate(0,"+P.range()[0]+")");d3.transition(m.select(".nv-x.nv-axis")).call(q);p.scale(P).ticks(O/36).tickSize(-B,0);d3.transition(m.select(".nv-y1.nv-axis")).style("opacity",A.length?1:0).call(p);f.scale(N).ticks(O/36).tickSize(A.length?0:-B,0);m.select(".nv-y2.nv-axis").style("opacity",H.length?
1:0).attr("transform","translate("+B+",0)");d3.transition(m.select(".nv-y2.nv-axis")).call(f);g.dispatch.on("stateChange",function(b){G=b;R.stateChange(G);a.update()});R.on("tooltipShow",function(m){if(L){var g=z.parentNode,k=m.pos[0]+(g.offsetLeft||0),r=m.pos[1]+(g.offsetTop||0),t=q.tickFormat()(b.x()(m.point,m.pointIndex)),y=(m.series.bar?p:f).tickFormat()(b.y()(m.point,m.pointIndex)),t=S(m.series.key,t,y,m,a);v.tooltip.show([k,r],t,0>m.value?"n":"s",null,g)}});R.on("changeState",function(b){"undefined"!==
typeof b.disabled&&(y.forEach(function(a,f){a.disabled=b.disabled[f]}),G.disabled=b.disabled);a.update()})});return a}var b=v.models.line(),k=v.models.historicalBar(),q=v.models.axis(),p=v.models.axis(),f=v.models.axis(),g=v.models.legend(),t={top:30,right:60,bottom:50,left:60},r=null,I=null,B=function(a){return a.x},A=function(a){return a.y},E=v.utils.defaultColor(),D=!0,L=!0,S=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},C,P,N,G={},T=null,M="No Data Available.",R=d3.dispatch("tooltipShow",
"tooltipHide","stateChange","changeState");k.padData(!0);b.clipEdge(!1).padData(!0);q.orient("bottom").tickPadding(7).highlightZero(!1);p.orient("left");f.orient("right");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+t.left,a.pos[1]+t.top];R.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){R.tooltipHide(a)});k.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+t.left,a.pos[1]+t.top];R.tooltipShow(a)});k.dispatch.on("elementMouseout.tooltip",
function(a){R.tooltipHide(a)});R.on("tooltipHide",function(){L&&v.tooltip.cleanup()});a.dispatch=R;a.legend=g;a.lines=b;a.bars=k;a.xAxis=q;a.y1Axis=p;a.y2Axis=f;d3.rebind(a,b,"defined","size","clipVoronoi","interpolate");a.options=v.utils.optionsFunc.bind(a);a.x=function(f){if(!arguments.length)return B;B=f;b.x(f);k.x(f);return a};a.y=function(f){if(!arguments.length)return A;A=f;b.y(f);k.y(f);return a};a.margin=function(b){if(!arguments.length)return t;t.top="undefined"!=typeof b.top?b.top:t.top;
t.right="undefined"!=typeof b.right?b.right:t.right;t.bottom="undefined"!=typeof b.bottom?b.bottom:t.bottom;t.left="undefined"!=typeof b.left?b.left:t.left;return a};a.width=function(b){if(!arguments.length)return r;r=b;return a};a.height=function(b){if(!arguments.length)return I;I=b;return a};a.color=function(b){if(!arguments.length)return E;E=v.utils.getColor(b);g.color(E);return a};a.showLegend=function(b){if(!arguments.length)return D;D=b;return a};a.tooltips=function(b){if(!arguments.length)return L;
L=b;return a};a.tooltipContent=function(b){if(!arguments.length)return S;S=b;return a};a.state=function(b){if(!arguments.length)return G;G=b;return a};a.defaultState=function(b){if(!arguments.length)return T;T=b;return a};a.noData=function(b){if(!arguments.length)return M;M=b;return a};return a};v.models.lineWithFocusChart=function(){function a(z){z.each(function(z){function O(){r.empty()||r.extent(T);fa.data([r.empty()?P.domain():T]).each(function(a,b){var f=P(a[0])-S.range()[0],m=S.range()[1]-P(a[1]);
d3.select(this).select(".left").attr("width",0>f?0:f);d3.select(this).select(".right").attr("x",P(a[1])).attr("width",0>m?0:m)})}function U(){T=r.empty()?null:r.extent();var a=r.empty()?P.domain():r.extent();1>=Math.abs(a[0]-a[1])||(F.brush({extent:a,brush:r}),O(),ia.select(".nv-focus .nv-linesWrap").datum(z.filter(function(a){return!a.disabled}).map(function(f,m){return{key:f.key,values:f.values.filter(function(f,m){return b.x()(f,m)>=a[0]&&b.x()(f,m)<=a[1]})}})).transition().duration(K).call(b),
ia.select(".nv-focus .nv-x.nv-axis").transition().duration(K).call(q),ia.select(".nv-focus .nv-y.nv-axis").transition().duration(K).call(p))}var H=d3.select(this),ba=this,W=(E||parseInt(H.style("width"))||960)-I.left-I.right,m=(D||parseInt(H.style("height"))||400)-I.top-I.bottom-L,Q=L-B.top-B.bottom;a.update=function(){H.transition().duration(K).call(a)};a.container=this;if(z&&z.length&&z.filter(function(a){return a.values.length}).length)H.selectAll(".nv-noData").remove();else{var da=H.selectAll(".nv-noData").data([y]);
...
"nv-x nv-axis");Y.append("g").attr("class","nv-y nv-axis");Y.append("g").attr("class","nv-linesWrap");J=J.append("g").attr("class","nv-context");J.append("g").attr("class","nv-x nv-axis");J.append("g").attr("class","nv-y nv-axis");J.append("g").attr("class","nv-linesWrap");J.append("g").attr("class","nv-brushBackground");J.append("g").attr("class","nv-x nv-brush");G&&(t.width(W),ia.select(".nv-legendWrap").datum(z).call(t),I.top!=t.height()&&(I.top=t.height(),m=(D||parseInt(H.style("height"))||400)-
...
d3.transition(da).call(k);q.scale(S).ticks(W/100).tickSize(-m,0);p.scale(C).ticks(m/36).tickSize(-W,0);ia.select(".nv-focus .nv-x.nv-axis").attr("transform","translate(0,"+m+")");r.x(P).on("brush",function(){var b=a.transitionDuration();a.transitionDuration(0);U();a.transitionDuration(b)});T&&r.extent(T);var fa=ia.select(".nv-brushBackground").selectAll("g").data([T||r.extent()]),m=fa.enter().append("g");m.append("rect").attr("class","left").attr("x",0).attr("y",0).attr("height",Q);m.append("rect").attr("class",
"right").attr("x",0).attr("y",0).attr("height",Q);m=ia.select(".nv-x.nv-brush").call(r);m.selectAll("rect").attr("height",Q);m.selectAll(".resize").append("path").attr("d",function(a){var b=(a=+("e"==a))?1:-1,f=Q/3;return"M"+.5*b+","+f+"A6,6 0 0 "+a+" "+6.5*b+","+(f+6)+"V"+(2*f-6)+"A6,6 0 0 "+a+" "+.5*b+","+2*f+"ZM"+2.5*b+","+(f+8)+"V"+(2*f-8)+"M"+4.5*b+","+(f+8)+"V"+(2*f-8)});U();f.scale(P).ticks(W/100).tickSize(-Q,0);ia.select(".nv-context .nv-x.nv-axis").attr("transform","translate(0,"+N.range()[0]+
")");d3.transition(ia.select(".nv-context .nv-x.nv-axis")).call(f);g.scale(N).ticks(Q/36).tickSize(-W,0);d3.transition(ia.select(".nv-context .nv-y.nv-axis")).call(g);ia.select(".nv-context .nv-x.nv-axis").attr("transform","translate(0,"+N.range()[0]+")");t.dispatch.on("stateChange",function(b){a.update()});F.on("tooltipShow",function(f){if(M){var m=ba.parentNode,g=f.pos[0]+(m.offsetLeft||0),k=f.pos[1]+(m.offsetTop||0),r=q.tickFormat()(b.x()(f.point,f.pointIndex)),t=p.tickFormat()(b.y()(f.point,f.pointIndex));
f=R(f.series.key,r,t,f,a);v.tooltip.show([g,k],f,null,null,m)}})});return a}var b=v.models.line(),k=v.models.line(),q=v.models.axis(),p=v.models.axis(),f=v.models.axis(),g=v.models.axis(),t=v.models.legend(),r=d3.svg.brush(),I={top:30,right:30,bottom:30,left:60},B={top:0,right:30,bottom:20,left:60},A=v.utils.defaultColor(),E=null,D=null,L=100,S,C,P,N,G=!0,T=null,M=!0,R=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},y="No Data Available.",F=d3.dispatch("tooltipShow","tooltipHide",
"brush"),K=250;b.clipEdge(!0);k.interactive(!1);q.orient("bottom").tickPadding(5);p.orient("left");f.orient("bottom").tickPadding(5);g.orient("left");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+I.left,a.pos[1]+I.top];F.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){F.tooltipHide(a)});F.on("tooltipHide",function(){M&&v.tooltip.cleanup()});a.dispatch=F;a.legend=t;a.lines=b;a.lines2=k;a.xAxis=q;a.yAxis=p;a.x2Axis=f;a.y2Axis=g;d3.rebind(a,b,"defined","isArea",
...
E.empty()?null:E.extent();M=E.empty()?z.domain():E.extent();W.brush({extent:M,brush:E});da();q.width(fa).height(ja).color(m.map(function(a,b){return a.color||G(a,b)}).filter(function(a,b){return!m[b].disabled&&m[b].bar}));b.width(fa).height(ja).color(m.map(function(a,b){return a.color||G(a,b)}).filter(function(a,b){return!m[b].disabled&&!m[b].bar}));var a=ra.select(".nv-focus .nv-barsWrap").datum(na.length?na.map(function(a,b){return{key:a.key,values:a.values.filter(function(a,b){return q.x()(a,b)>=
M[0]&&q.x()(a,b)<=M[1]})}}):[{values:[]}]),g=ra.select(".nv-focus .nv-linesWrap").datum(ha[0].disabled?[{values:[]}]:ha.map(function(a,f){return{key:a.key,values:a.values.filter(function(a,f){return b.x()(a,f)>=M[0]&&b.x()(a,f)<=M[1]})}}));K=na.length?q.xScale():b.xScale();f.scale(K).ticks(fa/100).tickSize(-ja,0);f.domain([Math.ceil(M[0]),Math.floor(M[1])]);ra.select(".nv-x.nv-axis").transition().duration(0).call(f);a.transition().duration(0).call(q);g.transition().duration(0).call(b);ra.select(".nv-focus .nv-x.nv-axis").attr("transform",
"translate(0,"+V.range()[0]+")");t.scale(V).ticks(ja/36).tickSize(-fa,0);ra.select(".nv-focus .nv-y1.nv-axis").style("opacity",na.length?1:0);r.scale(O).ticks(ja/36).tickSize(na.length?0:-fa,0);ra.select(".nv-focus .nv-y2.nv-axis").style("opacity",ha.length?1:0).attr("transform","translate("+K.range()[1]+",0)");ra.select(".nv-focus .nv-y1.nv-axis").transition().duration(0).call(t);ra.select(".nv-focus .nv-y2.nv-axis").transition().duration(0).call(r)}var ia=d3.select(this),Y=this,fa=(S||parseInt(ia.style("width"))||
...
return a}var na=m.filter(function(a){return!a.disabled&&a.bar}),ha=m.filter(function(a){return!a.bar});K=q.xScale();z=g.scale();V=q.yScale();O=b.yScale();U=p.yScale();H=k.yScale();var aa=m.filter(function(a){return!a.disabled&&a.bar}).map(function(a){return a.values.map(function(a,b){return{x:P(a,b),y:N(a,b)}})}),oa=m.filter(function(a){return!a.disabled&&!a.bar}).map(function(a){return a.values.map(function(a,b){return{x:P(a,b),y:N(a,b)}})});K.range([0,fa]);z.domain(d3.extent(d3.merge(aa.concat(oa)),
...
A.dispatch.on("stateChange",function(b){a.update()});W.on("tooltipShow",function(m){if(y){var g=Y.parentNode;M&&(m.pointIndex+=Math.ceil(M[0]));var k=m.pos[0]+(g.offsetLeft||0),p=m.pos[1]+(g.offsetTop||0),q=f.tickFormat()(b.x()(m.point,m.pointIndex)),z=(m.series.bar?t:r).tickFormat()(b.y()(m.point,m.pointIndex)),q=F(m.series.key,q,z,m,a);v.tooltip.show([k,p],q,0>m.value?"n":"s",null,g)}});J()});return a}var b=v.models.line(),k=v.models.line(),q=v.models.historicalBar(),p=v.models.historicalBar(),
...
f.orient("bottom").tickPadding(5);t.orient("left");r.orient("right");g.orient("bottom").tickPadding(5);I.orient("left");B.orient("right");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+D.left,a.pos[1]+D.top];W.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){W.tooltipHide(a)});q.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+D.left,a.pos[1]+D.top];W.tooltipShow(a)});q.dispatch.on("elementMouseout.tooltip",function(a){W.tooltipHide(a)});
W.on("tooltipHide",function(){y&&v.tooltip.cleanup()});a.dispatch=W;a.legend=A;a.lines=b;a.lines2=k;a.bars=q;a.bars2=p;a.xAxis=f;a.x2Axis=g;a.y1Axis=t;a.y2Axis=r;a.y3Axis=I;a.y4Axis=B;d3.rebind(a,b,"defined","size","clipVoronoi","interpolate");a.options=v.utils.optionsFunc.bind(a);a.x=function(f){if(!arguments.length)return P;P=f;b.x(f);q.x(f);return a};a.y=function(f){if(!arguments.length)return N;N=f;b.y(f);q.y(f);return a};a.margin=function(b){if(!arguments.length)return D;D.top="undefined"!=typeof b.top?
...
y=b;return a};a.tooltipContent=function(b){if(!arguments.length)return F;F=b;return a};a.noData=function(b){if(!arguments.length)return ba;ba=b;return a};a.brushExtent=function(b){if(!arguments.length)return R;R=b;return a};return a};v.models.multiBar=function(){function a(v){v.each(function(a){var v=k-b.left-b.right,K=q-b.top-b.bottom,U=d3.select(this);L&&a.length&&(L=[{values:a[0].values.map(function(a){return{x:a.x,y:0,series:a.series,size:.01}})}]);A&&(a=d3.layout.stack().offset(E).values(function(a){return a.values}).y(r)(!a.length&&
L?L:a));a.forEach(function(a,b){a.values.forEach(function(a){a.series=b})});A&&a[0].values.map(function(b,f){var g=0,k=0;a.map(function(a){a=a.values[f];a.size=Math.abs(a.y);0>a.y?(a.y1=k,k-=a.size):(a.y1=a.size+g,g+=a.size)})});var H=N&&G?[]:a.map(function(a){return a.values.map(function(a,b){return{x:t(a,b),y:r(a,b),y0:a.y0,y1:a.y1}})});p.domain(N||d3.merge(H).map(function(a){return a.x})).rangeBands(T||[0,v],R);f.domain(G||d3.extent(d3.merge(H).map(function(a){return A?0<a.y?a.y1:a.y1+a.y:a.y}).concat(I))).range(M||
...
"nv-bar positive"}).attr("x",function(b,f,g){return A?0:g*p.rangeBand()/a.length}).attr("y",function(a){return F(A?a.y0:0)}).attr("height",0).attr("width",p.rangeBand()/(A?1:a.length)).attr("transform",function(a,b){return"translate("+p(t(a,b))+",0)"});v.style("fill",function(a,b,f){return D(a,f,b)}).style("stroke",function(a,b,f){return D(a,f,b)}).on("mouseover",function(b,g){d3.select(this).classed("hover",!0);y.elementMouseover({value:r(b,g),point:b,series:a[b.series],pos:[p(t(b,g))+p.rangeBand()*
(A?a.length/2:b.series+.5)/a.length,f(r(b,g)+(A?b.y0:0))],pointIndex:g,seriesIndex:b.series,e:d3.event})}).on("mouseout",function(b,f){d3.select(this).classed("hover",!1);y.elementMouseout({value:r(b,f),point:b,series:a[b.series],pointIndex:f,seriesIndex:b.series,e:d3.event})}).on("click",function(b,g){y.elementClick({value:r(b,g),point:b,series:a[b.series],pos:[p(t(b,g))+p.rangeBand()*(A?a.length/2:b.series+.5)/a.length,f(r(b,g)+(A?b.y0:0))],pointIndex:g,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()}).on("dblclick",
function(b,g){y.elementDblClick({value:r(b,g),point:b,series:a[b.series],pos:[p(t(b,g))+p.rangeBand()*(A?a.length/2:b.series+.5)/a.length,f(r(b,g)+(A?b.y0:0))],pointIndex:g,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()});v.attr("class",function(a,b){return 0>r(a,b)?"nv-bar negative":"nv-bar positive"}).transition().attr("transform",function(a,b){return"translate("+p(t(a,b))+",0)"});S&&(C||(C=a.map(function(){return!0})),v.style("fill",function(a,b,f){return d3.rgb(S(a,b)).darker(C.map(function(a,
...
(A?1:a.length)):v.transition().delay(function(b,f){return f*P/a[0].values.length}).attr("x",function(b,f){return b.series*p.rangeBand()/a.length}).attr("width",p.rangeBand()/a.length).attr("y",function(a,b){return 0>r(a,b)?f(0):1>f(0)-f(r(a,b))?f(0)-1:f(r(a,b))||0}).attr("height",function(a,b){return Math.max(Math.abs(f(r(a,b))-f(0)),1)||0});p.copy();F=f.copy()});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,p=d3.scale.ordinal(),f=d3.scale.linear(),g=Math.floor(1E4*Math.random()),t=function(a){return a.x},
r=function(a){return a.y},I=[0],B=!0,A=!1,E="zero",D=v.utils.defaultColor(),L=!1,S=null,C,P=1200,N,G,T,M,R=.1,y=d3.dispatch("chartClick","elementClick","elementDblClick","elementMouseover","elementMouseout"),F;a.dispatch=y;a.options=v.utils.optionsFunc.bind(a);a.x=function(b){if(!arguments.length)return t;t=b;return a};a.y=function(b){if(!arguments.length)return r;r=b;return a};a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?
f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return p;p=b;return a};a.yScale=function(b){if(!arguments.length)return f;f=b;return a};a.xDomain=function(b){if(!arguments.length)return N;N=b;return a};a.yDomain=function(b){if(!arguments.length)return G;
...
(0===b||0!==ia%2?17:5)+")"})}S&&Q.filter(function(a,b){return 0!==b%Math.ceil(O[0].values.length/(ba/100))}).selectAll("text, line").style("opacity",0);P&&Q.selectAll(".tick text").attr("transform","rotate("+P+" 0,0)").style("text-anchor",0<P?"start":"end");m.select(".nv-x.nv-axis").selectAll("g.nv-axisMaxMin text").style("opacity",1)}D&&(q.scale(M).ticks(W/36).tickSize(-ba,0),m.select(".nv-y.nv-axis").transition().call(q));p.dispatch.on("stateChange",function(b){R=b;K.stateChange(R);a.update()});
f.dispatch.on("legendClick",function(f,m){if(f.disabled){J=J.map(function(a){a.disabled=!0;return a});f.disabled=!1;switch(f.key){case "Grouped":b.stacked(!1);break;case "Stacked":b.stacked(!0)}R.stacked=b.stacked();K.stateChange(R);a.update()}});K.on("tooltipShow",function(f){if(N){var m=H.parentNode,g=f.pos[0]+(m.offsetLeft||0),p=f.pos[1]+(m.offsetTop||0),r=k.tickFormat()(b.x()(f.point,f.pointIndex)),t=q.tickFormat()(b.y()(f.point,f.pointIndex)),r=G(f.series.key,r,t,f,a);v.tooltip.show([g,p],r,
0>f.value?"n":"s",null,m)}});K.on("changeState",function(f){"undefined"!==typeof f.disabled&&(O.forEach(function(a,b){a.disabled=f.disabled[b]}),R.disabled=f.disabled);"undefined"!==typeof f.stacked&&(b.stacked(f.stacked),R.stacked=f.stacked);a.update()})});return a}var b=v.models.multiBar(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f=v.models.legend(),g={top:30,right:20,bottom:50,left:60},t=null,r=null,I=v.utils.defaultColor(),B=!0,A=!0,E=!0,D=!0,L=!1,S=!0,C=!1,P=0,N=!0,G=function(a,
b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" on "+b+"</p>"},T,M,R={stacked:!1},y=null,F="No Data Available.",K=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),z=250;b.stacked(!1);k.orient("bottom").tickPadding(7).highlightZero(!0).showMaxMin(!1).tickFormat(function(a){return a});q.orient(L?"right":"left").tickFormat(d3.format(",.1f"));f.updateState(!1);b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+g.left,a.pos[1]+g.top];K.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",
function(a){K.tooltipHide(a)});K.on("tooltipHide",function(){N&&v.tooltip.cleanup()});a.dispatch=K;a.multibar=b;a.legend=p;a.xAxis=k;a.yAxis=q;d3.rebind(a,b,"x","y","xDomain","yDomain","xRange","yRange","forceX","forceY","clipEdge","id","stacked","stackOffset","delay","barColor","groupSpacing");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return g;g.top="undefined"!=typeof b.top?b.top:g.top;g.right="undefined"!=typeof b.right?b.right:g.right;g.bottom="undefined"!=
...
E=b;return a};a.showYAxis=function(b){if(!arguments.length)return D;D=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return L;L=b;q.orient(b?"right":"left");return a};a.reduceXTicks=function(b){if(!arguments.length)return S;S=b;return a};a.rotateLabels=function(b){if(!arguments.length)return P;P=b;return a};a.staggerLabels=function(b){if(!arguments.length)return C;C=b;return a};a.tooltip=function(b){if(!arguments.length)return G;G=b;return a};a.tooltips=function(b){if(!arguments.length)return N;
N=b;return a};a.tooltipContent=function(b){if(!arguments.length)return G;G=b;return a};a.state=function(b){if(!arguments.length)return R;R=b;return a};a.defaultState=function(b){if(!arguments.length)return y;y=b;return a};a.noData=function(b){if(!arguments.length)return F;F=b;return a};a.transitionDuration=function(b){if(!arguments.length)return z;z=b;return a};return a};v.models.multiBarHorizontal=function(){function a(p){p.each(function(a){var p=k-b.left-b.right,v=q-b.top-b.bottom;d3.select(this);
D&&(a=d3.layout.stack().offset("zero").values(function(a){return a.values}).y(r)(a));a.forEach(function(a,b){a.values.forEach(function(a){a.series=b})});D&&a[0].values.map(function(b,f){var g=0,m=0;a.map(function(a){a=a.values[f];a.size=Math.abs(a.y);0>a.y?(a.y1=m-a.size,m-=a.size):(a.y1=g,g+=a.size)})});var K=G&&T?[]:a.map(function(a){return a.values.map(function(a,b){return{x:t(a,b),y:r(a,b),y0:a.y0,y1:a.y1}})});f.domain(G||d3.merge(K).map(function(a){return a.x})).rangeBands(M||[0,v],.1);g.domain(T||
...
1).style("fill-opacity",.75);p=p.selectAll("g.nv-bar").data(function(a){return a.values});p.exit().remove();v=p.enter().append("g").attr("transform",function(b,g,k){return"translate("+F(D?b.y0:0)+","+(D?0:k*f.rangeBand()/a.length+f(t(b,g)))+")"});v.append("rect").attr("width",0).attr("height",f.rangeBand()/(D?1:a.length));p.on("mouseover",function(b,k){d3.select(this).classed("hover",!0);y.elementMouseover({value:r(b,k),point:b,series:a[b.series],pos:[g(r(b,k)+(D?b.y0:0)),f(t(b,k))+f.rangeBand()*
(D?a.length/2:b.series+.5)/a.length],pointIndex:k,seriesIndex:b.series,e:d3.event})}).on("mouseout",function(b,f){d3.select(this).classed("hover",!1);y.elementMouseout({value:r(b,f),point:b,series:a[b.series],pointIndex:f,seriesIndex:b.series,e:d3.event})}).on("click",function(b,k){y.elementClick({value:r(b,k),point:b,series:a[b.series],pos:[f(t(b,k))+f.rangeBand()*(D?a.length/2:b.series+.5)/a.length,g(r(b,k)+(D?b.y0:0))],pointIndex:k,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()}).on("dblclick",
function(b,k){y.elementDblClick({value:r(b,k),point:b,series:a[b.series],pos:[f(t(b,k))+f.rangeBand()*(D?a.length/2:b.series+.5)/a.length,g(r(b,k)+(D?b.y0:0))],pointIndex:k,seriesIndex:b.series,e:d3.event});d3.event.stopPropagation()});v.append("text");L&&!D?(p.select("text").attr("text-anchor",function(a,b){return 0>r(a,b)?"end":"start"}).attr("y",f.rangeBand()/(2*a.length)).attr("dy",".32em").text(function(a,b){return P(r(a,b))}),p.transition().select("text").attr("x",function(a,b){return 0>r(a,
b)?-4:g(r(a,b))-g(0)+4})):p.selectAll("text").text("");S&&!D?(v.append("text").classed("nv-bar-label",!0),p.select("text.nv-bar-label").attr("text-anchor",function(a,b){return 0>r(a,b)?"start":"end"}).attr("y",f.rangeBand()/(2*a.length)).attr("dy",".32em").text(function(a,b){return t(a,b)}),p.transition().select("text.nv-bar-label").attr("x",function(a,b){return 0>r(a,b)?g(0)-g(r(a,b))+4:-4})):p.selectAll("text.nv-bar-label").text("");p.attr("class",function(a,b){return 0>r(a,b)?"nv-bar negative":
"nv-bar positive"});A&&(E||(E=a.map(function(){return!0})),p.style("fill",function(a,b,f){return d3.rgb(A(a,b)).darker(E.map(function(a,b){return b}).filter(function(a,b){return!E[b]})[f]).toString()}).style("stroke",function(a,b,f){return d3.rgb(A(a,b)).darker(E.map(function(a,b){return b}).filter(function(a,b){return!E[b]})[f]).toString()}));D?p.transition().attr("transform",function(a,b){return"translate("+g(a.y1)+","+f(t(a,b))+")"}).select("rect").attr("width",function(a,b){return Math.abs(g(r(a,
b)+a.y0)-g(a.y0))}).attr("height",f.rangeBand()):p.transition().attr("transform",function(b,k){return"translate("+(0>r(b,k)?g(r(b,k)):g(0))+","+(b.series*f.rangeBand()/a.length+f(t(b,k)))+")"}).select("rect").attr("height",f.rangeBand()/a.length).attr("width",function(a,b){return Math.max(Math.abs(g(r(a,b))-g(0)),1)});f.copy();F=g.copy()});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,p=Math.floor(1E4*Math.random()),f=d3.scale.ordinal(),g=d3.scale.linear(),t=function(a){return a.x},r=
...
typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.yScale=function(b){if(!arguments.length)return g;g=b;return a};a.xDomain=function(b){if(!arguments.length)return G;G=b;return a};a.yDomain=function(b){if(!arguments.length)return T;
...
0),ba.select(".nv-x.nv-axis").transition().call(k),ba.select(".nv-x.nv-axis").selectAll("g").selectAll("line, text"));D&&(q.scale(P).ticks(J/100).tickSize(-O,0),ba.select(".nv-y.nv-axis").attr("transform","translate(0,"+O+")"),ba.select(".nv-y.nv-axis").transition().call(q));ba.select(".nv-zeroLine line").attr("x1",P(0)).attr("x2",P(0)).attr("y1",0).attr("y2",-O);p.dispatch.on("stateChange",function(b){N=b;M.stateChange(N);a.update()});f.dispatch.on("legendClick",function(f,g){if(f.disabled){W=W.map(function(a){a.disabled=
!0;return a});f.disabled=!1;switch(f.key){case "Grouped":b.stacked(!1);break;case "Stacked":b.stacked(!0)}N.stacked=b.stacked();M.stateChange(N);a.update()}});M.on("tooltipShow",function(f){if(L){var g=z.parentNode,p=f.pos[0]+(g.offsetLeft||0),r=f.pos[1]+(g.offsetTop||0),t=k.tickFormat()(b.x()(f.point,f.pointIndex)),y=q.tickFormat()(b.y()(f.point,f.pointIndex)),t=S(f.series.key,t,y,f,a);v.tooltip.show([p,r],t,0>f.value?"e":"w",null,g)}});M.on("changeState",function(f){"undefined"!==typeof f.disabled&&
(y.forEach(function(a,b){a.disabled=f.disabled[b]}),N.disabled=f.disabled);"undefined"!==typeof f.stacked&&(b.stacked(f.stacked),N.stacked=f.stacked);a.update()})});return a}var b=v.models.multiBarHorizontal(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend().height(30),f=v.models.legend().height(30),g={top:30,right:20,bottom:50,left:60},t=null,r=null,I=v.utils.defaultColor(),B=!0,A=!0,E=!0,D=!0,L=!0,S=function(a,b,f,g,k){return"<h3>"+a+" - "+b+"</h3><p>"+f+"</p>"},C,P,N={stacked:!1},G=null,
T="No Data Available.",M=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),R=250;b.stacked(!1);k.orient("left").tickPadding(5).highlightZero(!1).showMaxMin(!1).tickFormat(function(a){return a});q.orient("bottom").tickFormat(d3.format(",.1f"));f.updateState(!1);b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+g.left,a.pos[1]+g.top];M.tooltipShow(a)});b.dispatch.on("elementMouseout.tooltip",function(a){M.tooltipHide(a)});M.on("tooltipHide",function(){L&&v.tooltip.cleanup()});
a.dispatch=M;a.multibar=b;a.legend=p;a.xAxis=k;a.yAxis=q;d3.rebind(a,b,"x","y","xDomain","yDomain","xRange","yRange","forceX","forceY","clipEdge","id","delay","showValues","showBarLabels","valueFormat","stacked","barColor");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return g;g.top="undefined"!=typeof b.top?b.top:g.top;g.right="undefined"!=typeof b.right?b.right:g.right;g.bottom="undefined"!=typeof b.bottom?b.bottom:g.bottom;g.left="undefined"!=typeof b.left?b.left:
...
v.models.multiChart=function(){function a(F){F.each(function(F){var z=d3.select(this),J=this;a.update=function(){z.transition().call(a)};a.container=this;var O=(q||parseInt(z.style("width"))||960)-b.left-b.right,U=(p||parseInt(z.style("height"))||400)-b.top-b.bottom,H=F.filter(function(a){return!a.disabled&&"line"==a.type&&1==a.yAxis}),ba=F.filter(function(a){return!a.disabled&&"line"==a.type&&2==a.yAxis}),W=F.filter(function(a){return!a.disabled&&"bar"==a.type&&1==a.yAxis}),m=F.filter(function(a){return!a.disabled&&
"bar"==a.type&&2==a.yAxis}),Q=F.filter(function(a){return!a.disabled&&"area"==a.type&&1==a.yAxis}),da=F.filter(function(a){return!a.disabled&&"area"==a.type&&2==a.yAxis}),qa=F.filter(function(a){return!a.disabled&&1==a.yAxis}).map(function(a){return a.values.map(function(a,b){return{x:a.x,y:a.y}})}),ia=F.filter(function(a){return!a.disabled&&2==a.yAxis}).map(function(a){return a.values.map(function(a,b){return{x:a.x,y:a.y}})});r.domain(d3.extent(d3.merge(qa.concat(ia)),function(a){return a.x})).range([0,
...
U+")");d3.transition(Y.select(".x.axis")).call(G);T.ticks(U/36).tickSize(-O,0);d3.transition(Y.select(".y1.axis")).call(T);M.ticks(U/36).tickSize(-O,0);d3.transition(Y.select(".y2.axis")).call(M);Y.select(".y2.axis").style("opacity",ia.length?1:0).attr("transform","translate("+r.range()[1]+",0)");R.dispatch.on("stateChange",function(b){a.update()});y.on("tooltipShow",function(b){if(g){var f=J.parentNode,m=b.pos[0]+(f.offsetLeft||0),k=b.pos[1]+(f.offsetTop||0),p=G.tickFormat()(D.x()(b.point,b.pointIndex)),
q=(2==b.series.yAxis?M:T).tickFormat()(D.y()(b.point,b.pointIndex));b=t(b.series.key,p,q,b,a);v.tooltip.show([m,k],b,void 0,void 0,f.offsetParent)}})});return a}var b={top:30,right:20,bottom:50,left:60},k=d3.scale.category20().range(),q=null,p=null,f=!0,g=!0,t=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" at "+b+"</p>"},r,I,B;r=d3.scale.linear();var A=d3.scale.linear(),E=d3.scale.linear(),D=v.models.line().yScale(A),L=v.models.line().yScale(E),S=v.models.multiBar().stacked(!1).yScale(A),C=v.models.multiBar().stacked(!1).yScale(E),
P=v.models.stackedArea().yScale(A),N=v.models.stackedArea().yScale(E),G=v.models.axis().scale(r).orient("bottom").tickPadding(5),T=v.models.axis().scale(A).orient("left"),M=v.models.axis().scale(E).orient("right"),R=v.models.legend().height(30),y=d3.dispatch("tooltipShow","tooltipHide");D.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+b.left,a.pos[1]+b.top];y.tooltipShow(a)});D.dispatch.on("elementMouseout.tooltip",function(a){y.tooltipHide(a)});L.dispatch.on("elementMouseover.tooltip",
...
q=b;return a};a.height=function(b){if(!arguments.length)return p;p=b;return a};a.color=function(b){if(!arguments.length)return k;k=b;R.color(b);return a};a.showLegend=function(b){if(!arguments.length)return f;f=b;return a};a.tooltips=function(b){if(!arguments.length)return g;g=b;return a};a.tooltipContent=function(b){if(!arguments.length)return t;t=b;return a};return a};v.models.ohlcBar=function(){function a(v){v.each(function(a){var v=k-b.left-b.right,y=q-b.top-b.bottom,P=d3.select(this);f.domain(N||
d3.extent(a[0].values.map(t).concat(D)));S?f.range(T||[.5*v/a[0].values.length,v*(a[0].values.length-.5)/a[0].values.length]):f.range(T||[0,v]);g.domain(G||[d3.min(a[0].values.map(E).concat(L)),d3.max(a[0].values.map(A).concat(L))]).range(M||[y,0]);f.domain()[0]===f.domain()[1]&&(f.domain()[0]?f.domain([f.domain()[0]-.01*f.domain()[0],f.domain()[1]+.01*f.domain()[1]]):f.domain([-1,1]));g.domain()[0]===g.domain()[1]&&(g.domain()[0]?g.domain([g.domain()[0]+.01*g.domain()[0],g.domain()[1]-.01*g.domain()[1]]):
...
function(a,b){return"translate("+f(t(a,b))+","+g(A(a,b))+")"}).on("mouseover",function(b,m){d3.select(this).classed("hover",!0);R.elementMouseover({point:b,series:a[0],pos:[f(t(b,m)),g(r(b,m))],pointIndex:m,seriesIndex:0,e:d3.event})}).on("mouseout",function(b,f){d3.select(this).classed("hover",!1);R.elementMouseout({point:b,series:a[0],pointIndex:f,seriesIndex:0,e:d3.event})}).on("click",function(a,b){R.elementClick({value:r(a,b),data:a,index:b,pos:[f(t(a,b)),g(r(a,b))],e:d3.event,id:p});d3.event.stopPropagation()}).on("dblclick",
function(a,b){R.elementDblClick({value:r(a,b),data:a,index:b,pos:[f(t(a,b)),g(r(a,b))],e:d3.event,id:p});d3.event.stopPropagation()});y.attr("class",function(a,b,f){return(I(a,b)>B(a,b)?"nv-tick negative":"nv-tick positive")+" nv-tick-"+f+"-"+b});d3.transition(y).attr("transform",function(a,b){return"translate("+f(t(a,b))+","+g(A(a,b))+")"}).attr("d",function(b,f){var k=v/a[0].values.length*.9;return"m0,0l0,"+(g(I(b,f))-g(A(b,f)))+"l"+-k/2+",0l"+k/2+",0l0,"+(g(E(b,f))-g(I(b,f)))+"l0,"+(g(B(b,f))-
g(E(b,f)))+"l"+k/2+",0l"+-k/2+",0z"})});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,p=Math.floor(1E4*Math.random()),f=d3.scale.linear(),g=d3.scale.linear(),t=function(a){return a.x},r=function(a){return a.y},I=function(a){return a.open},B=function(a){return a.close},A=function(a){return a.high},E=function(a){return a.low},D=[],L=[],S=!1,C=!0,P=v.utils.defaultColor(),N,G,T,M,R=d3.dispatch("chartClick","elementClick","elementDblClick","elementMouseover","elementMouseout");a.dispatch=
R;a.options=v.utils.optionsFunc.bind(a);a.x=function(b){if(!arguments.length)return t;t=b;return a};a.y=function(b){if(!arguments.length)return r;r=b;return a};a.open=function(b){if(!arguments.length)return I;I=b;return a};a.close=function(b){if(!arguments.length)return B;B=b;return a};a.high=function(b){if(!arguments.length)return A;A=b;return a};a.low=function(b){if(!arguments.length)return E;E=b;return a};a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:
b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.yScale=function(b){if(!arguments.length)return g;g=b;return a};a.xDomain=function(b){if(!arguments.length)return N;N=b;return a};a.yDomain=
...
var b={top:0,right:0,bottom:0,left:0},k=500,q=500,p=function(a){return a.x},f=function(a){return a.y},g=function(a){return a.description},t=Math.floor(1E4*Math.random()),r=v.utils.defaultColor(),I=d3.format(",.2f"),B=!0,A=!0,E=!1,D="key",L=.02,S=!1,C=!1,P=!1,N=!1,G=.5,T=d3.dispatch("chartClick","elementClick","elementDblClick","elementMouseover","elementMouseout");a.dispatch=T;a.options=v.utils.optionsFunc.bind(a);a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?
f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.values=function(b){v.log("pie.values() is no longer supported.");return a};a.x=function(b){if(!arguments.length)return p;p=b;return a};a.y=function(b){if(!arguments.length)return f;f=d3.functor(b);
...
S=b;return a};a.donutRatio=function(b){if(!arguments.length)return G;G=b;return a};a.startAngle=function(b){if(!arguments.length)return P;P=b;return a};a.endAngle=function(b){if(!arguments.length)return N;N=b;return a};a.id=function(b){if(!arguments.length)return t;t=b;return a};a.color=function(b){if(!arguments.length)return r;r=v.utils.getColor(b);return a};a.valueFormat=function(b){if(!arguments.length)return I;I=b;return a};a.labelThreshold=function(b){if(!arguments.length)return L;L=b;return a};
return a};v.models.pieChart=function(){function a(r){r.each(function(r){var t=d3.select(this),v=(p||parseInt(t.style("width"))||960)-q.left-q.right,L=(f||parseInt(t.style("height"))||400)-q.top-q.bottom;a.update=function(){t.transition().call(a)};a.container=this;B.disabled=r.map(function(a){return!!a.disabled});if(!A){var G;A={};for(G in B)A[G]=B[G]instanceof Array?B[G].slice(0):B[G]}if(r&&r.length)t.selectAll(".nv-noData").remove();else return G=t.selectAll(".nv-noData").data([E]),G.enter().append("text").attr("class",
"nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),G.attr("x",q.left+v/2).attr("y",q.top+L/2).text(function(a){return a}),a;G=t.selectAll("g.nv-wrap.nv-pieChart").data([r]);var I=G.enter().append("g").attr("class","nvd3 nv-wrap nv-pieChart").append("g"),M=G.select("g");I.append("g").attr("class","nv-pieWrap");I.append("g").attr("class","nv-legendWrap");g&&(k.width(v).key(b.x()),G.select(".nv-legendWrap").datum(r).call(k),q.top!=k.height()&&(q.top=k.height(),L=(f||parseInt(t.style("height"))||
400)-q.top-q.bottom),G.select(".nv-legendWrap").attr("transform","translate(0,"+-q.top+")"));G.attr("transform","translate("+q.left+","+q.top+")");b.width(v).height(L);v=M.select(".nv-pieWrap").datum([r]);d3.transition(v).call(b);k.dispatch.on("stateChange",function(b){B=b;D.stateChange(B);a.update()});b.dispatch.on("elementMouseout.tooltip",function(a){D.tooltipHide(a)});D.on("changeState",function(b){"undefined"!==typeof b.disabled&&(r.forEach(function(a,f){a.disabled=b.disabled[f]}),B.disabled=
b.disabled);a.update()})});return a}var b=v.models.pie(),k=v.models.legend(),q={top:30,right:20,bottom:20,left:20},p=null,f=null,g=!0,t=v.utils.defaultColor(),r=!0,I=function(a,b,f,g){return"<h3>"+a+"</h3><p>"+b+"</p>"},B={},A=null,E="No Data Available.",D=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState");b.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+q.left,a.pos[1]+q.top];D.tooltipShow(a)});D.on("tooltipShow",function(f){if(r){var g=b.description()(f.point)||
b.x()(f.point),k=f.pos[0]+0,p=f.pos[1]+0,q=b.valueFormat()(b.y()(f.point)),g=I(g,q,f,a);v.tooltip.show([k,p],g,0>f.value?"n":"s",null,void 0)}});D.on("tooltipHide",function(){r&&v.tooltip.cleanup()});a.legend=k;a.dispatch=D;a.pie=b;d3.rebind(a,b,"valueFormat","values","x","y","description","id","showLabels","donutLabelsOutside","pieLabelsOutside","labelType","donut","donutRatio","labelThreshold");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return q;q.top="undefined"!=
typeof b.top?b.top:q.top;q.right="undefined"!=typeof b.right?b.right:q.right;q.bottom="undefined"!=typeof b.bottom?b.bottom:q.bottom;q.left="undefined"!=typeof b.left?b.left:q.left;return a};a.width=function(b){if(!arguments.length)return p;p=b;return a};a.height=function(b){if(!arguments.length)return f;f=b;return a};a.color=function(f){if(!arguments.length)return t;t=v.utils.getColor(f);k.color(t);b.color(t);return a};a.showLegend=function(b){if(!arguments.length)return g;g=b;return a};a.tooltips=
function(b){if(!arguments.length)return r;r=b;return a};a.tooltipContent=function(b){if(!arguments.length)return I;I=b;return a};a.state=function(b){if(!arguments.length)return B;B=b;return a};a.defaultState=function(b){if(!arguments.length)return A;A=b;return a};a.noData=function(b){if(!arguments.length)return E;E=b;return a};return a};v.models.scatter=function(){function a(Y){Y.each(function(a){var Y=k-b.left-b.right,ca=q-b.top-b.bottom,aa=d3.select(this);a.forEach(function(a,b){a.values.forEach(function(a){a.series=
b})});var na=K&&z&&U?[]:d3.merge(a.map(function(a){return a.values.map(function(a,b){return{x:I(a,b),y:B(a,b),size:A(a,b)}})}));g.domain(K||d3.extent(na.map(function(a){return a.x}).concat(L)));T&&a[0]?g.range(J||[(Y*M+Y)/(2*a[0].values.length),Y-Y*(1+M)/(2*a[0].values.length)]):g.range(J||[0,Y]);t.domain(z||d3.extent(na.map(function(a){return a.y}).concat(S))).range(O||[ca,0]);r.domain(U||d3.extent(na.map(function(a){return a.size}).concat(C))).range(H||[16,256]);if(g.domain()[0]===g.domain()[1]||
t.domain()[0]===t.domain()[1])ba=!0;g.domain()[0]===g.domain()[1]&&(g.domain()[0]?g.domain([g.domain()[0]-.01*g.domain()[0],g.domain()[1]+.01*g.domain()[1]]):g.domain([-1,1]));t.domain()[0]===t.domain()[1]&&(t.domain()[0]?t.domain([t.domain()[0]-.01*t.domain()[0],t.domain()[1]+.01*t.domain()[1]]):t.domain([-1,1]));isNaN(g.domain()[0])&&g.domain([-1,1]);isNaN(t.domain()[0])&&t.domain([-1,1]);Q=Q||g;da=da||t;var ha=aa.selectAll("g.nv-wrap.nv-scatter").data([a]),na=ha.enter().append("g").attr("class",
...
b){return a.color}).style("stroke",function(a,b){return a.color}).attr("cx",function(a,b){return v.utils.NaNtoZero(Q(I(a,b)))}).attr("cy",function(a,b){return v.utils.NaNtoZero(da(B(a,b)))}).attr("r",function(a,b){return Math.sqrt(r(A(a,b))/Math.PI)}),ca.exit().remove(),Y.exit().selectAll("path.nv-point").transition().attr("cx",function(a,b){return v.utils.NaNtoZero(g(I(a,b)))}).attr("cy",function(a,b){return v.utils.NaNtoZero(t(B(a,b)))}).remove(),ca.each(function(a,b){d3.select(this).classed("nv-point",
!0).classed("nv-point-"+b,!0).classed("hover",!1)}),ca.transition().attr("cx",function(a,b){return v.utils.NaNtoZero(g(I(a,b)))}).attr("cy",function(a,b){return v.utils.NaNtoZero(t(B(a,b)))}).attr("r",function(a,b){return Math.sqrt(r(A(a,b))/Math.PI)})):(ca=Y.selectAll("path.nv-point").data(function(a){return a.values}),ca.enter().append("path").style("fill",function(a,b){return a.color}).style("stroke",function(a,b){return a.color}).attr("transform",function(a,b){return"translate("+Q(I(a,b))+","+
da(B(a,b))+")"}).attr("d",d3.svg.symbol().type(E).size(function(a,b){return r(A(a,b))})),ca.exit().remove(),Y.exit().selectAll("path.nv-point").transition().attr("transform",function(a,b){return"translate("+g(I(a,b))+","+t(B(a,b))+")"}).remove(),ca.each(function(a,b){d3.select(this).classed("nv-point",!0).classed("nv-point-"+b,!0).classed("hover",!1)}),ca.transition().attr("transform",function(a,b){return"translate("+g(I(a,b))+","+t(B(a,b))+")"}).attr("d",d3.svg.symbol().type(E).size(function(a,b){return r(A(a,
b))})));clearTimeout(qa);qa=setTimeout(function(){if(!P)return!1;var p=d3.merge(a.map(function(a,b){return a.values.map(function(a,f){var k=I(a,f),m=B(a,f);return[g(k)+1E-7*Math.random(),t(m)+1E-7*Math.random(),b,f,a]}).filter(function(a,b){return G(a[4],b)})}));if(!0===m){if(y){ha.select("defs").selectAll(".nv-point-clips").data([f]).enter().append("clipPath").attr("class","nv-point-clips").attr("id","nv-points-clip-"+f);var r=ha.select("#nv-points-clip-"+f).selectAll("circle").data(p);r.enter().append("circle").attr("r",
F);r.exit().remove();r.attr("cx",function(a){return a[0]}).attr("cy",function(a){return a[1]});ha.select(".nv-point-paths").attr("clip-path","url(#nv-points-clip-"+f+")")}p.length&&(p.push([g.range()[0]-20,t.range()[0]-20,null,null]),p.push([g.range()[1]+20,t.range()[1]+20,null,null]),p.push([g.range()[0]-20,t.range()[0]+20,null,null]),p.push([g.range()[1]+20,t.range()[1]-20,null,null]));var v=d3.geom.polygon([[-10,-10],[-10,q+10],[k+10,q+10],[k+10,-10]]),r=d3.geom.voronoi(p).map(function(a,b){return{data:v.clip(a),
series:p[b][2],point:p[b][3]}}),r=ha.select(".nv-point-paths").selectAll("path").data(r);r.enter().append("path").attr("class",function(a,b){return"nv-path-"+b});r.exit().remove();r.attr("d",function(a){return 0===a.data.length?"M 0 0":"M"+a.data.join("L")+"Z"});var z=function(f,k){if(ia)return 0;var m=a[f.series];if("undefined"!==typeof m){var p=m.values[f.point];k({point:p,series:m,pos:[g(I(p,f.point))+b.left,t(B(p,f.point))+b.top],seriesIndex:f.series,pointIndex:f.point})}};r.on("click",function(a){z(a,
W.elementClick)}).on("mouseover",function(a){z(a,W.elementMouseover)}).on("mouseout",function(a,b){z(a,W.elementMouseout)})}else ha.select(".nv-groups").selectAll(".nv-group").selectAll(".nv-point").on("click",function(f,k){if(ia||!a[f.series])return 0;var m=a[f.series],p=m.values[k];W.elementClick({point:p,series:m,pos:[g(I(p,k))+b.left,t(B(p,k))+b.top],seriesIndex:f.series,pointIndex:k})}).on("mouseover",function(f,k){if(ia||!a[f.series])return 0;var m=a[f.series],p=m.values[k];W.elementMouseover({point:p,
series:m,pos:[g(I(p,k))+b.left,t(B(p,k))+b.top],seriesIndex:f.series,pointIndex:k})}).on("mouseout",function(b,f){if(ia||!a[b.series])return 0;var g=a[b.series];W.elementMouseout({point:g.values[f],series:g,seriesIndex:b.series,pointIndex:f})});ia=!1},300);Q=g.copy();da=t.copy();r.copy()});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,p=v.utils.defaultColor(),f=Math.floor(1E5*Math.random()),g=d3.scale.linear(),t=d3.scale.linear(),r=d3.scale.linear(),I=function(a){return a.x},B=function(a){return a.y},
...
b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.xScale=function(b){if(!arguments.length)return g;g=b;return a};a.yScale=function(b){if(!arguments.length)return t;t=b;return a};a.zScale=function(b){if(!arguments.length)return r;
r=b;return a};a.xDomain=function(b){if(!arguments.length)return K;K=b;return a};a.yDomain=function(b){if(!arguments.length)return z;z=b;return a};a.sizeDomain=function(b){if(!arguments.length)return U;U=b;return a};a.xRange=function(b){if(!arguments.length)return J;J=b;return a};a.yRange=function(b){if(!arguments.length)return O;O=b;return a};a.sizeRange=function(b){if(!arguments.length)return H;H=b;return a};a.forceX=function(b){if(!arguments.length)return L;L=b;return a};a.forceY=function(b){if(!arguments.length)return S;
...
ba=b;return a};return a};v.models.scatterChart=function(){function a(da){da.each(function(da){function ia(){if(F)return ha.select(".nv-point-paths").style("pointer-events","all"),!1;ha.select(".nv-point-paths").style("pointer-events","none");var a=d3.mouse(this);E.distortion(y).focus(a[0]);D.distortion(y).focus(a[1]);ha.select(".nv-scatterWrap").call(b);G&&ha.select(".nv-x.nv-axis").call(k);T&&ha.select(".nv-y.nv-axis").call(q);ha.select(".nv-distributionX").datum(da.filter(function(a){return!a.disabled})).call(g);
ha.select(".nv-distributionY").datum(da.filter(function(a){return!a.disabled})).call(t)}var Y=d3.select(this),fa=this,ja=(I||parseInt(Y.style("width"))||960)-r.left-r.right,ca=(B||parseInt(Y.style("height"))||400)-r.top-r.bottom;a.update=function(){Y.transition().duration(m).call(a)};a.container=this;U.disabled=da.map(function(a){return!!a.disabled});if(!H){var aa;H={};for(aa in U)H[aa]=U[aa]instanceof Array?U[aa].slice(0):U[aa]}if(da&&da.length&&da.filter(function(a){return a.values.length}).length)Y.selectAll(".nv-noData").remove();
else return aa=Y.selectAll(".nv-noData").data([W]),aa.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),aa.attr("x",r.left+ja/2).attr("y",r.top+ca/2).text(function(a){return a}),a;aa=Y.selectAll("g.nv-wrap.nv-scatterChart").data([da]);var na=aa.enter().append("g").attr("class","nvd3 nv-wrap nv-scatterChart nv-chart-"+b.id()).append("g"),ha=aa.select("g");na.append("rect").attr("class","nvd3 nv-background");na.append("g").attr("class","nv-x nv-axis");
na.append("g").attr("class","nv-y nv-axis");na.append("g").attr("class","nv-scatterWrap");na.append("g").attr("class","nv-distWrap");na.append("g").attr("class","nv-legendWrap");na.append("g").attr("class","nv-controlsWrap");if(N){var oa=J?ja/2:ja;p.width(oa);aa.select(".nv-legendWrap").datum(da).call(p);r.top!=p.height()&&(r.top=p.height(),ca=(B||parseInt(Y.style("height"))||400)-r.top-r.bottom);aa.select(".nv-legendWrap").attr("transform","translate("+(ja-oa)+","+-r.top+")")}J&&(f.width(180).color(["#444"]),
ha.select(".nv-controlsWrap").datum(Q).attr("transform","translate(0,"+-r.top+")").call(f));aa.attr("transform","translate("+r.left+","+r.top+")");M&&ha.select(".nv-y.nv-axis").attr("transform","translate("+ja+",0)");b.width(ja).height(ca).color(da.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!da[b].disabled}));0!==L&&b.xDomain(null);0!==S&&b.yDomain(null);aa.select(".nv-scatterWrap").datum(da.filter(function(a){return!a.disabled})).call(b);0!==L&&(oa=E.domain()[1]-E.domain()[0],
b.xDomain([E.domain()[0]-L*oa,E.domain()[1]+L*oa]));0!==S&&(oa=D.domain()[1]-D.domain()[0],b.yDomain([D.domain()[0]-S*oa,D.domain()[1]+S*oa]));0===S&&0===L||aa.select(".nv-scatterWrap").datum(da.filter(function(a){return!a.disabled})).call(b);G&&(k.scale(E).ticks(k.ticks()&&k.ticks().length?k.ticks():ja/100).tickSize(-ca,0),ha.select(".nv-x.nv-axis").attr("transform","translate(0,"+D.range()[0]+")").call(k));T&&(q.scale(D).ticks(q.ticks()&&q.ticks().length?q.ticks():ca/36).tickSize(-ja,0),ha.select(".nv-y.nv-axis").call(q));
C&&(g.getData(b.x()).scale(E).width(ja).color(da.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!da[b].disabled})),na.select(".nv-distWrap").append("g").attr("class","nv-distributionX"),ha.select(".nv-distributionX").attr("transform","translate(0,"+D.range()[0]+")").datum(da.filter(function(a){return!a.disabled})).call(g));P&&(t.getData(b.y()).scale(D).width(ca).color(da.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!da[b].disabled})),na.select(".nv-distWrap").append("g").attr("class",
"nv-distributionY"),ha.select(".nv-distributionY").attr("transform","translate("+(M?ja:-t.size())+",0)").datum(da.filter(function(a){return!a.disabled})).call(t));d3.fisheye&&(ha.select(".nv-background").attr("width",ja).attr("height",ca),ha.select(".nv-background").on("mousemove",ia),ha.select(".nv-background").on("click",function(){F=!F}),b.dispatch.on("elementClick.freezeFisheye",function(){F=!F}));f.dispatch.on("legendClick",function(f,g){f.disabled=!f.disabled;y=f.disabled?0:2.5;ha.select(".nv-background").style("pointer-events",
f.disabled?"none":"all");ha.select(".nv-point-paths").style("pointer-events",f.disabled?"all":"none");f.disabled?(E.distortion(y).focus(0),D.distortion(y).focus(0),ha.select(".nv-scatterWrap").call(b),ha.select(".nv-x.nv-axis").call(k),ha.select(".nv-y.nv-axis").call(q)):F=!1;a.update()});p.dispatch.on("stateChange",function(b){U.disabled=b.disabled;ba.stateChange(U);a.update()});b.dispatch.on("elementMouseover.tooltip",function(a){d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-distx-"+
a.pointIndex).attr("y1",function(b,f){return a.pos[1]-ca});d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-disty-"+a.pointIndex).attr("x2",a.pos[0]+g.size());a.pos=[a.pos[0]+r.left,a.pos[1]+r.top];ba.tooltipShow(a)});ba.on("tooltipShow",function(f){if(K){var g=fa.parentNode,m=f.pos[0]+(g.offsetLeft||0),p=f.pos[1]+(g.offsetTop||0),t=f.pos[0]+(g.offsetLeft||0),y=D.range()[0]+r.top+(g.offsetTop||0),B=E.range()[0]+r.left+(g.offsetLeft||0),C=f.pos[1]+(g.offsetTop||0),A=k.tickFormat()(b.x()(f.point,
f.pointIndex)),H=q.tickFormat()(b.y()(f.point,f.pointIndex));null!=z&&v.tooltip.show([t,y],z(f.series.key,A,H,f,a),"n",1,g,"x-nvtooltip");null!=V&&v.tooltip.show([B,C],V(f.series.key,A,H,f,a),"e",1,g,"y-nvtooltip");null!=O&&v.tooltip.show([m,p],O(f.series.key,A,H,f,a),0>f.value?"n":"s",null,g)}});ba.on("changeState",function(b){"undefined"!==typeof b.disabled&&(da.forEach(function(a,f){a.disabled=b.disabled[f]}),U.disabled=b.disabled);a.update()});E.copy();D.copy()});return a}var b=v.models.scatter(),
k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f=v.models.legend(),g=v.models.distribution(),t=v.models.distribution(),r={top:30,right:20,bottom:50,left:75},I=null,B=null,A=v.utils.defaultColor(),E=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):b.xScale(),D=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):b.yScale(),L=0,S=0,C=!1,P=!1,N=!0,G=!0,T=!0,M=!1,J=!!d3.fisheye,y=0,F=!1,K=!0,z=function(a,b,f){return"<strong>"+b+"</strong>"},V=function(a,b,f){return"<strong>"+
f+"</strong>"},O=null,U={},H=null,ba=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),W="No Data Available.",m=250;b.xScale(E).yScale(D);k.orient("bottom").tickPadding(10);q.orient(M?"right":"left").tickPadding(10);g.axis("x");t.axis("y");f.updateState(!1);var Q=[{key:"Magnify",disabled:!0}];b.dispatch.on("elementMouseout.tooltip",function(a){ba.tooltipHide(a);d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-distx-"+a.pointIndex).attr("y1",0);d3.select(".nv-chart-"+
b.id()+" .nv-series-"+a.seriesIndex+" .nv-disty-"+a.pointIndex).attr("x2",t.size())});ba.on("tooltipHide",function(){K&&v.tooltip.cleanup()});a.dispatch=ba;a.scatter=b;a.legend=p;a.controls=f;a.xAxis=k;a.yAxis=q;a.distX=g;a.distY=t;d3.rebind(a,b,"id","interactive","pointActive","x","y","shape","size","xScale","yScale","zScale","xDomain","yDomain","xRange","yRange","sizeDomain","sizeRange","forceX","forceY","forceSize","clipVoronoi","clipRadius","useVoronoi");a.options=v.utils.optionsFunc.bind(a);
a.margin=function(b){if(!arguments.length)return r;r.top="undefined"!=typeof b.top?b.top:r.top;r.right="undefined"!=typeof b.right?b.right:r.right;r.bottom="undefined"!=typeof b.bottom?b.bottom:r.bottom;r.left="undefined"!=typeof b.left?b.left:r.left;return a};a.width=function(b){if(!arguments.length)return I;I=b;return a};a.height=function(b){if(!arguments.length)return B;B=b;return a};a.color=function(b){if(!arguments.length)return A;A=v.utils.getColor(b);p.color(A);g.color(A);t.color(A);return a};
a.showDistX=function(b){if(!arguments.length)return C;C=b;return a};a.showDistY=function(b){if(!arguments.length)return P;P=b;return a};a.showControls=function(b){if(!arguments.length)return J;J=b;return a};a.showLegend=function(b){if(!arguments.length)return N;N=b;return a};a.showXAxis=function(b){if(!arguments.length)return G;G=b;return a};a.showYAxis=function(b){if(!arguments.length)return T;T=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return M;M=b;q.orient(b?"right":"left");
...
var a=d3.mouse(this);E.distortion(M).focus(a[0]);D.distortion(M).focus(a[1]);aa.select(".nv-scatterWrap").datum(m.filter(function(a){return!a.disabled})).call(b);P&&aa.select(".nv-x.nv-axis").call(k);N&&aa.select(".nv-y.nv-axis").call(q);aa.select(".nv-distributionX").datum(m.filter(function(a){return!a.disabled})).call(g);aa.select(".nv-distributionY").datum(m.filter(function(a){return!a.disabled})).call(t)}var qa=d3.select(this),ia=this,Y=(I||parseInt(qa.style("width"))||960)-r.left-r.right,fa=
(B||parseInt(qa.style("height"))||400)-r.top-r.bottom;a.update=function(){qa.transition().duration(ba).call(a)};a.container=this;V.disabled=m.map(function(a){return!!a.disabled});if(!O){var ja;O={};for(ja in V)O[ja]=V[ja]instanceof Array?V[ja].slice(0):V[ja]}if(m&&m.length&&m.filter(function(a){return a.values.length}).length)qa.selectAll(".nv-noData").remove();else return ja=qa.selectAll(".nv-noData").data([H]),ja.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor",
"middle"),ja.attr("x",r.left+Y/2).attr("y",r.top+fa/2).text(function(a){return a}),a;E=b.xScale();D=b.yScale();var ca=qa.selectAll("g.nv-wrap.nv-scatterChart").data([m]);ja=ca.enter().append("g").attr("class","nvd3 nv-wrap nv-scatterChart nv-chart-"+b.id()).append("g");var aa=ca.select("g");ja.append("rect").attr("class","nvd3 nv-background").style("pointer-events","none");ja.append("g").attr("class","nv-x nv-axis");ja.append("g").attr("class","nv-y nv-axis");ja.append("g").attr("class","nv-scatterWrap");
ja.append("g").attr("class","nv-regressionLinesWrap");ja.append("g").attr("class","nv-distWrap");ja.append("g").attr("class","nv-legendWrap");ja.append("g").attr("class","nv-controlsWrap");ca.attr("transform","translate("+r.left+","+r.top+")");G&&aa.select(".nv-y.nv-axis").attr("transform","translate("+Y+",0)");C&&(p.width(Y/2),ca.select(".nv-legendWrap").datum(m).call(p),r.top!=p.height()&&(r.top=p.height(),fa=(B||parseInt(qa.style("height"))||400)-r.top-r.bottom),ca.select(".nv-legendWrap").attr("transform",
"translate("+Y/2+","+-r.top+")"));T&&(f.width(180).color(["#444"]),aa.select(".nv-controlsWrap").datum(W).attr("transform","translate(0,"+-r.top+")").call(f));b.width(Y).height(fa).color(m.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!m[b].disabled}));ca.select(".nv-scatterWrap").datum(m.filter(function(a){return!a.disabled})).call(b);ca.select(".nv-regressionLinesWrap").attr("clip-path","url(#nv-edge-clip-"+b.id()+")");ca=ca.select(".nv-regressionLinesWrap").selectAll(".nv-regLines").data(function(a){return a});
...
typeof a.slope||"undefined"===typeof a.intercept?0:1});P&&(k.scale(E).ticks(k.ticks()?k.ticks():Y/100).tickSize(-fa,0),aa.select(".nv-x.nv-axis").attr("transform","translate(0,"+D.range()[0]+")").call(k));N&&(q.scale(D).ticks(q.ticks()?q.ticks():fa/36).tickSize(-Y,0),aa.select(".nv-y.nv-axis").call(q));L&&(g.getData(b.x()).scale(E).width(Y).color(m.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!m[b].disabled})),ja.select(".nv-distWrap").append("g").attr("class","nv-distributionX"),
aa.select(".nv-distributionX").attr("transform","translate(0,"+D.range()[0]+")").datum(m.filter(function(a){return!a.disabled})).call(g));S&&(t.getData(b.y()).scale(D).width(fa).color(m.map(function(a,b){return a.color||A(a,b)}).filter(function(a,b){return!m[b].disabled})),ja.select(".nv-distWrap").append("g").attr("class","nv-distributionY"),aa.select(".nv-distributionY").attr("transform","translate("+(G?Y:-t.size())+",0)").datum(m.filter(function(a){return!a.disabled})).call(t));d3.fisheye&&(aa.select(".nv-background").attr("width",
...
aa.select(".nv-x.nv-axis").call(k),aa.select(".nv-y.nv-axis").call(q)):J=!1;a.update()});p.dispatch.on("stateChange",function(b){V=b;U.stateChange(V);a.update()});b.dispatch.on("elementMouseover.tooltip",function(a){d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-distx-"+a.pointIndex).attr("y1",a.pos[1]-fa);d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-disty-"+a.pointIndex).attr("x2",a.pos[0]+g.size());a.pos=[a.pos[0]+r.left,a.pos[1]+r.top];U.tooltipShow(a)});U.on("tooltipShow",
function(f){if(y){var g=ia.parentNode,m=f.pos[0]+(g.offsetLeft||0),p=f.pos[1]+(g.offsetTop||0),t=f.pos[0]+(g.offsetLeft||0),B=D.range()[0]+r.top+(g.offsetTop||0),C=E.range()[0]+r.left+(g.offsetLeft||0),A=f.pos[1]+(g.offsetTop||0),O=k.tickFormat()(b.x()(f.point,f.pointIndex)),H=q.tickFormat()(b.y()(f.point,f.pointIndex));null!=F&&v.tooltip.show([t,B],F(f.series.key,O,H,f,a),"n",1,g,"x-nvtooltip");null!=K&&v.tooltip.show([C,A],K(f.series.key,O,H,f,a),"e",1,g,"y-nvtooltip");null!=z&&v.tooltip.show([m,
p],z(f.series.key,O,H,f.point.tooltip,f,a),0>f.value?"n":"s",null,g)}});U.on("changeState",function(b){"undefined"!==typeof b.disabled&&(m.forEach(function(a,f){a.disabled=b.disabled[f]}),V.disabled=b.disabled);a.update()});E.copy();D.copy()});return a}var b=v.models.scatter(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f=v.models.legend(),g=v.models.distribution(),t=v.models.distribution(),r={top:30,right:20,bottom:50,left:75},I=null,B=null,A=v.utils.defaultColor(),E=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):
b.xScale(),D=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):b.yScale(),L=!1,S=!1,C=!0,P=!0,N=!0,G=!1,T=!!d3.fisheye,M=0,J=!1,y=!0,F=function(a,b,f){return"<strong>"+b+"</strong>"},K=function(a,b,f){return"<strong>"+f+"</strong>"},z=function(a,b,f,g){return"<h3>"+a+"</h3><p>"+g+"</p>"},V={},O=null,U=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),H="No Data Available.",ba=250;b.xScale(E).yScale(D);k.orient("bottom").tickPadding(10);q.orient(G?"right":"left").tickPadding(10);
g.axis("x");t.axis("y");f.updateState(!1);var W=[{key:"Magnify",disabled:!0}];b.dispatch.on("elementMouseout.tooltip",function(a){U.tooltipHide(a);d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-distx-"+a.pointIndex).attr("y1",0);d3.select(".nv-chart-"+b.id()+" .nv-series-"+a.seriesIndex+" .nv-disty-"+a.pointIndex).attr("x2",t.size())});U.on("tooltipHide",function(){y&&v.tooltip.cleanup()});a.dispatch=U;a.scatter=b;a.legend=p;a.controls=f;a.xAxis=k;a.yAxis=q;a.distX=g;a.distY=t;d3.rebind(a,
b,"id","interactive","pointActive","x","y","shape","size","xScale","yScale","zScale","xDomain","yDomain","xRange","yRange","sizeDomain","sizeRange","forceX","forceY","forceSize","clipVoronoi","clipRadius","useVoronoi");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return r;r.top="undefined"!=typeof b.top?b.top:r.top;r.right="undefined"!=typeof b.right?b.right:r.right;r.bottom="undefined"!=typeof b.bottom?b.bottom:r.bottom;r.left="undefined"!=typeof b.left?b.left:
r.left;return a};a.width=function(b){if(!arguments.length)return I;I=b;return a};a.height=function(b){if(!arguments.length)return B;B=b;return a};a.color=function(b){if(!arguments.length)return A;A=v.utils.getColor(b);p.color(A);g.color(A);t.color(A);return a};a.showDistX=function(b){if(!arguments.length)return L;L=b;return a};a.showDistY=function(b){if(!arguments.length)return S;S=b;return a};a.showControls=function(b){if(!arguments.length)return T;T=b;return a};a.showLegend=function(b){if(!arguments.length)return C;
C=b;return a};a.showXAxis=function(b){if(!arguments.length)return P;P=b;return a};a.showYAxis=function(b){if(!arguments.length)return N;N=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return G;G=b;q.orient(b?"right":"left");return a};a.fisheye=function(b){if(!arguments.length)return M;M=b;return a};a.tooltips=function(b){if(!arguments.length)return y;y=b;return a};a.tooltipContent=function(b){if(!arguments.length)return z;z=b;return a};a.tooltipXContent=function(b){if(!arguments.length)return F;
F=b;return a};a.tooltipYContent=function(b){if(!arguments.length)return K;K=b;return a};a.state=function(b){if(!arguments.length)return V;V=b;return a};a.defaultState=function(b){if(!arguments.length)return O;O=b;return a};a.noData=function(b){if(!arguments.length)return H;H=b;return a};a.transitionDuration=function(b){if(!arguments.length)return ba;ba=b;return a};return a};v.models.sparkline=function(){function a(p){p.each(function(a){var p=k-b.left-b.right,v=q-b.top-b.bottom,L=d3.select(this);f.domain(B||
d3.extent(a,t)).range(E||[0,p]);g.domain(A||d3.extent(a,r)).range(D||[v,0]);a=L.selectAll("g.nv-wrap.nv-sparkline").data([a]);a.enter().append("g").attr("class","nvd3 nv-wrap nv-sparkline").append("g");a.select("g");a.attr("transform","translate("+b.left+","+b.top+")");p=a.selectAll("path").data(function(a){return[a]});p.enter().append("path");p.exit().remove();p.style("stroke",function(a,b){return a.color||I(a,b)}).attr("d",d3.svg.line().x(function(a,b){return f(t(a,b))}).y(function(a,b){return g(r(a,
b))}));a=a.selectAll("circle.nv-point").data(function(a){function b(f){if(-1!=f){var g=a[f];g.pointIndex=f;return g}return null}var f=a.map(function(a,b){return r(a,b)}),k=b(f.lastIndexOf(g.domain()[1])),p=b(f.indexOf(g.domain()[0])),f=b(f.length-1);return[p,k,f].filter(function(a){return null!=a})});a.enter().append("circle");a.exit().remove();a.attr("cx",function(a,b){return f(t(a,a.pointIndex))}).attr("cy",function(a,b){return g(r(a,a.pointIndex))}).attr("r",2).attr("class",function(a,b){return t(a,
a.pointIndex)==f.domain()[1]?"nv-point nv-currentValue":r(a,a.pointIndex)==g.domain()[0]?"nv-point nv-minValue":"nv-point nv-maxValue"})});return a}var b={top:2,right:0,bottom:2,left:0},k=400,q=32,p=!0,f=d3.scale.linear(),g=d3.scale.linear(),t=function(a){return a.x},r=function(a){return a.y},I=v.utils.getColor(["#000"]),B,A,E,D;a.options=v.utils.optionsFunc.bind(a);a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?f.top:b.top;b.right="undefined"!=typeof f.right?f.right:
b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.x=function(b){if(!arguments.length)return t;t=d3.functor(b);return a};a.y=function(b){if(!arguments.length)return r;r=d3.functor(b);return a};a.xScale=function(b){if(!arguments.length)return f;f=b;return a};a.yScale=function(b){if(!arguments.length)return g;
g=b;return a};a.xDomain=function(b){if(!arguments.length)return B;B=b;return a};a.yDomain=function(b){if(!arguments.length)return A;A=b;return a};a.xRange=function(b){if(!arguments.length)return E;E=b;return a};a.yRange=function(b){if(!arguments.length)return D;D=b;return a};a.animate=function(b){if(!arguments.length)return p;p=b;return a};a.color=function(b){if(!arguments.length)return I;I=v.utils.getColor(b);return a};return a};v.models.sparklinePlus=function(){function a(v){v.each(function(A){function P(){if(!r){var a=
y.selectAll(".nv-hoverValue").data(t),g=a.enter().append("g").attr("class","nv-hoverValue").style("stroke-opacity",0).style("fill-opacity",0);a.exit().transition().duration(250).style("stroke-opacity",0).style("fill-opacity",0).remove();a.attr("transform",function(a){return"translate("+f(b.x()(A[a],a))+",0)"}).transition().duration(250).style("stroke-opacity",1).style("fill-opacity",1);t.length&&(g.append("line").attr("x1",0).attr("y1",-k.top).attr("x2",0).attr("y2",J),g.append("text").attr("class",
"nv-xValue").attr("x",-6).attr("y",-k.top).attr("text-anchor","end").attr("dy",".9em"),y.select(".nv-hoverValue .nv-xValue").text(I(b.x()(A[t[0]],t[0]))),g.append("text").attr("class","nv-yValue").attr("x",6).attr("y",-k.top).attr("text-anchor","start").attr("dy",".9em"),y.select(".nv-hoverValue .nv-yValue").text(B(b.y()(A[t[0]],t[0]))))}}var N=d3.select(this),G=(q||parseInt(N.style("width"))||960)-k.left-k.right,J=(p||parseInt(N.style("height"))||400)-k.top-k.bottom;a.update=function(){a(v)};a.container=
...
0).style("fill",b.color()(A[A.length-1],A.length-1)).text(B(M));N.select(".nv-hoverArea").append("rect").on("mousemove",function(){if(!r){for(var a=d3.mouse(this)[0]-k.left,a=Math.round(f.invert(a)),g=Math.abs(b.x()(A[0],0)-a),p=0,q=0;q<A.length;q++)Math.abs(b.x()(A[q],q)-a)<g&&(g=Math.abs(b.x()(A[q],q)-a),p=q);t=[p];P()}}).on("click",function(){r=!r}).on("mouseout",function(){t=[];P()});y.select(".nv-hoverArea rect").attr("transform",function(a){return"translate("+-k.left+","+-k.top+")"}).attr("width",
G+k.left+k.right).attr("height",J+k.top)});return a}var b=v.models.sparkline(),k={top:15,right:100,bottom:10,left:50},q=null,p=null,f,g,t=[],r=!1,I=d3.format(",r"),B=d3.format(",.2f"),A=!0,E=!0,D=!1,L="No Data Available.";a.sparkline=b;d3.rebind(a,b,"x","y","xScale","yScale","color");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return k;k.top="undefined"!=typeof b.top?b.top:k.top;k.right="undefined"!=typeof b.right?b.right:k.right;k.bottom="undefined"!=typeof b.bottom?
b.bottom:k.bottom;k.left="undefined"!=typeof b.left?b.left:k.left;return a};a.width=function(b){if(!arguments.length)return q;q=b;return a};a.height=function(b){if(!arguments.length)return p;p=b;return a};a.xTickFormat=function(b){if(!arguments.length)return I;I=b;return a};a.yTickFormat=function(b){if(!arguments.length)return B;B=b;return a};a.showValue=function(b){if(!arguments.length)return A;A=b;return a};a.alignValue=function(b){if(!arguments.length)return E;E=b;return a};a.rightAlignValue=function(b){if(!arguments.length)return D;
D=b;return a};a.noData=function(b){if(!arguments.length)return L;L=b;return a};return a};v.models.stackedArea=function(){function a(r){r.each(function(r){var v=k-b.left-b.right,P=q-b.top-b.bottom,M=d3.select(this);D=J.xScale();L=J.yScale();var R=r;r.forEach(function(a,b){a.seriesIndex=b;a.values=a.values.map(function(a,f){a.index=f;a.seriesIndex=b;return a})});r=r.filter(function(a){return!a.disabled});r=d3.layout.stack().order(B).offset(I).values(function(a){return a.values}).x(g).y(t).out(function(a,
b,f){f=0===t(a)?0:f;a.display={y:f,y0:b}})(r);var M=M.selectAll("g.nv-wrap.nv-stackedarea").data([r]),y=M.enter().append("g").attr("class","nvd3 nv-wrap nv-stackedarea"),F=y.append("defs"),y=y.append("g"),K=M.select("g");y.append("g").attr("class","nv-areaWrap");y.append("g").attr("class","nv-scatterWrap");M.attr("transform","translate("+b.left+","+b.top+")");J.width(v).height(P).x(g).y(function(a){return a.display.y+a.display.y0}).forceY([0]).color(r.map(function(a,b){return a.color||p(a,a.seriesIndex)}));
K.select(".nv-scatterWrap").datum(r).call(J);F.append("clipPath").attr("id","nv-edge-clip-"+f).append("rect");M.select("#nv-edge-clip-"+f+" rect").attr("width",v).attr("height",P);K.attr("clip-path",E?"url(#nv-edge-clip-"+f+")":"");var z=d3.svg.area().x(function(a,b){return D(g(a,b))}).y0(function(a){return L(a.display.y0)}).y1(function(a){return L(a.display.y+a.display.y0)}).interpolate(A),V=d3.svg.area().x(function(a,b){return D(g(a,b))}).y0(function(a){return L(a.display.y0)}).y1(function(a){return L(a.display.y0)}),
...
a.seriesIndex).classed("hover",!0)});J.dispatch.on("elementMouseout.area",function(a){K.select(".nv-chart-"+f+" .nv-area-"+a.seriesIndex).classed("hover",!1)});a.d3_stackedOffset_stackPercent=function(a){var b=a.length,f=a[0].length,g=1/b,k,m,p,q=[];for(m=0;m<f;++m){for(p=k=0;k<R.length;k++)p+=t(R[k].values[m]);if(p)for(k=0;k<b;k++)a[k][m][1]/=p;else for(k=0;k<b;k++)a[k][m][1]=g}for(m=0;m<f;++m)q[m]=0;return q}});return a}var b={top:0,right:0,bottom:0,left:0},k=960,q=500,p=v.utils.defaultColor(),
f=Math.floor(1E5*Math.random()),g=function(a){return a.x},t=function(a){return a.y},r="stack",I="zero",B="default",A="linear",E=!1,D,L,J=v.models.scatter(),C=d3.dispatch("tooltipShow","tooltipHide","areaClick","areaMouseover","areaMouseout");J.size(2.2).sizeDomain([2.2,2.2]);J.dispatch.on("elementClick.area",function(a){C.areaClick(a)});J.dispatch.on("elementMouseover.tooltip",function(a){a.pos=[a.pos[0]+b.left,a.pos[1]+b.top];C.tooltipShow(a)});J.dispatch.on("elementMouseout.tooltip",function(a){C.tooltipHide(a)});
a.dispatch=C;a.scatter=J;d3.rebind(a,J,"interactive","size","xScale","yScale","zScale","xDomain","yDomain","xRange","yRange","sizeDomain","forceX","forceY","forceSize","clipVoronoi","useVoronoi","clipRadius","highlightPoint","clearHighlights");a.options=v.utils.optionsFunc.bind(a);a.x=function(b){if(!arguments.length)return g;g=d3.functor(b);return a};a.y=function(b){if(!arguments.length)return t;t=d3.functor(b);return a};a.margin=function(f){if(!arguments.length)return b;b.top="undefined"!=typeof f.top?
f.top:b.top;b.right="undefined"!=typeof f.right?f.right:b.right;b.bottom="undefined"!=typeof f.bottom?f.bottom:b.bottom;b.left="undefined"!=typeof f.left?f.left:b.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return q;q=b;return a};a.clipEdge=function(b){if(!arguments.length)return E;E=b;return a};a.color=function(b){if(!arguments.length)return p;p=v.utils.getColor(b);return a};a.offset=function(b){if(!arguments.length)return I;
I=b;return a};a.order=function(b){if(!arguments.length)return B;B=b;return a};a.style=function(b){if(!arguments.length)return r;r=b;switch(r){case "stack":a.offset("zero");a.order("default");break;case "stream":a.offset("wiggle");a.order("inside-out");break;case "stream-center":a.offset("silhouette");a.order("inside-out");break;case "expand":a.offset("expand");a.order("default");break;case "stack_percent":a.offset(a.d3_stackedOffset_stackPercent),a.order("default")}return a};a.interpolate=function(b){if(!arguments.length)return A;
A=b;return a};return a};v.models.stackedAreaChart=function(){function a(H){H.each(function(H){var W=d3.select(this),m=this,Q=(r||parseInt(W.style("width"))||960)-t.left-t.right,da=(I||parseInt(W.style("height"))||400)-t.top-t.bottom;a.update=function(){W.transition().duration(U).call(a)};a.container=this;R.disabled=H.map(function(a){return!!a.disabled});if(!y){var qa;y={};for(qa in R)y[qa]=R[qa]instanceof Array?R[qa].slice(0):R[qa]}if(H&&H.length&&H.filter(function(a){return a.values.length}).length)W.selectAll(".nv-noData").remove();
else return qa=W.selectAll(".nv-noData").data([F]),qa.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),qa.attr("x",t.left+Q/2).attr("y",t.top+da/2).text(function(a){return a}),a;G=b.xScale();T=b.yScale();qa=W.selectAll("g.nv-wrap.nv-stackedAreaChart").data([H]);var ia=qa.enter().append("g").attr("class","nvd3 nv-wrap nv-stackedAreaChart").append("g"),Y=qa.select("g");ia.append("rect").style("opacity",0);ia.append("g").attr("class","nv-x nv-axis");
ia.append("g").attr("class","nv-y nv-axis");ia.append("g").attr("class","nv-stackedWrap");ia.append("g").attr("class","nv-legendWrap");ia.append("g").attr("class","nv-controlsWrap");ia.append("g").attr("class","nv-interactive");Y.select("rect").attr("width",Q).attr("height",da);E&&(ia=A?Q-z:Q,p.width(ia),Y.select(".nv-legendWrap").datum(H).call(p),t.top!=p.height()&&(t.top=p.height(),da=(I||parseInt(W.style("height"))||400)-t.top-t.bottom),Y.select(".nv-legendWrap").attr("transform","translate("+
(Q-ia)+","+-t.top+")"));if(A){var fa=[{key:O.stacked||"Stacked",metaKey:"Stacked",disabled:"stack"!=b.style(),style:"stack"},{key:O.stream||"Stream",metaKey:"Stream",disabled:"stream"!=b.style(),style:"stream"},{key:O.expanded||"Expanded",metaKey:"Expanded",disabled:"expand"!=b.style(),style:"expand"},{key:O.stack_percent||"Stack %",metaKey:"Stack_Percent",disabled:"stack_percent"!=b.style(),style:"stack_percent"}];z=V.length/3*260;fa=fa.filter(function(a){return-1!==V.indexOf(a.metaKey)});f.width(z).color(["#444",
"#444","#444"]);Y.select(".nv-controlsWrap").datum(fa).call(f);t.top!=Math.max(f.height(),p.height())&&(t.top=Math.max(f.height(),p.height()),da=(I||parseInt(W.style("height"))||400)-t.top-t.bottom);Y.select(".nv-controlsWrap").attr("transform","translate(0,"+-t.top+")")}qa.attr("transform","translate("+t.left+","+t.top+")");S&&Y.select(".nv-y.nv-axis").attr("transform","translate("+Q+",0)");C&&(g.width(Q).height(da).margin({left:t.left,top:t.top}).svgContainer(W).xScale(G),qa.select(".nv-interactive").call(g));
b.width(Q).height(da);Y.select(".nv-stackedWrap").datum(H).transition().call(b);D&&(k.scale(G).ticks(Q/100).tickSize(-da,0),Y.select(".nv-x.nv-axis").attr("transform","translate(0,"+da+")"),Y.select(".nv-x.nv-axis").transition().duration(0).call(k));J&&(q.scale(T).ticks("wiggle"==b.offset()?0:da/36).tickSize(-Q,0).setTickFormat("expand"==b.style()||"stack_percent"==b.style()?d3.format("%"):M),Y.select(".nv-y.nv-axis").transition().duration(0).call(q));b.dispatch.on("areaClick.toggle",function(b){1===
...
function(f){b.clearHighlights();var p,r,y,z=[];H.filter(function(a,b){a.seriesIndex=b;return!a.disabled}).forEach(function(g,k){r=v.interactiveBisect(g.values,f.pointXValue,a.x());b.highlightPoint(k,r,!0);var m=g.values[r];if("undefined"!==typeof m){"undefined"===typeof p&&(p=m);"undefined"===typeof y&&(y=a.xScale()(a.x()(m,r)));var q="expand"==b.style()?m.display.y:a.y()(m,r);z.push({key:g.key,value:q,color:B(g,g.seriesIndex),stackedValue:m.display})}});z.reverse();if(2<z.length){var A=a.yScale().invert(f.mouseY),
C=null;z.forEach(function(a,b){A=Math.abs(A);var f=Math.abs(a.stackedValue.y0),g=Math.abs(a.stackedValue.y);A>=f&&A<=g+f&&(C=b)});null!=C&&(z[C].highlight=!0)}var D=k.tickFormat()(a.x()(p,r)),I="expand"==b.style()?function(a,b){return d3.format(".1%")(a)}:function(a,b){return q.tickFormat()(a)};g.tooltip.position({left:y+t.left,top:f.mouseY+t.top}).chartContainer(m.parentNode).enabled(P).valueFormatter(I).data({value:D,series:z})();g.renderGuideLine(y)});g.dispatch.on("elementMouseout",function(a){K.tooltipHide();
b.clearHighlights()});K.on("tooltipShow",function(f){if(P){var g=m.parentNode,p=f.pos[0]+(g.offsetLeft||0),r=f.pos[1]+(g.offsetTop||0),t=k.tickFormat()(b.x()(f.point,f.pointIndex)),y=q.tickFormat()(b.y()(f.point,f.pointIndex)),t=N(f.series.key,t,y,f,a);v.tooltip.show([p,r],t,0>f.value?"n":"s",null,g)}});K.on("changeState",function(f){"undefined"!==typeof f.disabled&&H.length===f.disabled.length&&(H.forEach(function(a,b){a.disabled=f.disabled[b]}),R.disabled=f.disabled);"undefined"!==typeof f.style&&
b.style(f.style);a.update()})});return a}var b=v.models.stackedArea(),k=v.models.axis(),q=v.models.axis(),p=v.models.legend(),f=v.models.legend(),g=v.interactiveGuideline(),t={top:30,right:25,bottom:50,left:60},r=null,I=null,B=v.utils.defaultColor(),A=!0,E=!0,D=!0,J=!0,S=!1,C=!1,P=!0,N=function(a,b,f,g,k){return"<h3>"+a+"</h3><p>"+f+" on "+b+"</p>"},G,T,M=d3.format(",.2f"),R={style:b.style()},y=null,F="No Data Available.",K=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),z=250,
V=["Stacked","Stream","Expanded"],O={},U=250;k.orient("bottom").tickPadding(7);q.orient(S?"right":"left");f.updateState(!1);b.dispatch.on("tooltipShow",function(a){a.pos=[a.pos[0]+t.left,a.pos[1]+t.top];K.tooltipShow(a)});b.dispatch.on("tooltipHide",function(a){K.tooltipHide(a)});K.on("tooltipHide",function(){P&&v.tooltip.cleanup()});a.dispatch=K;a.stacked=b;a.legend=p;a.controls=f;a.xAxis=k;a.yAxis=q;a.interactiveLayer=g;d3.rebind(a,b,"x","y","size","xScale","yScale","xDomain","yDomain","xRange",
"yRange","sizeDomain","interactive","useVoronoi","offset","order","style","clipEdge","forceX","forceY","forceSize","interpolate");a.options=v.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return t;t.top="undefined"!=typeof b.top?b.top:t.top;t.right="undefined"!=typeof b.right?b.right:t.right;t.bottom="undefined"!=typeof b.bottom?b.bottom:t.bottom;t.left="undefined"!=typeof b.left?b.left:t.left;return a};a.width=function(b){if(!arguments.length)return r;r=b;return a};a.height=
function(b){if(!arguments.length)return I;I=b;return a};a.color=function(f){if(!arguments.length)return B;B=v.utils.getColor(f);p.color(B);b.color(B);return a};a.showControls=function(b){if(!arguments.length)return A;A=b;return a};a.showLegend=function(b){if(!arguments.length)return E;E=b;return a};a.showXAxis=function(b){if(!arguments.length)return D;D=b;return a};a.showYAxis=function(b){if(!arguments.length)return J;J=b;return a};a.rightAlignYAxis=function(b){if(!arguments.length)return S;S=b;q.orient(b?
...
function(b){if(!arguments.length)return F;F=b;return a};a.transitionDuration=function(b){if(!arguments.length)return U;U=b;return a};a.controlsData=function(b){if(!arguments.length)return V;V=b;return a};a.controlLabels=function(b){if(!arguments.length||"object"!==typeof b)return O;O=b;return a};q.setTickFormat=q.tickFormat;q.tickFormat=function(a){if(!arguments.length)return M;M=a;return q};return a}})();
...
J(this.element),k=this.options;this.table=this.data=null;this.chartOptions={currentChart:null,currentDataIndex:null,currentSeriesIndex:null,currentSpectrumIndex:null};this.table_options={hidden:!1};var q=a.find(".pt-chart");this.chart=q.length?q.first():null;k.renderFilter||k.renderOptions?(q="#"+a.attr("id"),k.renderOptions?(J(q+"-options").show(),k.collapseOptions&&(J(q+"-options legend").siblings().toggle(),J(q+"-options legend").children().toggle())):J(q+"-options").hide(),k.renderFilter?(J(q+
"-filters").show(),k.collapseFilter&&(J(q+"-filters legend").siblings().toggle(),J(q+"-filters legend").children().toggle())):J(q+"-options").hide()):a.find(".pt-form-container").hide();k.collapseTable&&(this.table_options.hidden=!0,a.find(".pt-table").hide(),a.find(".pt-show-table").show(),a.find(".pt-hide-table").hide());k.numberFormatter=function(a){var b=k.precision;if(null===a||"undefined"==typeof a)return"-";b=b||0==b?a.toFixed(b):a.toString();b=b.split(".");a=b[0];b=1<b.length?"."+b[1]:"";
a=a.replace(new RegExp("\\B(?=(\\d{"+k.thousandGrouping+"})+(?!\\d))","g"),k.thousandSeparator);return a+b};this.refresh()},_destroy:function(){this.table&&this.table.remove();this.chart&&this.chart.empty()},refresh:function(){var a=J(this.element),k=null;this._unbindEvents();var q=a.find('input[type="hidden"][name="pivotdata"]');q.length&&(k=JSON.parse(J(q).first().val()));k?"count"==k.method&&(this.options.precision=0,this.options.minTickSize=1):(k={empty:!0},a.find(".pt-hide-table").hide(),a.find(".pt-show-table").hide());
...
this.table=null;var q=this.data;if(!q.empty)if(this.options.renderTable){var p=q.cells,f=q.cols,g=q.rows,t=q.total,r=q.labels,v=this.options,B=v.showTotals,A=!1;1==f.length&&null===f[0][4]&&(A=!0);p=q.cells.slice(0);if(A&&B)for(f=[],q=0;q<g.length;q++)p[q]=[];else{for(q=0;q<g.length;q++)p[q]=p[q].filter(function(a,b){return"__other__"!=f[b][0]});f=f.filter(function(a){return"__other__"!=a[0]})}q=!1;1==f.length&&null===f[0][4]&&(q=!0);q&&B?(g=[],p=[]):(p=p.filter(function(a,b){return"__other__"!=g[b][0]}),
g=g.filter(function(a){return"__other__"!=a[0]}));k=d3.select(k.get(0)).append("table").attr("class","dataTable display report");k.append("thead").call(this._renderHeader,f,r,v).call(this._renderColumns,f,r,v);k.append("tbody").call(this._renderRows,this,g,f,r,p,v);v.showTotals&&k.append("tfoot").call(this._renderFooter,g,f,r,t);this.table=J(k.node());this.table_options.hidden?(a.find(".pt-show-table").show(),a.find(".pt-hide-table").hide()):(a.find(".pt-show-table").hide(),a.find(".pt-hide-table").show())}else a.find(".pt-show-table").hide(),
a.find(".pt-hide-table").hide()},_renderHeader:function(a,k,q,p){a=a.append("tr");a.append("th").attr("scope","col").text(q.layer);k.length&&a.append("th").attr({scope:"col",colspan:k.length}).text(q.cols);p.showTotals&&a.append("th").attr({scope:"col","class":"pt-totals-header pt-row-total",rowspan:2}).text(q.total);return a},_renderColumns:function(a,k,q,p){a=a.append("tr");a.append("th").attr({scope:"col","class":"pt-rows-header"}).text(q.rows);var f=!1;1==k.length&&null===k[0][4]&&(f=!0);a.selectAll("th.pt-data").data(k).enter().append("th").attr({scope:"col",
"class":"pt-col-label"}).text(function(a){return f?"":a[4]});return a},_renderRows:function(a,k,q,p,f,g,t){q=a.selectAll("tr.pt-row").data(q).enter().append("tr").attr("class",function(a,b){return b%2?"odd":"even"});var r=!1;1==q.length&&null===q[0][4]&&(r=!0);q.append("td").text(function(a){return r?"":a[4]});q.selectAll("td.pt-cell").data(function(a,b){return g[b]}).enter().append("td").attr("class","pt-cell").each(k._renderCell,f);t.showTotals&&q.append("td").attr("class","pt-row-total").text(function(a){return a[2][0]});
return q},_renderCell:function(a,k,q){k=d3.select(this);for(var p=a.items,f,g=0,t=p.length;g<t;g++){f=p[g];var r=k.append("div").attr("class","pt-cell-value");null===f?r.text(q.none):J.isArray(f)?r.append("ul").selectAll("li").data(f).enter().append("li").html(function(a){return a}):r.text(f);f=a.keys[g];p&&f&&f.length&&(J(r.node()).data("keys",f).data("fact",g),r.append("div").attr("class","pt-cell-zoom"));1<t-g&&r.append("span").text(" / ")}},_renderFooter:function(a,k,q,p,f){k=k.length%2?"odd":
"even";a=a.append("tr").attr("class",k+" pt-totals-row");a.append("th").attr({"class":"pt-totals-header",scope:"row"}).text(p.total);a.selectAll("td.pt-col-total").data(q).enter().append("td").attr("class","pt-col-total").text(function(a){return a[2][0]});a.append("td").attr("class","pt-total").text(f);return a},_renderChartOptions:function(){var a=J(this.element),k=a.find(".pt-chart-controls").first().empty(),q=this.data;if(!q.empty&&this.options.renderChart){var q=q.labels,p=a.attr("id"),a=q.layer,
f=q.rows,g=q.cols,t=q.per,r=J('<div class="pt-chart-opts">'),v=p+"-pchart-rows",B=p+"-vchart-rows",A=p+"-hchart-rows",E=p+"-schart-rows",D=p+"-pchart-cols",L=p+"-vchart-cols",S=p+"-hchart-cols",p=p+"-schart-cols";a&&J(r).append(J('<span class="pt-chart-label">'+a+": </span>"));f&&J(r).append(J('<div id="'+v+'" class="pt-chart-icon pt-pchart"/><div id="'+B+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+t+" "+f+"</span>"));g&&J(r).append(J('<div id="'+D+'" class="pt-chart-icon pt-pchart"/><div id="'+
L+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+t+" "+g+"</span>"));f&&g&&J(r).append(J('<span class="pt-chart-label">| '+q.breakdown+': </span><div id="'+E+'" class="pt-chart-icon pt-schart"/><div id="'+A+'" class="pt-chart-icon pt-hchart"/><span class="pt-chart-label">'+t+" "+f+'</span><div id="'+p+'"  class="pt-chart-icon pt-schart"/><div id="'+S+'"  class="pt-chart-icon pt-hchart"/><span class="pt-chart-label">'+t+" "+g+"</span>"));J(k).append(r)}},_truncateLabel:function(a,
k){return a&&a.length>k?a.substring(0,k-3).replace(/\s+$/g,"")+"...":a},_renderChart:function(a){var k=J(this.element),q=this.data;k.find(".pt-chart-contents").hide();if(k=this.chart)if(J(k).unbind("plothover").unbind("plotclick").empty(),!q.empty&&this.options.renderChart)if(!1===a)this.options.collapseChart=!0;else{k=this.options.collapseChart;if("undefined"==typeof a||!a){if(k)return;a=this.chartOptions.currentChart}if("undefined"==typeof a||!a){if(k)return;a=this.options.defaultChart}if("undefined"!=
typeof a&&a){this.options.collapseChart=!1;this.chartOptions.currentChart=a;k=a.type;a=a.axis;var p=q.labels,f=p.per,g=p.layer+" "+f+" "+p.rows,p=p.layer+" "+f+" "+p.cols,f=q.filter,t=f[0],r=f[1];"piechart"==k?"rows"==a?this._renderPieChart(q.rows,g,t):this._renderPieChart(q.cols,p,r):"barchart"==k?"rows"==a?this._renderBarChart(q.rows,q.facts,g,t):this._renderBarChart(q.cols,q.facts,p,r):"breakdown"==k?"rows"==a?this._renderBreakDown(q,0,g,f):this._renderBreakDown(q,1,p,f):"spectrum"==k&&this._renderSpectrum(q,
a,f)}}},_renderPieChart:function(a,k,q){var p=this.chart;if(p){J(p).css({height:"360px"}).closest(".pt-chart-contents").show().css({width:"98%"});k?J(p).siblings(".pt-chart-title").html("<h4>"+k+"</h4>"):J(p).siblings(".pt-chart-title").empty();var f=[],g=0;for(k=0;k<a.length;k++){var t=a[k];!t[1]&&0<=t[2][0]&&(f.push({index:t[0],label:t[4],value:t[2][0],key:t[3]}),g+=t[2][0])}var r=this;r.chartOptions.currentDataIndex=null;var v=function(a){if(r.chartOptions.currentDataIndex!=a.pointIndex){r._removeChartTooltip();
r.chartOptions.currentDataIndex=a.pointIndex;var b=a.value;r._renderChartTooltip(a.pos[0],a.pos[1],'<div class="pt-tooltip-label">'+a.label+"</div>"+('<div class="pt-tooltip-text">'+b+" ("+Math.round(b/g*100)+"%)</div>"));J(".pt-tooltip-label").css({color:nv.utils.defaultColor()({},a.pointIndex)})}};nv.addGraph(function(){var a=nv.models.pieChart().x(function(a){return a.label}).y(function(a){return a.value}).pieLabelsOutside(!1).labelType("percent").labelThreshold(.03).showLegend(!0).tooltips(!1);
a.legend.align(!0).rightAlign(!1);a.pie.dispatch.on("elementMouseover",v).on("elementMouseout",function(a){J(".pt-tooltip").remove();r.chartOptions.currentDataIndex=null;r.chartOptions.currentSeriesIndex=null});if(r.options.exploreChart&&q)a.pie.dispatch.on("elementClick",function(a){a=a.point;r._chartExplore([["__other__"==a.index?q+"__belongs":q,a.key]])});d3.select(J(p).get(0)).append("svg").attr("class","nv").datum(f).transition().duration(1200).call(a);nv.utils.windowResize(a.update);return a})}},
_renderBarChart:function(a,k,q,p){var f=this.chart;if(f){J(f).closest(".pt-chart-contents").show().css({width:"96%"});for(var g=[],t=this._truncateLabel,r,v,B,A=0;A<k.length;A++){r={key:k[A][2]};v=[];for(var E=0;E<a.length;E++)B=a[E],v.push({label:B[4],value:B[2][A],filterIndex:B[0],filterKey:B[3]});r.values=v;g.push(r)}J(f).css({height:"360px"});q?J(f).siblings(".pt-chart-title").html("<h4>"+q+"</h4>"):J(f).siblings(".pt-chart-title").empty();var D=function(a,b,f,g){a=g.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+
...
a.valueFormat(S),b=a.discretebar);a.yAxis.tickFormat(S);a.xAxis.tickFormat(function(a){return t(a,18)});d3.select(J(f).get(0)).append("svg").attr("class","nv").datum(g).transition().duration(500).call(a);if(L.options.exploreChart&&p)b.dispatch.on("elementClick",function(a){var b=a.point.filterKey;null===b&&(b="None");var f=p;"__other__"==a.point.filterIndex&&(f+="__belongs");L._chartExplore([[f,b]])});nv.utils.windowResize(a.update);return a})}},_renderBreakDown:function(a,k,q,p){var f=this.chart;
if(f){J(f).closest(".pt-chart-contents").show().css({width:"96%"});var g=a.cells,t,r,v=[],B=[],A,E;0===k?(t=a.rows,r=a.cols,a=function(a,b){return g[v[a]][B[b]].values[0]},A=p[0],E=p[1]):(t=a.cols,r=a.rows,a=function(a,b){return g[B[b]][v[a]].values[0]},A=p[1],E=p[0]);var D,L;p=[];k=[];D=0;for(L=t.length;D<L;D++)t[D][1]||(p.push(t[D]),v.push(D));D=0;for(L=r.length;D<L;D++)r[D][1]||(k.push(r[D]),B.push(D));var S=[];for(t=0;t<k.length;t++){r={key:k[t][4],filterIndex:k[t][0],filterKey:k[t][3]};D=[];
for(L=0;L<p.length;L++)D.push({label:p[L][4],filterIndex:p[L][0],filterKey:p[L][3],value:a(L,t)});r.values=D;S.push(r)}a=Math.max(p.length*Math.max(16*(k.length+1),50)+70,360);J(f).css({height:a+"px"});q?J(f).siblings(".pt-chart-title").html("<h4>"+q+"</h4>"):J(f).siblings(".pt-chart-title").empty();var C=function(a,b,f,g){b=g.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+nv.utils.defaultColor()({},g.seriesIndex)+'">'+a+'</div><div class="pt-tooltip-text">'+b.label+
...
"nv").datum(S).call(a);if(P.options.exploreChart&&A&&E)a.multibar.dispatch.on("elementClick",function(a){var b=a.series.filterKey,f;null===b&&(b="None");f="__other__"==a.series.filterIndex?E+"__belongs":E;var g=a.point.filterKey;null===g&&(g="None");P._chartExplore([["__other__"==a.point.filterIndex?A+"__belongs":A,g],[f,b]])});nv.utils.windowResize(a.update);return a})}},_renderSpectrum:function(a,k,q){var p=this.chart;if(p){var f=this,g=a.cells,t=a.labels,r,I,B,A,E,D;"rows"==k?(r=a.rows,I=a.cols,
k=t.rows,B=t.cols,A=q[0],E=q[1],D=function(a,b){return g[a][b]}):(r=a.cols,I=a.rows,k=t.cols,B=t.rows,A=q[1],E=q[0],D=function(a,b){return g[b][a]});var L=function(a,b){return null===a?I[b]:null===b?r[a]:D(a,b)},S=function(a,b){b===v&&(b="silver");for(var f=[],g,k,m=0;m<I.length;m++)g=L(null,m),k=null===a?g[2][0]:L(a,m).values[0],!g[1]&&0<=g[2][0]&&f.push({filterIndex:g[0],filterKey:g[3],label:g[4],value:k,color:b});return f},C=[],P=0;for(q=0;q<r.length;q++){var N=L(q,null);!N[1]&&0<=N[2][0]&&(C.push({position:q,
filterIndex:N[0],filterKey:N[3],label:N[4],value:N[2][0]}),P+=N[2][0])}f.chartOptions.currentDataIndex=null;J(p).removeAttr("style").closest(".pt-chart-contents").css({width:"98%",height:"auto"}).show();J(p).siblings(".pt-chart-title").empty();q=J('<div class="pt-spectrum-pie">').appendTo(p);var p=J('<div class="pt-spectrum-bar">').appendTo(p),G=this.options.numberFormatter,T=this._truncateLabel,M=nv.models.discreteBarChart().x(function(a){return a.label}).y(function(a){return a.value}).color(["silver"]).staggerLabels(!0).tooltips(!0).tooltipContent(function(a,
b,f,g){a=g.point;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+(a.color||["silver"])+'">'+a.label+'</div><div class="pt-tooltip-text">'+G(a.value)+"</div></div>"}).showValues(!0);M.valueFormat(G);M.yAxis.tickFormat(G);M.xAxis.tickFormat(function(a){return T(a,18)});var R=d3.select(J(p).get(0)).append("svg").attr("class","nv"),p=Math.floor(q.width()/2)-30,y=nv.models.pieChart().x(function(a){return a.label}).y(function(a){return a.value}).height(280).width(p).margin({top:-20,
...
function(a){var b=a.series.filterIndex,g=a.series.filterKey,k=a.point.filterIndex;a=a.point.filterKey;var p=[];null!==b&&p.push(["__other__"==b?A+"__belongs":A,g||"None"]);null!==k&&p.push(["__other__"==k?E+"__belongs":E,a||"None"]);f._chartExplore(p)});nv.utils.windowResize(M.update);return M})}},_chartExplore:function(a){var k=this.options,q=J(this.element).closest(".ui-tabs"),p=k.filterTab;if(q.length&&!1!==p)k=(k=k.filterForm)?J("#"+k):v,S3.search.setCurrentFilters(k,a),a=p?J("#"+p).index():0,
q.tabs("option","active",a);else if(q=k.filterURL)a=this._updateURL(q,a),window.open(a,"_blank")},_renderChartTooltip:function(a,k,q){J('<div class="pt-tooltip">'+q+"</div>").css({position:"absolute",display:"none",top:k-50,left:a+10,border:"1px solid #999",padding:"10px","min-height":"50px","max-width":"240px","z-index":"501","background-color":"white",color:"#000",opacity:.95}).appendTo("body").fadeIn(200)},_removeChartTooltip:function(){J(".pt-tooltip").remove();this.chartOptions.currentDataIndex=
null;this.chartOptions.currentSeriesIndex=null},_getOptions:function(){var a="#"+J(this.element).attr("id");return{rows:J(a+"-rows").val(),cols:J(a+"-cols").val(),fact:J(a+"-fact").val(),totals:J(a+"-totals").is(":checked")?1:0}},_getFilters:function(){var a="#"+J(this.element).attr("id"),k=null,a=J(a+"-filters");if(a.length)try{k=S3.search.getCurrentFilters(a.first())}catch(q){}return k},_updateURL:function(a,k){var q,p,f=[],g={},t,r,v,B;if(k)for(t=0,r=k.length;t<r;t++)q=k[t],B=q[0],g[B]=!0,f.push(B+
"="+q[1]);q=this.options.ajaxURL.split("?");if(1<q.length){p=q[1].split("&");q={};t=0;for(r=p.length;t<r;t++)v=p[t].split("="),1<v.length&&(B=decodeURIComponent(v[0]),g[B]||(f.push(B+"="+decodeURIComponent(v[1])),q[B]=!0));for(B in q)g[B]=!0}q=a.split("?");if(1<q.length)for(p=q[1].split("&"),t=0,r=p.length;t<r;t++)v=p[t].split("="),1<v.length&&(B=decodeURIComponent(v[0]),g[B]||f.push(B+"="+decodeURIComponent(v[1])));f=f.join("&");g=q[0];f&&(g=g+"?"+f);return g},_updateAjaxURL:function(a,k){var q=
this.options.ajaxURL.split("?"),p=[],f=!1,g;1<q.length?(g=q[1],g=g.split("&")):g=[];var t,r,v;if(a)for(t in a)v=a[t],r=t+"="+v,"totals"==t?this.options.showTotals=v?!0:!1:f||-1!=J.inArray(r,g)||(f=!0),p.push(r);t={};v={};var B,A,E;if(k)for(B=0,A=k.length;B<A;B++)r=k[B],E=r[0],r=r[1],null===r?t[E]||(v[E]=!0):(v[E]&&(v[E]=!1),r=E+"="+encodeURIComponent(r),t[E]?t[E].push(r):t[E]=[r]);B=0;for(A=g.length;B<A;B++)r=g[B].split("="),1<r.length&&(E=decodeURIComponent(r[0]),r=decodeURIComponent(r[1]),v[E]?
f=!0:t[E]?f||-1!=J.inArray(E+"="+r,t[E])||(f=!0):"aggregate"!=E&&(a&&a.hasOwnProperty(E)||p.push(g[B])));for(E in t)for(B=0,A=t[E].length;B<A;B++)f||-1!=J.inArray(t[E][B],g)||(f=!0),p.push(t[E][B]);p=p.join("&");q=q[0];p&&(q=q+"?"+p);this.options.ajaxURL=q;return f},reload:function(a,k,q){q="undefined"!=typeof q?q:!0;"undefined"==typeof k&&(k=this._getFilters());var p=this,f=this.element,g,t=f.find('input[type="hidden"][name="pivotdata"]');if(t.length){f.find(".pt-throbber").show();if(a||k)g=this._updateAjaxURL(a,
k);g||q?(a=this.options.ajaxURL,k=J.ajaxS3,J.searchS3!==v&&(k=J.searchS3),f.find(".pt-empty").hide(),k({url:a,dataType:"json",type:"GET",success:function(a){t.first().val(JSON.stringify(a));p.refresh()},error:function(a,b,f){console.log("UNAUTHORIZED"==f?i18n.gis_requires_login:a.responseText)}})):p.refresh()}},_bindEvents:function(){var a=this,k=J(this.element),q=this.data,p="#"+k.attr("id");J(p+"-options legend").click(function(){J(this).siblings().toggle();J(this).children().toggle()});J(p+"-filters legend").click(function(){J(this).siblings().toggle();
J(this).children().toggle()});k.find(".pt-hide-table").click(function(){a.table_options.hidden=!0;k.find(".pt-table").hide();J(this).siblings(".pt-show-table").show();J(this).hide()});k.find(".pt-show-table").click(function(){a.table_options.hidden=!1;k.find(".pt-table").show();J(this).siblings(".pt-hide-table").show();J(this).hide()});J(p+"-totals").click(function(){var f=J(this).is(":checked");a.options.showTotals!=f&&a.reload({totals:f},null,!1)});J(p+"-rows,"+p+"-cols,"+p+"-fact").on("change.autosubmit",
function(){J(p+"-pt-form").trigger("optionChanged")});if(this.options.autoSubmit){var f=this.options.autoSubmit;J(p+"-pt-form").on("optionChanged",function(){var g=J(this);if(!g.data("noAutoSubmit")){var k=g.data("autoSubmitTimeout");k&&clearTimeout(k);k=setTimeout(function(){var f=a._getOptions(),g=a._getFilters();a.reload(f,g,!1)},f);g.data("autoSubmitTimeout",k)}})}else J(p+"-pt-form input.pt-submit").click(function(){var f=a._getOptions(),k=a._getFilters();a.reload(f,k,!1)});J(p+" div.pt-table div.pt-cell-zoom").click(function(a){a=
J(a.currentTarget);var b=a.closest(".pt-cell-value"),f=b.find(".pt-cell-records");if(0<f.length)f.remove(),a.removeClass("opened");else{for(var k=b.data("keys"),f=b.data("fact"),b=q.lookups[q.facts[f][0]],f=J("<div/>").addClass("pt-cell-records"),p=J("<ul/>"),v=0;v<k.length;v++)p.append("<li>"+b[k[v]]+"</li>");f.append(p);a.addClass("opened").after(f)}});J(p+"-pchart-rows").click(function(){a._renderChart({type:"piechart",axis:"rows"})});J(p+"-vchart-rows").click(function(){a._renderChart({type:"barchart",
axis:"rows"})});J(p+"-schart-rows").click(function(){a._renderChart({type:"spectrum",axis:"rows"})});J(p+"-hchart-rows").click(function(){a._renderChart({type:"breakdown",axis:"rows"})});J(p+"-pchart-cols").click(function(){a._renderChart({type:"piechart",axis:"cols"})});J(p+"-vchart-cols").click(function(){a._renderChart({type:"barchart",axis:"cols"})});J(p+"-schart-cols").click(function(){a._renderChart({type:"spectrum",axis:"cols"})});J(p+"-hchart-cols").click(function(){a._renderChart({type:"breakdown",
