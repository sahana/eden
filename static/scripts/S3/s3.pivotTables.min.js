...
(function(J,v){var a=0;J.widget("s3.pivottable",{options:{showTotals:!0,ajaxURL:null,defaultChart:{type:"breakdown",axis:"rows"},renderFilter:!0,renderOptions:!0,renderChart:!0,renderTable:!0,collapseFilter:!1,collapseOptions:!0,collapseChart:!0,collapseTable:!1,exploreChart:!1,filterURL:null,filterForm:null,filterTab:null,autoSubmit:1E3,thousandSeparator:" ",thousandGrouping:"3",minTickSize:null,precision:null,textAll:"All"},_create:function(){this.id=a;a+=1;this.openRequest=this.chart=this.table=
null},_init:function(){var a=J(this.element),k=this.options;this.table=this.data=null;this.chartOptions={currentChart:null,currentDataIndex:null,currentSeriesIndex:null,currentSpectrumIndex:null};this.table_options={hidden:!1};var q=a.find(".pt-chart");this.chart=q.length?q.first():null;k.renderFilter||k.renderOptions?(q="#"+a.attr("id"),k.renderOptions?(J(q+"-options").show(),k.collapseOptions&&(J(q+"-options legend").siblings().toggle(),J(q+"-options legend").children().toggle())):J(q+"-options").hide(),
k.renderFilter?(J(q+"-filters").show(),k.collapseFilter&&(J(q+"-filters legend").siblings().toggle(),J(q+"-filters legend").children().toggle())):J(q+"-options").hide()):a.find(".pt-form-container").hide();k.collapseTable&&(this.table_options.hidden=!0,a.find(".pt-table").hide(),a.find(".pt-show-table").show(),a.find(".pt-hide-table").hide());k.numberFormatter=function(a){var b=k.precision;if(null===a||"undefined"==typeof a)return"-";b=b||0==b?a.toFixed(b):a.toString();b=b.split(".");a=b[0];b=1<b.length?
"."+b[1]:"";a=a.replace(new RegExp("\\B(?=(\\d{"+k.thousandGrouping+"})+(?!\\d))","g"),k.thousandSeparator);return a+b};this.refresh()},_destroy:function(){this.table&&this.table.remove();this.chart&&this.chart.empty()},refresh:function(){var a=J(this.element),k=null;this._unbindEvents();var q=a.find('input[type="hidden"][name="pivotdata"]');q.length&&(k=JSON.parse(J(q).first().val()));k?"count"==k.method&&(this.options.precision=0,this.options.minTickSize=1):(k={empty:!0},a.find(".pt-hide-table").hide(),
...
J(this.element),k=a.find(".pt-table").first().empty();this.table=null;var q=this.data;if(!q.empty)if(this.options.renderTable){var p=q.cells,f=q.cols,g=q.rows,t=q.total,r=q.labels,v=this.options,B=v.showTotals,A=!1;1==f.length&&null===f[0][4]&&(A=!0);p=q.cells.slice(0);if(A&&B)for(f=[],q=0;q<g.length;q++)p[q]=[];else{for(q=0;q<g.length;q++)p[q]=p[q].filter(function(a,b){return"__other__"!=f[b][0]});f=f.filter(function(a){return"__other__"!=a[0]})}q=!1;1==f.length&&null===f[0][4]&&(q=!0);q&&B?(g=[],
...
(a.find(".pt-show-table").hide(),a.find(".pt-hide-table").show())}else a.find(".pt-show-table").hide(),a.find(".pt-hide-table").hide()},_renderHeader:function(a,k,q,p){a=a.append("tr");a.append("th").attr("scope","col").text(q.layer);k.length&&a.append("th").attr({scope:"col",colspan:k.length}).text(q.cols);p.showTotals&&a.append("th").attr({scope:"col","class":"pt-totals-header pt-row-total",rowspan:2}).text(q.total);return a},_renderColumns:function(a,k,q,p){a=a.append("tr");a.append("th").attr({scope:"col",
"class":"pt-rows-header"}).text(q.rows);var f=!1;1==k.length&&null===k[0][4]&&(f=!0);a.selectAll("th.pt-data").data(k).enter().append("th").attr({scope:"col","class":"pt-col-label"}).text(function(a){return f?"":a[4]});return a},_renderRows:function(a,k,q,p,f,g,t){q=a.selectAll("tr.pt-row").data(q).enter().append("tr").attr("class",function(a,b){return b%2?"odd":"even"});var r=!1;1==q.length&&null===q[0][4]&&(r=!0);q.append("td").text(function(a){return r?"":a[4]});q.selectAll("td.pt-cell").data(function(a,
b){return g[b]}).enter().append("td").attr("class","pt-cell").each(k._renderCell,f);t.showTotals&&q.append("td").attr("class","pt-row-total").text(function(a){return a[2][0]});return q},_renderCell:function(a,k,q){k=d3.select(this);for(var p=a.items,f,g=0,t=p.length;g<t;g++){f=p[g];var r=k.append("div").attr("class","pt-cell-value");null===f?r.text(q.none):J.isArray(f)?r.append("ul").selectAll("li").data(f).enter().append("li").html(function(a){return a}):r.text(f);f=a.keys[g];p&&f&&f.length&&(J(r.node()).data("keys",
f).data("fact",g),r.append("div").attr("class","pt-cell-zoom"));1<t-g&&r.append("span").text(" / ")}},_renderFooter:function(a,k,q,p,f){k=k.length%2?"odd":"even";a=a.append("tr").attr("class",k+" pt-totals-row");a.append("th").attr({"class":"pt-totals-header",scope:"row"}).text(p.total);a.selectAll("td.pt-col-total").data(q).enter().append("td").attr("class","pt-col-total").text(function(a){return a[2][0]});a.append("td").attr("class","pt-total").text(f);return a},_renderChartOptions:function(){var a=
J(this.element),k=a.find(".pt-chart-controls").first().empty(),q=this.data;if(!q.empty&&this.options.renderChart){var q=q.labels,p=a.attr("id"),a=q.layer,f=q.rows,g=q.cols,t=q.per,r=J('<div class="pt-chart-opts">'),v=p+"-pchart-rows",B=p+"-vchart-rows",A=p+"-hchart-rows",E=p+"-schart-rows",D=p+"-pchart-cols",L=p+"-vchart-cols",S=p+"-hchart-cols",p=p+"-schart-cols";a&&J(r).append(J('<span class="pt-chart-label">'+a+": </span>"));f&&J(r).append(J('<div id="'+v+'" class="pt-chart-icon pt-pchart"/><div id="'+
B+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+t+" "+f+"</span>"));g&&J(r).append(J('<div id="'+D+'" class="pt-chart-icon pt-pchart"/><div id="'+L+'" class="pt-chart-icon pt-vchart"/><span class="pt-chart-label">'+t+" "+g+"</span>"));f&&g&&J(r).append(J('<span class="pt-chart-label">| '+q.breakdown+': </span><div id="'+E+'" class="pt-chart-icon pt-schart"/><div id="'+A+'" class="pt-chart-icon pt-hchart"/><span class="pt-chart-label">'+t+" "+f+'</span><div id="'+p+'"  class="pt-chart-icon pt-schart"/><div id="'+
S+'"  class="pt-chart-icon pt-hchart"/><span class="pt-chart-label">'+t+" "+g+"</span>"));J(k).append(r)}},_truncateLabel:function(a,k){return a&&a.length>k?a.substring(0,k-3).replace(/\s+$/g,"")+"...":a},_renderChart:function(a){var k=J(this.element),q=this.data;k.find(".pt-chart-contents").hide();if(k=this.chart)if(J(k).unbind("plothover").unbind("plotclick").empty(),!q.empty&&this.options.renderChart)if(!1===a)this.options.collapseChart=!0;else{k=this.options.collapseChart;if("undefined"==typeof a||
!a){if(k)return;a=this.chartOptions.currentChart}if("undefined"==typeof a||!a){if(k)return;a=this.options.defaultChart}if("undefined"!=typeof a&&a){this.options.collapseChart=!1;this.chartOptions.currentChart=a;k=a.type;a=a.axis;var p=q.labels,f=p.per,g=p.layer+" "+f+" "+p.rows,p=p.layer+" "+f+" "+p.cols,f=q.filter,t=f[0],r=f[1];"piechart"==k?"rows"==a?this._renderPieChart(q.rows,g,t):this._renderPieChart(q.cols,p,r):"barchart"==k?"rows"==a?this._renderBarChart(q.rows,q.facts,g,t):this._renderBarChart(q.cols,
q.facts,p,r):"breakdown"==k?"rows"==a?this._renderBreakDown(q,0,g,f):this._renderBreakDown(q,1,p,f):"spectrum"==k&&this._renderSpectrum(q,a,f)}}},_renderPieChart:function(a,k,q){var p=this.chart;if(p){J(p).css({height:"360px"}).closest(".pt-chart-contents").show().css({width:"98%"});k?J(p).siblings(".pt-chart-title").html("<h4>"+k+"</h4>"):J(p).siblings(".pt-chart-title").empty();var f=[],g=0;for(k=0;k<a.length;k++){var t=a[k];!t[1]&&0<=t[2][0]&&(f.push({index:t[0],label:t[4],value:t[2][0],key:t[3]}),
g+=t[2][0])}var r=this;r.chartOptions.currentDataIndex=null;var v=function(a){if(r.chartOptions.currentDataIndex!=a.pointIndex){r._removeChartTooltip();r.chartOptions.currentDataIndex=a.pointIndex;var b=a.value;r._renderChartTooltip(a.pos[0],a.pos[1],'<div class="pt-tooltip-label">'+a.label+"</div>"+('<div class="pt-tooltip-text">'+b+" ("+Math.round(b/g*100)+"%)</div>"));J(".pt-tooltip-label").css({color:nv.utils.defaultColor()({},a.pointIndex)})}};nv.addGraph(function(){var a=nv.models.pieChart().x(function(a){return a.label}).y(function(a){return a.value}).pieLabelsOutside(!1).labelType("percent").labelThreshold(.03).showLegend(!0).tooltips(!1);
...
k);g||q?(a=this.options.ajaxURL,k=J.ajaxS3,J.searchS3!==v&&(k=J.searchS3),f.find(".pt-empty").hide(),p.openRequest&&(p.openRequest.onreadystatechange=null,p.openRequest.abort()),p.openRequest=k({url:a,dataType:"json",type:"GET",success:function(a){p.openRequest=null;t.first().val(JSON.stringify(a));p.refresh()},error:function(a,b,f){console.log("UNAUTHORIZED"==f?i18n.gis_requires_login:a.responseText)}})):p.refresh()}},_bindEvents:function(){var a=this,k=J(this.element),q=this.data,p="#"+k.attr("id");
J(p+"-options legend").click(function(){J(this).siblings().toggle();J(this).children().toggle()});J(p+"-filters legend").click(function(){J(this).siblings().toggle();J(this).children().toggle()});k.find(".pt-hide-table").click(function(){a.table_options.hidden=!0;k.find(".pt-table").hide();J(this).siblings(".pt-show-table").show();J(this).hide()});k.find(".pt-show-table").click(function(){a.table_options.hidden=!1;k.find(".pt-table").show();J(this).siblings(".pt-hide-table").show();J(this).hide()});
J(p+"-totals").click(function(){var f=J(this).is(":checked");a.options.showTotals!=f&&a.reload({totals:f},null,!1)});J(p+"-rows,"+p+"-cols,"+p+"-fact").on("change.autosubmit",function(){J(p+"-pt-form").trigger("optionChanged")});if(this.options.autoSubmit){var f=this.options.autoSubmit;J(p+"-pt-form").on("optionChanged",function(){var g=J(this);if(!g.data("noAutoSubmit")){var k=g.data("autoSubmitTimeout");k&&clearTimeout(k);k=setTimeout(function(){var f=a._getOptions(),g=a._getFilters();a.reload(f,
g,!1)},f);g.data("autoSubmitTimeout",k)}})}else J(p+"-pt-form input.pt-submit").click(function(){var f=a._getOptions(),k=a._getFilters();a.reload(f,k,!1)});J(p+" div.pt-table div.pt-cell-zoom").click(function(a){a=J(a.currentTarget);var b=a.closest(".pt-cell-value"),f=b.find(".pt-cell-records");if(0<f.length)f.remove(),a.removeClass("opened");else{for(var k=b.data("keys"),f=b.data("fact"),b=q.lookups[q.facts[f][0]],f=J("<div/>").addClass("pt-cell-records"),p=J("<ul/>"),v=0;v<k.length;v++)p.append("<li>"+
