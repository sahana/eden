...
$jscomp.polyfillIsolated=function(b,l,g,n){var p=b.split(".");b=1===p.length;n=p[0];n=!b&&n in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var a=0;a<p.length-1;a++){var c=p[a];if(!(c in n))return;n=n[c]}p=p[p.length-1];g=$jscomp.IS_SYMBOL_NATIVE&&"es6"===g?n[p]:null;l=l(g);null!=l&&(b?$jscomp.defineProperty($jscomp.polyfills,p,{configurable:!0,writable:!0,value:l}):l!==g&&($jscomp.propertyToPolyfillSymbol[p]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(p):$jscomp.POLYFILL_PREFIX+p,p=
$jscomp.propertyToPolyfillSymbol[p],$jscomp.defineProperty(n,p,{configurable:!0,writable:!0,value:l})))};$jscomp.initSymbol=function(){};
$jscomp.polyfill("Symbol",function(b){if(b)return b;var l=function(p,a){this.$jscomp$symbol$id_=p;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:a})};l.prototype.toString=function(){return this.$jscomp$symbol$id_};var g=0,n=function(p){if(this instanceof n)throw new TypeError("Symbol is not a constructor");return new l("jscomp_symbol_"+(p||"")+"_"+g++,p)};return n},"es6","es3");$jscomp.initSymbolIterator=function(){};
...
"es3");$jscomp.initSymbolAsyncIterator=function(){};$jscomp.iteratorPrototype=function(b){b={next:b};b[Symbol.iterator]=function(){return this};return b};$jscomp.iteratorFromArray=function(b,l){b instanceof String&&(b+="");var g=0,n={next:function(){if(g<b.length){var p=g++;return{value:l(p,b[p]),done:!1}}n.next=function(){return{done:!0,value:void 0}};return n.next()}};n[Symbol.iterator]=function(){return n};return n};
