...
b('<tr class="rm-module-add">');var f=b("<td>").attr("colspan",this.tableWidth);b('<span class="action-lnk rm-add-rule">').text(g.rm_AddRule).appendTo(f);"t"!=a&&!this.options.fRules&&d.length&&c.hide();c.append(f).appendTo(e)}return e},_ruleTableRow:function(a){var c=b('<tr class="rm-rule">').data({rule:a}),d=this.options,e=a[3],f;e?!0!==e&&(f=e):!0!==a[2]&&(f=a[1]+"/"+(a[2]||"*"));f?b('<td class="rm-rule-target">').text(f).appendTo(c):(e=this._targetSelector(a),b('<td class="rm-rule-target">').append(e).appendTo(c));
