...
[]}},_serialize:function(){var a=this.rules.filter(function(a){return null!==a[0]&&(0!==a[0]||!a[7])});this.input.val(JSON.stringify(a))},_ruleSets:function(){var a={_other:[]},b={_other:[]},d=this.options;this.rules.forEach(function(c){var e;if(e=c[3]){var h=b;var k=d.models;e=e.split("_")[0]}else{h=a;k=d.modules;e=c[1];var g=c[2];e="default"!=e||"table"!=g&&"tables"!=g?e:"default/dt"}k.hasOwnProperty(e)?h[e]===m&&(h[e]=[]):e="_other";h[e].push(c)});return{pages:a,tables:b}},_renderExpandCollapseAll:function(){var a=
...
b("<td>").append(d.text(g.rm_DeleteRule)).appendTo(c)):(d=b('<a class="rm-submit-rule action-btn">'),a=b('<span class="rm-cancel-add action-lnk">'),b("<td>").append(d.text(g.rm_Add)).append(a.text(g.rm_Cancel)).appendTo(c)));return c},_targetSelector:function(a){var c=this.options,d=b("<div>"),e=a[1],f=function(a,c){c===m&&(c=a);return b('<option value="'+a+'">').text(c)},h=function(){return b('<option value="">').prop("selected",!0)};if(a[3]){var k=c.models[e],l=b("<optgroup>").attr("label",g.rm_RestrictedTables),
n=b("<optgroup>").attr("label",g.rm_UnrestrictedTables),q=0,p=0;Object.keys(k).sort().forEach(function(a){k[a]?(q+=1,l.append(f(a))):(p+=1,n.append(f(a)))});a=b("<select>").append(h());q&&a.append(l);p&&a.append(n)}else"_other"==e?(a=b('<input type="text" size="20">'),a.data("pattern",/^(\w+)(\/(\*|[\w]+))?$/)):"default/dt"==e?(a=b("<select>"),a.append(h()).append(f("default/table")).append(f("default/tables"))):(d.append("<span>"+e+" / </span>"),a=b('<input type="text" size="10">'),a.data("pattern",
/^(\w+|\*)$/));a.addClass("rm-target-select").appendTo(d);return d},_validateTarget:function(a){var b=a.val(),d=a.data("pattern");d.lastIndex=0;if(b&&d&&!d.exec(b))return a.addClass("rm-invalid"),!1;a.removeClass("rm-invalid");return!0},_defaultPermissions:function(a){var b=this.options,d=b.defaultPermissions[a];a={};var e=" ("+g.rm_Default+")";if(d!==m){var f=d[0];d=d[1]&~f;var h=function(a){var c=[];b.permissions.forEach(function(b){a&b.b&&c.push(b.l)});return c.join(", ")};f&&(a.uACL=h(f)+e);d&&
(a.oACL=h(d)+e)}a.uACL||(a.uACL=g.rm_NoAccess+e);return a},_defaultRule:function(a){a=a?g.rm_NoAccess:g.rm_NoRestrictions;a=b("<td>").attr("colspan",this.tableWidth).text(a);return b('<tr class="rm-default-rule">').append(a)},_permissionSelector:function(a){var c=b('<td class="rm-permission-all">'),d=b('<td class="rm-permission-own">');this.options.permissions.forEach(function(e){var f=b('<input class="rm-permission" type="checkbox">'),h=b('<input class="rm-permission" type="checkbox">');b("<label>").append(f).append(e.l).appendTo(c);
b("<label>").append(h).append(e.l).css({visibility:e.o&&"visible"||"hidden"}).appendTo(d);var g=a[5]&e.b;h.prop("checked",g);h.data({bit:e.b,selected:g,implied:!1});g=a[4]&e.b;f.prop("checked",g);f.data({bit:e.b,selected:g,implied:!1});h.data("implied",g);g&&h.prop({checked:!0,disabled:!0});f.data("imply",h)});return{uACL:c,oACL:d}},_scopeSelector:function(a){var c=b('<select class="rm-scope-select">'),d=b('<option value="">').text(g.rm_AssignedEntities),e=b('<option value="any">').text(g.rm_AllEntities);
if(a)switch(a[6]){case "any":e.prop("selected",!0);break;default:d.prop("selected",!0),a[6]=null}c.append(d).append(e);return b("<div>").append(c)},_addRule:function(a){var c=this.options,d=a.closest(".rm-module-rules"),e=d.data("module"),f=c.models[e],g=this;b("tfoot .rm-rule",b(this.element)).each(function(){g._cancelAdd(b(this))});var k=a.closest(".rm-rule");if(k.length){var l=k.data("rule");if(a=l[3]){l=[0,null,null,a,0,0,null,!1];if(c=c.defaultPermissions[a])l[4]=c[0],l[5]=c[1];this.rules.push(l);
l=this._ruleTableRow(l);k.after(l).remove();f[a]+=1;this._serialize()}}else f=!0,a.closest(".rm-table-rules").length?l=[0,e,null,!0,0,0,null,!1]:c.fRules?l=[0,e,!0,null,0,0,null,!1]:b("tbody .rm-rule",d).length||(l=[0,e,null,null,0,0,null,!1],f=!1),l&&(l=this._ruleTableRow(l),f?a.closest(".rm-module-add").hide().after(l):(b("tbody",d).append(l),a.closest(".rm-module-add").hide())),b(".rm-default-rule",d).hide(),b(".rm-rule-labels",d).show()},_submitAdd:function(a){var c=a.closest(".rm-module-rules"),
d=a.data("rule"),e=null,f=null,g=null,k=b(".rm-target-select",a).val().replace(/\s/,"");if(d[3]){if(g=k,!g)return}else{e=d[1];f=k;var l="_other"==e;if("default/dt"==e||l){if(k=/^(\w+)(\/(\*|[\w]+))?$/.exec(k))e=k[1],f=k[3];else return;if(l)for(l=b(".rm-module-rules",a.closest(".rm-page-rules")),k=l.length;k--;){var n=b(l[k]);if(n.data("module")==e){c=n;break}}}if(!f||"*"==f)f=null;else if(!/^\w+$/.exec(f))return}d[1]=e&&e.toLowerCase();d[2]=f&&f.toLowerCase();d[3]=g&&g.toLowerCase();var q,p,r;b("tbody .rm-rule",
c).each(function(){var a=b(this),c=a.data("rule");if(!q){a:{var e=null===d[0]||null===c[0]?[1,2,3]:[1,2,3,6];for(var h=e.length,k;h--;)if(k=e[h],d[k]!==c[k]){e=!1;break a}e=!0}e?(p=c,r=q=a):r||(g?c[3]>g&&(r=a):c[2]&&(f&&c[2]>f||!f)&&(r=a))}});if(p&&null!==p[0])p.splice(1,d.length-1),p.push.apply(p,d.slice(1)),d=p;else if(this.rules.push(d),e=d[3])l=this.options.models[c.data("module")],l[e]=l[e]!==m?l[e]+1:1;this._serialize();e=this._ruleTableRow(d);r?e.insertBefore(r):e.appendTo(b("tbody",c));q&&
q.remove();this._indicateNumRules(c,b("tbody .rm-rule",c).length);a.siblings(".rm-module-add").show();a.remove()},_cancelAdd:function(a){var c=a.closest(".rm-module-rules");0===b("tbody .rm-rule",c).length&&(b(".rm-rule-labels",c).hide(),b(".rm-default-rule",c).show());a.siblings(".rm-module-add").show();a.remove()},_updateRule:function(a,b){if(a=a.data("rule")){for(var c in b){var e=b[c];if(e!==m)switch(c){case "c":a[1]=e;break;case "f":a[2]=e;break;case "t":a[3]=e;break;case "uACL":a[4]=e;break;
case "oACL":a[5]=e;break;case "scope":a[6]=e;break;case "deleted":a[7]=!!e}}this._serialize()}},_deleteRule:function(a){if(confirm(g.rm_ConfirmDeleteRule)){var c=this.options,d=a.closest(".rm-module-rules"),e=!1,f=a.data("rule");f[7]=!0;this._serialize();var h=f[3];h?this.rules.filter(function(a){return a[3]==h&&!a[7]}).length||(f=d.data("module"),c=c.models[f],--c[h],0<c[h]&&this._ruleTableRow([null,null,null,h,null,null,null,!1]).insertBefore(a)):e=!0;c=b(".rm-rule",d).length-1;c||(this._defaultRule(e).insertBefore(a),
b(".rm-rule-labels",d).hide(),b(".rm-module-add",d).show());this._indicateNumRules(d,c);a.remove()}},_updatePermissions:function(a){this._updateRule(a,{uACL:this._getPermissions(b(".rm-permission-all",a)),oACL:this._getPermissions(b(".rm-permission-own",a))})},_getPermissions:function(a){var c=0;b(".rm-permission",a).each(function(){var a=b(this);!a.data("implied")&&a.data("selected")&&(a=a.data("bit"))&&(c|=a)});return c},_indicateNumRules:function(a,c){var d=b(".rm-module-numrules",a);c?(d.text("["+
c+"]"),a.addClass("hasrules")):(d.empty(),a.removeClass("hasrules"))},_toggleRuleTable:function(a){a.hasClass("rm-expanded")?(b("tbody, tfoot",a).hide(),a.removeClass("rm-expanded")):(b("tbody, tfoot",a).show(),a.addClass("rm-expanded"));b(".rm-module-toggle i",a).toggle()},_toggleAll:function(a,c){var d=this;c?b(".rm-module-rules:not(.rm-expanded)",a).each(function(a,c){d._toggleRuleTable(b(c))}):b(".rm-module-rules.rm-expanded",a).each(function(a,c){d._toggleRuleTable(b(c))})},_permissionChanged:function(a){if(a.data("implied"))a.prop({checked:!0,
disabled:!0});else if(a.prop("disabled"))a.prop({disabled:!1,checked:a.data("selected")});else{var b=a.prop("checked"),d=a.data("imply");a.data({selected:b});d&&d.length&&d.data("implied",b).change()}this._updatePermissions(a.closest(".rm-rule"))},_scopeChanged:function(a){var b=a.closest(".rm-rule").data("rule");switch(a.val()){case "any":b[6]="any";break;default:b[6]=null}this._serialize()},_bindEvents:function(){var a=b(this.element),c=this.eventNamespace,d=this;b(".rm-table-rules, .rm-page-rules",
a).on("click"+c,".rm-expand-all",function(){d._toggleAll(b(this).closest(".rm-table-rules, .rm-page-rules"),!0);return!1}).on("click"+c,".rm-collapse-all",function(){d._toggleAll(b(this).closest(".rm-table-rules, .rm-page-rules"),!1);return!1});b(".rm-module-rules",a).on("click"+c,".rm-module-header",function(){d._toggleRuleTable(b(this).closest(".rm-module-rules"));return!1}).on("change"+c,".rm-permission",function(){d._permissionChanged(b(this));return!1}).on("change"+c,".rm-scope-select",function(){d._scopeChanged(b(this));
return!1}).on("click"+c,".rm-delete-rule",function(){d._deleteRule(b(this).closest(".rm-rule"));return!1}).on("click"+c,".rm-add-rule",function(){d._addRule(b(this))}).on("click"+c,".rm-cancel-add",function(){d._cancelAdd(b(this).closest(".rm-rule"))}).on("click"+c,".rm-submit-rule",function(){d._submitAdd(b(this).closest(".rm-rule"))}).on("input"+c,"input.rm-target-select",function(){d._validateTarget(b(this))});return!0},_unbindEvents:function(){var a=b(this.element),c=this.eventNamespace;b(".rm-module-rules, .rm-table-rules, .rm-page-rules",
