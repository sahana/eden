...
$jscomp.SymbolClass=function(b,l){this.$jscomp$symbol$id_=b;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:l})};$jscomp.SymbolClass.prototype.toString=function(){return this.$jscomp$symbol$id_};$jscomp.Symbol=function(){function b(g){if(this instanceof b)throw new TypeError("Symbol is not a constructor");return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX+(g||"")+"_"+l++,g)}var l=0;return b}();
...
Object.keys(c.modules).sort().forEach(function(a){c.modules[a][1]&&f._ruleTable("p",a,n[a]).appendTo(h)});n._other.length&&this._ruleTable("p","_other",n._other).appendTo(h);c.tRules&&(n=d.tables,h=b(".rm-table-rules",a),this._renderExpandCollapseAll().appendTo(h),Object.keys(c.models).sort().forEach(function(a){"_system"!=a&&f._ruleTable("t",a,n[a]).appendTo(h)}),this._ruleTable("t","_system",n._system).appendTo(h),n._other.length&&this._ruleTable("t","_other",n._other).appendTo(h));e.tabs().removeClass("hide").show();
