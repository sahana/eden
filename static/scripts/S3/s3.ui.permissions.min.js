...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(b){var l=0;return function(){return l<b.length?{done:!1,value:b[l++]}:{done:!0}}};$jscomp.arrayIterator=function(b){return{next:$jscomp.arrayIteratorImpl(b)}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,l,g){b!=Array.prototype&&b!=Object.prototype&&(b[l]=g.value)};
$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var b=0;return function(l){return $jscomp.SYMBOL_PREFIX+(l||"")+b++}}();
...
$jscomp.iteratorFromArray=function(b,l){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var g=0,m={next:function(){if(g<b.length){var p=g++;return{value:l(p,b[p]),done:!1}}m.next=function(){return{done:!0,value:void 0}};return m.next()}};m[Symbol.iterator]=function(){return m};return m};
$jscomp.polyfill=function(b,l,g,m){if(l){g=$jscomp.global;b=b.split(".");for(m=0;m<b.length-1;m++){var p=b[m];p in g||(g[p]={});g=g[p]}b=b[b.length-1];m=g[b];l=l(m);l!=m&&null!=l&&$jscomp.defineProperty(g,b,{configurable:!0,writable:!0,value:l})}};$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");
...
a=g.rm_DynamicTables;break;default:f="default/dt"==a?"DEFAULT":a.toLocaleUpperCase(),a=this.options.modules.hasOwnProperty(a)?this.options.modules[a][0]:""}b('<div class="rm-module-prefix">').text(f).appendTo(d);b('<div class="rm-module-title">').text(a).appendTo(d);b('<div class="rm-module-numrules">').appendTo(d);b("<tr>").append(d).appendTo(c);return c},_ruleTableBody:function(a,c,d){var e=this.options,f=b("<tbody>").hide(),n=!0,h=d.map(m);if("t"==a){if(c=e.models[c])for(var k in c)c[k]&&-1==h.indexOf(k)&&
d.push([null,null,null,k,null,null,null,!1]);h=g.rm_Table;0===d.length&&(n=!1,f.append(this._defaultRule(!1)))}else{k="default/dt"==c;var l;for(l in e.defaultPermissions)if((a=k?"default/tables"==l||"default/table"==l:l.slice(0,c.length+1)==c+"/")&&-1==h.indexOf(l)){a=l.split("/");var r=a[1];if("*"==r)r=null;else if(!e.fRules)continue;d.push([null,a[0],r,null,null,null,null,!1])}h=g.rm_Page;0===d.length&&(n=!1,f.append(this._defaultRule(!0)))}c=b('<tr class="rm-rule-labels">').hide().appendTo(f);
c.append("<th>"+h+"</th>").append("<th>"+g.rm_AllRecords+"</th>").append("<th>"+g.rm_OwnedRecords+"</th>");e.useRealms&&b("<th>").text(g.rm_Scope).appendTo(c);c.append("<th></th>");if(n){c.show();d=d.sort(function(a,b){a=a.slice(1,4).join(" ");b=b.slice(1,4).join(" ");return a===b?0:a>b&&1||-1});var q=this;d.forEach(function(a){q._ruleTableRow(a).appendTo(f)})}return f},_ruleTableFooter:function(a,c,d){var e=b("<tfoot>").hide();if("_other"!=c){c=b('<tr class="rm-module-add">');var f=b("<td>").attr("colspan",
...
a=b('<span class="rm-cancel-add action-lnk">'),b("<td>").append(d.text(g.rm_Add)).append(a.text(g.rm_Cancel)).appendTo(c)));return c},_targetSelector:function(a){var c=this.options,d=b("<div>"),e=a[1],f=function(a,c){c===l&&(c=a);return b('<option value="'+a+'">').text(c)},n=function(){return b('<option value="">').prop("selected",!0).prop("disabled",!0).hide()};if(a[3]){var h=c.models[e],k=b("<optgroup>").attr("label",g.rm_RestrictedTables),m=b("<optgroup>").attr("label",g.rm_UnrestrictedTables),
r=0,q=0;Object.keys(h).sort().forEach(function(a){h[a]?(r+=1,k.append(f(a))):(q+=1,m.append(f(a)))});a=b("<select>").append(n());r&&a.append(k);q&&a.append(m)}else"_other"==e?(a=b('<input type="text" size="20">'),a.data("pattern",/^(\w+)(\/(\*|[\w]+))?$/)):"default/dt"==e?(a=b("<select>"),a.append(n()).append(f("default/table")).append(f("default/tables"))):(d.append("<span>"+e+" / </span>"),a=b('<input type="text" size="10">'),a.data("pattern",/^(\w+|\*)$/));a.addClass("rm-target-select").appendTo(d);
return d},_validateTarget:function(a){var b=a.val(),d=a.data("pattern");d.lastIndex=0;if(b&&d&&!d.exec(b))return a.addClass("rm-invalid"),!1;a.removeClass("rm-invalid");return!0},_defaultPermissions:function(a){var b=this.options,d=b.defaultPermissions[a];a={};var e=" ("+g.rm_Default+")";if(d!==l){var f=d[0];d=d[1]&~f;var n=function(a){var c=[];b.permissions.forEach(function(b){a&b.b&&c.push(b.l)});return c.join(", ")};f&&(a.uACL=n(f)+e);d&&(a.oACL=n(d)+e)}a.uACL||(a.uACL=g.rm_NoAccess+e);return a},
...
e=null,f=null,g=null,h=b(".rm-target-select",a).val().replace(/\s/,"");if(d[3]){if(g=h,!g)return}else{e=d[1];f=h;var k="_other"==e;if("default/dt"==e||k){if(h=/^(\w+)(\/(\*|[\w]+))?$/.exec(h))e=h[1],f=h[3];else return;if(k)for(k=b(".rm-module-rules",a.closest(".rm-page-rules")),h=k.length;h--;){var m=b(k[h]);if(m.data("module")==e){c=m;break}}}if(!f||"*"==f)f=null;else if(!/^\w+$/.exec(f))return}d[1]=e&&e.toLowerCase();d[2]=f&&f.toLowerCase();d[3]=g&&g.toLowerCase();var r,q,p;b("tbody .rm-rule",c).each(function(){var a=
b(this),c=a.data("rule");if(!r){a:{var e=null===d[0]||null===c[0]?[1,2,3]:[1,2,3,6];for(var h=e.length,k;h--;)if(k=e[h],d[k]!==c[k]){e=!1;break a}e=!0}e?(q=c,p=r=a):p||(g?c[3]>g&&(p=a):c[2]&&(f&&c[2]>f||!f)&&(p=a))}});if(q&&null!==q[0])q.splice(1,d.length-1),q.push.apply(q,d.slice(1)),d=q;else if(this.rules.push(d),e=d[3])k=this.options.models[c.data("module")],k[e]=k[e]!==l?k[e]+1:1;this._serialize();e=this._ruleTableRow(d);p?e.insertBefore(p):e.appendTo(b("tbody",c));r&&r.remove();this._indicateNumRules(c,
