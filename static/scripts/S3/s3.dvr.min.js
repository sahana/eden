...
f.bind("click"+d,function(){e._clearAlert();g.hasClass("hide")?g.hide().removeClass("hide").slideDown():g.slideToggle()});g.find("a.event-type-selector").bind("click"+d,function(){var b=a(this),d=b.data("code"),b=b.data("name");a('input[type="hidden"][name="event"]').val(d);a(".event-type-name").text(b);a(c+"_person__row .controls").text()&&e._toggleSubmit(!0);h.each(function(){var b=a(this),c=b.data("tmp");c&&b.attr("href",c.replace("%7BEVENT%7D",d))});g.slideUp()});b.delegate(".toggle-picture",
