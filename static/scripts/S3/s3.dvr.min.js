...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,k,g){a instanceof String&&(a=String(a));for(var b=a.length,c=0;c<b;c++){var d=a[c];if(k.call(g,d,c,a))return{i:c,v:d}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
if(d){c={l:d,c:!0};d=this.options.ajaxURL;var e=a(b+"_person__row .controls").empty(),h=a('<div class="inline-throbber">').insertAfter(e),f=this;this._removeProfilePicture();this._clearDetails();a.ajaxS3({url:d,type:"POST",dataType:"json",contentType:"application/json; charset=utf-8",data:JSON.stringify(c),success:function(c){h.remove();if(c.e)a('<div class="error_wrapper"><div id="label__error" class="error" style="display: block;">'+c.e+"</div></div>").hide().insertAfter(a(b+"_label")).slideDown();
else{e.html(c.p).removeClass("hide").show();var d=f.flagInfo;c.f?d.val(JSON.stringify(c.f)):d.val("[]");d=f.permissionInfo;c.s!==k?d.val(JSON.stringify(c.s)):d.val("false");d=f.actionableInfo;var g=c.u;d.length&&(g!==k?d.val(JSON.stringify(c.u)):(g=!0,d.val("true")));c.d&&f._updateDetails(c.d,g);c.b&&(f.imageURL.val(c.b),f._showProfilePicture());f.blockedEvents=c.i||{};f.blockingInfo.val(JSON.stringify(f.blockedEvents));f.eventType.val()&&f._toggleSubmit(!0);f._showFlagInfo()}c.a?S3.showAlert(c.a,
"error"):c.m&&S3.showAlert(c.m,"success")},error:function(){h.remove();f._clearForm(!0)}})}},_registerEvent:function(){this._clearAlert();var b=this.idPrefix,c=a(b+"_label").val(),d=this.eventType.val();if(c&&d){c={l:c,t:d};d=this.options.ajaxURL;var e=a(b+"_person__row .controls"),h=a('<div class="inline-throbber">').insertAfter(e),f=this;e=this.actionDetails;e.length&&(e=e.val(),c.d=e?JSON.parse(e):[]);c.c=a(b+"comments").val();a.ajaxS3({url:d,type:"POST",dataType:"json",contentType:"application/json; charset=utf-8",
...
a("<h6>").addClass("event-registration-blocked").html(b[0]);if(new Date(b[1])>new Date)return this.blockingMessage=a("<div>").addClass("small-12-columns").append(c).prependTo(a("#submit_record__row")),!1}return!0},_showFlagInfo:function(){var b=this.flagInfo,c=a(this.idPrefix+"_flaginfo__row .controls").empty();b=b.length?JSON.parse(b.val()):[];var d=b.length;if(d){c.addClass("has-flaginfo");c=a('<div class="checkpoint-advise">').hide().appendTo(c);for(var e,h,f=0;f<d;f++)e=b[f],h=a('<div class="checkpoint-instructions">').appendTo(c),
...
if(b){var f=b=!1;e.length&&(e=e.val())&&(b=JSON.parse(e));b&&(f=!0,h.length&&(h=h.val())&&(f=JSON.parse(h)));b&&f&&(f=this._checkBlockedEvents());b&&f&&d.reverse()}e=c.find(d[0]);c.find(d[1]).prop("disabled",!0).hide().insertAfter(e);e.prop("disabled",!1).hide().removeClass("hide").show()},_clearAlert:function(){a(".alert-error, .alert-warning, .alert-info, .alert-success").fadeOut("fast");a(".error_wrapper").fadeOut("fast").remove()},_clearForm:function(b,c){var d=this.idPrefix;a(".inline-throbber").remove();
b||this._clearAlert();c||a(d+"_label").val("");a(d+"_person__row .controls").hide().empty();this._removeProfilePicture();this._clearDetails();this._toggleSubmit(!1)},_bindEvents:function(){var b=a(this.element),c=this.idPrefix,d=this.eventNamespace,e=this,h=a(".zxing-button"),f=a("#event-type-toggle"),g=a("#event-type-selector");-1==navigator.userAgent.toLowerCase().indexOf("android")?h.addClass("disabled").click(function(a){a.preventDefault();a.stopPropagation();return!1}):h.bind("click"+d,function(){e._clearAlert()});
f.bind("click"+d,function(){e._clearAlert();g.hasClass("hide")?g.hide().removeClass("hide").slideDown():g.slideToggle()});g.find("a.event-type-selector").bind("click"+d,function(){var b=a(this),d=b.data("code");b=b.data("name");a('input[type="hidden"][name="event"]').val(d);a(".event-type-name").text(b).removeClass("placeholder");a(c+"_person__row .controls").text()&&e._toggleSubmit(!0);h.each(function(){var b=a(this),c=b.data("tmp");c&&b.attr("href",c.replace("%7BEVENT%7D",d))});g.slideUp()});b.delegate(".toggle-picture",
