...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,g,f){a instanceof String&&(a=String(a));for(var b=a.length,c=0;c<b;c++){var d=a[c];if(g.call(f,d,c,a))return{i:c,v:d}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
...
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(a,g){var f=$jscomp.propertyToPolyfillSymbol[g];if(null==f)return a[g];f=a[f];return void 0!==f?f:a[g]};
$jscomp.polyfill=function(a,g,f,b){g&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(a,g,f,b):$jscomp.polyfillUnisolated(a,g,f,b))};$jscomp.polyfillUnisolated=function(a,g,f,b){f=$jscomp.global;a=a.split(".");for(b=0;b<a.length-1;b++){var c=a[b];if(!(c in f))return;f=f[c]}a=a[a.length-1];b=f[a];g=g(b);g!=b&&null!=g&&$jscomp.defineProperty(f,a,{configurable:!0,writable:!0,value:g})};
$jscomp.polyfillIsolated=function(a,g,f,b){var c=a.split(".");a=1===c.length;b=c[0];b=!a&&b in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var d=0;d<c.length-1;d++){var e=c[d];if(!(e in b))return;b=b[e]}c=c[c.length-1];f=$jscomp.IS_SYMBOL_NATIVE&&"es6"===f?b[c]:null;g=g(f);null!=g&&(a?$jscomp.defineProperty($jscomp.polyfills,c,{configurable:!0,writable:!0,value:g}):g!==f&&(void 0===$jscomp.propertyToPolyfillSymbol[c]&&(f=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[c]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(c):$jscomp.POLYFILL_PREFIX+f+"$"+c),$jscomp.defineProperty(b,$jscomp.propertyToPolyfillSymbol[c],{configurable:!0,writable:!0,value:g})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(g,f){return $jscomp.findInternal(this,g,f).v}},"es6","es3");
(function(a,g){var f=0;a.widget("dvr.eventRegistration",{options:{tablename:"case_event",ajax:null,ajaxURL:"",showPicture:!0,showPictureText:"Show Picture",hidePictureText:"Hide Picture"},_create:function(){this.id=f;f+=1;this.eventNamespace=".eventRegistration"},_init:function(){this.idPrefix="#"+this.options.tablename;var b=a(this.element);this.flagInfo=b.find("input[type=hidden][name=flags]");this.permissionInfo=b.find("input[type=hidden][name=permitted]");this.actionableInfo=b.find("input[type=hidden][name=actionable]");
...
else{e.html(h.p).removeClass("hide").show();var k=l.flagInfo;h.f?k.val(JSON.stringify(h.f)):k.val("[]");k=l.permissionInfo;h.s!==g?k.val(JSON.stringify(h.s)):k.val("false");k=l.actionableInfo;var n=h.u;k.length&&(n!==g?k.val(JSON.stringify(h.u)):(n=!0,k.val("true")));h.d&&l._updateDetails(h.d,n);h.b&&(l.imageURL.val(h.b),l._showProfilePicture());l.blockedEvents=h.i||{};l.blockingInfo.val(JSON.stringify(l.blockedEvents));l.eventType.val()&&l._toggleSubmit(!0);l._showFlagInfo()}h.a?S3.showAlert(h.a,
