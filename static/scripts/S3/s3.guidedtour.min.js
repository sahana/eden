...
function pre_step_callback(b,k){$.each(pre_step_data,function(m,l){var h=l[1],a=l[2];if(b==l[0]){var d=$("#"+h+" thead th").map(function(){return $(this).text().toLowerCase()});d[0]="id";var h=$("#"+h+" tbody tr").map(function(b){var c={};if(b==a)return $(this).find("td").each(function(a){a=d[a];c[a]="id"==a?$(this).find("a").attr("db_id"):$(this).text()}),c}).get(),c=$(k)[0].innerHTML;0<h.length&&$.each(h[0],function(a,b){c=c.replace(RegExp("dt_"+a,"g"),b)});$($(k)[0]).html(c)}})}
