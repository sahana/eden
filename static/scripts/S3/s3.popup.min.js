...
v,q,r,!0),n.startsWith("sub_")&&(n.endsWith("_none")?(b.$("#"+n.replace("_none","_0")).parent().hierarchicalopts("addNode",v,q,r,!0),b.$("#"+n.replace("_none","_default")).parent().hierarchicalopts("addNode",v,q,r,!0)):n.endsWith("_0")&&(b.$("#"+n.replace("_0","_none")).parent().hierarchicalopts("addNode",v,q,r,!0),b.$("#"+n.replace("_0","_default")).parent().hierarchicalopts("addNode",v,q,r,!0))));q=+q;!isNaN(q)&&q>A&&(A=q,J=r)}),I&&(H.val(J),h.val(A).change()),E){if(K){var u=["_0","_none","_default"],
