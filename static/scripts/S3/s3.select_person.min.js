...
$("#edit_selected_person_link").removeClass("hide"),f());$("#select_from_registry").click(function(){$("#select_from_registry_row").addClass("hide");$("#person_autocomplete_row").removeClass("hide");$(a).removeClass("hide");$("#person_autocomplete_label").removeClass("hide");$(a).focus()});$(a).focusout(function(){e=$(c).val();$(a).addClass("hide");$("#person_autocomplete_label").addClass("hide");$("#select_from_registry_row").removeClass("hide");0<e&&$("#clear_form_link").removeClass("hide")});clear_person_form=
...
person.hasOwnProperty("gender")&&$("#pr_person_gender").val(person.gender["@value"]);person.hasOwnProperty("date_of_birth")&&$("#pr_person_date_of_birth").val(person.date_of_birth["@value"]);person.hasOwnProperty("occupation")&&$("#pr_person_occupation").val(person.occupation);try{$.each(person.$_pr_contact,function(){method=this.contact_method["@value"];b=this.value;"undefined"!==typeof b&&('"EMAIL"'==method?$("#pr_person_email").val(b):'"SMS"'==method&&$("#pr_person_mobile_phone").val(b))})}catch(d){}}catch(e){$(c).val("")}$("#person_load_throbber").addClass("hide");
$("#select_from_registry").removeClass("hide");$("#clear_form_link").removeClass("hide");$("#edit_selected_person_link").removeClass("hide")});$("#person_autocomplete_row").addClass("hide");$("#select_from_registry_row").removeClass("hide")};"None"!=b&&($(c).val(b),select_person(b));$("form").submit(function(){S3ClearNavigateAwayConfirm();d();return!0})});
