S3.timeline.loadGDataCallback=function(b){for(var b=b.feed.entry,a=[],c=0;c<b.length;++c){var d=b[c];if(d.gd$when!=null){var e=d.gd$when[0],f=S3.timeline.convertFromGDataDate(e.startTime),e=S3.timeline.convertFromGDataDate(e.endTime);a.push({start:f,end:e,title:d.title.$t,description:d.content.$t,link:d.link[0].href})}}S3.timeline.data={dateTimeFormat:"iso8601",events:a};S3.timeline.eventSource.loadJSON(S3.timeline.data,".");S3.timeline.tl.hideLoadingMessage();S3.timeline.tl.layout()};
S3.timeline.zeroPad=function(b){if(b<0)throw Error("n is negative");return b<10?"0"+b:b};S3.timeline.convertToGDataDate=function(b){return b.getFullYear()+"-"+S3.timeline.zeroPad(b.getMonth()+1)+"-"+S3.timeline.zeroPad(b.getDate())};S3.timeline.convertFromGDataDate=function(b){b=b.match(/(\d{4})-(\d{2})-(\d{2})/);return new Date(parseInt(b[1],10),parseInt(b[2],10)-1,parseInt(b[3],10))};
