SimileAjax={Platform:{}};SimileAjax.urlPrefix=SimileAjax_urlPrefix;SimileAjax.version="2.2.1";SimileAjax.jQuery=jQuery;SimileAjax.Platform.os={isMac:!1,isWin:!1,isWin32:!1,isUnix:!1};SimileAjax.Platform.browser={isIE:!1,isNetscape:!1,isMozilla:!1,isFirefox:!1,isOpera:!1,isSafari:!1,majorVersion:0,minorVersion:0};
...
SimileAjax.DOM.registerEvent=function(a,b,c){var d=function(f){if(f=f?f:event?event:null){var e=f.target?f.target:f.srcElement?f.srcElement:null;e&&=1==e.nodeType||9==e.nodeType?e:e.parentNode;return c(a,f,e)}return!0};SimileAjax.Platform.browser.isIE?a.attachEvent("on"+b,d):a.addEventListener(b,d,!1)};
...
c?(this.timeline_at_start=!d,this.timeline_at_stop=!1):(this.timeline_at_stop=!d,this.timeline_at_start=!1);return d};Timeline._Impl.prototype.zoom=function(a,b,c,d){var f=null,e=RegExp("^timeline-band-([0-9]+)$").exec(d.id);e&&(f=parseInt(e[1]));null!=f&&this._bands[f].zoom(a,b,c,d);this.paint()};
