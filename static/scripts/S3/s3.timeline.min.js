...
$jscomp.polyfill=function(a,b,c,d){if(b){c=$jscomp.global;a=a.split(".");for(d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&$jscomp.defineProperty(c,a,{configurable:!0,writable:!0,value:b})}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");SimileAjax={Platform:{}};SimileAjax.urlPrefix=SimileAjax_urlPrefix;SimileAjax.version="2.2.1";SimileAjax.jQuery=jQuery;
SimileAjax.Platform.os={isMac:!1,isWin:!1,isWin32:!1,isUnix:!1};SimileAjax.Platform.browser={isIE:!1,isNetscape:!1,isMozilla:!1,isFirefox:!1,isOpera:!1,isSafari:!1,majorVersion:0,minorVersion:0};
...
-1!=a.indexOf("netscape");SimileAjax.Platform.browser.isMozilla=-1!=b.indexOf("mozilla");SimileAjax.Platform.browser.isFirefox=-1!=b.indexOf("firefox");SimileAjax.Platform.browser.isOpera=-1!=a.indexOf("opera");SimileAjax.Platform.browser.isSafari=-1!=a.indexOf("safari");a=function(a){a=a.split(".");SimileAjax.Platform.browser.majorVersion=parseInt(a[0]);SimileAjax.Platform.browser.minorVersion=parseInt(a[1])};var c=function(a,b,c){b=a.indexOf(b,c);return 0<=b?b:a.length};if(SimileAjax.Platform.browser.isMozilla){var d=
...
SimileAjax.Platform.getDefaultLocale=function(){return SimileAjax.Platform.clientLocale};SimileAjax.Debug={silent:!1};SimileAjax.Debug.log=function(a){var b="console"in window&&"log"in window.console?function(a){console.log(a)}:function(a){SimileAjax.Debug.silent||alert(a)};SimileAjax.Debug.log=b;b(a)};SimileAjax.Debug.warn=function(a){var b="console"in window&&"warn"in window.console?function(a){console.warn(a)}:function(a){SimileAjax.Debug.silent||alert(a)};SimileAjax.Debug.warn=b;b(a)};
SimileAjax.Debug.exception=function(a,b){var c="throw"==SimileAjax.parseURLParameters().errors||"throw"==SimileAjax.params.errors?function(a,b){throw a;}:"console"in window&&"error"in window.console?function(a,b){null!=b?console.error(b+" %o",a):console.error(a);throw a;}:function(a,b){SimileAjax.Debug.silent||alert("Caught exception: "+b+"\n\nDetails: "+("description"in a?a.description:a));throw a;};SimileAjax.Debug.exception=c;c(a,b)};
SimileAjax.Debug.objectToString=function(a){return SimileAjax.Debug._objectToString(a,"")};SimileAjax.Debug._objectToString=function(a,b){var c=b+" ";if("object"==typeof a){var d="{";for(e in a)d+=c+e+": "+SimileAjax.Debug._objectToString(a[e],c)+"\n";return d+(b+"}")}if("array"==typeof a){d="[";for(var e=0;e<a.length;e++)d+=SimileAjax.Debug._objectToString(a[e],c)+"\n";return d+(b+"]")}return a};SimileAjax.XmlHttp={};
...
(function(){var a={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},b={array:function(a){var c=["["],e,f,g=a.length;for(f=0;f<g;f+=1){var h=a[f];if(e=b[typeof h])if(h=e(h),"string"==typeof h){k&&(c[c.length]=",");c[c.length]=h;var k=!0}}c[c.length]="]";return c.join("")},"boolean":function(a){return String(a)},"null":function(a){return"null"},number:function(a){return isFinite(a)?String(a):"null"},object:function(a){if(a){if(a instanceof Array)return b.array(a);var c=
["{"],e,f;for(f in a){var g=a[f];if(e=b[typeof g])if(g=e(g),"string"==typeof g){h&&(c[c.length]=",");c.push(b.string(f),":",g);var h=!0}}c[c.length]="}";return c.join("")}return"null"},string:function(b){/["\\\x00-\x1f]/.test(b)&&(b=b.replace(/([\x00-\x1f\\"])/g,function(b,c){if(b=a[c])return b;b=c.charCodeAt();return"\\u00"+Math.floor(b/16).toString(16)+(b%16).toString(16)}));return'"'+b+'"'}};SimileAjax.JSON.toJSONString=function(a){return a instanceof Object?b.object(a):a instanceof Array?b.array(a):
a.toString()};SimileAjax.JSON.parseJSON=function(){try{return!/[^,:{}\[\]0-9.\-+Eaeflnr-u \n\r\t]/.test(this.replace(/"(\\.|[^"\\])*"/g,""))&&eval("("+this+")")}catch(c){return!1}}})();SimileAjax.DOM={};SimileAjax.DOM.registerEventWithObject=function(a,b,c,d){SimileAjax.DOM.registerEvent(a,b,function(a,b,g){return c[d].call(c,a,b,g)})};
...
SimileAjax.Graphics.createBubbleForContentAndPoint=function(a,b,c,d,e,f){"number"!=typeof d&&(d=300);"number"!=typeof f&&(f=0);a.style.position="absolute";a.style.left="-5000px";a.style.top="0px";a.style.width=d+"px";document.body.appendChild(a);window.setTimeout(function(){var d=a.scrollWidth+10,h=a.scrollHeight+10,k=0;0<f&&h>f&&(h=f,k=d-25);h=SimileAjax.Graphics.createBubbleForPoint(b,c,d,h,e);document.body.removeChild(a);a.style.position="static";a.style.left="";a.style.top="";0<k?(d=document.createElement("div"),
a.style.width="",d.style.width=k+"px",d.appendChild(a),h.content.appendChild(d)):(a.style.width=d+"px",h.content.appendChild(a))},200)};
SimileAjax.Graphics.createBubbleForPoint=function(a,b,c,d,e){c=parseInt(c,10);d=parseInt(d,10);var f=SimileAjax.Graphics.bubbleConfig,g=SimileAjax.Graphics.pngIsTranslucent?"pngTranslucent":"pngNotTranslucent",h=function(a){return a+" "+a+"-"+g},k=document.createElement("div");k.className=h(f.containerCSSClass);k.style.width=c+"px";k.style.height=d+"px";var l=document.createElement("div");l.className=h(f.innerContainerCSSClass);k.appendChild(l);var m={_closed:!1},p=SimileAjax.WindowManager.pushLayer(function(){m._closed||
(document.body.removeChild(m._div),m._doc=null,m._div=null,m._content=null,m._closed=!0)},!0,k);m._div=k;m.close=function(){SimileAjax.WindowManager.popLayer(p)};var q=function(a){var b=document.createElement("div");b.className=h(f.borderGraphicCSSClassPrefix+a);l.appendChild(b)};q("top-left");q("top-right");q("bottom-left");q("bottom-right");q("left");q("right");q("top");q("bottom");q=document.createElement("div");q.className=h(f.contentContainerCSSClass);l.appendChild(q);m.content=q;q=document.createElement("div");
q.className=h(f.closeGraphicCSSClass);l.appendChild(q);SimileAjax.WindowManager.registerEventWithObject(q,"click",m,"close");(function(){var g=SimileAjax.Graphics.getWindowDimensions(),m=g.w,p=g.h;g=Math.ceil(f.arrowGraphicWidth/2);var q=function(a){var b=document.createElement("div");b.className=h(f.arrowGraphicCSSClassPrefix+"point-"+a);l.appendChild(b);return b};if(0<a-g-f.borderGraphicSize-f.extraPadding&&a+g+f.borderGraphicSize+f.extraPadding<m){var v=a-Math.round(c/2);v=a<m/2?Math.max(v,f.extraPadding+
f.borderGraphicSize):Math.min(v,m-f.extraPadding-f.borderGraphicSize-c);if(e&&"top"==e||!e&&0<b-f.arrowGraphicTargetOffset-d-f.borderGraphicSize-f.extraPadding){p=q("down");p.style.left=a-g-v+"px";k.style.left=v+"px";k.style.top=b-f.arrowGraphicTargetOffset-d+"px";return}if(e&&"bottom"==e||!e&&b+f.arrowGraphicTargetOffset+d+f.borderGraphicSize+f.extraPadding<p){p=q("up");p.style.left=a-g-v+"px";k.style.left=v+"px";k.style.top=b+f.arrowGraphicTargetOffset+"px";return}}m=b-Math.round(d/2);m=b<p/2?Math.max(m,
f.extraPadding+f.borderGraphicSize):Math.min(m,p-f.extraPadding-f.borderGraphicSize-d);e&&"left"==e||!e&&0<a-f.arrowGraphicTargetOffset-c-f.borderGraphicSize-f.extraPadding?(p=q("right"),p.style.top=b-g-m+"px",k.style.top=m+"px",k.style.left=a-f.arrowGraphicTargetOffset-c+"px"):(p=q("left"),p.style.top=b-g-m+"px",k.style.top=m+"px",k.style.left=a+f.arrowGraphicTargetOffset+"px")})();document.body.appendChild(k);return m};
...
SimileAjax.Graphics.createStructuredDataCopyButton=function(a,b,c,d){var e=document.createElement("div");e.style.position="relative";e.style.display="inline";e.style.width=b+"px";e.style.height=c+"px";e.style.overflow="hidden";e.style.margin="2px";SimileAjax.Graphics.pngIsTranslucent?e.style.background="url("+a+") no-repeat":e.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+a+"', sizingMethod='image')";e.innerHTML="<textarea rows='1' autocomplete='off' value='none' style='"+
(SimileAjax.Platform.browser.isIE?"filter:alpha(opacity=0)":"opacity: 0")+"' />";var f=e.firstChild;f.style.width=b+"px";f.style.height=c+"px";f.onmousedown=function(a){a=a?a:event?event:null;2==a.button&&(f.value=d(),f.select())};return e};SimileAjax.Graphics.getWidthHeight=function(a){if(null==a.getBoundingClientRect){var b=a.offsetWidth;a=a.offsetHeight}else a=a.getBoundingClientRect(),b=Math.ceil(a.right-a.left),a=Math.ceil(a.bottom-a.top);return{width:b,height:a}};
...
SimileAjax.DateTime.setIso8601Date=function(a,b){var c=b.match(SimileAjax.DateTime._dateRegexp);if(!c)throw Error("Invalid date string: "+b);var d=c[5],e=c[7],f=c[9];b=c[11];var g=c[13]?c[13]:1;a.setUTCFullYear(("-"==c[1]?-1:1)*c[2]);f?(a.setUTCMonth(0),a.setUTCDate(Number(f))):b?(a.setUTCMonth(0),a.setUTCDate(1),c=(c=a.getUTCDay())?c:7,b=Number(g)+7*Number(b),4>=c?a.setUTCDate(b+1-c):a.setUTCDate(b+8-c)):(d&&(a.setUTCDate(1),a.setUTCMonth(d-1)),e&&a.setUTCDate(e));return a};
SimileAjax.DateTime.setIso8601Time=function(a,b){var c=b.match(SimileAjax.DateTime._timeRegexp);if(!c)return SimileAjax.Debug.warn("Invalid time string: "+b),!1;b=Number(c[3]?c[3]:0);var d=c[5]?c[5]:0,e=c[7]?1E3*Number("0."+c[7]):0;a.setUTCHours(c[1]);a.setUTCMinutes(b);a.setUTCSeconds(d);a.setUTCMilliseconds(e);return a};SimileAjax.DateTime.timezoneOffset=(new Date).getTimezoneOffset();
...
SimileAjax.DateTime.roundDownToInterval=function(a,b,c,d,e){c*=SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.HOUR];var f=new Date(a.getTime()+c),g=function(a){a.setUTCMilliseconds(0);a.setUTCSeconds(0);a.setUTCMinutes(0);a.setUTCHours(0)},h=function(a){g(a);a.setUTCDate(1);a.setUTCMonth(0)};switch(b){case SimileAjax.DateTime.MILLISECOND:b=f.getUTCMilliseconds();f.setUTCMilliseconds(b-b%d);break;case SimileAjax.DateTime.SECOND:f.setUTCMilliseconds(0);b=f.getUTCSeconds();f.setUTCSeconds(b-
b%d);break;case SimileAjax.DateTime.MINUTE:f.setUTCMilliseconds(0);f.setUTCSeconds(0);b=f.getUTCMinutes();f.setTime(f.getTime()-b%d*SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.MINUTE]);break;case SimileAjax.DateTime.HOUR:f.setUTCMilliseconds(0);f.setUTCSeconds(0);f.setUTCMinutes(0);b=f.getUTCHours();f.setUTCHours(b-b%d);break;case SimileAjax.DateTime.DAY:g(f);break;case SimileAjax.DateTime.WEEK:g(f);d=(f.getUTCDay()+7-e)%7;f.setTime(f.getTime()-d*SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.DAY]);
break;case SimileAjax.DateTime.MONTH:g(f);f.setUTCDate(1);b=f.getUTCMonth();f.setUTCMonth(b-b%d);break;case SimileAjax.DateTime.YEAR:h(f);b=f.getUTCFullYear();f.setUTCFullYear(b-b%d);break;case SimileAjax.DateTime.DECADE:h(f);f.setUTCFullYear(10*Math.floor(f.getUTCFullYear()/10));break;case SimileAjax.DateTime.CENTURY:h(f);f.setUTCFullYear(100*Math.floor(f.getUTCFullYear()/100));break;case SimileAjax.DateTime.MILLENNIUM:h(f),f.setUTCFullYear(1E3*Math.floor(f.getUTCFullYear()/1E3))}a.setTime(f.getTime()-
c)};SimileAjax.DateTime.roundUpToInterval=function(a,b,c,d,e){var f=a.getTime();SimileAjax.DateTime.roundDownToInterval(a,b,c,d,e);a.getTime()<f&&a.setTime(a.getTime()+SimileAjax.DateTime.gregorianUnitLengths[b]*d)};
...
String.substitute=function(a,b){for(var c="",d=0;d<a.length-1;){var e=a.indexOf("%",d);if(0>e||e==a.length-1)break;else if(e>d&&"\\"==a.charAt(e-1))c+=a.substring(d,e-1)+"%",d=e+1;else{var f=parseInt(a.charAt(e+1));c=isNaN(f)||f>=b.length?c+a.substring(d,e+2):c+(a.substring(d,e)+b[f].toString());d=e+2}}d<a.length&&(c+=a.substring(d));return c};SimileAjax.HTML={};SimileAjax.HTML._e2uHash={};
...
SimileAjax.EventIndex.prototype._index=function(){for(var a=this._events.length(),b=0;b<a;b++){var c=this._events.elementAt(b);c._earliestOverlapIndex=b}var d=1;for(b=0;b<a;b++)for(c=this._events.elementAt(b),c=c.getEnd(),d=Math.max(d,b+1);d<a;){var e=this._events.elementAt(d),f=e.getStart();if(0>this._unit.compare(f,c))e._earliestOverlapIndex=b,d++;else break}this._indexed=!0};
...
SimileAjax.ListenerQueue.prototype.fire=function(a,b){for(var c=[].concat(this._listeners),d=0;d<c.length;d++){var e=c[d];if(a in e)try{e[a].apply(e,b)}catch(f){SimileAjax.Debug.exception("Error firing event of name "+a,f)}else if(null!=this._wildcardHandlerName&&this._wildcardHandlerName in e)try{e[this._wildcardHandlerName].apply(e,[a])}catch(f){SimileAjax.Debug.exception("Error firing event of name "+a+" to wildcard handler",f)}}};
...
b&&SimileAjax.History._currentIndex>SimileAjax.History._baseIndex;){SimileAjax.History._currentIndex--;var a=SimileAjax.History._actions[SimileAjax.History._currentIndex-SimileAjax.History._baseIndex];try{a.undo()}catch(g){SimileAjax.Debug.exception(g,"History: Failed to undo action {"+a.label+"}")}}SimileAjax.History._listeners.fire("onAfterUndoSeveral",[]);c()},0);else if(b>SimileAjax.History._currentIndex)SimileAjax.History._listeners.fire("onBeforeRedoSeveral",[]),window.setTimeout(function(){for(;SimileAjax.History._currentIndex<
b&&SimileAjax.History._currentIndex-SimileAjax.History._baseIndex<SimileAjax.History._actions.length;){var a=SimileAjax.History._actions[SimileAjax.History._currentIndex-SimileAjax.History._baseIndex];try{a.perform()}catch(g){SimileAjax.Debug.exception(g,"History: Failed to redo action {"+a.label+"}")}SimileAjax.History._currentIndex++}SimileAjax.History._listeners.fire("onAfterRedoSeveral",[]);c()},0);else{var d=SimileAjax.History._currentIndex-SimileAjax.History._baseIndex-1,e=0<=d&&d<SimileAjax.History._actions.length?
SimileAjax.History.formatHistoryEntryTitle(SimileAjax.History._actions[d].label):SimileAjax.History._plainDocumentTitle;SimileAjax.History._iframe.contentWindow.document.title=e;document.title=e}}catch(f){}};SimileAjax.History.getNextUndoAction=function(){try{return SimileAjax.History._actions[SimileAjax.History._currentIndex-SimileAjax.History._baseIndex-1]}catch(a){return null}};
...
SimileAjax.WindowManager._onBodyMouseMove=function(a,b,c){if(null!=SimileAjax.WindowManager._draggedElement){a=SimileAjax.WindowManager._draggedElementCallback;var d=SimileAjax.WindowManager._lastCoords,e=b.clientX-d.x;d=b.clientY-d.y;if(SimileAjax.WindowManager._dragging)try{SimileAjax.WindowManager._lastCoords={x:b.clientX,y:b.clientY};if("onDragBy"in a)a.onDragBy(e,d);if("_ghostElmt"in a){m=a._ghostElmt;SimileAjax.WindowManager._ghostCoords.left+=e;SimileAjax.WindowManager._ghostCoords.top+=d;
m.style.left=SimileAjax.WindowManager._ghostCoords.left+"px";m.style.top=SimileAjax.WindowManager._ghostCoords.top+"px";if(null!=SimileAjax.WindowManager._draggingModeIndicatorElmt){var f=SimileAjax.WindowManager._draggingModeIndicatorElmt;f.style.left=SimileAjax.WindowManager._ghostCoords.left-16+"px";f.style.top=SimileAjax.WindowManager._ghostCoords.top+"px"}if("droppable"in a&&a.droppable){var g=SimileAjax.DOM.getEventPageCoordinates(b);c=SimileAjax.DOM.hittest(g.x,g.y,[SimileAjax.WindowManager._ghostElmt,
SimileAjax.WindowManager._dropTargetHighlightElement]);c=SimileAjax.WindowManager._findDropTarget(c);if(c!=SimileAjax.WindowManager._potentialDropTarget&&(null!=SimileAjax.WindowManager._dropTargetHighlightElement&&(document.body.removeChild(SimileAjax.WindowManager._dropTargetHighlightElement),SimileAjax.WindowManager._dropTargetHighlightElement=null,SimileAjax.WindowManager._potentialDropTarget=null),f=!1,null!=c&&("canDropOn"in a&&!a.canDropOn(c)||"canDrop"in c&&!c.canDrop(SimileAjax.WindowManager._draggedElement)||
(f=!0)),f)){var h=SimileAjax.DOM.getPageCoordinates(c),k=document.createElement("div");k.style.border="4px solid yellow";k.style.backgroundColor="yellow";k.style.position="absolute";k.style.left=h.left+"px";k.style.top=h.top+"px";k.style.width=c.offsetWidth-8+"px";k.style.height=c.offsetHeight-8+"px";SimileAjax.Graphics.setOpacity(k,30);document.body.appendChild(k);SimileAjax.WindowManager._potentialDropTarget=c;SimileAjax.WindowManager._dropTargetHighlightElement=k}}}}catch(p){SimileAjax.Debug.exception("WindowManager: Error handling mouse move",
p),SimileAjax.WindowManager._cancelDragging()}else if(5<Math.abs(e)||5<Math.abs(d))try{if("onDragStart"in a)a.onDragStart();if("ghost"in a&&a.ghost){var l=SimileAjax.WindowManager._draggedElement;SimileAjax.WindowManager._ghostCoords=SimileAjax.DOM.getPageCoordinates(l);SimileAjax.WindowManager._ghostCoords.left+=e;SimileAjax.WindowManager._ghostCoords.top+=d;var m=l.cloneNode(!0);m.style.position="absolute";m.style.left=SimileAjax.WindowManager._ghostCoords.left+"px";m.style.top=SimileAjax.WindowManager._ghostCoords.top+
...
(function(){var a;S3.timeline.loadGDataCallback=function(b){b=b.feed.entry;for(var c=[],f=0;f<b.length;++f){var e=b[f];if(null!==e.gd$when){var l=e.gd$when[0],m=d(l.startTime);l=d(l.endTime);c.push({start:m,end:l,title:e.title.$t,description:e.content.$t,link:e.link[0].href})}}S3.timeline.data={dateTimeFormat:"iso8601",events:c};a.loadJSON(S3.timeline.data,".");b=S3.timeline.tl;b.hideLoadingMessage();b.layout()};var b=function(a){if(0>a)throw Error("n is negative");return 10>a?"0"+a:a},c=function(a){return a.getFullYear()+
"-"+b(a.getMonth()+1)+"-"+b(a.getDate())},d=function(a){a=a.match(/(\d{4})-(\d{2})-(\d{2})/);return new Date(parseInt(a[1],10),parseInt(a[2],10)-1,parseInt(a[3],10))};S3.timeline.onLoadCalendar=function(){a=new Timeline.DefaultEventSource;var b=document.getElementById("s3timeline"),d=Timeline.ClassicTheme.create();d.event.bubble.width=320;d.event.bubble.height=180;var e=new Date((new Date).getTime()+2592E5);d=[Timeline.createBandInfo({eventSource:a,date:e,width:"40%",intervalUnit:Timeline.DateTime.WEEK,
intervalPixels:300,theme:d}),Timeline.createBandInfo({eventSource:a,date:e,width:"60%",intervalUnit:Timeline.DateTime.MONTH,intervalPixels:550,theme:d})];d[1].syncWith=0;d[1].highlight=!0;b=Timeline.create(b,d);S3.timeline.tl=b;b.showLoadingMessage();b=S3.timeline.calendar;d=new Date((new Date).getDate());e=new Date((new Date).getTime()+7776E6);d="?start-min="+c(d)+"&start-max="+c(e)+"&alt=json-in-script&callback=S3.timeline.loadGDataCallback&max-results=5000";b+=d;d=document.createElement("script");
d.src=b;document.body.appendChild(d)};S3.timeline.onLoad=function(){a=new Timeline.DefaultEventSource;var b=document.getElementById("s3timeline"),c=Timeline.ClassicTheme.create();c.timeline_start=new Date(S3.timeline.tl_start);c.timeline_stop=new Date(S3.timeline.tl_end);c.event.bubble.width=320;c.event.bubble.height=180;var d=Timeline.DateTime.parseIso8601DateTime(S3.timeline.now);c=[Timeline.createBandInfo({width:"90%",intervalUnit:Timeline.DateTime.DAY,intervalPixels:140,eventSource:a,date:d,theme:c}),
Timeline.createBandInfo({overview:!0,width:"10%",intervalUnit:Timeline.DateTime.MONTH,intervalPixels:200,eventSource:a,date:d})];c[1].syncWith=0;c[1].highlight=!0;b=Timeline.create(b,c,Timeline.HORIZONTAL);a.loadJSON(S3.timeline.data,".");b.layout();S3.timeline.tl=b};var e=null;S3.timeline.onResize=function(){null===e&&(e=window.setTimeout(function(){e=null;S3.timeline.tl.layout()},500))}})();
...
Timeline.VERTICAL=1;Timeline._defaultTheme=null;Timeline.getDefaultLocale=function(){return Timeline.clientLocale};Timeline.create=function(a,b,c,d){null==Timeline.timelines&&(Timeline.timelines=[]);var e=Timeline.timelines.length;Timeline.timelines[e]=null;a=new Timeline._Impl(a,b,c,d,e);return Timeline.timelines[e]=a};
Timeline.createBandInfo=function(a){var b="theme"in a?a.theme:Timeline.getDefaultTheme(),c="decorators"in a?a.decorators:[],d="eventSource"in a?a.eventSource:null,e=new Timeline.LinearEther({centersOn:"date"in a?a.date:new Date,interval:SimileAjax.DateTime.gregorianUnitLengths[a.intervalUnit],pixelsPerInterval:a.intervalPixels,theme:b}),f=new Timeline.GregorianEtherPainter({unit:a.intervalUnit,multiple:"multiple"in a?a.multiple:1,theme:b,align:"align"in a?a.align:void 0}),g={showText:"showEventText"in
...
eventSource:d,timeZone:"timeZone"in a?a.timeZone:0,ether:e,etherPainter:f,eventPainter:g,theme:b,decorators:c,zoomIndex:"zoomIndex"in a?a.zoomIndex:0,zoomSteps:"zoomSteps"in a?a.zoomSteps:null}};
...
if("eventPainterParams"in a)for(var g in a.eventPainterParams)f[g]=a.eventPainterParams[g];"trackHeight"in a&&(f.trackHeight=a.trackHeight);"trackGap"in a&&(f.trackGap=a.trackGap);g="overview"in a&&a.overview?"overview":"layout"in a?a.layout:"original";if("eventPainter"in a)f=new a.eventPainter(f);else switch(g){case "overview":f=new Timeline.OverviewEventPainter(f);break;case "detailed":f=new Timeline.DetailedEventPainter(f);break;default:f=new Timeline.OriginalEventPainter(f)}return{width:a.width,
eventSource:c,timeZone:"timeZone"in a?a.timeZone:0,ether:d,etherPainter:e,eventPainter:f,theme:b,zoomIndex:"zoomIndex"in a?a.zoomIndex:0,zoomSteps:"zoomSteps"in a?a.zoomSteps:null}};Timeline.getDefaultTheme=function(){null==Timeline._defaultTheme&&(Timeline._defaultTheme=Timeline.ClassicTheme.create(Timeline.getDefaultLocale()));return Timeline._defaultTheme};Timeline.setDefaultTheme=function(a){Timeline._defaultTheme=a};
Timeline.loadXML=function(a,b){SimileAjax.XmlHttp.get(a,function(b,d,e){alert("Failed to load data xml from "+a+"\n"+b)},function(c){var d=c.responseXML;!d.documentElement&&c.responseStream&&d.load(c.responseStream);b(d,a)})};Timeline.loadJSON=function(a,b){SimileAjax.XmlHttp.get(a,function(b,d,e){alert("Failed to load json data from "+a+"\n"+b)},function(c){b(eval("("+c.responseText+")"),a)})};Timeline.getTimelineFromID=function(a){return Timeline.timelines[a]};
...
Timeline._Impl.prototype.loadXML=function(a,b){var c=this,d=function(b,d,e){alert("Failed to load data xml from "+a+"\n"+b);c.hideLoadingMessage()},e=function(d){try{var f=d.responseXML;!f.documentElement&&d.responseStream&&f.load(d.responseStream);b(f,a)}finally{c.hideLoadingMessage()}};this.showLoadingMessage();window.setTimeout(function(){SimileAjax.XmlHttp.get(a,d,e)},0)};
Timeline._Impl.prototype.loadJSON=function(a,b){var c=this,d=function(b,d,e){alert("Failed to load json data from "+a+"\n"+b);c.hideLoadingMessage()},e=function(d){try{b(eval("("+d.responseText+")"),a)}finally{c.hideLoadingMessage()}};this.showLoadingMessage();window.setTimeout(function(){SimileAjax.XmlHttp.get(a,d,e)},0)};Timeline._Impl.prototype._autoWidthScrollListener=function(a){a.getTimeline()._autoWidthCheck(!1)};
Timeline._Impl.prototype._autoWidthCheck=function(a){function b(){var a=c.getWidthStyle();if(d)c._containerDiv.style[a]=e+"px";else{c._autoResizing=!0;var b={};b[a]=e+"px";SimileAjax.jQuery(c._containerDiv).animate(b,c.autoWidthAnimationTime,"linear",function(){c._autoResizing=!1})}}var c=this,d=c._starting,e=0;c.autoWidth&&function(){var d=0,g=c.getPixelWidth();if(!c._autoResizing){for(var h=0;h<c._bands.length;h++)c._bands[h].checkAutoWidth(),d+=c._bandInfos[h].width;if(d>g||a)e=d,b(),c._distributeWidths()}}()};
...
Timeline._Impl.prototype._distributeWidths=function(){for(var a=this.getPixelLength(),b=this.getPixelWidth(),c=0,d=0;d<this._bands.length;d++){var e=this._bands[d],f=this._bandInfos[d].width;if("string"==typeof f){var g=f.indexOf("%");0<g?(f=parseInt(f.substr(0,g)),f=Math.round(f*b/100)):f=parseInt(f)}e.setBandShiftAndWidth(c,f);e.setViewLength(a);c+=f}};
Timeline._Impl.prototype.shiftOK=function(a,b){var c=0<b,d=0>b;if(c&&null==this.timeline_start||d&&null==this.timeline_stop||0==b)return!0;for(var e=!1,f=0;f<this._bands.length&&!e;f++)e=this._bands[f].busy();if(e)return!0;if(c&&this.timeline_at_start||d&&this.timeline_at_stop)return!1;d=!1;for(f=0;f<this._bands.length&&!d;f++)d=this._bands[f],d=c?(f==a?d.getMinVisibleDateAfterDelta(b):d.getMinVisibleDate())>=this.timeline_start:(f==a?d.getMaxVisibleDateAfterDelta(b):d.getMaxVisibleDate())<=this.timeline_stop;
c?(this.timeline_at_start=!d,this.timeline_at_stop=!1):(this.timeline_at_stop=!d,this.timeline_at_start=!1);return d};Timeline._Impl.prototype.zoom=function(a,b,c,d){var e=null,f=/^timeline-band-([0-9]+)$/.exec(d.id);f&&(e=parseInt(f[1]));null!=e&&this._bands[e].zoom(a,b,c,d);this.paint()};
...
Timeline._Band.prototype._onMouseMove=function(a,b,c){if(this._dragging||this._orthogonalDragging){var d=b.clientX-this._dragX,e=b.clientY-this._dragY;this._dragX=b.clientX;this._dragY=b.clientY}if(this._dragging)this._timeline.isHorizontal()?this._moveEther(d,e):this._moveEther(e,d);else if(this._orthogonalDragging)a=this.getViewWidth(),c=this._scrollBar.firstChild,this._timeline.isHorizontal()?this._moveEther(0,-e*a/c.offsetHeight):this._moveEther(0,-d*a/c.offsetWidth);else return;this._positionHighlight();
...
Timeline._Band.prototype._onMouseScroll=function(a,b,c){c=new Date;c=c.getTime();if(!this._lastScrollTime||50<c-this._lastScrollTime){this._lastScrollTime=c;c=0;b.wheelDelta?c=b.wheelDelta/120:b.detail&&(c=-b.detail/3);var d=this._theme.mouseWheel;if(this._zoomSteps||"zoom"===d){if(d=SimileAjax.DOM.getEventRelativeCoordinates(b,a),0!=c){var e;0<c&&(e=!0);0>c&&(e=!1);this._timeline.zoom(e,d.x,d.y,a)}}else"scroll"===d&&this._moveEther(50*(0>c?-1:1))}b.stopPropagation&&b.stopPropagation();b.cancelBubble=
...
Timeline._Band.prototype._positionHighlight=function(){if(this._syncWithBand){var a=this._syncWithBand.getMinVisibleDate(),b=this._syncWithBand.getMaxVisibleDate();if(this._highlight){var c=0,d=1,e=this._syncWithBand.getEventPainter();"supportsOrthogonalScrolling"in e&&e.supportsOrthogonalScrolling()&&(c=e.getOrthogonalExtent(),d=this._syncWithBand.getViewWidth(),c=Math.max(d,c),d/=c,c=-this._syncWithBand.getViewOrthogonalOffset()/c);this._etherPainter.setHighlight(a,b,c,d)}}};
...
Timeline.HotZoneEther.prototype.initialize=function(a,b){this._band=a;this._timeline=b;this._unit=b.getUnit();this._zones=[{startTime:Number.NEGATIVE_INFINITY,endTime:Number.POSITIVE_INFINITY,magnify:1}];a=this._params;for(b=0;b<a.zones.length;b++)for(var c=a.zones[b],d=this._unit.parseFromObject(c.start),e=this._unit.parseFromObject(c.end),f=0;f<this._zones.length&&0<this._unit.compare(e,d);f++){var g=this._zones[f];0>this._unit.compare(d,g.endTime)&&(0<this._unit.compare(d,g.startTime)&&(this._zones.splice(f,
0,{startTime:g.startTime,endTime:d,magnify:g.magnify}),f++,g.startTime=d),0>this._unit.compare(e,g.endTime)?(this._zones.splice(f,0,{startTime:d,endTime:e,magnify:c.magnify*g.magnify}),f++,d=g.startTime=e):(g.magnify*=c.magnify,d=g.endTime))}"startsOn"in this._params?this._start=this._unit.parseFromObject(this._params.startsOn):"endsOn"in this._params?(this._start=this._unit.parseFromObject(this._params.endsOn),this.shiftPixels(-this._timeline.getPixelLength())):(this._start="centersOn"in this._params?
...
Timeline.HotZoneEther.prototype._dateDiffToPixelOffset=function(a,b){var c=this._getScale(),d=0;if(0>this._unit.compare(a,b)){for(var e=0;e<this._zones.length&&!(0>this._unit.compare(a,this._zones[e].endTime));)e++;for(;0>this._unit.compare(a,b);){var f=this._zones[e],g=this._unit.earlier(b,f.endTime);d+=this._unit.compare(g,a)/(c/f.magnify);a=g;e++}}else{for(e=this._zones.length-1;0<=e&&!(0<this._unit.compare(a,this._zones[e].startTime));)e--;for(;0<this._unit.compare(a,b);)f=this._zones[e],g=this._unit.later(b,
f.startTime),d+=this._unit.compare(g,a)/(c/f.magnify),a=g,e--}return d};
Timeline.HotZoneEther.prototype._pixelOffsetToDate=function(a,b){var c=this._getScale();if(0<a){for(var d=0;d<this._zones.length&&!(0>this._unit.compare(b,this._zones[d].endTime));)d++;for(;0<a;){var e=this._zones[d],f=c/e.magnify;if(e.endTime==Number.POSITIVE_INFINITY)b=this._unit.change(b,a*f),a=0;else{var g=this._unit.compare(e.endTime,b)/f;g>a?(b=this._unit.change(b,a*f),a=0):(b=e.endTime,a-=g)}d++}}else{for(d=this._zones.length-1;0<=d&&!(0<this._unit.compare(b,this._zones[d].startTime));)d--;
for(a=-a;0<a;)e=this._zones[d],f=c/e.magnify,e.startTime==Number.NEGATIVE_INFINITY?(b=this._unit.change(b,-a*f),a=0):(g=this._unit.compare(b,e.startTime)/f,g>a?(b=this._unit.change(b,-a*f),a=0):(b=e.startTime,a-=g)),d--}return b};Timeline.HotZoneEther.prototype._getScale=function(){return this._interval/this._pixelsPerInterval};Timeline.GregorianEtherPainter=function(a){this._params=a;this._theme=a.theme;this._unit=a.unit;this._multiple="multiple"in a?a.multiple:1};
...
this._band.getMaxDate(),c=this._band.getTimeZone(),d=this._band.getLabeller(),e=0;e<this._zones.length&&!(a.getTime()<this._zones[e].endTime);)e++;for(var f=this._zones.length-1;0<=f&&!(b.getTime()>this._zones[f].startTime);)f--;for(;e<=f;e++){var g=this._zones[e],h=new Date(Math.max(a.getTime(),g.startTime)),k=new Date(Math.min(b.getTime(),g.endTime));SimileAjax.DateTime.roundDownToInterval(h,g.unit,c,g.multiple,this._theme.firstDayOfWeek);for(SimileAjax.DateTime.roundUpToInterval(k,g.unit,c,g.multiple,
...
this._band.getMaxDate(),c=this._band.getMinDate().getUTCFullYear()-this._startDate.getUTCFullYear();a.setUTCFullYear(this._band.getMinDate().getUTCFullYear()-c%this._multiple);var d=this;c=function(a){for(var b=0;b<d._multiple;b++)SimileAjax.DateTime.incrementByInterval(a,SimileAjax.DateTime.YEAR)};for(var e={labelInterval:function(a,b){a=a.getUTCFullYear()-d._startDate.getUTCFullYear();return{text:a,emphasized:0==a}}};a.getTime()<b.getTime();)this._intervalMarkerLayout.createIntervalMarker(a,e,SimileAjax.DateTime.YEAR,
...
Timeline.EtherIntervalMarkerLayout=function(a,b,c,d,e){var f=a.isHorizontal();this.positionDiv=f?"Top"==d?function(a,b){a.style.left=b+"px";a.style.top="0px"}:function(a,b){a.style.left=b+"px";a.style.bottom="0px"}:"Left"==d?function(a,b){a.style.top=b+"px";a.style.left="0px"}:function(a,b){a.style.top=b+"px";a.style.right="0px"};var g=c.ether.interval.line,h=c.ether.interval.weekend,k=SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.DAY];this.createIntervalMarker=function(d,m,p,q,u){var l=
Math.round(b.dateToPixelOffset(d));if(e&&p!=SimileAjax.DateTime.WEEK){var t=a.getDocument().createElement("div");t.className="timeline-ether-lines";100>g.opacity&&SimileAjax.Graphics.setOpacity(t,g.opacity);f?t.style.left=l+"px":t.style.top=l+"px";u.appendChild(t)}if(p==SimileAjax.DateTime.WEEK){t=c.firstDayOfWeek;t=new Date(d.getTime()+(6-t-7)*k);var w=new Date(t.getTime()+2*k);t=Math.round(b.dateToPixelOffset(t));w=Math.round(b.dateToPixelOffset(w));w=Math.max(1,w-t);var v=a.getDocument().createElement("div");
v.className="timeline-ether-weekends";100>h.opacity&&SimileAjax.Graphics.setOpacity(v,h.opacity);f?(v.style.left=t+"px",v.style.width=w+"px"):(v.style.top=t+"px",v.style.height=w+"px");u.appendChild(v)}d=m.labelInterval(d,p);m=a.getDocument().createElement("div");m.innerHTML=d.text;m.className="timeline-date-label";d.emphasized&&(m.className+=" timeline-date-label-em");this.positionDiv(m,l);q.appendChild(m);return m}};
Timeline.EtherHighlight=function(a,b,c,d){var e=a.isHorizontal();this._highlightDiv=null;this._createHighlightDiv=function(){if(null==this._highlightDiv){this._highlightDiv=a.getDocument().createElement("div");this._highlightDiv.setAttribute("name","ether-highlight");this._highlightDiv.className="timeline-ether-highlight";var b=c.ether.highlightOpacity;100>b&&SimileAjax.Graphics.setOpacity(this._highlightDiv,b);d.appendChild(this._highlightDiv)}};this.position=function(a,c,d,k){d=d||0;k=k||1;this._createHighlightDiv();
a=Math.round(b.dateToPixelOffset(a));c=Math.round(b.dateToPixelOffset(c));c=Math.max(c-a,3);var f=b.getViewWidth()-4;e?(this._highlightDiv.style.left=a+"px",this._highlightDiv.style.width=c+"px",this._highlightDiv.style.top=Math.round(d*f)+"px",this._highlightDiv.style.height=Math.round(k*f)+"px"):(this._highlightDiv.style.top=a+"px",this._highlightDiv.style.height=c+"px",this._highlightDiv.style.left=Math.round(d*f)+"px",this._highlightDiv.style.width=Math.round(k*f)+"px")}};
...
Timeline.DefaultEventSource.prototype.loadXML=function(a,b){b=this._getBaseURL(b);var c=a.documentElement.getAttribute("wiki-url"),d=a.documentElement.getAttribute("wiki-section"),e=a.documentElement.getAttribute("date-time-format");e=this._events.getUnit().getParser(e);a=a.documentElement.firstChild;for(var f=!1;null!=a;){if(1==a.nodeType){f="";null!=a.firstChild&&3==a.firstChild.nodeType&&(f=a.firstChild.nodeValue);var g=null===a.getAttribute("isDuration")&&null===a.getAttribute("durationEvent")||
"false"==a.getAttribute("isDuration")||"false"==a.getAttribute("durationEvent");f=new Timeline.DefaultEventSource.Event({id:a.getAttribute("id"),start:e(a.getAttribute("start")),end:e(a.getAttribute("end")),latestStart:e(a.getAttribute("latestStart")),earliestEnd:e(a.getAttribute("earliestEnd")),instant:g,text:a.getAttribute("title"),description:f,image:this._resolveRelativeURL(a.getAttribute("image"),b),link:this._resolveRelativeURL(a.getAttribute("link"),b),icon:this._resolveRelativeURL(a.getAttribute("icon"),
b),color:a.getAttribute("color"),textColor:a.getAttribute("textColor"),hoverText:a.getAttribute("hoverText"),classname:a.getAttribute("classname"),tapeImage:a.getAttribute("tapeImage"),tapeRepeat:a.getAttribute("tapeRepeat"),caption:a.getAttribute("caption"),eventID:a.getAttribute("eventID"),trackNum:a.getAttribute("trackNum")});f._node=a;f.getProperty=function(a){return this._node.getAttribute(a)};f.setWikiInfo(c,d);this._events.add(f);f=!0}a=a.nextSibling}f&&this._fire("onAddMany",[])};
Timeline.DefaultEventSource.prototype.loadJSON=function(a,b){b=this._getBaseURL(b);var c=!1;if(a&&a.events){var d="wikiURL"in a?a.wikiURL:null,e="wikiSection"in a?a.wikiSection:null,f="dateTimeFormat"in a?a.dateTimeFormat:null;f=this._events.getUnit().getParser(f);for(var g=0;g<a.events.length;g++){c=a.events[g];var h=c.isDuration||"durationEvent"in c&&!c.durationEvent||"de"in c&&!c.de;h=new Timeline.DefaultEventSource.Event({id:"id"in c?c.id:void 0,start:f(c.start||c.s),end:f(c.end||c.e),latestStart:f(c.latestStart||
c.ls),earliestEnd:f(c.earliestEnd||c.ee),instant:h,text:c.title||c.t,description:c.description||c.d,image:this._resolveRelativeURL(c.image,b),link:this._resolveRelativeURL(c.link,b),icon:this._resolveRelativeURL(c.icon,b),color:c.color,textColor:c.textColor,hoverText:c.hoverText,classname:c.classname||c.c,tapeImage:c.tapeImage,tapeRepeat:c.tapeRepeat,caption:c.caption,eventID:c.eventID||c.eid,trackNum:c.trackNum});h._obj=c;h.getProperty=function(a){return this._obj[a]};h.setWikiInfo(d,e);this._events.add(h);
c=!0}}c&&this._fire("onAddMany",[])};
Timeline.DefaultEventSource.prototype.loadSPARQL=function(a,b){b=this._getBaseURL(b);var c=this._events.getUnit().getParser("iso8601");if(null!=a){for(a=a.documentElement.firstChild;null!=a&&(1!=a.nodeType||"results"!=a.nodeName);)a=a.nextSibling;var d=null,e=null;null!=a&&(d=a.getAttribute("wiki-url"),e=a.getAttribute("wiki-section"),a=a.firstChild);for(var f=!1;null!=a;){if(1==a.nodeType){f={};for(var g=a.firstChild;null!=g;)1==g.nodeType&&null!=g.firstChild&&1==g.firstChild.nodeType&&null!=g.firstChild.firstChild&&
3==g.firstChild.firstChild.nodeType&&(f[g.getAttribute("name")]=g.firstChild.firstChild.nodeValue),g=g.nextSibling;null==f.start&&null!=f.date&&(f.start=f.date);g=null===f.isDuration&&null===f.durationEvent||"false"==f.isDuration||"false"==f.durationEvent;g=new Timeline.DefaultEventSource.Event({id:f.id,start:c(f.start),end:c(f.end),latestStart:c(f.latestStart),earliestEnd:c(f.earliestEnd),instant:g,text:f.title,description:f.description,image:this._resolveRelativeURL(f.image,b),link:this._resolveRelativeURL(f.link,
b),icon:this._resolveRelativeURL(f.icon,b),color:f.color,textColor:f.textColor,hoverText:f.hoverText,caption:f.caption,classname:f.classname,tapeImage:f.tapeImage,tapeRepeat:f.tapeRepeat,eventID:f.eventID,trackNum:f.trackNum});g._bindings=f;g.getProperty=function(a){return this._bindings[a]};g.setWikiInfo(d,e);this._events.add(g);f=!0}a=a.nextSibling}f&&this._fire("onAddMany",[])}};Timeline.DefaultEventSource.prototype.add=function(a){this._events.add(a);this._fire("onAddOne",[a])};
...
Timeline.DefaultEventSource.prototype._fire=function(a,b){for(var c=0;c<this._listeners.length;c++){var d=this._listeners[c];if(a in d)try{d[a].apply(d,b)}catch(e){SimileAjax.Debug.exception(e)}}};Timeline.DefaultEventSource.prototype._getBaseURL=function(a){if(0>a.indexOf("://")){var b=this._getBaseURL(document.location.href);a="/"==a.substr(0,1)?b.substr(0,b.indexOf("/",b.indexOf("://")+3))+a:b+a}b=a.lastIndexOf("/");return 0>b?"":a.substr(0,b+1)};
...
Timeline.OriginalEventPainter.prototype.paintPreciseInstantEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart();f=Math.round(this._band.dateToPixelOffset(f));var g=Math.round(f+b.iconWidth/2);f=Math.round(f-b.iconWidth/2);var h=this._getLabelDivClassName(a),k=this._frc.computeSize(e,h),l=g+c.event.label.offsetFromLine;g=this._findFreeTrack(a,l+k.width);var m=Math.round(b.trackOffset+g*b.trackIncrement+b.trackHeight/2-k.height/2),p=this._paintEventIcon(a,g,f,b,c,0);
e=this._paintEventLabel(a,e,l,m,k.width,k.height,c,h,d);b=[p.elmt,e.elmt];var q=this;h=function(b,c,d){return q._onClickInstantEvent(p.elmt,c,a)};SimileAjax.DOM.registerEvent(p.elmt,"mousedown",h);SimileAjax.DOM.registerEvent(e.elmt,"mousedown",h);c=this._createHighlightDiv(d,p,c,a);null!=c&&b.push(c);this._fireEventPaintListeners("paintedEvent",a,b);this._eventIdToElmt[a.getID()]=p.elmt;this._tracks[g]=f};
Timeline.OriginalEventPainter.prototype.paintImpreciseInstantEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getEnd(),h=Math.round(this._band.dateToPixelOffset(f)),k=Math.round(this._band.dateToPixelOffset(g));f=Math.round(h+b.iconWidth/2);g=Math.round(h-b.iconWidth/2);var l=this._getLabelDivClassName(a),m=this._frc.computeSize(e,l),p=f+c.event.label.offsetFromLine;f=this._findFreeTrack(a,Math.max(p+m.width,k));var q=c.event.tape.height,u=Math.round(b.trackOffset+
f*b.trackIncrement+q),r=this._paintEventIcon(a,f,g,b,c,q);e=this._paintEventLabel(a,e,p,u,m.width,m.height,c,l,d);l=a.getColor();l=null!=l?l:c.event.instant.impreciseColor;h=this._paintEventTape(a,f,h,k,l,c.event.instant.impreciseOpacity,b,c,0);b=[r.elmt,e.elmt,h.elmt];var t=this;k=function(b,c,d){return t._onClickInstantEvent(r.elmt,c,a)};SimileAjax.DOM.registerEvent(r.elmt,"mousedown",k);SimileAjax.DOM.registerEvent(h.elmt,"mousedown",k);SimileAjax.DOM.registerEvent(e.elmt,"mousedown",k);c=this._createHighlightDiv(d,
r,c,a);null!=c&&b.push(c);this._fireEventPaintListeners("paintedEvent",a,b);this._eventIdToElmt[a.getID()]=r.elmt;this._tracks[f]=g};
Timeline.OriginalEventPainter.prototype.paintPreciseDurationEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getEnd();f=Math.round(this._band.dateToPixelOffset(f));var h=Math.round(this._band.dateToPixelOffset(g)),k=this._getLabelDivClassName(a),l=this._frc.computeSize(e,k);g=this._findFreeTrack(a,Math.max(f+l.width,h));var m=Math.round(b.trackOffset+g*b.trackIncrement+c.event.tape.height),p=a.getColor();p=null!=p?p:c.event.duration.color;var q=this._paintEventTape(a,
g,f,h,p,100,b,c,0);e=this._paintEventLabel(a,e,f,m,l.width,l.height,c,k,d);b=[q.elmt,e.elmt];var u=this;h=function(b,c,d){return u._onClickDurationEvent(q.elmt,c,a)};SimileAjax.DOM.registerEvent(q.elmt,"mousedown",h);SimileAjax.DOM.registerEvent(e.elmt,"mousedown",h);c=this._createHighlightDiv(d,q,c,a);null!=c&&b.push(c);this._fireEventPaintListeners("paintedEvent",a,b);this._eventIdToElmt[a.getID()]=q.elmt;this._tracks[g]=f};
Timeline.OriginalEventPainter.prototype.paintImpreciseDurationEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getLatestStart(),h=a.getEnd(),k=a.getEarliestEnd();f=Math.round(this._band.dateToPixelOffset(f));g=Math.round(this._band.dateToPixelOffset(g));h=Math.round(this._band.dateToPixelOffset(h));var l=Math.round(this._band.dateToPixelOffset(k)),m=this._getLabelDivClassName(a),p=this._frc.computeSize(e,m);k=this._findFreeTrack(a,Math.max(g+p.width,h));var q=
Math.round(b.trackOffset+k*b.trackIncrement+c.event.tape.height),u=a.getColor();u=null!=u?u:c.event.duration.color;h=this._paintEventTape(a,k,f,h,c.event.duration.impreciseColor,c.event.duration.impreciseOpacity,b,c,0);var r=this._paintEventTape(a,k,g,l,u,100,b,c,1);b=this._paintEventLabel(a,e,g,q,p.width,p.height,c,m,d);e=[h.elmt,r.elmt,b.elmt];var t=this;g=function(b,c,d){return t._onClickDurationEvent(r.elmt,c,a)};SimileAjax.DOM.registerEvent(r.elmt,"mousedown",g);SimileAjax.DOM.registerEvent(b.elmt,
"mousedown",g);c=this._createHighlightDiv(d,r,c,a);null!=c&&e.push(c);this._fireEventPaintListeners("paintedEvent",a,e);this._eventIdToElmt[a.getID()]=r.elmt;this._tracks[k]=f};Timeline.OriginalEventPainter.prototype._encodeEventElID=function(a,b){return Timeline.EventUtils.encodeEventElID(this._timeline,this._band,a,b)};Timeline.OriginalEventPainter.prototype._findFreeTrack=function(a,b){a=a.getTrackNum();if(null!=a)return a;for(a=0;a<this._tracks.length&&!(this._tracks[a]>b);a++);return a};
Timeline.OriginalEventPainter.prototype._paintEventIcon=function(a,b,c,d,e,f){e=a.getIcon();e=null!=e?e:d.icon;b=0<f?d.trackOffset+b*d.trackIncrement+f+d.impreciseIconMargin:Math.round(d.trackOffset+b*d.trackIncrement+d.trackHeight/2-d.iconHeight/2);f=SimileAjax.Graphics.createTranslucentImage(e);e=this._timeline.getDocument().createElement("div");e.className=this._getElClassName("timeline-event-icon",a,"icon");e.id=this._encodeEventElID("icon",a);e.style.left=c+"px";e.style.top=b+"px";e.appendChild(f);
...
Timeline.OriginalEventPainter.prototype._paintEventLabel=function(a,b,c,d,e,f,g,h,k){var l=this._timeline.getDocument().createElement("div");l.className=h;l.id=this._encodeEventElID("label",a);l.style.left=c+"px";l.style.width=e+"px";l.style.top=d+"px";l.innerHTML=b;null!=a._title&&(l.title=a._title);b=a.getTextColor();null==b&&(b=a.getColor());null!=b&&(l.style.color=b);g.event.highlightLabelBackground&&0<=k&&(l.style.background=this._getHighlightColor(k,g));this._eventLayer.appendChild(l);return{left:c,
top:d,width:e,height:f,elmt:l}};
Timeline.OriginalEventPainter.prototype._paintEventTape=function(a,b,c,d,e,f,g,h,k){d-=c;h=h.event.tape.height;b=g.trackOffset+b*g.trackIncrement;g=this._timeline.getDocument().createElement("div");g.className=this._getElClassName("timeline-event-tape",a,"tape");g.id=this._encodeEventElID("tape"+k,a);g.style.left=c+"px";g.style.width=d+"px";g.style.height=h+"px";g.style.top=b+"px";null!=a._title&&(g.title=a._title);null!=e&&(g.style.backgroundColor=e);e=a.getTapeImage();a=a.getTapeRepeat();a=null!=
a?a:"repeat";null!=e&&(g.style.backgroundImage="url("+e+")",g.style.backgroundRepeat=a);SimileAjax.Graphics.setOpacity(g,f);this._eventLayer.appendChild(g);return{left:c,top:b,width:d,height:h,elmt:g}};Timeline.OriginalEventPainter.prototype._getLabelDivClassName=function(a){return this._getElClassName("timeline-event-label",a,"label")};Timeline.OriginalEventPainter.prototype._getElClassName=function(a,b,c){b=b.getClassName();var d=[];b&&(c&&d.push(c+"-"+b+" "),d.push(b+" "));d.push(a);return d.join("")};
...
Timeline.DetailedEventPainter.prototype.paintPreciseInstantEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=Math.round(this._band.dateToPixelOffset(f)),h=Math.round(g+b.iconWidth/2);f=Math.round(g-b.iconWidth/2);var k=this._frc.computeSize(e),l=this._findFreeTrackForSolid(h,g),m=this._paintEventIcon(a,l,f,b,c);h+=c.event.label.offsetFromLine;var p=l,q=this._getTrackData(l);Math.min(q.solid,q.text)>=h+k.width?(q.solid=f,q.text=h):(q.solid=f,h=g+c.event.label.offsetFromLine,
p=this._findFreeTrackForText(l,h+k.width,function(a){a.line=g-2}),this._getTrackData(p).text=f,this._paintEventLine(a,g,l,p,b,c));b=this._paintEventLabel(a,e,h,Math.round(b.trackOffset+p*b.trackIncrement+b.trackHeight/2-k.height/2),k.width,k.height,c);var u=this;e=function(b,c,d){return u._onClickInstantEvent(m.elmt,c,a)};SimileAjax.DOM.registerEvent(m.elmt,"mousedown",e);SimileAjax.DOM.registerEvent(b.elmt,"mousedown",e);this._createHighlightDiv(d,m,c);this._eventIdToElmt[a.getID()]=m.elmt};
Timeline.DetailedEventPainter.prototype.paintImpreciseInstantEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getEnd(),h=Math.round(this._band.dateToPixelOffset(f)),k=Math.round(this._band.dateToPixelOffset(g)),l=Math.round(h+b.iconWidth/2);g=Math.round(h-b.iconWidth/2);var m=this._frc.computeSize(e),p=this._findFreeTrackForSolid(k,h);f=this._paintEventTape(a,p,h,k,c.event.instant.impreciseColor,c.event.instant.impreciseOpacity,b,c);var q=this._paintEventIcon(a,
p,g,b,c);this._getTrackData(p).solid=g;l+=c.event.label.offsetFromLine;var u=l+m.width;u<k?k=p:(l=h+c.event.label.offsetFromLine,u=l+m.width,k=this._findFreeTrackForText(p,u,function(a){a.line=h-2}),this._getTrackData(k).text=g,this._paintEventLine(a,h,p,k,b,c));b=this._paintEventLabel(a,e,l,Math.round(b.trackOffset+k*b.trackIncrement+b.trackHeight/2-m.height/2),m.width,m.height,c);var r=this;e=function(b,c,d){return r._onClickInstantEvent(q.elmt,c,a)};SimileAjax.DOM.registerEvent(q.elmt,"mousedown",
e);SimileAjax.DOM.registerEvent(f.elmt,"mousedown",e);SimileAjax.DOM.registerEvent(b.elmt,"mousedown",e);this._createHighlightDiv(d,q,c);this._eventIdToElmt[a.getID()]=q.elmt};
Timeline.DetailedEventPainter.prototype.paintPreciseDurationEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getEnd(),h=Math.round(this._band.dateToPixelOffset(f)),k=Math.round(this._band.dateToPixelOffset(g));f=this._frc.computeSize(e);g=this._findFreeTrackForSolid(k);var l=a.getColor();l=null!=l?l:c.event.duration.color;var m=this._paintEventTape(a,g,h,k,l,100,b,c);this._getTrackData(g).solid=h;k=h+c.event.label.offsetFromLine;l=this._findFreeTrackForText(g,
k+f.width,function(a){a.line=h-2});this._getTrackData(l).text=h-2;this._paintEventLine(a,h,g,l,b,c);b=this._paintEventLabel(a,e,k,Math.round(b.trackOffset+l*b.trackIncrement+b.trackHeight/2-f.height/2),f.width,f.height,c);var p=this;e=function(b,c,d){return p._onClickDurationEvent(m.elmt,c,a)};SimileAjax.DOM.registerEvent(m.elmt,"mousedown",e);SimileAjax.DOM.registerEvent(b.elmt,"mousedown",e);this._createHighlightDiv(d,m,c);this._eventIdToElmt[a.getID()]=m.elmt};
Timeline.DetailedEventPainter.prototype.paintImpreciseDurationEvent=function(a,b,c,d){this._timeline.getDocument();var e=a.getText(),f=a.getStart(),g=a.getLatestStart(),h=a.getEnd(),k=a.getEarliestEnd();f=Math.round(this._band.dateToPixelOffset(f));var l=Math.round(this._band.dateToPixelOffset(g));h=Math.round(this._band.dateToPixelOffset(h));var m=Math.round(this._band.dateToPixelOffset(k));k=this._frc.computeSize(e);g=this._findFreeTrackForSolid(h);var p=a.getColor();p=null!=p?p:c.event.duration.color;
this._paintEventTape(a,g,f,h,c.event.duration.impreciseColor,c.event.duration.impreciseOpacity,b,c);var q=this._paintEventTape(a,g,l,m,p,100,b,c);this._getTrackData(g).solid=f;f=l+c.event.label.offsetFromLine;h=this._findFreeTrackForText(g,f+k.width,function(a){a.line=l-2});this._getTrackData(h).text=l-2;this._paintEventLine(a,l,g,h,b,c);b=this._paintEventLabel(a,e,f,Math.round(b.trackOffset+h*b.trackIncrement+b.trackHeight/2-k.height/2),k.width,k.height,c);var u=this;e=function(b,c,d){return u._onClickDurationEvent(q.elmt,
c,a)};SimileAjax.DOM.registerEvent(q.elmt,"mousedown",e);SimileAjax.DOM.registerEvent(b.elmt,"mousedown",e);this._createHighlightDiv(d,q,c);this._eventIdToElmt[a.getID()]=q.elmt};
...
Timeline.DetailedEventPainter.prototype._paintEventLine=function(a,b,c,d,e,f){a=Math.round(e.trackOffset+c*e.trackIncrement+e.trackHeight/2);e=Math.round(Math.abs(d-c)*e.trackIncrement);var g="1px solid "+f.event.label.lineColor,h=this._timeline.getDocument().createElement("div");h.style.position="absolute";h.style.left=b+"px";h.style.width=f.event.label.offsetFromLine+"px";h.style.height=e+"px";c>d?(h.style.top=a-e+"px",h.style.borderTop=g):(h.style.top=a+"px",h.style.borderBottom=g);h.style.borderLeft=
g;this._lineLayer.appendChild(h)};
Timeline.DetailedEventPainter.prototype._paintEventIcon=function(a,b,c,d,e){e=a.getIcon();e=null!=e?e:d.icon;b=Math.round(d.trackOffset+b*d.trackIncrement+d.trackHeight/2-d.iconHeight/2);e=SimileAjax.Graphics.createTranslucentImage(e);var f=this._timeline.getDocument().createElement("div");f.style.position="absolute";f.style.left=c+"px";f.style.top=b+"px";f.appendChild(e);f.style.cursor="pointer";null!=a._title&&(f.title=a._title);this._eventLayer.appendChild(f);return{left:c,top:b,width:d.iconWidth,
height:d.iconHeight,elmt:f}};
Timeline.DetailedEventPainter.prototype._paintEventLabel=function(a,b,c,d,e,f,g){var h=this._timeline.getDocument(),k=h.createElement("div");k.style.position="absolute";k.style.left=c+"px";k.style.width=e+"px";k.style.top=d+"px";k.style.height=f+"px";k.style.backgroundColor=g.event.label.backgroundColor;SimileAjax.Graphics.setOpacity(k,g.event.label.backgroundOpacity);this._eventLayer.appendChild(k);g=h.createElement("div");g.style.position="absolute";g.style.left=c+"px";g.style.width=e+"px";g.style.top=
d+"px";g.innerHTML=b;g.style.cursor="pointer";null!=a._title&&(g.title=a._title);b=a.getTextColor();null==b&&(b=a.getColor());null!=b&&(g.style.color=b);this._eventLayer.appendChild(g);return{left:c,top:d,width:e,height:f,elmt:g}};
Timeline.DetailedEventPainter.prototype._paintEventTape=function(a,b,c,d,e,f,g,h){d-=c;h=h.event.tape.height;b=Math.round(g.trackOffset+b*g.trackIncrement+g.trackHeight/2-h/2);g=this._timeline.getDocument().createElement("div");g.style.position="absolute";g.style.left=c+"px";g.style.width=d+"px";g.style.top=b+"px";g.style.height=h+"px";g.style.backgroundColor=e;g.style.overflow="hidden";g.style.cursor="pointer";null!=a._title&&(g.title=a._title);SimileAjax.Graphics.setOpacity(g,f);this._eventLayer.appendChild(g);
...
Timeline.OverviewEventPainter.prototype.paint=function(){var a=this._band.getEventSource();if(null!=a){this._prepareForPainting();var b=this._params.theme.event;b={trackOffset:b.overviewTrack.offset,trackHeight:b.overviewTrack.height,trackGap:b.overviewTrack.gap,trackIncrement:b.overviewTrack.height+b.overviewTrack.gap};var c=this._band.getMinDate(),d=this._band.getMaxDate(),e=null!=this._filterMatcher?this._filterMatcher:function(a){return!0},f=null!=this._highlightMatcher?this._highlightMatcher:
function(a){return-1};for(a=a.getEventReverseIterator(c,d);a.hasNext();)c=a.next(),e(c)&&this.paintEvent(c,b,this._params.theme,f(c));this._highlightLayer.style.display="block";this._eventLayer.style.display="block";this._band.updateEventTrackInfo(this._tracks.length,b.trackIncrement)}};Timeline.OverviewEventPainter.prototype.softPaint=function(){};
...
Timeline.OverviewEventPainter.prototype.paintEvent=function(a,b,c,d){a.isInstant()?this.paintInstantEvent(a,b,c,d):this.paintDurationEvent(a,b,c,d)};Timeline.OverviewEventPainter.prototype.paintInstantEvent=function(a,b,c,d){var e=a.getStart();e=Math.round(this._band.dateToPixelOffset(e));var f=a.getColor();f=a.getClassName()?null:null!=f?f:c.event.duration.color;a=this._paintEventTick(a,e,f,100,b,c);this._createHighlightDiv(d,a,c)};
Timeline.OverviewEventPainter.prototype.paintDurationEvent=function(a,b,c,d){var e=a.getLatestStart(),f=a.getEarliestEnd();e=Math.round(this._band.dateToPixelOffset(e));f=Math.round(this._band.dateToPixelOffset(f));for(var g=0;g<this._tracks.length&&!(f<this._tracks[g]);g++);this._tracks[g]=f;var h=a.getColor(),k=a.getClassName();h=k?null:null!=h?h:c.event.duration.color;a=this._paintEventTape(a,g,e,f,h,100,b,c,k);this._createHighlightDiv(d,a,c)};
Timeline.OverviewEventPainter.prototype._paintEventTape=function(a,b,c,d,e,f,g,h,k){a=g.trackOffset+b*g.trackIncrement;d-=c;g=g.trackHeight;b=this._timeline.getDocument().createElement("div");b.className="timeline-small-event-tape";k&&(b.className+=" small-"+k);b.style.left=c+"px";b.style.width=d+"px";b.style.top=a+"px";b.style.height=g+"px";e&&(b.style.backgroundColor=e);100>f&&SimileAjax.Graphics.setOpacity(b,f);this._eventLayer.appendChild(b);return{left:c,top:a,width:d,height:g,elmt:b}};
Timeline.OverviewEventPainter.prototype._paintEventTick=function(a,b,c,d,e,f){c=f.event.overviewTrack.tickHeight;e=e.trackOffset-c;f=this._timeline.getDocument().createElement("div");f.className="timeline-small-event-icon";f.style.left=b+"px";f.style.top=e+"px";if(a=a.getClassName())f.className+=" small-"+a;100>d&&SimileAjax.Graphics.setOpacity(f,d);this._eventLayer.appendChild(f);return{left:b,top:e,width:1,height:c,elmt:f}};
...
Timeline.CompactEventPainter.prototype.paint=function(){var a=this._band.getEventSource();if(null!=a){this._eventIdToElmt={};this._prepareForPainting();var b=this._computeMetrics(),c=this._band.getMinDate(),d=this._band.getMaxDate(),e=null!=this._filterMatcher?this._filterMatcher:function(a){return!0},f=null!=this._highlightMatcher?this._highlightMatcher:function(a){return-1};d=a.getEventIterator(c,d);a="stackConcurrentPreciseInstantEvents"in this._params&&"object"==typeof this._params.stackConcurrentPreciseInstantEvents;
if("collapseConcurrentPreciseInstantEvents"in this._params&&this._params.collapseConcurrentPreciseInstantEvents||a){c=[];for(var g=null;d.hasNext();){var h=d.next();e(h)&&(!h.isInstant()||h.isImprecise()?this.paintEvent(h,b,this._params.theme,f(h)):null!=g&&g.getStart().getTime()==h.getStart().getTime()?c[c.length-1].push(h):(c.push([h]),g=h))}for(e=0;e<c.length;e++)if(d=c[e],1==d.length)this.paintEvent(d[0],b,this._params.theme,f(h));else{g=-1;for(var k=0;0>g&&k<d.length;k++)g=f(d[k]);a?this.paintStackedPreciseInstantEvents(d,
b,this._params.theme,g):this.paintCompositePreciseInstantEvents(d,b,this._params.theme,g)}}else for(;d.hasNext();)h=d.next(),e(h)&&this.paintEvent(h,b,this._params.theme,f(h));this._highlightLayer.style.display="block";this._lineLayer.style.display="block";this._eventLayer.style.display="block";this._setOrthogonalOffset(b)}};Timeline.CompactEventPainter.prototype.softPaint=function(){this._setOrthogonalOffset(this._computeMetrics())};
...
Timeline.CompactEventPainter.prototype.paintPreciseInstantEvent=function(a,b,c,d){var e={tooltip:a.getProperty("tooltip")||a.getText()},f={url:a.getIcon()};null==f.url?(f.url=b.defaultIcon,f.width=b.defaultIconWidth,f.height=b.defaultIconHeight,f.className="timeline-event-icon-default"):(f.width=a.getProperty("iconWidth")||b.customIconWidth,f.height=a.getProperty("iconHeight")||b.customIconHeight);var g={text:a.getText(),color:a.getTextColor()||a.getColor(),className:a.getClassName()},h=this.paintTapeIconLabel(a.getStart(),
e,null,f,g,b,c,d),k=this;b=function(b,c,d){return k._onClickInstantEvent(h.iconElmtData.elmt,c,a)};SimileAjax.DOM.registerEvent(h.iconElmtData.elmt,"mousedown",b);SimileAjax.DOM.registerEvent(h.labelElmtData.elmt,"mousedown",b);this._eventIdToElmt[a.getID()]=h.iconElmtData.elmt};
Timeline.CompactEventPainter.prototype.paintCompositePreciseInstantEvents=function(a,b,c,d){for(var e=a[0],f=[],g=0;g<a.length;g++)f.push(a[g].getProperty("tooltip")||a[g].getText());f={tooltip:f.join("; ")};g={url:b.compositeIcon,width:b.compositeIconWidth,height:b.compositeIconHeight,className:"timeline-event-icon-composite"};var h={text:String.substitute(this._params.compositeEventLabelTemplate,[a.length])},k=this.paintTapeIconLabel(e.getStart(),f,null,g,h,b,c,d),l=this;b=function(b,c,d){return l._onClickMultiplePreciseInstantEvent(k.iconElmtData.elmt,
c,a)};SimileAjax.DOM.registerEvent(k.iconElmtData.elmt,"mousedown",b);SimileAjax.DOM.registerEvent(k.labelElmtData.elmt,"mousedown",b);for(g=0;g<a.length;g++)this._eventIdToElmt[a[g].getID()]=k.iconElmtData.elmt};
Timeline.CompactEventPainter.prototype.paintStackedPreciseInstantEvents=function(a,b,c,d){d="limit"in this._params.stackConcurrentPreciseInstantEvents?this._params.stackConcurrentPreciseInstantEvents.limit:10;var e="moreMessageTemplate"in this._params.stackConcurrentPreciseInstantEvents?this._params.stackConcurrentPreciseInstantEvents.moreMessageTemplate:"%0 More Events",f=d<=a.length-2,g=this._band,h=function(a){var c={url:a.getIcon()};null==c.url?(c.url=b.defaultStackIcon,c.width=b.defaultStackIconWidth,
c.height=b.defaultStackIconHeight,c.className="timeline-event-icon-stack timeline-event-icon-default"):(c.width=a.getProperty("iconWidth")||b.customIconWidth,c.height=a.getProperty("iconHeight")||b.customIconHeight,c.className="timeline-event-icon-stack");return c},k=h(a[0]),l=0,m=0,p=0,q=0,u=[],r=0;for(;r<a.length&&(!f||r<d);r++){var t=a[r],w=t.getText();t=h(t);var v=this._frc.computeSize(w);w={text:w,iconData:t,labelSize:v,iconLeft:k.width+5*r-t.width};w.labelLeft=k.width+5*r+b.iconLabelGap;w.top=
p;u.push(w);l=Math.min(l,w.iconLeft);p+=v.height;m=Math.max(m,w.labelLeft+v.width);q=Math.max(q,w.top+t.height)}if(f){var B=String.substitute(e,[a.length-d]),z=this._frc.computeSize(B),F=k.width+5*(d-1)+b.iconLabelGap,H=p;p+=z.height;m=Math.max(m,F+z.width)}m+=b.labelRightMargin;p+=b.labelBottomMargin;q+=b.iconBottomMargin;var A=Math.round(g.dateToPixelOffset(a[0].getStart()));e=[];g=Math.ceil(Math.max(q,p)/b.trackHeight);k=k.width+5*(a.length-1);for(r=0;r<g;r++)e.push({start:l,end:k});l=Math.ceil(p/
b.trackHeight);for(r=0;r<l;r++)p=e[r],p.end=Math.max(p.end,m);var C=this._fitTracks(A,e)*b.trackHeight+b.trackOffset,x=this._timeline.getDocument().createElement("div");x.className="timeline-event-icon-stack";x.style.position="absolute";x.style.overflow="visible";x.style.left=A+"px";x.style.top=C+"px";x.style.width=k+"px";x.style.height=q+"px";x.innerHTML="<div style='position: relative'></div>";this._eventLayer.appendChild(x);var y=this,G=function(a){try{var b=parseInt(this.getAttribute("index")),
c=x.firstChild.childNodes;for(a=0;a<c.length;a++)c[a].style.zIndex=a==b?c.length:c.length-a}catch(I){}};m=function(b){var d=u[b],f=a[b],e=f.getProperty("tooltip")||f.getText(),g=y._paintEventLabel({tooltip:e},{text:d.text},A+d.labelLeft,C+d.top,d.labelSize.width,d.labelSize.height,c);g.elmt.setAttribute("index",b);g.elmt.onmouseover=G;var h=SimileAjax.Graphics.createTranslucentImage(d.iconData.url);e=y._timeline.getDocument().createElement("div");e.className="timeline-event-icon"+("className"in d.iconData?
" "+d.iconData.className:"");e.style.left=d.iconLeft+"px";e.style.top=d.top+"px";e.style.zIndex=u.length-b;e.appendChild(h);e.setAttribute("index",b);e.onmouseover=G;x.firstChild.appendChild(e);b=function(a,b,c){return y._onClickInstantEvent(g.elmt,b,f)};SimileAjax.DOM.registerEvent(e,"mousedown",b);SimileAjax.DOM.registerEvent(g.elmt,"mousedown",b);y._eventIdToElmt[f.getID()]=e};for(r=0;r<u.length;r++)m(r);if(f){var D=a.slice(d),E=this._paintEventLabel({tooltip:B},{text:B},A+F,C+H,z.width,z.height,
c);SimileAjax.DOM.registerEvent(E.elmt,"mousedown",function(a,b,c){return y._onClickMultiplePreciseInstantEvent(E.elmt,b,D)});for(r=0;r<D.length;r++)this._eventIdToElmt[D[r].getID()]=E.elmt}};
...
className:a.getClassName()},k=this.paintTapeIconLabel(a.getStart(),e,f,g,h,b,c,d),l=this;b=null!=g?function(b,c,d){return l._onClickInstantEvent(k.iconElmtData.elmt,c,a)}:function(b,c,d){return l._onClickInstantEvent(k.labelElmtData.elmt,c,a)};SimileAjax.DOM.registerEvent(k.labelElmtData.elmt,"mousedown",b);SimileAjax.DOM.registerEvent(k.impreciseTapeElmtData.elmt,"mousedown",b);null!=g?(SimileAjax.DOM.registerEvent(k.iconElmtData.elmt,"mousedown",b),this._eventIdToElmt[a.getID()]=k.iconElmtData.elmt):
this._eventIdToElmt[a.getID()]=k.labelElmtData.elmt};
Timeline.CompactEventPainter.prototype.paintPreciseDurationEvent=function(a,b,c,d){var e={tooltip:a.getProperty("tooltip")||a.getText()},f={start:a.getStart(),end:a.getEnd(),color:a.getColor()||a.getTextColor(),isInstant:!1},g={url:a.getIcon()};null==g.url?g=null:(g.width=a.getProperty("iconWidth")||b.customIconWidth,g.height=a.getProperty("iconHeight")||b.customIconHeight);var h={text:a.getText(),color:a.getTextColor()||a.getColor(),className:a.getClassName()},k=this.paintTapeIconLabel(a.getLatestStart(),
e,f,g,h,b,c,d),l=this;b=null!=g?function(b,c,d){return l._onClickInstantEvent(k.iconElmtData.elmt,c,a)}:function(b,c,d){return l._onClickInstantEvent(k.labelElmtData.elmt,c,a)};SimileAjax.DOM.registerEvent(k.labelElmtData.elmt,"mousedown",b);SimileAjax.DOM.registerEvent(k.tapeElmtData.elmt,"mousedown",b);null!=g?(SimileAjax.DOM.registerEvent(k.iconElmtData.elmt,"mousedown",b),this._eventIdToElmt[a.getID()]=k.iconElmtData.elmt):this._eventIdToElmt[a.getID()]=k.labelElmtData.elmt};
...
this._eventIdToElmt[a.getID()]=k.labelElmtData.elmt};
Timeline.CompactEventPainter.prototype.paintTapeIconLabel=function(a,b,c,d,e,f,g,h){var k=this._band;h=function(a){return Math.round(k.dateToPixelOffset(a))};a=h(a);var l=[],m=0,p=0,q=0;if(null!=c){m=f.tapeHeight+f.tapeBottomMargin;p=Math.ceil(f.tapeHeight/f.trackHeight);for(var u=h(c.end)-a,r=h(c.start)-a,t=0;t<p;t++)l.push({start:r,end:u});q=f.trackHeight-m%f.tapeHeight}r=u=0;if(null!=d)for(("iconAlign"in d)&&"center"==d.iconAlign&&(u=-Math.floor(d.width/2)),r=u+d.width+f.iconLabelGap,0<p&&(l[p-
1].end=Math.max(l[p-1].end,r)),t=d.height+f.iconBottomMargin+q;0<t;)l.push({start:u,end:r}),t-=f.trackHeight;t=this._frc.computeSize(e.text);q=t.height+f.labelBottomMargin+q;var w=r+t.width+f.labelRightMargin;0<p&&(l[p-1].end=Math.max(l[p-1].end,w));for(var v=0;0<q;v++)p+v<l.length?l[p+v].end=w:l.push({start:0,end:w}),q-=f.trackHeight;l=this._fitTracks(a,l)*f.trackHeight+f.trackOffset;p={};p.labelElmtData=this._paintEventLabel(b,e,a+r,l+m,t.width,t.height,g);if(null!=c){if("latestStart"in c||"earliestEnd"in
c)p.impreciseTapeElmtData=this._paintEventTape(b,c,f.tapeHeight,l,h(c.start),h(c.end),g.event.duration.impreciseColor,g.event.duration.impreciseOpacity,f,g);!c.isInstant&&"start"in c&&"end"in c&&(p.tapeElmtData=this._paintEventTape(b,c,f.tapeHeight,l,a,h("earliestEnd"in c?c.earliestEnd:c.end),c.color,100,f,g))}null!=d&&(p.iconElmtData=this._paintEventIcon(b,d,l+m,a+u,f,g));return p};
...
Timeline.CompactEventPainter.prototype._paintEventIcon=function(a,b,c,d,e,f){f=SimileAjax.Graphics.createTranslucentImage(b.url);var g=this._timeline.getDocument().createElement("div");g.className="timeline-event-icon"+("className"in b?" "+b.className:"");g.style.left=d+"px";g.style.top=c+"px";g.appendChild(f);"tooltip"in a&&"string"==typeof a.tooltip&&(g.title=a.tooltip);this._eventLayer.appendChild(g);return{left:d,top:c,width:e.iconWidth,height:e.iconHeight,elmt:g}};
Timeline.CompactEventPainter.prototype._paintEventLabel=function(a,b,c,d,e,f,g){g=this._timeline.getDocument().createElement("div");g.className="timeline-event-label";g.style.left=c+"px";g.style.width=e+1+"px";g.style.top=d+"px";g.innerHTML=b.text;"tooltip"in a&&"string"==typeof a.tooltip&&(g.title=a.tooltip);"color"in b&&"string"==typeof b.color&&(g.style.color=b.color);"className"in b&&"string"==typeof b.className&&(g.className+=" "+b.className);this._eventLayer.appendChild(g);return{left:c,top:d,
width:e,height:f,elmt:g}};
Timeline.CompactEventPainter.prototype._paintEventTape=function(a,b,c,d,e,f,g,h,k,l){f-=e;k=this._timeline.getDocument().createElement("div");k.className="timeline-event-tape";k.style.left=e+"px";k.style.top=d+"px";k.style.width=f+"px";k.style.height=c+"px";"tooltip"in a&&"string"==typeof a.tooltip&&(k.title=a.tooltip);null!=g&&"string"==typeof b.color&&(k.style.backgroundColor=g);"backgroundImage"in b&&"string"==typeof b.backgroundImage&&(k.style.backgroundImage="url("+backgroundImage+")",k.style.backgroundRepeat=
"backgroundRepeat"in b&&"string"==typeof b.backgroundRepeat?b.backgroundRepeat:"repeat");SimileAjax.Graphics.setOpacity(k,h);"className"in b&&"string"==typeof b.className&&(k.className+=" "+b.className);this._eventLayer.appendChild(k);return{left:e,top:d,width:f,height:c,elmt:k}};
...
b=this._band.dateToPixelOffset(b);var c=this._timeline.getDocument(),d=function(){var a=c.createElement("table");a.insertRow(0).insertCell(0);return a},e=c.createElement("div");e.className="timeline-highlight-decorator";this._cssClass&&(e.className+=" "+this._cssClass);null!=this._color&&(e.style.backgroundColor=this._color);100>this._opacity&&SimileAjax.Graphics.setOpacity(e,this._opacity);this._layerDiv.appendChild(e);var f=d();f.className="timeline-highlight-label timeline-highlight-label-start";
var g=f.rows[0].cells[0];g.innerHTML=this._startLabel;this._cssClass&&(g.className="label_"+this._cssClass);this._layerDiv.appendChild(f);d=d();d.className="timeline-highlight-label timeline-highlight-label-end";g=d.rows[0].cells[0];g.innerHTML=this._endLabel;this._cssClass&&(g.className="label_"+this._cssClass);this._layerDiv.appendChild(d);this._timeline.isHorizontal()?(e.style.left=a+"px",e.style.width=b-a+"px",f.style.right=this._band.getTotalViewLength()-a+"px",f.style.width=this._startLabel.length+
"em",d.style.left=b+"px",d.style.width=this._endLabel.length+"em"):(e.style.top=a+"px",e.style.height=b-a+"px",f.style.bottom=a+"px",f.style.height="1.5px",d.style.top=b+"px",d.style.height="1.5px")}this._layerDiv.style.display="block"};Timeline.SpanHighlightDecorator.prototype.softPaint=function(){};
