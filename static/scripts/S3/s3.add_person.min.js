...
if(!f.attr("autocomplete")){var k=$(c),m=k.val(),g=m?{value:m,full_name:f.val(),gender:$(c+"_gender").val(),date_of_birth:$(c+"_date_of_birth").val(),occupation:$(c+"_occupation").val(),email:$(c+"_email").val(),mobile_phone:$(c+"_mobile_phone").val()}:{};k.data("existing",g);m=f.attr("data-c");$(c+"_full_name").after('<div id="'+b+'_throbber" class="throbber fright hide"></div>');var n=$(c+"_throbber"),l=S3.Ap.concat("/"+m+"/person/search_ac");f.autocomplete({delay:450,minLength:2,source:function(b,
