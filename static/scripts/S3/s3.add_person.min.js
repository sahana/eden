...
$(a+"_edit_bar .icon-remove").hide()):($(a+"_full_name").prop("disabled",!1).val(""),$(a+"_first_name").prop("disabled",!1).val(""),$(a+"_middle_name").prop("disabled",!1).val(""),$(a+"_last_name").prop("disabled",!1).val(""),r(b))});if(d){c='<div id="'+b+'_duplicates" class="req"></div>';k?$(a+"_box_bottom").before(c):$(a+"_box_bottom1").before(c);var C=$(a+"_duplicates");C.data("results",[]).click(function(){G(b)});$(a+"_full_name,"+a+"_first_name,"+a+"_middle_name,"+a+"_last_name,"+a+"_date_of_birth,"+
...
!1);r(b);var f=$(a),a=e.attr("data-f"),c=S3.Ap.concat("/"+c+"/"+a+"/"+d+"/lookup");$.getJSONS3(c,function(a){try{f.val(d);var c={value:d};if(fullname){var h=e.val();c.full_name=h}f.data("existing",c);I(a,b)}catch(l){f.val(""),r(b)}})},J=function(b,d){var a="#"+b,e=$(a+"_full_name");0==e.length?(fullname=!1,e=$(a+"_first_name"),e.prop("disabled",!1).val(""),void 0==e.attr("data-c")?(e=$(a+"_last_name"),e.prop("disabled",!1).val("")):$(a+"_last_name").prop("disabled",!1).val(""),$(a+"_middle_name").prop("disabled",
!1).val("")):(fullname=!0,e.prop("disabled",!1).val(""));r(b);var c=$(a),f=S3.Ap.concat("/org/site/"+d+"/site_contact_person");$.getJSONS3(f,function(d){try{var f=d.id;c.val(f);var h={value:f};if(fullname){var l=d.name;e.val(l);h.full_name=l}else{var m=d.first_name;$(a+"_first_name").val(m);h.first_name=m;var n=d.last_name;$(a+"_last_name").val(n);h.last_name=n;var p=$(a+"_middle_name");if(p.length){var q=d.middle_name;p.val(q);h.middle_name=q}}c.data("existing",h);I(d,b,f)}catch(t){c.val(""),fullname?
...
$.ajaxS3({url:a,data:b,type:"POST",dataType:"json",success:function(a){$(d+"_results").remove();if(a.length){var b=i18n.dupes_found.replace("_NUM_",a.length);$(d+"_duplicates").html(b+' <i class="icon-caret-down"> </i>').show().data("results",a)}else $(d+"_duplicates").data("results",[]).hide()}})}},G=function(b){var d="#"+b;if(!$(d+"_results").length){for(var a=$(d+"_duplicates"),e=a.data("results"),c,f,g,k='<div id="'+b+'_results">',h=e.length,l=0;l<h;l++)f=e[l],g=f.name,c='<div class="dl-item" data-id='+
