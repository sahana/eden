(function(c){c.extend(c.fn,{pstrength:function(a){a=c.extend({verdects:["Very Weak","Weak","Medium","Strong","Very Strong","Too Short","Unsafe Password Word!"],colors:["#f00","#c06","#f60","#3c0","#3f0","#ccc","#f00"],scores:[10,15,30,40],common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],minchar:6,minchar_label:"The minimum number of characters is "},a);return this.each(function(){var e=c(this).attr("id");if(options.minchar_label){c(this).after('<div class="pstrength-minchar" id="'+e+'_minchar">'+
