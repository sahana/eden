...
this.earth.getFeatures()}catch(c){return}for(var b=a.getFirstChild();null!=b;)a.removeChild(b),b=a.getFirstChild();this.layers.each(function(a){this.addLayer(a)},this)}},addLayer:function(a,c){var b=a.getLayer(),d=b&&b.url;if(this.earth&&b instanceof OpenLayers.Layer.WMS&&"string"==typeof d&&!1!==this.fireEvent("beforeadd",a)){var e=b.id;if(this.layerCache[e])d=this.layerCache[e];else{var f=this.earth.createLink("kl_"+e),d=d.replace(/\?.*/,""),g=b.params;f.setHref(d+("/kml?mode=refresh&layers="+g.LAYERS+
"&styles="+g.STYLES));d=this.earth.createNetworkLink("nl_"+e);d.setName(e);d.set(f,!1,!1);this.layerCache[e]=d}d.setVisibility(b.getVisibility());void 0!==c&&c<this.earth.getFeatures().getChildNodes().getLength()?this.earth.getFeatures().insertBefore(this.earth.getFeatures().getChildNodes().item(c)):this.earth.getFeatures().appendChild(d)}},setExtent:function(a){a=a.transform(this.map.getProjectionObject(),this.projection);var c=a.getCenterLonLat();a=this.getExtentWidth(a)/(2*Math.tan(this.HORIZONTAL_FIELD_OF_VIEW));
