...
function inTriangle(a,c,d,e){var f=areaOfTriangle(c,d,e);a=areaOfTriangle(a,c,d)+areaOfTriangle(a,c,e)+areaOfTriangle(a,d,e);return 0.001>Math.abs(f-a)?!0:!1}function inRectangle(a,c,d,e,f){return inTriangle(a,c,d,f)||inTriangle(a,e,d,f)}
...
(function(a){a="undefined"!==typeof exports?exports:a.SunCalc={};var c=Math,d=c.PI/180,e=c.sin,f=c.cos,q=357.5291*d,l=0.98560028*d,n=1.9148*d,g=0.02*d,s=3E-4*d,r=102.9372*d,x=23.45*d,E=280.16*d,F=360.9856235*d,y=[[-0.83,"sunrise","sunset"],[-0.3,"sunriseEnd","sunsetStart"],[-6,"dawn","dusk"],[-12,"nauticalDawn","nauticalDusk"],[-18,"nightEnd","night"],[6,"goldenHourEnd","goldenHour"]];a.addTime=function(a,c,d){y.push([a,c,d])};a.getTimes=function(a,p,m){m=d*-m;p*=d;a=c.round(a.valueOf()/864E5-0.5+
2440588-2451545-9E-4-m/(2*c.PI));var h=2451545.0009+(0+m)/(2*c.PI)+a,k=q+l*(h-2451545),u=n*e(k)+g*e(2*k)+s*e(3*k),u=k+r+u+c.PI,A=c.asin(e(u)*e(x)),h=h+0.0053*e(k)+-0.0069*e(2*u),z={solarNoon:new Date(864E5*(h+0.5-2440588))},v,B,t,w,C,D;v=0;for(B=y.length;v<B;v+=1)t=y[v],w=t[0],C=t[1],t=t[2],w=2451545.0009+(c.acos((e(w*d)-e(p)*e(A))/(f(p)*f(A)))+m)/(2*c.PI)+a+0.0053*e(k)+-0.0069*e(2*u),D=h-(w-h),z[C]=new Date(864E5*(D+0.5-2440588)),z[t]=new Date(864E5*(w+0.5-2440588));return z};a.getPosition=function(a,
p,m){m=d*-m;p*=d;a=a.valueOf()/864E5-0.5+2440588;var h=q+l*(a-2451545),k=n*e(h)+g*e(2*h)+s*e(3*h),k=h+r+k+c.PI,h=c.asin(e(k)*e(x)),k=c.atan2(e(k)*f(x),f(k));m=E+F*(a-2451545)-m-k;return{azimuth:c.atan2(e(m),f(m)*e(p)-c.tan(h)*f(p)),altitude:c.asin(e(p)*e(h)+f(p)*f(h)*f(m))}}})(this);
