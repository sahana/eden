...
function GetWeatherText2(a){var c="";a.snow&&a.snow["3h"]&&(c="Snow ( "+a.snow["3h"]+"\u043c\u043c )");a.rain&&a.rain["3h"]&&(c="Rain:("+a.rain["3h"]+"\u043c\u043c)");return c}function GetWeatherIcon2(a,c){var d=new Date,e=SunCalc.getTimes(d,a.lat,a.lng),d=d>e.sunrise&&d<e.sunset?"d":"n",e=c.clouds.all,f="transparent";1>e&&0<=e&&(f="01");5>e&&1<=e&&(f="01");25>e&&5<=e&&(f="01");50>e&&25<=e&&(f="02");75>e&&50<=e&&(f="03");75<=e&&(f="04");c.rain&&c.rain["3h"]&&(f="09");return f+d+".png"}
function GetWeatherForecastBubleHtml(a,c,d){var e=new Date((new Date).getTime()-168E5),f=Math.round(10*a.main.temp)/10,q=Math.round(100*a.main.temp_min)/100,l=Math.round(100*a.main.temp_max)/100,n=new Date(1E3*a.dt),g=SunCalc.getTimes(n,a.coord.lat,a.coord.lon),g=a.dt>g.sunrise&&a.dt<g.sunset?"d":"n",t=GetWeatherText2(a),q='<p class="weather_title"><a style="weather_title_link" href="http://openweathermap.org/city/'+a.id+'">'+a.name+'</a></p><div style="float:left" ><div class="weather_block"><div class="cur_weather_block" title="'+
...
" m/s</div></div>";h_footer="</div>";h_body="";for(l=0;l<d&&!(e<new Date(1E3*c[l].dt));l++);for(g=l;g<d+l;g++){var r=new Date;SunCalc.getTimes(n,a.coord.lat,a.coord.lon);f=Math.round(c[g].main.temp);Math.round(100*c[g].main.temp_min);Math.round(100*c[g].main.temp_max);n=new Date(1E3*c[g].dt);e>n||(hr=n.getHours(),r=hr+":00",10>hr&&(r="0"+r),h_o='<div style="font-size:small;float:left;text-align:center;"><div title="'+WeekDayText.days[n.getDay()]+'">'+WeekDayText.days_small[n.getDay()]+'</div><div title="'+
n.toString()+'">'+r+'</div><img alt="'+GetWeatherText2(c[g])+'" src="http://openweathermap.org/img/w/'+GetWeatherIcon2(a,c[g])+'"/><div class="small_val" title="Temperature">'+f+'\u00b0</div><div class="small_val" title="\u0412\u0435\u0442\u0435\u0440">'+c[g].wind.speed+' m/s</div><div class="small_val_grey" title="\u0414\u0430\u0432\u043b\u0435\u043d\u0438\u0435">'+c[g].main.pressure+"</div></div>",h_body+=h_o)}return q+h_body+h_footer}
...
(function(a){a="undefined"!==typeof exports?exports:a.SunCalc={};var c=Math,d=c.PI/180,e=c.sin,f=c.cos,q=357.5291*d,l=.98560028*d,n=1.9148*d,g=.02*d,t=3E-4*d,r=102.9372*d,y=23.45*d,F=280.16*d,G=360.9856235*d,z=[[-.83,"sunrise","sunset"],[-.3,"sunriseEnd","sunsetStart"],[-6,"dawn","dusk"],[-12,"nauticalDawn","nauticalDusk"],[-18,"nightEnd","night"],[6,"goldenHourEnd","goldenHour"]];a.addTime=function(a,c,d){z.push([a,c,d])};a.getTimes=function(a,p,m){m=d*-m;p*=d;a=c.round(a.valueOf()/864E5-.5+2440588-
2451545-9E-4-m/(2*c.PI));var h=2451545.0009+(0+m)/(2*c.PI)+a,k=q+l*(h-2451545),v=n*e(k)+g*e(2*k)+t*e(3*k),v=k+r+v+c.PI,B=c.asin(e(v)*e(y)),h=h+.0053*e(k)+-.0069*e(2*v),A={solarNoon:new Date(864E5*(h+.5-2440588))},w,C,u,x,D,E;w=0;for(C=z.length;w<C;w+=1)u=z[w],x=u[0],D=u[1],u=u[2],x=2451545.0009+(c.acos((e(x*d)-e(p)*e(B))/(f(p)*f(B)))+m)/(2*c.PI)+a+.0053*e(k)+-.0069*e(2*v),E=h-(x-h),A[D]=new Date(864E5*(E+.5-2440588)),A[u]=new Date(864E5*(x+.5-2440588));return A};a.getPosition=function(a,p,m){m=d*
-m;p*=d;a=a.valueOf()/864E5-.5+2440588;var h=q+l*(a-2451545),k=n*e(h)+g*e(2*h)+t*e(3*h),k=h+r+k+c.PI,h=c.asin(e(k)*e(y)),k=c.atan2(e(k)*f(y),f(k));m=F+G*(a-2451545)-m-k;return{azimuth:c.atan2(e(m),f(m)*e(p)-c.tan(h)*f(p)),altitude:c.asin(e(p)*e(h)+f(p)*f(h)*f(m))}}})(this);
