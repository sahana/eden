...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         BR Assistance Status - CSV Import Stylesheet
         ...
         Default..............string..........is default status
                                              true|false
         Termination..........string..........terminates the measure
                                              true|false
         Default Termination..string..........is the default termination
                                              true|false
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="row">
        ...
        <resource name="br_assistance_status">
            ...
            <xsl:call-template name="Boolean">
                <xsl:with-param name="column">Termination</xsl:with-param>
                <xsl:with-param name="field">is_termination</xsl:with-param>
            </xsl:call-template>

            <xsl:call-template name="Boolean">
                <xsl:with-param name="column">Default Termination</xsl:with-param>
                <xsl:with-param name="field">is_default_termination</xsl:with-param>
            </xsl:call-template>
