...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         Vehicles - CSV Import Stylesheet

         CSV fields:
         Name............................vehicle_vehicle.name
         Type............................vehicle_vehicle.vehicle_type_id$code
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="/">
        <s3xml>
            ...
            <xsl:for-each select="//row[generate-id(.)=
                ...
                <xsl:call-template name="VehicleType"/>
            </xsl:for-each>
    ...
    <xsl:template match="row">
        ...
        <xsl:variable name="VehicleType" select="col[@field='Type']/text()"/>
        ...
        <resource name="asset_asset">
            ...
            <resource name="vehicle_vehicle">
                ...
                <!-- Type -->
                <reference field="vehicle_type_id" resource="vehicle_vehicle_type">
    ...
    <xsl:template name="VehicleType">
        ...
        <xsl:if test="$Type!=''">
            <resource name="vehicle_vehicle_type">
                ...
                <data field="code"><xsl:value-of select="$Type"/></data>
            </resource>
        </xsl:if>
    </xsl:template>
