...
<xsl:stylesheet version="1.0"
    ...
    <!-- **********************************************************************
         Reservoirs - CSV Import Stylesheet
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="row">
        ...
        <xsl:variable name="ReservoirName" select="col[@field='Name']/text()"/>
        <xsl:variable name="country">
        ...
        <xsl:if test="$wkt!='' or $addr_street!='' or $lat!=''">
            <!-- Specific Location -->
            <xsl:call-template name="Location"/>
        </xsl:if>

        <resource name="water_reservoir">
            <xsl:attribute name="tuid">
                <xsl:value-of select="$ReservoirName"/>
            </xsl:attribute>

            <!-- Link to Location -->
            <xsl:if test="$country!='' or $wkt!='' or $addr_street!='' or $lat!=''">
                <xsl:call-template name="LocationReference"/>
            </xsl:if>

            <!-- Reservoir data -->
            <data field="name"><xsl:value-of select="$ReservoirName"/></data>
    ...
    <xsl:template name="LocationReference">
        ...
        <xsl:choose>
            <xsl:when test="$wkt!='' or $addr_street!='' or $lat!=''">
                <!-- Specific Location -->
