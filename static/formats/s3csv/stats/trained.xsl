...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         Trained People - CSV Import Stylesheet

         CSV fields:
         Name.................................stats_trained.name
         Type.................................stats_trained.parameter_id
         Number...............................stats_trained.value
         Organisation.........................stats_trained.organisation_id
         ...
         Organisation Group...................stats_trained_group.group_id  
         ...
         Comments.............................stats_trained.comments
    ...
    <xsl:template match="row">
        ...
        <resource name="stats_trained">
            ...
            <xsl:if test="col[@field='Organisation']!=''">
                <reference field="organisation_id" resource="org_organisation">
                    <xsl:attribute name="tuid">
                        <xsl:value-of select="concat('Org:', col[@field='Organisation'])"/>
                    </xsl:attribute>
                </reference>
            </xsl:if>

            <xsl:if test="col[@field='Type']!=''">
                <reference field="parameter_id" resource="stats_trained_type">
                    <xsl:attribute name="tuid">
            ...
            <xsl:if test="col[@field='Organisation Group']!=''">
                <resource name="stats_trained_group">
