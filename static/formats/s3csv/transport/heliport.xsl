...
<xsl:stylesheet version="1.0"
    ...
    <!-- **********************************************************************
         Heliport - CSV Import Stylesheet

         CSV fields:
         Name....................transport_heliport.name
         ...
         Comments................transport_heliport.comments
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="row">
        ...
        <xsl:variable name="HeliportName" select=""/>
        <xsl:variable name="country">
        ...
        <xsl:if test="$addr_street!='' or $lat!=''">
            <!-- Specific Location -->
        ...
        <resource name="transport_heliport">
            ...
            <!-- Link to Location -->
            <xsl:if test="$country!='' or $addr_street!='' or $lat!=''">
    ...
    <xsl:template name="LocationReference">
        ...
        <xsl:choose>
            <xsl:when test="$addr_street!='' or $lat!=''">
                <!-- Specific Location -->
