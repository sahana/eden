...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         Religions - CSV Import Stylesheet

         CSV column...........Format..........Content

         Religion.................string..........Religion Name
         SubReligion..............string..........Sub Religion Name
         SubSubReligion... (indefinite depth)
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="row">
        <xsl:call-template name="ReligionHierarchy">
            <xsl:with-param name="Level">Religion</xsl:with-param>
    ...
    <xsl:template name="ReligionHierarchy">
        ...
        <xsl:if test="$Name!=''">
            ...
            <xsl:variable name="NextLevel">
                <xsl:choose>
                    <xsl:when test="$Level='Religion'">SubReligion</xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template name="Religion">
        ...
        <resource name="pr_religion">
            ...
            <xsl:attribute name="tuid">
                <xsl:value-of select="concat('RELIGION:', $Path)"/>
            </xsl:attribute>
            ...
            <xsl:if test="$ParentPath!=''">
                <reference field="parent" resource="pr_religion">
                    <xsl:attribute name="tuid">
                        <xsl:value-of select="concat('RELIGION:', $ParentPath)"/>
                    </xsl:attribute>
                </reference>
            </xsl:if>
