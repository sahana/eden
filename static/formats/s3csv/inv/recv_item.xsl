...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         ...
         CSV fields:
         destination............inv_recv.site_id -> org_office.name
         from_location..........inv_recv.from_site_id -> org_office.name
    ...
    *********************************************************************** -->
    ...
    <xsl:template match="/">
        <s3xml>
            ...
            <!-- ******************************************************************
                 Search for each source and create a unique org_office record
                 ****************************************************************** -->
            <xsl:for-each select="//row[generate-id(.)=
