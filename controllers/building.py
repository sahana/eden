...
table = db.define_table(tablename,
                        ...
                        Field("photo", "boolean", label=T("Photo Taken?")), represent = s3_yes_no_represent,
                        ...
                        Field("barricades", "boolean",
                              label=T("Barricades are needed")), represent = s3_yes_no_represent,
                        Field("barricades_details", "text",
                              label="(%s)" % T("state location")),
                        Field("detailed_evaluation", "boolean",
                              label=T("Level 2 or detailed engineering evaluation recommended")), represent = s3_yes_no_represent,
                        Field("detailed_structural", "boolean",
                              label=T("Structural")), represent = s3_yes_no_represent,
                        Field("detailed_geotechnical", "boolean",
                              label=T("Geotechnical")), represent = s3_yes_no_represent,
                        Field("detailed_other", "boolean", label=T("Other")), represent = s3_yes_no_represent,
