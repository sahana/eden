        ...
        if r.interactive:
            ...
            if output["form"] == None:
                ...
                redirect(URL(c="survey",
                             ...
                             args=[series_id,"read"],
                             vars = {}))
            # Because this is a bespoke form CRUD gets a little upset and
            # displays an error "Invalid form (re-opened in another window?)"
            # So so long as we don't have an error on the from we can
            # delete this error.
