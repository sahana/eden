...
class ProposalSetForm(ModelForm):
    ...
    """
    ProposalSetForm is a basic form autogenerated form from ProposalSet model. Returns\
    and empty form to create a new proposal set.
...
class ProposalForm(ModelForm):
    ...
    """
    ProposalForm is a basic form autogenerated form for Proposal model. Returns an \
    empty form for creating a new proposal.
