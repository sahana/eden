...
settings.base.prepopulate = ["CrisisMap"]
settings.base.system_name = T("Crisis Map Template- Sahana Eden ")
settings.base.system_name_short = T("Crisis Map Template")

# Theme (folder to use for views/layout.html)
settings.base.theme = "CrisisMap"
...
settings.frontpage.rss = [
    ...
    {"title": "International Crisis Group - Global  ",
     "url": "http://feeds.feedburner.com/crisisgroup-global"
    },
    {"title": "International Crisis Group - Asia ",
     "url": "http://www.crisisgroup.org/en/regions/asia/rss-asia.aspx"
    }
]
