    ...
    def hrm(self):
        ...
        return M()(
                    ...
                    M("Offices", c="org", f="office",
                      check=manager_mode)(
                        M("New Office", m="create"),
                        #M("List All"),
                        M("Import", m="import", p="create"),
                    ),
                    M("Department Catalog", c="hrm", f="department",
                      check=manager_mode)(
                        M("New Department", m="create"),
                        #M("List All"),
                    ),
