...
'Create Address': '주소 추가',
'Create Alternative Item': '대체 항목 추가',
...
'Create Contact Information': '문의처 정보 추가',
'Create Course': '과정 추가',
'Create Course Certificate': 'certicate 코스 추가',
'Create Credential': '권한 정보 추가',
...
'Create Item to Commitment': '때，확약 항목 추가',
'Add Item to Inventory': '재고 항목 추가',
'Add Item to Request': '항목 추가 요청',
'Create Item to Shipment': '운송 항목에 대한 추가',
...
'Add New': '새로 추가',
'Create Activity': '새 활동에 추가',
'Create Address': '새 주소 추가',
'Create Alternative Item': '새 대안 항목 추가',
'Add New Assessment': '새 평가 추가',
'Add New Assessment Summary': '새 평가 요약',
'Create Asset': '새 자산 추가',
'Add New Baseline': '새 기준선 추가',
'Add New Baseline Type': '새 기준선 유형 추가',
'Create Brand': '새 브랜드 추가',
...
'Create Resource': '새 자원 추가',
'Add New River': '새 river 추가',
'Create Role': '새 역할 추가',
'Add New Role to User': '새 역할에 사용자 추가',
'Create Room': '새 강의실 추가',
'Add New Scenario': '새 시나리오 추가',
'Create Sector': '새 섹터를 추가',
'Add New Sent Item': '새 보낸 항목 추가',
'Add New Setting': '새 설정 추가',
'Create Shelter': '새 shelter 추가',
'Create Shelter Service': 'shelter 새 서비스 추가',
'Create Shelter Type': '새 shelter 유형 추가',
'Create Skill': '새 항목 추가',
'Add New Solution': '새 솔루션 추가',
'Create Staff Member': '추가할 새 스태프 구성원',
...
'Create Task': '새 태스크 추가',
'Add New Team': '새 팀 추가',
'Create Theme': '새 테마 추가',
'Add New Ticket': '새 티켓 추가',
'Add New Track': '추가할 새 추적',
'Create User': '새 사용자 추가',
'Add New User to Role': '새 사용자 역할 추가',
'Create Volunteer': '새 자발적으로 추가',
'Create Warehouse': '새 웨어하우스 추가',
...
'Create Skill': '스킬 추가',
'Create Skill Equivalence': '기술 반복기에 추가',
