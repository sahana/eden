...
'Create Address': 'Thêm địa chỉ',
'Create Affiliation': 'Thêm liên kết',
...
'Create Branch Organization': 'Thêm tổ chức cấp tỉnh/ huyện/ xã',
...
'Create Certification': 'Thêm bằng cấp',
...
'Create Contact Information': 'Thêm thông tin liên hệ',
'Create Course': 'Thêm khóa tập huấn',
'Create Course Certificate': 'Thêm chứng nhận khóa tập huấn',
'Create Credential': 'Thêm thư ủy nhiệm',
'Create Data to Theme Layer': 'Thêm dữ liệu vào lớp chủ đề',
...
'Create Educational Achievements': 'Thêm thành tích học tập',
...
'Create Hours': 'Thêm thời gian hoạt động',
'Create Identity': 'Thêm nhận dạng',
...
'Create Item to Commitment': 'Thêm hàng hóa vào cam kết',
'Create Item to Shipment': 'Thêm hàng hóa vào lô hàng chuyển đi',
...
'Create Log Entry': 'Thêm ghi chép nhật ký',
...
'Create Activity': 'Thêm hoạt động mới',
'Create Activity Type': 'Thêm loại hình hoạt động mới',
'Create Address': 'Thêm địa chỉ mới',
'Create Affiliation': 'Thêm liên kết mới',
'Add New Aid Request': 'Thêm yêu cầu cứu trợ mới',
'Create Alternative Item': 'Thêm mặt hàng thay thế mới',
...
'Create Asset': 'Thêm tài sản Mới',
'Create Award': 'Thêm phần thưởng mới',
...
'Create Branch Organization': 'Thêm tổ chức cấp tỉnh/ huyện/ xã mới',
'Create Brand': 'Thêm nhãn hiệu mới',
'Create Catalog': 'Thêm danh mục mới',
'Create Certificate': 'Thêm chứng nhận mới',
'Create Certification': 'Thêm bằng cấp mới',
'Add New Cluster': 'Thêm nhóm mới',
'Add New Commitment Item': 'Thêm hàng hóa cam kết mới',
'Add New Community': 'Thêm cộng đồng mới',
'Create Competency Rating': 'Thêm đánh giá năng lực mới',
'Add New Config': 'Thêm cấu hình mới',
'Create Contact': 'Thêm liên lạc mới',
'Create Course': 'Thêm khóa học mới',
'Create Course Certificate': 'Thêm chứng nhận khóa học mới',
'Create Credential': 'Thêm thư ủy nhiệm mới',
'Create Data to Theme Layer': 'Thêm dữ liệu mới vào lớp chủ đề',
...
'Create Department': 'Thêm phòng/ban mới',
'Add New Document': 'Thêm tài liệu mới',
'Add New Donor': 'Thêm nhà tài trợ mới',
'Add New Entry': 'Thêm hồ sơ mới',
'Create Facility': 'Thêm bộ phận mới',
'Create Facility Type': 'Thêm loại hình bộ phận mới',
'Create Feature Layer': 'Thêm lớp chức năng mới',
'Add New Flood Report': 'Thêm báo cáo lũ lụt mới',
'Add New Framework': 'Thêm khung chương trình mới',
'Add new Group': 'Thêm nhóm mới',
'Create Group': 'Thêm nhóm mới',
'Create Hazard': 'Thêm hiểm họa mới',
'Create Hospital': 'Thêm Bệnh viện mới',
'Create Hours': 'Thêm thời gian hoạt động mới',
'Create Identity': 'Thêm nhận dạng mới',
'Add New Image': 'Thêm hình ảnh mới',
'Create Incident': 'Thêm sự kiện',
'Create Incident Report': 'Thêm báo cáo sự cố mới',
'Create New Item': 'Thêm hàng hóa mới',
'Create Item Category': 'Thêm danh mục hàng hóa mới',
'Create Item Pack': 'Thêm gói hàng hóa mới',
...
'Create Job Title': 'Thêm chức danh công việc mới',
'Add New Key': 'Thêm Key mới',
'Create New Kit': 'Thêm dụng cụ mới',
'Create Layer': 'Thêm lớp mới',
'Add New Layer to Symbology': 'Thêm lớp mới vào các mẫu biểu tượng',
'Create Location': 'Thêm địa điểm mới',
'Create Location Hierarchy': 'Thêm thứ tự địa điểm mới',
'Create Log Entry': 'Thêm ghi chép nhật ký mới',
'Add New Mailing List': 'Thêm danh sách gửi thư mới',
'Create Map Configuration': 'Thêm cài đặt cấu hình bản đồ mới',
'Create Marker': 'Thêm công cụ đánh dấu mới',
...
'Create Milestone': 'Thêm mốc quan trọng mới',
'Create Office': 'Thêm văn phòng mới',
'Create Office Type': 'Thêm loại hình văn phòng mới',
'Create Organization': 'Thểm tổ chức mới',
'Add New Organization Domain': 'Thêm lĩnh vực hoạt động mới của tổ chức',
'Create Organization Type': 'Thêm loại hình tổ chức mới',
'Add New Output': 'Thêm kết quả đầu ra mới',
'Add New Participant': 'Thêm người tham dự mới',
'Create Person to Commitment': 'Thêm đối tượng cam kết mới',
"Create Person's Details": 'Thêm thông tin mới của đối tượng',
'Create Photo': 'Thêm ảnh mới',
'Add new position.': 'Thêm địa điểm mới',
'Add New Problem': 'Thêm vấn đề mới',
'Create Professional Experience': 'Thêm kinh nghiệm nghề nghiệp mới',
'Add New Profile Configuration': 'Thêm định dạng hồ sơ tiểu sử mới',
'Create Program': 'Thêm chương trình mới',
'Create Project': 'Thêm dự án mới',
'Add new project.': 'Thêm dự án mới',
'Create Projection': 'Thêm dự đoán mới',
...
'Create Resource': 'Thêm nguồn lực mới',
'Add New Response': 'Thêm phản hồi mới',
'Create Role': 'Thêm vai trò mới',
'Add New Role to User': 'Gán vai trò mới cho người dùng',
'Create Room': 'Thêm phòng mới',
'Create Sector': 'Thêm lĩnh vực mới',
...
'Create Skill': 'Thêm kỹ năng mới',
'Create Skill Equivalence': 'Thêm kỹ năng tương đương mới',
'Create Skill Type': 'Thêm loại kỹ năng mới',
...
'Create Staff Member': 'Thêm cán bộ mới',
'Add new staff role.': 'Thêm vai trò nhân viên mới',
'Create Status': 'Thêm trạng thái mới',
'Create New Stock Items': 'Thêm mặt hàng mới lưu kho',
'Add New Storage Location': 'Thêm Vị trí kho lưu trữ mới',
'Add New Survey Template': 'Thêm mẫu khảo sát mới',
'Create Symbology': 'Thêm biểu tượng mới',
'Create Symbology for Layer': 'Thêm biểu tượng mới cho lớp',
'Create Task': 'Thêm nhiệm vụ mới',
'Add New Team': 'Thêm Đội/Nhóm mới',
'Add New Team Member': 'Thêm thành viên mới',
'Create Theme': 'Thêm chủ đề mới',
'Create Training': 'Thêm tập huấn mới',
'Create Training Event': 'Thêm khóa tập huấn mới',
'Create new translation language': 'Thêm ngôn ngữ biên dịch mới',
'Add New Unit': 'Thêm đơn vị mới',
'Create User': 'Thêm người dùng mới',
'Add New Vehicle Assignment': 'Thêm phân công mới cho phương tiện vận chuyển',
'Create Volunteer': 'Thêm tình nguyện viên mới',
'Create Volunteer Cluster': 'Thêm nhóm tình nguyện viên mới',
'Create Volunteer Cluster Position': 'Thêm vị trí mới của nhóm tình nguyện viên',
'Create Volunteer Cluster Type': 'Thêm loại hình mới của nhóm tình nguyện viên',
...
'Create Warehouse': 'Thêm kho hàng mới',
...
'Create Organization to Project': 'Thêm tổ chức tham gia dự án',
...
'Create Person to Commitment': 'Thêm đối tượng cam kết',
"Create Person's Details": 'Thêm thông tin cá nhân',
'Create Photo': 'Thêm ảnh',
'Add Point': 'Thêm điểm',
'Add Polygon': 'Thêm đường chuyền',
'Create Professional Experience': 'Thêm kinh nghiệm nghề nghiệp',
'Add Profile Configuration': 'Thêm hồ sơ tiểu sử',
'Create Profile Configuration for this Layer': 'Thêm định dạng hồ sơ tiểu sử cho lớp này',
...
'Create Reference Document': 'Thêm tài liệu tham chiếu',
...
'Create Skill Equivalence': 'Thêm kỹ năng tương đương',
...
'Create Stock to Warehouse': 'Thêm hàng vào kho',
...
'Create Symbology for Layer': 'Thêm biểu tượng cho lớp',
'Create Task': 'Thêm nhiệm vụ',
'Add Team': 'Thêm Đội/Nhóm',
'Add Team Member': 'Thêm thành viên Đội/Nhóm',
'Create Template Section': 'Thêm nội dung vào biểu mẫu',
...
'Create Training': 'Thêm tập huấn',
...
"Type the name of an existing catalog item OR Click 'Create New Item' to add an item which is not in the catalog.": "Nhập tên của một mặt hàng trong danh mục đang tồn tại HOẶC Nhấn 'Thêm mặt hàng mới' để thêm một mặt hàng chưa có trong danh mục.",
'Types': 'Các loại',
