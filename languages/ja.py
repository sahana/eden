...
'Create Address': 'アドレスを追加',
'Add Aid Request': '治療要請を追加',
'Create Alternative Item': '代わりの物資を追加',
'Add an Photo.': '写真を追加.',
...
'Create Contact Information': '連絡先情報を追加',
'Create Credential': '証明書の追加',
...
'Create Hospital': '病院情報を追加',
'Create Identification Report': 'IDレポートを追加',
'Create Identity': 'IDを追加',
'Add Image': '画像を追加',
'Add Impact': '被災状況の追加',
...
'Create Item to Shipment': '輸送に物資を追加する',
'Add Key': 'Keyを追加',
'Add Kit': 'Kitを追加',
'Create Layer': 'レイヤを追加',
...
'Create Contact': '連絡先を新規追加',
'Create Credential': '証明書の新規追加',
...
'Create Reference Document': 'リファレンス文書を追加',
'Add Report': 'レポートを追加',
'Add Request': '支援要請を追加',
