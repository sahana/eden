...
'Create Identity': 'Προσθήκη Ταυτότητας',
...
'Create Log Entry': 'Προσθήκη εισαγωγής καταγραφής(Log Entry)',
...
'Create Sector': 'Προσθήκη Νέου Τομέα',
