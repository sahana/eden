...
'Add Family Member': 'Додати члена сім',
...
'Create Hospital': 'Створити заклад охорони здоров',
...
'Current staffing level at the facility.': 'Існуючий стан працівників закладів охорони здоров',
'Current?': 'Існуючі?',
...
'Edit Family Member': 'Змінити члена сім',
...
'List Family Members': 'Перелік членів сім',
...
'Map of Hospitals': 'Карта закладів охорони здоров',
...
'No Family Members currently registered': 'На даний момент не зареєстровано членів сім',
...
'No Household Members currently registered': 'На даний момент не зареєстровано жодного члена сім',
...
'Organization and Operation of EOCs': 'Організація та функціонування середовища охорони здоров',
...
'Remove Family Member': 'Прибрати члена сім',
...
'Train the Trainer for Emergency Health': 'Тренуйте тренерів з надзвичайних ситуацій здоров',
...
'Train the Trainer for Prepared Family': 'Тренуйте наставників для підготовленої сім',
...
'Who usually collects water for the family?': 'Хто зазвичай носить воду для сім?',
'Width (m)': 'Ширина (м)',
