...
'%(number)s %(team)s members added': '%(number)s учасниками команди %(team)s додано',
'%(number)s areas assigned': '%(number)s областю виділено',
'%(number)s assigned': '%(number)s виділено',
'%(number)s messages deleted': '%(number)s повідомлень вилучено',
'%(number)s payment(s) not found': '%(number)s платежами не знайдено',
'%(number)s payment(s) registered': '%(number)s платежів зареєстровано',
'%(number)s Recipients added to Alert': '%(number)s Отримувачами додано до Попередження',
...
'Add %(team)s Members': 'Додати %(команду)s Учасниками',
...
'Export in %(format)s format': 'Експортувати у %(format)s форматом',
...
'households': 'Домашні',
'Households below %(br)s poverty line': 'Домогосподарства під %(br)s межею бідності',
...
'Links': 'Посилання',
'List %(site_label)s Status': 'Перелік %(site_label)s Стан',
...
'Role %(role)s deleted': 'Роль %(роль)s вилучено',
...
'Show': 'Показати',
'Show %(number)s entries': 'Показати %(number)s елементами',
...
'There are more than %(max)s results, please input more characters.': 'Є більше %(макс)s результатами, будь ласка, введіть більше символів.',
...
'tonsure': 'тонзура',
'Too many records - %(number)s more records not included': 'Забагато записів - %(number)s декількома записами не включено',
