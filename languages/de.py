...
'%(region)s Emergency Relief': 'Katastrophenhilfe %(region)s',
...
'A reference number for bookkeeping purposes (optional, for your own use)': 'Eine Referenznummer für Buchhaltungszwecke (optional, zu Ihrem eigenen Gebrauch)',
...
'About Us': 'Über uns',
'About': 'Über',
'Accept Group Voucher': 'Gruppengutschein annehmen',
...
'Account holder is required': 'Kontoinhaber ist erforderlich',
...
'Accountant##billing': 'Rechnungsführer',
'Acronym': 'Abkürzung',
...
'Add Booking Mode': 'Buchungsmodus hinzufügen',
...
'Add Item to Stock': 'Artikel zum Bestand hinzufügen',
...
'Add Organization to Project': 'Organisation zum Projekt hinzufügen',
...
'Add Service Mode': 'Servicemodus hinzufügen',
...
'Add Stock to Warehouse': 'Bestand zum Warenlager hinzufügen',
...
'Additional information and advice regarding facility and services': 'Weitere Informationen und Hinweise bzgl. Einrichtung und Leistungen',
...
'All Current Needs': 'Alle aktuellen Bedarfe',
...
'All Relief Offers': 'Alle Hilfsangebote',
...
'Appointments via': 'Terminvergabe via',
...
'Approval and Publication': 'Freigabe und Veröffentlichung',
'Approval': 'Freigabe',
'Approve Organization': 'Organisation Freigeben',
'Approve Test Station': 'Teststelle bestätigen',
'Approve': 'Bestätigen',
'Approved##actionable': 'Freigegeben',
'Approved': 'Bestätigt',
...
'Assets': 'Anlagen',
'Assign %(staff)s': '%(staff)s zuordnen',
'Assign ': 'Zuordnung ',
...
'Assigned to': 'Zugeordnet zu',
'Assigned': 'Zugeordnet',
'Assistance Offer Details': 'Details zum Hilfsangebot',
'Assistance Offers': 'Hilfsangebote',
...
'Availability and Status': 'Verfügbarkeit und Status',
...
'Beneficiary/Representative Date of Birth': 'Geburtsdatum des Berechtigten/Vertreters',
'Billing Date': 'Abrechnungsdatum',
'Billing Details': 'Details zur Abrechnung',
'Billing already scheduled for that date': 'Abrechnung für dieses Datum bereits geplant',
'Billing created': 'Abrechnung angelegt',
'Billing deleted': 'Abrechnung gelöscht',
...
'Block Email-Address': 'Email-Adresse blockieren',
'Blocked Entries': 'Gesperrte Einträge',
...
'Bomb': 'Bombe',
'Booking Mode Details': 'Details zum Buchungsmodus',
'Booking Mode added': 'Buchungsmodus hinzugefügt',
'Booking Mode deleted': 'Buchungsmodus gelöscht',
'Booking Mode updated': 'Buchungsmodus aktualisiert',
'Booking Mode': 'Buchungsmodus',
'Booking Modes': 'Buchungsmodi',
...
'Can order equipment': 'Kann Ausrüstung anfordern',
...
'Cancel Voucher Acceptance': 'Gutscheinannahme stornieren',
'Cancel this voucher acceptance': 'Diese Gutscheinannahme stornieren',
'Cancel##debit': 'Stornieren',
'Cancel': 'Abbrechen',
'Canceled (excused)': 'Ausgefallen (entschuldigt)',
'Canceled (failed to appear)': 'Ausgefallen (nicht erschienen)',
'Canceled': 'Abgebrochen',
'Cancellation successful': 'Stornierung erfolgreich',
'Cancelled by requesting organisation or volunteer': 'Abgesagt durch anfragende Organisation oder Freiwilligen',
'Cancelled##fin': 'Storniert',
'Cancelled': 'Abgesagt',
...
'Certificates##disease': 'Bescheinigungen',
...
'Claim has incorrect status': 'Forderungsstatus inkorrekt',
'Cleanup Assistance': 'Aufräumunterstützung',
'Cleanup Equiment': 'Aufräummaterial',
'Clear All': 'Alle entfernen',
'Clear Entry': 'Eintrag löschen',
...
'Compensation Balance': 'Saldo Vergütungen',
'Compensation Claim Details': 'Details zum Vergütungsanspruch',
'Compensation Claim created': 'Vergütungsanspruch angelegt',
'Compensation Claim deleted': 'Vergütungsanspruch gelöscht',
'Compensation Claim updated': 'Vergütungsanspruch aktualisiert',
'Compensation Claim': 'Vergütungsanspruch',
'Compensation Claims': 'Vergütungsansprüche',
'Compensation pending##fin': 'Vergütung ausstehend',
...
'Completion/Adjustment Required': 'Vervollständigung/Überarbeitung erforderlich',
...
'Confirm that you want to cancel this voucher acceptance': 'Bestätigen Sie dass Sie diese Gutscheinannahme stornieren wollen',
'Confirmed': 'Bestätigt',
...
'Contact and Appointments': 'Kontakt und Terminvergabe',
'Contact details': 'Details zum Kontakt',
...
'Create Assistance Offer': 'Hilfsangebot anlegen',
'Create Bed Type': 'Bettentyp erstellen',
'Create Billing': 'Abrechnung anlegen',
...
'Create Certificate##disease': 'Bescheinigung ausstellen',
...
'Create Compensation Claim': 'Vergütungsanspruch anlegen',
...
'Create Daily Report': 'Tagesbericht erstellen',
...
'Create Direct Offer': 'Direktangebot erstellen',
'Create Eligibility Type': 'Anspruchsart anlegen',
...
'Create Group Voucher': 'Gruppengutschein ausstellen',
...
'Create Item Category': 'Artikelkategorie erstellen',
...
'Create Transaction': 'Transaktion anlegen',
...
'Credit Balance': 'Saldo Guthaben',
'Credit Card': 'Kreditkarte',
'Credit Issued': 'Bewilligtes Guthaben',
'Credit Redeemed': 'Eingelöstes Guthaben',
'Credit##fin': 'Guthaben',
'Crime': 'Kriminalität',
...
'Current Need Reports': 'Aktuelle Bedarfsmeldungen',
'Current Needs & Relief Offers at a glance': 'Aktuelle Bedarfe & Hilfsangebote auf einen Blick',
...
'Current Relief Offers': 'Aktuelle Hilfsangebote',
...
'Current shelter population as a number of people': 'Aktuelle Unterkunftsbelegung als Anzahl Personen',
'Current': 'Aktuell',
...
'Daily Report created': 'Tagesbericht erstellt',
'Daily Report deleted': 'Tagesbericht gelöscht',
'Daily Report updated': 'Tagesbericht aktualisiert',
...
'Date can only be changed while process has not yet started': 'Datum kann nur geändert werden solange der Prozess noch nicht begonnen hat',
...
'Date': 'Datum',
'Date/Time is required!': 'Datum/Uhrzeit ist erforderlich!',
...
'Default Credit per Voucher': 'Standardguthaben pro Gutschein',
...
'Delete Asset Log Entry': 'Protokolleintrag zur Anlage löschen',
'Delete Asset': 'Anlage löschen',
'Delete Baseline Type': 'Referenzdatum-Typ löschen',
'Delete Baseline': 'Referenzdatum löschen',
'Delete Billing': 'Abrechnung löschen',
'Delete Booking Mode': 'Buchungsmodus gelöscht',
...
'Delete Catalog Item': 'Katalogeintrag löschen',
...
'Delete Compensation Claim': 'Vergütungsanspruch löschen',
...
'Delete Course Certificate': 'Kurszertifikat löschen',
'Delete Course': 'Kurs löschen',
'Delete Credential': 'Qualifikation löschen',
'Delete Daily Report': 'Tagesbericht löschen',
...
'Delete Direct Offer': 'Direktangebot löschen',
'Delete Document': 'Dokument löschen',
'Delete Donor': 'Spender löschen',
'Delete Eligibility Type': 'Anspruchsart löschen',
...
'Delete Feature Layer': 'Objekt-Kartenebene löschen',
'Delete Group': 'Gruppe löschen',
'Delete Hospital': 'Krankenhaus löschen',
'Delete Image': 'Grafik löschen',
'Delete Impact Type': 'Auswirkungstyp löschen',
...
'Delete Item Pack': 'Packung löschen',
...
'Delete Request Item': 'Artikel aus Anfrage löschen',
...
'Delete Section': 'Abschnitt Abschnitt',
'Delete Sector': 'Bereich löschen',
'Delete Seized Item': 'Beschlagnahmung löschen',
'Delete Sent Item': 'Artikel aus Lieferung löschen',
'Delete Sent Shipment': 'Ausgehende Lieferung löschen',
'Delete Service Contact Type': 'Leistungsträgerart löschen',
'Delete Service Contact': 'Leistungsträger löschen',
'Delete Service Mode': 'Servicemodus löschen',
...
'Delete Shipment Item': 'Lieferartikel löschen',
...
'Delete Skill Type': 'Befähigungstyp löschen',
...
'Delete Warehouse Type': 'Warenlagertyp löschen',
...
'Delivery##supplying': 'Belieferung',
...
'Diarrhea': 'Durchfall',
'Did you receive this shipment?': 'Haben Sie diese Lieferung erhalten?',
'Died': 'Verstorben',
'Dignitary Visit': 'Besuch des Würdenträgers',
'Direct Offer Details': 'Details zum Direktangebot',
'Direct Offer created': 'Direktangebot angelegt',
'Direct Offer deleted': 'Direktangebot gelöscht',
'Direct Offer updated': 'Direktangebot aktualisiert',
'Direct Offers': 'Direktangebote',
'Direct': 'Direkt',
'Direction': 'Richtung',
...
'District': 'Bezirk',
'Djibouti': 'Dschibuti',
'Do not report': 'Nicht melden',
'Do you really want to approve this record?': 'Wollen Sie diesen Datensatz wirklich bestätigen?',
'Do you really want to delete these records?': 'Sollen diese Datensätze wirklich gelöscht werden?',
'Do you really want to reject this record? (This action can not be reversed)': 'Wollen Sie diesen Datensatz wirklich abweisen? (Diese Aktion kann nicht rückgängig gemacht werden)',
...
'Do you want to cancel this sent shipment? The items will be returned to the Inventory. This action CANNOT be undone!': 'Möchten Sie diese ausgehende Lieferung wirklich stornieren? Die Artikel werden an die Bestandserfassung zurückgegeben. Diese Aktion kann NICHT rückgängig gemacht werden!',
...
'Do you want to register a shipment for this request?': 'Wollen Sie eine Lieferung für diese Anfrage registrieren?',
...
'Document generated by %(user)s on %(date)s': 'Dokument erzeugt von %(user)s am %(date)s',
...
'Donation Phone #': 'Spender Telefon-Nr.',
'Donation': 'Spende',
...
'Edit Billing': 'Abrechnung bearbeiten',
'Edit Booking Mode': 'Buchungsmodus bearbeiten',
...
'Edit Compensation Claim': 'Vergütungsanspruch bearbeiten',
...
'Edit Daily Report': 'Tagesbericht bearbeiten',
...
'Edit Item Category': 'Artikelkategorie bearbeiten',
'Edit Item Pack': 'Packung bearbeiten',
...
'Edit Organization Type': 'Organisationstyp bearbeiten',
...
'Edit Project Organization': 'Teilnehmerorganisation bearbeiten',
...
'Edit Service Mode': 'Servicemodus bearbeiten',
...
'Edit Shipment Item': 'Lieferartikel bearbeiten',
...
'Edit Warehouse Stock': 'Warenlagerbestand bearbeiten',
'Edit Warehouse Type': 'Warenlagertyp bearbeiten',
...
'Elevation': 'Höhe',
'Elevators': 'Aufzüge',
'Eligibility Type Details': 'Details zur Anspruchsart',
'Eligibility Type created': 'Anpruchsart angelegt',
'Eligibility Type deleted': 'Anspruchsart gelöscht',
'Eligibility Type updated': 'Anspruchsart aktualisiert',
'Eligibility Types': 'Anspruchsarten',
'Eligibility type not permissible for issuer': 'Anspruchsart nicht zulässig für Aussteller',
'Eligibility type required': 'Anspruchsart erforderlich',
...
'Emergency Relief': 'Katastrophenhilfe',
'Emergency Shelter': 'Notunterkunft',
'Emergency Shelters': 'Notunterkünfte',
...
'Enter a valid URL': 'Geben Sie eine gültige URL an',
'Enter a valid date before': 'Geben Sie zuvor eine gültiges Datum ein',
'Enter a valid email address': 'Geben Sie eine gültige Email-Adresse an',
...
'Enter the number of beneficiaries (max %(max)s)': 'Geben Sie die Anzahl der Berechtigten ein (max. %(max)s)',
...
'Enter the service quantity': 'Geben Sie die Anzahl der Leistungen ein',
...
'Errors': 'Fehler',
'Escort': 'Begleitung',
'Essential Goods / Household': 'Waren des täglichen Bedarfs / Haushalt',
...
'Fulfillment Status': 'Bedarfsdeckung',
'Fulfilment Status': 'Bedarfsdeckung',
'Full beard': 'Vollbart',
'Full': 'vollständig, voll, ganz',
'Fullscreen Map': 'Großbild Karte',
'Function not available': 'Funktion nicht verfügbar',
...
'Group Representative Date of Birth': 'Geburtsdatum des Gruppenvertreters',
...
'Group voucher! - use dedicated form': 'Gruppengutschein! - bitte entsprechendes Formular verwenden',
'Group': 'Gruppe',
...
'Heavy Machinery': 'Schweres Gerät / Maschinen',
'Height (cm)': 'Höhe (cm)',
'Height (m)': 'Höhe (m)',
'Height': 'Höhe',
...
'Import Booking Modes': 'Buchungsmodi importieren',
...
'Import Service Modes': 'Servicemodi importieren',
...
'Incoming Shipments': 'Ankommende Lieferungen',
'Incoming': 'Eingehend',
'Incomplete': 'Unvollständig',
'Inconclusive': 'Nicht schlüssig',
'Incorrect Date of Birth': 'Falsches Geburtsdatum',
...
'Information / Guidance': 'Information / Handlungshilfen',
...
'Initial Credit##fin': 'Anfängliches Guthaben',
...
'Internal identifier to track the payment (optional), e.g. payment order number': 'Interne Referenznummer zur Nachverfolgung der Zahlung (optional), z.B. Zahlungs-Anordnungsnummer',
...
'Invalid Request - Missing Parameter': 'Ungültige Anfrage - Fehlender Parameter',
'Invalid eligibility type': 'Ungültige Anspruchsart',
...
'Invoice Details': 'Details zur Rechnung',
'Invoice No.': 'Rechnung Nr.',
'Invoice created': 'Rechnung angelegt',
'Invoice deleted': 'Rechnung gelöscht',
'Invoice integrity compromised': 'Richtigkeit der Rechnung nicht sichergestellt',
'Invoice issued': 'Rechnung ausgestellt',
'Invoice updated': 'Rechnung aktualisiert',
'Invoice': 'Rechnung',
'Invoiced': 'Rechnung gestellt',
'Invoices': 'Rechnungen',
'Invoicing Party': 'Rechnungssteller',
...
'Issue anonymous contact tracing code': 'Anonyme Meldung zur Kontaktnachverfolgung',
'Issue personal test certificate': 'Namentliche Meldung und persönliche Testbescheinigung',
'Issued On': 'Ausgestellt am',
'Issued without Record': 'Ausgegeben ohne Aufzeichnung',
...
'Item Pack Details': 'Details zur Packung',
'Item Pack added': 'Packung hinzugefügt',
'Item Pack deleted': 'Packung gelöscht',
'Item Pack updated': 'Packung aktualisiert',
'Item Packs': 'Packungen',
'Item Source Tracking Number': 'Ursprungs-Referenz zum Artikel',
'Item Status': 'Artikelstatus',
'Item Tracking Status': 'Lieferstatus',
...
'Item removed from Stock': 'Artikel aus dem Bestand entfernt',
'Item updated': 'Artikel aktualisiert',
'Item': 'Artikel',
'Item(s) added to Request': 'Artikel zur Anfrage hinzugefügt',
...
'Items in Stock': 'Bestandsartikel',
'Items': 'Artikel',
...
'List All Sent Shipments': 'Liste aller ausgehenden Lieferungen',
...
'List Billings': 'Liste Abrechnungen',
'List Booking Modes': 'Liste Buchungsmodi',
...
'List Compensation Claims': 'Liste Vergütungsansprüche',
...
'List Daily Reports': 'Liste Tagesberichte',
...
'List Eligibility Types': 'Liste Anspruchsarten',
...
'List Offers': 'Liste Angebote',
'List Offices': 'Liste der Geschäftsstellen',
'List Orders': 'Liste Bestellungen',
'List Organization Types': 'Liste Organisationstypen',
...
'List Project Organizations': 'Liste Teilnehmerorganisationen',
...
'List Received/Incoming Shipments': 'Liste Eingehende Lieferungen',
...
'List Shipment Items': 'Liste Lieferartikel',
...
'MPAV Qualification': 'MPAV Berechtigung',
...
'Manage Returns': 'Rücksendungen verwalten',
...
'Map of Warehouses': 'Karte von Warenlagern',
'Map': 'Karte',
...
'Matching My Needs': 'Passend zu meinem Bedarf',
'Matching Offers': 'Passende Hilfsangebote',
...
'Minimum quantity is %(min)s': 'Mindestmenge ist %(min)s',
...
'Missing voucher signature': 'Fehlende Gutschein-Nr',
'Missing': 'Fehlend',
...
'Morocco': 'Marokko',
'Mosque': 'Moschee',
'Most commonly needed': 'Am häufigsten benötigt',
'Most commonly offered': 'Am häufigsten angeboten',
'Mother': 'Mutter',
'Motorcycle': 'Motorrad',
...
'Needs Statistic': 'Bedarfsstatistik',
...
'New Item Category': 'Neue Artikelkategorie',
...
'No Assistance Offers currently registered': 'Zurzeit keine Hilfsabgebote registriert',
...
'No Billings currently registered': 'Zurzeit keine Abrechnungen registriert',
'No Booking Modes currently defined': 'Zurzeit keine Buchungsmodi definiert',
...
'No Compensation Claims currently registered': 'Zurzeit keine Vergütungsansprüche registriert',
...
'No Daily Reports currently registered': 'Zurzeit keine Tagesberichte registriert',
...
'No Invoices currently registered': 'Zurzeit keine Rechnungen registriert',
'No Item Categories currently registered': 'Zurzeit sind keine Artikelkategorien registriert',
'No Item Packs currently registered': 'Zurzeit sind keine Packungen registriert',
...
'No Items currently requested': 'Zurzeit keine Artikel angefragt',
...
'No Managed Organizations': 'Keine verwalteten Organisationen',
...
'No Orders registered': 'Keine Bestellungen registriert',
'No Organization Types currently registered': 'Zurzeit keine Organisationstypen registriert',
'No Organizations currently registered': 'Zurzeit sind keine Organisationen registriert',
'No Packs for Item': 'Keine Packung zum Artikel',
...
'No Sent Shipments': 'Keine ausgehenden Lieferungen',
...
'No Service Modes currently defined': 'Zurzeit keine Servicemodi definiert',
...
'No Transactions currently registered': 'Zurzeit keine Transaktionen registriert',
...
'No Warehouse Types currently registered': 'Zurzeit keine Warenlagertypen registriert',
...
'No more items may be added to this request': 'Es können keine Artikel mehr zur Anfrage hinzugefügt werden',
...
'Notes of the Provider': 'Vermerke des Leistungsträgers',
'Notes': 'Notizen',
'Notice to Airmen': 'Hinweis für Flieger',
'Notification could not be sent: %(error)s': 'Benachrichtigung konnte nicht verschickt werden: %(error)s',
'Notification sent': 'Benachrichtigung verschickt',
'Notifications sent': 'Benachrichtigungen verschickt',
'Notifications': 'Benachrichtigungen',
'Notify about Rejection': 'Über Abweisung informieren',
...
'Number of Beneficiaries': 'Anzahl Berechtigte',
...
'Number of Need Reports': 'Anzahl von Bedarfsmeldungen',
...
'Number of People with Needs Reported': 'Anzahl Personen mit Bedarfsmeldungen',
'Number of Positive Test Results': 'Anzahl positive Testergebnisse',
'Number of Providers': 'Anzahl Anbieter',
'Number of Relief Offers': 'Anzahl Hilfsangebote',
'Number of Relief Providers': 'Anzahl Hilfeanbieter',
...
'Number of positive results cannot be greater than number of tests': 'Anzahl positiver Ergebnisse kann nicht größer sein als die Anzahl ausgeführter Tests',
...
'Offer Assistance / Supplies': 'Hilfe / Hilfsmittel anbieten',
'Offer created': 'Angebot registriert',
'Offer deleted': 'Angebot gelöscht',
'Offer has lapsed': 'Angebot ist verfallen',
'Offer is blocked': 'Angebot ist gesperrt',
...
'Optional link to an Incident which this Assessment was triggered by.': 'Optionaler Link zum einem Vorfall, der diese Beurteilung auslöste.',
'Optional': 'Optional',
...
'Order': 'Bestellung',
'Orderable Item Categories': 'Bestellbare Artikelkategorien',
'Orderer': 'Besteller',
'Orders##delivery': 'Bestellungen',
'Orders': 'Bestellungen',
'Organisation / Company': 'Organisation / Firma',
...
'Organization Type Details': 'Details zum Organisationstyp',
'Organization Type added': 'Organisationstyp hinzugefügt',
'Organization Type deleted': 'Organisationstyp gelöscht',
'Organization Type updated': 'Organisationstyp aktualisiert',
'Organization Type': 'Organisationstyp',
'Organization Types': 'Organisationstypen',
'Organization added to Project': 'Organisation zum Projekt hinzugefügt',
...
'Organization not authorized': 'Organisation nicht berechtigt',
'Organization removed from Project': 'Organisation aus dem Projekt entfernt',
...
'Organizations to be Approved': 'Freizugebende Organisationen',
...
'Original Value per Pack': 'Ursprünglicher Wert pro Packung',
...
'Outgoing SMS handler': 'SMS-Handler für ausgehende Informationen',
'Outgoing Shipments': 'Ausgehende Lieferungen',
...
'Patients': 'Patienten',
'Payable within %(num)s days to': 'Zahlbar innerhalb von %(num)s Tagen an',
'Payers': 'Kostenträger',
...
'Pending Compensation Claims': 'Ausstehende Vergütungsansprüche',
'Pending Credits': 'Offene Guthaben',
...
'Person Tested': 'Getestete Person',
...
'Place where help is provided': 'Ort wo die Hilfe angeboten wird',
'Place': 'Ort',
...
'Please enter a %(site)s OR an Organization': 'Bitte geben Sie eine Stelle ODER Organisation an',
'Please enter a %(site)s': 'Bitte geben Sie eine Stelle an',
...
'Please enter an Organization/Supplier': 'Bitte geben Sie eine Organisation/einen Lieferanten an',
'Please enter request details here.': 'Bitte geben Sie hier Details für die Anfrage ein',
'Please enter the details on the next screen.': 'Bitte geben Sie Details auf der nächsten Seite ein',
...
'Power Supply / Generators': 'Stromversorgung / Generatoren',
...
'Prepare Shipment': 'Lieferung vorbereiten',
...
'Processing Status': 'Bearbeitungsstatus',
...
'Program has ended': 'Programm ist beendet',
'Program inactive': 'Programm inaktiv',
...
'Provide Digital %(title)s Certificate': 'Digitales %(title)s-Zertifikat bereitstellen',
...
'Provider Notification Failed': 'Leistungsträger-Benachrichtigung fehlgeschlagen',
'Provider Self-Registration': 'Leistungsträger-Selbstregistrierung',
'Provider Type': 'Art des Anbieters',
...
'Public Registry': 'Öffentliches Verzeichnis',
...
'Quantity / Size / Capacity': 'Menge / Größe / Kapazität',
...
'Quantity Oustanding': 'Ausstehende Menge',
'Quantity Planned': 'Geplante Menge',
'Quantity Received': 'Erhaltene Menge',
'Quantity Requested': 'Angeforderte Menge',
'Quantity Returned': 'Zurückgegebene Menge',
'Quantity Sent': 'Gesendete Menge',
'Quantity Shipped': 'Versendete Menge',
...
'Ready for Review': 'Bereit für Prüfung',
'Ready for Transfer': 'Transferbereit',
'Reason for Cancellation##fin': 'Grund für Stornierung',
'Reason for Rejection': 'Ablehnungsgrund',
'Reason must be specified': 'Grund muss angegeben werden',
'Reason': 'Grund',
...
'Register Shipment': 'Lieferung registrieren',
...
'Register another test result': 'Weiteres Testergebnis registrieren',
'Register as Private Citizen': 'Registrieren als Privatperson',
...
'Registration is still pending approval from Approver (%s) - please wait until confirmation received.': 'Ihre Registrierung wurde noch nicht vom Administrator (%s) bestätigt - bitte warten Sie auf Bestätigungsmitteilung.',
'Registration is still pending approval from the system administrator - please wait until confirmation received.': 'Ihre Registrierung wurde noch nicht vom Administrator bestätigt - bitte warten Sie auf Bestätigungsmitteilung.',
...
'Reject': 'Abweisen',
'Rejected##claim': 'Abgelehnt',
'Rejected': 'Zurückgewiesen',
'Relationship': 'Beziehung',
'Relief Offers': 'Hilfsangebote',
...
'Remaining Compensation Claims': 'Ausstehender Vergütungsanspruch',
'Remaining Credit': 'Ausstehendes Guthaben',
'Remarks': 'Bemerkungen',
...
'Remove Item from Stock': 'Artikel aus dem Bestand entfernen',
'Remove Layer from Profile': 'Kartenebene aus dem Profil entfernen',
...
'Remove Organization from Project': 'Organisation aus dem Projekt entfernen',
'Remove Person from Group': 'Person aus Gruppe entfernen',
'Remove Person from Team': 'Person aus Team entfernen',
'Remove Stock from Warehouse': 'Bestand vom Warenlager entfernen',
'Remove existing data before import': 'Existierende Daten vor dem Import entfernen',
...
'Repair': 'Reparieren',
'Repaired': 'Repariert',
'Repairs (building)': 'Reparaturen (Gebäude)',
'Repairs (electric)': 'Reparaturen (Elektrik)',
'Repairs (other)': 'Reparaturen (sonstige)',
'Repairs (vehicles/machines)': 'Reparaturen (Fahrzeuge/Maschinen)',
'Repairs': 'Reparaturen',
...
'Report for this date exists - please update the existing report instead': 'Tagesbericht für dieses Datum existiert bereits - bitte aktualisieren Sie diesen falls erforderlich',
'Report my location': 'Meinen Standort melden',
'Report of': 'Bericht von',
'Report test result to %(system)s': 'Testergebnis an %(system)s melden',
...
'Report to %(system)s failed': 'Meldung an %(system)s fehlgeschlagen',
...
'Request Status updated': 'Anfragestatus aktualisiert',
...
'Requests contains no items': 'Anfrage enthält keine Artikel',
'Requests': 'Anfragen',
...
'Result not reported to %(system)s': 'Ergebnis NICHT an %(system)s gemeldet',
'Result reported to %(system)s': 'Ergebnis an %(system)s gemeldet',
'Result': 'Ergebnis',
'Results': 'Ergebnisse',
'Retail Crime': 'Einzelhandel Kriminalität',
'Retrieve Password': 'Passwort abrufen',
'Retry sending to %(app)s': 'Erneut versuchen an %(app)s zu senden',
...
'Reunion': 'Réunion',
'Revert Entry': 'Eintrag wiederherstellen',
...
'Sanitary Equipment': 'Sanitäreinrichtungen',
...
'Save and add Items': 'Speichern und Artikel hinzufügen',
'Save': 'Speichern',
...
'Schools': 'Schulen',
'Seaports': 'Seehafen',
'Search & Rescue': 'Suche und Rettung',
...
'Search Item Packs': 'Packungen suchen',
...
'Search Sent Shipments': 'Ausgehende Lieferungen suchen',
...
'Search for items with this text in the name.': 'Nach Artikeln mit diesem Text im Namen suchen',
...
'Select Stock from this Warehouse': 'Bestandsartikel von diesem Warenlager auswählen',
...
'Send Commitment as Shipment': 'Lieferung für Zusage schicken',
...
'Sent Shipment canceled': 'Ausgehende Lieferung storniert',
'Sent Shipment updated': 'Ausgehende Lieferung aktualisiert',
'Sent Shipments': 'Ausgehende Lieferungen',
...
'Service Mode Details': 'Details zum Servicemodus',
'Service Mode added': 'Servicemodus hinzugefügt',
'Service Mode deleted': 'Servicemodus gelöscht',
'Service Mode updated': 'Servicemodus aktualisiert',
'Service Mode': 'Servicemodus',
'Service Modes': 'Servicemodi',
'Service Offer': 'Leistungsangebot',
'Service Quantity': 'Anzahl Leistungen',
...
'Service quantity compensated': 'Anzahl vergüteter Leistungen',
'Service quantity invoiced': 'Anzahl in Rechnung gestellter Leistungen',
'Service': 'Leistung',
...
'Shipment Item Details': 'Details zum Lieferartikel',
'Shipment Item deleted': 'Lieferartikel gelöscht',
'Shipment Item updated': 'Lieferartikel aktualisiert',
'Shipment Items Received': 'Lieferartikel entgegengenommen',
...
'Shipment Items sent from Warehouse': 'Lieferartikel von Warenlager abgeschickt',
'Shipment Items': 'Lieferungsartikel',
'Shipment Type': 'Typ der Lieferung',
'Shipment already in process': 'Lieferung wird bereits bearbeitet',
'Shipment already in process, or not possible': 'Lieferung wird bereits bearbeitet, oder ist nicht möglich',
'Shipment received': 'Lieferung entgegengenommen',
'Shipment to Receive': 'Entgegenzunehmende Lieferung',
...
'Shipping Organization': 'Versendende Organisation',
...
'Signature / Stamp': 'Stempel/Unterschrift',
...
'Specify the name of the organization (max 60 characters)': 'Geben Sie den Namen der Organisation an (max. 60 Zeichen)',
'Specify the name of the test station (max 60 characters)': 'Geben Sie den Namen der Teststelle an (max. 60 Zeichen)',
...
'Status cannot be changed once process has started': 'Status kann nicht geändert werden nachdem der Prozess begonnen hat',
'Status cannot be changed': 'Status kann nicht geändert werden',
...
'Stock added to Warehouse': 'Bestand zum Warenlager hinzugefügt',
'Stock in Warehouse': 'Bestand im Warenlager',
'Stock removed from Warehouse': 'Bestand vom Warenlager entfernt',
'Stock': 'Bestand',
'Stolen': 'Gestohlen',
...
'Telecommunication / IT': 'Telekommunikation / IT',
...
'Templates': 'Vorlagen',
'Temporary Housing': 'Behelfsunterkünfte',
...
'The Tracking Number %s ': 'Die Referenznummer %s',
...
'This direct offer already exists': 'Dieses Direktangebot besteht bereits',
...
'This invoice may be invalid - please contact the administrator': 'Diese Rechnung ist möglicherweise ungültig - bitte kontaktieren Sie den Administrator',
...
'This shipment contains %s items': 'Diese Lieferung enthält %s Artikel',
'This shipment contains one line item': 'Diese Lieferung enthält einen Artikel',
...
'Total Active Organisations': 'Aktive Organisationen',
'Total Active Users': 'Aktive Benutzer',
...
'Total Number of Tests': 'Anzahl Tests',
...
'Total Services Rendered': 'Summe erbrachte Leistungen',
...
'Total number of vouchers': 'Gesamtanzahl Gutscheine',
'Total population of site visited': 'Gesamtzahl der Bevölkerung des besuchten Gebietes',
'Total quantity of service': 'Gesamtanzahl erbrachter Leistungen',
'Total': 'Summe',
...
'Track Shipment': 'Lieferung nachverfolgen',
...
'Transaction created': 'Transaktion angelegt',
...
'Unapproved Test Stations': 'Nicht freigegebene Teststellen',
...
'Unit of Service': 'Leistungseinheit',
'Unit to determine the service quantity (e.g. "Meals")': 'Einheit zur Feststellung der Anzahl von Leistungen (z.B. "Mahlzeiten")',
...
'Valid until': 'Gültig bis',
'Validity Period for Vouchers (Days)': 'Gültigkeitsdauer für Gutscheine (Tage)',
'Value can no longer be changed': 'Wert kann nicht mehr geändert werden',
'Value not allowed': 'Unzulässiger Wert',
'Value per Pack': 'Wert pro Packung',
...
'Via Distribution Center': 'Via Verteilungszentrum',
'Viet Nam': 'Vietnam',
...
'View on Map': 'Auf der Karte ansehen',
...
'Voucher Instructions': 'Anweisungen für Gutscheine',
'Voucher Issuance': 'Gutschein-Ausgabe',
'Voucher Programs': 'Gutschein-Programme',
'Voucher acceptance cannot be cancelled': 'Gutscheinannahme kann nicht storniert werden',
'Voucher acceptance cannot be cancelled: %s': 'Gutscheinannahme kann nicht storniert werden: %s',
...
'Voucher is for a different program': 'Gutschein ist für ein anderes Programm',
'Voucher program has ended': 'Gutscheinprogramm beendet',
'Voucher program suspended': 'Gutscheinprogramm gesperrt',
...
'Warehouse Stock Details': 'Details zum Lagerbestand',
'Warehouse Stock Report': 'Bericht zum Warenlagerbestand',
'Warehouse Stock updated': 'Lagerbestand aktualisiert',
'Warehouse Stock': 'Lagerbestand',
'Warehouse Type Details': 'Details zum Warenlagertyp',
'Warehouse Type added': 'Warenlagertyp hinzugefügt',
'Warehouse Type deleted': 'Warenlagertyp gelöscht',
'Warehouse Type updated': 'Warenlagertyp aktualisiert',
...
'Width': 'Breite',
'Wild Fire': 'Wildfeuer',
'Will be filled automatically when the Shipment has been Received': 'Wird automatisch ausgefüllt wenn die Lieferung entgegengenommen wird',
...
'You do not have permission for any facility to add an order.': 'Sie haben keine Berechtigung für irgendeine Einrichtung eine Bestellung anzulegen',
...
'You do not have permission for any facility to receive a shipment.': 'Sie haben keine Berechtigung für irgendeine Einrichtung eine Lieferung entgegenzunehmen',
'You do not have permission for any facility to send a shipment.': 'Sie haben keine Berechtigung für eine Einrichtung um eine Lieferung zu senden',
...
'You do not have permission to cancel this sent shipment.': 'Sie haben keine Berechtigung diese ausgehende Lieferung zu löschen.',
...
'You do not have permission to send a shipment from this site.': 'Sie haben keine Berechtigung Lieferungen von dieser Stelle zu senden.',
...
'Your action is required to approve a New Test Station for %(system_name)s:\n%(org_name)s\nPlease go to %(url)s to approve this station.': 'Ihre Bestätigung ist erforderlich für eine neue Teststelle für %(system_name)s:\n%(org_name)s\nGehen Sie auf %(url)s um die Teststelle zu bestätigen.',
'Your action is required to approve a New User for %(org_name)s:\n%(user_name)s\nPlease go to %(url)s to approve this user.': 'Ein neues Benutzerkonto für %(org_name)s wurde registriert und wartet auf Ihre Freigabe:\n%(user_name)s\nGehen Sie auf %(url)s um den Benutzer zu bestätigen.',
...
'Your offer is waiting for approval by the administrator': 'Ihr Angebot muss noch durch den Administrator freigegeben werden',
...
'message template not found': 'Mitteilungsvorlage nicht gefunden',
'meters': 'meter',
'missed': 'verpasst',
'missing': 'fehlend',
