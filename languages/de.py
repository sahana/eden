...
'Please mark all times when you are generally available during the week, click boxes to select/deselect hours individually or hold the left mouse button pressed and move over the boxes to select/deselect multiple.': 'Bitte markieren Sie alle Zeiten zu denen sie während der Woche grundsätzlich verfügbar sind; klicken Sie auf die Kästchen um einzelne Stunden aus/abzuwählen, oder halten Sie die Maustaste gedrückt und fahren Sie über die Kästchen um mehrere nacheinander aus/abzuwählen.',
