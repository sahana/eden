...
'Add': 'Adicionar',
'Create a Person': 'Adicionar uma Pessoa',
...
'Create Activity': 'Adicionar Actividade',
'Create Activity Report': 'Adicionar Relatório de Actividade',
'Create Activity Type': 'Adicionar Tipo de Atividade',
'Create Address': 'Adicionar Endereço',
'Create Alternative Item': 'Adicionar Item Alternativo',
'Add Assessment': 'Adicionar Avaliação',
'Add Assessment Summary': 'Adicionar Resumo/Sumário de Avaliação',
'Create Asset': 'adicionar bem/posse',
...
'Create Bed Type': 'Adicionar Tipo de Cama',
'Create Brand': 'Adicionar Marca',
'Create Budget': 'Adicionar Orçamento',
'Add Bundle': 'Adicionar Pacote',
'Create Catalog Item': 'Adicionar Item de Catálogo',
'Create Cholera Treatment Capability Information': 'Adicionar Informação de Capacidade de Tratamento de Cólera',
'Add Cluster Subsector': 'Adicionar Subsector de Bloco',
'Create Contact': 'Adicionar Contacto',
'Create Contact Information': 'Adicionar Informação de Contacto',
'Create Credential': 'adicionar credencial',
'Add Credentials': 'Adicionar Credenciais',
'Create Dead Body Report': 'Adicionar Relatório de Cadáver',
...
'Create Feature Layer': 'Adicionar Camada de Característica',
'Add Flood Report': 'Adicionar Relatório de Inundação',
'Create Group': 'Adicionar Grupo',
'Add Group Member': 'Adicionar Membro de Grupo',
'Create Hospital': 'Adicionar Hospital',
'Create Identification Report': 'Adicionar Relatório de Identificação',
'Create Identity': 'Adicionar Identidade',
'Add Image': 'Adicionar Imagem',
'Add Impact': 'Adicionar Impacto',
'Add Impact Type': 'Adicionar Tipo de Impacto',
'Create Incident': 'Adicionar Ocorrência',
'Create Incident Report': 'Adicionar Relatório de Incidente',
'Add Item': 'Adicionar Item',
'Create Item Category': 'Adicionar Categoria de Item',
'Create Item Pack': 'Adicionar pacote de Item',
'Add Item to Request': 'Adicionar Item ao Pedido',
'Create Item to Shipment': 'Adicionar Item a Carregamento',
'Add Key': 'Adicionar Chave',
'Add Kit': 'Adicionar Kit',
'Create Layer': 'Adicionar Camada',
'Add Level 2 Assessment': 'Adicionar Avaliação Nível 2',
'Create Location': 'Adicionar Localização',
'Create Log Entry': 'Adicionar Entrada de Diário/Log',
'Create Map Configuration': 'Adicionar Configuração de Mapa',
'Create Marker': 'Adicionar Marcador',
...
'Create Feature Layer': 'Adicionar Nova Camada de Característica',
'Add New Flood Report': 'Adicionar Novo Relatório de Inundação',
'Add new Group': 'Adicionar novo Grupo',
'Create Group': 'Adicionar Novo Grupo',
'Create Hospital': 'Adicionar Novo Hospital',
'Create Identity': 'adicionar nova identificação',
'Add New Image': 'Adicionar Nova Imagem',
'Add New Impact': 'Adicionar Novo Impacto',
'Create Incident Report': 'Adicionar Novo Relatório de Incidente',
'Add new Individual': 'Adicionar novo Indivíduo',
'Add New Inventory Item': 'Adicionar Novo Item de Inventário',
'Create New Item': 'Adicionar novo item',
'Create Item Category': 'Adicionar Nova Categoria de Item',
'Create Item Pack': 'Adicionar Novo Pacote de Item',
'Add New Item to Kit': 'Adicionar Novo Item ao Kit',
'Add New Key': 'Adicionar Nova Chave',
'Create New Kit': 'Adicionar novo Kit',
'Create Layer': 'Adicionar Nova Camada',
'Add New Level 1 Assessment': 'Adicionar Nova Avaliação Nível 1',
'Add New Level 2 Assessment': 'Adicionar Nova Avaliação  Nível 2',
'Create Location': 'Adicionar Nova Localização',
'Create Log Entry': 'Adicionar Nova Entrada de Diário/Log',
'Create Map Configuration': 'Adicionar Nova Configuração de Mapa',
'Create Marker': 'Adicionar Novo Marcador',
...
'Create Office': 'Adicionar novo escritório',
'Create Organization': 'Adicionar nova organização',
'Create Photo': 'Adicionar Nova Foto/fotografia',
'Add New Population Statistic': 'Adicionar Nova Estatística de População',
'Add New Problem': 'Adicionar Novo Problema',
'Create Project': 'Adicionar Novo Projecto',
'Add new project.': 'Adicionar novo projecto',
'Create Projection': 'Adicionar Nova Projecção',
...
'Create Resource': 'Adicionar Novo Recurso',
'Add New River': 'Adicionar Novo Rio/ Curso de água',
'Create Role': 'Adicionar Novo Papel',
'Add New Role to User': 'Adicionar Nova Função a Utilizador',
'Create Sector': 'Adicionar Sector ',
'Add New Sent Item': 'Adicionar Novo Item Enviado',
'Add New Setting': 'Adicionar Nova Definição',
'Create Shelter': 'Adicionar novo abrigo',
'Create Shelter Service': 'Adicionar novo serviço de abrigo',
'Create Shelter Type': 'Adicionar Novo Tipo de Abrigo',
'Create Skill': 'adicionar nova habilidade',
'Add New Solution': 'Adicionar Nova Solução',
'Add New Staff': 'Adicionar Novo Staff/funcionário',
'Create Staff Member': 'Adicionar Novo Membro de Staff/funcionário',
...
'Create Task': 'Adicionar Nova Tarefa',
'Add New Team': 'Adicionar Nova Equipa',
'Create Theme': 'Adicionar Novo Tema',
'Add New Ticket': 'Adicionar Novo Bilhete',
'Add New Track': 'Adicionar Novo Trajecto',
'Create User': 'Adicionar Novo Utilizador',
'Add New User to Role': 'Adicionar Novo Utilizador a Função',
'Create Volunteer': 'Adicionar Novo Voluntário',
'Create Warehouse': 'Adicionar novo armazém',
'Add Note': 'Adicionar Nota',
'Create Office': 'Adicionar Escritório/Serviço/Agência',
'Create Organization': 'Adicionar Organização',
'Add Peer': 'Adicionar Peer',
'Add Person': 'adicionar pessoa',
'Create Personal Effects': 'Adicionar Objectos de Uso Pessoal',
'Create Photo': 'Adicionar Foto',
'Add Population Statistic': 'Adicionar Estatística Populacional',
'Add Problem': 'Adicionar Problema',
'Create Project': 'Adicionar Projecto',
'Create Projection': 'Adicionar Projecção',
'Add Question': 'Adicionar Questão',
'Add Rapid Assessment': 'Adicionar Avaliação Rápida',
'Add Record': 'Adicionar Registo',
'Create Reference Document': 'Adicionar Documento de Referência',
'Add Report': 'Adicionar Relatório',
'Add Request': 'Adicionar Pedido',
'Create Resource': 'Adicionar Recurso',
'Add River': 'Adicionar Rio/curso de água',
'Create Role': 'adicionar papel',
'Add Section': 'Adicionar Secção',
'Create Sector': 'Adicionar Sector',
'Create Service Profile': 'Adicionar Perfil de Serviço',
'Create Shelter': 'Adicionar Abrigo',
'Create Shelter Service': 'Adicionar Serviço de Abrigo',
'Create Shelter Type': 'Adicionar Tipo de Abrigo',
'Create Skill': 'Adicionar Capacidade/Habilidade',
'Add Solution': 'Adicionar Solução',
'Add Staff': 'Adicionar Staff/ Funcionário',
'Add Staff Type': 'Adicionar Tipo de Staff',
'Create Status': 'Adicionar Estado',
...
'Create User': 'Adicionar Utilizador',
'Create Volunteer': 'Adicionar Voluntário',
'Add Volunteer Availability': 'Adicionar disponibilidade de voluntários',
'Create Warehouse': 'Adicionar Armazém ',
...
"If you don't see the Hospital in the list, you can add a new one by clicking link 'Create Hospital'.": "Se você não vê o Hospital na lista, pode adicionar um novo carregando na ligação 'Adicionar Hospital'.",
"If you don't see the Organization in the list, you can add a new one by clicking link 'Create Organization'.": "Se você não vê a Organização na lista, pode adicionar uma nova carregando na ligação 'Adicionar Organização'.",
