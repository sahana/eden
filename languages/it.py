...
'Create Competency Rating': 'Crea valutazione competenza',
...
'Create Facility': 'Crea Funzione',
'Create Feature Layer': "Strato per l'aggiunta di una nuova caratteristica",
'Create Feature Layer': 'Crea Livello di funzione',
