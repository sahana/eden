...
'"Warning: this %s is full for daytime"%resource': '"Avviso: questo %s è pieno per le ore diurne"%resource',
'"Warning: this %s is full for the night"%resource': '"Avviso: questo %s è pieno per la notte"%resource',
