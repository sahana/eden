...
'Create Branch Organization': 'Add New Branch Organisation',
'Create Organization': 'Add New Organisation',
'Add New Organization Domain': 'Add New Organisation Domain',
'Create Organization Type': 'Add New Organisation Type',
'Create Organization': 'Add Organisation',
'Add Organization Domain': 'Add Organisation Domain',
'Create Organization to Project': 'Add Organisation to Project',
'Create Organization Type': 'Add Organisation Type',
'Add Partner Organization': 'Add Partner Organisation',
'Add Partner Organizations': 'Add Partner Organisations',
'Create Program': 'Add Programme',
...
"Type the name of an existing catalog item OR Click 'Create New Item' to add an item which is not in the catalog.": "Type the name of an existing catalogue item OR Click 'Create New Item' to add an item which is not in the catalogue.",
