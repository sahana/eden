...
'Severe': 'Severe',
'Severity': 'Severity',
"Shapely library not functional, so can't find centroid! Install Geos & Shapely for Line/Polygon support": "Shapely library not functional, so can't find centroid! Install Geos & Shapely for Line/Polygon support",
