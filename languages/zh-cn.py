...
'Create Address': '添加地址',
'Create Alternative Item': '添加备用项目',
'Add Assessment': '添加评估',
...
'Create Certification': '添加认证',
'Create Cholera Treatment Capability Information': '添加霍乱治疗功能信息',
'Add Cluster': '添加集群',
'Add Cluster Subsector': '添加集群分组',
'Add Competency': '添加职务',
'Create Competency Rating': '添加能力评级',
'Create Contact': '添加联系人',
'Create Contact Information': '添加联系人信息',
'Create Course': '添加教程',
'Create Course Certificate': '添加当然Certificate',
...
'Create Item to Commitment': '将库存项目添加到承诺',
'Add Item to Inventory': '将库存项目添加到库存',
'Add Item to Request': '将库存项目添加到请求',
'Create Item to Shipment': '将库存项目添加到发货',
'Add Job Role': '添加作业角色',
'Add Key': '添加键',
'Add Kit': '添加套件',
'Create Layer': '添加层',
...
'Add New': '添加新',
'Create Activity': '添加新的活动',
'Create Address': '添加新地址',
'Create Alternative Item': '添加新的替代项目',
...
'Create Resource': '添加新的资源',
'Add New River': '添加新河道',
'Create Role': '添加新角色',
'Add New Role to User': '添加新角色到用户',
'Create Room': '添加新房间',
'Add New Scenario': '添加新方案',
'Create Sector': '添加新的部门',
'Add New Sent Item': '添加新发送项',
'Add New Setting': '添加新设置',
'Create Shelter': '添加新住房',
'Create Shelter Service': '添加新住房服务',
'Create Shelter Type': '添加新住所类型',
'Create Skill': '添加新技术',
'Add New Solution': '添加新的解决方案',
'Create Staff Member': '添加新成员',
...
'Create Volunteer': '添加新的志愿者',
'Create Warehouse': '添加新仓库',
'Create Office': '添加办公室',
...
'Add Record': '添加记录',
'Create Reference Document': '添加引用文件',
'Add Report': '添加报告',
'Add Request': '新增请求',
...
'Create Skill': '添加技能',
'Create Skill Equivalence': '添加技能等',
