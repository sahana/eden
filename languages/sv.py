...
'Create Activity Organisation': 'Create Activity Organisation',
...
'Create Alternative Item': 'Create Alternative Item',
...
'Create Assessment Answer': 'Create Assessment Answer',
...
'Create Branch Organization': 'Create Branch Organization',
...
'Create Data to Theme Layer': 'Create Data to Theme Layer',
...
'Create Educational Achievements': 'Create Educational Achievements',
...
'Create Item to Commitment': 'Create Item to Commitment',
'Add Item to Procurement Plan': 'Add Item to Procurement Plan',
'Create Item to Shipment': 'Create Item to Shipment',
...
"Create Person's Details": "Create Person's Details",
...
'Create Professional Experience': 'Create Professional Experience',
...
'Create Skill Equivalence': 'Create Skill Equivalence',
...
'Create New Stock Items': 'Create New Stock Items',
'Add New Subsector': 'Add New Subsector',
'Create Symbology': 'Create Symbology',
'Create Symbology for Layer': 'Create Symbology for Layer',
...
'Create new translation language': 'Create new translation language',
...
'Create Office Type': 'Create Office Type',
'Add Order': 'Add Order',
'Create Organization': 'Lägg till Organisation',
'Add Organization Domain': 'Add Organization Domain',
'Add Organization Needs': 'Add Organization Needs',
'Create Organization to Project': 'Create Organization to Project',
'Create Organization Type': 'Create Organization Type',
'Add Participant': 'Add Participant',
'Add Partner Organization': 'Add Partner Organization',
'Add People': 'Add People',
'Create People to Commitment': 'Create People to Commitment',
...
'Create Profile Configuration for this Layer': 'Create Profile Configuration for this Layer',
'Create Program': 'Create Program',
...
'Create Stock to Warehouse': 'Create Stock to Warehouse',
...
'Create Template Section': 'Create Template Section',
'Create Theme': 'Create Theme',
...
"Type the name of an existing catalog item OR Click 'Create New Item' to add an item which is not in the catalog.": "Type the name of an existing catalog item OR Click 'Create New Item' to add an item which is not in the catalog.",
'Type the name of an existing catalog kit': 'Type the name of an existing catalog kit',
"Type the name of an existing catalog kit OR Click 'Create New Kit' to add a kit which is not in the catalog.": "Type the name of an existing catalog kit OR Click 'Create New Kit' to add a kit which is not in the catalog.",
