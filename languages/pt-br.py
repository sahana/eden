...
'Create a Person': 'Incluir uma pessoa',
...
'Create Activity': 'Incluir Atividade',
'Create Activity Report': 'Incluir Relatório de atividade',
'Create Activity Type': 'Incluir tipo de atividade',
'Create Address': 'Incluir Endereço',
...
'Create Bed Type': 'Incluir Tipo De Cama',
'Create Brand': 'Incluir Marca',
'Create Budget': 'Incluir Orçamento',
...
'Create Catalog': 'Incluir Catálogo',
'Create Catalog Item': 'Incluir Item de Catálogo',
'Create Certificate': 'Incluir certificado',
'Create Certification': 'Adicionar Certificação',
'Create Cholera Treatment Capability Information': 'Incluir Informação sobre capacidade para tratamento de cólera',
'Add Cluster': 'Incluir cluster',
'Add Cluster Subsector': 'Incluir Subsetor de Cluster',
'Add Competency': 'incluir competência',
'Create Competency Rating': 'Incluir Classificação da Competência',
'Create Contact': 'Incluir contato',
'Create Contact Information': 'Incluir informações de contato',
'Create Course': 'Incluir curso',
'Create Course Certificate': 'Incluir Certificado de Curso',
'Create Credential': 'Incluir referência',
'Add Credentials': 'Incluir Referências',
'Create Dead Body Report': 'Incluir Relatório de Cadáver',
'Add Disaster Victims': 'Incluir Vítimas de Desastre',
'Add Distribution.': 'Incluir distribuição.',
'Add Donor': 'Incluir doador',
'Create Facility': 'Incluir Recurso',
'Add Feature Class': 'Incluir classe de recurso',
'Create Feature Layer': 'Incluir camada de recurso',
'Add Flood Report': 'Incluir Relatório Enchente',
'Create Group': 'Incluir Grupo',
'Add Group Member': 'Incluir Membro do Grupo',
'Create Hospital': 'Incluir Hospital',
'Add Human Resource': 'Incluir Recurso Humano',
'Create Identification Report': 'Incluir Identificação Relatório',
'Create Identity': 'Incluir Identidade',
'Add Image': 'Incluir Imagem',
'Add Impact': 'Adicionar Impacto',
'Add Impact Type': 'Incluir Tipo De Impacto',
'Create Incident': 'Adicionar Incidente',
'Create Incident Report': 'Incluir relatório de incidente',
'Add Inventory Item': 'Inclúir item de inventário',
'Add Item': 'Incluir item',
'Create Item Category': 'Incluir categoria de item',
'Create Item Pack': 'Incluir pacote de itens',
'Add Item to Catalog': 'Incluir Item no Catálogo',
'Create Item to Commitment': 'Incluir Item no Compromisso',
'Add Item to Inventory': 'Incluir Item de Inventário',
'Add Item to Request': 'Incluir Item para pedido',
'Create Item to Shipment': 'Adicionar Item para Embarque',
'Add Job Role': 'Incluir tarefa Função',
'Add Key': 'Incluir Chave',
'Add Kit': 'Adicionar Kit',
'Create Layer': 'Incluir Camada',
'Add Level 1 Assessment': 'Incluir nível de Avaliação 1',
'Add Level 2 Assessment': 'Incluir nível de Avaliação 2',
'Create Location': 'Incluir Local',
'Create Log Entry': 'Adicionar Entrada de Log',
'Create Map Configuration': 'Incluir Mapa de configuração',
'Create Marker': 'Incluir Marcador',
...
'Create Activity': 'Incluir Nova Atividade',
'Create Address': 'Incluir Novo Endereço',
'Create Alternative Item': 'Incluir novo Item Alternativo',
'Add New Assessment': 'Adicionar Nova Avaliação',
'Add New Assessment Summary': 'Incluir novo Resumo de Avaliação',
'Create Asset': 'Incluir Novo Ativo',
...
'Create Catalog': 'Incluir Novo Catálogo',
'Create Catalog Item': 'Incluir novo Item de catálogo',
...
'Create Contact': 'Incluir novo contato',
'Create Credential': 'Incluir nova credencial',
...
'Create Facility': 'Incluir novo Recurso',
'Add New Feature Class': 'Incluir nova classe do recurso',
'Create Feature Layer': 'Adicionar nova camada de características',
...
'Create Location': 'Incluir Novo Local',
'Create Log Entry': 'Incluir nova entrada de Log',
'Create Map Configuration': 'Incluir Novo Mapa de Configuração',
'Create Marker': 'Incluir novo Marcador',
...
'Create Organization': 'Incluir nova Organização',
'Create Photo': 'Adicionar Nova Foto',
'Add New Population Statistic': 'Incluir nova População De Estatística',
'Add New Problem': 'Incluir novo Problema',
'Create Project': 'Incluir novo projeto',
...
'Create Task': 'Incluir Nova Tarefa',
'Add New Team': 'Adicionar nova equipe',
'Create Theme': 'Incluir novo tema',
'Add New Ticket': 'Incluir nova permissão',
'Add New Track': 'Adicionar Nova Pista',
'Create User': 'Incluir Novo Usuário',
'Add New User to Role': 'Adicionar Novo usuário para Função',
'Create Volunteer': 'Incluir novo Voluntário',
'Create Warehouse': 'Adicionar novo armazém',
'Add Note': 'Incluir nota',
'Create Office': 'Adicionar Office',
'Create Organization': 'Incluir Organização',
'Add Peer': 'Incluír Par',
'Add Person': 'incluir pessoa',
'Create Personal Effects': 'Incluir efeitos pessoais',
'Create Photo': 'Incluir Foto',
'Add Population Statistic': 'Incluir População Estatística',
'Add Position': 'Adicionar Posição',
'Add Problem': 'Adicionar Problema',
'Create Project': 'Adicionar Projeto',
'Create Projection': 'Adicionar Projeção',
'Add Question': 'Adicionar Pergunta',
'Add Rapid Assessment': 'Adicionar Avaliação Rápida',
'Add Record': 'Incluir Registro',
'Create Reference Document': 'Incluir documento de referência',
'Add Report': 'Incluir Relatório',
'Add Request': 'Incluir Pedido',
'Create Resource': 'Incluir Recurso',
'Add River': 'Incluir Rio',
'Create Role': 'Incluir Função',
'Create Room': 'Incluir Sala',
'Add Section': 'Incluir Secção',
'Create Sector': 'Incluir Sector',
'Create Service Profile': 'Incluir Perfil de Serviço',
'Add Setting': 'Adicionar Definição',
'Create Shelter': 'Incluir Abrigo',
'Create Shelter Service': 'Incluir Serviço de Abrigo',
'Create Shelter Type': 'Incluir Tipo de Abrigo',
'Create Skill': 'Incluir Habilidade',
'Create Skill Equivalence': 'Incluir equivalência de habilidades',
'Add Skill Provision': 'Incluir provisão de habilidades',
'Create Skill Type': 'Incluir Tipo de Habilidade',
'Add Solution': 'Incluir Solução',
'Add Staff': 'Incluir equipe',
'Create Staff Member': 'Adicionar membro da equipe',
'Add staff members': 'Incluir membros da equipe',
'Add Staff Type': 'Incluir tipo de equipe',
'Create Status': 'Incluir Status',
...
"If you don't see the Hospital in the list, you can add a new one by clicking link 'Create Hospital'.": "Se você não vê o Hospital na lista, você pode incluir um novo clicando no link 'incluir Hospital'.",
"If you don't see the Office in the list, you can add a new one by clicking link 'Create Office'.": "Se você não vê o escritório na lista, você pode incluir um novo clicando no link 'incluir escritório'.",
"If you don't see the Organization in the list, you can add a new one by clicking link 'Create Organization'.": 'Se voce não vê a Organização na lista, voce poderá adicionar uma nova clicando no link "Incluir Organização"',
...
"Select a Room from the list or click 'Create Room'": "Escolha uma sala da lista ou clique 'Incluir sala'",
