...
'Create Alternative Item': '新增替代項目',
'Add an Photo.': '新增一个照片。',
'Add Assessment': '新增評量',
...
'Create Contact Information': '新增聯絡資訊',
'Create Course': '新增課程',
'Add Course Certicate': '新增進程凭證',
'Create Credential': '新增認證',
...
'Create Item to Commitment': '新增項目至承諾',
'Add Item to Inventory': '新增項目至庫存',
'Add Item to Request': '新增項目至要求',
'Create Item to Shipment': '新增項目至出貨',
'Add Job Role': '新增工作角色',
'Add Key': '新增金鑰',
'Add Kit': '新增套件',
'Add Landmark': '新增里程碑',
...
'Create Reference Document': '新增参照文件',
...
'Add Site': '新增站台',
'Create Skill': '新增技能',
'Create Skill Equivalence': '新增等值技能',
