...
"Caution: doesn't respect the framework rules": "احتیاط: فریم ورک کے قوانین کا احترام نہیں کرتا",
...
'Configure/Monitor Synchronization': 'ترتیب دیں / ہم وقت سازی کی نگرانی',
'Configure Run-time Settings': 'رن ٹائم کی ترتیبات کی تشکیل',
...
'Features Include:': 'خصوصیات میں شامل ہیں',
'Female': 'عورت',
...
'Manage Users & Roles': 'صارفین اور کردار کی اطلاع دیں',
...
'Translate the System': 'نظام کے ترجمہ',
...
'View Error Tickets': 'خرابی ٹکٹ دیکھیں',
...
'View Test Results Reports': 'ٹیسٹ کے نتائج کی رپورٹیں دیکھیں',
...
'View/Edit the Database directly': 'براہ راست ڈیٹا بیس ملاحظہ / ترمیم',
...
'meters': 'meters',
'missing': 'missing',
'module allows the site administrator to configure various options.': 'ماڈیول سائٹ ایڈمنسٹریٹر سے مختلف اختیارات کو ترتیب دینے کی اجازت دیتا ہے',
