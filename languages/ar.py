...
'%(GRN)s Number':'عدد ال %(GRN)s',
'%(PO)s Number':'عدد ال %(PO)s',
'%(REQ)s Number':'عدد ال %(REQ)s',
...
'Course Certificates':'شهادات التخرج من الدورة',
...
'Date Needed By':'تاريخ يحتاجها ب-',
...
'Google Satellite':'الاقمار الصناعية google',
...
'Institution': 'مؤسسة',
'Insufficient Priviliges':'امتيازات غير كافية',
...
'Job Title Catalog':'فهرس العنوان الوظيفي',
...
'Requester': 'الطالب',
'Requests': 'المطالب',
'Required Fields':'ميداين المتطلبات',
...
'Search Shipped Items':'بحث شحن السلع',
...
'Summary': 'موجز',
'Sunday': 'الأحد',
'Supplier/Donor':'المورد / المانحين',
'Suppliers':'المجهزين',
'Supplies': 'لوازم',
...
'Waybill Number':'عدد بوليصة الشحن',
'Website': 'موقع ويب',
...
'You must enter a minimum of %d characters':'من الاحرف %d يجب عليك ادخال ما لايقل عن',
