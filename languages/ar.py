...
'Create Alternative Item': 'إضافة عنصر بديل',
...
'Create Credential': 'أضف االاعتمادات',
...
'Create Map Configuration': 'اضافة تكوين خريطة',
'Create Marker': 'أضف ماركر',
'Add Membership': 'أضف عضوية',
'Add Need': 'أضف حاجة',
'Create Address': 'إضافة عنوان جديد',
'Create Alternative Item': 'إضافة عنصربديل جديد',
...
'Create Office': 'إضافة مكتب جديد',
'Create Organization': 'أضف منظمة جديدة',
...
'Create Skill Equivalence': 'أضف مهارة معادلة',
