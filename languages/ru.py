...
'Create Cluster Subsector': 'Добавить кластер Подсектора',
'Create Cluster': 'Добавить кластер',
...
'Create Facility': 'Добавить средство',
...
'Create Item': 'Добавить новый элемент',
'Create Kit': 'Добавить новый комплект',
