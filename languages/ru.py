...
'Create a Person': 'Добавить пользователя',
...
'Create Activity': 'Добавить действие',
'Create Activity Report': 'Добавить действие Отчета',
'Create Activity Type': 'Добавить тип работы',
'Create Address': 'Добавить адрес',
'Create Alternative Item': 'Добавить альтернативной элемент',
'Add Assessment': 'Добавить Оценки',
'Add Assessment Summary': 'Добавить суммарную оценку',
'Create Asset': 'Добавить ресурс',
...
'Create Bed Type': 'Добавить тип кровати',
'Create Brand': 'Добавить Марки',
'Create Budget': 'Добавить Бюджета',
...
'Create Catalog': 'Добавить каталог',
'Create Catalog Item': 'Добавить элемент каталога',
'Create Certificate': 'Добавить сертификат',
'Create Certification': 'Добавить Сертификации',
'Create Cholera Treatment Capability Information': 'Добавить лечению холеры Возможность Информации',
...
'Create Contact Information': 'Добавление контактной информации',
'Create Course': 'Добавить курс',
'Create Course Certificate': 'Добавить курс Сертификата',
'Create Credential': 'Добавить идентификационные данные',
...
'Create Log Entry': 'Добавить запись журнала',
...
'Create Activity': 'Добавить новое действие',
'Create Address': 'Добавить новый адрес',
'Create Alternative Item': 'Добавить новый альтернативной номенклатуры',
'Add New Assessment': 'Добавить новую оценку',
'Add New Assessment Summary': 'Добавить новую сводную оценку',
'Create Asset': 'Добавить новый ресурс',
'Add New Baseline': 'Добавить новую контрольную версию',
'Add New Baseline Type': 'Добавить новый Базовый Тип',
'Create Brand': 'Добавить новой торговой марки',
...
'Create Catalog': 'Добавить новый каталог',
...
'Create Contact': 'Добавить новый контакт',
'Create Credential': 'Добавить новое разрешение',
...
'Create Facility': 'Добавить новое средство',
'Add New Feature Class': 'Добавить класс нового средства',
'Create Feature Layer': 'Добавить новый компонент Слой',
'Add New Flood Report': 'Добавить новый Наводнениям Отчет',
'Create Group': 'Добавить новую группу',
'Add new Group': 'Добавить новую группу',
'Create Hospital': 'Добавить новый Больницу',
'Add New Human Resource': 'Добавить новый людских ресурсов',
'Create Identity': 'Добавить новое удостоверение',
...
'Create Incident Report': 'Добавить новый отчет о происшествии',
'Add new Individual': 'Добавить новый Отдельных',
'Create New Item': 'Добавить новый элемент',
'Create Item Category': 'Добавить новый элемент категории',
'Create Item Pack': 'Добавить новый элемент пакет',
'Add New Item to Kit': 'Добавить новый элемент в комплект',
'Add New Key': 'Добавьте новый ключ',
'Create New Kit': 'Добавить новый комплект',
'Create Layer': 'Добавить новый слой',
'Add New Level 1 Assessment': 'Добавить новую оценку уровня 1',
'Add New Level 2 Assessment': 'Добавить новую оценку уровня 2',
'Create Location': 'Добавить новый участок',
'Create Log Entry': 'Добавить запись протокола',
'Create Map Configuration': 'Добавить новый конфигурации отображения',
'Create Marker': 'Добавить новый Маркер',
...
'Create Office': 'Добавить новый офис',
'Create Organization': 'Добавить новую организацию',
'Create Photo': 'Добавить новую фотографию',
'Add New Population Statistic': 'Добавить новый Народонаселению Статистики',
'Add New Problem': 'Добавить новую проблему',
'Create Project': 'Добавить новый проект',
'Add new project.': 'Добавить новый проект.',
'Create Projection': 'Добавить новую проекцию',
...
'Create Resource': 'Добавить новый ресурс',
'Add New River': 'Добавить новый Реке',
'Create Role': 'Добавить новую роль',
'Add New Role to User': 'Добавить новую роль для пользователя',
'Create Room': 'Добавить новое помещение',
'Add New Scenario': 'Добавить новый Сценарий',
'Create Sector': 'Добавить новый сектор',
'Add New Sent Item': 'Добавить новый посланный элемент',
'Add New Setting': 'Добавить новую установку',
'Create Shelter': 'Добавить новое укрытие',
'Create Shelter Service': 'Добавить новую услугу убежища',
'Create Shelter Type': 'Добавить новый тип убежища',
'Create Skill': 'Добавить новый Навык',
'Add New Solution': 'Добавить новое решение',
'Create Staff Member': 'Добавить новый сотрудник',
...
'Create Task': 'Добавить новую задачу',
'Add New Team': 'Добавить новую Группу',
'Create Theme': 'Добавить тему',
...
'Create Volunteer': 'Добавить новый Доброволец',
'Create Warehouse': 'Добавить новый склад',
...
'Create Reference Document': 'Добавить ссылку Документа',
...
'Create Room': 'Добавить Комнаты',
'Add Section': 'Добавить раздел',
'Create Sector': 'Добавить сектор',
'Create Service Profile': 'Добавить профиль службы',
'Add Setting': 'Добавить параметр',
'Create Shelter': 'Добавить Жильем',
'Create Shelter Service': 'Добавить Жильем Службы',
'Create Shelter Type': 'Добавить Жильем Типа',
'Create Skill': 'Добавить навык',
'Create Skill Equivalence': 'Добавить Навык Equivalence',
'Add Skill Provision': 'Добавить Навык Предоставления',
'Create Skill Type': 'Добавить тип навыка',
'Add Solution': 'Добавить решение',
'Create Staff Member': 'Добавить сотрудника',
