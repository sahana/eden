...
deployment_settings.auth.hmac_key = "6ca0c8f5-4ee7-42fb-bd55-73104a0534af"
# This setting will set the minimum passwod length to 8
deployment_settings.auth.password_min_length = 8
# Email settings
# Outbound server
