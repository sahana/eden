...
sys.path.insert(0, os.path.abspath('../../')) # Path for importing django-nose
sys.path.insert(0, os.path.abspath('../../src/')) # Path for source code
#print sys.path
...
#html_title = 'e-cidadania v0.1.5 beta3'
...
#'preamble': 'Este es un preambuloasdasdasdas',
}
...
texinfo_documents = [
  ('index', 'e-cidadania', u'e-cidadania Documentation', u'e-cidadania',
   'e-cidadania', 'e-democracy tool for citizens', 'Miscellaneous'),
]
