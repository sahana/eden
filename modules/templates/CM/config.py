...
#
UI_DEFAULTS = {"case_bamf_first": True,
               ...
               "case_lodging": "text", # "site"|"text"|None
...
def config(settings):
    ...
    settings.base.system_name = "CaseManagement"
    settings.base.system_name_short = "CaseManagement"

    # PrePopulate data
    settings.base.prepopulate += ("CM",)
    settings.base.prepopulate_demo += ("CM/Demo",)
