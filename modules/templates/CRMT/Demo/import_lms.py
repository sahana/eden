...
#
#
# run as python web2py.py -S eden -M -R applications/eden/private/templates/CRMT2/Demo/import_lms.py
#
...
filename = os.path.join(request.folder, "private", "templates", "CRMT2", "Demo", "LMS_sample_orgs.csv")
