...
def config(settings):
    """
        Template settings for Kashmir Floods Response

        http://eden.sahanafoundation.org/wiki/Deployments/KashmirFloods
    """
    ...
    # PrePopulate data
    settings.base.prepopulate += ("historic/Kashmir", "historic/Kashmir/Demo", "default/users")

    # Theme (folder to use for views/layout.html)
    settings.base.theme = "historic.Kashmir"
