...
def config(settings):
    ...
    # -----------------------------------------------------------------------------
    # Pre-Populate
    settings.base.prepopulate += ("historic/Syria", "default/users")
    ...
    settings.base.theme = "historic.Syria"
    ...
    def render_contacts(list_id, item_id, resource, rfields, record):
        ...
        if permit("update", table, record_id=person_id):
            ...
            edit_url = URL(c="hrm", f="person",
                           ...
                           vars=vars)
            title_update = s3.crud_strings.hrm_human_resource.title_update
...
# -----------------------------------------------------------------------------
# Functions which are importable by other Templates
# -----------------------------------------------------------------------------
