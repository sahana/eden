...
class S3OptionsMenu(default.S3OptionsMenu):
    ...
    def hrm():
        ...
        return M()(
                    ...
                    M("Staff & Volunteers (Combined)",
                      c="hrm", f="human_resource", m="summary", check=is_super_editor),
                    ...
                    M("Certificate Catalog", c="hrm", f="certificate", check=use_certs)(
                        M("Create", m="create"),
                        M("Import", m="import", p="create", check=is_org_admin),
    ...
    def vol():
        ...
        return M(c="vol")(
                    ...
                    M("Staff & Volunteers (Combined)",
                      c="vol", f="human_resource", m="summary", check=is_super_editor),
                    ...
                    M("Certificate Catalog", f="certificate", check=use_certs)(
                        M("Create", m="create"),
                        #M("Skill Equivalence", f="certificate_skill"),
                    ),
                    ...
                    M("Awards", f="award", check=is_org_admin)(
                        M("Create", m="create"),
                    ),
