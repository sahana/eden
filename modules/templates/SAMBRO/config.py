...
%(WEBSITE)s: %(Website)s%(Profile)s""") % dict(Status = arow.status,
    ...
    # -------------------------------------------------------------------------
    def customise_event_event_type_controller(**attr):
        ...
        def custom_prep(r):
            ...
            # On-delete option
            current.s3db.event_type_id.attr.ondelete = "SET NULL"
    ...
    settings.customise_event_event_type_controller = customise_event_event_type_controller
