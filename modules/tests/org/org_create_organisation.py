    ...
    def test_add_logo(self):
        ...
        dataList = [
                    {"org" : "Afghan Red Crescent Society",
                     "logo" : "private/prepopulate/demo/IFRC_Train/icrc-cl.gif"
                    },
                    {"org" : "International Federation of Red Cross and Red Crescent Societies",
                     "logo" : "private/prepopulate/demo/IFRC_Train/icrc.gif"
                    },
                   ]
        ...
        for data in dataList:
            ...
            logo_path = "%s/%s" % (self.config.base_dir, data["logo"])
            ...
            self.assertTrue(logo,
                            "The logo is not on the database for %s" % data["org"])
