...
# python web2py.py -S eden -M -R applications/eden/modules/unit_tests/s3db/stats.py
#
import unittest
import datetime
...
@unittest.skip("Comment or remove this line in modules/unit_tests/s3db/stats.py to activate this test")
